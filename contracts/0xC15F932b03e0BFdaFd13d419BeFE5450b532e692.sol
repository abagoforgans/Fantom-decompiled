...
function sub_502d88d9(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    deposits[address(arg1)] = deposits[address(arg1)] + msg.value - (msg.value / 20)
}
...
function triggerLaunch() {
    ...
    call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
       value eth.balance(this.address) wei
         gas gas_remaining wei
        args 0, uint32(stor5), 100000 * 10^18, 0, 0, 0x844d4992375368ce4bd03d19307258216d0dd147, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    require ext_code.size(0x844d4992375368ce4bd03d19307258216d0dd147)
    call 0x844d4992375368ce4bd03d19307258216d0dd147.genesis(uint256 arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
