...
function deposit(uint256 arg1, uint256 arg2) payable {
    ...
    call 0x2069b76afe6b734fb65d1d099e7ec64ee9cc76b2.transferFrom(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) with:
         gas gas_remaining wei
        args 4128803, arg1, 4128803, arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    if arg2 < arg2 / 20:
        revert with 'NH{q', 17
    require ext_code.size(0xf8a3bd81144d50b36f617bb34dda5833dfafe472)
    staticcall 0xf8a3bd81144d50b36f617bb34dda5833dfafe472.userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args 0, msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
