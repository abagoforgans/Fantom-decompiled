...
function sub_1d9e75f2(?) payable {
    ...
    while idx < users.length:
        if idx >= users.length:
            revert with 'NH{q', 50
        if tickets[stor15[idx]] > -uint128(balance[stor15[idx]] / 1000) + test266151307():
            revert with 'NH{q', 17
        tickets[stor15[idx]] = uint128(tickets[stor15[idx]] + uint128(balance[stor15[idx]] / 1000))
        if idx >= users.length:
            revert with 'NH{q', 50
        mem[0] = users[idx]
        mem[32] = 13
        if totalTickets > -(balance[stor15[idx]] / 1000) - 1:
            revert with 'NH{q', 17
        totalTickets += balance[stor15[idx]] / 1000
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_90d22ed2(?) payable {
    ...
    if msg.sender == stor0:
        ...
        while idx < users.length:
            ...
            mem[mem[64] + 36] = balance[stor15[idx]]
            require ext_code.size(stor3)
            call stor3.0xa9059cbb with:
                 gas gas_remaining wei
                args users[idx], balance[stor15[idx]]
...
function drawing() payable {
    ...
    if ext_call.return_data[0] < ext_call.return_data[0]:
        revert with 'NH{q', 17
    if 0 / 100 and stor10 > -1 / 0 / 100:
        revert with 'NH{q', 17
    if 0 / 100 * stor10 / 100 and 75 > -1 / 0 / 100 * stor10 / 100:
        revert with 'NH{q', 17
    require ext_code.size(stor3)
    call stor3.0xa9059cbb with:
         gas gas_remaining wei
        args stor0, 75 * 0 / 100 * stor10 / 100
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    if 0 / 100 and stor10 > -1 / 0 / 100:
        revert with 'NH{q', 17
    if 0 / 100 * stor10 / 100 and 25 > -1 / 0 / 100 * stor10 / 100:
        revert with 'NH{q', 17
    require ext_code.size(stor3)
    call stor3.0xa9059cbb with:
         gas gas_remaining wei
        args stor2, 25 * 0 / 100 * stor10 / 100
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    while idx < users.length:
        mem[0] = users[idx]
        mem[32] = 12
        if s > -tickets[stor15[idx]] - 1:
            revert with 'NH{q', 17
        if s + tickets[stor15[idx]] <= sha3(block.hash(block.number - 1)) % totalTickets:
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            s = s + tickets[stor15[idx]]
            continue 
        if idx >= users.length:
            revert with 'NH{q', 50
        if 100 < stor10:
        ...
        if -stor10 + 100 < stor11:
            revert with 'NH{q', 17
        if 0 / 100 and -stor10 + -stor11 + 100 > -1 / 0 / 100:
            revert with 'NH{q', 17
        require ext_code.size(stor3)
        call stor3.0xa9059cbb with:
             gas gas_remaining wei
            args users[idx], (100 * 0 / 100) - (stor10 * 0 / 100) - (stor11 * 0 / 100)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        ...
        if 0 / 100 and -stor10 + -stor11 + 100 > -1 / 0 / 100:
            revert with 'NH{q', 17
        stor35 = (100 * 0 / 100) - (stor10 * 0 / 100) - (stor11 * 0 / 100)
        if idx >= users.length:
            revert with 'NH{q', 50
        stor25 = users[idx]
}
