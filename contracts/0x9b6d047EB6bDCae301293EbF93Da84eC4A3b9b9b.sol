...
function buy(uint256 arg1, address arg2) payable {
    ...
    if not arg1 / 10:
        ...
        if not return_data.size:
            ...
            if ext_code.size(sub_c946d766Address) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = 0, msg.sender, Mask(224, 32, 100 * arg1 / 10) >> 32
            call sub_c946d766Address with:
               funct uint32(msg.sender)
                 gas gas_remaining wei
                args 100 * arg1 / 10, mem[392 len 24], 0, mem[520 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), address(arg2) << 64, 0, address(this.address), arg1
                if not unknown_0x23b872dd(?????), address(arg2) << 64:
            ...
            if ext_code.size(sub_c946d766Address) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 457 len 64] = 0, msg.sender, Mask(224, 32, 100 * arg1 / 10) >> 32
            call sub_c946d766Address with:
               funct uint32(msg.sender)
                 gas gas_remaining wei
                args 100 * arg1 / 10, mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 521 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), address(arg2) << 64, 0, address(this.address), arg1
                if not unknown_0x23b872dd(?????), address(arg2) << 64:
