...
function sub_b5c1b1fd(?) payable {
    ...
    call stor1.flashLoan(address rg1, address rg2, uint256 rg3, bytes rg4) with:
         gas gas_remaining wei
        args address(this.address), address(arg2), arg1, 128, 192, arg4 << 192, arg5, address(arg6), address(arg7), address(arg8), address(arg9)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function onFlashLoan(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    require return_data.size >= 32
    _73 = mem[_72]
    if ext_call.return_data[0] > mem[_72]:
        revert with 0, 'SafeMath: subtraction overflow'
    _75 = mem[352]
    mem[mem[64] + 4] = mem[396 len 20]
    mem[mem[64] + 36] = -1
    require ext_code.size(address(_75))
    call address(_75).approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args mem[mem[64] + 4], -1
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    mem[mem[64] + 36] = _73 - ext_call.return_data[0]
    mem[mem[64] + 68] = address(_84)
    require ext_code.size(address(_82))
    call address(_82).liquidateBorrow(address rg1, uint256 rg2, address rg3) with:
         gas gas_remaining wei
        args mem[mem[64] + 4], _73 - ext_call.return_data[0], address(_84)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[64] = mem[64] + ceil32(return_data.size)
    ...
    staticcall address(_89).balanceOf(address rg1) with:
            gas gas_remaining wei
           args address(this.address)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    call address(_94).approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
    ...
    staticcall address(_101).balanceOf(address rg1) with:
            gas gas_remaining wei
           args address(this.address)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    require return_data.size >= 32
    require ext_code.size(address(_101))
    call address(_101).redeem(uint256 rg1) with:
         gas gas_remaining wei
        args mem[_104]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
