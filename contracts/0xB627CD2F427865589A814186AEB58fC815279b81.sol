...
const INIT_CODE_PAIR_HASH = sha3(code.data[1834 len 9212], mem[9340 len 4] >> 73440)
...
function createPair(address arg1, address arg2) payable {
    ...
    require arg2 == arg2
    if arg1 == arg2:
        revert with 0, 'Brush: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'Brush: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'Brush: PAIR_EXISTS'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[1834 len 9212]
