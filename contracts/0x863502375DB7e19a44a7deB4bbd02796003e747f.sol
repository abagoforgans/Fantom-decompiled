            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    if not return_data.size:
                        ...
                        call address(vaultAddress).depositAll() with:
                             gas gas_remaining wei
                            args (Mask(8 * (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size)), -(8 * (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 4) + 256, 0xde5f626800000000000000000000000000000000000000000000000000000000) >> -(8 * (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 4) + 256)
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        emit Sponsored(address arg1, uint256 arg2):
                                       arg1,
...
function redeemToken(uint256 arg1) payable {
    ...
    if not totalSupply:
        ...
        if not arg1:
            ...
            require return_data.size >= 32
            require ext_code.size(address(vaultAddress))
            call address(vaultAddress).0x2e1a7d4d with:
                 gas gas_remaining wei
