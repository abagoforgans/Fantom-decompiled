...
function setRoyalties(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if owner != msg.sender:
...
function mint(address arg1) payable {
    ...
    if ext_code.size(arg1) > 0:
        ...
        call arg1.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
            ...
            args 0, uint32(msg.sender), 0, stor10, 128, 0
        ...
        if Mask(32, 224, ext_call.return_data[0]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
    emit Minted(stor10, msg.sender, 1);
    if stor10 > -2:
        revert with 'NH{q', 17
    stor10++
}
...
function sub_927f59ba(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        if ownerOf[s]:
            revert with 0, 'ERC721: token already minted'
        if balanceOf[address(_108)] > -2:
            revert with 'NH{q', 17
        balanceOf[address(_108)]++
        mem[0] = s
        mem[32] = 2
        ownerOf[s] = address(_108)
        emit Transfer(0, address(_108), s);
        if ext_code.size(address(_108)) > 0:
            ...
            t = 0
            while t < 0:
                mem[mem[64] + t + 164] = mem[_109 + t + 32]
                t = t + 32
                continue 
            require ext_code.size(address(_108))
            call address(_108).onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                 gas gas_remaining wei
            ...
            require return_data.size >= 32
            require mem[_159] == Mask(32, 224, mem[_159])
            if Mask(32, 224, mem[_159]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        mem[mem[64]] = s
        mem[mem[64] + 32] = msg.sender
        mem[mem[64] + 64] = 1
        emit Minted(s, msg.sender, 1);
        if s == -1:
            revert with 'NH{q', 17
        if idx == -1:
            revert with 'NH{q', 17
