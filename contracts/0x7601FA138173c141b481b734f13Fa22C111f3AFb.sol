...
const sub_a8fcc417(?) = 0xf0b9e5ba00000000000000000000000000000000000000000000000000000000
...
function sub_0e198440(?) payable {
    ...
    if ext_call.return_data[0] > !arg2:
        revert with 0, 17
    if var32002 >= ext_call.return_data[0] + arg2:
    mem[ceil32(return_data.size) + 96] = 0x23b872dd00000000000000000000000000000000000000000000000000000000
    mem[var36001] = this.address
    mem[var36001 + 32] = msg.sender
    mem[var36001 + 64] = var36002
    require ext_code.size(stor0)
    call stor0.mem[var40004 len 4] with:
         gas gas_remaining wei
    ...
    if ext_call.return_data[0] > !arg2:
        revert with 0, 17
    if var56002 >= ext_call.return_data[0] + arg2:
    # nil
}
