...
function lockLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, address arg6) payable {
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            mem[460 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len 28]
            call address(ext_call.return_data[0]) with:
               funct uint32(stor2)
                 gas gas_remaining wei
                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[524 len 4]
            if not return_data.size:
                if not ext_call.success:
