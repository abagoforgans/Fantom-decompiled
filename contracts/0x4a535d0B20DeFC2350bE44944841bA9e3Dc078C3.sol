...
function sub_dc917407(?) payable {
    ...
    while idx < _39:
        ...
        mem[64] = mem[64] + 64
        require idx < mem[96]
        mem[_40] = mem[mem[(32 * idx) + 128] + 12 len 20]
        require idx < mem[96]
        mem[_40 + 32] = mem[mem[(32 * idx) + 128] + 32]
        sub_b7324175.length++
        mem[0] = 3
        sub_b7324175[sub_b7324175.length].field_0 = mem[_40 + 12 len 20]
        sub_b7324175[sub_b7324175.length].field_256 = mem[_40 + 32]
        _39 = mem[96]
        idx = idx + 1
        continue 
}
