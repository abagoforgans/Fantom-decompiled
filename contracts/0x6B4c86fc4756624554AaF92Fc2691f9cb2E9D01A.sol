...
function setStartBlock(uint256 arg1) payable {
    ...
    emit StartBlockChanged(arg1, arg1 + 309000);
}
...
function sub_74324acd(?) payable {
    ...
    if sub_f34b1c85 >= arg1 / salePrice:
        ...
        mem[(2 * ceil32(return_data.size)) + 164] = arg1 / salePrice
        ...
        mem[(2 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1 / salePrice, 0
        mem[(2 * ceil32(return_data.size)) + 328] = 0
        call stor8 with:
           funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, arg1 / salePrice, 0) >> 224
             gas gas_remaining wei
            args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, arg1 / salePrice, 0) << 288)
        if not return_data.size:
            ...
            mem[(2 * ceil32(return_data.size)) + 328] = 0xff7e5bbcb51cac4c9a03d95e63aee82280efd9ea
            ...
            if not ext_code.size(USDCAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 456 len 128] = 0, msg.sender, 0xff7e5bbcb51cac4c9a03d95e63aee82280efd9ea, arg1, 0
            mem[(2 * ceil32(return_data.size)) + 556] = 0
            call USDCAddress with:
               funct Mask(32, 224, 0, msg.sender, 0xff7e5bbcb51cac4c9a03d95e63aee82280efd9ea, arg1, 0) >> 224
                 gas gas_remaining wei
                args (Mask(768, -544, 0, msg.sender, 0xff7e5bbcb51cac4c9a03d95e63aee82280efd9ea, arg1, 0) << 544)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
            ...
            if sub_f34b1c85 < arg1 / salePrice:
                revert with 0, 17
            sub_f34b1c85 -= arg1 / salePrice
            if sub_3e428831[msg.sender] > !(arg1 / salePrice):
                revert with 0, 17
            sub_3e428831[msg.sender] += arg1 / salePrice
            emit 0x58024150: msg.sender, arg1, arg1 / salePrice
        else:
            ...
            mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = 0xff7e5bbcb51cac4c9a03d95e63aee82280efd9ea
            ...
            if not ext_code.size(USDCAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 457 len 128] = 0, msg.sender, 0xff7e5bbcb51cac4c9a03d95e63aee82280efd9ea, arg1, 0
            ...
            if not return_data.size:
                ...
                mem[(4 * ceil32(return_data.size)) + 522] = arg1 / salePrice
        ...
        if not return_data.size:
            ...
            if sub_f34b1c85 < sub_f34b1c85:
                revert with 0, 17
            sub_f34b1c85 = 0
            if sub_3e428831[msg.sender] > !sub_f34b1c85:
                revert with 0, 17
            sub_3e428831[msg.sender] += sub_f34b1c85
