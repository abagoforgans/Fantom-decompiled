...
function sub_975deca9(?) payable {
    if owner != msg.sender:
        revert with 0, 'Only owner allowed.'
    uint256(stor3.field_0) = not bool(sub_3ccafd11) or Mask(248, 8, uint256(stor3.field_0))
}
...
function convert(uint256 arg1) payable {
    ...
    call sub_74709ae4Address.transferFrom(address arg1, address arg2, uint256 arg3) with:
    ...
    call gtonAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
