...
function uri(uint256 arg1) payable {
    ...
    if bool(stor2.length):
        ...
        if not s:
            ...
            if bool(stor2.length):
                ...
                if not bool(stor2.length):
                    ...
                    mem[_731 + uint255(stor2.length.field_1) + _791 + 32] = '.json'
                    if ceil32(_791) <= _791:
                        _1211 = mem[64]
            ...
            if not bool(stor2.length):
                ...
                mem[_731 + stor2.length.field_1 % 128 + _800 + 32] = '.json'
                if ceil32(_800) <= _800:
                    _1214 = mem[64]
        ...
        if bool(stor2.length):
            ...
            if not bool(stor2.length):
                ...
                _792 = mem[96]
                mem[mem[64] + uint255(stor2.length.field_1) + 32 len ceil32(mem[96])] = mem[128 len ceil32(mem[96])]
                mem[_732 + uint255(stor2.length.field_1) + _792 + 32] = '.json'
                if ceil32(_792) <= _792:
                    _1217 = mem[64]
        ...
        if not bool(stor2.length):
            ...
            _802 = mem[96]
            mem[mem[64] + stor2.length.field_1 % 128 + 32 len ceil32(mem[96])] = mem[128 len ceil32(mem[96])]
            mem[_732 + stor2.length.field_1 % 128 + _802 + 32] = '.json'
            if ceil32(_802) <= _802:
                _1220 = mem[64]
    ...
    if not s:
        ...
        if bool(stor2.length):
            ...
            if not bool(stor2.length):
                ...
                _795 = mem[96]
                mem[mem[64] + uint255(stor2.length.field_1) + 32 len ceil32(mem[96])] = mem[128 len ceil32(mem[96])]
                mem[_733 + uint255(stor2.length.field_1) + _795 + 32] = '.json'
                if ceil32(_795) <= _795:
                    _1223 = mem[64]
        ...
        if not bool(stor2.length):
            ...
            _806 = mem[96]
            mem[mem[64] + stor2.length.field_1 % 128 + 32 len ceil32(mem[96])] = mem[128 len ceil32(mem[96])]
            mem[_733 + stor2.length.field_1 % 128 + _806 + 32] = '.json'
            if ceil32(_806) <= _806:
                _1226 = mem[64]
    ...
    if bool(stor2.length):
        ...
        if not bool(stor2.length):
            ...
            _796 = mem[96]
            mem[mem[64] + uint255(stor2.length.field_1) + 32 len ceil32(mem[96])] = mem[128 len ceil32(mem[96])]
            mem[_734 + uint255(stor2.length.field_1) + _796 + 32] = '.json'
            if ceil32(_796) <= _796:
                _1229 = mem[64]
    ...
    if not bool(stor2.length):
        ...
        _808 = mem[96]
        mem[mem[64] + stor2.length.field_1 % 128 + 32 len ceil32(mem[96])] = mem[128 len ceil32(mem[96])]
        mem[_734 + stor2.length.field_1 % 128 + _808 + 32] = '.json'
        if ceil32(_808) <= _808:
            _1232 = mem[64]
