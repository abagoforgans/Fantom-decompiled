    ...
    if not return_data.size:
        ...
        if arg2 > balanceOf[address(msg.sender)]:
            revert with 0, 
                        ...
                        0x7345524332303a206275726e20616d6f756e74206578636565647320,
                        Mask(16, -256, 0x7345524332303a206275726e20616d6f756e7420657863656564732062616c616e63, 34, 0x7345524332303a206275726e20616d6f756e74206578636565647320) << 256
    else:
        mem[260 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
            revert with 0, 'SafeERC20: low-level call failed'
