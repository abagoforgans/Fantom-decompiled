...
function sub_8508aa34(?) payable {
    ...
    return stor8000[stor8000[address(arg1)][arg2]].field_0, 
           stor8000[stor8000[address(arg1)][arg2]].field_0,
...
function sub_7d6b79e7(?) payable {
    ...
    if not ext_code.size(transferTokenAddress):
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = transfer(address arg1, uint256 arg2), stor8000[arg1].field_0, stor8000[arg1].field_0, stor8000[arg1].field_544
    call transferTokenAddress with:
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with transfer(address arg1, uint256 arg2), stor8000[arg1].field_0, stor8000[arg1].field_0, stor8000[arg1].field_512
        if not transfer(address arg1, uint256 arg2), stor8000[arg1].field_0:
            revert with 0, 32, 42, 0x215361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
    else:
        mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
