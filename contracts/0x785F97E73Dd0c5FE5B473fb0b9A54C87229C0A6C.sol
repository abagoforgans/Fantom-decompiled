    ...
    while idx < arg4.length:
        ...
        if not _354 % 32:
            ...
            if not _555 % 32:
                ...
                if not mem[_340 + ceil32(return_data.size)] % 32:
                    emit Log(string rg1):
                             32,
                             mem[_555 + _354 + _340 + (2 * ceil32(return_data.size)) + 96 len mem[_340 + ceil32(return_data.size)] + 32],
                else:
                    ...
                    emit Log(string rg1):
                             32,
                             mem[_555 + _354 + _340 + (2 * ceil32(return_data.size)) + 96 len floor32(mem[_340 + ceil32(return_data.size)]) + 64],
            else:
                ...
                if not mem[_340 + ceil32(return_data.size)] % 32:
                    emit Log(string rg1):
                             32,
                             mem[floor32(_555) + _354 + _340 + (2 * ceil32(return_data.size)) + 128 len mem[_340 + ceil32(return_data.size)] + 32],
                else:
                    ...
                    emit Log(string rg1):
                             32,
                             mem[floor32(_555) + _354 + _340 + (2 * ceil32(return_data.size)) + 128 len floor32(mem[_340 + ceil32(return_data.size)]) + 64],
            sub_8f7371e0++
            idx = idx + 1
            continue 
        ...
        if not _556 % 32:
            ...
            if not mem[_340 + ceil32(return_data.size)] % 32:
                emit Log(string rg1):
                         32,
                         mem[_556 + floor32(_354) + _340 + (2 * ceil32(return_data.size)) + 128 len mem[_340 + ceil32(return_data.size)] + 32],
            else:
                ...
                emit Log(string rg1):
                         32,
                         mem[_556 + floor32(_354) + _340 + (2 * ceil32(return_data.size)) + 128 len floor32(mem[_340 + ceil32(return_data.size)]) + 64],
        else:
            ...
            if not mem[_340 + ceil32(return_data.size)] % 32:
                emit Log(string rg1):
                         32,
                         mem[floor32(_556) + floor32(_354) + _340 + (2 * ceil32(return_data.size)) + 160 len mem[_340 + ceil32(return_data.size)] + 32],
            else:
                ...
                emit Log(string rg1):
                         32,
                         mem[floor32(_556) + floor32(_354) + _340 + (2 * ceil32(return_data.size)) + 160 len floor32(mem[_340 + ceil32(return_data.size)]) + 64],
        sub_8f7371e0++
        s = ceil32(_556) + 1
        continue 
}
