...
function sub_e61574b0(?) payable {
    ...
    mem[64] = ceil32(return_data.size) + 192
    require return_data.size >= 32
    _28 = mem[192 len 4], 232830643
    require mem[192 len 4], 232830643 <= test266151307()
    require mem[192 len 4], 232830643 + 223 < return_data.size + 192
    _29 = mem[mem[192 len 4], 232830643 + 192]
    if mem[mem[192 len 4], 232830643 + 192] > test266151307():
        revert with 0, 65
    if ceil32(32 * mem[mem[192 len 4], 232830643 + 192]) + 1 < 0 or ceil32(return_data.size) + ceil32(32 * mem[mem[192 len 4], 232830643 + 192]) + 193 > test266151307():
        revert with 0, 65
    ...
    mem[ceil32(return_data.size) + 224 len 32 * _29] = mem[_28 + 224 len 32 * _29]
    if 1 >= _29:
        revert with 0, 50
    _46 = mem[ceil32(return_data.size) + 256]
    mem[mem[64] + 68] = 4
    ...
    mem[64] = mem[64] + 96
    mem[_50] = mem[_49]
    mem[_50 + 32] = mem[_49 + 32]
    mem[_50 + 64] = mem[_49 + 64]
    if _46 and mem[_50] > -1 / _46:
        revert with 0, 17
    mem[mem[64]] = _46 * mem[_50] / 10^6
    return mem[mem[64]], 18
}
