                                ...
                                if totalSupply:
                                    if uint64(block.timestamp) < periodFinish:
                                        if not totalSupply:
                                            ...
                                            if not uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(block.timestamp - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128):
                                            else:
                                                ...
                                                if not sub_a0801fa6:
                                                    ...
                                                    if not userRewards[msg.sender].field_256:
                                                        if uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(block.timestamp - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128) < 0:
                                                            revert with 'NH{q', 17
                                                        else:
                                                            require ext_code.size(rewardTokenAddress)
                                                        ...
                                                        if uint64(block.timestamp) < userRewards[msg.sender].field_256:
                                                            ...
                                                            if uint64(uint64(block.timestamp) - userRewards[msg.sender].field_256) > claimLimit:
                                                                ...
                                                                call rewardTokenAddress.0xa9059cbb with:
                                                                     gas gas_remaining wei
                                                                    args 57005, (10000 * uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(block.timestamp - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) - (sub_a0801fa6 * uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(block.timestamp - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) / 10000
                                                                if not ext_call.success:
                                                                    revert with ext_call.return_data[0 len return_data.size]
                                                                else:
                                                                    require return_data.size >= 32
                                                                    ...
                                                                    if not ext_call.return_data[0]:
                                                                        ...
                                                                        if uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(block.timestamp - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128) < (10000 * uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(block.timestamp - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) - (sub_a0801fa6 * uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(block.timestamp - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) / 10000:
                                                                            revert with 'NH{q', 17
                                                                        else:
                                                                            require ext_code.size(rewardTokenAddress)
                                                                            call rewardTokenAddress.0xa9059cbb with:
                                                                                 gas gas_remaining wei
                                                                                args msg.sender, uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(block.timestamp - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128) - ((10000 * uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(block.timestamp - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) - (sub_a0801fa6 * uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(block.timestamp - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) / 10000)
                                                                            if not ext_call.success:
                                                                                revert with ext_call.return_data[0 len return_data.size]
                                                                            else:
                                                                                require return_data.size >= 32
                                        ...
                                        if not totalSupply:
                                            ...
                                            if not uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(periodFinish - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128):
                                            else:
                                                userRewards[msg.sender].field_0 = userRewards[msg.sender].field_0
                                                if not sub_a0801fa6:
                                                    ...
                                                    if not userRewards[msg.sender].field_256:
                                                        ...
                                                        if uint64(block.timestamp) < userRewards[msg.sender].field_256:
                                                            ...
                                                            if uint64(uint64(block.timestamp) - userRewards[msg.sender].field_256) > claimLimit:
                                                                ...
                                                                call rewardTokenAddress.0xa9059cbb with:
                                                                     gas gas_remaining wei
                                                                    args 57005, (10000 * uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(periodFinish - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) - (sub_a0801fa6 * uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(periodFinish - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) / 10000
                                                                if not ext_call.success:
                                                                    revert with ext_call.return_data[0 len return_data.size]
                                                                else:
                                                                    require return_data.size >= 32
                                                                    ...
                                                                    if not ext_call.return_data[0]:
                                                                        ...
                                                                        if uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(periodFinish - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128) < (10000 * uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(periodFinish - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) - (sub_a0801fa6 * uint128((balanceOf[address(msg.sender)] * uint128((10^18 * uint64(periodFinish - lastUpdateTime) * rewardRate / totalSupply) + rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) / 10000:
                                                                            revert with 'NH{q', 17
                                                                        else:
                                                                            require ext_code.size(rewardTokenAddress)
                                                                            call rewardTokenAddress.0xa9059cbb with:
                                    ...
                                    if not uint128((balanceOf[address(msg.sender)] * uint128(rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128):
                                    else:
                                        userRewards[msg.sender].field_0 = userRewards[msg.sender].field_0
                                        if not sub_a0801fa6:
                                            ...
                                            if not userRewards[msg.sender].field_256:
                                                ...
                                                if uint64(block.timestamp) < userRewards[msg.sender].field_256:
                                                    ...
                                                    if uint64(uint64(block.timestamp) - userRewards[msg.sender].field_256) > claimLimit:
                                                        ...
                                                        call rewardTokenAddress.0xa9059cbb with:
                                                             gas gas_remaining wei
                                                            args 57005, (10000 * uint128((balanceOf[address(msg.sender)] * uint128(rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) - (sub_a0801fa6 * uint128((balanceOf[address(msg.sender)] * uint128(rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) / 10000
                                                        if not ext_call.success:
                                                            revert with ext_call.return_data[0 len return_data.size]
                                                        else:
                                                            require return_data.size >= 32
                                                            ...
                                                            if not ext_call.return_data[0]:
                                                                ...
                                                                if uint128((balanceOf[address(msg.sender)] * uint128(rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128) < (10000 * uint128((balanceOf[address(msg.sender)] * uint128(rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) - (sub_a0801fa6 * uint128((balanceOf[address(msg.sender)] * uint128(rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) / 10000:
                                                                    revert with 'NH{q', 17
                                                                else:
                                                                    require ext_code.size(rewardTokenAddress)
                                                                    call rewardTokenAddress.0xa9059cbb with:
                                                                         gas gas_remaining wei
                                                                        args msg.sender, uint128((balanceOf[address(msg.sender)] * uint128(rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128) - ((10000 * uint128((balanceOf[address(msg.sender)] * uint128(rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) - (sub_a0801fa6 * uint128((balanceOf[address(msg.sender)] * uint128(rewardPerTokenStored - userRewards[address(msg.sender)].field_0) / 10^18) + userRewards[address(msg.sender)].field_128)) / 10000)
                                                                    if not ext_call.success:
                                                                        revert with ext_call.return_data[0 len return_data.size]
                                                                    else:
                                                                        require return_data.size >= 32
