...
#
const name = 'BabyDeath', 0

const decimals = 4

const symbol = 'BabyDeath', 0
...
function approveMax(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    allowance[address(msg.sender)][address(arg1)] = stor13
...
function airdrop(address arg1, address[] arg2, uint256[] arg3) payable {
    ...
    while idx < arg2.length:
        ...
        mem[64] = mem[64] + 64
        mem[_59] = 20
        mem[_59 + 32] = 'Insufficient Balance'
        mem[32] = 8
        ...
        if balanceOf[address(cd[((32 * idx) + arg2 + 36)])] > -cd[((32 * idx) + arg3 + 36)] - 1:
            revert with 'NH{q', 17
