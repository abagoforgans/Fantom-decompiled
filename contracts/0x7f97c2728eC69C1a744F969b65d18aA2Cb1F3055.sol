...
function sub_35c793ab(?) payable {
    ...
    return 32, 8994, code.data[7055 len 8930], mem[9058 len 30] >> 71184, address(arg1), address(arg2), 0 >> 71696, 0
}
...
function deploy(address arg1, address arg2) payable {
    ...
    if feeds[address(arg1)]:
        revert with 0, 'PE'
    mem[9216 len 8960] = code.data[7055 len 8930], mem[9058 len 30]
    mem[18146 len 64] = address(arg1), arg2
    mem[18242] = address(arg1)
    mem[18210] = 20
    create2 contract with 0 wei
                    salt: sha3(arg1)
                    code: mem[9216 len mem[9184]]
