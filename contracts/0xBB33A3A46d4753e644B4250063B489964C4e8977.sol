...
const pairCodeHash = sha3(code.data[3463 len 14815])

const INIT_CODE_PAIR_HASH = sha3(code.data[3463 len 14784], mem[29760 len 1], Mask(240, 8, code.data[18248 len 30]) >> 8)
