...
function setCanAdd(address arg1, bool arg2) payable {
    ...
    emit SetCanAdd(msg.sender, arg1, bool(uint8(arg2)));
}
...
function setCanOpen(address arg1, bool arg2) payable {
    ...
    emit SetCanOpen(msg.sender, arg1, bool(uint8(arg2)));
}
...
function setCanSubtract(address arg1, bool arg2) payable {
    ...
    emit SetCanSubtract(msg.sender, arg1, bool(uint8(arg2)));
}
...
function sub_16c4faa8(?) payable {
    ...
    if stor8[arg1[all]][arg2[all]]:
        return totalBalance[stor7[arg1[all]][arg2[all]]]
    else:
        return 0
}
...
function subtract(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if totalBalance[arg1] < arg3:
        revert with 0, 17
    totalBalance[arg1] -= arg3
...
function sub_2daf5799(?) payable {
    ...
    if totalBalance[stor7[arg1[all]][arg2[all]]] < arg4:
        revert with 0, 17
    totalBalance[stor7[arg1[all]][arg2[all]]] -= arg4
...
function sub_b48ffdb9(?) payable {
    ...
    if totalBalance[arg1] < arg4:
        revert with 0, 17
    totalBalance[arg1] -= arg4
...
function sub_5f2ecbb2(?) payable {
    ...
    if totalBalance[stor7[arg1[all]][arg2[all]]] < arg5:
        revert with 0, 17
    totalBalance[stor7[arg1[all]][arg2[all]]] -= arg5
...
function sub_ea4ee101(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return balance[stor7[arg1[all]][arg2[all]]][ext_call.return_data[0]]
}
...
function sub_d41ebce1(?) payable {
    ...
    if not stor8[call.data[cd[4] + 36 len ('cd', 4).length]][call.data[cd[36] + 36 len ('cd', 36).length]]:
        ...
        if totalTokens == -1:
            revert with 0, 17
        totalTokens++
        emit Open(msg.sender, totalTokens);
}
