...
function enter() payable {
    ...
    if stor11 >= sub_f23f3ba5:
        ...
        if ext_call.return_data[0] < ext_call.return_data[0] / 20:
            revert with 'NH{q', 17
        ...
        mem[(2 * ceil32(return_data.size)) + (32 * players.length) + 228] = ext_call.return_data[0] - (ext_call.return_data[0] / 20)
        require ext_code.size(sub_b1b0c49eAddress)
        ...
        mem[(4 * ceil32(return_data.size)) + (32 * players.length) + 228] = ext_call.return_data[0] / 20
        require ext_code.size(sub_b1b0c49eAddress)
        call sub_b1b0c49eAddress.0xa9059cbb with:
             gas gas_remaining wei
