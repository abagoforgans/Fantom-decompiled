...
address sub_4ca01d45Address;

function totalSupply() payable {
    return totalSupply
}

function sub_4ca01d45(?) payable {
    return sub_4ca01d45Address
}
...
function sub_4853772d(?) payable {
    require ext_code.size(sub_4ca01d45Address)
    staticcall sub_4ca01d45Address.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function leave(uint256 arg1) payable {
    ...
    if not totalSupply:
        revert with 'NH{q', 18
    if arg1 and ext_call.return_data[0] / totalSupply > -1 / arg1:
        revert with 'NH{q', 17
    if arg1 and ext_call.return_data[0] / totalSupply > -1 / arg1:
        revert with 'NH{q', 17
    if not msg.sender:
    ...
    require ext_code.size(sub_4ca01d45Address)
    call sub_4ca01d45Address.0xa9059cbb with:
         gas gas_remaining wei
        args msg.sender, arg1 * ext_call.return_data[0] / totalSupply
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function enter(uint256 arg1) payable {
    ...
    if not uint8(stor8.field_160):
        revert with 0, 'staking has not yet begun'
    require ext_code.size(soulAddress)
    staticcall soulAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    if not uint255(ext_call.return_data[0]):
        if arg1 and 1 > -1 / arg1:
            revert with 'NH{q', 17
        require ext_code.size(sub_4ca01d45Address)
        call sub_4ca01d45Address.0x23b872dd with:
             gas gas_remaining wei
        ...
        if not 2 * ext_call.return_data[0]:
            revert with 'NH{q', 18
        if arg1 and totalSupply / 2 * ext_call.return_data[0] > -1 / arg1:
            revert with 'NH{q', 17
        require ext_code.size(sub_4ca01d45Address)
        call sub_4ca01d45Address.0x23b872dd with:
             gas gas_remaining wei
        ...
        if not msg.sender:
            revert with 0, 'ERC20: mint to the zero address'
        if totalSupply > (-1 * arg1 * totalSupply / 2 * ext_call.return_data[0]) - 1:
            revert with 'NH{q', 17
        totalSupply += arg1 * totalSupply / 2 * ext_call.return_data[0]
        if balanceOf[address(msg.sender)] > (-1 * arg1 * totalSupply / 2 * ext_call.return_data[0]) - 1:
            revert with 'NH{q', 17
