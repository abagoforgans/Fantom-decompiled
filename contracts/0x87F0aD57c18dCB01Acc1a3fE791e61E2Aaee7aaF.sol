...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    require return_data.size >= 32
    if ext_call.return_data[0] > mem[_96]:
        revert with 0, 'SafeMath: subtraction overflow'
    mem[mem[64] + 4] = this.address
    require ext_code.size(address(cd[(arg5 + 164)]))
    staticcall address(cd[(arg5 + 164)]).0x70a08231 with:
    ...
    mem[64] = mem[64] + 96
    require 0 < mem[_114]
    mem[_114 + 32] = address(cd[(arg5 + 164)])
    require 1 < mem[_114]
    mem[_114 + 64] = address(cd[(arg5 + 132)])
    mem[_114 + 100] = this.address
    require ext_code.size(address(cd[(arg5 + 132)]))
    staticcall address(cd[(arg5 + 132)]).0x70a08231 with:
            gas gas_remaining wei
           args this.address
    mem[_114 + 96] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[64] = _114 + ceil32(return_data.size) + 96
    require return_data.size >= 32
    mem[_114 + ceil32(return_data.size) + 96] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
    mem[_114 + ceil32(return_data.size) + 100] = _113
    mem[_114 + ceil32(return_data.size) + 132] = cd[(arg5 + 36)]
    mem[_114 + ceil32(return_data.size) + 164] = 160
    mem[_114 + ceil32(return_data.size) + 260] = mem[_114]
    idx = 0
    s = _114 + ceil32(return_data.size) + 292
    t = _114 + 32
    while idx < mem[_114]:
        mem[s] = mem[t + 12 len 20]
        idx = idx + 1
    ...
    call address(cd[(arg5 + 100)]).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args _113, cd[(arg5 + 36)], 160, address(this.address), block.timestamp, mem[_114 + ceil32(return_data.size) + 260 len (32 * mem[_114]) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(cd[(arg5 + 132)]))
    staticcall address(cd[(arg5 + 132)]).0x70a08231 with:
