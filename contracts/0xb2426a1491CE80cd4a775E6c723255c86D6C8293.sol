...
function burn(uint256 arg1) payable {
    ...
    if arg1 > MAX_TOTAL_SUPPLY:
        revert with 0, 32, 36, 0x654275726e20616d6f756e742065786365656473206d617820746f74616c20737570706c, mem[164 len 28] >> 32, 0
    MAX_TOTAL_SUPPLY -= arg1
...
function init(address arg1, address arg2) payable {
    ...
    stor7[arg2] = 1
    sub_32adb9a5.length++
    sub_32adb9a5[sub_32adb9a5.length] = arg2
    if not msg.sender:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply > 0xfffffffffffffffffffffffffffffffffffffffffffff5697e9c0f5a84bfffff:
        revert with 0, 17
    if totalSupply + 50000 * 10^18 > MAX_TOTAL_SUPPLY:
        revert with 0, 'Max total supply exceeded'
    if not msg.sender:
        if 50000 * 10^18 > MAX_TOTAL_SUPPLY:
            revert with 0, 32, 36, 0x654275726e20616d6f756e742065786365656473206d617820746f74616c20737570706c, mem[164 len 28] >> 32, 0
        MAX_TOTAL_SUPPLY -= 50000 * 10^18
    if totalSupply > 0xfffffffffffffffffffffffffffffffffffffffffffff5697e9c0f5a84bfffff:
        revert with 0, 17
