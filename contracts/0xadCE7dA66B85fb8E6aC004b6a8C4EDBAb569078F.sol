...
function getSwapRatio() {
    if block.timestamp <= startTime + 300:
        return 100
    if not (block.timestamp + -startTime - 300 / 600) + 1:
        return 100
    if (30 * block.timestamp + -startTime - 300 / 600) + 30 / (block.timestamp + -startTime - 300 / 600) + 1 != 30:
        revert with 0, 'SafeMath: multiplication overflow'
    return ((30 * block.timestamp + -startTime - 300 / 600) + 130)
}
    ...
    if block.timestamp <= startTime + 300:
        ...
        if not (block.timestamp + -startTime - 300 / 600) + 1:
            ...
            if not ext_call.return_data[0]:
                mem[ceil32(return_data.size) + 160] = 26
                mem[ceil32(return_data.size) + 192] = 'SafeMath: division by zero'
                if not (30 * block.timestamp + -startTime - 300 / 600) + 130:
                ...
                call sub_040c30daAddress.0x40c10f19 with:
                     gas gas_remaining wei
                    args msg.sender, 0 / (30 * block.timestamp + -startTime - 300 / 600) + 130
            else:
                if 100 * ext_call.return_data[0] / ext_call.return_data[0] != 100:
                    revert with 0, 'SafeMath: multiplication overflow'
                mem[ceil32(return_data.size) + 160] = 26
                ...
                call sub_040c30daAddress.0x40c10f19 with:
                     gas gas_remaining wei
                    args msg.sender, 100 * ext_call.return_data[0] / (30 * block.timestamp + -startTime - 300 / 600) + 130
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
