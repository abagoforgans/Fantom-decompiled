...
function updateBalance() payable {
    require ext_code.size(iTokenAddress)
    call iTokenAddress.balanceOfUnderlying(address arg1) with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(iTokenAddress)
    call iTokenAddress.borrowBalanceCurrent(address arg1) with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] - reserves > 0:
        if ext_call.return_data[0] - reserves >= minLeverage:
            ...
            while idx < borrowDepth:
                require ext_code.size(iTokenAddress)
                call iTokenAddress.0xa0712d68 with:
                     gas gas_remaining wei
                    args s
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if not s:
                    mem[100] = 0
                    require ext_code.size(iTokenAddress)
                    call iTokenAddress.borrow(uint256 arg1) with:
                         gas gas_remaining wei
                        args 0
                    mem[96] = ext_call.return_data[0]
                    if not ext_call.success:
...
function deleverageOnce(uint256 arg1) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(iTokenAddress)
    call iTokenAddress.repayBorrow(uint256 arg1) with:
         gas gas_remaining wei
    ...
    if not ext_call.return_data[0]:
        ...
        if 0 / arg1 > ext_call.return_data[0]:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(iTokenAddress)
        call iTokenAddress.redeemUnderlying(uint256 arg1) with:
             gas gas_remaining wei
...
function retireStrat() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(iTokenAddress)
    staticcall iTokenAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(iTokenAddress)
    call iTokenAddress.redeem(uint256 arg1) with:
         gas gas_remaining wei
        args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
            ...
            if tx.origin == owner:
                ...
                if stor0:
                    ...
                    if not ext_call.return_data[0] - reserves:
                        ...
                        if ext_code.size(wantAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, ext_call.return_data[0] - reserves - ((ext_call.return_data[0] * WITHDRAW_FEE) - (reserves * WITHDRAW_FEE) / 10000)) >> 32
                        mem[352 len 4] = 0
                        call wantAddress with:
                           funct uint32(stor4)
                             gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if stor0:
                    ...
                    if not arg1:
                        ...
                        if ext_code.size(wantAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / 10000)) >> 32
                        mem[352 len 4] = 0
                        mem[324 len 0] = 0
                        call wantAddress with:
                           funct uint32(stor4)
                             gas gas_remaining wei
                            args Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / 10000)) << 224, mem[324 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), arg1 - (arg1 * WITHDRAW_FEE / 10000)
                            if not unknown_0xa9059cbb(?????), Mask(224, 0, stor4):
                                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
            ...
            if tx.origin == owner:
                ...
                if stor0:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        if ext_code.size(wantAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = 0, address(vaultAddress), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / 10000)) >> 32
                        mem[352 len 4] = 0
                        call wantAddress with:
                           funct uint32(stor4)
                             gas gas_remaining wei
                            args ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / 10000), mem[196 len 28], mem[324 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with unknown_0xa9059cbb(?????), 
                                            address(vaultAddress),
                                            ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / 10000)
                            if not 0, Mask(224, 0, stor4):
                                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
            ...
            if tx.origin == owner:
                ...
                if stor0:
                    ...
                    if not arg1:
                        ...
                        if ext_code.size(wantAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = 0, address(vaultAddress), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / 10000)) >> 32
                        mem[352 len 4] = 0
                        call wantAddress with:
                           funct uint32(stor4)
                             gas gas_remaining wei
                            args arg1 - (arg1 * WITHDRAW_FEE / 10000), mem[196 len 28], mem[324 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with unknown_0xa9059cbb(?????), address(vaultAddress), arg1 - (arg1 * WITHDRAW_FEE / 10000)
                            if not 0, Mask(224, 0, stor4):
                                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
