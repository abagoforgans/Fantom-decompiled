...
function currentPupURI() {
    ...
    if not s:
        ...
        _241 = mem[64]
        mem[64] = mem[96] + mem[64] + 129
        mem[mem[96] + _107 + 129] = 32
        mem[mem[96] + _107 + 161] = mem[_241]
        _249 = mem[_241]
        mem[mem[96] + _107 + 193 len ceil32(mem[_241])] = mem[_241 + 32 len ceil32(mem[_241])]
        if not _249 % 32:
            return memory
              from mem[64]
               len _249 + mem[96] + _107 + -mem[64] + 193
        mem[floor32(_249) + mem[96] + _107 + 193] = mem[floor32(_249) + mem[96] + _107 + -(_249 % 32) + 225 len _249 % 32]
        return memory
          from mem[64]
           len floor32(_249) + mem[96] + _107 + -mem[64] + 225
    mem[128 len s] = code.data[13578 len s]
    t = s
    idx = stor17
    while idx:
        require t - 1 < mem[96]
    ...
    _245 = mem[64]
    mem[64] = mem[96] + mem[64] + 129
    mem[mem[96] + _109 + 129] = 32
    mem[mem[96] + _109 + 161] = mem[_245]
    _252 = mem[_245]
    mem[mem[96] + _109 + 193 len ceil32(mem[_245])] = mem[_245 + 32 len ceil32(mem[_245])]
    if not _252 % 32:
        return memory
          from mem[64]
           len _252 + mem[96] + _109 + -mem[64] + 193
    mem[floor32(_252) + mem[96] + _109 + 193] = mem[floor32(_252) + mem[96] + _109 + -(_252 % 32) + 225 len _252 % 32]
    return memory
      from mem[64]
       len floor32(_252) + mem[96] + _109 + -mem[64] + 225
}
...
function deposit(address arg1, bool arg2) payable {
    ...
    if arg2:
            ...
            if not stor17:
                ...
                if not t:
                    ...
                    while s >= 32:
                        ...
                        s = s - 32
                        continue 
                    mem[mem[64] + floor32(mem[_256]) + 124] = mem[_256 + floor32(mem[_256]) + -(mem[_256] % 32) + 64 len mem[_256] % 32] or Mask(8 * -(mem[_256] % 32) + 32, -(8 * -(mem[_256] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_256]) + 124])
                    _710 = mem[_452]
                    t = _452 + 32
                    u = _590 + mem[64] + 124
                    s = mem[_452]
                    ...
                    mem[_256 + 32 len t] = code.data[13578 len t]
                    u = t
                    s = stor17
                    while s:
                        require u - 1 < mem[_256]
        ...
        if msg.value >= sub_74cfaceb:
            ...
            if not stor17:
                mem[384 len 64] = 0x6e68747470733a2f2f676174657761792e70696e6174612e636c6f75642f697066732f516d56754d64467359354548547946575872474a5858637a765a613955
                mem[452 len 28] = 0x3958646b696d6b546e555a62562f70757070795f64617461, mem[284 len 4]
                mem[476 len 0] = None
                mem[476 len 31] = Mask(248, 0, 0, mem[480 len 27])
                mem[477 len 0] = None
