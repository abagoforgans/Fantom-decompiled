...
array of uint256 addressToName;
...
function addressToName(address arg1) payable {
    return addressToName[arg1][0 len addressToName[arg1].length]
}
...
function nameToAddress(string arg1) payable {
...
function add(string arg1, address arg2) payable {
    ...
    addressToName[address(arg2)][] = Array(len=arg1.length, data=arg1[all])
