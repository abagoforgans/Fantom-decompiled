...
function deploy(address[] arg1, uint8[] arg2, string arg3, string arg4, uint256 arg5, uint256 arg6, uint256 arg7, address arg8, address arg9) payable {
    ...
    mem[(64 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + ceil32(arg4.length) + (32 * mem[(32 * arg1.length) + 128]) + 612 len ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + 160])] = mem[(32 * arg1.length) + (32 * arg2.length) + 192 len ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + 160])]
    if ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + 160]) > mem[(32 * arg1.length) + (32 * arg2.length) + 160]:
        mem[(64 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + ceil32(arg4.length) + (32 * mem[(32 * arg1.length) + 128]) + mem[(32 * arg1.length) + (32 * arg2.length) + 160] + 612] = 0
    mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + ceil32(arg4.length) + 324] = ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + 160]) + (32 * arg1.length) + (32 * mem[(32 * arg1.length) + 128]) + 384
    mem[ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + 160]) + (64 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + ceil32(arg4.length) + (32 * mem[(32 * arg1.length) + 128]) + 612] = mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + 192]
    mem[ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + 160]) + (64 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + ceil32(arg4.length) + (32 * mem[(32 * arg1.length) + 128]) + 644 len ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + 192])] = mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + 224 len ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + 192])]
    if ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + 192]) > mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + 192]:
        mem[ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + 160]) + (64 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + ceil32(arg4.length) + (32 * mem[(32 * arg1.length) + 128]) + mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + 192] + 644] = 0
    ...
    call address(create.new_address).mem[mem[64] len 4] with:
        ...
        args mem[mem[64] + 4 len ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + 192]) + ceil32(mem[(32 * arg1.length) + (32 * arg2.length) + 160]) + (64 * arg1.length) + (32 * arg2.length) + ceil32(arg3.length) + ceil32(arg4.length) + (32 * mem[(32 * arg1.length) + 128]) + -mem[64] + 640]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(create.new_address))
    staticcall address(create.new_address).swapStorage() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(address(create.new_address))
    call address(create.new_address).initialize(address arg1, address arg2, address arg3) with:
         gas gas_remaining wei
