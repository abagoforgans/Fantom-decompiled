...
function earn(uint256 arg1) {
    ...
    while idx < arg1:
        ...
        if not ext_call.return_data[0]:
            ...
            if (-10 * ext_call.return_data[0]) + (ext_call.return_data[32] * ext_call.return_data[0]) / ext_call.return_data[0] != ext_call.return_data[32] - 10:
