        ...
        if ext_call.return_data[0]:
            if block.timestamp <= bonusEndTime:
                ...
                if not ext_call.return_data[0]:
                    revert with 0, 18
                if poolInfo[arg1].field_768 > !(10000 * 10^18 * (block.timestamp * rewardPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * rewardPerSecond * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
                    revert with 0, 17
                ...
                if poolInfo[arg1].field_512 >= bonusEndTime:
                    ...
                    if not ext_call.return_data[0]:
                        revert with 0, 18
                    if poolInfo[arg1].field_768 > !(10000 * 10^18 * 0 / totalAllocPoint / ext_call.return_data[0]):
                        revert with 0, 17
                    ...
                    if not ext_call.return_data[0]:
                        revert with 0, 18
                    if poolInfo[arg1].field_768 > !(10000 * 10^18 * (bonusEndTime * rewardPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * rewardPerSecond * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
                        revert with 0, 17
        ...
        if block.timestamp > poolInfo[idx].field_512:
            ...
            if mem[_9]:
                if block.timestamp <= bonusEndTime:
                    ...
                    if not mem[_9]:
                        revert with 0, 18
                    if poolInfo[idx].field_768 > !(10000 * 10^18 * (block.timestamp * rewardPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * rewardPerSecond * poolInfo[idx].field_256) / totalAllocPoint / mem[_9]):
                        revert with 0, 17
                    ...
                    if poolInfo[idx].field_512 >= bonusEndTime:
                        ...
                        if not mem[_9]:
                            revert with 0, 18
                        if poolInfo[idx].field_768 > !(10000 * 10^18 * 0 / totalAllocPoint / mem[_9]):
                            revert with 0, 17
                        ...
                        if not mem[_9]:
                            revert with 0, 18
                        if poolInfo[idx].field_768 > !(10000 * 10^18 * (bonusEndTime * rewardPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * rewardPerSecond * poolInfo[idx].field_256) / totalAllocPoint / mem[_9]):
                            revert with 0, 17
...
function pendingReward(address arg1) payable {
    ...
    if block.timestamp <= bonusEndTime:
        ...
        if not ext_call.return_data[0]:
            revert with 0, 18
        if uint256(poolInfo.field_768) > !(10000 * 10^18 * (block.timestamp * rewardPerSecond * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * rewardPerSecond * uint256(poolInfo.field_256)) / totalAllocPoint / ext_call.return_data[0]):
            revert with 0, 17
    ...
    if uint256(poolInfo.field_512) >= bonusEndTime:
        ...
        if not ext_call.return_data[0]:
            revert with 0, 18
        if uint256(poolInfo.field_768) > !(10000 * 10^18 * 0 / totalAllocPoint / ext_call.return_data[0]):
            revert with 0, 17
    ...
    if not ext_call.return_data[0]:
        revert with 0, 18
    if uint256(poolInfo.field_768) > !(10000 * 10^18 * (bonusEndTime * rewardPerSecond * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * rewardPerSecond * uint256(poolInfo.field_256)) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 17
