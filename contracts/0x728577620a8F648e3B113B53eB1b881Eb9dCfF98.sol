...
function sub_f4350fc8(?) payable {
    ...
    if not sub_c7b2c2d1.length:
        ...
        require return_data.size >= 32
        _24 = mem[96 len 4], ext_call.return_data[0 len 28]
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[(32 * _27) + ceil32(return_data.size) + 164] = address(owner)
        mem[(32 * _27) + ceil32(return_data.size) + 196] = ext_call.return_data[0]
        mem[(32 * _27) + ceil32(return_data.size) + 128] = 68
        mem[(32 * _27) + ceil32(return_data.size) + 164 len 28] = Mask(224, 0, stor2)
        mem[(32 * _27) + ceil32(return_data.size) + 160 len 4] = transfer(address arg1, uint256 arg2)
        mem[(32 * _27) + ceil32(return_data.size) + 228] = 32
        mem[(32 * _27) + ceil32(return_data.size) + 260] = 'SafeERC20: low-level call failed'
        if eth.balance(this.address) < 0:
            revert with 0, 
                        32,
                        38,
                        0x8d416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c,
                        mem[(32 * _27) + ceil32(return_data.size) + 398 len 26]
        if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
            revert with 0, 'Address: call to non-contract'
        mem[(32 * _27) + ceil32(return_data.size) + 292 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len 28]
        mem[(32 * _27) + ceil32(return_data.size) + 384 len 4] = 0
        mem[(32 * _27) + ceil32(return_data.size) + 356 len 0] = 0
        call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83 with:
           funct uint32(stor2)
             gas gas_remaining wei
            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _27) + ceil32(return_data.size) + 356 len 4]
        if not return_data.size:
            if not ext_call.success:
            ...
            if mem[96 len 4], ext_call.return_data[0 len 28]:
                ...
                if not ext_call.return_data[28 len 4], 0:
                    revert with 0, 
                                ...
                                42,
                                0x645361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                mem[(32 * _27) + ceil32(return_data.size) + 402 len 22]
        else:
            mem[(32 * _27) + ceil32(return_data.size) + 324 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size:
                    revert with ext_call.return_data[0 len return_data.size]
                revert with 0, 'SafeERC20: low-level call failed'
            if return_data.size:
                require return_data.size >= 32
                if not mem[(32 * _27) + ceil32(return_data.size) + 324]:
                    revert with 0, 
                                32,
                                42,
                                0x645361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                mem[(32 * _27) + ceil32(return_data.size) + ceil32(return_data.size) + 403 len 22]
    else:
        mem[0] = 1
        mem[292] = address(sub_c7b2c2d1.field_0)
        idx = 292
        ...
        mem[64] = ceil32(return_data.size) + 96
        require return_data.size >= 32
        _129 = mem[96 len 4], ext_call.return_data[0 len 28]
        require mem[96 len 4], ext_call.return_data[0 len 28] <= 4294967296
        require mem[96 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
        require mem[mem[96 len 4], ext_call.return_data[0 len 28] + 96] <= 4294967296 and mem[96 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[96 len 4], ext_call.return_data[0 len 28] + 96]) + 32 <= return_data.size
        mem[ceil32(return_data.size) + 96] = mem[mem[96 len 4], ext_call.return_data[0 len 28] + 96]
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[(32 * _142) + ceil32(return_data.size) + 164] = address(owner)
        ...
        mem[(32 * _142) + ceil32(return_data.size) + 160 len 4] = transfer(address arg1, uint256 arg2)
        ...
        if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
            revert with 0, 'Address: call to non-contract'
        mem[(32 * _142) + ceil32(return_data.size) + 292 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len 28]
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0]
                if not transfer(address arg1, uint256 arg2), Mask(224, 32, msg.sender) >> 32:
                    revert with 0, 32, 42, 0x645361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[698 len 22]
            else:
