...
function sub_2fa400e8(?) payable {
    ...
    call stor1.length.0xe2386573 with:
    ...
    while idx < arg3.length:
        ...
        if not _64 % 32:
            ...
            call stor1.length.mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _64 + _62 + -mem[64] + 288]
            if not ext_call.success:
                mem[mem[64]] = 32
                mem[mem[64] + 32] = 20
                ...
                require return_data.size >= 32
                _122 = mem[_119]
                require mem[_119] <= 4294967296
                require mem[_119] + 32 <= return_data.size
                require mem[mem[_119] + _119] <= 4294967296 and mem[_119] + mem[mem[_119] + _119] + 32 <= return_data.size
                mem[_119 + ceil32(return_data.size)] = mem[mem[_119] + _119]
                _130 = mem[_122 + _119]
                s = 0
                while s < _130:
                    mem[_119 + ceil32(return_data.size) + s + 32] = mem[_122 + _119 + s + 32]
                    s = s + 32
                    continue 
                if not _130 % 32:
                    mem[64] = _130 + _119 + ceil32(return_data.size) + 32
                    mem[_130 + _119 + ceil32(return_data.size) + 32] = 32
                    mem[_130 + _119 + ceil32(return_data.size) + 64] = mem[_119 + ceil32(return_data.size)]
                    s = 0
                    while s < mem[_119 + ceil32(return_data.size)]:
                        mem[_130 + _119 + ceil32(return_data.size) + s + 96] = mem[_119 + ceil32(return_data.size) + s + 32]
                        s = s + 32
                        continue 
                    if not mem[_119 + ceil32(return_data.size)] % 32:
                        emit Log(mem[mem[64] len mem[_119 + ceil32(return_data.size)] + _130 + _119 + ceil32(return_data.size) + -mem[64] + 96]);
                    else:
                        mem[floor32(mem[_119 + ceil32(return_data.size)]) + _130 + _119 + ceil32(return_data.size) + 96] = mem[floor32(mem[_119 + ceil32(return_data.size)]) + _130 + _119 + ceil32(return_data.size) + -(mem[_119 + ceil32(return_data.size)] % 32) + 128 len mem[_119 + ceil32(return_data.size)] % 32]
                        emit Log(mem[mem[64] len floor32(mem[_119 + ceil32(return_data.size)]) + _130 + _119 + ceil32(return_data.size) + -mem[64] + 128]);
                else:
                    mem[floor32(_130) + _119 + ceil32(return_data.size) + 32] = mem[floor32(_130) + _119 + ceil32(return_data.size) + -(_130 % 32) + 64 len _130 % 32]
                    mem[64] = floor32(_130) + _119 + ceil32(return_data.size) + 64
                    mem[floor32(_130) + _119 + ceil32(return_data.size) + 64] = 32
                    mem[floor32(_130) + _119 + ceil32(return_data.size) + 96] = mem[_119 + ceil32(return_data.size)]
                    s = 0
                    while s < mem[_119 + ceil32(return_data.size)]:
                        mem[floor32(_130) + _119 + ceil32(return_data.size) + s + 128] = mem[_119 + ceil32(return_data.size) + s + 32]
                        s = s + 32
                        continue 
                    if not mem[_119 + ceil32(return_data.size)] % 32:
                        emit Log(mem[mem[64] len mem[_119 + ceil32(return_data.size)] + floor32(_130) + _119 + ceil32(return_data.size) + -mem[64] + 128]);
                    else:
                        mem[floor32(mem[_119 + ceil32(return_data.size)]) + floor32(_130) + _119 + ceil32(return_data.size) + 128] = mem[floor32(mem[_119 + ceil32(return_data.size)]) + floor32(_130) + _119 + ceil32(return_data.size) + -(mem[_119 + ceil32(return_data.size)] % 32) + 160 len mem[_119 + ceil32(return_data.size)] % 32]
                        emit Log(mem[mem[64] len floor32(mem[_119 + ceil32(return_data.size)]) + floor32(_130) + _119 + ceil32(return_data.size) + -mem[64] + 160]);
                sub_8f7371e0++
        else:
            mem[floor32(_64) + _62 + 292] = mem[floor32(_64) + _62 + -(_64 % 32) + 324 len _64 % 32]
            require ext_code.size(stor1.length)
            call stor1.length.mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len floor32(_64) + _62 + -mem[64] + 320]
            if not ext_call.success:
                mem[mem[64]] = 32
                mem[mem[64] + 32] = 20
                mem[mem[64] + 64] = 'external call failed'
                ...
                require return_data.size >= 32
                _127 = mem[_124]
                require mem[_124] <= 4294967296
                require mem[_124] + 32 <= return_data.size
                require mem[mem[_124] + _124] <= 4294967296 and mem[_124] + mem[mem[_124] + _124] + 32 <= return_data.size
                mem[_124 + ceil32(return_data.size)] = mem[mem[_124] + _124]
                _132 = mem[_127 + _124]
                s = 0
                while s < _132:
                    mem[_124 + ceil32(return_data.size) + s + 32] = mem[_127 + _124 + s + 32]
                    s = s + 32
                    continue 
                if not _132 % 32:
                    mem[64] = _132 + _124 + ceil32(return_data.size) + 32
                    mem[_132 + _124 + ceil32(return_data.size) + 32] = 32
                    mem[_132 + _124 + ceil32(return_data.size) + 64] = mem[_124 + ceil32(return_data.size)]
                    s = 0
                    while s < mem[_124 + ceil32(return_data.size)]:
                        mem[_132 + _124 + ceil32(return_data.size) + s + 96] = mem[_124 + ceil32(return_data.size) + s + 32]
                        s = s + 32
                        continue 
                    if not mem[_124 + ceil32(return_data.size)] % 32:
                        emit Log(mem[mem[64] len mem[_124 + ceil32(return_data.size)] + _132 + _124 + ceil32(return_data.size) + -mem[64] + 96]);
                    else:
                        mem[floor32(mem[_124 + ceil32(return_data.size)]) + _132 + _124 + ceil32(return_data.size) + 96] = mem[floor32(mem[_124 + ceil32(return_data.size)]) + _132 + _124 + ceil32(return_data.size) + -(mem[_124 + ceil32(return_data.size)] % 32) + 128 len mem[_124 + ceil32(return_data.size)] % 32]
                        emit Log(mem[mem[64] len floor32(mem[_124 + ceil32(return_data.size)]) + _132 + _124 + ceil32(return_data.size) + -mem[64] + 128]);
                else:
                    mem[floor32(_132) + _124 + ceil32(return_data.size) + 32] = mem[floor32(_132) + _124 + ceil32(return_data.size) + -(_132 % 32) + 64 len _132 % 32]
                    mem[64] = floor32(_132) + _124 + ceil32(return_data.size) + 64
                    mem[floor32(_132) + _124 + ceil32(return_data.size) + 64] = 32
                    mem[floor32(_132) + _124 + ceil32(return_data.size) + 96] = mem[_124 + ceil32(return_data.size)]
                    s = 0
                    while s < mem[_124 + ceil32(return_data.size)]:
                        mem[floor32(_132) + _124 + ceil32(return_data.size) + s + 128] = mem[_124 + ceil32(return_data.size) + s + 32]
                        s = s + 32
                        continue 
                    if not mem[_124 + ceil32(return_data.size)] % 32:
                        emit Log(mem[mem[64] len mem[_124 + ceil32(return_data.size)] + floor32(_132) + _124 + ceil32(return_data.size) + -mem[64] + 128]);
                    else:
                        mem[floor32(mem[_124 + ceil32(return_data.size)]) + floor32(_132) + _124 + ceil32(return_data.size) + 128] = mem[floor32(mem[_124 + ceil32(return_data.size)]) + floor32(_132) + _124 + ceil32(return_data.size) + -(mem[_124 + ceil32(return_data.size)] % 32) + 160 len mem[_124 + ceil32(return_data.size)] % 32]
                        emit Log(mem[mem[64] len floor32(mem[_124 + ceil32(return_data.size)]) + floor32(_132) + _124 + ceil32(return_data.size) + -mem[64] + 160]);
                sub_8f7371e0++
        idx = idx + 1
        continue 
}
            ...
            if not ext_call.success:
                ...
                if not _158 % 32:
                    ...
                    if not mem[_152 + ceil32(return_data.size)] % 32:
                        emit Log(string rg1):
                                 32,
                                 mem[_158 + _152 + ceil32(return_data.size) + 64 len mem[_152 + ceil32(return_data.size)] + 32],
                    else:
                        ...
                        emit Log(Array(len=mem[_152 + ceil32(return_data.size)], data=mem[_158 + _152 + ceil32(return_data.size) + 96 len floor32(mem[_152 + ceil32(return_data.size)]) + 32]));
                else:
                    ...
                    if not mem[_152 + ceil32(return_data.size)] % 32:
                        emit Log(string rg1):
                                 32,
                                 mem[floor32(_158) + _152 + ceil32(return_data.size) + 96 len mem[_152 + ceil32(return_data.size)] + 32],
                    else:
                        ...
                        emit Log(Array(len=mem[_152 + ceil32(return_data.size)], data=mem[floor32(_158) + _152 + ceil32(return_data.size) + 128 len floor32(mem[_152 + ceil32(return_data.size)]) + 32]));
                sub_8f7371e0++
        idx = idx + 1
        continue 
}
