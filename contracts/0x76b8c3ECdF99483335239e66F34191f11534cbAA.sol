            ...
            if userInfo[arg1][address(msg.sender)] * ext_call.return_data[0] / ext_call.return_data[0] <= 0:
                ...
                if ext_call.return_data[0] <= userInfo[arg1][address(msg.sender)]:
                    ...
                    if ext_call.return_data[0] >= userInfo[arg1][address(msg.sender)] * ext_call.return_data[0] / ext_call.return_data[0]:
                        mem[388 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, userInfo[arg1][address(msg.sender)] * ext_call.return_data[0] / ext_call.return_data[0]) >> 32
                        call poolInfo[arg1].field_0 with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                    ...
                    if ext_code.size(poolInfo[arg1].field_0) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    if ext_call.return_data[0] >= userInfo[arg1][address(msg.sender)] * ext_call.return_data[0] / ext_call.return_data[0]:
                        mem[324 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, userInfo[arg1][address(msg.sender)] * ext_call.return_data[0] / ext_call.return_data[0]) >> 32
                        call poolInfo[arg1].field_0 with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
