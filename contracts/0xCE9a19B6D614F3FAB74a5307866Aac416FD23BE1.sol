    ...
    if arg1.length - 1 >= arg1.length:
        ...
        if mem[(32 * arg1.length - 1) + (32 * arg1.length) + 172 len 20] != ext_call.return_data[12 len 20]:
            ...
            if not (32 * arg3.length) + (32 * arg2.length) + (32 * arg1.length) + 256 % 32:
                ...
                call address(_256).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
...
function pancakeCall(address arg1, uint256 arg2, uint256 arg3, bytes arg4) {
    ...
    if cd[(arg4 + 132)] >= cd[(arg4 + cd[(arg4 + 36)] + 36)]:
        ...
        staticcall address(_245).token0() with:
                gas gas_remaining wei
               args mem[(64 * cd[(arg4 + cd[(arg4 + 100)] + 36)]) + (64 * cd[(arg4 + cd[(arg4 + 68)] + 36)]) + (64 * cd[(arg4 + cd[(arg4 + 36)] + 36)]) + 484 len (95 * cd[(arg4 + cd[(arg4 + 100)] + 36)]) + (95 * cd[(arg4 + cd[(arg4 + 68)] + 36)]) + (95 * cd[(arg4 + cd[(arg4 + 36)] + 36)])]
...
function sub_3aa99232(?) {
    ...
    if ('cd', 100)[3] >= cd[(cd[100] + ('cd', 100)[0] + 36)]:
        ...
        staticcall address(_245).token0() with:
                gas gas_remaining wei
               args mem[(64 * cd[(cd[100] + ('cd', 100)[2] + 36)]) + (64 * cd[(cd[100] + ('cd', 100)[1] + 36)]) + (64 * cd[(cd[100] + ('cd', 100)[0] + 36)]) + 484 len (95 * cd[(cd[100] + ('cd', 100)[2] + 36)]) + (95 * cd[(cd[100] + ('cd', 100)[1] + 36)]) + (95 * cd[(cd[100] + ('cd', 100)[0] + 36)])]
