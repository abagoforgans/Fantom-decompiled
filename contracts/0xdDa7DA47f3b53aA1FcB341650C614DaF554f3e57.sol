...
function enter(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(bscxAddress)
    staticcall bscxAddress.0x70a08231 with:
    ...
    require ext_code.size(bscxAddress)
    call bscxAddress.0x23b872dd with:
         gas gas_remaining wei
    ...
    if not arg1:
        ...
        if not 0 / totalSupply:
            ...
            if 0 > 0 / totalSupply:
                revert with 0, 'SafeMath: subtraction overflow'
            require ext_code.size(bscxAddress)
            call bscxAddress.0xa9059cbb with:
                 gas gas_remaining wei
                args msg.sender, 0 / totalSupply
        else:
            require 0 / totalSupply
            if 0 / totalSupply * FEE / 0 / totalSupply != FEE:
            ...
            totalSupply -= arg1
            emit Transfer(arg1, msg.sender, 0);
            if 0 / totalSupply * FEE / 1000 > 0 / totalSupply:
                revert with 0, 'SafeMath: subtraction overflow'
            require ext_code.size(bscxAddress)
            call bscxAddress.0xa9059cbb with:
                 gas gas_remaining wei
                args msg.sender, (0 / totalSupply) - (0 / totalSupply * FEE / 1000)
    else:
        require arg1
        ...
        if not arg1 * ext_call.return_data[0] / totalSupply:
            ...
            if arg1 * ext_call.return_data[0] / totalSupply * FEE / arg1 * ext_call.return_data[0] / totalSupply != FEE:
                revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
            if not msg.sender:
                revert with 0, 32, 33, 0x6545524332303a206275726e2066726f6d20746865207a65726f20616464726573, mem[325 len 31]
            if arg1 > balanceOf[address(msg.sender)]:
            ...
            totalSupply -= arg1
            emit Transfer(arg1, msg.sender, 0);
            if arg1 * ext_call.return_data[0] / totalSupply * FEE / 1000 > arg1 * ext_call.return_data[0] / totalSupply:
                revert with 0, 'SafeMath: subtraction overflow'
            require ext_code.size(bscxAddress)
            call bscxAddress.0xa9059cbb with:
                 gas gas_remaining wei
                args msg.sender, (arg1 * ext_call.return_data[0] / totalSupply) - (arg1 * ext_call.return_data[0] / totalSupply * FEE / 1000)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
