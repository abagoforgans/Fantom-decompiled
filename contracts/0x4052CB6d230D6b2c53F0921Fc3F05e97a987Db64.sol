...
function sub_5821ed0d(?) {
    ...
    if not ext_call.return_data[0]:
        ...
        call sub_f6c6e5e8Address.0xab4e4c24 with:
             gas gas_remaining wei
            args (ext_call.return_data[0] * ext_call.return_data[0]) + eth.balance(msg.sender) / 2 / ext_call.return_data[0], (ext_call.return_data[0] * ext_call.return_data[0]) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0] * ext_call.return_data[0] / 10000, mem[(6 * ceil32(return_data.size)) + 228 len 64], address(this.address), block.timestamp + 60
        if not ext_call.success:
            revert with 0, 'swap tomb'
        require ext_code.size(sub_dbd33e45Address)
        call sub_dbd33e45Address.balanceOf(address arg1) with:
             gas gas_remaining wei
            args this.address
