...
function offers(address arg1, uint256 arg2, address arg3) payable {
    require calldata.size - 4 >= 96
...
function updatePlatformFee(uint16 arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'wOwnable: caller is not the owne'
    platformFee = arg1
...
function updatePlatformFeeRecipient(address arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'wOwnable: caller is not the owne'
...
function cancelOffer(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
...
function cancelListing(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    if stor101 == 2:
...
function validateItemSold(address arg1, uint256 arg2, address arg3, address arg4) payable {
...
function updateListing(address arg1, uint256 arg2, address arg3, uint256 arg4) payable {
    require calldata.size - 4 >= 128
    if stor101 == 2:
        revert with 0, 32, 31, 0xfe5265656e7472616e637947756172643a207265656e7472616e742063616c6c
    stor101 = 2
...
function sub_42cbb4b8(?) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_call.return_data[0]:
            revert with 0, 'invalid nft address'
    require ext_code.size(sub_f3ad65f4Address)
    staticcall sub_f3ad65f4Address.auction() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).auctions(address arg1, uint256 arg2) with:
            gas gas_remaining wei
    ...
    if ext_call.return_data[96]:
        if bool(ext_call.return_data[160]) != 1:
            revert with 0, 
                        32,
                        44,
                        0x63616e6e6f7420706c61636520616e206f666665722069662061756374696f6e20697320676f696e67206f,
                        ext_call.return_data[112 len 20]
...
function listItem(address arg1, uint256 arg2, uint256 arg3, address arg4, uint256 arg5, uint256 arg6) payable {
    require calldata.size - 4 >= 192
...
function registerCollectionRoyalty(address arg1, address arg2, uint16 arg3, address arg4) payable {
    require calldata.size - 4 >= 128
    if owner != msg.sender:
        revert with 0, 'wOwnable: caller is not the owne'
    if not arg2:
    ...
    if ext_call.return_data[12 len 20] == arg1:
        revert with 0, 'invalid nft address'
    require ext_code.size(sub_f3ad65f4Address)
    staticcall sub_f3ad65f4Address.factory() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_call.return_data[0]:
        revert with 0, 'invalid nft address'
    require ext_code.size(sub_f3ad65f4Address)
    staticcall sub_f3ad65f4Address.privateFactory() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_call.return_data[0]:
        revert with 0, 'invalid nft address'
    require ext_code.size(sub_f3ad65f4Address)
    staticcall sub_f3ad65f4Address.artFactory() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_call.return_data[0]:
        revert with 0, 'invalid nft address'
    require ext_code.size(sub_f3ad65f4Address)
    staticcall sub_f3ad65f4Address.privateArtFactory() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function registerRoyalty(address arg1, uint256 arg2, uint16 arg3) payable {
    require calldata.size - 4 >= 96
    if arg3 > 10000:
        revert with 0, 'invalid royalty'
    require ext_code.size(sub_f3ad65f4Address)
