...
function sub_f360506c(?) payable {
    ...
    if ext_call.return_data[12 len 20] == 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83:
        if ext_call.return_data[12 len 20] != 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83:
            ...
            if not Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[0])):
                revert with 0, 18
            return Mask(112, 0, Mask(112, 0, 1000 * Mask(112, 0, ext_call.return_data[0])) / Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[0])))
        ...
        if not Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[32])):
            revert with 0, 18
        return Mask(112, 0, Mask(112, 0, 1000 * Mask(112, 0, ext_call.return_data[0])) / Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[32])))
    if ext_call.return_data[12 len 20] == 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83:
        if Mask(112, 0, ext_call.return_data[32]) > 5192296858534827628530:
            revert with 0, 17
        if not Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[32])):
            revert with 0, 18
        return Mask(112, 0, Mask(112, 0, 1000 * Mask(112, 0, ext_call.return_data[32])) / Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[32])))
    if Mask(112, 0, ext_call.return_data[0]) > 5192296858534827628530:
        revert with 0, 17
    if Mask(112, 0, ext_call.return_data[32]) > 0x4189374bc6a7ef9db22d0e5604:
        revert with 0, 17
    if not Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[0])):
        revert with 0, 18
    return Mask(112, 0, Mask(112, 0, 1000 * Mask(112, 0, ext_call.return_data[32])) / Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[0])))
}
