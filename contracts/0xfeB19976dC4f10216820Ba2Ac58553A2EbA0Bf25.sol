...
function getSwapRatio() {
    if block.timestamp <= startTime + (120 * 24 * 3600):
        return 100
    if not block.timestamp + -startTime - (120 * 24 * 3600) / 720 * 24 * 3600:
        return 100
    if 30 * block.timestamp + -startTime - (120 * 24 * 3600) / 720 * 24 * 3600 / block.timestamp + -startTime - (120 * 24 * 3600) / 720 * 24 * 3600 != 30:
        revert with 0, 'SafeMath: multiplication overflow'
    if (30 * block.timestamp + -startTime - (120 * 24 * 3600) / 720 * 24 * 3600) + 100 < 30 * block.timestamp + -startTime - (120 * 24 * 3600) / 720 * 24 * 3600:
        revert with 0, 'SafeMath: addition overflow'
    return ((30 * block.timestamp + -startTime - (120 * 24 * 3600) / 720 * 24 * 3600) + 100)
}
    ...
    if block.timestamp <= startTime + (120 * 24 * 3600):
        ...
        if not block.timestamp + -startTime - (120 * 24 * 3600) / 720 * 24 * 3600:
            if not ext_call.return_data[0]:
                ...
                if not ext_code.hash(sub_56603732Address):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 420 len 128] = unknown_0x23b872dd(?????), msg.sender, 57005, ext_call.return_data[0], 0
            ...
            if not ext_call.return_data[0]:
                mem[ceil32(return_data.size) + 160] = 26
                mem[ceil32(return_data.size) + 192] = 'SafeMath: division by zero'
                if not (30 * block.timestamp + -startTime - (120 * 24 * 3600) / 720 * 24 * 3600) + 100:
                ...
                call sub_040c30daAddress.mint(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
                    args msg.sender, 0 / (30 * block.timestamp + -startTime - (120 * 24 * 3600) / 720 * 24 * 3600) + 100
            else:
                if 100 * ext_call.return_data[0] / ext_call.return_data[0] != 100:
                    revert with 0, 'SafeMath: multiplication overflow'
                mem[ceil32(return_data.size) + 160] = 26
                ...
                call sub_040c30daAddress.mint(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
                    args msg.sender, 100 * ext_call.return_data[0] / (30 * block.timestamp + -startTime - (120 * 24 * 3600) / 720 * 24 * 3600) + 100
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
