...
function pancakeCall(address arg1, uint256 arg2, uint256 arg3, bytes arg4) payable {
    ...
    call mem[(32 * cd[(arg4 + cd[(arg4 + 36)] + 36)]) + 172 len 20].transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function sub_3aa99232(?) payable {
    ...
    call mem[(32 * cd[(cd[100] + ('cd', 100)[0] + 36)]) + 172 len 20].transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args mem[140 len 20], _10
