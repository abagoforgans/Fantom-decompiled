...
function sub_cfdbb7cd(?) {
    ...
    if not sub_96c7ee46[address(arg1)][arg2].field_0:
        return bool(sub_96c7ee46[address(arg1)][arg2].field_0)
...
function sub_670322f8(?) {
    ...
    if sub_96c7ee46[address(arg1)][arg2].field_512:
        if sub_96c7ee46[address(arg1)][arg2].field_0:
...
function sub_d12514b7(?) {
    require calldata.size - 4 >= 96
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if not Mask(1, 7, validator[arg2].field_0):
        revert with 0, 'validator isn't slashed'
    if arg3 > 1457100266114788805830000:
        revert with 0, 'amount is too high'
    require ext_code.size(stor102)
    call stor102.incBalance(address arg1, uint256 arg2) with:
    ...
    emit 0x172fdfaf: arg3, arg1, arg2
}
