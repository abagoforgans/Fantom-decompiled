...
function name() payable {
    ...
    if ceil32(_5) <= _5:
        ...
        if ceil32(_5) <= _5:
            ...
            mem[_5 + _39 + 37] = 32
            _77 = mem[_71]
            mem[_5 + _39 + 69] = mem[_71]
            mem[_5 + _39 + 101 len ceil32(_77)] = mem[_71 + 32 len ceil32(_77)]
            if ceil32(_77) > _77:
                mem[_5 + _39 + _77 + 101] = 0
            return 32, mem[_5 + _39 + 69 len ceil32(_77) + 32]
        mem[mem[64] + _5 + 37] = 0
        _74 = mem[64]
        mem[64] = _5 + _39 + 37
        mem[_5 + _39 + 37] = 32
        _81 = mem[_74]
        mem[_5 + _39 + 69] = mem[_74]
        mem[_5 + _39 + 101 len ceil32(_81)] = mem[_74 + 32 len ceil32(_81)]
        if ceil32(_81) > _81:
            mem[_5 + _39 + _81 + 101] = 0
        return 32, mem[_5 + _39 + 69 len ceil32(_81) + 32]
    ...
    if ceil32(_5) <= _5:
        ...
        mem[_5 + _41 + 37] = 32
        _79 = mem[_72]
        mem[_5 + _41 + 69] = mem[_72]
        mem[_5 + _41 + 101 len ceil32(_79)] = mem[_72 + 32 len ceil32(_79)]
        if ceil32(_79) > _79:
            mem[_5 + _41 + _79 + 101] = 0
        return 32, mem[_5 + _41 + 69 len ceil32(_79) + 32]
    mem[mem[64] + _5 + 37] = 0
    _76 = mem[64]
    mem[64] = _5 + _41 + 37
    mem[_5 + _41 + 37] = 32
    _82 = mem[_76]
    mem[_5 + _41 + 69] = mem[_76]
    mem[_5 + _41 + 101 len ceil32(_82)] = mem[_76 + 32 len ceil32(_82)]
    if ceil32(_82) > _82:
        mem[_5 + _41 + _82 + 101] = 0
    return 32, mem[_5 + _41 + 69 len ceil32(_82) + 32]
}
...
function tendTrigger(uint256 arg1) payable {
    ...
    if not mem[(32 * _65 - 1) + ceil32(return_data.size) + 224]:
        ...
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        if 10^12 * mem[(32 * _65 - 1) + ceil32(return_data.size) + 224]:
            if 1000000000000 * 10^18 * mem[(32 * _65 - 1) + ceil32(return_data.size) + 224] / 10^12 * mem[(32 * _65 - 1) + ceil32(return_data.size) + 224] != 10^18:
                revert with 0, 'SafeMath: multiplication overflow'
        if not mem[_134]:
            revert with 0, 'SafeMath: division by zero', 0
    return 0
...
function ethToWant(uint256 arg1) payable {
    ...
    mem[64] = mem[64] + ceil32(return_data.size)
    require return_data.size >= 32
    if not 10^12 * mem[(32 * _65 - 1) + ceil32(return_data.size) + 224]:
        if not mem[_134]:
            revert with 0, 'SafeMath: division by zero', 0
        return (0 / mem[_134])
    if 1000000000000 * 10^18 * mem[(32 * _65 - 1) + ceil32(return_data.size) + 224] / 10^12 * mem[(32 * _65 - 1) + ceil32(return_data.size) + 224] != 10^18:
    ...
    if not mem[_134]:
        revert with 0, 'SafeMath: division by zero', 0
    return (1000000000000 * 10^18 * mem[(32 * _65 - 1) + ceil32(return_data.size) + 224] / mem[_134])
}
...
function harvestTrigger(uint256 arg1) payable {
    ...
    if not mem[(32 * _323 - 1) + ceil32(return_data.size) + 224]:
        ...
        require return_data.size >= 32
        _652 = mem[_650]
        if not 10^12 * mem[(32 * _323 - 1) + ceil32(return_data.size) + 224]:
            _655 = mem[64]
            mem[64] = mem[64] + 64
            mem[_655] = 26
            ...
            if 1000000000000 * 10^18 * mem[(32 * _323 - 1) + ceil32(return_data.size) + 224] / 10^12 * mem[(32 * _323 - 1) + ceil32(return_data.size) + 224] != 10^18:
                revert with 0, 'SafeMath: multiplication overflow'
            _659 = mem[64]
            mem[64] = mem[64] + 64
            mem[_659] = 26
