...
function sub_d0192354(?) payable {
    ...
    require return_data.size >= 32
    _48 = mem[224 len 4], Mask(224, 32, arg2) >> 32
    ...
    call stor4.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
         gas gas_remaining wei
        args stor1, stor3, arg2, mem[ceil32(return_data.size) + 320], arg2, mem[ceil32(return_data.size) + 320], address(this.address), block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
