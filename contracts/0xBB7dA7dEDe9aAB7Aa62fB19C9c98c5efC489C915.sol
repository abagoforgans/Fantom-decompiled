...
function sub_129fa7e8(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_0:
        revert with 0, 
                    32,
                    42,
    ...
    if stor2 / arg4 <= 0:
        revert with 0, 'SafeMath: division by zero'
    require stor2 / arg4
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_0 = 1
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_8 = 1
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]][1][].field_0 = Array(len=arg5.length, data=arg5[all])
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_512 = arg3
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_768 = arg2
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_1024 = arg4
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_1280 = block.timestamp
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_1536 = block.timestamp
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_1792 = stor2 / arg4
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_2048 = stor2 / arg4
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_2304 = arg2 - block.timestamp / stor2 / arg4
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_2560 = arg3 / stor2 / arg4
    sub_84a0b485[address(msg.sender)][stor8[address(msg.sender)]].field_2816 = arg1
...
function unlockToken(uint256 arg1) {
    ...
    if block.timestamp - sub_84a0b485[address(msg.sender)][arg1].field_1536 / sub_84a0b485[address(msg.sender)][arg1].field_2304 < sub_84a0b485[address(msg.sender)][arg1].field_2048:
        if not sub_84a0b485[address(msg.sender)][arg1].field_2560:
            ...
            require ext_code.size(sub_84a0b485[address(msg.sender)][arg1].field_2816)
            call sub_84a0b485[address(msg.sender)][arg1].field_2816.0xa9059cbb with:
                 gas gas_remaining wei
                args msg.sender, 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
