...
function setStrategy(address arg1) payable {
    ...
    call strategyAddress.0x853828b6 with:
...
function withdraw(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(strategyAddress)
    staticcall strategyAddress.0xad7a672f with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if not ext_call.return_data[0]:
        ...
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 0 / totalSupply) >> 32
        mem[352 len 4] = 0
        mem[324 len 0] = 0
        call wantAddress with:
           funct uint32(msg.sender)
             gas gas_remaining wei
            args Mask(224, 32, 0 / totalSupply) << 224, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with unknown_0xa9059cbb(?????), msg.sender, 0 / totalSupply
            if not unknown_0xa9059cbb(?????), Mask(224, 32, msg.sender) >> 32:
                revert with 0, 32, 42, 0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if not msg.sender:
                revert with 0, 32, 33, 0x6545524332303a206275726e2066726f6d20746865207a65726f20616464726573, mem[361 len 31]
            if arg1 > balanceOf[address(msg.sender)]:
                revert with 0, 
                            ...
                            mem[326 len 26],
                            0,
                            Mask(16, -256, 0x7345524332303a206275726e20616d6f756e7420657863656564732062616c616e63, mem[326 len 26], 0) << 256
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size:
        ...
        call strategyAddress.0x2e1a7d4d with:
             gas gas_remaining wei
            args (arg1 * ext_call.return_data[0] / totalSupply)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if eth.balance(this.address) < 0:
            revert with 0, 32, 38, 0x65416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[366 len 26]
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1 * ext_call.return_data[0] / totalSupply) >> 32
        mem[352 len 4] = 0
        mem[324 len 0] = 0
        call wantAddress with:
           funct uint32(msg.sender)
             gas gas_remaining wei
            args Mask(224, 32, arg1 * ext_call.return_data[0] / totalSupply) << 224, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with unknown_0xa9059cbb(?????), msg.sender, arg1 * ext_call.return_data[0] / totalSupply
            if not unknown_0xa9059cbb(?????), Mask(224, 32, msg.sender) >> 32:
                revert with 0, 32, 42, 0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if not msg.sender:
                revert with 0, 32, 33, 0x6545524332303a206275726e2066726f6d20746865207a65726f20616464726573, mem[361 len 31]
        ...
        totalSupply -= arg1
        emit Transfer(arg1, msg.sender, 0);
        emit Withdraw(arg1, arg1 * ext_call.return_data[0] / totalSupply, msg.sender);
}
...
function withdrawAll() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if balanceOf[address(msg.sender)] > balanceOf[address(msg.sender)]:
                revert with 0, 
                            ...
                            mem[ceil32(return_data.size) + 327 len 30],
                            mem[ceil32(return_data.size) + 387 len 2]
        ('le', ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'balanceOf', 0))), ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'balanceOf', 0))))
        balanceOf[address(msg.sender)] = 0
        if balanceOf[address(msg.sender)] > totalSupply:
            revert with 0, 'SafeMath: subtraction overflow'
        totalSupply -= balanceOf[address(msg.sender)]
        emit Transfer(balanceOf[address(msg.sender)], msg.sender, 0);
        emit Withdraw(balanceOf[address(msg.sender)], 0 / totalSupply, msg.sender);
    else:
        ...
        call strategyAddress.0x2e1a7d4d with:
             gas gas_remaining wei
            args (balanceOf[address(msg.sender)] * ext_call.return_data[0] / totalSupply)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if eth.balance(this.address) < 0:
            revert with 0, 32, 38, 0x65416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[366 len 26]
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, balanceOf[address(msg.sender)] * ext_call.return_data[0] / totalSupply) >> 32
        mem[352 len 4] = 0
        mem[324 len 0] = 0
        call wantAddress with:
           funct uint32(msg.sender)
             gas gas_remaining wei
            args Mask(224, 32, balanceOf[address(msg.sender)] * ext_call.return_data[0] / totalSupply) << 224, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with unknown_0xa9059cbb(?????), msg.sender, balanceOf[address(msg.sender)] * ext_call.return_data[0] / totalSupply
            if not unknown_0xa9059cbb(?????), Mask(224, 32, msg.sender) >> 32:
                revert with 0, 32, 42, 0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if not msg.sender:
                revert with 0, 32, 33, 0x6545524332303a206275726e2066726f6d20746865207a65726f20616464726573, mem[361 len 31]
        ...
        totalSupply -= balanceOf[address(msg.sender)]
        emit Transfer(balanceOf[address(msg.sender)], msg.sender, 0);
        emit Withdraw(balanceOf[address(msg.sender)], balanceOf[address(msg.sender)] * ext_call.return_data[0] / totalSupply, msg.sender);
}
    ...
    if not return_data.size:
        ...
        if totalSupply <= 0:
            ...
            if not totalSupply:
                ...
                if not msg.sender:
                    revert with 0, 'ERC20: mint to the zero address'
                if (arg1 * totalSupply / ext_call.return_data[0]) + totalSupply < totalSupply:
                    revert with 0, 'SafeMath: addition overflow'
                totalSupply += arg1 * totalSupply / ext_call.return_data[0]
                if (arg1 * totalSupply / ext_call.return_data[0]) + balanceOf[address(msg.sender)] < balanceOf[address(msg.sender)]:
                    revert with 0, 'SafeMath: addition overflow'
