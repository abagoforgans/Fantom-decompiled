...
address owner;
uint256 stor8;
mapping of address sub_480eb287;
...
function sub_480eb287(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return sub_480eb287[arg1]
}
...
function royaltyInfo(uint256 arg1, uint256 arg2) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    if arg2 and 250 > -1 / arg2:
        revert with 'NH{q', 17
    return sub_480eb287[arg1], 250 * arg2 / 10000
}
...
function supportsInterface(bytes4 arg1) payable {
    ...
    if Mask(32, 224, arg1) == *U Z:
        return True
    if Mask(32, 224, arg1) == 0xc87b56dd00000000000000000000000000000000000000000000000000000000:
        return True
    if Mask(32, 224, arg1) == 0x42966c6800000000000000000000000000000000000000000000000000000000:
        return True
    if Mask(32, 224, arg1) == 0x80ac58cd00000000000000000000000000000000000000000000000000000000:
        return True
    if Mask(32, 224, arg1) == 0x5b5e139f00000000000000000000000000000000000000000000000000000000:
    ...
    if stor6[stor8].field_0:
        ...
        if arg2.length:
            ...
            while stor6[stor8].field_1 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
    sub_480eb287[stor8] = 0x23c0d2461f83374150e008cfb3a016491f6424a1
}
