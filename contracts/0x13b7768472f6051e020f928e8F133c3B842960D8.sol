...
function sub_103d9908(?) payable {
    ...
    if stor[mem[arg1.length + 160 len ceil32(arg1.length)]][Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0)] == stor0:
        revert with 0, 
                    32,
                    37,
    ...
    staticcall stor[mem[arg1.length + 160 len ceil32(arg1.length)]][Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0)].0xc45a0155 with:
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require uint8(10^uint8(ext_call.return_data[0]))
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).0x313ce567 with:
            gas gas_remaining wei
    if not ext_call.success:
    ...
    require uint8(10^uint8(ext_call.return_data[0]))
    return 0, 
           Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) / uint8(10^uint8(ext_call.return_data[0]))),
           Mask(112, 0, ext_call.return_data[32]) / uint8(10^uint8(ext_call.return_data[0])) << 248,
