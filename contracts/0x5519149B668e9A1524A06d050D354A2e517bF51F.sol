        ...
        if not nFTBalance[arg1].field_256:
                ...
                if not nFTBalance[arg1].field_256 / 100:
                    ...
                    if not nFTBalance[arg1].field_256 / 100:
                        ...
                        call stakingAddress.0x42966c68 with:
                             gas gas_remaining wei
                            args Mask(224, 32, arg1) >> 32, mem[708 len 4]
                        if bool(ext_call.success) != 1:
                            revert with 0, 'mint call failed'
                        require ext_code.size(sub_96effb75Address)
                        call sub_96effb75Address.0xa9059cbb with:
                        ...
                        call sub_96effb75Address.0xa9059cbb with:
                             gas gas_remaining wei
                            args 57005, 5 * nFTBalance[arg1].field_256 / 100 / 2
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_code.size(sub_96effb75Address)
                        call sub_96effb75Address.0xa9059cbb with:
                             gas gas_remaining wei
                            args rewardPoolAddress, 5 * nFTBalance[arg1].field_256 / 100 / 2
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        sub_1bf53cf3 += 5 * nFTBalance[arg1].field_256 / 100 / 2
                else:
            ...
            if not nFTBalance[arg1].field_256 / 100:
                if not nFTBalance[arg1].field_256 / 100:
                    ...
                    if 95 * nFTBalance[arg1].field_256 / 100 / nFTBalance[arg1].field_256 / 100 != 95:
                        revert with 0, 32, 33, 0xbf536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
                    if (sub_157cf2e8 * nFTBalance[arg1].field_256 / 10^18) - nFTBalance[arg1].field_768 + (95 * nFTBalance[arg1].field_256 / 100) < 95 * nFTBalance[arg1].field_256 / 100:
                        revert with 0, 'SafeMath: addition overflow'
                    if not nFTBalance[arg1].field_256 / 100:
                        nFTBalance[arg1].field_256 = 0
                        nFTBalance[arg1].field_512 = 0
                        ...
                        call sub_96effb75Address.0xa9059cbb with:
                             gas gas_remaining wei
                            args msg.sender, (sub_157cf2e8 * nFTBalance[arg1].field_256 / 10^18) - nFTBalance[arg1].field_768 + (95 * nFTBalance[arg1].field_256 / 100)
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_code.size(sub_96effb75Address)
                ...
                if not nFTBalance[arg1].field_256 / 100:
                    if not nFTBalance[arg1].field_256 / 100:
                        ...
                        if not nFTBalance[arg1].field_256 / 100:
                            ...
                            call stakingAddress.0x42966c68 with:
                                 gas gas_remaining wei
                                args Mask(224, 32, arg1) >> 32, mem[964 len 4]
                            if bool(ext_call.success) != 1:
                                revert with 0, 'mint call failed'
                            require ext_code.size(sub_96effb75Address)
                            call sub_96effb75Address.0xa9059cbb with:
