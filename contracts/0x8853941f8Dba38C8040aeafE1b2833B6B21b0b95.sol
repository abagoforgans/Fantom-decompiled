...
function sub_e44e7936(?) {
    ...
    mem[(2 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0] - prizePool, 0
    mem[(2 * ceil32(return_data.size)) + 328] = 0
    call sub_439cf6ddAddress with:
       funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0] - prizePool, 0) >> 224
         gas gas_remaining wei
        args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0] - prizePool, 0) << 288)
