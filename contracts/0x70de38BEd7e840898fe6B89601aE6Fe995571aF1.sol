    ...
    while idx < ('cd', 100).length:
        if ext_call.return_data[0] >= cd[68]:
            ...
            call address(cd[4]).safeTransferFrom(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) with:
                 gas gas_remaining wei
                args address(this.address), address(cd[132]), cd[36], ext_call.return_data[0], 160, 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        if idx >= mem[96]:
            revert with 'NH{q', 50
        ...
        if mem[_71]:
            ...
            if idx >= mem[96]:
                revert with 'NH{q', 50
            if mem[_79] >= cd[68] - ext_call.return_data[0]:
                _82 = mem[(32 * idx) + 128]
                mem[mem[64]] = 0xf242432a00000000000000000000000000000000000000000000000000000000
                mem[mem[64] + 4] = address(_82)
                mem[mem[64] + 36] = this.address
                mem[mem[64] + 68] = cd[36]
                mem[mem[64] + 100] = cd[68] - ext_call.return_data[0]
                mem[mem[64] + 132] = 160
                mem[mem[64] + 164] = 0
                require ext_code.size(address(cd[4]))
                call address(cd[4]).safeTransferFrom(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) with:
                     gas gas_remaining wei
                    args address(_82), address(this.address), cd[36], cd[68] - ext_call.return_data[0], 160, 0
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if ext_call.return_data[0] > -cd[68] + ext_call.return_data[0] - 1:
                    revert with 'NH{q', 17
            else:
                _85 = mem[(32 * idx) + 128]
                mem[mem[64]] = 0xf242432a00000000000000000000000000000000000000000000000000000000
