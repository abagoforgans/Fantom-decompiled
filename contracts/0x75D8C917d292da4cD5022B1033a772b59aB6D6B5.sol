...
const pairCodeHash = sha3(code.data[2437 len 11352])

const INIT_CODE_PAIR_HASH = sha3(code.data[2437 len 11328], mem[22848 len 8], Mask(128, 64, code.data[13773 len 16]) >> 64)
