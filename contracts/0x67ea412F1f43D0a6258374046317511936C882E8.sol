...
function stakedSupply(uint16 arg1) payable {
    ...
    if not poolElevation[arg1 << 240]:
        ...
        if 4 == poolElevation[arg1 << 240]:
            require ext_code.size(stor13)
            staticcall stor13.supply(uint16 arg1) with:
                    gas gas_remaining wei
                   args arg1
        else:
            require ext_code.size(stor12)
...
function enable() payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(stor11)
    call stor11.enable(uint256 arg1) with:
         gas gas_remaining wei
        args launchTimestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(stor13)
    call stor13.enable(uint256 arg1) with:
         gas gas_remaining wei
        args launchTimestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function redeemRewards(address arg1, uint256 arg2) payable {
    ...
    require ext_code.size(summitAddress)
    staticcall summitAddress.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if arg2 <= ext_call.return_data[0]:
        call summitAddress.transfer(address arg1, uint256 arg2) with:
             gas gas_remaining wei
...
function switchTotem(uint8 arg1, uint8 arg2) payable {
    ...
    if not arg1:
        ...
        if 4 == arg1:
            require ext_code.size(stor13)
            call stor13.switchTotem(uint8 arg1, uint8 arg2, address arg3) with:
                 gas gas_remaining wei
                args arg1 << 248, arg2 << 248, msg.sender
        else:
            require ext_code.size(stor12)
...
function userTotem(uint8 arg1, address arg2) payable {
    ...
    if not arg1:
        ...
        if 4 == arg1:
            require ext_code.size(stor13)
            staticcall stor13.isTotemInUse(uint8 arg1, address arg2) with:
                    gas gas_remaining wei
                   args arg1 << 248, arg2
        else:
            require ext_code.size(stor12)
...
function initialize(address arg1, address arg2, address arg3, address arg4, address arg5, address arg6, address arg7) payable {
    ...
    call arg6.initialize(address arg1, address arg2, address arg3) with:
         gas gas_remaining wei
        args stor9, address(arg1), arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(stor13)
    call stor13.initialize(address arg1, address arg2, address arg3) with:
         gas gas_remaining wei
        args stor9, address(arg1), arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not enabled:
        ...
        if not sub_38deefb0[address(arg1)].field_256:
            ...
            if sub_38deefb0[address(arg1)].field_0 != arg2:
                ...
                require return_data.size >= 32
                require ext_code.size(sub_38deefb0[address(arg1)].field_0)
                call sub_38deefb0[address(arg1)].field_0.enact() with:
                     gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
...
function elevate(uint16 arg1, uint16 arg2, uint256 arg3, address arg4, uint8 arg5) payable {
    ...
    if arg5 >= ext_call.return_data[31 len 1]:
        revert with 0, 'Invalid totem'
    if poolElevation[poolElevation[arg2 << 240]] > 4:
        revert with 0, 'Invalid elev'
