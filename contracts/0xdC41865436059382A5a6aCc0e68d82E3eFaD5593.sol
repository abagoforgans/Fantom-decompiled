...
function createTransferUnwrapRequest(uint256 arg1, bytes32 arg2) payable {
    ...
    require ext_code.size(0x7e11b85e08d1a574f4d92845611fc65996174585)
    delegate 0x7e11b85e08d1a574f4d92845611fc65996174585.0xa506d954 with:
         gas gas_remaining wei
...
function attachValue(bytes arg1) payable {
    ...
    while idx < arg1.length:
        if u != 0:
            ...
            mem[mem[64] + 36] = 0
            require ext_code.size(0x7e11b85e08d1a574f4d92845611fc65996174585)
            delegate 0x7e11b85e08d1a574f4d92845611fc65996174585.0x9d6ad84b with:
                 gas gas_remaining wei
                args 4, 0
            if not delegate.return_code:
                revert with ext_call.return_data[0 len return_data.size]
