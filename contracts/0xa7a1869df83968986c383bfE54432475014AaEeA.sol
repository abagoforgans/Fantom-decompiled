...
function sendValueToSubInt(int64 arg1, uint256 arg2, bytes32 arg3) {
    ...
    call subscriptions[arg3].field_256.attachValue(int64 arg1) with:
...
function subscribe(address arg1, uint8 arg2, uint256 arg3) {
    ...
    require ext_code.size(0xc0d67e4e22a7f3e6e122fd4be58e5cc9ab6bde8)
    delegate 0xc0d67e4e22a7f3e6e122fd4be58e5cc9ab6bde8.0xa506d954 with:
         gas gas_remaining wei
...
function sendValueToSubByte(bytes arg1, uint256 arg2, bytes32 arg3) {
    ...
    stor20[arg2][arg3] = 1
    require ext_code.size(subscriptions[arg3].field_256)
    call subscriptions[arg3].field_256.attachValue(bytes arg1) with:
         gas gas_remaining wei
        args Array(len=arg1.length, data=arg1[all])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
