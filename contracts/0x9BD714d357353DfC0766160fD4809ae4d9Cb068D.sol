...
function sub_5f6eb012(?) payable {
    ...
    if arg1.length:
        stor8[arg2][] = Array(len=arg1.length, data=arg1[all])
    else:
        stor8[arg2] = 0
        idx = 0
...
function createNew() payable {
    require msg.sender
    require this.address != msg.sender
    require ext_code.size(sub_5d33a1f4Address)
    staticcall sub_5d33a1f4Address.allowance(address rg1, address rg2) with:
    ...
    if stor3[stor11]:
        ...
        mem[128 len 79] = 0x6e68747470733a2f2f6368617274736261636b75702e7a6f6f636f696e2e636173682f6170692f6e6674732f38623436376162632d613132342d346430642d626564342d3333393965636563663739
        if not stor3[stor11]:
        ...
        stor3[stor11] = tokenByIndex.length
        emit Transfer(0, msg.sender, stor11);
        mem[192 len 79] = 0x6e68747470733a2f2f6368617274736261636b75702e7a6f6f636f696e2e636173682f6170692f6e6674732f38623436376162632d613132342d346430642d626564342d3333393965636563663739
        if not stor3[stor11]:
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if tokenByIndex[stor3[arg3] - 1].field_256 != arg1:
        revert with 0, 32, 41, 0x364552433732313a207472616e73666572206f6620746f6b656e2074686174206973206e6f74206f77, mem[397 len 23]
    if not arg2:
...
function safeTransferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if msg.sender == tokenByIndex[stor3[arg3] - 1].field_256:
        ...
        require stor3[arg3] - 1 < tokenByIndex.length
        if tokenByIndex[stor3[arg3] - 1].field_256 != arg1:
            revert with 0, 32, 41, 0x364552433732313a207472616e73666572206f6620746f6b656e2074686174206973206e6f74206f77, mem[429 len 23]
        if not arg2:
