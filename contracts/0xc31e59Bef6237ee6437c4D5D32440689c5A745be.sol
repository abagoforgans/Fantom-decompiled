...
const sub_e06c73b1(?) = (27500 * 10^18 * 3600)
...
function sub_5c6b16c1(?) payable {
    ...
    if 27500 * 10^18 * 3600 < rewardClaimed:
        revert with 0, 17
    if arg2 > -rewardClaimed + (27500 * 10^18 * 3600):
        revert with 0, 'exceedRewards'
    if rewardClaimed > !arg2:
        revert with 0, 17
    rewardClaimed += arg2
    if not address(arg1):
        revert with 0, 'ERC20: mint to the zero address'
...
function sub_739272ad(?) payable {
    ...
    if not sub_52b779ea:
        ...
        staticcall sub_105481afAddress.0xd34410ba with:
                gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
