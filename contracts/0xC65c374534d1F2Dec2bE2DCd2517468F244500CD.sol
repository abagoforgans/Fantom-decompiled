...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if totalSupply - (2 * arg2 / 100) < 10^15:
        ...
        if frozenOf[address(msg.sender)].field_0:
            ...
            frozenOf[address(arg1)].field_256 = frozenOf[address(arg1)].field_256 + arg2 - (2 * arg2 / 100)
            ...
            if 2 * arg2 / 100 > 0:
                if totalFrozen <= 0:
                    ...
                    emit Transfer((2 * arg2 / 100 / 2), msg.sender, this.address);
                    totalSupply -= 2 * arg2 / 100 / 2
                    emit Transfer((2 * arg2 / 100 / 2), msg.sender, 0);
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if totalSupply - (2 * arg3 / 100) < 10^15:
        ...
        if frozenOf[address(arg1)].field_0:
            ...
            frozenOf[address(arg2)].field_256 = frozenOf[address(arg2)].field_256 + arg3 - (2 * arg3 / 100)
            ...
            if 2 * arg3 / 100 > 0:
                if totalFrozen <= 0:
                    ...
                    emit Transfer((2 * arg3 / 100 / 2), arg1, this.address);
                    totalSupply -= 2 * arg3 / 100 / 2
                    emit Transfer((2 * arg3 / 100 / 2), arg1, 0);
...
function bulkTransfer(address[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 2
        if totalSupply - (2 * cd[((32 * idx) + arg2 + 36)] / 100) < 10^15:
            ...
            if frozenOf[address(msg.sender)].field_0:
                ...
                frozenOf[address(cd[((32 * idx) + arg1 + 36)])].field_256 = frozenOf[address(cd[((32 * idx) + arg1 + 36)])].field_256 + cd[((32 * idx) + arg2 + 36)] - (2 * cd[((32 * idx) + arg2 + 36)] / 100)
                mem[96] = cd[((32 * idx) + arg2 + 36)] - (2 * cd[((32 * idx) + arg2 + 36)] / 100)
                emit Transfer((cd[((32 * idx) + arg2 + 36)] - (2 * cd[((32 * idx) + arg2 + 36)] / 100)), msg.sender, address(cd[((32 * idx) + arg1 + 36)]));
                if 2 * cd[((32 * idx) + arg2 + 36)] / 100 > 0:
                    if totalFrozen <= 0:
                        totalSupply -= 2 * cd[((32 * idx) + arg2 + 36)] / 100
                        emit Transfer((2 * cd[((32 * idx) + arg2 + 36)] / 100), msg.sender, 0);
                        mem[96] = 2 * cd[((32 * idx) + arg2 + 36)] / 100
                        emit Burn((2 * cd[((32 * idx) + arg2 + 36)] / 100));
                    else:
                        require totalFrozen
                        stor3 += Mask(192, 1, 2 * cd[((32 * idx) + arg2 + 36)] / 100) << 63 / totalFrozen
                        emit Transfer((2 * cd[((32 * idx) + arg2 + 36)] / 100 / 2), msg.sender, this.address);
                        totalSupply -= 2 * cd[((32 * idx) + arg2 + 36)] / 100 / 2
                        emit Transfer((2 * cd[((32 * idx) + arg2 + 36)] / 100 / 2), msg.sender, 0);
