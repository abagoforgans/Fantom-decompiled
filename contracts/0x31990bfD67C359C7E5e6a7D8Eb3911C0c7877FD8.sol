...
function sub_6e36a724(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[_81] = cd[(cd[4] + cd[s] + cd[(cd[4] + cd[s] + 68)] + 36)]
        require cd[4] + cd[s] + cd[(cd[4] + cd[s] + 68)] + cd[(cd[4] + cd[s] + cd[(cd[4] + cd[s] + 68)] + 36)] + 68 <= calldata.size
        mem[_81 + 32 len cd[(cd[4] + cd[s] + cd[(cd[4] + cd[s] + 68)] + 36)]] = call.data[cd[4] + cd[s] + cd[(cd[4] + cd[s] + 68)] + 68 len cd[(cd[4] + cd[s] + cd[(cd[4] + cd[s] + 68)] + 36)]]
        mem[_81 + cd[(cd[4] + cd[s] + cd[(cd[4] + cd[s] + 68)] + 36)] + 32] = 0
        mem[_55 + 32] = _81
        mem[t] = _55
        s = s + 32
        t = t + 32
    ...
    if not _54:
        ...
        while idx < _106:
            ...
            s = 0
            while cd[4] + (32 * ('cd', 4).length) + 36 < _117:
                mem[cd[4] + (32 * ('cd', 4).length) + _115 + 36] = mem[cd[4] + (32 * ('cd', 4).length) + _114 + 68]
                _106 = mem[96]
                s = cd[4] + (32 * ('cd', 4).length) + 68
                continue 
            if cd[4] + (32 * ('cd', 4).length) + 36 <= _117:
        ...
        while idx < _154:
            ...
            if ceil32(_169) <= _169:
                call address(_162).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _169 + _167 + -mem[64] - 4]
                if not return_data.size:
                    if idx >= mem[_56]:
                        revert with 0, 50
                    mem[(32 * idx) + _56 + 32] = 96
