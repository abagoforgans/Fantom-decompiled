...
function estimatedTotalAssets() payable {
    ...
    if ext_call.return_data[0] < 0:
        revert with 0, 'SafeMath: addition overflow'
    return (7 * ext_call.return_data[0])
}
...
function isActive() payable {
    ...
    if ext_call.return_data[0] < 0:
        revert with 0, 'SafeMath: addition overflow'
    return (7 * ext_call.return_data[0] > 0)
}
...
function harvestTrigger(uint256 arg1) payable {
    ...
    if debtThreshold < 0:
        revert with 0, 'SafeMath: addition overflow'
    if debtThreshold + (7 * ext_call.return_data[0]) < ext_call.return_data[192]:
        return 1
    if 7 * ext_call.return_data[0] <= ext_call.return_data[192]:
        require ext_code.size(vaultAddress)
        staticcall vaultAddress.creditAvailable() with:
                gas gas_remaining wei
        if not ext_call.success:
        ...
        if arg1 * profitFactor / profitFactor != arg1:
            revert with 0, 'SafeMath: multiplication overflow'
        return (arg1 * profitFactor < ext_call.return_data[0])
    if ext_call.return_data[192] > 7 * ext_call.return_data[0]:
        revert with 0, 'SafeMath: subtraction overflow', 0
    require ext_code.size(vaultAddress)
    staticcall vaultAddress.creditAvailable() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if (8 * ext_call.return_data[0]) - ext_call.return_data[192] < ext_call.return_data[0]:
        revert with 0, 'SafeMath: addition overflow'
    if not profitFactor:
        return (0 < (8 * ext_call.return_data[0]) - ext_call.return_data[192])
    if arg1 * profitFactor / profitFactor != arg1:
        revert with 0, 'SafeMath: multiplication overflow'
    return (arg1 * profitFactor < (8 * ext_call.return_data[0]) - ext_call.return_data[192])
}
