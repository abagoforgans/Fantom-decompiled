...
function sub_f762988f(?) payable {
    ...
    require mem[(32 * arg3.length) + mem[(32 * arg3.length) + 128 len 4], Mask(224, 32, arg1) >> 32 + 128] <= 4294967296 and mem[(32 * arg3.length) + 128 len 4], Mask(224, 32, arg1) >> 32 + (32 * mem[(32 * arg3.length) + mem[(32 * arg3.length) + 128 len 4], Mask(224, 32, arg1) >> 32 + 128]) + 32 <= return_data.size
    mem[(32 * arg3.length) + ceil32(return_data.size) + 128] = mem[(32 * arg3.length) + mem[(32 * arg3.length) + 128 len 4], Mask(224, 32, arg1) >> 32 + 128]
    _23 = mem[(32 * arg3.length) + _20 + 128]
    mem[(32 * arg3.length) + ceil32(return_data.size) + 160 len floor32(mem[(32 * arg3.length) + _20 + 128])] = mem[(32 * arg3.length) + _20 + 160 len floor32(mem[(32 * arg3.length) + _20 + 128])]
...
function sub_f0024dff(?) payable {
    ...
    require mem[(32 * arg3.length) + mem[(32 * arg3.length) + 128 len 4], Mask(224, 32, arg1) >> 32 + 128] <= 4294967296 and mem[(32 * arg3.length) + 128 len 4], Mask(224, 32, arg1) >> 32 + (32 * mem[(32 * arg3.length) + mem[(32 * arg3.length) + 128 len 4], Mask(224, 32, arg1) >> 32 + 128]) + 32 <= return_data.size
    mem[(32 * arg3.length) + ceil32(return_data.size) + 128] = mem[(32 * arg3.length) + mem[(32 * arg3.length) + 128 len 4], Mask(224, 32, arg1) >> 32 + 128]
    _24 = mem[(32 * arg3.length) + _21 + 128]
    mem[(32 * arg3.length) + ceil32(return_data.size) + 160 len floor32(mem[(32 * arg3.length) + _21 + 128])] = mem[(32 * arg3.length) + _21 + 160 len floor32(mem[(32 * arg3.length) + _21 + 128])]
