...
function balanceOfPool() payable {
    ...
    staticcall address(masterchefAddress).userInfo(address arg1, address arg2) with:
            gas gas_remaining wei
           args address(this.address), poolTokenAddress
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(masterchefAddress))
    call address(masterchefAddress).deposit(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function retireStrat() payable {
    if address(vaultAddress) != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(address(masterchefAddress))
    call address(masterchefAddress).emergencyWithdraw(address arg1) with:
         gas gas_remaining wei
...
function sub_50013920(?) payable {
    ...
    if arg5 != 3:
        if arg5 != 2:
            sub_329a597c.length = 2
            s = 0
            idx = 96
            while 160 > idx:
                sub_329a597c[s] = mem[idx + 12 len 20]
                s = s + 1
                idx = idx + 32
                continue 
            idx = 2
            while sub_329a597c.length > idx:
                sub_329a597c[idx] = 0
                idx = idx + 1
                continue 
        else:
            mem[160] = arg2
            sub_329a597c.length = 3
            s = 0
            idx = 96
            while 192 > idx:
                sub_329a597c[s] = mem[idx + 12 len 20]
...
function sub_3e200b2e(?) payable {
    ...
    if arg5 != 3:
        if arg5 != 2:
            sub_a3e5be35.length = 2
            s = 0
            idx = 96
            while 160 > idx:
                sub_a3e5be35[s] = mem[idx + 12 len 20]
                s = s + 1
                idx = idx + 32
                continue 
            idx = 2
            while sub_a3e5be35.length > idx:
                sub_a3e5be35[idx] = 0
                idx = idx + 1
                continue 
        else:
            mem[160] = arg2
            sub_a3e5be35.length = 3
            s = 0
            idx = 96
            while 192 > idx:
                sub_a3e5be35[s] = mem[idx + 12 len 20]
...
function withdraw(uint256 arg1) payable {
    ...
    require ext_code.size(address(masterchefAddress))
    call address(masterchefAddress).withdraw(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function panic() payable {
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    call address(masterchefAddress).emergencyWithdraw(address arg1) with:
                         gas gas_remaining wei
                        args poolTokenAddress, mem[(2 * ceil32(return_data.size)) + 790 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        else:
            mem[456 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size > 0:
    ...
    if not ext_call.success:
        ...
        revert with 0, 'SafeERC20: low-level call failed'
    if return_data.size <= 0:
        mem[(4 * ceil32(return_data.size)) + 760] = poolTokenAddress
        require ext_code.size(address(masterchefAddress))
        call address(masterchefAddress).emergencyWithdraw(address arg1) with:
             gas gas_remaining wei
