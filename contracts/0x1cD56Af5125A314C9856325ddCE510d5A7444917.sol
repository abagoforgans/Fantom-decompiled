...
function mintAsset() payable {
    ...
    while idx < sub_b8517dd8:
        ...
        mem[0] = idx
        mem[32] = 0
        mem[96] = 0xe9185e1700000000000000000000000000000000000000000000000000000000
        mem[100] = ext_call.return_data[0] / 100 * stor0[idx].field_256
        require ext_code.size(stor0[idx].field_0)
        call stor0[idx].field_0.0xe9185e17 with:
             gas gas_remaining wei
            args (ext_call.return_data[0] / 100 * stor0[idx].field_256)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        idx = idx + 1
        continue 
