...
uint8 decimals;
address sub_dccd4d69Address; offset 8
...
function leave(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(sub_dccd4d69Address)
    staticcall sub_dccd4d69Address.0x70a08231 with:
    ...
    if not arg1:
        ...
        require ext_code.size(sub_dccd4d69Address)
        call sub_dccd4d69Address.0xa9059cbb with:
             gas gas_remaining wei
...
function enter(uint256 arg1) payable {
    ...
    require ext_code.size(sub_dccd4d69Address)
    call sub_dccd4d69Address.0x23b872dd with:
         gas gas_remaining wei
