    ...
    while idx < 5001:
        ...
        if not idx + arg1:
            ...
            if not ext_call.return_data[0]:
                ...
                if idx + arg1 < arg1:
                    revert with 0, 'SafeMath: addition overflow'
                if idx + arg1 + ext_call.return_data[0] < ext_call.return_data[0]:
                    revert with 0, 'SafeMath: addition overflow'
                if not 0 / ext_call.return_data[0]:
                    ...
                    if (0 / ext_call.return_data[0]) + totalSupply:
                        if idx + arg1 < arg1:
                            revert with 0, 'SafeMath: addition overflow'
                        if idx + arg1 != 0 / (0 / ext_call.return_data[0]) + totalSupply:
                            idx = idx + 1
                            continue 
                        if idx + arg1 < arg1:
                            revert with 0, 'SafeMath: addition overflow'
                    ...
                    if (idx * 0 / ext_call.return_data[0]) + (arg1 * 0 / ext_call.return_data[0]) + (ext_call.return_data[0] * 0 / ext_call.return_data[0]) / 0 / ext_call.return_data[0] != idx + arg1 + ext_call.return_data[0]:
                    ...
                    if (0 / ext_call.return_data[0]) + totalSupply:
                        if idx + arg1 < arg1:
                            revert with 0, 'SafeMath: addition overflow'
                        if idx + arg1 != (idx * 0 / ext_call.return_data[0]) + (arg1 * 0 / ext_call.return_data[0]) + (ext_call.return_data[0] * 0 / ext_call.return_data[0]) / (0 / ext_call.return_data[0]) + totalSupply:
                            idx = idx + 1
                            continue 
                        if idx + arg1 < arg1:
                            revert with 0, 'SafeMath: addition overflow'
            ...
            if (idx * totalSupply) + (arg1 * totalSupply) / idx + arg1 != totalSupply:
                revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _132 = mem[64]
            mem[64] = mem[64] + 64
            mem[_132] = 26
            ...
            if not ext_call.return_data[0]:
                ...
                if ((idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) + totalSupply < totalSupply:
                    revert with 0, 'SafeMath: addition overflow'
                if idx + arg1 < arg1:
                    revert with 0, 'SafeMath: addition overflow'
                if idx + arg1 + ext_call.return_data[0] < ext_call.return_data[0]:
                    revert with 0, 'SafeMath: addition overflow'
                if not (idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]:
                    _172 = mem[64]
                    mem[64] = mem[64] + 64
                    mem[_172] = 26
                    mem[_172 + 32] = 'SafeMath: division by zero'
                    if ((idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) + totalSupply:
                        if idx + arg1 < arg1:
                            revert with 0, 'SafeMath: addition overflow'
                        if idx + arg1 != 0 / ((idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) + totalSupply:
                            idx = idx + 1
                            continue 
                        if idx + arg1 < arg1:
                            revert with 0, 'SafeMath: addition overflow'
                    ...
                    if (idx * (idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) + (arg1 * (idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) + (ext_call.return_data[0] * (idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) / (idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0] != idx + arg1 + ext_call.return_data[0]:
                        revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                    _174 = mem[64]
                    mem[64] = mem[64] + 64
                    mem[_174] = 26
                    ...
                    if ((idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) + totalSupply:
                        if idx + arg1 < arg1:
                            revert with 0, 'SafeMath: addition overflow'
                        if idx + arg1 != (idx * (idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) + (arg1 * (idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) + (ext_call.return_data[0] * (idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) / ((idx * totalSupply) + (arg1 * totalSupply) / ext_call.return_data[0]) + totalSupply:
                            idx = idx + 1
                            continue 
                        if idx + arg1 < arg1:
                            revert with 0, 'SafeMath: addition overflow'
                ...
                if delegates[address(msg.sender)]:
                    if block.number >= 4294967296:
                        revert with 0, 
                                    32,
                                    51,
                                    0x725a4f4f3a3a5f7772697465436865636b706f696e743a20626c6f636b206e75,
                    ...
                    if totalSupply * arg1 / ext_call.return_data[0] > 0:
                        if delegates[address(msg.sender)]:
                            ...
                            if numCheckpoints[stor9[address(msg.sender)]]:
                                if numCheckpoints[stor9[address(msg.sender)]] <= 0:
                                    checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]]].field_0 = uint32(block.number)
                                    checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]]].field_256 = checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]] - 1 << 224].field_256 + (totalSupply * arg1 / ext_call.return_data[0])
                                    numCheckpoints[stor9[address(msg.sender)]] = uint32(numCheckpoints[stor9[address(msg.sender)]] + 1)
                                else:
                                    if checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]] - 1 << 224].field_0 == uint32(block.number):
                                        checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]] - 1 << 224].field_256 += totalSupply * arg1 / ext_call.return_data[0]
                                    else:
                                        checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]]].field_0 = uint32(block.number)
                                        checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]]].field_256 = checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]] - 1 << 224].field_256 + (totalSupply * arg1 / ext_call.return_data[0])
                                        numCheckpoints[stor9[address(msg.sender)]] = uint32(numCheckpoints[stor9[address(msg.sender)]] + 1)
                                emit DelegateVotesChanged(checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]] - 1 << 224].field_256, checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]] - 1 << 224].field_256 + (totalSupply * arg1 / ext_call.return_data[0]), delegates[address(msg.sender)]);
                            else:
                                if numCheckpoints[stor9[address(msg.sender)]] <= 0:
                                    checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]]].field_0 = uint32(block.number)
                                    checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]]].field_256 = totalSupply * arg1 / ext_call.return_data[0]
                                    numCheckpoints[stor9[address(msg.sender)]] = uint32(numCheckpoints[stor9[address(msg.sender)]] + 1)
                                else:
                                    if checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]] - 1 << 224].field_0 == uint32(block.number):
                                        checkpoints[stor9[address(msg.sender)]][stor11[stor9[address(msg.sender)]] - 1 << 224].field_256 = totalSupply * arg1 / ext_call.return_data[0]
                ...
                if delegates[arg2]:
                    ...
                    if numCheckpoints[stor9[arg2]]:
                        if numCheckpoints[stor9[arg2]] <= 0:
                            ...
                            checkpoints[stor9[arg2]][stor11[stor9[arg2]]].field_256 = checkpoints[stor9[arg2]][stor11[stor9[arg2]] - 1 << 224].field_256 + arg3
                            ...
                            if checkpoints[stor9[arg2]][stor11[stor9[arg2]] - 1 << 224].field_0 == uint32(block.number):
                                ...
                                checkpoints[stor9[arg2]][stor11[stor9[arg2]]].field_256 = checkpoints[stor9[arg2]][stor11[stor9[arg2]] - 1 << 224].field_256 + arg3
                                numCheckpoints[stor9[arg2]] = uint32(numCheckpoints[stor9[arg2]] + 1)
                        emit DelegateVotesChanged(checkpoints[stor9[arg2]][stor11[stor9[arg2]] - 1 << 224].field_256, checkpoints[stor9[arg2]][stor11[stor9[arg2]] - 1 << 224].field_256 + arg3, delegates[arg2]);
                    else:
                        if numCheckpoints[stor9[arg2]] <= 0:
                            checkpoints[stor9[arg2]][stor11[stor9[arg2]]].field_0 = uint32(block.number)
