    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * sub_d68e1302 / 10000)) >> 32
                mem[452 len 0] = 0
                call lpPairAddress with:
                   funct uint32(stor10)
                     gas gas_remaining wei
            ...
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg1) >> 32
                call lpPairAddress with:
                   funct uint32(stor10)
                     gas gas_remaining wei
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg1 - (arg1 * sub_d68e1302 / 10000)) >> 32
                mem[452 len 0] = 0
                call lpPairAddress with:
                   funct uint32(stor10)
                     gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * sub_d68e1302 / 10000)) >> 32
                call lpPairAddress with:
                   funct uint32(stor10)
                     gas gas_remaining wei
            ...
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg1) >> 32
                call lpPairAddress with:
                   funct uint32(stor10)
                     gas gas_remaining wei
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg1 - (arg1 * sub_d68e1302 / 10000)) >> 32
                call lpPairAddress with:
                   funct uint32(stor10)
                     gas gas_remaining wei
