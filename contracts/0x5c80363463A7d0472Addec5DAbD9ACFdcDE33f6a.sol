...
function burnToken(address arg1, uint256 arg2, uint256 arg3) payable {
...
function createToken(address arg1, uint256 arg2, uint256 arg3) payable {
    require calldata.size - 4 >= 96
    require arg1 == arg1
    require arg2 == arg2
    require arg3 == arg3
    ...
    stor1[address(msg.sender)][stor3] = 1
    emit ApprovalForAll(1, msg.sender, stor3);
    return arg2
}
