...
function depositStake(uint256 arg1) payable {
    ...
    require ext_code.size(sub_e30b1a30Address)
    staticcall sub_e30b1a30Address.allowance(address arg1, address arg2) with:
            gas gas_remaining wei
    ...
    require ext_code.size(sub_e30b1a30Address)
    call sub_e30b1a30Address.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
