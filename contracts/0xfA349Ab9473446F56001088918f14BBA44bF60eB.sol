...
function totalSupply() {
    require stor3
    return ((10^6 * block.timestamp - stor7 / 900 / stor3 * stor4) + 24 * 10^6)
}
...
function tokensToClaim(address arg1) {
    ...
    return ((24 * 10^6 * 10^12 * balanceOf[address(arg1)].field_256 / balanceOf[address(arg1)].field_768) + (10^6 * block.timestamp - stor7 / 900 / stor3 * stor4 * 10^12 * balanceOf[address(arg1)].field_256 / balanceOf[address(arg1)].field_768) / 10^12)
}
...
function allInfoFor(address arg1) {
    ...
    return (10^6 * block.timestamp - stor7 / 900 / stor3 * stor4) + 24 * 10^6, 
           ...
           (24 * 10^6 * 10^12 * balanceOf[address(arg1)].field_256 / balanceOf[address(arg1)].field_768) + (10^6 * block.timestamp - stor7 / 900 / stor3 * stor4 * 10^12 * balanceOf[address(arg1)].field_256 / balanceOf[address(arg1)].field_768) / 10^12
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    if not stor5:
        ...
        if stor6 + 900 < block.timestamp:
            stor6 = block.timestamp
            require stor3
            stor0 = (10^6 * block.timestamp - stor7 / 900 / stor3 * stor4) + 24 * 10^6
