...
const masterchef = 0xc7dad2e953dc7b11474151134737a007049f576e
...
function balanceOfPool() payable {
    require ext_code.size(0xc7dad2e953dc7b11474151134737a007049f576e)
    staticcall 0xc7dad2e953dc7b11474151134737a007049f576e.userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
...
function deposit(uint256 arg1) payable {
    ...
    if arg1 > 0:
        if ext_call.return_data[0] > 0:
            require ext_code.size(0xc7dad2e953dc7b11474151134737a007049f576e)
            call 0xc7dad2e953dc7b11474151134737a007049f576e.deposit(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args poolId, arg1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] < arg1:
        ...
        require ext_code.size(0xc7dad2e953dc7b11474151134737a007049f576e)
        call 0xc7dad2e953dc7b11474151134737a007049f576e.withdraw(uint256 arg1, uint256 arg2) with:
             gas gas_remaining wei
...
function pause() payable {
    ...
    if ext_code.size(inputAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), 0xc7dad2e953dc7b1147415113, 0, 0
    call inputAddress.0x49f576e with:
         gas gas_remaining wei
        args 0, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), 0xc7dad2e953dc7b1147415113, 0, 0
        if not approve(address arg1, uint256 arg2), 0xc7dad2e953dc7b1147415113:
            revert with 0, 32, 42, 0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        if eth.balance(this.address) < 0:
