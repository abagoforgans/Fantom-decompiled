...
function farm() payable {
    ...
    call farmContractAddress.0x47e7ef24 with:
         gas gas_remaining wei
            ...
            if not arg2:
                ...
                if not uint8(stor2.field_24):
                    ...
                    if not return_data.size:
                        ...
                        call farmContractAddress.0x47e7ef24 with:
                             gas gas_remaining wei
                            args wantAddress, ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 654 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        stor1 = 1
                        idx = 0
            ...
            if sharesTotal <= 0:
                ...
                if not uint8(stor2.field_24):
                    ...
                    if not return_data.size:
                        ...
                        call farmContractAddress.0x47e7ef24 with:
                             gas gas_remaining wei
                            args wantAddress, ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 526 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        stor1 = 1
                        idx = 0
        ...
        if 0 / wantLockedTotal <= sharesTotal:
            ...
            if withdrawFeeFactor >= 10000:
                if not uint8(stor2.field_24):
                    ...
                    require ext_code.size(farmContractAddress)
                    call farmContractAddress.0xf3fef3a3 with:
                         gas gas_remaining wei
                        args wantAddress, arg2
                    if arg2:
                    else:
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                ...
                if not arg2:
                    ...
                    if not uint8(stor2.field_24):
                        ...
                        call farmContractAddress.0xf3fef3a3 with:
                             gas gas_remaining wei
                            args wantAddress, arg2 * withdrawFeeFactor / 10000
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
