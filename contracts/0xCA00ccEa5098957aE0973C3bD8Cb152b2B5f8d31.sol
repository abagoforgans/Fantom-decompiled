...
function sub_d2f7f289(?) payable {
    return sub_d2f7f289Address
}
...
function sub_7b816531(?) payable {
    require ext_code.size(sub_d2f7f289Address)
    staticcall sub_d2f7f289Address.token0() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(sub_d2f7f289Address)
    staticcall sub_d2f7f289Address.totalSupply() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(sub_d2f7f289Address)
    staticcall sub_d2f7f289Address.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    if sub_4e1ea47cAddress != address(ext_call.return_data[0]):
        ...
        if 10^18 * ext_call.return_data[32] > 0x119799812dea11197f27f0f6e885c8ba7eb31f476caf7411a863387:
            revert with 0, 17
        if 1000000000000 * 10^18 * ext_call.return_data[32] > !(10^18 * ext_call.return_data[0]):
            revert with 0, 17
        if not ext_call.return_data[0]:
            revert with 0, 18
        return ((1000000000000 * 10^18 * ext_call.return_data[32]) + (10^18 * ext_call.return_data[0]) / ext_call.return_data[0])
    if ext_call.return_data[32] and 10^18 > -1 / ext_call.return_data[32]:
        revert with 0, 17
    if ext_call.return_data[0] and 10^18 > -1 / ext_call.return_data[0]:
        revert with 0, 17
    if 10^18 * ext_call.return_data[0] > 0x119799812dea11197f27f0f6e885c8ba7eb31f476caf7411a863387:
        revert with 0, 17
    if 1000000000000 * 10^18 * ext_call.return_data[0] > !(10^18 * ext_call.return_data[32]):
        revert with 0, 17
    if not ext_call.return_data[0]:
        revert with 0, 18
    return ((1000000000000 * 10^18 * ext_call.return_data[0]) + (10^18 * ext_call.return_data[32]) / ext_call.return_data[0])
}
...
function sub_ca070284(?) payable {
    ...
    if sub_4e1ea47cAddress != address(ext_call.return_data[0]):
        ...
        staticcall sub_825db985Address.userInfo(uint256 rg1, address rg2) with:
                gas gas_remaining wei
               args 27, 0x7ebdeb7107b14322d4afc1cb855e9ed716f9d7d2
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] and (1000000000000 * 10^18 * ext_call.return_data[32]) + (10^18 * ext_call.return_data[0]) / ext_call.return_data[0] > -1 / ext_call.return_data[0]:
            revert with 0, 17
        return (ext_call.return_data[0] * (1000000000000 * 10^18 * ext_call.return_data[32]) + (10^18 * ext_call.return_data[0]) / ext_call.return_data[0] / 10^18)
    if ext_call.return_data[32] and 10^18 > -1 / ext_call.return_data[32]:
        revert with 0, 17
    if ext_call.return_data[0] and 10^18 > -1 / ext_call.return_data[0]:
        revert with 0, 17
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] and (1000000000000 * 10^18 * ext_call.return_data[0]) + (10^18 * ext_call.return_data[32]) / ext_call.return_data[0] > -1 / ext_call.return_data[0]:
        revert with 0, 17
    return (ext_call.return_data[0] * (1000000000000 * 10^18 * ext_call.return_data[0]) + (10^18 * ext_call.return_data[32]) / ext_call.return_data[0] / 10^18)
}
