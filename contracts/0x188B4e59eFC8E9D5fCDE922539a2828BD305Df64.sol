...
function subscribe(address arg1, uint8 arg2, uint256 arg3) payable {
    ...
    while idx < oracles.length:
        ...
        while idx >= 32:
            ...
            idx = idx - 32
            continue 
        mem[mem[64] + 64] = mem[179 len 13] or Mask(152, 104, mem[mem[64] + 64])
        _112 = mem[64]
        mem[mem[64]] = -mem[64] + 218
        mem[64] = 250
        _114 = sha3(mem[_112 + 32 len mem[_112]])
        mem[0] = sha3(mem[_112 + 32 len mem[_112]])
        if subscriptions[mem[0]].field_0:
            revert with 0, 'rq is exist'
        subscriptions[_114].field_0 = msg.sender
        subscriptions[_114].field_256 = arg1
        subscriptions[_114].field_416 = arg2
        subscriptions[_114].field_512 = arg3
        require ext_code.size(0xd5938629af019c1add1b9fc9f92c9615a01f9e6)
        delegate 0xd5938629af019c1add1b9fc9f92c9615a01f9e6.0xa506d954 with:
             gas gas_remaining wei
            args 5, _114
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
        subscriptionIds.length++
        subscriptionIds[subscriptionIds.length].field_0 = _114
        emit NewSubscriber(_114);
    if owner != msg.sender:
