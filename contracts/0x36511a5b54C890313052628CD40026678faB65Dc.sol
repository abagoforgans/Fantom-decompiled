...
function COIN() payable {
    require ext_code.size(0x5a917b3bc44b52c03523f93351e0d477d8e61b17)
    delegate 0x5a917b3bc44b52c03523f93351e0d477d8e61b17.WETH() with:
...
function factory() payable {
    if stor1:
        return stor1
    require ext_code.size(0x5a917b3bc44b52c03523f93351e0d477d8e61b17)
    delegate 0x5a917b3bc44b52c03523f93351e0d477d8e61b17.0xc45a0155 with:
         gas gas_remaining wei
        args 
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function hasPool(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0x5a917b3bc44b52c03523f93351e0d477d8e61b17)
    delegate 0x5a917b3bc44b52c03523f93351e0d477d8e61b17.0x1246dbf5 with:
         gas gas_remaining wei
        args arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getReserves(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0x5a917b3bc44b52c03523f93351e0d477d8e61b17)
    delegate 0x5a917b3bc44b52c03523f93351e0d477d8e61b17.0x3e99c1e4 with:
         gas gas_remaining wei
        args arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function coinQuote(address arg1, uint256 arg2) payable {
    ...
    require ext_code.size(0x5a917b3bc44b52c03523f93351e0d477d8e61b17)
    delegate 0x5a917b3bc44b52c03523f93351e0d477d8e61b17.ethQuote(address rg1, uint256 rg2) with:
         gas gas_remaining wei
...
function getPair(address arg1, address arg2) payable {
    ...
    require ext_code.size(0x5a917b3bc44b52c03523f93351e0d477d8e61b17)
    if stor1:
        delegate 0x5a917b3bc44b52c03523f93351e0d477d8e61b17.getPair(address rg1, address rg2, address rg3) with:
             gas gas_remaining wei
...
function getPathForCoinToToken(address arg1) payable {
    ...
    mem[100] = arg1
    require ext_code.size(0x5a917b3bc44b52c03523f93351e0d477d8e61b17)
    delegate 0x5a917b3bc44b52c03523f93351e0d477d8e61b17.getPathForETHToToken(address rg1) with:
         gas gas_remaining wei
        args arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
