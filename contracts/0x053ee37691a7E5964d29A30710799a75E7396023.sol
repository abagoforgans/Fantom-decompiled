...
#
#  - swap(address arg1, address arg2, uint256 arg3)
#
address stor0;
address stor1;
address stor2;
    ...
    if address(ext_call.return_data[0]):
        ...
        if address(ext_call.return_data[0]):
            ...
            if address(ext_call.return_data[0]):
                ...
                if not ext_call.return_data[12 len 20]:
                    require ext_code.size(call.data[calldata.size + 12 len 20])
                    staticcall call.data[calldata.size + 12 len 20].0x313ce567 with:
                            gas gas_remaining wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_code.size(call.data[calldata.size + 44 len 20])
                    staticcall call.data[calldata.size + 44 len 20].0x313ce567 with:
                            gas gas_remaining wei
                else:
                    require ext_code.size(stor0)
                    staticcall stor0.0x313ce567 with:
