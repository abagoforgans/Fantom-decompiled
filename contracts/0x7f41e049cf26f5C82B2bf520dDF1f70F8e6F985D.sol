...
function sub_31c53fb4(?) payable {
    ...
    staticcall this.address.0xe08be849 with:
            gas gas_remaining wei
           args address(arg1), address(arg2), ext_call.return_data[0], mem[140 len 20]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(this.address)
    ...
    call this.address.0x7dc20382 with:
         gas gas_remaining wei
        args address(arg1), address(arg2), ext_call.return_data[0], ext_call.return_data[0], msg.sender, mem[140 len 20]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    staticcall this.address.0xe08be849 with:
            gas gas_remaining wei
           args address(arg2), address(arg1), ext_call.return_data[0], mem[172 len 20]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(32 * arg3.length) + 132] = arg2
...
function swap(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5, address arg6) {
    ...
    call arg1.0x23b872dd with:
         gas gas_remaining wei
        args address(arg5), this.address, arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(arg1)
