...
function sub_7e48d4ea(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if stor11 + delay < stor11:
        revert with 0, 'SafeMath: addition overflow'
    if stor11 + delay >= block.timestamp:
        revert with 0, 'Delay has not passed'
    delay = stor10
    emit 0x832f93a7: stor10
}
...
function earn() payable {
    ...
    mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor14), uint32(stor14), ext_call.return_data[0 len 28]
    mem[324 len 0] = 0
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor14), uint32(stor14), ext_call.return_data[0]
        if not unknown_0xa9059cbb(?????), Mask(224, 0, stor14):
...
function upgradeStrat() payable {
    ...
    if stor8 + delay < stor8:
        revert with 0, 'SafeMath: addition overflow'
    if stor8 + delay >= block.timestamp:
        revert with 0, 'Delay has not passed'
