...
function sendValueToSubByte(bytes arg1, uint256 arg2, bytes32 arg3) {
    ...
    while idx < oracles.length:
        ...
        idx = 0
        while idx < arg1.length:
            mem[ceil32(arg1.length) + idx + 196] = mem[idx + 128]
            idx = idx + 32
            continue 
        require ext_code.size(subscriptions[arg3].field_256)
...
function sendHashValue(bytes32 arg1, uint8[] arg2, bytes32[] arg3, bytes32[] arg4) {
    ...
    pulses[stor17].field_0 = arg1
    pulses[stor17].field_256 = block.number
    emit NewPulse(lastPulseId, block.number, arg1);
    lastPulseId++
}

function subscribe(address arg1, uint8 arg2, uint256 arg3) payable {
    mem[64] = 96
    ...
    while idx < oracles.length:
        ...
        if oracles[idx].field_0 != msg.sender:
            idx = idx + 1
            continue 
        mem[128] = call.func_hash
        mem[132] = address(msg.sender)
        mem[152] = address(arg1)
        mem[172] = arg2 << 248
        s = 128
        t = 205
        idx = 45
        while idx >= 32:
            ...
            idx = idx - 32
            continue 
        mem[237] = 0 or Mask(152, 104, mem[237])
        if subscriptions[mem[205 len 45]].field_0:
            revert with 0, 'rq is exist'
        subscriptions[mem[205 len 45]].field_0 = msg.sender
        subscriptions[mem[205 len 45]].field_256 = arg1
        subscriptions[mem[205 len 45]].field_416 = arg2
        subscriptions[mem[205 len 45]].field_512 = arg3
        require ext_code.size(0xd804134c772ab10d9166ebaf123ce3d802af1f93)
        delegate 0xd804134c772ab10d9166ebaf123ce3d802af1f93.0xa506d954 with:
             gas gas_remaining wei
            args 5, sha3(mem[205 len 45])
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
        subscriptionIds.length++
        subscriptionIds[subscriptionIds.length].field_0 = sha3(mem[205 len 45])
        emit NewSubscriber(sha3(mem[205 len 45]));
    if owner != msg.sender:
        revert with 0, 'caller is not owner or oracle'
    if subscriptions[uint32(call.func_hash)][msg.sender][uint64(arg1)][mem[237 len 13]].field_0:
        revert with 0, 'rq is exist'
    subscriptions[uint32(call.func_hash)][msg.sender][uint64(arg1)][mem[237 len 13]].field_0 = msg.sender
    subscriptions[uint32(call.func_hash)][msg.sender][uint64(arg1)][mem[237 len 13]].field_256 = arg1
    subscriptions[uint32(call.func_hash)][msg.sender][uint64(arg1)][mem[237 len 13]].field_416 = arg2
    subscriptions[uint32(call.func_hash)][msg.sender][uint64(arg1)][mem[237 len 13]].field_512 = arg3
    require ext_code.size(0xd804134c772ab10d9166ebaf123ce3d802af1f93)
    delegate 0xd804134c772ab10d9166ebaf123ce3d802af1f93.0xa506d954 with:
         gas gas_remaining wei
        args 5, sha3(uint32(call.func_hash), msg.sender, uint64(arg1), mem[237 len 13])
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    subscriptionIds.length++
    subscriptionIds[subscriptionIds.length].field_0 = sha3(uint32(call.func_hash), msg.sender, uint64(arg1), mem[237 len 13])
    emit NewSubscriber(sha3(uint32(call.func_hash), msg.sender, uint64(arg1), mem[237 len 13]));
}
...
function updateOracles(address[] arg1, uint8[] arg2, bytes32[] arg3, bytes32[] arg4, uint256 arg5) {
    ...
    require mem[mem[_54] + _54] <= 4294967296 and mem[_54] + (32 * mem[mem[_54] + _54]) + 32 <= return_data.size
    mem[_54 + ceil32(return_data.size)] = mem[mem[_54] + _54]
    _62 = mem[_59 + _54]
    mem[_54 + ceil32(return_data.size) + 32 len floor32(mem[_59 + _54])] = mem[_59 + _54 + 32 len floor32(mem[_59 + _54])]
