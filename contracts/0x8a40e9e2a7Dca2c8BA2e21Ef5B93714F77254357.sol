...
mapping of uint256 sub_756a86bd;
...
function sub_756a86bd(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    return sub_756a86bd[arg1][arg2]
}
...
function approve(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        ...
        if ext_call.return_data[12 len 20] != msg.sender:
            revert with 0, 'Must be owner'
    sub_756a86bd[arg1][arg2] = arg3
    emit 0x93e4f122: arg3, arg1, arg2
    return 1
}
...
function transferFrom(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) payable {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        ...
        if ext_call.return_data[12 len 20] != msg.sender:
            revert with 0, 'Must be owner'
    if arg4 > sub_756a86bd[arg2][arg1]:
    ...
    if sub_756a86bd[arg2][arg1] < arg4:
        revert with 'NH{q', 17
    sub_756a86bd[arg2][arg1] -= arg4
    return 1
}
