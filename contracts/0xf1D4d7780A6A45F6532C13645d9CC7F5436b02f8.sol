...
address wbnbAddress;
uint32 stor10;
address sub_81269197Address;
uint256 stor10;
address sub_445d5ca0Address;
...
function sub_445d5ca0(?) payable {
    return sub_445d5ca0Address
}
...
function sub_5da61c90(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_5da61c90.length
    return sub_5da61c90[arg1]
}
...
function sub_81269197(?) payable {
    return address(sub_81269197Address)
}
