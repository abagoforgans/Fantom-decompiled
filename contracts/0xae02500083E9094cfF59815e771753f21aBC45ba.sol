...
function withdrawAll(address arg1) payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        require return_data.size >= 32
    require ext_code.size(sub_dbd33e45Address)
    staticcall sub_dbd33e45Address.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_5821ed0d(?) {
    ...
    if not ext_call.return_data[0]:
        ...
        require ext_code.size(sub_dbd33e45Address)
        staticcall sub_dbd33e45Address.taxRate() with:
                gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        if ext_call.return_data[0] < ext_call.return_data[0] + eth.balance(this.address) / 2:
            ...
            if 8000 * (10000 * ext_call.return_data[0] / 2 * ext_call.return_data[0] / 10^18) - (ext_call.return_data[0] * ext_call.return_data[0] / 2 * ext_call.return_data[0] / 10^18) / 10000 / 10000 <= 0:
                revert with 0, 
                            ...
                            0x7772656365697665466d74416d7420616d6f756e74206d7573742062652067726561746572207468616e207a6572,
                            mem[306 len 18]
            emit 0x98a68058: Mask(255, 1, ext_call.return_data[0]), 8000 * (10000 * ext_call.return_data[0] / 2 * ext_call.return_data[0] / 10^18) - (ext_call.return_data[0] * ext_call.return_data[0] / 2 * ext_call.return_data[0] / 10^18) / 10000 / 10000
            require ext_code.size(sub_dbd33e45Address)
            staticcall sub_dbd33e45Address.balanceOf(address arg1) with:
                    gas gas_remaining wei
                   args this.address
