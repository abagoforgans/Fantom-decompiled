...
const InitialSupply = 15 * 10^9

const decimals = 8

const TeamWallet = 0xc453f1e8f16dfedaeba8bf0d7f5c27947b048e46
...
function getBurnedTokens() {
    if 15 * 10^9 < totalSupply:
        revert with 'NH{q', 17
    return (-totalSupply + 15 * 10^9 / 100 * 10^6)
}
...
function sendBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0xc453f1e8f16dfedaeba8bf0d7f5c27947b048e46 with:
    ...
    if balanceOf[address(this.address)] >= stor10:
        if uint8(uint8(stor12.field_32) + uint8(stor12.field_40)):
            ...
            if not -(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_32) + uint8(stor12.field_40)) / 2) + stor10:
                revert with 'NH{q', 18
            if totalLPBNB > -(0 / -(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_32) + uint8(stor12.field_40)) / 2) + stor10) - 1:
                revert with 'NH{q', 17
            totalLPBNB += 0 / -(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_32) + uint8(stor12.field_40)) / 2) + stor10
            if not this.address:
                revert with 0, 'Approve from zero'
            if not stor13:
                revert with 0, 'Approve to zero'
