...
function getAllPairs() payable {
    ...
    staticcall sub_7edc9126Address.mem[var14003 len 4] with:
    ...
    mem[100] = var20001
    require ext_code.size(sub_7edc9126Address)
    staticcall sub_7edc9126Address.mem[var22003 len 4] with:
            gas gas_remaining wei
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require var26003 < 0x1e3dd18b00000000000000000000000000000000000000000000000000000000
    mem[(32 * var28001) + 128] = address(var28003)
    mem[96] = 0x574f2ba300000000000000000000000000000000000000000000000000000000
    require ext_code.size(sub_7edc9126Address)
    staticcall sub_7edc9126Address.mem[var32003 len 4] with:
            gas gas_remaining wei
    ...
    mem[100] = var38001
    require ext_code.size(sub_7edc9126Address)
    staticcall sub_7edc9126Address.mem[var40003 len 4] with:
            gas gas_remaining wei
           args mem[var40003 + 4 len var40004 - 4]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require var44003 < 0x1e3dd18b00000000000000000000000000000000000000000000000000000000
    require ext_code.size(sub_7edc9126Address)
    # nil
}
