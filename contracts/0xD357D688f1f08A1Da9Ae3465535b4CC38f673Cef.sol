...
function SFI_minter() payable {
    return sFI_minterAddress
}
...
function set_minter(address arg1) payable {
    require calldata.size - 4 >= 32
    if governanceAddress != msg.sender:
        revert with 0, 'must be governance'
    sFI_minterAddress = arg1
}
...
function mint_SFI(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    if sFI_minterAddress != msg.sender:
        revert with 0, 'must be SFI_minter'
    ...
    if ext_call.return_data[0] + arg2 >= MAX_TOKENS:
        revert with 0, 'cannot mint more than MAX_TOKENS'
    if not arg1:
...
function erc_sweep(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    if governanceAddress != msg.sender:
        revert with 0, 'must be governance'
    ...
    if not return_data.size:
        ...
        emit ErcSwept(address rg1, address rg2, address rg3, uint256 rg4):
                      msg.sender,
                      arg2,
                      0,
                      address(arg1),
        ...
        emit ErcSwept(msg.sender, address(arg2), address(arg1), ext_call.return_data[0]);
}
