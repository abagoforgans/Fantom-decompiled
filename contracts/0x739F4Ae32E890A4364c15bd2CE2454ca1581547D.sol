...
function sub_29db79c5(?) payable {
    ...
    if var104002 >= sub_4a2fc9e8.length:
    if var110001 >= sub_4a2fc9e8.length:
        revert with 'NH{q', 50
    # nil
}
...
function sub_3d81b8fa(?) payable {
    ...
    require ext_code.size(rarityAddress)
    call rarityAddress.mem[var61004 len 4] with:
         gas gas_remaining wei
...
function sub_8649fe86(?) payable {
    ...
    require ext_code.size(rarityAddress)
    call rarityAddress.mem[var69004 len 4] with:
         gas gas_remaining wei
    ...
    while idx < ('cd', 4).length:
        ...
        if mem[_35 + 12 len 20] == this.address:
            ...
            if not stor3[mem[(32 * idx) + 128]]:
                ...
                mem[0] = mem[(32 * idx) + 128]
                mem[32] = 3
                stor3[mem[(32 * idx) + 128]] = sub_4a2fc9e8.length
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
        ...
        if mem[_45 + 12 len 20] != this.address:
            ...
            if stor3[mem[(32 * idx) + 128]]:
                ...
                if sub_4a2fc9e8.length < 1:
                    revert with 'NH{q', 17
                if sub_4a2fc9e8.length - 1 != stor3[mem[(32 * idx) + 128]] - 1:
                    if sub_4a2fc9e8.length - 1 >= sub_4a2fc9e8.length:
                        revert with 'NH{q', 50
                    if stor3[mem[(32 * idx) + 128]] - 1 >= sub_4a2fc9e8.length:
                        revert with 'NH{q', 50
                    sub_4a2fc9e8[stor3[mem[(32 * idx) + 128]]] = sub_4a2fc9e8[sub_4a2fc9e8.length]
                    stor3[stor2[stor2.length]] = stor3[mem[(32 * idx) + 128]]
