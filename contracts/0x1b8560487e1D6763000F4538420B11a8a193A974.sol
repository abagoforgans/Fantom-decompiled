...
#
const name = 'BabyKabosuInu', 0

const decimals = 2

const symbol = 'BabyKabosu', 0
...
function getMultipliedFee() {
    ...
    if not stor19:
        ...
        if not stor32:
            revert with 'NH{q', 18
        if stor19 > -((stor31 * 0 / stor30) + (stor32 * 0 / stor30) - (block.timestamp * 0 / stor30) - (stor31 * stor19) - (stor32 * stor19) + (block.timestamp * stor19) / stor32) - 1:
            revert with 'NH{q', 17
