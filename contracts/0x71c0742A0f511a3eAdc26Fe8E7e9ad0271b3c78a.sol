...
uint256 poolId;
uint8 canWithdraw;
uint8 withdrawn; offset 8
uint256 sub_de88670f;
uint256 sub_7dd167c6;
uint256 sub_83475a96;
uint256 sub_f84a9bd2;
...
function sub_7dd167c6(?) payable {
    return sub_7dd167c6
}

function sub_83475a96(?) payable {
    return sub_83475a96
}
...
function sub_e0347e9e(?) payable {
    if block.timestamp > sub_7dd167c6:
        revert with 0, 'SafeMath: subtraction overflow'
    return (sub_7dd167c6 - block.timestamp)
}
...
function timeStaked() payable {
    require ext_code.size(address(masterchefAddress))
    staticcall address(masterchefAddress).0xfb39d1e3 with:
            gas gas_remaining wei
...
function sub_644f0e3a(?) payable {
    if block.timestamp > sub_7dd167c6:
        revert with 0, 'SafeMath: subtraction overflow'
    if sub_7dd167c6 - block.timestamp > 0:
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] <= 336 * 24 * 3600:
        revert with 0, '!ready'
    sub_83475a96 = block.timestamp
    if sub_83475a96 + windowLength < sub_83475a96:
        revert with 0, 'SafeMath: addition overflow'
    sub_f84a9bd2 = sub_83475a96 + windowLength
    canWithdraw = 1
    emit 0x16f2430d: msg.sender
}
...
function makeCustomTxn(address arg1, address arg2, address arg3, uint256 arg4) payable {
    ...
    if ext_call.return_data[0] >= arg4:
        ...
        idx = 96
        while 160 > idx:
            stor34[s].field_0 = mem[idx + 12 len 20]
            s = s + 1
            idx = idx + 32
            continue 
        idx = 2
        while stor34.length > idx:
            stor34[idx].field_0 = 0
            idx = idx + 1
            continue 
        ...
        if not stor34.length:
            ...
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor34.length
        else:
            mem[0] = 34
            mem[356] = address(stor34.field_0)
            idx = 356
            s = 0
            while (32 * stor34.length) + 356 > idx + 32:
            ...
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor34.length, mem[356 len 32 * stor34.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if return_data.size:
            ...
            if not return_data.size:
                ...
                mem[ceil32(return_data.size) + 653] = stor34.length
                if not stor34.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor34.length
                else:
                    mem[0] = 34
                    mem[ceil32(return_data.size) + 685] = address(stor34.field_0)
                    idx = ceil32(return_data.size) + 685
                    s = 0
                    while ceil32(return_data.size) + (32 * stor34.length) + 685 > idx + 32:
                        mem[idx + 32] = stor34[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor34.length, mem[ceil32(return_data.size) + 685 len 32 * stor34.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                mem[(2 * ceil32(return_data.size)) + 654] = stor34.length
                if not stor34.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor34.length, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                else:
                    mem[0] = 34
                    mem[(2 * ceil32(return_data.size)) + 686] = address(stor34.field_0)
                    idx = (2 * ceil32(return_data.size)) + 686
                    s = 0
                    while (2 * ceil32(return_data.size)) + (32 * stor34.length) + 686 > idx + 32:
                        mem[idx + 32] = stor34[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor34.length, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) + (32 * stor34.length) - (2 * ceil32(return_data.size))]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            if not return_data.size:
                ...
                if not stor34.length:
                    ...
                    mem[0] = 34
                    mem[684] = address(stor34.field_0)
                    idx = 684
                    s = 0
                    while (32 * stor34.length) + 684 > idx + 32:
                        mem[idx + 32] = stor34[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor34.length, mem[684 len 32 * stor34.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
...
function pause() payable {
    ...
    call wantAddress with:
       funct uint32(stor18)
         gas gas_remaining wei
        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), 0) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            ...
            if not return_data.size:
                ...
                if return_data.size <= 0:
                    ...
                    if not return_data.size:
                        ...
                        call address(masterchefAddress).emergencyWithdraw(uint256 arg1) with:
                             gas gas_remaining wei
                            args poolId, mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 791 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                else:
                    require return_data.size >= 32
                    if not mem[ceil32(return_data.size) + 621]:
                        revert with 0, 
