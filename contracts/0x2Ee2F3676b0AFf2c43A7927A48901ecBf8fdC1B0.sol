...
uint8 decimals;
address sub_51645e28Address; offset 8
...
function sub_6d64073b(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_51645e28Address = arg1
}
...
function mint(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    if owner != msg.sender:
        if sub_51645e28Address != msg.sender:
            revert with 0, 'caller is not the owner or F4DP'
    if not arg1:
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if arg1 == 57005:
        ...
        if arg2 > balanceOf[address(msg.sender)]:
            revert with 0, 32, 34, 0x6442455032303a206275726e20616d6f756e7420657863656564732062616c616e63, mem[162 len 30], mem[222 len 2]
        ...
        if not arg2:
            if 0 > arg2:
                revert with 0, 'SafeMath: subtraction overflow'
            if arg2 != arg2:
                revert with 0, 32, 33, 0x734644593a3a7472616e736665723a204275726e2076616c756520696e76616c69, mem[325 len 31]
            if msg.sender == 57005:
                revert with 0, 32, 33, 0x6f42455032303a206275726e2066726f6d20746865207a65726f20616464726573, mem[325 len 31]
            if 0 > balanceOf[address(msg.sender)]:
                revert with 0, 32, 34, 0x6442455032303a206275726e20616d6f756e7420657863656564732062616c616e63, mem[290 len 30], mem[350 len 2]
            if 0 > totalSupply:
                revert with 0, 'SafeMath: subtraction overflow'
