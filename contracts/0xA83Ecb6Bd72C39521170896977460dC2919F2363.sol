...
function sub_103d9908(?) payable {
    ...
    require ext_code.size(Mask(112, 0, ext_call.return_data[0]))
    staticcall Mask(112, 0, ext_call.return_data[0]).decimals() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(Mask(112, 0, ext_call.return_data[32]))
    staticcall Mask(112, 0, ext_call.return_data[32]).decimals() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
