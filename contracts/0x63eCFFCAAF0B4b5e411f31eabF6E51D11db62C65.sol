...
function sub_da858dae(?) payable {
    ...
    return (ext_call.return_data[18 len 14] * ext_call.return_data[50 len 14] / ext_call.return_data[18 len 14] + arg2)
}

function sub_b7aa2564(?) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(arg1)
    staticcall arg1.getReserves() with:
            gas gas_remaining wei
    ...
    require return_data.size >= 96
    require ext_call.return_data[18 len 14] + arg2
    return (ext_call.return_data[50 len 14] - (ext_call.return_data[18 len 14] * ext_call.return_data[50 len 14] / ext_call.return_data[18 len 14] + arg2))
}

function sub_884ccf7c(?) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(arg1)
...
function sub_199b1e59(?) payable {
    ...
    return (arg2 / ext_call.return_data[50 len 14] - (ext_call.return_data[18 len 14] * ext_call.return_data[50 len 14] / ext_call.return_data[18 len 14] + arg2))
}
...
function sub_619d4e2f(?) payable {
    ...
    if sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[ceil32(arg1.length) + floor32(arg1.length) + 198 len arg1.length % 32]) == _5:
        ...
        staticcall 0x991152411a7b5a14a8cf0cdde8439435328070df.0xe6a43905 with:
                gas gas_remaining wei
               args address(arg2), arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_f994e6e9(?) payable {
    ...
    if -100 * 10^uint8(ext_call.return_data[0]) > 0:
        revert with 0, 'ds-math-sub-underflow'
    if not 98 * 10^uint8(ext_call.return_data[0]):
        if -10^uint8(ext_call.return_data[0]) > 0:
            revert with 0, 'ds-math-sub-underflow'
        return -10^uint8(ext_call.return_data[0])
    require 98 * 10^uint8(ext_call.return_data[0])
    if (98 * ext_call.return_data[18 len 14] * 10^uint8(ext_call.return_data[0])) - (98 * ext_call.return_data[50 len 14] * 10^uint8(ext_call.return_data[0])) - (9800 * 10^uint8(ext_call.return_data[0]) * 10^uint8(ext_call.return_data[0])) / 98 * 10^uint8(ext_call.return_data[0]) != ext_call.return_data[18 len 14] - ext_call.return_data[50 len 14] - (100 * 10^uint8(ext_call.return_data[0])):
        revert with 0, 'ds-math-mul-overflow'
    if -10^uint8(ext_call.return_data[0]) > 0:
        revert with 0, 'ds-math-sub-underflow'
    return ((98 * ext_call.return_data[18 len 14] * 10^uint8(ext_call.return_data[0])) - (98 * ext_call.return_data[50 len 14] * 10^uint8(ext_call.return_data[0])) - (9800 * 10^uint8(ext_call.return_data[0]) * 10^uint8(ext_call.return_data[0])) - 10^uint8(ext_call.return_data[0]))
}
