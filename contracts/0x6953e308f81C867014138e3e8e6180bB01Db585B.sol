...
function sub_1f73fa8c(?) payable {
    ...
    staticcall 0xf491e7b69e4244ad4002bc14e878a34207e38c29.getAmountOut(uint256 arg1, uint256 arg2, uint256 arg3) with:
            gas gas_remaining wei
           args 1, ext_call.return_data[0] << 144, Mask(112, 0, ext_call.return_data[32])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
