...
array of address sub_69bf6f67;
array of address sub_3489b9a0;
...
function sub_3489b9a0(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_3489b9a0.length
    return sub_3489b9a0[arg1]
}
...
function sub_69bf6f67(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_69bf6f67.length
    return sub_69bf6f67[arg1]
}
