...
function flipSaleStatus() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    uint256(stor18) = not bool(uint8(isSaleActive)) or Mask(248, 8, uint256(stor18))
}
...
function sub_af39f3fa(?) {
    ...
    if not arg2:
        ...
        while idx < _44:
            ...
            t = t + 32
            continue 
        emit 0xaabe451b: mem[mem[64] len _42 + (32 * _44) + -mem[64] + 64]
        _86 = mem[64]
        mem[mem[64]] = 32
        _88 = mem[96]
        mem[mem[64] + 32] = mem[96]
