...
function sub_c3c1829e(?) payable {
    ...
    if Mask(255, 1, ('cd', 36).length):
        ...
        mem[mem[64] + 128] = (32 * _430) + 160
        _500 = mem[_498]
        mem[mem[64] + (32 * _430) + 192] = mem[_498]
        mem[mem[64] + (32 * _430) + 224 len 32 * _500] = mem[_498 + 32 len 32 * _500]
        return mem[mem[64] len 128], (32 * _430) + 160, mem[mem[64] + 160 len (32 * _430) + (32 * _500) + 64]
    idx = ('cd', 36).length / 2
    s = 0
    s = var56007
    while idx < ('cd', 36).length - 1:
