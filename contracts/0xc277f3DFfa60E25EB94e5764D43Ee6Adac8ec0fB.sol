...
#
const MAXIMUM_REFERRAL_BP = 2000
...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        if not block.number - poolInfo[idx].field_512:
            ...
            call sub_17809b17Address.0x40c10f19 with:
                 gas gas_remaining wei
        ...
        if (block.number * sub_d6ed7bf1) - (poolInfo[idx].field_512 * sub_d6ed7bf1) / block.number - poolInfo[idx].field_512 != sub_d6ed7bf1:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (block.number * sub_d6ed7bf1) - (poolInfo[idx].field_512 * sub_d6ed7bf1):
            _141 = mem[64]
            mem[64] = mem[64] + 64
            mem[_141] = 26
            ...
            revert with memory
              from mem[64]
               len _206 + -mem[64] + 100
        require (block.number * sub_d6ed7bf1) - (poolInfo[idx].field_512 * sub_d6ed7bf1)
        if (block.number * sub_d6ed7bf1 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_d6ed7bf1 * poolInfo[idx].field_256) / (block.number * sub_d6ed7bf1) - (poolInfo[idx].field_512 * sub_d6ed7bf1) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _145 = mem[64]
        mem[64] = mem[64] + 64
        mem[_145] = 26
        ...
        call sub_17809b17Address.0x40c10f19 with:
             gas gas_remaining wei
            args devAddr, (block.number * sub_d6ed7bf1 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_d6ed7bf1 * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * sub_d6ed7bf1 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_d6ed7bf1 * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(sub_17809b17Address)
        call sub_17809b17Address.0x40c10f19 with:
             gas gas_remaining wei
            args address(this.address), (block.number * sub_d6ed7bf1 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_d6ed7bf1 * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * sub_d6ed7bf1 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_d6ed7bf1 * poolInfo[idx].field_256) / totalAllocPoint:
            _191 = mem[64]
            mem[64] = mem[64] + 64
            mem[_191] = 26
            ...
            revert with memory
              from mem[64]
               len _203 + -mem[64] + 100
        require (block.number * sub_d6ed7bf1 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_d6ed7bf1 * poolInfo[idx].field_256) / totalAllocPoint
        if 10^12 * (block.number * sub_d6ed7bf1 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_d6ed7bf1 * poolInfo[idx].field_256) / totalAllocPoint / (block.number * sub_d6ed7bf1 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_d6ed7bf1 * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _202 = mem[64]
        mem[64] = mem[64] + 64
        mem[_202] = 26
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^12 * (block.number * sub_d6ed7bf1 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_d6ed7bf1 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^12 * (block.number * sub_d6ed7bf1 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_d6ed7bf1 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _218 = mem[64]
...
function updateEmissionRate(uint256 arg1) payable {
    ...
    while idx < poolInfo.length:
        ...
        revert with memory
          from mem[64]
           len _224 + -mem[64] + 100
    emit EmissionRateUpdated(sub_d6ed7bf1, arg1, msg.sender);
    sub_d6ed7bf1 = arg1
}

function pendingLava(uint256 arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    ...
    if (block.number * sub_d6ed7bf1) - (poolInfo[arg1].field_512 * sub_d6ed7bf1) / block.number - poolInfo[arg1].field_512 != sub_d6ed7bf1:
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    if not (block.number * sub_d6ed7bf1) - (poolInfo[arg1].field_512 * sub_d6ed7bf1):
        if totalAllocPoint <= 0:
            revert with 0, 'SafeMath: division by zero'
        require totalAllocPoint
        if not 0 / totalAllocPoint:
        ...
        if userInfo[arg1][address(arg2)].field_512 < 0:
            revert with 0, 'SafeMath: addition overflow'
        return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * 0 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256 + userInfo[arg1][address(arg2)].field_512)
    require (block.number * sub_d6ed7bf1) - (poolInfo[arg1].field_512 * sub_d6ed7bf1)
    if (block.number * sub_d6ed7bf1 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_d6ed7bf1 * poolInfo[arg1].field_256) / (block.number * sub_d6ed7bf1) - (poolInfo[arg1].field_512 * sub_d6ed7bf1) != poolInfo[arg1].field_256:
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    if totalAllocPoint <= 0:
        revert with 0, 'SafeMath: division by zero'
    require totalAllocPoint
    if not (block.number * sub_d6ed7bf1 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_d6ed7bf1 * poolInfo[arg1].field_256) / totalAllocPoint:
        if ext_call.return_data[0] <= 0:
            revert with 0, 'SafeMath: division by zero'
        require ext_call.return_data[0]
        if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
        ...
        if userInfo[arg1][address(arg2)].field_512 < 0:
            revert with 0, 'SafeMath: addition overflow'
        return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (0 / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256 + userInfo[arg1][address(arg2)].field_512)
    require (block.number * sub_d6ed7bf1 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_d6ed7bf1 * poolInfo[arg1].field_256) / totalAllocPoint
    if 10^12 * (block.number * sub_d6ed7bf1 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_d6ed7bf1 * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * sub_d6ed7bf1 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_d6ed7bf1 * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if ext_call.return_data[0] <= 0:
        revert with 0, 'SafeMath: division by zero'
    require ext_call.return_data[0]
    if poolInfo[arg1].field_768 + (10^12 * (block.number * sub_d6ed7bf1 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_d6ed7bf1 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
        revert with 0, 'SafeMath: addition overflow'
    if not userInfo[arg1][address(arg2)].field_0:
        if userInfo[arg1][address(arg2)].field_256 > 0:
            revert with 0, 'SafeMath: subtraction overflow'
        ...
        return (-userInfo[arg1][address(arg2)].field_256 + userInfo[arg1][address(arg2)].field_512)
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * sub_d6ed7bf1 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_d6ed7bf1 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (block.number * sub_d6ed7bf1 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_d6ed7bf1 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * sub_d6ed7bf1 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_d6ed7bf1 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    if userInfo[arg1][address(arg2)].field_512 < 0:
        revert with 0, 'SafeMath: addition overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * sub_d6ed7bf1 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_d6ed7bf1 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256 + userInfo[arg1][address(arg2)].field_512)
}
