...
function sub_21814f90(?) payable {
    ...
    if arg1 != sub_f43acfd5:
        ...
        if not ext_call.return_data[0]:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 553 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, 0 / sub_2f624bc8) >> 32
            call wantAddress with:
               funct uint32(stor4)
                 gas gas_remaining wei
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 553 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, BURN_FEE * ext_call.return_data[0] / sub_2f624bc8) >> 32
            call wantAddress with:
               funct uint32(stor4)
                 gas gas_remaining wei
