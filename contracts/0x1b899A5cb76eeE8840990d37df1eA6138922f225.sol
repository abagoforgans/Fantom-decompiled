    ...
    if not ('cd', 4).length:
        ...
        if not ('cd', 4).length:
            ...
            while idx < ('cd', 4).length - 1:
                ...
                require return_data.size >= 96
                _312 = mem[_298]
                require mem[_298] == mem[_298 + 18 len 14]
                require mem[_298 + 32] == mem[_298 + 50 len 14]
                require mem[_298 + 64] == mem[_298 + 92 len 4]
                require idx < mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
                _348 = mem[(32 * idx) + (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224]
                require idx < mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
                mem[mem[(32 * idx) + (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224] + 32] = mem[_298 + 50 len 14]
                mem[_348] = Mask(112, 0, _312)
                idx = idx + 1
                continue 
            mem[mem[64]] = 32
            _302 = mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
            ...
            while idx < ('cd', 4).length - 1:
                ...
                require idx < mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
                _448 = mem[(32 * idx) + (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224]
                require idx < mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
                mem[mem[(32 * idx) + (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224] + 32] = mem[_428 + 50 len 14]
                mem[_448] = Mask(112, 0, _432)
                idx = idx + 1
                continue 
            mem[mem[64]] = 32
            _430 = mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
            mem[mem[64] + 32] = mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
            idx = 0
            s = (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224
            t = mem[64] + 64
        ...
        if not ('cd', 4).length:
            ...
            while idx < ('cd', 4).length - 1:
                ...
                require idx < mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
                _350 = mem[(32 * idx) + (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224]
                require idx < mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
                mem[mem[(32 * idx) + (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224] + 32] = mem[_300 + 50 len 14]
                mem[_350] = Mask(112, 0, _313)
                idx = idx + 1
                continue 
            mem[mem[64]] = 32
            _305 = mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
            mem[mem[64] + 32] = mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
            idx = 0
            s = (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224
            t = mem[64] + 64
            ...
            while idx < ('cd', 4).length - 1:
                ...
                require idx < mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
                _449 = mem[(32 * idx) + (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224]
                require idx < mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
                mem[mem[(32 * idx) + (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224] + 32] = mem[_429 + 50 len 14]
                mem[_449] = Mask(112, 0, _433)
                idx = idx + 1
                continue 
            mem[mem[64]] = 32
            _431 = mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
            mem[mem[64] + 32] = mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192]
            idx = 0
            s = (64 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224
            t = mem[64] + 64
