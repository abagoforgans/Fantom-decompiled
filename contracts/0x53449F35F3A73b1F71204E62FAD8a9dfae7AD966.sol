...
function sub_b1a475ef(?) {
    ...
    mem[64] = ceil32(return_data.size) + 192
    require return_data.size >= 32
    _66 = mem[192 len 4], Mask(224, 32, arg1) >> 32
    require mem[192 len 4], Mask(224, 32, arg1) >> 32 <= 4294967296
    require mem[192 len 4], Mask(224, 32, arg1) >> 32 + 32 <= return_data.size
    require mem[mem[192 len 4], Mask(224, 32, arg1) >> 32 + 192] <= 4294967296 and mem[192 len 4], Mask(224, 32, arg1) >> 32 + (32 * mem[mem[192 len 4], Mask(224, 32, arg1) >> 32 + 192]) + 32 <= return_data.size
    mem[ceil32(return_data.size) + 192] = mem[mem[192 len 4], Mask(224, 32, arg1) >> 32 + 192]
    _69 = mem[_66 + 192]
    mem[ceil32(return_data.size) + 224 len floor32(mem[_66 + 192])] = mem[_66 + 224 len floor32(mem[_66 + 192])]
    require 1 < mem[ceil32(return_data.size) + 192]
    if not mem[ceil32(return_data.size) + 256]:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[(32 * _69) + ceil32(return_data.size) + 288] = ext_call.return_data[12 len 20]
        mem[(32 * _69) + ceil32(return_data.size) + 320] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
        mem[(32 * _69) + ceil32(return_data.size) + 324] = arg1
        mem[(32 * _69) + ceil32(return_data.size) + 356] = 0 / slippage
        mem[(32 * _69) + ceil32(return_data.size) + 420] = this.address
        mem[(32 * _69) + ceil32(return_data.size) + 452] = block.timestamp
        mem[(32 * _69) + ceil32(return_data.size) + 388] = 160
        mem[(32 * _69) + ceil32(return_data.size) + 484] = 2
        mem[(32 * _69) + ceil32(return_data.size) + 516 len 0] = None
        require ext_code.size(uniswapRouterAddress)
        call uniswapRouterAddress.swapExactTokensForETH(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args arg1, 0 / slippage, Array(len=2, data=mem[(32 * _69) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
    else:
        if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
            revert with 0, 
                        ...
                        mem[(32 * _69) + ceil32(return_data.size) + 325 len 31]
        if slippage <= 0:
            revert with 0, ':divErr'
        require slippage
        require ext_code.size(uniswapRouterAddress)
        ...
        mem[(32 * _69) + ceil32(return_data.size) + 320] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
        mem[(32 * _69) + ceil32(return_data.size) + 324] = arg1
        mem[(32 * _69) + ceil32(return_data.size) + 356] = 100 * mem[ceil32(return_data.size) + 256] / slippage
        mem[(32 * _69) + ceil32(return_data.size) + 420] = this.address
        mem[(32 * _69) + ceil32(return_data.size) + 452] = block.timestamp
        mem[(32 * _69) + ceil32(return_data.size) + 388] = 160
        mem[(32 * _69) + ceil32(return_data.size) + 484] = 2
        ...
        call uniswapRouterAddress.swapExactTokensForETH(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args arg1, 100 * mem[ceil32(return_data.size) + 256] / slippage, Array(len=2, data=mem[(32 * _69) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(32 * _69) + ceil32(return_data.size) + 320 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (32 * _69) + (2 * ceil32(return_data.size)) + 320
    require return_data.size >= 32
    require mem[(32 * _69) + ceil32(return_data.size) + 320 len 4], Mask(224, 32, arg1) >> 32 <= 4294967296
    require mem[(32 * _69) + ceil32(return_data.size) + 320 len 4], Mask(224, 32, arg1) >> 32 + 32 <= return_data.size
    require mem[(32 * _69) + ceil32(return_data.size) + mem[(32 * _69) + ceil32(return_data.size) + 320 len 4], Mask(224, 32, arg1) >> 32 + 320] <= 4294967296 and mem[(32 * _69) + ceil32(return_data.size) + 320 len 4], Mask(224, 32, arg1) >> 32 + (32 * mem[(32 * _69) + ceil32(return_data.size) + mem[(32 * _69) + ceil32(return_data.size) + 320 len 4], Mask(224, 32, arg1) >> 32 + 320]) + 32 <= return_data.size
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    if not arg2:
        ...
        _197 = mem[_192 + 192]
        mem[ceil32(return_data.size) + 224 len floor32(mem[_192 + 192])] = mem[_192 + 224 len floor32(mem[_192 + 192])]
        require 1 < mem[ceil32(return_data.size) + 192]
        if not mem[ceil32(return_data.size) + 256]:
            if slippage <= 0:
                revert with 0, ':divErr'
            ...
            if 0 / slippage:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(32 * _197) + ceil32(return_data.size) + 516 len 0] = None
                require ext_code.size(uniswapRouterAddress)
                call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args 0, 0 / slippage, 160, address(this.address), block.timestamp, 2, mem[(32 * _197) + ceil32(return_data.size) + 516 len 64]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        else:
            if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                revert with 0, 
                            ...
                            33,
                            0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            mem[(32 * _197) + ceil32(return_data.size) + 325 len 31]
            if slippage <= 0:
                revert with 0, ':divErr'
            require slippage
            emit 0x93c3b255: 0
            ...
            if 100 * mem[ceil32(return_data.size) + 256] / slippage:
                ...
                call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args 0, 100 * mem[ceil32(return_data.size) + 256] / slippage, 160, address(this.address), block.timestamp, 2, mem[(32 * _197) + ceil32(return_data.size) + 516 len 64]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        require arg2 <= balanceOf[msg.sender]
        ...
        mem[64] = ceil32(return_data.size) + 192
        require return_data.size >= 32
        _190 = mem[192 len 4], Mask(224, 32, 25 * arg2 / 100) >> 32
        ...
        if not mem[ceil32(return_data.size) + 256]:
            ...
            if 0 / slippage:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(32 * _196) + ceil32(return_data.size) + 516 len 0] = None
                require ext_code.size(uniswapRouterAddress)
                call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args 25 * arg2 / 100, 0 / slippage, Array(len=2, data=mem[(32 * _196) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        else:
            if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                revert with 0, 
                            ...
                            33,
                            0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            mem[(32 * _196) + ceil32(return_data.size) + 325 len 31]
            if slippage <= 0:
                revert with 0, ':divErr'
            require slippage
            emit 0x93c3b255: (25 * arg2 / 100)
            ...
            if 100 * mem[ceil32(return_data.size) + 256] / slippage:
                ...
                call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args 25 * arg2 / 100, 100 * mem[ceil32(return_data.size) + 256] / slippage, Array(len=2, data=mem[(32 * _196) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        ...
        if arg1 != this.address:
            ...
            if arg1 != ext_call.return_data[12 len 20]:
                if arg1 != 0xf491e7b69e4244ad4002bc14e878a34207e38c29:
                    ...
                    mem[64] = ceil32(return_data.size) + 192
                    require return_data.size >= 32
                    _310 = mem[192 len 4], 0
                    require mem[192 len 4], 0 <= 4294967296
                    require mem[192 len 4], 0 + 32 <= return_data.size
                    require mem[mem[192 len 4], 0 + 192] <= 4294967296 and mem[192 len 4], 0 + (32 * mem[mem[192 len 4], 0 + 192]) + 32 <= return_data.size
                    mem[ceil32(return_data.size) + 192] = mem[mem[192 len 4], 0 + 192]
                    _315 = mem[_310 + 192]
                    mem[ceil32(return_data.size) + 224 len floor32(mem[_310 + 192])] = mem[_310 + 224 len floor32(mem[_310 + 192])]
                    require 1 < mem[ceil32(return_data.size) + 192]
                    if not mem[ceil32(return_data.size) + 256]:
                        if slippage <= 0:
                            revert with 0, ':divErr'
                        ...
                        if 0 / slippage:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            mem[(32 * _315) + ceil32(return_data.size) + 516 len 0] = None
                            require ext_code.size(uniswapRouterAddress)
                            call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args 0, 0 / slippage, 160, address(this.address), block.timestamp, 2, mem[(32 * _315) + ceil32(return_data.size) + 516 len 64]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    else:
                        if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                            revert with 0, 
                                        ...
                                        33,
                                        0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                        mem[(32 * _315) + ceil32(return_data.size) + 325 len 31]
                        if slippage <= 0:
                            revert with 0, ':divErr'
                        require slippage
                        emit 0x93c3b255: 0
                        ...
                        if 100 * mem[ceil32(return_data.size) + 256] / slippage:
                            ...
                            call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args 0, 100 * mem[ceil32(return_data.size) + 256] / slippage, 160, address(this.address), block.timestamp, 2, mem[(32 * _315) + ceil32(return_data.size) + 516 len 64]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
        require arg3 <= balanceOf[address(arg1)]
        ...
        if arg1 != this.address:
            ...
            if arg1 != ext_call.return_data[12 len 20]:
                if arg1 != 0xf491e7b69e4244ad4002bc14e878a34207e38c29:
                    ...
                    mem[64] = ceil32(return_data.size) + 192
                    require return_data.size >= 32
                    _308 = mem[192 len 4], Mask(224, 32, 25 * arg3 / 100) >> 32
                    ...
                    _314 = mem[_308 + 192]
                    mem[ceil32(return_data.size) + 224 len floor32(mem[_308 + 192])] = mem[_308 + 224 len floor32(mem[_308 + 192])]
                    require 1 < mem[ceil32(return_data.size) + 192]
                    if not mem[ceil32(return_data.size) + 256]:
                        if slippage <= 0:
                            revert with 0, ':divErr'
                        ...
                        if 0 / slippage:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            mem[(32 * _314) + ceil32(return_data.size) + 516 len 0] = None
                            require ext_code.size(uniswapRouterAddress)
                            call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args 25 * arg3 / 100, 0 / slippage, Array(len=2, data=mem[(32 * _314) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    else:
                        if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                            revert with 0, 
                                        ...
                                        33,
                                        0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                        mem[(32 * _314) + ceil32(return_data.size) + 325 len 31]
                        if slippage <= 0:
                            revert with 0, ':divErr'
                        require slippage
                        emit 0x93c3b255: (25 * arg3 / 100)
                        ...
                        if 100 * mem[ceil32(return_data.size) + 256] / slippage:
                            ...
                            call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args 25 * arg3 / 100, 100 * mem[ceil32(return_data.size) + 256] / slippage, Array(len=2, data=mem[(32 * _314) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
