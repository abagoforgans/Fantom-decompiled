...
function sub_103d9908(?) payable {
    ...
    staticcall stor[mem[arg1.length + 160 len ceil32(arg1.length)]][Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0)].factory() with:
    ...
    return 0, 
           ...
           Mask(112, 0, ext_call.return_data[32]) / uint8(10^uint8(ext_call.return_data[0])),
