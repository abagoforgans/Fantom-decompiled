...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if not address(cd[(arg5 + 132)]):
        ...
        mem[(12 * ceil32(return_data.size)) + 640] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[(13 * ceil32(return_data.size)) + 676] = ext_call.return_data[0]
        require ext_code.size(address(cd[(arg5 + 196)]))
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        mem[(14 * ceil32(return_data.size)) + 672] = address(cd[(arg5 + 196)])
        mem[(14 * ceil32(return_data.size)) + 704] = address(cd[(arg5 + 164)])
        mem[(14 * ceil32(return_data.size)) + 736] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
        mem[(14 * ceil32(return_data.size)) + 740] = ext_call.return_data[0]
        idx = 0
        s = (14 * ceil32(return_data.size)) + 672
        t = (14 * ceil32(return_data.size)) + 932
        while idx < 2:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
        ...
        call address(cd[(arg5 + 100)]).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], 1, Array(len=2, data=mem[(14 * ceil32(return_data.size)) + 932 len 64]), address(this.address), block.timestamp
    else:
        require ext_code.size(address(cd[(arg5 + 68)]))
        staticcall address(cd[(arg5 + 68)]).factory() with:
                gas gas_remaining wei
        ...
        mem[(13 * ceil32(return_data.size)) + 640] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[(14 * ceil32(return_data.size)) + 676] = ext_call.return_data[0]
        require ext_code.size(address(cd[(arg5 + 196)]))
        call address(cd[(arg5 + 196)]).approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args address(cd[(arg5 + 100)]), ext_call.return_data[0]
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        mem[(15 * ceil32(return_data.size)) + 672] = address(cd[(arg5 + 196)])
        mem[(15 * ceil32(return_data.size)) + 704] = address(cd[(arg5 + 228)])
        mem[(15 * ceil32(return_data.size)) + 736] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
        mem[(15 * ceil32(return_data.size)) + 740] = ext_call.return_data[0]
        mem[(15 * ceil32(return_data.size)) + 772] = 1
        mem[(15 * ceil32(return_data.size)) + 804] = 160
        mem[(15 * ceil32(return_data.size)) + 900] = 2
        idx = 0
        s = (15 * ceil32(return_data.size)) + 672
        t = (15 * ceil32(return_data.size)) + 932
        while idx < 2:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
            t = t + 32
            continue 
        mem[(15 * ceil32(return_data.size)) + 836] = this.address
        mem[(15 * ceil32(return_data.size)) + 868] = block.timestamp
        require ext_code.size(address(cd[(arg5 + 100)]))
        call address(cd[(arg5 + 100)]).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], 1, Array(len=2, data=mem[(15 * ceil32(return_data.size)) + 932 len 64]), address(this.address), block.timestamp
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[(16 * ceil32(return_data.size)) + 740] = address(cd[(arg5 + 100)])
        mem[(16 * ceil32(return_data.size)) + 772] = ext_call.return_data[0]
        require ext_code.size(address(cd[(arg5 + 196)]))
        call address(cd[(arg5 + 196)]).approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args address(cd[(arg5 + 100)]), ext_call.return_data[0]
        ...
        mem[(18 * ceil32(return_data.size)) + 832] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
        mem[(18 * ceil32(return_data.size)) + 836] = ext_call.return_data[0]
        idx = 0
        s = (18 * ceil32(return_data.size)) + 768
        t = (18 * ceil32(return_data.size)) + 1028
        while idx < 2:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
        ...
        call address(cd[(arg5 + 132)]).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], cd[(arg5 + 36)], Array(len=2, data=mem[(18 * ceil32(return_data.size)) + 1028 len 64]), address(this.address), block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(cd[(arg5 + 164)]))
    staticcall address(cd[(arg5 + 164)]).0x70a08231 with:
