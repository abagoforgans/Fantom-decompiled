...
function balanceOfPool() payable {
    ...
    _4 = mem[96 len 4], Mask(224, 0, stor14.field_32)
    require uint32(stor14.field_0), address(this.address) << 64 <= 4294967296
    require uint32(stor14.field_0), address(this.address) << 64 + 32 <= return_data.size
    require mem[uint32(stor14.field_0), address(this.address) << 64 + 96] <= 4294967296 and uint32(stor14.field_0), address(this.address) << 64 + (32 * mem[uint32(stor14.field_0), address(this.address) << 64 + 96]) + 32 <= return_data.size
    mem[ceil32(return_data.size) + 96] = mem[uint32(stor14.field_0), address(this.address) << 64 + 96]
    _8 = mem[uint32(stor14.field_0), address(this.address) << 64 + 96]
    mem[ceil32(return_data.size) + 128 len floor32(mem[uint32(stor14.field_0), address(this.address) << 64 + 96])] = mem[uint32(stor14.field_0), address(this.address) << 64 + 128 len floor32(mem[uint32(stor14.field_0), address(this.address) << 64 + 96])]
    mem[64] = (32 * _8) + ceil32(return_data.size) + 128
    require 0, mem[164 len 28] <= 4294967296
    require 0, mem[164 len 28] + 32 <= return_data.size
    require mem[0, mem[164 len 28] + 96] <= 4294967296 and 0, mem[164 len 28] + (32 * mem[0, mem[164 len 28] + 96]) + 32 <= return_data.size
    return _4
}
...
function balanceOf() payable {
    ...
    return (ext_call.return_data[0] + _4)
}
