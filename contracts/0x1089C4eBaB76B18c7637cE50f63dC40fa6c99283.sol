        ...
        if stor4[address(arg1)]:
            ...
            if not arg2:
                ...
                if balanceOf[arg1] + arg2 < balanceOf[arg1]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[address(arg1)] = balanceOf[arg1] + arg2
                if balanceOf[stor3] > -1:
                    revert with 0, 17
                if balanceOf[stor3] < balanceOf[stor3]:
                    revert with 0, 'SafeMath: addition overflow'
                ...
                if balanceOf[stor3] > !(arg2 * taxFee / 100 / 100):
                    revert with 0, 17
                if balanceOf[stor3] + (arg2 * taxFee / 100 / 100) < balanceOf[stor3]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor3] += arg2 * taxFee / 100 / 100
    ...
    if stor4[address(arg1)]:
        ...
        if stor4[address(arg2)]:
            ...
            if not arg3:
                ...
                if balanceOf[stor3] > !(arg3 * taxFee / 100 / 100):
                    revert with 0, 17
                if balanceOf[stor3] + (arg3 * taxFee / 100 / 100) < balanceOf[stor3]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor3] += arg3 * taxFee / 100 / 100
