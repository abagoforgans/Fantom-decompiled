...
function sub_c3fc44b6(?) payable {
    ...
    mem[96 len 64] = code.data[2321 len 64]
    mem[160 len 64] = code.data[2321 len 64]
    mem[224 len 64] = code.data[2321 len 64]
    idx = cd[196]
    while idx < cd[228]:
        require cd[196] < 2
...
function sub_209afece(?) payable {
    ...
    if address(cd[((32 * cd[100]) + cd[36] + 36)]) < address(cd[((32 * cd[100]) + cd[68] + 36)]):
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 96
        require cd[100] < ext_call.return_data[0]
        require cd[100] < ext_call.return_data[0]
        if address(cd[((32 * cd[100]) + cd[36] + 36)]) == address(cd[((32 * cd[100]) + cd[36] + 36)]):
            mem[(32 * cd[100]) + 128] = Mask(112, 0, ext_call.return_data[0])
        else:
            mem[(32 * cd[100]) + 128] = Mask(112, 0, ext_call.return_data[32])
    else:
        ...
        if address(cd[((32 * cd[100]) + cd[36] + 36)]) == address(cd[((32 * cd[100]) + cd[68] + 36)]):
            ...
            mem[(32 * cd[100]) + 128] = Mask(112, 0, ext_call.return_data[32])
    mem[192 len 2048] = ext_call.return_data[32], 64, mem[192 len 1984]
