...
function feeAddresses(uint256 arg1) {
...
function setFeeAddresses(uint256 arg1, address arg2) {
    require calldata.size - 4 >= 64
    require arg2 == arg2
    if feeAddress != msg.sender:
        if owner != msg.sender:
...
function massHarvestFromStrategies() {
    ...
    while idx < strategies.length:
        ...
        if strategies[idx]:
            ...
            call strategies[idx].harvest() with:
                 gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        idx = idx + 1
...
function emergencyWithdraw(uint256 arg1, address arg2) {
    ...
    if rewarder[arg1]:
        ...
        if userInfo[arg1][msg.sender].field_0 <= ext_call.return_data[0]:
            require arg1 < lpToken.length
            mem[ceil32(return_data.size) + 196 len 96] = transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, userInfo[arg1][msg.sender].field_0, mem[ceil32(return_data.size) + 196 len 28]
            ...
            call strategies[arg1].withdraw(uint256 arg1) with:
                 gas gas_remaining wei
            ...
            if 2 * ext_call.return_data[0] < ext_call.return_data[0]:
                revert with 0, 'SafeMath: addition overflow'
            require arg1 < lpToken.length
            mem[(2 * ceil32(return_data.size)) + 196 len 96] = transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, 2 * ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 196 len 28]
