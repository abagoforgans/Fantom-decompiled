...
function getOfferDetails(uint256 arg1) {
    ...
    if stor7[stor6[arg1]].field_0 != arg1:
        revert with 0, 'offer not registered'
    mem[96] = stor4[arg1].field_768
    if not stor4[arg1].field_768:
        mem[(32 * stor4[arg1].field_768) + 128] = stor4[arg1].field_1024
        if not stor4[arg1].field_1024:
            mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 160] = address(stor4[arg1].field_0)
            mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 192] = address(stor4[arg1].field_256)
            mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 224] = stor4[arg1].field_512
            mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 256] = 192
            mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 352] = stor4[arg1].field_768
            idx = 0
            s = 128
            t = (32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 384
            while idx < stor4[arg1].field_768:
                ...
                t = t + 32
                continue 
            mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 288] = (96 * stor4[arg1].field_768) + 224
        else:
            mem[(32 * stor4[arg1].field_768) + 160] = stor4[arg1][4].field_0
            idx = (32 * stor4[arg1].field_768) + 160
            s = 0
            while (32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 128 > idx:
            ...
            while idx < stor4[arg1].field_768:
                ...
                t = t + 32
                continue 
            mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 288] = (32 * stor4[arg1].field_768) + 224
        mem[(64 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 384] = stor4[arg1].field_1024
        mem[(64 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 416 len 32 * stor4[arg1].field_1024] = mem[(32 * stor4[arg1].field_768) + 160 len 32 * stor4[arg1].field_1024]
        mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 320] = stor4[arg1].field_1536
        return memory
          from (32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 160
           len (96 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 256
    mem[128] = address(stor4[arg1][3].field_0)
    idx = 128
    s = 0
    while (32 * stor4[arg1].field_768) + 96 > idx:
        mem[idx + 32] = address(stor4[arg1][s + 3].field_256)
        idx = idx + 32
        s = s + 1
        continue 
    mem[64] = (32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 160
    mem[(32 * stor4[arg1].field_768) + 128] = stor4[arg1].field_1024
    if not stor4[arg1].field_1024:
        mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 160] = address(stor4[arg1].field_0)
        mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 192] = address(stor4[arg1].field_256)
    ...
    while idx < stor4[arg1].field_768:
        ...
        continue 
    mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 288] = (32 * stor4[arg1].field_768) + 224
    mem[(64 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 384] = mem[(32 * stor4[arg1].field_768) + 128]
    mem[(64 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 416 len 32 * mem[(32 * stor4[arg1].field_768) + 128]] = mem[(32 * stor4[arg1].field_768) + 160 len 32 * mem[(32 * stor4[arg1].field_768) + 128]]
    mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 320] = stor4[arg1].field_1536
    return memory
      from mem[64]
       len (64 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + (32 * mem[(32 * stor4[arg1].field_768) + 128]) + -mem[64] + 416
}
