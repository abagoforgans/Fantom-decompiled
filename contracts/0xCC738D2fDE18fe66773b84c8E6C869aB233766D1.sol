...
const pairCodeHash = sha3(code.data[1823 len 8919])

const INIT_CODE_PAIR_HASH = sha3(code.data[1823 len 8896], mem[17984 len 9], Mask(112, 72, code.data[10728 len 14]) >> 72)
