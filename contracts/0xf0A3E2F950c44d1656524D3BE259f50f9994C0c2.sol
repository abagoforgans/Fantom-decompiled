...
const sub_4d749d33(?) = 10

const sub_69ceec35(?) = 3

const sub_7a907771(?) = 2

const symbol = 'MVFB Chapter I', 0
...
function approve(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    require arg2 == arg2
    require arg3 == arg3
    require ext_code.size(0x2f54a6a28798e2e9c91b13a914916fb60a14861)
    staticcall 0x2f54a6a28798e2e9c91b13a914916fb60a14861.getApproved(uint256 arg1) with:
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        require ext_code.size(0x2f54a6a28798e2e9c91b13a914916fb60a14861)
        staticcall 0x2f54a6a28798e2e9c91b13a914916fb60a14861.ownerOf(uint256 arg1) with:
                gas gas_remaining wei
               args arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if arg1 != 9:
            ...
            if arg1 != 11:
                if arg2 > -1:
                    revert with 'NH{q', 17
                return arg2
        if arg2 > 0x3fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
            revert with 'NH{q', 17
        return (4 * arg2)
                        ...
                        if arg1 == 6:
                            ...
                            if arg1 == 7:
                                ...
                                if arg1 == 8:
                                    ...
                                    if arg1 == 9:
                                        if uint32(arg3) - 10 / 2 > 0x7ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffa:
                                            revert with 'NH{q', 17
                                        if (uint32(arg3) - 10 / 2) + 5 > 0:
                                            if (uint32(arg3) - 10 / 2) + 5 and arg2 > -1 / (uint32(arg3) - 10 / 2) + 5:
                                                revert with 'NH{q', 17
                                            return ((5 * arg2) + (uint32(arg3) - 10 / 2 * arg2))
                                    else:
                                        if arg1 == 10:
