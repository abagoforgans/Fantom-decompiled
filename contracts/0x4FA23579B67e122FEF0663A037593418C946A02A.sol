...
const lp = 0x84311ecc54d7553378c067282940b0fdfb913675

const ice = 0xf16e81dce15b08f326220742020379b855b87df9

const sorbettiere = 0x5200cb2cee4b6144b2b2984e246b52bb1afcbd0
...
array of struct sub_3df44a46;
address owner;

function sub_3df44a46(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_3df44a46.length
    return sub_3df44a46[arg1].field_0
}
...
function withdraw(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Owner required'
    require ext_code.size(0x5200cb2cee4b6144b2b2984e246b52bb1afcbd0)
    call 0x05200cb2cee4b6144b2b2984e246b52bb1afcbd0.withdraw(uint256 rg1, uint256 rg2) with:
         gas gas_remaining wei
        args 1, arg1
    if not ext_call.success:
...
function deposit(uint256 arg1) payable {
    ...
    if not ext_code.size(0x84311ecc54d7553378c067282940b0fdfb913675):
        revert with 0, 'Address: call to non-contract'
    mem[292 len 96] = unknown_0x23b872dd(?????), msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
    mem[416 len 4] = 0
    mem[388 len 0] = 0
    call 0x84311ecc54d7553378c067282940b0fdfb913675 with:
         gas gas_remaining wei
    ...
    require ext_code.size(0x5200cb2cee4b6144b2b2984e246b52bb1afcbd0)
    call 0x05200cb2cee4b6144b2b2984e246b52bb1afcbd0.deposit(uint256 rg1, uint256 rg2) with:
         gas gas_remaining wei
        args 1, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function depositAll() payable {
    if owner != msg.sender:
        revert with 0, 'Owner required'
    require ext_code.size(0x84311ecc54d7553378c067282940b0fdfb913675)
    staticcall 0x84311ecc54d7553378c067282940b0fdfb913675.0x70a08231 with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function harvest() payable {
    if owner != msg.sender:
        revert with 0, 'Owner required'
    require ext_code.size(0x5200cb2cee4b6144b2b2984e246b52bb1afcbd0)
    staticcall 0x5200cb2cee4b6144b2b2984e246b52bb1afcbd0.userInfo(uint256 rg1, address rg2) with:
            gas gas_remaining wei
           args 1, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(0xf16e81dce15b08f326220742020379b855b87df9)
    staticcall 0xf16e81dce15b08f326220742020379b855b87df9.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not ext_call.return_data[0]:
        ...
        mem[164] = 160
        mem[260] = sub_3df44a46.length
        if not sub_3df44a46.length:
            ...
            call 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args 0, 0, 0, 160, address(this.address), block.timestamp + 1800, sub_3df44a46.length
        else:
            mem[0] = 1
            mem[292] = address(sub_3df44a46.field_0)
            idx = 292
            s = 0
            while (32 * sub_3df44a46.length) + 292 > idx + 32:
                mem[idx + 32] = sub_3df44a46[s].field_256
                idx = idx + 32
                s = s + 1
                continue 
            require ext_code.size(0x1b02da8cb0d097eb8d57a175b88c7d8b47997506)
            call 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args 0, 0, 0, 160, address(this.address), block.timestamp + 1800, sub_3df44a46.length, mem[292 len 32 * sub_3df44a46.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_code.size(0x1b02da8cb0d097eb8d57a175b88c7d8b47997506)
        call 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506.addLiquidity(address rg1, address rg2, uint256 rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint256 rg8) with:
             gas gas_remaining wei
            args 0xf16e81dce15b08f326220742020379b855b87df9, 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83, 0, ext_call.return_data[0], 0, 0, this.address, block.timestamp + 1800
    else:
        ...
        if not sub_3df44a46.length:
            ...
            call 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args 0, uint32(50 * ext_call.return_data[0] / 100), 0, 160, address(this.address), block.timestamp + 1800, sub_3df44a46.length
        else:
            mem[0] = 1
            mem[292] = address(sub_3df44a46.field_0)
            idx = 292
            ...
            call 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args 0, uint32(50 * ext_call.return_data[0] / 100), 0, 160, address(this.address), block.timestamp + 1800, sub_3df44a46.length, mem[292 len 32 * sub_3df44a46.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[96 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = ceil32(return_data.size) + 96
        ...
        call 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506.addLiquidity(address rg1, address rg2, uint256 rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint256 rg8) with:
             gas gas_remaining wei
            args 0xf16e81dce15b08f326220742020379b855b87df9, 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83, 50 * ext_call.return_data[0] / 100, ext_call.return_data[0], 0, 0, this.address, block.timestamp + 1800
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdrawAll() payable {
    ...
    if not return_data.size:
        ...
        if not ext_code.size(0xf16e81dce15b08f326220742020379b855b87df9):
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = 0, msg.sender, ext_call.return_data[0 len 28]
        call 0xf16e81dce15b08f326220742020379b855b87df9 with:
           funct uint32(msg.sender)
             gas gas_remaining wei
...
function reApprove() payable {
    require ext_code.size(0xf16e81dce15b08f326220742020379b855b87df9)
    staticcall 0xf16e81dce15b08f326220742020379b855b87df9.0xdd62ed3e with:
            gas gas_remaining wei
           args this.address, 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if not ext_code.size(0xf16e81dce15b08f326220742020379b855b87df9):
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address rg1, uint256 rg2), 0x1b02da8cb0d097eb8d57a175, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    mem[324 len 0] = 0
    call 0xf16e81dce15b08f326220742020379b855b87df9.0x47997506 with:
         gas gas_remaining wei
        args Mask(480, -256, approve(address rg1, uint256 rg2), 0x1b02da8cb0d097eb8d57a175, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address rg1, uint256 rg2), 0x1b02da8cb0d097eb8d57a175, 0, -1
        if not approve(address rg1, uint256 rg2), 0x1b02da8cb0d097eb8d57a175:
            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        require ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83)
        ...
        if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = 0, 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0x47997506 with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if not approve(address rg1, uint256 rg2), 0x1b02da8cb0d097eb8d57a175:
                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[534 len 22]
            require ext_code.size(0x84311ecc54d7553378c067282940b0fdfb913675)
            staticcall 0x84311ecc54d7553378c067282940b0fdfb913675.0xdd62ed3e with:
                    gas gas_remaining wei
                   args this.address, 0x5200cb2cee4b6144b2b2984e246b52bb1afcbd0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0]:
            ...
            if not ext_code.size(0x84311ecc54d7553378c067282940b0fdfb913675):
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = 0, 0x5200cb2cee4b6144b2b2984e246b52bb1afcbd0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call 0x84311ecc54d7553378c067282940b0fdfb913675.0xb1afcbd0 with:
                 gas gas_remaining wei
            ...
            if not ext_code.size(0x84311ecc54d7553378c067282940b0fdfb913675):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 589 len 64] = 0, 0x5200cb2cee4b6144b2b2984e246b52bb1afcbd0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call 0x84311ecc54d7553378c067282940b0fdfb913675.0xb1afcbd0 with:
                 gas gas_remaining wei
        ...
        if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 425 len 64] = 0, 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        if not return_data.size:
            ...
            staticcall 0x84311ecc54d7553378c067282940b0fdfb913675.0xdd62ed3e with:
                    gas gas_remaining wei
                   args this.address, 0x5200cb2cee4b6144b2b2984e246b52bb1afcbd0, mem[(2 * ceil32(return_data.size)) + 494 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0]:
            ...
            if not ext_code.size(0x84311ecc54d7553378c067282940b0fdfb913675):
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 590 len 64] = 0, 0x5200cb2cee4b6144b2b2984e246b52bb1afcbd0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call 0x84311ecc54d7553378c067282940b0fdfb913675.0xb1afcbd0 with:
                 gas gas_remaining wei
