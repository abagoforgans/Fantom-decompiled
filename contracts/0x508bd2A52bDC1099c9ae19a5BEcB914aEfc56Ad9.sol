...
function bets(bytes32 arg1) {
    ...
    if stor5[arg1].field_2560:
        if stor5[arg1].field_2560 == uint255(stor5[arg1].field_2560) * 0.5 < 32:
            revert with 0, 34
        if stor5[arg1].field_2560:
            if stor5[arg1].field_2560 == uint255(stor5[arg1].field_2560) * 0.5 < 32:
                revert with 0, 34
            if Mask(256, -1, stor5[arg1].field_2560):
                if 31 >= uint255(stor5[arg1].field_2560) * 0.5:
                    mem[128] = 256 * stor5[arg1].field_2568
                else:
                    mem[128] = stor5[arg1][10].field_0
                    idx = 128
                    s = 0
                    while (uint255(stor5[arg1].field_2560) * 0.5) + 96 > idx:
        ...
        return bool(stor5[arg1].field_0), 
               ...
               Array(len=2 * Mask(256, -1, stor5[arg1].field_2560), data=mem[128 len ceil32(uint255(stor5[arg1].field_2560) * 0.5)]),
