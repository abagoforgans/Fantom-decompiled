        ...
        if not nFTBalance[arg1].field_256:
            ...
            if not nFTBalance[arg1].field_256:
                ...
                if sub_fd50644d * nFTBalance[arg1].field_256 / nFTBalance[arg1].field_256 != sub_fd50644d:
                    revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                nFTBalance[arg1].field_768 = sub_fd50644d * nFTBalance[arg1].field_256 / 10^18
            emit 0x6556253d: msg.sender, (sub_fd50644d * nFTBalance[arg1].field_256 / 10^18) - nFTBalance[arg1].field_768, arg1, block.timestamp
    else:
        if not totalStaked:
            lastRewardBlock = block.number
            if not nFTBalance[arg1].field_256:
            ...
            if not nFTBalance[arg1].field_256:
                ...
                if (sub_fd50644d * nFTBalance[arg1].field_256 / 10^18) - nFTBalance[arg1].field_768:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    emit 0x6556253d: ext_call.return_data[12 len 20], (sub_fd50644d * nFTBalance[arg1].field_256 / 10^18) - nFTBalance[arg1].field_768, arg1, block.timestamp
            if arg2 > nFTBalance[arg1].field_256:
                revert with 0, 'SafeMath: subtraction overflow'
            nFTBalance[arg1].field_256 -= arg2
            if not nFTBalance[arg1].field_256:
        ...
        while ext_call.success:
            ...
            if block.number <= lastRewardBlock:
                ...
                if not nFTBalance[ext_call.return_data[0]].field_256:
                    ...
                    mem[mem[64] + 64] = ext_call.return_data[0]
                    mem[mem[64] + 96] = block.timestamp
                    emit 0x6556253d: msg.sender, (sub_fd50644d * nFTBalance[ext_call.return_data[0]].field_256 / 10^18) - nFTBalance[ext_call.return_data[0]].field_768, ext_call.return_data[0], block.timestamp
            else:
                if not totalStaked:
                    lastRewardBlock = block.number
                    mem[0] = ext_call.return_data[0]
