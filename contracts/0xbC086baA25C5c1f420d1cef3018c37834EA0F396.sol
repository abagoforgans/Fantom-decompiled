...
function withdraw(uint256 arg1) payable {
    ...
    if arg1 <= ext_call.return_data[0]:
        ...
        call stakingTokenAddress with:
           funct uint32(stor6)
             gas gas_remaining wei
            args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0) << 256, mem[356 len 4]
        if not return_data.size:
            if not ext_call.success:
            ...
            if not ext_code.size(stakingTokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[488 len 64] = 0, address(strategyAddress), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call stakingTokenAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
                args -1, mem[392 len 28], mem[552 len 4]
            if not return_data.size:
                ...
                if not ext_call.success:
                    ...
                    revert with 0, 
                                ...
                                0x725361666545524332303a206c6f772d6c6576656c2063616c6c206661696c656420696e206d61737465,
                                mem[466 len 22],
                                Mask(80, 0, 0, address(strategyAddress), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff)
                if return_data.size:
                    require return_data.size >= 32
                    if not mem[520]:
                        revert with 0, 
            ...
            if not ext_call.success:
                ...
                revert with 0, 
                            ...
                            0x725361666545524332303a206c6f772d6c6576656c2063616c6c206661696c656420696e206d61737465,
                            mem[270 len 22],
                            Mask(80, 0, approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0)
            if return_data.size:
                require return_data.size >= 32
                if not mem[324]:
                    revert with 0, 
            ...
            if not ext_code.size(stakingTokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 489 len 64] = 0, address(strategyAddress), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call stakingTokenAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
                args -1, mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 553 len 4]
            if not return_data.size:
                ...
                if not ext_call.success:
                    ...
                    revert with 0, 
                                ...
                                0x725361666545524332303a206c6f772d6c6576656c2063616c6c206661696c656420696e206d61737465,
                                mem[ceil32(return_data.size) + 467 len 22],
                                0, address(strategyAddress), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff << 176,
                                mem[(2 * ceil32(return_data.size)) + 622 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                if return_data.size:
                    require return_data.size >= 32
                    if not mem[ceil32(return_data.size) + 521]:
