...
function onFlashLoan(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    mem[64] = mem[64] + ceil32(return_data.size)
    require return_data.size >= 32
    if ext_call.return_data[0] > mem[_187]:
        revert with 0, 'SafeMath: subtraction overflow'
    _190 = mem[352]
    mem[mem[64] + 4] = mem[396 len 20]
    mem[mem[64] + 36] = -1
    require ext_code.size(address(_190))
    call address(_190).approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args mem[mem[64] + 4], -1
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    mem[mem[64] + 36] = _199
    mem[mem[64] + 68] = address(_200)
    require ext_code.size(address(_197))
    call address(_197).liquidateBorrow(address rg1, uint256 rg2, address rg3) with:
         gas gas_remaining wei
        args mem[mem[64] + 4], _199, address(_200)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[64] = mem[64] + ceil32(return_data.size)
    ...
    call address(_205).approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
    ...
    staticcall address(_210).balanceOf(address rg1) with:
            gas gas_remaining wei
           args address(this.address)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    require ext_code.size(address(_210))
    call address(_210).redeem(uint256 rg1) with:
         gas gas_remaining wei
        args _214
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    staticcall address(_219).balanceOf(address rg1) with:
            gas gas_remaining wei
           args address(this.address)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    if mem[_222] > 0:
        ...
        call address(_224).approve(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args mem[mem[64] + 4], -1
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
        ...
        staticcall address(_232).balanceOf(address rg1) with:
                gas gas_remaining wei
               args address(this.address)
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
        ...
        require return_data.size >= 32
        mem[_239 + ceil32(return_data.size) + 96] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
        mem[_239 + ceil32(return_data.size) + 100] = _236
        mem[_239 + ceil32(return_data.size) + 132] = 1
        mem[_239 + ceil32(return_data.size) + 164] = 160
        mem[_239 + ceil32(return_data.size) + 260] = mem[_239]
        idx = 0
        s = _239 + ceil32(return_data.size) + 292
        t = _239 + 32
        while idx < mem[_239]:
            mem[s] = mem[t + 12 len 20]
            idx = idx + 1
            ...
            t = t + 32
            continue 
        mem[_239 + ceil32(return_data.size) + 196] = this.address
        mem[_239 + ceil32(return_data.size) + 228] = block.timestamp
        require ext_code.size(address(_238))
        call address(_238).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _239 + ceil32(return_data.size) + (32 * mem[_239]) + -mem[64] + 288]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64] + 4] = this.address
        require ext_code.size(arg2)
        ...
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        if ext_call.return_data[0] > mem[_262]:
            revert with 0, 'SafeMath: subtraction overflow'
