...
function sub_031fa973(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor158[address(arg1)] = 0
}

function sub_fe04e55c(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor158[address(arg1)] = 1
}
...
function mint(address arg1, string arg2) payable {
    ...
    if not stor158[address(msg.sender)]:
    ...
    if stor159[stor151].field_0:
        if stor159[stor151].field_0 == stor159[stor151].field_1 < 32:
            revert with 'NH{q', 34
        if arg2.length:
            stor159[stor151][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor159[stor151].field_0 = 0
            idx = 0
            while stor159[stor151].field_1 + 31 / 32 > idx:
                stor159[stor151][idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if stor159[stor151].field_0 == stor159[stor151].field_1 < 32:
...
function initialize() payable {
    ...
    if bool(stor152.length):
        ...
        stor152.length.field_1 = 26
        stor152.length.field_8 = 'ZooArts Non-Fungible Token' / 256
        idx = 0
    ...
    if bool(stor153.length):
        ...
        stor153.length.field_1 = 5
        stor153.length.field_8 = 'ZANFT' / 256
        idx = 0
...
function tokenURI(uint256 arg1) payable {
    ...
    if stor159[arg1].field_0:
        if stor159[arg1].field_0 == stor159[arg1].field_1 < 32:
            revert with 'NH{q', 34
        if stor159[arg1].field_0:
            if stor159[arg1].field_0 == stor159[arg1].field_1 < 32:
                revert with 'NH{q', 34
            if stor159[arg1].field_1:
                if 31 < stor159[arg1].field_1:
                    mem[128] = stor159[arg1].field_0
                    idx = 128
                    s = 0
                    while stor159[arg1].field_1 + 96 > idx:
                        mem[idx + 32] = stor159[arg1][s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, stor159[arg1].field_1), data=mem[128 len ceil32(stor159[arg1].field_1)])
                mem[128] = 256 * stor159[arg1].field_8
        else:
            if stor159[arg1].field_0 == stor159[arg1].field_1 < 32:
                revert with 'NH{q', 34
            if stor159[arg1].field_1:
                if 31 < stor159[arg1].field_1:
                    ...
                    return Array(len=2 * Mask(256, -1, stor159[arg1].field_1), data=mem[128 len ceil32(stor159[arg1].field_1)])
                mem[128] = 256 * stor159[arg1].field_8
        mem[ceil32(stor159[arg1].field_1) + 224 len ceil32(stor159[arg1].field_1)] = mem[128 len ceil32(stor159[arg1].field_1)]
        if ceil32(stor159[arg1].field_1) > stor159[arg1].field_1:
            mem[ceil32(stor159[arg1].field_1) + stor159[arg1].field_1 + 224] = 0
        return Array(len=2 * Mask(256, -1, stor159[arg1].field_1), data=mem[128 len ceil32(stor159[arg1].field_1)], mem[(2 * ceil32(stor159[arg1].field_1)) + 224 len 2 * ceil32(stor159[arg1].field_1)]), 
    if stor159[arg1].field_0 == stor159[arg1].field_1 < 32:
        revert with 'NH{q', 34
    if stor159[arg1].field_0:
        if stor159[arg1].field_0 == stor159[arg1].field_1 < 32:
        ...
        if stor159[arg1].field_1:
            if 31 < stor159[arg1].field_1:
                ...
                while stor159[arg1].field_1 + 96 > idx:
                    ...
                    s = s + 1
                    continue 
                return Array(len=stor159[arg1].field_0, data=mem[128 len ceil32(stor159[arg1].field_1)])
            mem[128] = 256 * stor159[arg1].field_8
    else:
        if stor159[arg1].field_0 == stor159[arg1].field_1 < 32:
            revert with 'NH{q', 34
    ...
    if ceil32(stor159[arg1].field_1) > stor159[arg1].field_1:
        mem[ceil32(stor159[arg1].field_1) + stor159[arg1].field_1 + 224] = 0
    return Array(len=stor159[arg1].field_0, data=mem[128 len ceil32(stor159[arg1].field_1)], mem[(2 * ceil32(stor159[arg1].field_1)) + 224 len 2 * ceil32(stor159[arg1].field_1)]), 
}
