...
function pause() payable {
    ...
    Mask(96, 0, stor13.field_160) = Mask(96, 0, not bool(paused))
}
...
function sub_dca00605(?) payable {
    ...
    if not return_data.size:
        ...
        if ext_code.size(supraAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[456 len 64] = 0, treasureAddress, stor12
        call supraAddress with:
           funct uint32(stor13.field_0)
             gas gas_remaining wei
        ...
        if ext_code.size(supraAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 457 len 64] = 0, treasureAddress, stor12
        call supraAddress with:
           funct uint32(stor13.field_0)
             gas gas_remaining wei
