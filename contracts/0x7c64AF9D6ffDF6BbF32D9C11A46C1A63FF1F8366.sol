    ...
    if not return_data.size:
        ...
        if return_data.size:
            ...
            if not mem[ceil32(return_data.size) + 292]:
                revert with 0, 'SafeERC20: ERC20 operation did not succeed'
    emit 0xcb5d13eb: address(arg1), ext_call.return_data[0]
}
...
function sub_5023ab65(?) {
    ...
    mem[ceil32(ceil32(cd[(cd[4] + ('cd', 4)[8] + 4)])) + ceil32(return_data.size) + 545 len 4] = unknown_0x23b872dd(?????)
    ...
    if not ext_code.size(address(('cd', 4).length)):
        revert with 0, 'Address: call to non-contract'
    mem[ceil32(ceil32(cd[(cd[4] + ('cd', 4)[8] + 4)])) + ceil32(return_data.size) + 709 len 128] = unknown_0x23b872dd(?????), msg.sender, address(create.new_address), ext_call.return_data[0], 0
    mem[ceil32(ceil32(cd[(cd[4] + ('cd', 4)[8] + 4)])) + ceil32(return_data.size) + 809] = 0
    call address(('cd', 4).length) with:
       funct Mask(32, 224, unknown_0x23b872dd(?????), msg.sender, address(create.new_address), ext_call.return_data[0], 0) >> 224
         gas gas_remaining wei
        args (Mask(768, -544, unknown_0x23b872dd(?????), msg.sender, address(create.new_address), ext_call.return_data[0], 0) << 544)
    if not return_data.size:
        if not ext_call.success:
            if ('cd', 4).length:
                revert with memory
    ...
    staticcall address(('cd', 4).length).0x70a08231 with:
            gas gas_remaining wei
