...
function harvestTrigger(uint256 arg1) payable {
    ...
    if 0 == ext_call.return_data[32]:
        ...
        t = (2 * ceil32(return_data.size)) + 768
        while idx < 2:
        ...
        mem[(4 * ceil32(return_data.size)) + 832] = _414
        ...
        if mem[(32 * _414 - 1) + (4 * ceil32(return_data.size)) + 864] >= stor12:
            return mem[(32 * _414 - 1) + (4 * ceil32(return_data.size)) + 864] >= stor12
        ...
        if block.timestamp - ext_call.return_data[160] < minReportDelay:
            ...
            idx = 0
            s = (2 * ceil32(return_data.size)) + 996
            t = (2 * ceil32(return_data.size)) + 832
            while idx < 2:
                mem[s] = mem[t + 12 len 20]
                idx = idx + 1
                s = s + 32
            ...
            if mem[(32 * _413 - 1) + (4 * ceil32(return_data.size)) + 928] >= stor12:
                return mem[(32 * _413 - 1) + (4 * ceil32(return_data.size)) + 928] >= stor12
            mem[mem[64] + 4] = vaultAddress
            require ext_code.size(wantAddress)
            staticcall wantAddress.0x70a08231 with:
                    gas gas_remaining wei
            ...
            if 4 * ext_call.return_data[0] <= ext_call.return_data[192]:
                ...
                if not profitFactor:
                    ...
                    idx = 0
                    s = (10 * ceil32(return_data.size)) + 1124
                    t = (10 * ceil32(return_data.size)) + 960
                    while idx < 2:
                        mem[s] = mem[t + 12 len 20]
                        idx = idx + 1
                        s = s + 32
                    ...
                    if mem[(32 * _409 - 1) + (11 * ceil32(return_data.size)) + 1056] >= stor12:
                        return mem[(32 * _409 - 1) + (11 * ceil32(return_data.size)) + 1056] >= stor12
                    mem[mem[64] + 4] = vaultAddress
                    require ext_code.size(wantAddress)
                    staticcall wantAddress.0x70a08231 with:
                            gas gas_remaining wei
                ...
                if not profitFactor:
                    ...
                    idx = 0
                    s = (10 * ceil32(return_data.size)) + 1188
                    t = (10 * ceil32(return_data.size)) + 1024
                    while idx < 2:
                        mem[s] = mem[t + 12 len 20]
                        idx = idx + 1
                        s = s + 32
                    ...
                    if mem[(32 * _412 - 1) + (11 * ceil32(return_data.size)) + 1120] >= stor12:
                        return mem[(32 * _412 - 1) + (11 * ceil32(return_data.size)) + 1120] >= stor12
                    mem[mem[64] + 4] = vaultAddress
                    require ext_code.size(wantAddress)
                    staticcall wantAddress.0x70a08231 with:
                            gas gas_remaining wei
                    ...
                    if mem[(32 * _411 - 1) + (11 * ceil32(return_data.size)) + 1120] >= stor12:
                        return mem[(32 * _411 - 1) + (11 * ceil32(return_data.size)) + 1120] >= stor12
                    mem[mem[64] + 4] = vaultAddress
                    require ext_code.size(wantAddress)
                    staticcall wantAddress.0x70a08231 with:
                            gas gas_remaining wei
