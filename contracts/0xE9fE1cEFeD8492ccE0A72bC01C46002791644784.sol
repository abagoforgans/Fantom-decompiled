    ...
    if not stor8.length:
        ...
        if not stor8.length:
            ...
            while idx < stor8.length:
                ...
                return memory
                  from mem[64]
                   len (98 * stor8.length) + (32 * _185) + -mem[64] + 320
        else:
            ...
            while idx < stor8.length:
                ...
                return memory
                  from mem[64]
                   len (98 * stor8.length) + (32 * _187) + -mem[64] + 320
    else:
        mem[128 len 32 * stor8.length] = call.data[calldata.size len 32 * stor8.length]
        if stor8.length > test266151307():
            revert with 0, 65
        ...
        if not stor8.length:
            ...
            while idx < stor8.length:
                ...
                return memory
                  from mem[64]
                   len (98 * stor8.length) + (32 * _189) + -mem[64] + 320
        else:
            mem[(32 * stor8.length) + 160 len 32 * stor8.length] = call.data[calldata.size len 32 * stor8.length]
            idx = 0
            s = ((reserve0 * diff0 * arg1) + (sub_89a6e543 * arg1) / totalSupply) - (reserve0 * diff0)
            while idx < stor8.length:
                ...
                return memory
                  from mem[64]
                   len (98 * stor8.length) + (32 * _191) + -mem[64] + 320
    mem[(64 * stor8.length) + 160] = reserve0
    mem[(64 * stor8.length) + 192] = 96
    mem[(64 * stor8.length) + 256] = stor8.length
...
function burn(address arg1, address arg2, uint256 arg3, address arg4, uint256 arg5) payable {
    ...
    if (reserve0 * diff0 * arg3) + (sub_89a6e543 * arg3) / totalSupply <= reserve0 * diff0:
        ...
        while idx < 0:
            ...
            mem[0] = mem[(32 * idx) + 128]
            mem[32] = 10
            if sub_6c391ab0[mem[(32 * idx) + 128]] < mem[(32 * idx) + 160]:
                revert with 0, 17
            sub_6c391ab0[mem[(32 * idx) + 128]] -= mem[(32 * idx) + 160]
            if idx >= 0:
                revert with 0, 50
            if s > !mem[(32 * idx) + 160]:
                revert with 0, 17
        ...
        if not stor8.length:
            ...
            while idx < stor8.length:
                ...
                if not arg5:
                    ...
                    while idx < stor8.length:
                        ...
                        mem[0] = mem[(32 * idx) + 128]
                        mem[32] = 10
                        if sub_6c391ab0[mem[(32 * idx) + 128]] < mem[(32 * idx) + (32 * stor8.length) + 160]:
                            revert with 0, 17
                        sub_6c391ab0[mem[(32 * idx) + 128]] -= mem[(32 * idx) + (32 * stor8.length) + 160]
                        if idx >= mem[(32 * stor8.length) + 128]:
                            revert with 0, 50
                    ...
                    return memory
                      from mem[64]
                       len (98 * stor8.length) + (2 * ceil32(return_data.size)) + (32 * _1795) + -mem[64] + 320
                ...
                return memory
                  from mem[64]
                   len (98 * stor8.length) + (4 * ceil32(return_data.size)) + (32 * _1796) + -mem[64] + 320
        else:
            mem[(32 * stor8.length) + 160 len 32 * stor8.length] = call.data[calldata.size len 32 * stor8.length]
            idx = 0
            s = ((reserve0 * diff0 * arg3) + (sub_89a6e543 * arg3) / totalSupply) - (reserve0 * diff0)
            while idx < stor8.length:
                ...
                if not arg5:
                    ...
                    return memory
                      from mem[64]
                       len (98 * stor8.length) + (2 * ceil32(return_data.size)) + (32 * _1799) + -mem[64] + 320
                mem[(64 * stor8.length) + ceil32(return_data.size) + 164] = arg4
                mem[(64 * stor8.length) + ceil32(return_data.size) + 196] = arg5
                require ext_code.size(token0Address)
                call token0Address.0xa9059cbb with:
                ...
                return memory
                  from mem[64]
                   len (98 * stor8.length) + (4 * ceil32(return_data.size)) + (32 * _1800) + -mem[64] + 320
    else:
        mem[128 len 32 * stor8.length] = call.data[calldata.size len 32 * stor8.length]
        if stor8.length > test266151307():
            revert with 0, 65
        ...
        if not stor8.length:
            ...
            while idx < stor8.length:
                ...
                if not arg5:
                    ...
                    return memory
                      from mem[64]
                       len (98 * stor8.length) + (2 * ceil32(return_data.size)) + (32 * _1803) + -mem[64] + 320
                mem[(64 * stor8.length) + ceil32(return_data.size) + 164] = arg4
                mem[(64 * stor8.length) + ceil32(return_data.size) + 196] = arg5
                require ext_code.size(token0Address)
                call token0Address.0xa9059cbb with:
                ...
                return memory
                  from mem[64]
                   len (98 * stor8.length) + (4 * ceil32(return_data.size)) + (32 * _1804) + -mem[64] + 320
        else:
            mem[(32 * stor8.length) + 160 len 32 * stor8.length] = call.data[calldata.size len 32 * stor8.length]
            idx = 0
            s = ((reserve0 * diff0 * arg3) + (sub_89a6e543 * arg3) / totalSupply) - (reserve0 * diff0)
            while idx < stor8.length:
                ...
                if not arg5:
                    ...
                    return memory
                      from mem[64]
                       len (98 * stor8.length) + (2 * ceil32(return_data.size)) + (32 * _1807) + -mem[64] + 320
                mem[(64 * stor8.length) + ceil32(return_data.size) + 164] = arg4
                mem[(64 * stor8.length) + ceil32(return_data.size) + 196] = arg5
                require ext_code.size(token0Address)
                call token0Address.0xa9059cbb with:
                ...
                return memory
                  from mem[64]
                   len (98 * stor8.length) + (4 * ceil32(return_data.size)) + (32 * _1808) + -mem[64] + 320
    if reserve0 < arg5:
        revert with 0, 17
    mem[(64 * stor8.length) + 164] = arg1
    mem[(64 * stor8.length) + 196] = reserve0 - arg5
