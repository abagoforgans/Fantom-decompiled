...
function supportsInterface(bytes4 arg1) payable {
    ...
    if 0xeacabe1400000000000000000000000000000000000000000000000000000000 == Mask(32, 224, arg1):
        return True
...
function mintNFT(address arg1, string arg2) payable {
    ...
    if stor10[stor11].field_0:
        if stor10[stor11].field_0 == uint255(stor10[stor11].field_0) * 0.5 < 32:
            revert with 0, 34
        if arg2.length:
            stor10[stor11][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor10[stor11].field_0 = 0
            idx = 0
            while (uint255(stor10[stor11].field_0) * 0.5) + 31 / 32 > idx:
                stor10[stor11][idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if stor10[stor11].field_0 == stor10[stor11].field_1 < 32:
            revert with 0, 34
        if arg2.length:
            stor10[stor11][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor10[stor11].field_0 = 0
            idx = 0
            while stor10[stor11].field_1 + 31 / 32 > idx:
                stor10[stor11][idx].field_0 = 0
                idx = idx + 1
                continue 
    return stor11
