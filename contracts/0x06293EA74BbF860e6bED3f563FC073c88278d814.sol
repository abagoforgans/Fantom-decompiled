...
const pairCodeHash = sha3(code.data[3463 len 14778])

const INIT_CODE_PAIR_HASH = sha3(code.data[3463 len 14752], mem[29696 len 6], Mask(160, 48, code.data[18221 len 20]) >> 48)
