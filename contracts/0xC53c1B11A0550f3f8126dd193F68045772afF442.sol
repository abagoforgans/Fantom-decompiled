...
function sub_66d24f9e(?) payable {
    ...
    call address(arg1).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
        ...
        args arg3, 0, address(this.address), 128, 64, address(arg1), address(arg2)
...
function uniswapV2Call(address arg1, uint256 arg2, uint256 arg3, bytes arg4) payable {
    ...
    if stor0 != tx.origin:
        revert with 0, 'Origin tx must be owner'
    if arg2:
        if arg3:
    ...
    if not arg2:
        ...
        staticcall address(cd[(arg4 + 68)]).getReserves() with:
                gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 96
        ...
        if not ext_call.return_data[50 len 14]:
            ...
            if not (1000 * ext_call.return_data[18 len 14]) + (997 * arg2):
                revert with 'NH{q', 18
            if 0 / (1000 * ext_call.return_data[18 len 14]) + (997 * arg2) <= (0 / (997 * Mask(112, 0, ext_call.return_data[0])) - (997 * arg2)) + 1:
                revert with 0, 'amountReceived < amountRequired'
            ...
            if not (1000 * ext_call.return_data[18 len 14]) + (997 * arg2):
                revert with 'NH{q', 18
            if 997 * arg2 * ext_call.return_data[50 len 14] / (1000 * ext_call.return_data[18 len 14]) + (997 * arg2) <= (0 / (997 * Mask(112, 0, ext_call.return_data[0])) - (997 * arg2)) + 1:
                revert with 0, 'amountReceived < amountRequired'
            require ext_code.size(address(ext_call.return_data[0]))
            call address(ext_call.return_data[0]).0xa9059cbb with:
                 gas gas_remaining wei
        ...
        if not ext_call.return_data[50 len 14]:
            ...
            if not (1000 * ext_call.return_data[18 len 14]) + (997 * arg2):
                revert with 'NH{q', 18
            if 0 / (1000 * ext_call.return_data[18 len 14]) + (997 * arg2) <= (1000 * Mask(112, 0, ext_call.return_data[32]) * arg2 / (997 * Mask(112, 0, ext_call.return_data[0])) - (997 * arg2)) + 1:
                revert with 0, 'amountReceived < amountRequired'
            require ext_code.size(address(ext_call.return_data[0]))
            call address(ext_call.return_data[0]).0xa9059cbb with:
                 gas gas_remaining wei
            ...
            if not (1000 * ext_call.return_data[18 len 14]) + (997 * arg2):
                revert with 'NH{q', 18
            if 997 * arg2 * ext_call.return_data[50 len 14] / (1000 * ext_call.return_data[18 len 14]) + (997 * arg2) <= (1000 * Mask(112, 0, ext_call.return_data[32]) * arg2 / (997 * Mask(112, 0, ext_call.return_data[0])) - (997 * arg2)) + 1:
                revert with 0, 'amountReceived < amountRequired'
            require ext_code.size(address(ext_call.return_data[0]))
            call address(ext_call.return_data[0]).0xa9059cbb with:
                 gas gas_remaining wei
