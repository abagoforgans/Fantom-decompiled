...
address owner;
uint256 stor1;
uint256 sub_5d472515;
uint256 sub_5cceeb4b;
address meowAddress;
address devaddr;
...
uint256 sub_49333f69;
uint256 sub_6d52697d;
...
function sub_5cceeb4b(?) payable {
    return sub_5cceeb4b
}

function sub_5d472515(?) payable {
    return sub_5d472515
}

function sub_6d52697d(?) payable {
    return sub_6d52697d
}
...
function availableUnlock(uint256 arg1, address arg2) payable {
    ...
    ('iszero', ('add', ('field', 1280, ('stor', ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('map', ('param', 'arg1'), ('name', 'userInfo', 8))))), ('mul', -1, ('field', 1024, ('stor', ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('map', ('param', 'arg1'), ('name', 'userInfo', 8))))))))
    revert
}
                    ...
                    if totalAllocPoint > 0:
                        ...
                        if not block.timestamp - poolInfo[idx].field_512:
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            if (0 / totalAllocPoint) + sub_6d52697d < sub_6d52697d:
                                revert with 0, 'SafeMath: addition overflow'
                            if (0 / totalAllocPoint) + sub_6d52697d <= sub_5d472515:
                                if (0 / totalAllocPoint / 10) + sub_49333f69 < sub_49333f69:
                                    revert with 0, 'SafeMath: addition overflow'
                                if (0 / totalAllocPoint / 10) + sub_49333f69 <= sub_5cceeb4b:
                                    require ext_code.size(meowAddress)
                                    call meowAddress.0x40c10f19 with:
                                         gas gas_remaining wei
                                        args this.address, 0 / totalAllocPoint / 10
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    require ext_code.size(meowAddress)
                                    call meowAddress.0x40c10f19 with:
                                    ...
                                    if (0 / totalAllocPoint / 10) + sub_49333f69 < sub_49333f69:
                                        revert with 0, 'SafeMath: addition overflow'
                                    sub_49333f69 += 0 / totalAllocPoint / 10
                                    if (0 / totalAllocPoint) + sub_6d52697d < sub_6d52697d:
                                        revert with 0, 'SafeMath: addition overflow'
                                    sub_6d52697d += 0 / totalAllocPoint
                                    if not 0 / totalAllocPoint / 10:
                                        if 0 > 0 / totalAllocPoint / 10:
                                            revert with 0, 'SafeMath: subtraction overflow'
                                        require ext_code.size(meowAddress)
                                        staticcall meowAddress.0x70a08231 with:
                                                gas gas_remaining wei
                                        ...
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        require return_data.size >= 32
                                        if sub_20f79efd * 0 / totalAllocPoint / 10 / 10000 <= ext_call.return_data[0]:
                                            mem[132] = sub_20f79efd * 0 / totalAllocPoint / 10 / 10000
                                            require ext_code.size(meowAddress)
                                            call meowAddress.0xa9059cbb with:
                                                 gas gas_remaining wei
                                                args devaddr, sub_20f79efd * 0 / totalAllocPoint / 10 / 10000
                                        else:
                                            mem[132] = ext_call.return_data[0]
                                            require ext_code.size(meowAddress)
                                            call meowAddress.0xa9059cbb with:
                                        ...
                                        if not ext_call.return_data[0]:
                                            revert with 0, 
                                                        ...
                                                        mem[219 len 9]
                                        mem[96] = 0xdd46706400000000000000000000000000000000000000000000000000000000
                                        mem[100] = (0 / totalAllocPoint / 10) - (sub_20f79efd * 0 / totalAllocPoint / 10 / 10000)
                                        require ext_code.size(developmentFundAddress)
                                        call developmentFundAddress.0xdd467064 with:
                                             gas gas_remaining wei
                                            args ((0 / totalAllocPoint / 10) - (sub_20f79efd * 0 / totalAllocPoint / 10 / 10000))
                                else:
                                    if sub_49333f69 > sub_5cceeb4b:
                                        revert with 0, 'SafeMath: subtraction overflow'
                                    require ext_code.size(meowAddress)
                                    call meowAddress.0x40c10f19 with:
                                         gas gas_remaining wei
                                        args this.address, sub_5cceeb4b - sub_49333f69
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    require ext_code.size(meowAddress)
                                    call meowAddress.0x40c10f19 with:
                                    ...
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    if sub_5cceeb4b < sub_49333f69:
                                        revert with 0, 'SafeMath: addition overflow'
                                    sub_49333f69 = sub_5cceeb4b
                                    if (0 / totalAllocPoint) + sub_6d52697d < sub_6d52697d:
                                        revert with 0, 'SafeMath: addition overflow'
                                    sub_6d52697d += 0 / totalAllocPoint
                                    if not sub_5cceeb4b - sub_49333f69:
                                        if 0 > sub_5cceeb4b - sub_49333f69:
                                            revert with 0, 'SafeMath: subtraction overflow'
                                        require ext_code.size(meowAddress)
                                        staticcall meowAddress.0x70a08231 with:
                                                gas gas_remaining wei
                                        ...
                                        if not ext_call.return_data[0]:
                                            revert with 0, 
                                                        ...
                                                        mem[219 len 9]
                                        mem[96] = 0xdd46706400000000000000000000000000000000000000000000000000000000
                                        mem[100] = sub_5cceeb4b - sub_49333f69
                                        require ext_code.size(developmentFundAddress)
                                        call developmentFundAddress.0xdd467064 with:
                                             gas gas_remaining wei
                                            args (sub_5cceeb4b - sub_49333f69)
                                    else:
                                        if (sub_5cceeb4b * sub_20f79efd) - (sub_49333f69 * sub_20f79efd) / sub_5cceeb4b - sub_49333f69 != sub_20f79efd:
                                            revert with 0, 32, 33, 0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[197 len 31]
                                        if (sub_5cceeb4b * sub_20f79efd) - (sub_49333f69 * sub_20f79efd) / 10000 > sub_5cceeb4b - sub_49333f69:
                                            revert with 0, 'SafeMath: subtraction overflow'
                                        require ext_code.size(meowAddress)
                                        staticcall meowAddress.0x70a08231 with:
                                                gas gas_remaining wei
                                        ...
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        require return_data.size >= 32
                                        if (sub_5cceeb4b * sub_20f79efd) - (sub_49333f69 * sub_20f79efd) / 10000 <= ext_call.return_data[0]:
                                            mem[132] = (sub_5cceeb4b * sub_20f79efd) - (sub_49333f69 * sub_20f79efd) / 10000
                                            require ext_code.size(meowAddress)
                                            call meowAddress.0xa9059cbb with:
                                                 gas gas_remaining wei
                                                args devaddr, (sub_5cceeb4b * sub_20f79efd) - (sub_49333f69 * sub_20f79efd) / 10000
                                        else:
                                            mem[132] = ext_call.return_data[0]
                                            require ext_code.size(meowAddress)
                                            call meowAddress.0xa9059cbb with:
                                        ...
                                        if not ext_call.return_data[0]:
                                            revert with 0, 
                                                        ...
                                                        mem[219 len 9]
                                        mem[96] = 0xdd46706400000000000000000000000000000000000000000000000000000000
                                        mem[100] = sub_5cceeb4b - sub_49333f69 - ((sub_5cceeb4b * sub_20f79efd) - (sub_49333f69 * sub_20f79efd) / 10000)
                                        require ext_code.size(developmentFundAddress)
                                        call developmentFundAddress.0xdd467064 with:
                                             gas gas_remaining wei
                                            args (sub_5cceeb4b - sub_49333f69 - ((sub_5cceeb4b * sub_20f79efd) - (sub_49333f69 * sub_20f79efd) / 10000))
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not 0 / totalAllocPoint:
                                    if ext_call.return_data[0] <= 0:
                                ...
                                if (0 / totalAllocPoint / 10) + sub_49333f69 <= sub_5cceeb4b:
                                    ...
                                    call meowAddress.0x40c10f19 with:
                                         gas gas_remaining wei
                                        args this.address, sub_5d472515 - sub_6d52697d
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    if (0 / totalAllocPoint / 10) + sub_49333f69 < sub_49333f69:
                                        revert with 0, 'SafeMath: addition overflow'
                                    sub_49333f69 += 0 / totalAllocPoint / 10
                                    if sub_5d472515 < sub_6d52697d:
                                        revert with 0, 'SafeMath: addition overflow'
                                    sub_6d52697d = sub_5d472515
                                    if not 0 / totalAllocPoint / 10:
                                        if 0 > 0 / totalAllocPoint / 10:
                                            revert with 0, 'SafeMath: subtraction overflow'
                                        require ext_code.size(meowAddress)
                                ...
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not sub_5d472515 - sub_6d52697d:
                                    if ext_call.return_data[0] <= 0:
                                        revert with 0, 'SafeMath: division by zero'
                                    require ext_call.return_data[0]
                                    if (0 / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                                    ...
                                    if (10^12 * sub_5d472515) - (10^12 * sub_6d52697d) / sub_5d472515 - sub_6d52697d != 10^12:
                                        revert with 0, 32, 33, 0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[197 len 31]
                                    if ext_call.return_data[0] <= 0:
                                        revert with 0, 'SafeMath: division by zero'
                                    require ext_call.return_data[0]
                                    if ((10^12 * sub_5d472515) - (10^12 * sub_6d52697d) / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[idx].field_768 += (10^12 * sub_5d472515) - (10^12 * sub_6d52697d) / ext_call.return_data[0]
                        else:
                            ...
                            if not (block.timestamp * meowPerSecond) - (poolInfo[idx].field_512 * meowPerSecond):
                                ...
                                if totalAllocPoint <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require totalAllocPoint
                                if ((block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint) + sub_6d52697d < sub_6d52697d:
                                    revert with 0, 'SafeMath: addition overflow'
                                if ((block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint) + sub_6d52697d <= sub_5d472515:
                                    if ((block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10) + sub_49333f69 < sub_49333f69:
                                        revert with 0, 'SafeMath: addition overflow'
                                    if ((block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10) + sub_49333f69 <= sub_5cceeb4b:
                                        require ext_code.size(meowAddress)
                                        call meowAddress.0x40c10f19 with:
                                             gas gas_remaining wei
                                            args this.address, (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        require ext_code.size(meowAddress)
                                        call meowAddress.0x40c10f19 with:
                                        ...
                                        if ((block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10) + sub_49333f69 < sub_49333f69:
                                            revert with 0, 'SafeMath: addition overflow'
                                        sub_49333f69 += (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10
                                        if ((block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint) + sub_6d52697d < sub_6d52697d:
                                            revert with 0, 'SafeMath: addition overflow'
                                        sub_6d52697d += (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint
                                        if not (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10:
                                            if 0 > (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10:
                                                revert with 0, 'SafeMath: subtraction overflow'
                                            require ext_code.size(meowAddress)
                                            staticcall meowAddress.0x70a08231 with:
                                                    gas gas_remaining wei
                                            ...
                                            if not ext_call.return_data[0]:
                                                revert with 0, 
                                                            ...
                                                            mem[219 len 9]
                                            mem[96] = 0xdd46706400000000000000000000000000000000000000000000000000000000
                                            mem[100] = (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10
                                            require ext_code.size(developmentFundAddress)
                                            call developmentFundAddress.0xdd467064 with:
                                                 gas gas_remaining wei
                                                args ((block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10)
                                        else:
                                            if sub_20f79efd * (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10 / (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10 != sub_20f79efd:
                                                revert with 0, 32, 33, 0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[197 len 31]
                                            if sub_20f79efd * (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10 / 10000 > (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10:
                                                revert with 0, 'SafeMath: subtraction overflow'
                                            require ext_code.size(meowAddress)
                                            staticcall meowAddress.0x70a08231 with:
                                                    gas gas_remaining wei
                                            ...
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                                            require return_data.size >= 32
                                            if sub_20f79efd * (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10 / 10000 <= ext_call.return_data[0]:
                                                mem[132] = sub_20f79efd * (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10 / 10000
                                                require ext_code.size(meowAddress)
                                                call meowAddress.0xa9059cbb with:
                                                     gas gas_remaining wei
                                                    args devaddr, sub_20f79efd * (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10 / 10000
                                            else:
                                                mem[132] = ext_call.return_data[0]
                                                require ext_code.size(meowAddress)
                                                call meowAddress.0xa9059cbb with:
                                            ...
                                            if not ext_call.return_data[0]:
                                                revert with 0, 
                                                            ...
                                                            mem[219 len 9]
                                            mem[96] = 0xdd46706400000000000000000000000000000000000000000000000000000000
                                            mem[100] = ((block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10) - (sub_20f79efd * (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10 / 10000)
                                            require ext_code.size(developmentFundAddress)
                                            call developmentFundAddress.0xdd467064 with:
                                                 gas gas_remaining wei
                                                args (((block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10) - (sub_20f79efd * (block.timestamp * meowPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * meowPerSecond * poolInfo[idx].field_256) / totalAllocPoint / 10 / 10000))
                                    else:
                                        if sub_49333f69 > sub_5cceeb4b:
                                            revert with 0, 'SafeMath: subtraction overflow'
                                        require ext_code.size(meowAddress)
...
function addPool(uint256 arg1, address arg2) payable {
    ...
    if meowAddress == arg2:
        revert with 0, 
                    32,
                    46,
                    0x2e4d656f774d696e696e673a3a616464506f6f6c3a3a20746865205f7374616b65546f6b656e206973206d656f77,
                    mem[210 len 18]
