...
function setParams(address arg1, address arg2, uint256 arg3, uint256 arg4) payable {
    ...
    if block.timestamp + arg3 < block.timestamp:
        revert with 0, 'SafeMath: addition overflow'
    periodFinish = block.timestamp + arg3
...
function stake(uint256 arg1) payable {
    ...
    if totalSupply:
            ...
            if not periodFinish - lastUpdateTime:
                ...
                if block.timestamp < periodFinish:
                    ...
                    if not totalSupply:
                        ...
                        if ext_code.size(uniTokenAddress) <= 0:
        ...
        if lastUpdateTime > block.timestamp:
            revert with 0, 'SafeMath: subtraction overflow'
        if periodFinish + block.timestamp - lastUpdateTime < periodFinish:
            revert with 0, 'SafeMath: addition overflow'
