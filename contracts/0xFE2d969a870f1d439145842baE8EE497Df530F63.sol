...
function subscribe(address arg1, uint8 arg2, uint256 arg3) {
    ...
    require ext_code.size(0xcdb669b1fbab30df2fbce6f8e6e176d46b54388)
    delegate 0xcdb669b1fbab30df2fbce6f8e6e176d46b54388.0xa506d954 with:
         gas gas_remaining wei
...
function sendValueToSubByte(bytes arg1, uint256 arg2, bytes32 arg3) {
    ...
    if stor20[arg2][arg3]:
        revert with 0, 'sub sent'
    stor20[arg2][arg3] = 1
    mem[arg1.length + ceil32(arg1.length) + 160] = 0xcc32a15100000000000000000000000000000000000000000000000000000000
    mem[arg1.length + ceil32(arg1.length) + 164] = 32
    mem[arg1.length + ceil32(arg1.length) + 196] = arg1.length
    if arg1.length:
        mem[arg1.length + ceil32(arg1.length) + 228] = mem[128]
        mem[arg1.length + ceil32(arg1.length) + 260 len floor32(arg1.length - 1)] = mem[160 len floor32(arg1.length - 1)]
    require ext_code.size(subscriptions[arg3].field_256)
    call subscriptions[arg3].field_256.attachValue(bytes arg1) with:
         gas gas_remaining wei
        args Array(len=arg1.length, data=mem[arg1.length + ceil32(arg1.length) + 228 len arg1.length])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
