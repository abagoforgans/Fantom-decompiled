...
const sub_8ee69042(?) = 0x5f3b5dfeb7b28cdbd7faba78963ee202a494e2a2
...
function release() payable {
    if depositorAddress != msg.sender:
        revert with 0, '!auth'
    require ext_code.size(0x5f3b5dfeb7b28cdbd7faba78963ee202a494e2a2)
    call 0x5f3b5dfeb7b28cdbd7faba78963ee202a494e2a2.withdraw() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    return 1
...
function increaseTime(uint256 arg1) payable {
    ...
    if depositorAddress != msg.sender:
        revert with 0, '!auth'
    require ext_code.size(0x5f3b5dfeb7b28cdbd7faba78963ee202a494e2a2)
    call 0x5f3b5dfeb7b28cdbd7faba78963ee202a494e2a2.increase_unlock_time(uint256 arg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function increaseAmount(uint256 arg1) payable {
    ...
    if not ext_code.size(0xd533a949740bb3306d119cc777fa900ba034cd52):
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), 0x5f3b5dfeb7b28cdbd7faba78, 0, 0
    call 0xd533a949740bb3306d119cc777fa900ba034cd52.0xa494e2a2 with:
         gas gas_remaining wei
        args 0, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), 0x5f3b5dfeb7b28cdbd7faba78, 0, 0
        if not approve(address arg1, uint256 arg2), 0x5f3b5dfeb7b28cdbd7faba78:
            revert with 0, 32, 42, 0x6c5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        if arg1:
            require ext_code.size(0xd533a949740bb3306d119cc777fa900ba034cd52)
            staticcall 0xd533a949740bb3306d119cc777fa900ba034cd52.0xdd62ed3e with:
                    gas gas_remaining wei
                   args this.address, 0x5f3b5dfeb7b28cdbd7faba78963ee202a494e2a2
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
        ...
        if not ext_code.size(0xd533a949740bb3306d119cc777fa900ba034cd52):
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = approve(address arg1, uint256 arg2), 0x5f3b5dfeb7b28cdbd7faba78, 0, Mask(224, 32, arg1) >> 32
        mem[488 len 0] = 0
        call 0xd533a949740bb3306d119cc777fa900ba034cd52.0xa494e2a2 with:
             gas gas_remaining wei
        ...
        require ext_code.size(0x5f3b5dfeb7b28cdbd7faba78963ee202a494e2a2)
        call 0x5f3b5dfeb7b28cdbd7faba78963ee202a494e2a2.increase_amount(uint256 arg1) with:
             gas gas_remaining wei
            args arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    if not return_data.size:
        ...
        if not ext_code.size(0xd533a949740bb3306d119cc777fa900ba034cd52):
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 425 len 64] = approve(address arg1, uint256 arg2), 0x5f3b5dfeb7b28cdbd7faba78, 0, Mask(224, 32, arg1) >> 32
            ...
            if return_data.size:
                ...
                if not mem[456]:
                    revert with 0, 
                                ...
                                mem[ceil32(return_data.size) + 535 len 22]
        require ext_code.size(0x5f3b5dfeb7b28cdbd7faba78963ee202a494e2a2)
        call 0x5f3b5dfeb7b28cdbd7faba78963ee202a494e2a2.create_lock(uint256 arg1, uint256 arg2) with:
             gas gas_remaining wei
            args arg1, arg2
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
