    ...
    if arg3:
        ...
        if not uint8(-ext_call.return_data[31 len 1] + 18):
            ...
            if bool(bool(uint8(-ext_call.return_data[31 len 1] + 18) < 78)) or bool(bool(uint8(-ext_call.return_data[31 len 1] + 18) < 32)):
                ...
                if not ext_code.size(arg1):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 260 len 96] = transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, arg3 / 10^uint8(-ext_call.return_data[31 len 1] + 18), 0
                mem[ceil32(return_data.size) + 328] = 0
                call arg1 with:
                   funct Mask(32, 224, transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, arg3 / 10^uint8(-ext_call.return_data[31 len 1] + 18), 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, arg3 / 10^uint8(-ext_call.return_data[31 len 1] + 18), 0) << 288)
            else:
                s = 10
                t = 1
                ...
                if not ext_code.size(arg1):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 260 len 96] = transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, arg3 / s * t, 0
                mem[ceil32(return_data.size) + 328] = 0
                call arg1 with:
                   funct Mask(32, 224, transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, arg3 / s * t, 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, arg3 / s * t, 0) << 288)
        if not return_data.size:
            if not ext_call.success:
                if ext_call.return_data[0]:
                    revert with memory
