...
function _fallback() payable {
    ...
    if unknown_0x15721f07(?????) == uint32(call.func_hash) >> 224:
        ...
        require return_data.size >= 32
        _74 = mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32
        ...
        _77 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224]
        ...
        mem[(2 * ceil32(return_data.size)) + 224] = _77
        require return_data.size >= _74 + (32 * _77) + 32
        mem[(2 * ceil32(return_data.size)) + 256 len 32 * _77] = mem[ceil32(return_data.size) + _74 + 256 len 32 * _77]
        mem[mem[64]] = 32
        mem[mem[64] + 32] = _77
        mem[mem[64] + 64 len 32 * _77] = mem[(2 * ceil32(return_data.size)) + 256 len 32 * _77]
    ...
    mem[64] = (2 * ceil32(return_data.size)) + 224
    require return_data.size >= 32
    _76 = mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32
    require mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 <= test266151307()
    require ceil32(return_data.size) + mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 255 < ceil32(return_data.size) + return_data.size + 224
    _79 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224]
    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224] > test266151307():
        revert with 0, 65
    if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224]) + 225 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224]) + 1 < 0:
        revert with 0, 65
    mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224]) + 225
    mem[(2 * ceil32(return_data.size)) + 224] = _79
    require return_data.size >= _76 + (32 * _79) + 32
    mem[(2 * ceil32(return_data.size)) + 256 len 32 * _79] = mem[ceil32(return_data.size) + _76 + 256 len 32 * _79]
    mem[mem[64]] = 32
    mem[mem[64] + 32] = _79
    mem[mem[64] + 64 len 32 * _79] = mem[(2 * ceil32(return_data.size)) + 256 len 32 * _79]
