...
function withdraw(uint256 arg1, uint256 arg2) payable {
    ...
    staticcall stor3[arg1].field_768.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(stor3[arg1].field_512)
    staticcall stor3[arg1].field_512.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not ext_call.return_data[0]:
        revert with 0, 18
    require ext_code.size(stor3[arg1].field_512)
    call stor3[arg1].field_512.transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    require ext_code.size(stor3[arg1].field_768)
    call stor3[arg1].field_768.burn(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function sub_b209fcde(?) payable {
    ...
    stor3[arg1].field_256 = arg1
    stor3[arg1].field_512 = uint64(arg2) << 96
    stor3[arg1].field_768 = address(create.new_address)
...
function mine(uint256 arg1, uint256 arg2) payable {
    ...
    if ceil32(_13) <= _13:
        _89 = uint32(arg1), mem[ceil32(return_data.size) + 132 len 28]
        ...
        _91 = mem[ceil32(return_data.size) + uint32(arg1), mem[ceil32(return_data.size) + 132 len 28] + 96]
        ...
        mem[_93] = mem[ceil32(return_data.size) + uint32(arg1), mem[ceil32(return_data.size) + 132 len 28] + 96]
        require _89 + _91 + 32 <= return_data.size
        mem[_93 + 32 len ceil32(_91)] = mem[ceil32(return_data.size) + _89 + 128 len ceil32(_91)]
        if ceil32(_91) > _91:
            mem[_93 + _91 + 32] = 0
    else:
        mem[(2 * ceil32(return_data.size)) + _13 + 128] = 0
        _90 = uint32(arg1), mem[ceil32(return_data.size) + 132 len 28]
        require uint32(arg1), mem[ceil32(return_data.size) + 132 len 28] <= test266151307()
        require ceil32(return_data.size) + uint32(arg1), mem[ceil32(return_data.size) + 132 len 28] + 127 < ceil32(return_data.size) + return_data.size + 96
        _92 = mem[ceil32(return_data.size) + uint32(arg1), mem[ceil32(return_data.size) + 132 len 28] + 96]
        if mem[ceil32(return_data.size) + uint32(arg1), mem[ceil32(return_data.size) + 132 len 28] + 96] > test266151307():
            revert with 0, 65
        _94 = mem[64]
        if mem[64] + ceil32(ceil32(mem[ceil32(return_data.size) + uint32(arg1), mem[ceil32(return_data.size) + 132 len 28] + 96])) + 1 < mem[64] or mem[64] + ceil32(ceil32(mem[ceil32(return_data.size) + uint32(arg1), mem[ceil32(return_data.size) + 132 len 28] + 96])) + 1 > test266151307():
            revert with 0, 65
        mem[64] = mem[64] + ceil32(ceil32(mem[ceil32(return_data.size) + uint32(arg1), mem[ceil32(return_data.size) + 132 len 28] + 96])) + 1
        mem[_94] = mem[ceil32(return_data.size) + uint32(arg1), mem[ceil32(return_data.size) + 132 len 28] + 96]
        require _90 + _92 + 32 <= return_data.size
        mem[_94 + 32 len ceil32(_92)] = mem[ceil32(return_data.size) + _90 + 128 len ceil32(_92)]
        if ceil32(_92) > _92:
            mem[_94 + _92 + 32] = 0
    ...
    if ext_call.return_data[0] >= -1 / mem[ceil32(return_data.size) + 192]:
        ...
        if 0 > !(-1 / ext_call.return_data[0]):
            revert with 0, 17
        require ext_code.size(stor3[arg1].field_768)
        call stor3[arg1].field_768.mint(address arg1, uint256 arg2) with:
             gas gas_remaining wei
        ...
        if not ext_call.return_data[0]:
            revert with 0, 18
        if stor3[arg1].field_1024 > !(-1 / ext_call.return_data[0]):
            revert with 0, 17
        require ext_code.size(stor3[arg1].field_768)
        call stor3[arg1].field_768.mint(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args msg.sender, stor3[arg1].field_1024 + (-1 / ext_call.return_data[0])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
