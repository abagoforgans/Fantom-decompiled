...
function sub_184da8a8(?) payable {
    return sub_184da8a8
}

function sub_32ca2876(?) payable {
    return sub_32ca2876Address
}

function supra() payable {
    return supraAddress
}

function sub_4202a912(?) payable {
...
function sub_42515f80(?) payable {
    require calldata.size - 4 >= 32
    return bool(stor15[arg1])
}

function tokenFee() payable {
    return tokenFeeAddress
}

function sub_4a9655e9(?) payable {
    require calldata.size - 4 >= 32
...
function sub_ac2743b3(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_ac2743b3.length
    return sub_ac2743b3[arg1].field_0
}

function sub_b48207b8(?) payable {
    require calldata.size - 4 >= 32
    return bool(stor8[arg1])
}

function sub_b9d8746d(?) payable {
    return sub_b9d8746d
}

function sub_df158e67(?) payable {
...
function pause() payable {
    ...
    Mask(96, 0, stor14.field_160) = Mask(96, 0, not bool(paused))
}
...
function sub_dca00605(?) payable {
    ...
    if tokenFeeAddress == supraAddress:
        if not return_data.size:
            ...
            if ext_code.size(supraAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor14.field_0), uint32(stor14.field_0), Mask(224, 0, stor13.field_32)
            call supraAddress with:
               funct uint32(stor14.field_0)
                 gas gas_remaining wei
                args Mask(480, 0, stor13.field_0), mem[520 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg1
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            ...
            if ext_code.size(supraAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 457 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor14.field_0), uint32(stor14.field_0), Mask(224, 0, stor13.field_32)
            call supraAddress with:
               funct uint32(stor14.field_0)
                 gas gas_remaining wei
                args Mask(480, 0, stor13.field_0), mem[ceil32(return_data.size) + 521 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg1
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if not return_data.size:
            ...
            if ext_code.size(tokenFeeAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[488 len 96] = unknown_0x23b872dd(?????), msg.sender, treasureAddress, Mask(224, 0, stor13.field_32)
            mem[612 len 4] = 0
            mem[584 len 0] = 0
            ...
            if return_data.size <= 0:
                if ext_code.size(tokenFeeAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 489 len 96] = unknown_0x23b872dd(?????), msg.sender, treasureAddress, Mask(224, 0, stor13.field_32)
