    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                call lpToken0Address.0xdc33ae52 with:
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address rg1, uint256 rg2), 0x16327e3fbdaca3bcf7e38f5a, 0, 0) << 256, mem[816 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address rg1, uint256 rg2), 0x9083ea3756bde6ee6f27a6e9, 0, 0
                    if not approve(address rg1, uint256 rg2), 0x9083ea3756bde6ee6f27a6e9:
                ...
                call lpToken0Address.0xdc33ae52 with:
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address rg1, uint256 rg2), 0x16327e3fbdaca3bcf7e38f5a, 0, 0) << 256, mem[ceil32(return_data.size) + 817 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address rg1, uint256 rg2), 0x9083ea3756bde6ee6f27a6e9, 0, 0
                    if not approve(address rg1, uint256 rg2), 0x9083ea3756bde6ee6f27a6e9:
        ...
        if return_data.size > 0:
            ...
            if return_data.size <= 0:
                ...
                call lpToken0Address.0xdc33ae52 with:
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address rg1, uint256 rg2), 0x16327e3fbdaca3bcf7e38f5a, 0, 0) << 256, mem[(2 * ceil32(return_data.size)) + 818 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address rg1, uint256 rg2), 0x9083ea3756bde6ee6f27a6e9, 0, 0
                    if not approve(address rg1, uint256 rg2), 0x9083ea3756bde6ee6f27a6e9:
                ...
                if return_data.size > 0:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 919 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
                    call lpToken1Address.0xdc33ae52 with:
                         gas gas_remaining wei
