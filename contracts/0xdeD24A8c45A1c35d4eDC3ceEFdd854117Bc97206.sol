...
function summit() payable {
    return address(summitAddress)
}

function sub_a3afda1a(?) payable {
...
function balanceOfPool() payable {
    ...
    staticcall sub_a3afda1aAddress.userInfo(uint16 arg1, address arg2) with:
            gas gas_remaining wei
           args uint16(stor12.field_0), this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function retireStrat() payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
    require ext_code.size(address(summitAddress))
    call address(summitAddress).withdraw(uint16 arg1, uint256 arg2, uint256 arg3) with:
         gas gas_remaining wei
        args uint16(stor12.field_0), ext_call.return_data[32], 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(wantAddress)
    staticcall wantAddress.0x70a08231 with:
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        staticcall wantAddress.0xdd62ed3e with:
                gas gas_remaining wei
               args address(this.address), address(summitAddress)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] >= ext_call.return_data[0]:
            require ext_code.size(address(summitAddress))
            call address(summitAddress).deposit(uint16 arg1, uint256 arg2, uint256 arg3, uint8 arg4) with:
                 gas gas_remaining wei
                args 0, uint32(stor12.field_0), ext_call.return_data[0], 0, 0
        else:
            ...
            if not return_data.size:
                ...
                call address(summitAddress).deposit(uint16 arg1, uint256 arg2, uint256 arg3, uint8 arg4) with:
                     gas gas_remaining wei
                    args uint16(stor12.field_0), ext_call.return_data[0], 0, 0
            else:
                ...
                if not return_data.size:
                    ...
                    call address(summitAddress).deposit(uint16 arg1, uint256 arg2, uint256 arg3, uint8 arg4) with:
                         gas gas_remaining wei
                        args uint16(stor12.field_0), ext_call.return_data[0], 0, 0, mem[(2 * ceil32(return_data.size)) + 558 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
...
function pause() payable {
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), 0
            call wantAddress with:
               funct uint32(stor7)
                 gas gas_remaining wei
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 589 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), 0
            call wantAddress with:
               funct uint32(stor7)
                 gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 590 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, 0) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256
            call wantAddress with:
               funct uint32(stor7), mem[(2 * ceil32(return_data.size)) + 494 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
                 gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                staticcall sub_a3afda1aAddress.userInfo(uint16 arg1, address arg2) with:
                        gas gas_remaining wei
                       args uint16(stor12.field_0), address(this.address), mem[(2 * ceil32(return_data.size)) + 658 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 64
                require ext_code.size(address(summitAddress))
                call address(summitAddress).withdraw(uint16 arg1, uint256 arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args uint16(stor12.field_0), ext_call.return_data[32], 0, mem[(2 * ceil32(return_data.size)) + 690 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
    else:
        mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
            if return_data.size > 0:
...
function unpause() payable {
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call wantAddress with:
               funct uint32(stor7)
                 gas gas_remaining wei
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 589 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call wantAddress with:
               funct uint32(stor7)
                 gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            staticcall wantAddress.0xdd62ed3e with:
                    gas gas_remaining wei
                   args address(this.address), address(summitAddress), mem[(2 * ceil32(return_data.size)) + 494 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0]:
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 590 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, -1) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256
            call wantAddress with:
               funct uint32(stor7), mem[(2 * ceil32(return_data.size)) + 494 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
                 gas gas_remaining wei
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, ext_call.return_data[0] - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1 - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
        ...
        call address(summitAddress).withdraw(uint16 arg1, uint256 arg2, uint256 arg3) with:
             gas gas_remaining wei
            args uint16(stor12.field_0), arg1 - ext_call.return_data[0], 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(wantAddress)
        staticcall wantAddress.0x70a08231 with:
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1) >> 32
                call wantAddress with:
                   funct uint32(stor11)
                     gas gas_remaining wei
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1 - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
    ...
    if arg5 != 3:
        if arg5 != 2:
            ...
            while outputToWantRoute.length > idx:
                ...
                continue 
            address(stor6) = arg4
            mem[196] = address(stor6)
            mem[228] = 0
            mem[160] = 68
            mem[196 len 28] = Mask(224, 0, stor6)
            mem[192 len 4] = approve(address arg1, uint256 arg2)
            mem[260] = 32
            mem[292] = 'SafeERC20: low-level call failed'
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[324 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0
            mem[416 len 4] = 0
            call wrappedAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                staticcall wrappedAddress.0xdd62ed3e with:
                        gas gas_remaining wei
                       args address(this.address), address(stor6)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if ext_call.return_data[0]:
                    revert with 0, 
                                ...
                                0x645361666545524332303a20617070726f76652066726f6d206e6f6e2d7a65726f20746f206e6f6e2d7a65726f20616c6c6f77616e63,
                                mem[446 len 10]
                mem[360] = address(stor6)
                mem[392] = -1
                mem[324] = 68
                mem[360 len 28] = Mask(224, 0, stor6)
                ...
                mem[ceil32(return_data.size) + 361] = address(stor6)
                mem[ceil32(return_data.size) + 393] = -1
                mem[ceil32(return_data.size) + 325] = 68
                mem[ceil32(return_data.size) + 361 len 28] = Mask(224, 0, stor6)
            ...
            while outputToWantRoute.length > idx:
                ...
                continue 
            address(stor6) = arg4
            mem[228] = address(stor6)
            mem[260] = 0
            mem[192] = 68
            mem[228 len 28] = Mask(224, 0, stor6)
            mem[224 len 4] = approve(address arg1, uint256 arg2)
            mem[292] = 32
            mem[324] = 'SafeERC20: low-level call failed'
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[356 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0
            mem[448 len 4] = 0
            call wrappedAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if ext_call.return_data[0]:
                    revert with 0, 
                                ...
                                0x645361666545524332303a20617070726f76652066726f6d206e6f6e2d7a65726f20746f206e6f6e2d7a65726f20616c6c6f77616e63,
                                mem[478 len 10]
                mem[392] = address(stor6)
                mem[424] = -1
                mem[356] = 68
                mem[392 len 28] = Mask(224, 0, stor6)
                mem[388 len 4] = approve(address arg1, uint256 arg2)
                mem[456] = 32
                mem[488] = 'SafeERC20: low-level call failed'
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[520 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[612 len 4] = 0
                call wrappedAddress with:
                   funct uint32(stor6)
                     gas gas_remaining wei
                ...
                mem[ceil32(return_data.size) + 393] = address(stor6)
                mem[ceil32(return_data.size) + 425] = -1
                mem[ceil32(return_data.size) + 357] = 68
                mem[ceil32(return_data.size) + 393 len 28] = Mask(224, 0, stor6)
                ...
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 521 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        while outputToWantRoute.length > idx:
            ...
            continue 
        address(stor6) = arg4
        mem[260] = address(stor6)
        mem[292] = 0
        mem[224] = 68
        mem[260 len 28] = Mask(224, 0, stor6)
        mem[256 len 4] = approve(address arg1, uint256 arg2)
        mem[324] = 32
        mem[356] = 'SafeERC20: low-level call failed'
        if ext_code.size(wrappedAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[388 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0
        mem[480 len 4] = 0
        call wrappedAddress with:
           funct uint32(stor6)
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if ext_call.return_data[0]:
                revert with 0, 
                            ...
                            0x645361666545524332303a20617070726f76652066726f6d206e6f6e2d7a65726f20746f206e6f6e2d7a65726f20616c6c6f77616e63,
                            mem[510 len 10]
            mem[424] = address(stor6)
            mem[456] = -1
            mem[388] = 68
            mem[424 len 28] = Mask(224, 0, stor6)
            mem[420 len 4] = approve(address arg1, uint256 arg2)
            mem[488] = 32
            mem[520] = 'SafeERC20: low-level call failed'
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[552 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            mem[644 len 4] = 0
            call wrappedAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
            ...
            mem[ceil32(return_data.size) + 425] = address(stor6)
            mem[ceil32(return_data.size) + 457] = -1
            mem[ceil32(return_data.size) + 389] = 68
            mem[ceil32(return_data.size) + 425 len 28] = Mask(224, 0, stor6)
            ...
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 553 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
