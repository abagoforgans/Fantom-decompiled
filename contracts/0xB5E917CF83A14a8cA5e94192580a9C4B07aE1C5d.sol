...
function sub_be1482e6(?) payable {
    ...
    stor0[msg.sender][stor0[msg.sender].field_0].field_257 = 6
    stor0[msg.sender][stor0[msg.sender].field_0].field_264 = 0x686f6d69657300000000000000000000000000000000000000000000000000
    idx = 0
    ...
    stor0[msg.sender][stor0[msg.sender].field_0].field_513 = 6
    stor0[msg.sender][stor0[msg.sender].field_0].field_520 = 0x62756762757300000000000000000000000000000000000000000000000000
    idx = 0
    ...
    return (stor0[msg.sender].field_0 - 1)
}
