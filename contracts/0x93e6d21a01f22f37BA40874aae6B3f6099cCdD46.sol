        ...
        while idx < poolInfo.length:
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _245 + 68] = mem[idx + _243 + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _304 + 68] = mem[idx + _299 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _314 + 68] = mem[idx + _303 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _327 + 68] = mem[idx + _310 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * vikingPerBlock) - (poolInfo[idx].field_512 * vikingPerBlock):
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _324 + 68] = mem[idx + _309 + 32]
                        idx = idx + 32
                        continue 
            ...
            if not totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _265 + 68] = mem[idx + _257 + 32]
                    idx = idx + 32
                    continue 
            ...
            idx = 0
            while idx < 26:
                mem[idx + _354 + 68] = mem[idx + _337 + 32]
                idx = idx + 32
                continue 
    ...
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][msg.sender].field_0:
            ...
            if -userInfo[arg1][msg.sender].field_256:
                require ext_code.size(vikingAddress)
                staticcall vikingAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if -userInfo[arg1][msg.sender].field_256 <= ext_call.return_data[0]:
                    call vikingAddress.0xa9059cbb with:
                         gas gas_remaining wei
            ...
            if not poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if (block.number * vikingPerBlock) - (poolInfo[arg1].field_512 * vikingPerBlock) / block.number - poolInfo[arg1].field_512 != vikingPerBlock:
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if (block.number * vikingPerBlock) - (poolInfo[arg1].field_512 * vikingPerBlock):
                            if (block.number * vikingPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * vikingPerBlock * poolInfo[arg1].field_256) / (block.number * vikingPerBlock) - (poolInfo[arg1].field_512 * vikingPerBlock) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if (block.number * vikingPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * vikingPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                if 10^12 * (block.number * vikingPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * vikingPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * vikingPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * vikingPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
