...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if not arg3:
        ...
        mem[64] = ceil32(s) + 128
        if s:
            mem[128 len s] = code.data[2346 len s]
        t = s
        idx = arg3
        while idx:
            require t - 1 < mem[96]
    ...
    call msg.sender.liquidateBorrow(address rg1, uint256 rg2, address rg3) with:
         gas gas_remaining wei
        args 0xecb949c68c825650fd9d0aebe0cd3796fd126e66, 100000, 0xd528697008ac67a21818751a5e3c58c8dae54696
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(arg2)
