    ...
    if not stor17.length:
        ...
        while idx < stor17.length:
            ...
            if ceil32(_1190) <= _1190:
                mem[_1183 + 36] = ceil32(_1190) + 96
                _1425 = mem[_1175]
                mem[ceil32(_1190) + _1183 + 100] = mem[_1175]
                s = 0
                while s < _1425:
                    mem[s + ceil32(_1190) + _1183 + 132] = mem[s + _1175 + 32]
                    s = s + 32
                    continue 
    ...
    if not stor17.length:
        ...
        while idx < stor17.length:
            ...
            if ceil32(_2166) <= _2166:
                mem[mem[64] + 36] = ceil32(_2166) + 96
                _2401 = mem[_2151]
                mem[ceil32(_2166) + mem[64] + 100] = mem[_2151]
                s = 0
                while s < _2401:
                    mem[s + ceil32(_2166) + mem[64] + 132] = mem[s + _2151 + 32]
                    s = s + 32
                    continue 
                ...
                if ceil32(_2402) <= _2402:
                    ...
                    staticcall stor13.getReferenceData(string rg1, string rg2) with:
                            gas gas_remaining wei
                           args 64, ceil32(_2166) + 96, mem[mem[64] + 68 len _2166 + 32], 0, mem[mem[64] + _2166 + 132 len ceil32(_2402) + ceil32(_2166) - _2166]
                    mem[mem[64] len 96] = ext_call.return_data[0 len 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _2577 = mem[64]
                    ...
                    mem[_2402 + ceil32(_2166) + mem[64] + 132] = 0
                    require ext_code.size(stor13)
                    staticcall stor13.getReferenceData(string rg1, string rg2) with:
                            gas gas_remaining wei
                           args 64, ceil32(_2166) + 96, mem[mem[64] + 68 len _2166 + 32], 0, mem[mem[64] + _2166 + 132 len ceil32(_2402) + ceil32(_2166) - _2166]
...
function onFlashLoan(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if wFTMAddress == address(cd[(arg5 + 68)]):
        ...
        require ext_code.size(sub_07a12994[address(cd[(arg5 + 68)])])
        call sub_07a12994[address(cd[(arg5 + 68)])].0xa0712d68 with:
             gas gas_remaining wei
            args cd[(arg5 + 164)]
