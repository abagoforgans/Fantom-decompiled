...
function removeTokensForEth(uint256 arg1) payable {
    ...
    call sub_c63612d5Address.removeLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
         gas gas_remaining wei
        args 0, uint32(stor2), arg1, 0, 0, address(this.address), block.timestamp + 1800
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit_all() payable {
    ...
    staticcall address(lpAddress).0x70a08231 with:
            gas gas_remaining wei
           args msg.sender
    mem[96] = ext_call.return_data[0]
    if not ext_call.success:
...
function exit() payable {
    ...
    mem[(4 * ceil32(return_data.size)) + 224] = ext_call.return_data[32]
    mem[(4 * ceil32(return_data.size)) + 256] = ext_call.return_data[64]
    ...
    call sub_c63612d5Address.removeLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
         gas gas_remaining wei
        args address(sub_4e2dadf5Address), ext_call.return_data[0], 0, 0, address(this.address), block.timestamp + 1800
    ...
    staticcall address(sub_4e2dadf5Address).0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(8 * ceil32(return_data.size)) + 320] = address(sub_4e2dadf5Address)
    require ext_code.size(sub_c63612d5Address)
    ...
    mem[(10 * ceil32(return_data.size)) + 384] = 0x791ac94700000000000000000000000000000000000000000000000000000000
    ...
    call sub_c63612d5Address.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0, 160, address(this.address), block.timestamp + 1800, 2, mem[(10 * ceil32(return_data.size)) + 580 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if eth.balance(this.address):
        call msg.sender with:
