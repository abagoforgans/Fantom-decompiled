...
const INIT_CODE_PAIR_HASH = sha3(code.data[1730 len 9088], mem[18368 len 6], Mask(160, 48, code.data[10824 len 20]) >> 48)
...
function createPair(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    if arg1 == arg2:
        revert with 0, 'BQB: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'BQB: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'BQB: PAIR_EXISTS'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[1730 len 9114]
