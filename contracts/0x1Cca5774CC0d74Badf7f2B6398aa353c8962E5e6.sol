...
function sub_7fc030b8(?) {
    ...
    staticcall address(('cd', 4)[1]).balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    ...
    while idx < ('cd', 4).length:
        ...
        staticcall address(cd[((96 * idx) + cd[4] + 100)]).balanceOf(address rg1) with:
                gas gas_remaining wei
               args this.address
        ...
        staticcall address(cd[((96 * idx) + cd[4] + 68)]).allowance(address rg1, address rg2) with:
                gas gas_remaining wei
...
function sub_7aa20e63(?) {
    ...
    require ext_code.size(address(('cd', 100)[0]))
    staticcall address(('cd', 100)[0]).allowance(address rg1, address rg2) with:
            gas gas_remaining wei
    ...
    if not cd[164]:
        if ext_call.return_data[0] >= cd[36] * cd[132]:
            ...
            while idx < cd[132]:
                ...
                mem[_228 + 132] = block.timestamp + (8760 * 24 * 3600)
                require ext_code.size(address(cd[4]))
                call address(cd[4]).mem[mem[64] len 4] with:
                     gas 500000 wei
                    args mem[mem[64] + 4 len _228 + (32 * ('cd', 100).length) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _422 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if gas_remaining < 750000:
                    ...
                    staticcall address(cd[4]).mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _610 + (32 * ('cd', 100).length) + -mem[64] + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _730 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            while idx < cd[132]:
                ...
                while s < ('cd', 100).length:
                    ...
                    u = u + 32
                    continue 
                mem[_231 + 100] = this.address
                mem[_231 + 132] = block.timestamp + (8760 * 24 * 3600)
                require ext_code.size(address(cd[4]))
                call address(cd[4]).mem[mem[64] len 4] with:
                     gas 500000 wei
                    args mem[mem[64] + 4 len _231 + (32 * ('cd', 100).length) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _423 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if gas_remaining < 750000:
                    ...
                    staticcall address(cd[4]).mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _611 + (32 * ('cd', 100).length) + -mem[64] + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _731 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] >= cd[36] * cd[132]:
            ...
            while idx < cd[132]:
                ...
                mem[_234 + 132] = block.timestamp + (8760 * 24 * 3600)
                require ext_code.size(address(cd[4]))
                call address(cd[4]).mem[mem[64] len 4] with:
                     gas cd[164] wei
                    args mem[mem[64] + 4 len _234 + (32 * ('cd', 100).length) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _424 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if gas_remaining < 750000:
                    ...
                    staticcall address(cd[4]).mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _612 + (32 * ('cd', 100).length) + -mem[64] + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _732 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            while idx < cd[132]:
                ...
                mem[_237 + 132] = block.timestamp + (8760 * 24 * 3600)
                require ext_code.size(address(cd[4]))
                call address(cd[4]).mem[mem[64] len 4] with:
                     gas cd[164] wei
                    args mem[mem[64] + 4 len _237 + (32 * ('cd', 100).length) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _425 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if gas_remaining < 750000:
                    ...
                    staticcall address(cd[4]).mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _613 + (32 * ('cd', 100).length) + -mem[64] + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _733 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
