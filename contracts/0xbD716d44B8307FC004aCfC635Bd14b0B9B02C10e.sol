...
function safeMint(address arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if tokenByIndex.length >= maximumSupply:
    ...
    if arg1:
        tokenOfOwnerByIndex[address(arg1)][stor3[address(arg1)]] = stor16
        stor7[stor16] = balanceOf[address(arg1)]
    else:
...
function mint(uint256 arg1) payable {
    ...
    while idx < arg1:
        ...
        tokenByIndex[tokenByIndex.length] = stor16
        if msg.sender:
            tokenOfOwnerByIndex[address(msg.sender)][stor3[address(msg.sender)]] = stor16
