    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0 len 28]
                ...
                if not return_data.size:
                    if not ext_call.success:
                        revert with transfer(address rg1, uint256 rg2), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0]
                    if not transfer(address rg1, uint256 rg2), Mask(224, 0, stor9):
                ...
                if paused:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        if ext_code.size(lpPairAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[388 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * withdrawalFee / 10000)) >> 32
                        call lpPairAddress with:
                           funct uint32(stor9)
                             gas gas_remaining wei
            ...
            if tx.origin == owner:
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, arg1) >> 32
                mem[324 len 0] = 0
                call lpPairAddress with:
                   funct uint32(stor9)
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    if not ext_call.success:
                        revert with transfer(address rg1, uint256 rg2), Mask(224, 0, stor9), uint32(stor9), arg1
                    if not transfer(address rg1, uint256 rg2), Mask(224, 0, stor9):
                        revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                else:
                    mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if paused:
                    ...
                    if not arg1:
                        ...
                        if ext_code.size(lpPairAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[388 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, arg1 - (arg1 * withdrawalFee / 10000)) >> 32
                        mem[452 len 0] = 0
                        call lpPairAddress with:
                           funct uint32(stor9)
                             gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0 len 28]
                call lpPairAddress with:
                   funct uint32(stor9)
                     gas gas_remaining wei
                ...
                if paused:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        if ext_code.size(lpPairAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * withdrawalFee / 10000)) >> 32
                        mem[516 len 0] = 0
                        call lpPairAddress with:
                           funct uint32(stor9)
                             gas gas_remaining wei
            ...
            if tx.origin == owner:
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, arg1) >> 32
                call lpPairAddress with:
                   funct uint32(stor9)
                     gas gas_remaining wei
                ...
                if paused:
                    ...
                    if not arg1:
                        ...
                        if ext_code.size(lpPairAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, arg1 - (arg1 * withdrawalFee / 10000)) >> 32
                        mem[516 len 0] = 0
                        call lpPairAddress with:
                           funct uint32(stor9)
                             gas gas_remaining wei
