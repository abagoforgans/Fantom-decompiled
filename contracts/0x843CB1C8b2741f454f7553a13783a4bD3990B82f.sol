...
function sub_31bbcd52(?) payable {
    ...
    require ext_code.size(stor2[0])
    staticcall stor2[0].factory() with:
    ...
    if ext_call.return_data[12 len 20] == stor1:
        ...
        if ext_call.return_data[12 len 20] != stor1:
            ...
            require ext_code.size(stor2[0])
            staticcall stor2[0].getAmountOut(uint256 arg1, uint256 arg2, uint256 arg3) with:
                    gas gas_remaining wei
        ...
        require ext_code.size(stor2[0])
        call stor2[0].swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
             gas gas_remaining wei
        ...
        while idx < ext_call.return_data[0]:
            ...
            continue 
        require ext_code.size(stor2[0])
        call stor2[0].swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
