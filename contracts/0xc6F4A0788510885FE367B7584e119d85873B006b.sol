...
function multiTransfer(address[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        if idx >= mem[(32 * arg1.length) + 128]:
            revert with 'NH{q', 50
        _104 = mem[(32 * idx) + (32 * arg1.length) + 160]
        ...
        if not taxEnabled:
            ...
            if not stor7:
                revert with 'NH{q', 18
            if sha3(mem[_114 + 32 len mem[_114]]) % stor7 == 1:
                require _104 - (_104 * stor9 / 100) - (_104 * stor8 / 100)
                if totalSupply > -_104 + (_104 * stor9 / 100) + (_104 * stor8 / 100) - 1:
                    revert with 'NH{q', 17
                totalSupply = totalSupply + _104 - (_104 * stor9 / 100) - (_104 * stor8 / 100)
                mem[0] = address(_102)
                mem[32] = 0
                if balanceOf[address(_102)] > -_104 + (_104 * stor9 / 100) + (_104 * stor8 / 100) - 1:
                    revert with 'NH{q', 17
                balanceOf[address(_102)] = balanceOf[address(_102)] + _104 - (_104 * stor9 / 100) - (_104 * stor8 / 100)
                emit Transfer((_104 - (_104 * stor9 / 100) - (_104 * stor8 / 100)), 0, address(_102));
            emit Transfer((_104 - (_104 * stor9 / 100) - (_104 * stor8 / 100)), msg.sender, address(_102));
            emit Transfer((_104 * stor9 / 100), msg.sender, marketingAddress);
            mem[_113 + 128] = _104 * stor8 / 100
            emit Transfer((_104 * stor8 / 100), msg.sender, 0);
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
