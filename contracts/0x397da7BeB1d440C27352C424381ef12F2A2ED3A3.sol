...
#
const startBlock = 20973440

const ownerNATIVEReward = 1111

const NATIVEMaxSupply = 1690420 * 10^18

const NATIVE = 0xe961278f3b0b92dea45ab89421cb0d1961c6563a
...
function getMultiplier(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0xe961278f3b0b92dea45ab89421cb0d1961c6563a)
    staticcall 0xe961278f3b0b92dea45ab89421cb0d1961c6563a.0x18160ddd with:
...
function add(uint256 arg1, address arg2, address arg3) payable {
    ...
    if block.number > 20973440:
        poolInfo[poolInfo.length].field_512 = block.number
    else:
        poolInfo[poolInfo.length].field_512 = 20973440
...
function inCaseTokensGetStuck(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 == 0xe961278f3b0b92dea45ab89421cb0d1961c6563a:
        revert with 0, '!safe'
                ...
                if block.number - poolInfo[arg1].field_512 > 0:
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not 0 / totalAllocPoint:
                            require ext_code.size(0xe961278f3b0b92dea45ab89421cb0d1961c6563a)
                            call 0xe961278f3b0b92dea45ab89421cb0d1961c6563a.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 0
                        else:
