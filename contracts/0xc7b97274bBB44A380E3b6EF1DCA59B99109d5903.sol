...
function getKey(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
...
function approve(address arg1, uint256 arg2) payable {
    ...
    if stor11[msg.sender][('map', ('param', 'arg1'), ('param', 'arg2'))]:
    ...
    stor11[msg.sender][('map', ('param', 'arg1'), ('param', 'arg2'))] = 1
    ...
    if sub_7d70ae89[arg1][arg2] >= threshold:
        ...
        while idx < owners.length:
            ...
            mem[32] = sha3(owners[idx], 11)
            stor11[stor4[idx]][('map', ('param', 'arg1'), ('param', 'arg2'))] = 0
            idx = idx + 1
            continue 
    return 1
}
...
function addOwner(address arg1, uint256 arg2) payable {
    ...
    if arg2 > owners.length + 1:
        revert with 0, 'MultiSig: invalid threshold'
    if stor12[msg.sender][('map', ('param', 'arg1'), ('param', 'arg2'))]:
        revert with 0, 32, 34, 0x644d756c74695369673a20796f7527766520616c7265616479207369676e65642069, mem[282 len 30]
    sub_9979ea89[arg1][arg2]++
    stor12[msg.sender][('map', ('param', 'arg1'), ('param', 'arg2'))] = 1
    ...
    if sub_9979ea89[arg1][arg2] >= threshold:
        ...
        while idx < owners.length:
            mem[0] = sha3(arg1, arg2)
            mem[32] = sha3(owners[idx], 12)
            stor12[stor4[idx]][('map', ('param', 'arg1'), ('param', 'arg2'))] = 0
            idx = idx + 1
            continue 
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if stor10[msg.sender][('map', ('param', 'arg1'), ('param', 'arg2'))]:
        revert with 0, 32, 34, 0x644d756c74695369673a20796f7527766520616c7265616479207369676e65642069, mem[282 len 30]
    sub_1eb515f3[arg1][arg2]++
    stor10[msg.sender][('map', ('param', 'arg1'), ('param', 'arg2'))] = 1
    ...
    if sub_1eb515f3[arg1][arg2] >= threshold:
        ...
        while idx < owners.length:
            ...
            stor10[stor4[idx]][('map', ('param', 'arg1'), ('param', 'arg2'))] = 0
            idx = idx + 1
            continue 
    return 1
}
