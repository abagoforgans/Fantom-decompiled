    ...
    if 0x6b2615470a606dbc879e63d1cd212282504b6c8c != msg.sender:
        if 0xe8dd23472f9cb963fdaee7c1fc3b6900c47c73f7 != msg.sender:
            if 0xdc86c8e21e1e2301214652cef352c990a81c5a60 != msg.sender:
                if 0x19da21f58ec2043d35db87dcdd3985f6fb15983f != msg.sender:
                    if 0x5d07f0a238421b2194c98bdb6015aab918bbedd1 != msg.sender:
                        revert with 0, 'E1'
    ...
    if msg.sender == 0x6b2615470a606dbc879e63d1cd212282504b6c8c:
        ...
        if msg.sender == 0xe8dd23472f9cb963fdaee7c1fc3b6900c47c73f7:
            ...
            if msg.sender == 0xdc86c8e21e1e2301214652cef352c990a81c5a60:
                ...
                if msg.sender == 0x19da21f58ec2043d35db87dcdd3985f6fb15983f:
                    idx = 0
                    while idx < arg2:
                        mem[mem[64] len arg3.length] = arg3[all]
                        mem[arg3.length + mem[64]] = 0
    ...
    if msg.sender == 0x6b2615470a606dbc879e63d1cd212282504b6c8c:
        ...
        while idx < ('cd', 4).length:
            ...
            call address(cd[((32 * idx) + cd[4] + 36)]).mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)] + _22 + -mem[64] - 4]
            if return_data.size:
                _32 = mem[64]
                mem[64] = mem[64] + ceil32(return_data.size) + 1
                mem[_32] = return_data.size
            ...
            if msg.sender == 0xdc86c8e21e1e2301214652cef352c990a81c5a60:
                ...
                while idx < ('cd', 4).length:
                    ...
                    call address(cd[((32 * idx) + cd[4] + 36)]).mem[mem[64] len 4] with:
                       value cd[((32 * idx) + cd[36] + 36)] wei
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len cd[(cd[68] + cd[(cd[68] + (32 * idx) + 36)] + 36)] + _20 + -mem[64] - 4]
                    if return_data.size:
                        _30 = mem[64]
                        mem[64] = mem[64] + ceil32(return_data.size) + 1
                        mem[_30] = return_data.size
                ...
                if msg.sender == 0x19da21f58ec2043d35db87dcdd3985f6fb15983f:
                    ...
                    while idx < ('cd', 4).length:
                        ...
                        call address(cd[((32 * idx) + cd[4] + 36)]).mem[mem[64] len 4] with:
                           value cd[((32 * idx) + cd[36] + 36)] wei
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len cd[(cd[68] + cd[(cd[68] + (32 * idx) + 36)] + 36)] + _18 + -mem[64] - 4]
                        if return_data.size:
                            _28 = mem[64]
                            mem[64] = mem[64] + ceil32(return_data.size) + 1
                            mem[_28] = return_data.size
        ...
        if unknown_0x61602f8a(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x3d7a7c44(?????) <= uint32(call.func_hash) >> 224:
                        ...
                        if msg.sender == 0xe8dd23472f9cb963fdaee7c1fc3b6900c47c73f7:
                            ...
                            while idx < cd[36]:
                                ...
                                if return_data.size:
                                    _483 = mem[64]
                                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                                    mem[_483] = return_data.size
                                    mem[_483 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if idx == -1:
                                    revert with 0, 17
                                idx = idx + 1
                                continue 
                            ...
                            if msg.sender == 0xdc86c8e21e1e2301214652cef352c990a81c5a60:
                                ...
                                while idx < cd[36]:
                                    ...
                                    if return_data.size:
                                        _482 = mem[64]
                                        mem[64] = mem[64] + ceil32(return_data.size) + 1
                                        mem[_482] = return_data.size
                                        mem[_482 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                    if idx == -1:
                                        revert with 0, 17
                                    idx = idx + 1
                                    continue 
                                ...
                                if msg.sender == 0x19da21f58ec2043d35db87dcdd3985f6fb15983f:
                                    ...
                                    while idx < cd[36]:
                                        ...
                                        if return_data.size:
                                            _480 = mem[64]
                                            mem[64] = mem[64] + ceil32(return_data.size) + 1
                                            mem[_480] = return_data.size
                                            mem[_480 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                        if idx == -1:
                                            revert with 0, 17
                                        idx = idx + 1
                                        continue 
                if unknown_0x4b8acda4(?????) == uint32(call.func_hash) >> 224:
                    require calldata.size - 4 >= 96
                    require cd[4] == address(cd[4])
                    require cd[68] <= test266151307()
                    require cd[68] + 35 < calldata.size
                    ...
                    while idx < ('cd', 68).length:
                        ...
                        idx = idx + 1
                        continue 
                if uint32(call.func_hash) >> 224 != unknown_0x4c3a512d(?????):
                    if uint32(call.func_hash) >> 224 != unknown_0x51e5fb90(?????):
                    ...
                    if not ('cd', 4).length:
                        ...
                        mem[mem[64] + 64 len 32 * _471] = mem[160 len 32 * _471]
                        return 32, mem[mem[64] + 32 len (32 * _471) + 32]
                    ...
                    _473 = mem[128]
                    mem[mem[64] + 32] = mem[128]
                    mem[mem[64] + 64 len 32 * _473] = mem[160 len 32 * _473]
                    return 32, mem[mem[64] + 32 len (32 * _473) + 32]
                require not msg.value
                require calldata.size - 4 >= 32
                require cd[4] <= test266151307()
                require cd[4] + 35 < calldata.size
                ...
                if not ('cd', 4).length:
                    ...
                    while idx < ('cd', 4).length:
                        ...
                        if 0xd4c98901563ca730332e841edbcb801fe9f2551 == mem[_486 + 12 len 20]:
                            _524 = mem[64]
                            mem[64] = mem[64] + 96
                            if idx >= ('cd', 4).length:
                                revert with 0, 50
                            ...
                            mem[mem[64] + 4] = mem[_541 + 12 len 20]
                            mem[mem[64] + 36] = 0xd4c98901563ca730332e841edbcb801fe9f2551
                            require ext_code.size(0xce761d788df608bd21bdd59d6f4b54b2e27f25bb)
                            staticcall 0xce761d788df608bd21bdd59d6f4b54b2e27f25bb.isApprovedForAll(address arg1, address arg2) with:
                                    gas gas_remaining wei
                    ...
                    mem[(32 * ('cd', 4).length) + 160 len 96] = call.data[calldata.size len 96]
                    mem[var24001] = (32 * ('cd', 4).length) + 160
                    s = var24001
                    idx = var24002
                    while idx - 1:
                        mem[64] = mem[64] + 96
                    ...
                    while idx < ('cd', 4).length:
                        ...
                        if 0xd4c98901563ca730332e841edbcb801fe9f2551 == mem[_699 + 12 len 20]:
                            _703 = mem[64]
                            mem[64] = mem[64] + 96
                            if idx >= ('cd', 4).length:
                                revert with 0, 50
                            ...
                            mem[mem[64] + 4] = mem[_708 + 12 len 20]
                            mem[mem[64] + 36] = 0xd4c98901563ca730332e841edbcb801fe9f2551
                            require ext_code.size(0xce761d788df608bd21bdd59d6f4b54b2e27f25bb)
                            staticcall 0xce761d788df608bd21bdd59d6f4b54b2e27f25bb.isApprovedForAll(address arg1, address arg2) with:
                                    gas gas_remaining wei
                            ...
                            if msg.sender == 0xe8dd23472f9cb963fdaee7c1fc3b6900c47c73f7:
                                ...
                                while idx < ('cd', 4).length:
                                    ...
                                    call address(cd[((32 * idx) + cd[4] + 36)]).mem[mem[64] len 4] with:
                                       value cd[((32 * idx) + cd[36] + 36)] wei
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len cd[(cd[68] + cd[(cd[68] + (32 * idx) + 36)] + 36)] + _537 + -mem[64] - 4]
                                    if return_data.size:
                                        _561 = mem[64]
                                        mem[64] = mem[64] + ceil32(return_data.size) + 1
                                ...
                                if msg.sender == 0xdc86c8e21e1e2301214652cef352c990a81c5a60:
                                    ...
                                    while idx < ('cd', 4).length:
                                        ...
                                        call address(cd[((32 * idx) + cd[4] + 36)]).mem[mem[64] len 4] with:
                                           value cd[((32 * idx) + cd[36] + 36)] wei
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len cd[(cd[68] + cd[(cd[68] + (32 * idx) + 36)] + 36)] + _536 + -mem[64] - 4]
                                        if return_data.size:
                                            _560 = mem[64]
                                            mem[64] = mem[64] + ceil32(return_data.size) + 1
                                    ...
                                    if msg.sender == 0x19da21f58ec2043d35db87dcdd3985f6fb15983f:
                                        ...
                                        while idx < ('cd', 4).length:
                                            ...
                                            if return_data.size:
                                                _559 = mem[64]
                                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                                mem[_559] = return_data.size
                                                mem[_559 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                            if idx == -1:
                                                revert with 0, 17
                                            idx = idx + 1
                                            continue 
                                        ...
                                        while idx < ('cd', 4).length:
                                            ...
                                            call address(cd[((32 * idx) + cd[4] + 36)]).mem[mem[64] len 4] with:
                                               value cd[((32 * idx) + cd[36] + 36)] wei
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4 len cd[(cd[68] + cd[(cd[68] + (32 * idx) + 36)] + 36)] + _534 + -mem[64] - 4]
                                            if return_data.size:
                                                _558 = mem[64]
                                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                                mem[_558] = return_data.size
                                                mem[_558 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                            if idx == -1:
                                                revert with 0, 17
                                            idx = idx + 1
                                            continue 
            ...
            if unknown_0xcef13e68(?????) > uint32(call.func_hash) >> 224:
                    ...
                    if msg.sender == 0x6b2615470a606dbc879e63d1cd212282504b6c8c:
                        ...
                        while idx < ('cd', 4).length:
                            ...
                            if return_data.size:
                                _557 = mem[64]
                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                mem[_557] = return_data.size
                                mem[_557 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if idx == -1:
                                revert with 0, 17
                            idx = idx + 1
                            continue 
                        ...
                        if msg.sender == 0xe8dd23472f9cb963fdaee7c1fc3b6900c47c73f7:
                            ...
                            while idx < ('cd', 4).length:
                                ...
                                if return_data.size:
                                    _556 = mem[64]
                                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                                    mem[_556] = return_data.size
                                    mem[_556 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if idx == -1:
                                    revert with 0, 17
                                idx = idx + 1
                                continue 
                            ...
                            if msg.sender == 0xdc86c8e21e1e2301214652cef352c990a81c5a60:
                                ...
                                while idx < ('cd', 4).length:
                                    ...
                                    call address(cd[((32 * idx) + cd[4] + 36)]).mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)] + _530 + -mem[64] - 4]
                                    if return_data.size:
                                        _555 = mem[64]
                                        mem[64] = mem[64] + ceil32(return_data.size) + 1
                                        mem[_555] = return_data.size
                                        mem[_555 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                    if idx == -1:
                                        revert with 0, 17
                                    idx = idx + 1
                                    continue 
                                ...
                                if msg.sender == 0x19da21f58ec2043d35db87dcdd3985f6fb15983f:
                                    ...
                                    while idx < ('cd', 4).length:
                                        ...
                                        if return_data.size:
                                            _554 = mem[64]
                                            mem[64] = mem[64] + ceil32(return_data.size) + 1
                                            mem[_554] = return_data.size
                                            mem[_554 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                        if idx == -1:
                                            revert with 0, 17
                                        idx = idx + 1
                                        continue 
                                    ...
                                    while idx < ('cd', 4).length:
                                        ...
                                        if return_data.size:
                                            _553 = mem[64]
                                            mem[64] = mem[64] + ceil32(return_data.size) + 1
                                            mem[_553] = return_data.size
                                            mem[_553 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                        if idx == -1:
                                            revert with 0, 17
                                        idx = idx + 1
                                        continue 
                if unknown_0xa1db9782(?????) == uint32(call.func_hash) >> 224:
                    ...
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                if uint32(call.func_hash) >> 224 != unknown_0xbe69706b(?????):
                ...
                if not ('cd', 4).length:
                    ...
                    _475 = mem[128]
                    mem[mem[64] + 32] = mem[128]
                    mem[mem[64] + 64 len 32 * _475] = mem[160 len 32 * _475]
                    return 32, mem[mem[64] + 32 len (32 * _475) + 32]
                mem[160 len 32 * ('cd', 4).length] = call.data[calldata.size len 32 * ('cd', 4).length]
                idx = 0
                while idx < ('cd', 4).length:
                    mem[mem[64] + 4] = cd[((32 * idx) + cd[4] + 36)]
                ...
                _477 = mem[128]
                mem[mem[64] + 32] = mem[128]
                mem[mem[64] + 64 len 32 * _477] = mem[160 len 32 * _477]
                return 32, mem[mem[64] + 32 len (32 * _477) + 32]
            if unknown_0xf4a9d221(?????) > uint32(call.func_hash) >> 224:
                if unknown_0xcef13e68(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 64
                    require cd[4] == address(cd[4])
                ...
                if unknown_0xf4a9d221(?????) == uint32(call.func_hash) >> 224:
                    ...
                    while idx < ('cd', 4).length:
                        ...
                        if block.timestamp > mem[_495]:
                            ...
                            call 0xf1bf34e46ecf465591b7a7fa9635e4c583174fa3.0xbe774a71 with:
                                 gas gas_remaining wei
                                args 32, mem[mem[64] + 36 len (32 * _523) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                        if idx == -1:
                            revert with 0, 17
