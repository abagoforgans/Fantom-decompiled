    ...
    if not return_data.size:
        ...
        if not arg4:
            ...
            call arg1 with:
               funct uint32(stor11)
                 gas gas_remaining wei
                args Mask(480, -256, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0) << 256, mem[456 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'TransferHelper: TRANSFER_FAILED'
                if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
        ...
        if not return_data.size:
            if not arg4:
                ...
                call arg1 with:
                   funct uint32(stor11)
                     gas gas_remaining wei
                    args Mask(480, -256, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0) << 256, mem[ceil32(return_data.size) + 457 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'TransferHelper: TRANSFER_FAILED'
                    if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
