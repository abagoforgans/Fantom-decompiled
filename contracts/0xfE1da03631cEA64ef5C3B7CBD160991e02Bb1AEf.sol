            ...
            if tx.origin == owner:
                ...
                if stor0:
                    ...
                    if arg1:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1 - (100 * arg1 / 100000)) >> 32
                        call wantAddress with:
                           funct uint32(stor4)
                             gas gas_remaining wei
                            args Mask(224, 32, arg1 - (100 * arg1 / 100000)) << 224, mem[324 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), arg1 - (100 * arg1 / 100000)
                            if not unknown_0xa9059cbb(?????), Mask(224, 0, stor4):
                                revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                        else:
                            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if tx.origin == owner:
                ...
                if stor0:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, ext_call.return_data[0] - (100 * ext_call.return_data[0] / 100000)) >> 32
                        mem[324 len 0] = 0
                        call wantAddress with:
                           funct uint32(stor4)
                             gas gas_remaining wei
                            args Mask(224, 32, ext_call.return_data[0] - (100 * ext_call.return_data[0] / 100000)) << 224, mem[324 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with unknown_0xa9059cbb(?????), 
                                            Mask(224, 0, stor4),
                                            uint32(stor4),
                                            ext_call.return_data[0] - (100 * ext_call.return_data[0] / 100000)
                            if not unknown_0xa9059cbb(?????), Mask(224, 0, stor4):
                                revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                        else:
                            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
    ...
    if msg.sender == owner:
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    if not ext_code.size(depositTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[752 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0
                    mem[816 len 0] = 0
                    call depositTokenAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0) << 256, mem[816 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0
                        if not approve(address arg1, uint256 arg2), Mask(224, 0, stor10):
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(depositTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 753 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0
                        mem[ceil32(return_data.size) + 817 len 0] = 0
                        call depositTokenAddress with:
                           funct uint32(stor11)
                             gas gas_remaining wei
                            args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0) << 256, mem[ceil32(return_data.size) + 817 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0
                            if not approve(address arg1, uint256 arg2), Mask(224, 0, stor10):
                ...
                if not return_data.size:
                    ...
                    if not return_data.size:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.size(depositTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(2 * ceil32(return_data.size)) + 754 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0
                            mem[(2 * ceil32(return_data.size)) + 818 len 0] = 0
                            call depositTokenAddress with:
                               funct uint32(stor11)
                                 gas gas_remaining wei
                                args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0) << 256, mem[(2 * ceil32(return_data.size)) + 818 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0
                                if not approve(address arg1, uint256 arg2), Mask(224, 0, stor10):
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if return_data.size:
                    ...
                    if not ext_code.size(depositTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 755 len 64] = 0, address(poolAddress), 0
                    call depositTokenAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(depositTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 755 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0
                        call depositTokenAddress with:
                           funct uint32(stor11)
                             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            call depositTokenAddress with:
               funct uint32(stor11)
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0) << 256, mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 819 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0
                if not approve(address arg1, uint256 arg2), Mask(224, 0, stor10):
