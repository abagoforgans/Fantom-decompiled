...
function sub_d8d4bcb3(?) payable {
    ...
    call address(ext_call.return_data[0]).refreshConfiguration() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function deactivateReserve(address arg1) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).getReserveTotalLiquidity(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function initReserveWithData(address arg1, string arg2, string arg3, uint8 arg4, address arg5) payable {
    ...
    if not create.new_address:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(ext_call.return_data[0]))
    call address(ext_call.return_data[0]).initReserve(address arg1, address arg2, uint256 arg3, address arg4) with:
         gas gas_remaining wei
