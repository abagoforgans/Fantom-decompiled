...
function mint(address arg1, uint256 arg2) payable {
    ...
    if not wards[address(msg.sender)]:
        require arg2 + daiMintedToday[address(msg.sender)] >= arg2
        require block.number - lastMintRestart[address(msg.sender)] <= block.number
        if arg2 + daiMintedToday[address(msg.sender)] > dailyDAILimit:
            if block.number - lastMintRestart[address(msg.sender)] < 6500:
                revert with 0, 'Over daily DAI Limit'
            if arg2 > dailyDAILimit:
                revert with 0, 'Over daily DAI Limit'
        if block.number - lastMintRestart[address(msg.sender)] < 6500:
            require daiMintedToday[address(msg.sender)] + arg2 >= daiMintedToday[address(msg.sender)]
            daiMintedToday[address(msg.sender)] += arg2
        else:
            daiMintedToday[address(msg.sender)] = arg2
