...
function sub_0c55baa9(?) payable {
    ...
    mem[736] = 0
    mem[192] = 576
    mem[768 len 1152] = call.data[calldata.size len 1152]
    mem[224] = 768
    mem[1920] = 96
    mem[1952] = 0
    mem[1984] = 96
    ...
    staticcall this.address.0xa01bf1c2 with:
            gas gas_remaining wei
           args arg1
    mem[2016 len 160] = ext_call.return_data[0 len 160]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 160
    if not bool(ceil32(return_data.size) + 2176 <= test266151307()):
        revert with 0, 65
    mem[ceil32(return_data.size) + 2016] = ext_call.return_data[0]
    mem[ceil32(return_data.size) + 2048] = ext_call.return_data[32]
    mem[ceil32(return_data.size) + 2080] = ext_call.return_data[64]
    mem[ceil32(return_data.size) + 2112] = ext_call.return_data[96]
    mem[ceil32(return_data.size) + 2144] = ext_call.return_data[128]
    require ext_code.size(stor1)
    staticcall stor1.ability_scores(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[ceil32(return_data.size) + 2176 len 192] = ext_call.return_data[0 len 192]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    staticcall this.address.0x877e3817 with:
            gas gas_remaining wei
           args arg1
    mem[(2 * ceil32(return_data.size)) + 2176 len 64] = ext_call.return_data[0 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
    if not bool((4 * ceil32(return_data.size)) + 2240 <= test266151307()):
        revert with 0, 65
    mem[(4 * ceil32(return_data.size)) + 2176] = ext_call.return_data[0]
    mem[(4 * ceil32(return_data.size)) + 2208] = ext_call.return_data[32]
    require ext_code.size(this.address)
    staticcall this.address.0xb328d586 with:
            gas gas_remaining wei
           args arg1
    mem[(4 * ceil32(return_data.size)) + 2240 len 64] = ext_call.return_data[0 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
    if not bool((6 * ceil32(return_data.size)) + 2304 <= test266151307()):
        revert with 0, 65
    mem[(6 * ceil32(return_data.size)) + 2240] = ext_call.return_data[0]
    mem[(6 * ceil32(return_data.size)) + 2272] = ext_call.return_data[32]
    require ext_code.size(stor2)
    staticcall stor2.getSkills(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(6 * ceil32(return_data.size)) + 2304 len 1152] = ext_call.return_data[0 len 1152]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 1152
    require (6 * ceil32(return_data.size)) + 2335 < (6 * ceil32(return_data.size)) + return_data.size + 2304
    if not bool((7 * ceil32(return_data.size)) + 3456 <= test266151307()):
        revert with 0, 65
    require 1152 <= return_data.size
    idx = 0
    s = (6 * ceil32(return_data.size)) + 2304
    t = (7 * ceil32(return_data.size)) + 2304
    while idx < 36:
        require mem[s] == mem[s + 31 len 1]
        mem[t] = mem[s]
        idx = idx + 1
        ...
        t = t + 32
        continue 
    mem[(7 * ceil32(return_data.size)) + 3456] = 0x5718e17b00000000000000000000000000000000000000000000000000000000
    mem[(7 * ceil32(return_data.size)) + 3460] = arg1
    require ext_code.size(this.address)
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(7 * ceil32(return_data.size)) + 3456 len return_data.size] = ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    _47 = mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32
    require mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 <= test266151307()
    require return_data.size - mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 >= 96
    if not bool((8 * ceil32(return_data.size)) + 3552 <= test266151307()):
        revert with 0, 65
    mem[64] = (8 * ceil32(return_data.size)) + 3552
    _49 = mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + 3456]
    require mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + 3456] <= test266151307()
    require (7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + 3456] + 3487 < (7 * ceil32(return_data.size)) + return_data.size + 3456
    _50 = mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + 3456] + 3456]
    if mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + 3456] + 3456] > test266151307():
        revert with 0, 65
    if ceil32(ceil32(mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + 3456] + 3456])) + 97 < 96 or (8 * ceil32(return_data.size)) + ceil32(ceil32(mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + 3456] + 3456])) + 3553 > test266151307():
        revert with 0, 65
    mem[64] = (8 * ceil32(return_data.size)) + ceil32(ceil32(mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + 3456] + 3456])) + 3553
    mem[(8 * ceil32(return_data.size)) + 3552] = mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + 3456] + 3456]
    require mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + _49 + _50 + 32 <= return_data.size
    mem[(8 * ceil32(return_data.size)) + 3584 len ceil32(_50)] = mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 3456 len 4], Mask(224, 32, arg1) >> 32 + _49 + 3488 len ceil32(_50)]
    if ceil32(_50) <= _50:
        mem[(8 * ceil32(return_data.size)) + 3456] = (8 * ceil32(return_data.size)) + 3552
        mem[(8 * ceil32(return_data.size)) + 3488] = mem[(7 * ceil32(return_data.size)) + _47 + 3488]
        _161 = mem[(7 * ceil32(return_data.size)) + _47 + 3520]
        require mem[(7 * ceil32(return_data.size)) + _47 + 3520] <= test266151307()
        require (7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3487 < (7 * ceil32(return_data.size)) + return_data.size + 3456
        _164 = mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456]
        if mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456] > test266151307():
            revert with 0, 65
        _166 = mem[64]
        if mem[64] + ceil32(ceil32(mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456])) + 1 < mem[64] or mem[64] + ceil32(ceil32(mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456])) + 1 > test266151307():
            revert with 0, 65
        mem[64] = mem[64] + ceil32(ceil32(mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456])) + 1
        mem[_166] = mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456]
        require _47 + _161 + _164 + 32 <= return_data.size
        mem[_166 + 32 len ceil32(_164)] = mem[(7 * ceil32(return_data.size)) + _47 + _161 + 3488 len ceil32(_164)]
        if ceil32(_164) <= _164:
            mem[(8 * ceil32(return_data.size)) + 3520] = _166
            _268 = mem[64]
            mem[64] = mem[64] + 192
            mem[_268] = ceil32(return_data.size) + 2016
            mem[_268 + 32] = (4 * ceil32(return_data.size)) + 2176
            mem[_268 + 64] = (6 * ceil32(return_data.size)) + 2240
            _269 = mem[64]
            mem[64] = mem[64] + 192
            mem[_269] = uint32(ext_call.return_data[0])
            mem[_269 + 32] = uint32(ext_call.return_data[32])
            mem[_269 + 64] = uint32(ext_call.return_data[64])
            mem[_269 + 96] = uint32(ext_call.return_data[96])
            mem[_269 + 128] = uint32(ext_call.return_data[128])
            mem[_269 + 160] = uint32(ext_call.return_data[160])
            mem[_268 + 96] = _269
            mem[_268 + 128] = (7 * ceil32(return_data.size)) + 2304
            mem[_268 + 160] = (8 * ceil32(return_data.size)) + 3456
            mem[mem[64]] = 32
            ...
            mem[mem[64] + 288] = ext_call.return_data[32]
            mem[mem[64] + 320] = 0
            mem[mem[64] + 352] = 0
            mem[mem[64] + 384] = 0
            mem[mem[64] + 416] = 0
            ...
            while idx < 36:
                ...
                continue 
            _368 = mem[_268 + 160]
            mem[mem[64] + 1664] = 1664
            _372 = mem[_368]
            mem[mem[64] + 1696] = 96
            _376 = mem[_372]
            mem[mem[64] + 1792] = mem[_372]
            mem[mem[64] + 1824 len ceil32(_376)] = mem[_372 + 32 len ceil32(_376)]
            if ceil32(_376) <= _376:
                mem[mem[64] + 1728] = mem[_368 + 32]
                _437 = mem[_368 + 64]
                mem[mem[64] + 1760] = ceil32(_376) + 128
                _452 = mem[_437]
                mem[ceil32(_376) + mem[64] + 1824] = mem[_437]
                mem[ceil32(_376) + mem[64] + 1856 len ceil32(_452)] = mem[_437 + 32 len ceil32(_452)]
                if ceil32(_452) > _452:
                    mem[_452 + ceil32(_376) + mem[64] + 1856] = 0
                return 32, ext_call.return_data[0], 
                       ...
                       0,
                       0,
                       mem[mem[64] + 512 len 1152],
                       1664,
                       96,
                       mem[mem[64] + 1728],
                       ceil32(_376) + 128,
                       mem[mem[64] + 1792 len ceil32(_452) + ceil32(_376) + 64]
            mem[_376 + mem[64] + 1824] = 0
            mem[mem[64] + 1728] = mem[_368 + 32]
            _439 = mem[_368 + 64]
            mem[mem[64] + 1760] = ceil32(_376) + 128
            _453 = mem[_439]
            mem[ceil32(_376) + mem[64] + 1824] = mem[_439]
            mem[ceil32(_376) + mem[64] + 1856 len ceil32(_453)] = mem[_439 + 32 len ceil32(_453)]
            if ceil32(_453) > _453:
                mem[_453 + ceil32(_376) + mem[64] + 1856] = 0
            return 32, ext_call.return_data[0], 
                   ext_call.return_data[32],
                   ext_call.return_data[64],
                   ext_call.return_data[96],
                   ...
                   mem[mem[64] + 1728],
                   ceil32(_376) + 128,
                   mem[mem[64] + 1792 len _376 + 32],
                   0,
                   mem[mem[64] + _376 + 1856 len ceil32(_453) + ceil32(_376) - _376]
        mem[_164 + _166 + 32] = 0
        mem[(8 * ceil32(return_data.size)) + 3520] = _166
        _270 = mem[64]
        mem[64] = mem[64] + 192
        mem[_270] = ceil32(return_data.size) + 2016
        mem[_270 + 32] = (4 * ceil32(return_data.size)) + 2176
        mem[_270 + 64] = (6 * ceil32(return_data.size)) + 2240
        _271 = mem[64]
        mem[64] = mem[64] + 192
        mem[_271] = uint32(ext_call.return_data[0])
        mem[_271 + 32] = uint32(ext_call.return_data[32])
        mem[_271 + 64] = uint32(ext_call.return_data[64])
        mem[_271 + 96] = uint32(ext_call.return_data[96])
        mem[_271 + 128] = uint32(ext_call.return_data[128])
        mem[_271 + 160] = uint32(ext_call.return_data[160])
        mem[_270 + 96] = _271
        mem[_270 + 128] = (7 * ceil32(return_data.size)) + 2304
        mem[_270 + 160] = (8 * ceil32(return_data.size)) + 3456
        mem[mem[64]] = 32
        mem[mem[64] + 32] = ext_call.return_data[0]
        mem[mem[64] + 64] = ext_call.return_data[32]
        mem[mem[64] + 96] = ext_call.return_data[64]
        ...
        mem[mem[64] + 1696] = 96
        _377 = mem[_373]
        mem[mem[64] + 1792] = mem[_373]
        mem[mem[64] + 1824 len ceil32(_377)] = mem[_373 + 32 len ceil32(_377)]
        if ceil32(_377) <= _377:
            mem[mem[64] + 1728] = mem[_369 + 32]
            _441 = mem[_369 + 64]
            mem[mem[64] + 1760] = ceil32(_377) + 128
            _454 = mem[_441]
            mem[ceil32(_377) + mem[64] + 1824] = mem[_441]
            mem[ceil32(_377) + mem[64] + 1856 len ceil32(_454)] = mem[_441 + 32 len ceil32(_454)]
            if ceil32(_454) > _454:
                mem[_454 + ceil32(_377) + mem[64] + 1856] = 0
            return 32, ext_call.return_data[0], 
                   ext_call.return_data[32],
                   ext_call.return_data[64],
                   ext_call.return_data[96],
                   ...
                   mem[mem[64] + 1728],
                   ceil32(_377) + 128,
                   mem[mem[64] + 1792 len ceil32(_454) + ceil32(_377) + 64]
        mem[_377 + mem[64] + 1824] = 0
        mem[mem[64] + 1728] = mem[_369 + 32]
        _443 = mem[_369 + 64]
        mem[mem[64] + 1760] = ceil32(_377) + 128
        _455 = mem[_443]
        mem[ceil32(_377) + mem[64] + 1824] = mem[_443]
        mem[ceil32(_377) + mem[64] + 1856 len ceil32(_455)] = mem[_443 + 32 len ceil32(_455)]
        if ceil32(_455) > _455:
            mem[_455 + ceil32(_377) + mem[64] + 1856] = 0
        return 32, ext_call.return_data[0], 
               ext_call.return_data[32],
               ext_call.return_data[64],
               ext_call.return_data[96],
               ...
               mem[mem[64] + 1728],
               ceil32(_377) + 128,
               mem[mem[64] + 1792 len _377 + 32],
               0,
               mem[mem[64] + _377 + 1856 len ceil32(_455) + ceil32(_377) - _377]
    mem[_50 + (8 * ceil32(return_data.size)) + 3584] = 0
    mem[(8 * ceil32(return_data.size)) + 3456] = (8 * ceil32(return_data.size)) + 3552
    mem[(8 * ceil32(return_data.size)) + 3488] = mem[(7 * ceil32(return_data.size)) + _47 + 3488]
    _163 = mem[(7 * ceil32(return_data.size)) + _47 + 3520]
    require mem[(7 * ceil32(return_data.size)) + _47 + 3520] <= test266151307()
    require (7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3487 < (7 * ceil32(return_data.size)) + return_data.size + 3456
    _165 = mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456]
    if mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456] > test266151307():
        revert with 0, 65
    _167 = mem[64]
    if mem[64] + ceil32(ceil32(mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456])) + 1 < mem[64] or mem[64] + ceil32(ceil32(mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456])) + 1 > test266151307():
        revert with 0, 65
    mem[64] = mem[64] + ceil32(ceil32(mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456])) + 1
    mem[_167] = mem[(7 * ceil32(return_data.size)) + _47 + mem[(7 * ceil32(return_data.size)) + _47 + 3520] + 3456]
    require _47 + _163 + _165 + 32 <= return_data.size
    mem[_167 + 32 len ceil32(_165)] = mem[(7 * ceil32(return_data.size)) + _47 + _163 + 3488 len ceil32(_165)]
    if ceil32(_165) <= _165:
        mem[(8 * ceil32(return_data.size)) + 3520] = _167
        _272 = mem[64]
        mem[64] = mem[64] + 192
        mem[_272] = ceil32(return_data.size) + 2016
        mem[_272 + 32] = (4 * ceil32(return_data.size)) + 2176
        mem[_272 + 64] = (6 * ceil32(return_data.size)) + 2240
        _273 = mem[64]
        mem[64] = mem[64] + 192
        mem[_273] = uint32(ext_call.return_data[0])
        mem[_273 + 32] = uint32(ext_call.return_data[32])
        mem[_273 + 64] = uint32(ext_call.return_data[64])
        mem[_273 + 96] = uint32(ext_call.return_data[96])
        mem[_273 + 128] = uint32(ext_call.return_data[128])
        mem[_273 + 160] = uint32(ext_call.return_data[160])
        mem[_272 + 96] = _273
        mem[_272 + 128] = (7 * ceil32(return_data.size)) + 2304
        mem[_272 + 160] = (8 * ceil32(return_data.size)) + 3456
        mem[mem[64]] = 32
        mem[mem[64] + 32] = ext_call.return_data[0]
        mem[mem[64] + 64] = ext_call.return_data[32]
        mem[mem[64] + 96] = ext_call.return_data[64]
        ...
        mem[mem[64] + 1696] = 96
        _378 = mem[_374]
        mem[mem[64] + 1792] = mem[_374]
        mem[mem[64] + 1824 len ceil32(_378)] = mem[_374 + 32 len ceil32(_378)]
        if ceil32(_378) <= _378:
            mem[mem[64] + 1728] = mem[_370 + 32]
            _445 = mem[_370 + 64]
            mem[mem[64] + 1760] = ceil32(_378) + 128
            _456 = mem[_445]
            mem[ceil32(_378) + mem[64] + 1824] = mem[_445]
            mem[ceil32(_378) + mem[64] + 1856 len ceil32(_456)] = mem[_445 + 32 len ceil32(_456)]
            if ceil32(_456) > _456:
                mem[_456 + ceil32(_378) + mem[64] + 1856] = 0
            return 32, ext_call.return_data[0], 
                   ext_call.return_data[32],
                   ext_call.return_data[64],
                   ext_call.return_data[96],
                   ...
                   mem[mem[64] + 1728],
                   ceil32(_378) + 128,
                   mem[mem[64] + 1792 len ceil32(_456) + ceil32(_378) + 64]
        mem[_378 + mem[64] + 1824] = 0
        mem[mem[64] + 1728] = mem[_370 + 32]
        _447 = mem[_370 + 64]
        mem[mem[64] + 1760] = ceil32(_378) + 128
        _457 = mem[_447]
        mem[ceil32(_378) + mem[64] + 1824] = mem[_447]
        mem[ceil32(_378) + mem[64] + 1856 len ceil32(_457)] = mem[_447 + 32 len ceil32(_457)]
        if ceil32(_457) > _457:
            mem[_457 + ceil32(_378) + mem[64] + 1856] = 0
        return 32, ext_call.return_data[0], 
               ext_call.return_data[32],
               ext_call.return_data[64],
               ext_call.return_data[96],
               ...
               mem[mem[64] + 1728],
               ceil32(_378) + 128,
               mem[mem[64] + 1792 len _378 + 32],
               0,
               mem[mem[64] + _378 + 1856 len ceil32(_457) + ceil32(_378) - _378]
    mem[_165 + _167 + 32] = 0
    mem[(8 * ceil32(return_data.size)) + 3520] = _167
    _274 = mem[64]
    mem[64] = mem[64] + 192
    mem[_274] = ceil32(return_data.size) + 2016
    mem[_274 + 32] = (4 * ceil32(return_data.size)) + 2176
    mem[_274 + 64] = (6 * ceil32(return_data.size)) + 2240
    _275 = mem[64]
    mem[64] = mem[64] + 192
    mem[_275] = uint32(ext_call.return_data[0])
    mem[_275 + 32] = uint32(ext_call.return_data[32])
    mem[_275 + 64] = uint32(ext_call.return_data[64])
    mem[_275 + 96] = uint32(ext_call.return_data[96])
    mem[_275 + 128] = uint32(ext_call.return_data[128])
    mem[_275 + 160] = uint32(ext_call.return_data[160])
    mem[_274 + 96] = _275
    mem[_274 + 128] = (7 * ceil32(return_data.size)) + 2304
    mem[_274 + 160] = (8 * ceil32(return_data.size)) + 3456
    mem[mem[64]] = 32
    mem[mem[64] + 32] = ext_call.return_data[0]
    mem[mem[64] + 64] = ext_call.return_data[32]
    mem[mem[64] + 96] = ext_call.return_data[64]
    ...
    mem[mem[64] + 1696] = 96
    _379 = mem[_375]
    mem[mem[64] + 1792] = mem[_375]
    mem[mem[64] + 1824 len ceil32(_379)] = mem[_375 + 32 len ceil32(_379)]
    if ceil32(_379) <= _379:
        mem[mem[64] + 1728] = mem[_371 + 32]
        _449 = mem[_371 + 64]
        mem[mem[64] + 1760] = ceil32(_379) + 128
        _458 = mem[_449]
        mem[ceil32(_379) + mem[64] + 1824] = mem[_449]
        mem[ceil32(_379) + mem[64] + 1856 len ceil32(_458)] = mem[_449 + 32 len ceil32(_458)]
        if ceil32(_458) > _458:
            mem[_458 + ceil32(_379) + mem[64] + 1856] = 0
        return 32, ext_call.return_data[0], 
               ext_call.return_data[32],
               ext_call.return_data[64],
               ext_call.return_data[96],
               ...
               mem[mem[64] + 1728],
               ceil32(_379) + 128,
               mem[mem[64] + 1792 len ceil32(_458) + ceil32(_379) + 64]
    mem[_379 + mem[64] + 1824] = 0
    mem[mem[64] + 1728] = mem[_371 + 32]
    _451 = mem[_371 + 64]
    mem[mem[64] + 1760] = ceil32(_379) + 128
    _459 = mem[_451]
    mem[ceil32(_379) + mem[64] + 1824] = mem[_451]
    mem[ceil32(_379) + mem[64] + 1856 len ceil32(_459)] = mem[_451 + 32 len ceil32(_459)]
    if ceil32(_459) > _459:
        mem[_459 + ceil32(_379) + mem[64] + 1856] = 0
    return 32, ext_call.return_data[0], 
           ext_call.return_data[32],
           ext_call.return_data[64],
           ext_call.return_data[96],
           ...
           mem[mem[64] + 1728],
           ceil32(_379) + 128,
           mem[mem[64] + 1792 len _379 + 32],
           0,
           mem[mem[64] + _379 + 1856 len ceil32(_459) + ceil32(_379) - _379]
}
