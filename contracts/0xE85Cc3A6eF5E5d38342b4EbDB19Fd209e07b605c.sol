...
function sub_401ae8ef(?) payable {
    ...
    if bool(stor2[arg1].field_256):
        ...
        if bool(stor2[arg1].field_256):
            ...
            if uint255(stor2[arg1].field_257):
                if 31 >= uint255(stor2[arg1].field_257):
                    mem[576] = 256 * Mask(248, 0, stor2[arg1].field_264)
                else:
                    mem[576] = stor[sha3((7 * arg1) + ('name', 'stor2', 2) + 1)].field_0
                    idx = 576
                    s = 0
                    while uint255(stor2[arg1].field_257) + 544 > idx:
                        mem[idx + 32] = stor[s + sha3((7 * arg1) + ('name', 'stor2', 2) + 1)].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
            ...
            if stor2[arg1].field_257 % 128:
                if 31 >= stor2[arg1].field_257 % 128:
                    ...
                    idx = 576
                    s = 0
                    while stor2[arg1].field_257 % 128 + 544 > idx:
                        mem[idx + 32] = stor[s + sha3((7 * arg1) + ('name', 'stor2', 2) + 1)].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
        return 32, address(stor2[arg1].field_0), 
               ...
               stor2[arg1].field_1280,
               bool(uint8(stor2[arg1].field_1536)),
               2 * Mask(256, -1, uint255(stor2[arg1].field_257)),
               mem[576 len ceil32(uint255(stor2[arg1].field_257))]
    if bool(stor2[arg1].field_256) == stor2[arg1].field_257 % 128 < 32:
        revert with 0, 34
    if bool(stor2[arg1].field_256):
        if bool(stor2[arg1].field_256) == uint255(stor2[arg1].field_257) < 32:
    ...
    return 32, address(stor2[arg1].field_0), 
           ...
           stor2[arg1].field_1280,
           bool(uint8(stor2[arg1].field_1536)),
           stor2[arg1].field_256 % 128,
           mem[576 len ceil32(stor2[arg1].field_257 % 128)]
}
...
function sub_07400f09(?) payable {
    ...
    mem[ceil32(arg1.length) + ceil32(return_data.size) + 128] = 100
    ...
    if not ext_code.hash(address(stor2[arg2].field_0)):
        revert with 0, 'Address: call to non-contract'
    mem[ceil32(arg1.length) + ceil32(return_data.size) + 324 len 128] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), stor2[arg2].field_768, 0
    ...
    if not return_data.size:
        ...
        mem[ceil32(arg1.length) + ceil32(return_data.size) + 356 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
            if return_data.size:
                revert with ext_call.return_data[0 len return_data.size]
            revert with 0, 'SafeERC20: low-level call failed'
        if return_data.size:
            require return_data.size >= 32
            require mem[ceil32(arg1.length) + ceil32(return_data.size) + 356] == bool(mem[ceil32(arg1.length) + ceil32(return_data.size) + 356])
            if not mem[ceil32(arg1.length) + ceil32(return_data.size) + 356]:
                revert with 0, 'SafeERC20: ERC20 operation did not succeed'
...
function sub_03cfb847(?) payable {
    ...
    while idx < stor2.length:
        ...
        if bool(stor2[idx].field_256):
            ...
            mem[_33] = uint255(stor2[idx].field_257)
            if bool(stor2[idx].field_256):
                if bool(stor2[idx].field_256) == uint255(stor2[idx].field_257) < 32:
                    revert with 0, 34
                if uint255(stor2[idx].field_257):
                    if 31 >= uint255(stor2[idx].field_257):
                        mem[_33 + 32] = 256 * Mask(248, 0, stor2[idx].field_264)
                    else:
                        mem[0] = sha3(2) + (7 * idx) + 1
                        mem[_33 + 32] = stor[sha3(('name', 'stor2', 2) + (7 * idx) + 1)].field_0
                        t = _33 + 32
                        u = sha3(mem[0])
                        while _33 + uint255(stor2[idx].field_257) > t:
            ...
            t = _33 + 32
            u = sha3(mem[0])
            while _33 + stor2[u].field_257 % 128 > t:
                mem[t + 32] = uint256(stor1[u])
                t = t + 32
                u = u + 1
                continue 
        ...
        mem[_37] = stor2[idx].field_257 % 128
        if bool(stor2[idx].field_256):
            if bool(stor2[idx].field_256) == uint255(stor2[idx].field_257) < 32:
                revert with 0, 34
            if not uint255(stor2[idx].field_257):
                ...
                continue 
            if 31 >= uint255(stor2[idx].field_257):
                mem[_37 + 32] = 256 * Mask(248, 0, stor2[idx].field_264)
                mem[_29 + 32] = _37
                mem[_29 + 64] = stor2[idx].field_512
                mem[_29 + 96] = stor2[idx].field_768
                mem[_29 + 128] = stor2[idx].field_1024
                ...
                continue 
            mem[0] = sha3(2) + (7 * idx) + 1
            mem[_37 + 32] = stor[sha3(('name', 'stor2', 2) + (7 * idx) + 1)].field_0
            t = _37 + 32
            u = sha3(mem[0])
            while _37 + uint255(stor2[u].field_257) > t:
                mem[t + 32] = uint256(stor1[u])
                t = t + 32
                u = u + 1
                continue 
        ...
        if stor2[idx].field_257 % 128:
            if 31 >= stor2[idx].field_257 % 128:
                ...
                t = _37 + 32
                u = sha3(mem[0])
                while _37 + stor2[idx].field_257 % 128 > t:
                    mem[t + 32] = uint256(stor1[u])
                    t = t + 32
                    u = u + 1
                    continue 
    ...
    while idx < _31:
        ...
        mem[u + 160] = mem[_54 + 160]
        mem[u + 192] = bool(mem[_54 + 192])
        idx = idx + 1
        s = s + 32
        t = t + 32
        u = ceil32(_58) + u + 256
