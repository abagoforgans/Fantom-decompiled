...
function aggregate(address arg1, bytes[] arg2) payable {
    ...
    while idx < arg1 + (32 * arg1.length) + 36:
        ...
        if cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)] > test266151307():
            revert with 'NH{q', 65
        _128 = mem[64]
        if mem[64] + ceil32(ceil32(cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)])) + 1 > test266151307() or mem[64] + ceil32(ceil32(cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)])) + 1 < mem[64]:
            revert with 'NH{q', 65
        mem[64] = mem[64] + ceil32(ceil32(cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)])) + 1
        mem[_128] = cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)]
        require arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)] + 68 <= calldata.size
        mem[_128 + 32 len cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)]] = call.data[arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 68 len cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)]]
        mem[_128 + cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)] + 32] = 0
        mem[_72 + 32] = _128
        mem[s] = _72
        idx = idx + 32
        s = s + 32
...
function blockAndAggregate(address arg1, bytes[] arg2) payable {
    ...
    while idx < arg1 + (32 * arg1.length) + 36:
        ...
        if mem[64] + ceil32(ceil32(cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)])) + 1 > test266151307() or mem[64] + ceil32(ceil32(cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)])) + 1 < mem[64]:
            revert with 'NH{q', 65
        mem[64] = mem[64] + ceil32(ceil32(cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)])) + 1
        mem[_132] = cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)]
        require arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)] + 68 <= calldata.size
        mem[_132 + 32 len cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)]] = call.data[arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 68 len cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)]]
        mem[_132 + cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)] + 32] = 0
        mem[_83 + 32] = _132
        mem[s] = _83
        idx = idx + 32
        s = s + 32
    ...
    if not _84:
        ...
        _307 = mem[96]
        s = 0
        while arg1 + floor32(arg1.length) + 36 < _307:
            if arg1 + floor32(arg1.length) + 36 >= mem[96]:
                revert with 'NH{q', 50
            _311 = mem[mem[(32 * arg1 + floor32(arg1.length) + 36) + 128]]
            if arg1 + floor32(arg1.length) + 36 >= mem[96]:
                revert with 'NH{q', 50
            _314 = mem[mem[(32 * arg1 + floor32(arg1.length) + 36) + 128] + 32]
            _315 = mem[64]
            _317 = mem[mem[mem[(32 * arg1 + floor32(arg1.length) + 36) + 128] + 32]]
            idx = 0
            while idx < _317:
                mem[_315 + idx] = mem[_314 + idx + 32]
                _307 = mem[96]
                idx = idx + 32
                continue 
            if ceil32(_317) <= _317:
                ...
                if not return_data.size:
                    ...
                    mem[_358 + 32] = 96
                    if arg1 + floor32(arg1.length) + 36 >= mem[_85]:
                        revert with 'NH{q', 50
                    mem[(32 * arg1 + floor32(arg1.length) + 36) + _85 + 32] = _358
                else:
                    _351 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                    ...
                    if arg1 + floor32(arg1.length) + 36 >= mem[_85]:
                        revert with 'NH{q', 50
                    mem[(32 * arg1 + floor32(arg1.length) + 36) + _85 + 32] = _360
            else:
                mem[_315 + _317] = 0
                call address(_311).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if arg1 + floor32(arg1.length) + 36 >= mem[_85]:
                        revert with 'NH{q', 50
                    mem[(32 * arg1 + floor32(arg1.length) + 36) + _85 + 32] = _364
                else:
                    _354 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                    ...
                    if arg1 + floor32(arg1.length) + 36 >= mem[_85]:
                        revert with 'NH{q', 50
                    mem[(32 * arg1 + floor32(arg1.length) + 36) + _85 + 32] = _366
            if arg1 + floor32(arg1.length) + 36 == -1:
                revert with 'NH{q', 17
            _307 = mem[96]
            s = arg1 + floor32(arg1.length) + 37
            continue 
        _316 = mem[64]
        mem[mem[64]] = block.number
        mem[mem[64] + 32] = block.hash(block.number)
...
function tryAggregate(bool arg1, address arg2, bytes[] arg3) payable {
    ...
    while idx < arg2 + (32 * arg2.length) + 36:
        require cd[idx] <= test266151307()
        require calldata.size + -arg2 + -cd[idx] - 36 >= 64
        _101 = mem[64]
        if mem[64] + 64 > test266151307() or mem[64] + 64 < mem[64]:
            revert with 'NH{q', 65
        mem[64] = mem[64] + 64
        require cd[(arg2 + cd[idx] + 36)] == address(cd[(arg2 + cd[idx] + 36)])
        mem[_101] = cd[(arg2 + cd[idx] + 36)]
        ...
        mem[_175] = cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)]
        require arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)] + 68 <= calldata.size
        mem[_175 + 32 len cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)]] = call.data[arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 68 len cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)]]
        mem[_175 + cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)] + 32] = 0
        mem[_101 + 32] = _175
        mem[s] = _101
        idx = idx + 32
        s = s + 32
    ...
    if not _99:
        ...
        u = mem[64] + (32 * _206) + 64
        v = mem[64] + 64
        while arg2 + floor32(arg2.length) + 36 < _206:
            mem[v] = u + -_199 - 64
            _290 = mem[t]
            ...
            if ceil32(_312) > _312:
                mem[u + _312 + 96] = 0
            idx = arg2 + floor32(arg2.length) + 37
            t = t + 32
            u = u + ceil32(_312) + 96
            v = v + 32
            continue 
...
function tryBlockAndAggregate(bool arg1, address arg2, bytes[] arg3) payable {
    ...
    while idx < arg2 + (32 * arg2.length) + 36:
        ...
        if mem[64] + ceil32(ceil32(cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)])) + 1 > test266151307() or mem[64] + ceil32(ceil32(cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)])) + 1 < mem[64]:
            revert with 'NH{q', 65
        mem[64] = mem[64] + ceil32(ceil32(cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)])) + 1
        mem[_162] = cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)]
        require arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)] + 68 <= calldata.size
        mem[_162 + 32 len cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)]] = call.data[arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 68 len cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)]]
        mem[_162 + cd[(arg2 + cd[idx] + cd[(arg2 + cd[idx] + 68)] + 36)] + 32] = 0
        mem[_100 + 32] = _162
        mem[s] = _100
        idx = idx + 32
        s = s + 32
