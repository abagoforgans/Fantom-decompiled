...
uint256 sub_c3322db8;
mapping of uint256 sub_861e4656;
...
function sub_861e4656(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return sub_861e4656[arg1]
}

function sub_c3322db8(?) payable {
    return sub_c3322db8
}
...
function discover(uint256 arg1) payable {
    ...
    emit Transfer(0, msg.sender, sub_c3322db8);
    if ext_code.size(msg.sender) > 0:
        require ext_code.size(msg.sender)
        call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
             gas gas_remaining wei
            args 0, uint32(msg.sender), 0, sub_c3322db8, 128, 0
        ...
        if Mask(32, 224, ext_call.return_data[0]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
    emit 0x2124f995: arg1, sub_c3322db8, msg.sender
    if sub_c3322db8 == -1:
        revert with 'NH{q', 17
    sub_c3322db8++
}
