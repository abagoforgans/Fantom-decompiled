...
const masterchef = 0x9180583c1ab03587b545629dd60d2be0bf1df4f2
...
function balanceOfPool() payable {
    require ext_code.size(0x9180583c1ab03587b545629dd60d2be0bf1df4f2)
    staticcall 0x9180583c1ab03587b545629dd60d2be0bf1df4f2.0x93f1a40b with:
            gas gas_remaining wei
...
function deposit(uint256 arg1) payable {
    ...
    if arg1 > 0:
        if ext_call.return_data[0] > 0:
            require ext_code.size(0x9180583c1ab03587b545629dd60d2be0bf1df4f2)
            call 0x9180583c1ab03587b545629dd60d2be0bf1df4f2.deposit(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args poolId, arg1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        require ext_code.size(0x9180583c1ab03587b545629dd60d2be0bf1df4f2)
        call 0x9180583c1ab03587b545629dd60d2be0bf1df4f2.withdraw(uint256 arg1, uint256 arg2) with:
             gas gas_remaining wei
...
function pause() payable {
    if msg.sender == owner:
        ...
        if ext_code.size(inputAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address arg1, uint256 arg2), 0x9180583c1ab03587b545629d, 0, 0
        call inputAddress.0xbf1df4f2 with:
             gas gas_remaining wei
            args 0, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), 0x9180583c1ab03587b545629d, 0, 0
            if not approve(address arg1, uint256 arg2), 0x9180583c1ab03587b545629d:
                revert with 0, 32, 42, 0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if eth.balance(this.address) < 0:
            ...
            if not return_data.size:
                ...
                if eth.balance(this.address) < 0:
                    revert with 0, 32, 38, 0x2e416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[694 len 26]
                ...
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address arg1, uint256 arg2), 0x9180583c1ab03587b545629d, 0, 0
                    if not approve(address arg1, uint256 arg2), 0x9180583c1ab03587b545629d:
                        revert with 0, 32, 42, 0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[698 len 22]
                    if eth.balance(this.address) < 0:
                        revert with 0, 32, 38, 0x2e416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[858 len 26]
                    ...
                    if not return_data.size:
                        if not ext_call.success:
                            revert with approve(address arg1, uint256 arg2), 0x9180583c1ab03587b545629d, 0, 0
                        if not approve(address arg1, uint256 arg2), 0x9180583c1ab03587b545629d:
                            revert with 0, 32, 42, 0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[862 len 22]
                    else:
        ...
        if return_data.size <= 0:
            ...
            if return_data.size <= 0:
                ...
                mem[(4 * ceil32(return_data.size)) + 824 len 42] = 0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565
                revert with memory
                  from (4 * ceil32(return_data.size)) + 756
        ...
        call inputAddress.0xbf1df4f2 with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address arg1, uint256 arg2), 0x9180583c1ab03587b545629d, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), 0x9180583c1ab03587b545629d, 0, 0
            if not approve(address arg1, uint256 arg2), 0x9180583c1ab03587b545629d:
