...
uint8 saleIsActive;
uint8 sub_f833513d; offset 8
uint8 sub_bc040a6d; offset 16
...
function flipAutoRewardState() {
    if not roleAdmin[address(msg.sender)].field_0:
        revert with 0, 'Must have Admin role'
    Mask(248, 0, stor23.field_8) = Mask(248, 0, not sub_f833513d)
}

function flipAutoRewardAsCustom() {
    if not roleAdmin[address(msg.sender)].field_0:
        revert with 0, 'Must have Admin role'
    Mask(240, 0, stor23.field_16) = Mask(240, 0, not sub_bc040a6d)
}
...
function flipSaleState() {
    if not roleAdmin[address(msg.sender)].field_0:
        revert with 0, 'Must have Admin role'
    uint256(stor23.field_0) = not saleIsActive or Mask(248, 8, uint256(stor23.field_0))
}
