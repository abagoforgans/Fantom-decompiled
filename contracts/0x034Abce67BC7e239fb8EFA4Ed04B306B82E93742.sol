...
function stake(uint256 arg1) {
    ...
    mem[32] = 1
    mem[64] = 2144
    mem[96 len 2048] = code.data[6618 len 2048]
    if not stakes[msg.sender]:
        ...
        while idx < sub_a6df16d7.length:
            if sub_d8e5eb16[stor9[idx]].field_0:
                ...
                staticcall sub_a6df16d7[idx].balanceOf(address arg1) with:
                        gas gas_remaining wei
                       args this.address
        ...
        call sub_0ea195bcAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
             gas gas_remaining wei
        ...
        while s < sub_a6df16d7.length:
            if sub_d8e5eb16[stor9[s]].field_0:
                ...
                staticcall sub_a6df16d7[s].balanceOf(address arg1) with:
                        gas gas_remaining wei
                       args this.address
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
        ...
        if not arg1:
            ...
            if arg1 < stakes[msg.sender]:
                ...
                if not stakes[msg.sender]:
                    ...
                    emit UnStake(stakes[msg.sender], msg.sender);
                    if not mem[96]:
                        idx = 1
                        while idx < sub_a6df16d7.length:
                            require idx < 64
