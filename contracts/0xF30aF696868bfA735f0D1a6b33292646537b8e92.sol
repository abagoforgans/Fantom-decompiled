...
function sub_4746869e(?) payable {
    ...
    while idx < sub_d38b576d.length:
        ...
        mem[100] = 0xaa62cdbe5aeffaa3f33d6589c876953cf0014fdd
        mem[132] = sub_d38b576d[idx].field_0
        require ext_code.size(0xce761d788df608bd21bdd59d6f4b54b2e27f25bb)
        call 0xce761d788df608bd21bdd59d6f4b54b2e27f25bb.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0xaa62cdbe5aeffaa3f33d6589c876953cf0014fdd, sub_d38b576d[idx].field_0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if idx == -1:
            revert with 0, 17
...
function craft(uint256 arg1, uint256 arg2) payable {
    ...
    while idx < sub_d38b576d.length:
        mem[0] = 0
        mem[mem[64] + 100] = 0
        require ext_code.size(0xaa62cdbe5aeffaa3f33d6589c876953cf0014fdd)
        staticcall 0xaa62cdbe5aeffaa3f33d6589c876953cf0014fdd.simulate(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) with:
                gas gas_remaining wei
        ...
        if _25:
            if mem[_31] >= 250 * 10^18:
                require ext_code.size(0xaa62cdbe5aeffaa3f33d6589c876953cf0014fdd)
                staticcall 0xaa62cdbe5aeffaa3f33d6589c876953cf0014fdd.next_item() with:
                        gas gas_remaining wei
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                mem[mem[64] + 100] = 0
                require ext_code.size(0xaa62cdbe5aeffaa3f33d6589c876953cf0014fdd)
                call 0xaa62cdbe5aeffaa3f33d6589c876953cf0014fdd.craft(uint256 arg1, uint8 arg2, uint8 arg3, uint256 arg4) with:
                     gas gas_remaining wei
                ...
                mem[mem[64] + 68] = _36
                require ext_code.size(0xaa62cdbe5aeffaa3f33d6589c876953cf0014fdd)
                call 0xaa62cdbe5aeffaa3f33d6589c876953cf0014fdd.0x42842e0e with:
                     gas gas_remaining wei
