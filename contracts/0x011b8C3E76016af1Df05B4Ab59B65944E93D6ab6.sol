...
function unpause() payable {
    ...
    mem[ceil32(return_data.size) + 260 len 96] = approve(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), -1, 0
    ...
    if not return_data.size:
        ...
        if ext_call.return_data[0] > 0:
            ...
            require 0, Mask(224, 0, stor5) == bool(0, Mask(224, 0, stor5))
            if not 0, Mask(224, 0, stor5):
...
function addLiquidity() payable {
    ...
    mem[(2 * ceil32(return_data.size)) + 288 len 64] = ext_call.return_data[0], ext_call.return_data[0]
    mem[(2 * ceil32(return_data.size)) + 352] = 1
    mem[(2 * ceil32(return_data.size)) + 512 len 64] = call.data[calldata.size len 64]
    mem[(2 * ceil32(return_data.size)) + 576 len 64] = call.data[calldata.size len 64]
    mem[(2 * ceil32(return_data.size)) + 640] = usdcAddress
    mem[(2 * ceil32(return_data.size)) + 672] = outputAddress
    mem[(2 * ceil32(return_data.size)) + 384] = (2 * ceil32(return_data.size)) + 640
    mem[(2 * ceil32(return_data.size)) + 704] = ext_call.return_data[0]
    mem[(2 * ceil32(return_data.size)) + 736] = ext_call.return_data[0]
    mem[(2 * ceil32(return_data.size)) + 416] = (2 * ceil32(return_data.size)) + 704
    mem[(2 * ceil32(return_data.size)) + 448] = (2 * ceil32(return_data.size)) + 224
    mem[(2 * ceil32(return_data.size)) + 480] = 0
    mem[(2 * ceil32(return_data.size)) + 768] = 0xa95a17f500000000000000000000000000000000000000000000000000000000
    mem[(2 * ceil32(return_data.size)) + 772] = stor12
    mem[(2 * ceil32(return_data.size)) + 804] = this.address
    mem[(2 * ceil32(return_data.size)) + 836] = this.address
    mem[(2 * ceil32(return_data.size)) + 868] = 128
    idx = 0
    s = (2 * ceil32(return_data.size)) + 640
    t = (2 * ceil32(return_data.size)) + 900
    while idx < 2:
        ...
        t = t + 32
        continue 
    mem[(2 * ceil32(return_data.size)) + 964 len 64] = ext_call.return_data[0], ext_call.return_data[0]
    mem[(2 * ceil32(return_data.size)) + 1028] = 192
    mem[(2 * ceil32(return_data.size)) + 1092] = mem[(2 * ceil32(return_data.size)) + 224]
    mem[(2 * ceil32(return_data.size)) + 1124 len ceil32(mem[(2 * ceil32(return_data.size)) + 224])] = mem[(2 * ceil32(return_data.size)) + 256 len ceil32(mem[(2 * ceil32(return_data.size)) + 224])]
    if ceil32(mem[(2 * ceil32(return_data.size)) + 224]) > mem[(2 * ceil32(return_data.size)) + 224]:
        mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 224] + 1124] = 0
    require ext_code.size(sub_8519359dAddress)
    call sub_8519359dAddress.0xa95a17f5 with:
         gas gas_remaining wei
        args stor12, address(this.address), address(this.address), 128, mem[(2 * ceil32(return_data.size)) + 900 len 64], ext_call.return_data[0], ext_call.return_data[0], 192, 0, mem[(2 * ceil32(return_data.size)) + 224], mem[(2 * ceil32(return_data.size)) + 1124 len ceil32(mem[(2 * ceil32(return_data.size)) + 224])]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0], 0
                mem[ceil32(return_data.size) + 328] = 0
                call wantAddress with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0], 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0], 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0] > 0:
                            revert with memory
                ...
                if not ext_call.return_data[0]:
                    ...
                    mem[ceil32(return_data.size) + 260 len 28] = Mask(224, 0, stor9)
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 388 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] - (0 / WITHDRAWAL_MAX), 0
                    mem[ceil32(return_data.size) + 456] = 0
                    call wantAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] - (0 / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] - (0 / WITHDRAWAL_MAX), 0) << 288)
                else:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 388 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX), 0
                    mem[ceil32(return_data.size) + 456] = 0
                    call wantAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0] > 0:
                            revert with memory
            ...
            if tx.origin == owner:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1, 0
                mem[ceil32(return_data.size) + 328] = 0
                call wantAddress with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1, 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1, 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0] > 0:
                            revert with memory
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 388 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1 - (0 / WITHDRAWAL_MAX), 0
                    mem[ceil32(return_data.size) + 456] = 0
                    call wantAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1 - (0 / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1 - (0 / WITHDRAWAL_MAX), 0) << 288)
                else:
                    require arg1
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 388 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX), 0
                    mem[ceil32(return_data.size) + 456] = 0
                    call wantAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0] > 0:
                            revert with memory
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                mem[(2 * ceil32(return_data.size)) + 196 len 28] = Mask(224, 0, stor9)
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 324 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0], 0
                ...
                if not ext_call.return_data[0]:
                    ...
                    mem[(2 * ceil32(return_data.size)) + 324 len 28] = Mask(224, 0, stor9)
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 452 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] - (0 / WITHDRAWAL_MAX), 0
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 452 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX), 0
                    mem[(2 * ceil32(return_data.size)) + 520] = 0
                    call wantAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 324 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1, 0
                mem[(2 * ceil32(return_data.size)) + 392] = 0
                call wantAddress with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1, 0) >> 224
                     gas gas_remaining wei
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 452 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1 - (0 / WITHDRAWAL_MAX), 0
                    mem[(2 * ceil32(return_data.size)) + 520] = 0
                    call wantAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1 - (0 / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 452 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX), 0
                    mem[(2 * ceil32(return_data.size)) + 520] = 0
                    call wantAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
