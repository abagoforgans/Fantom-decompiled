...
function mint(address arg1, string arg2) payable {
    ...
    if stor14[stor13].field_0:
        if stor14[stor13].field_0 == uint255(stor14[stor13].field_0) * 0.5 < 32:
            revert with 0, 34
        if arg2.length:
            stor14[stor13][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor14[stor13].field_0 = 0
            idx = 0
            while (uint255(stor14[stor13].field_0) * 0.5) + 31 / 32 > idx:
                stor14[stor13][idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if stor14[stor13].field_0 == stor14[stor13].field_1 < 32:
            revert with 0, 34
        if arg2.length:
            stor14[stor13][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor14[stor13].field_0 = 0
            idx = 0
            while stor14[stor13].field_1 + 31 / 32 > idx:
                stor14[stor13][idx].field_0 = 0
                idx = idx + 1
                continue 
    stor13++
        ...
        if stor14[arg1].field_0:
            ...
            if stor14[arg1].field_1:
                if 31 < stor14[arg1].field_1:
                    ...
                    return Array(len=2 * Mask(256, -1, stor14[arg1].field_0), data=mem[128 len ceil32(uint255(stor14[arg1].field_0) * 0.5)])
                mem[128] = 256 * stor14[arg1].field_8
        mem[ceil32(uint255(stor14[arg1].field_0) * 0.5) + 224 len ceil32(uint255(stor14[arg1].field_0) * 0.5)] = mem[128 len ceil32(uint255(stor14[arg1].field_0) * 0.5)]
        if ceil32(uint255(stor14[arg1].field_0) * 0.5) > uint255(stor14[arg1].field_0) * 0.5:
            mem[(uint255(stor14[arg1].field_0) * 0.5) + ceil32(uint255(stor14[arg1].field_0) * 0.5) + 224] = 0
        return Array(len=2 * Mask(256, -1, stor14[arg1].field_0), data=mem[128 len ceil32(uint255(stor14[arg1].field_0) * 0.5)], mem[(2 * ceil32(uint255(stor14[arg1].field_0) * 0.5)) + 224 len 2 * ceil32(uint255(stor14[arg1].field_0) * 0.5)]), 
    if stor14[arg1].field_0 == stor14[arg1].field_1 < 32:
        revert with 0, 34
    if stor14[arg1].field_0:
        if stor14[arg1].field_0 == uint255(stor14[arg1].field_0) * 0.5 < 32:
        ...
        if stor14[arg1].field_1:
            if 31 < stor14[arg1].field_1:
                ...
                return Array(len=stor14[arg1].field_0, data=mem[128 len ceil32(stor14[arg1].field_1)])
            mem[128] = 256 * stor14[arg1].field_8
    mem[ceil32(stor14[arg1].field_1) + 224 len ceil32(stor14[arg1].field_1)] = mem[128 len ceil32(stor14[arg1].field_1)]
    if ceil32(stor14[arg1].field_1) > stor14[arg1].field_1:
        mem[stor14[arg1].field_1 + ceil32(stor14[arg1].field_1) + 224] = 0
    return Array(len=stor14[arg1].field_0, data=mem[128 len ceil32(stor14[arg1].field_1)], mem[(2 * ceil32(stor14[arg1].field_1)) + 224 len 2 * ceil32(stor14[arg1].field_1)]), 
}
