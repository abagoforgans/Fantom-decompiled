...
function sub_c8ee00be(?) payable {
    ...
    mem[mem[64]] = 36
    mem[64] = mem[64] + 68
    mem[_4005 + 32 len 4] = unknown_0x70a08231(?????)
    staticcall _4002.0x70a08231 with:
            gas gas_remaining wei
        ...
        while idx < _4615:
            ...
            if _4628 + 32 > mem[_4627]:
                ...
                if mem[_4621 + 96] <= 0:
                    ...
                    staticcall _4718.0x70a08231 with:
                            gas gas_remaining wei
                    ...
                    if mem[_4621 + 96] >= s:
                        ...
                        mem[64] = _4633 + 132
                        mem[_4633 + 96] = 0x70a0823100000000000000000000000000000000000000000000000000000000 or address(this.address) << 64
                        staticcall _4724.0x70a08231 with:
                                gas gas_remaining wei
                               args 0 or address(this.address) << 64, 0
                    else:
                        call mem[_4621] with:
                        ...
                        mem[64] = _4633 + 132
                        mem[_4633 + 96] = 0x70a0823100000000000000000000000000000000000000000000000000000000 or address(this.address) << 64
                        staticcall _4725.0x70a08231 with:
                                gas gas_remaining wei
                               args 0 or address(this.address) << 64, 0
                mem[0] = ext_call.return_data[0]
                if 1 != ext_call.success:
    ...
    while idx < _4616:
        ...
        if _4632 + 32 > mem[_4631]:
            ...
            if mem[_4623 + 96] <= 0:
                ...
                staticcall _4720.0x70a08231 with:
                        gas gas_remaining wei
                       args 0 or address(this.address) << 64, 0
            else:
                if mem[_4623 + 96] >= s:
                    ...
                    mem[64] = _4635 + 132
                    mem[_4635 + 96] = 0x70a0823100000000000000000000000000000000000000000000000000000000 or address(this.address) << 64
                    staticcall _4729.0x70a08231 with:
                            gas gas_remaining wei
                           args 0 or address(this.address) << 64, 0
                else:
                    call mem[_4623] with:
                    ...
                    mem[64] = _4635 + 132
                    mem[_4635 + 96] = 0x70a0823100000000000000000000000000000000000000000000000000000000 or address(this.address) << 64
                    staticcall _4730.0x70a08231 with:
                            gas gas_remaining wei
                           args 0 or address(this.address) << 64, 0
            mem[0] = ext_call.return_data[0]
            if 1 != ext_call.success:
