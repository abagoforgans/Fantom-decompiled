    ...
    if cd[36] == cd[68]:
        if not ('cd', 4).length:
            ...
            while idx < ('cd', 4).length:
                if idx >= ('cd', 4).length:
                    revert with 0, 50
                mem[(32 * idx) + ceil32(32 * ('cd', 4).length) + 129] = stor6
                if idx == -1:
                    revert with 0, 17
                idx = idx + 1
                continue 
            var31001 = ('cd', 4).length
        else:
        ...
        if cd[68] != stor4[cd[36]]:
            if not ('cd', 4).length:
                idx = 0
                while idx < ('cd', 4).length:
                    if idx >= ('cd', 4).length:
                        revert with 0, 50
                    mem[(32 * idx) + ceil32(32 * ('cd', 4).length) + 129] = stor5
                    if idx == -1:
                        revert with 0, 17
                    idx = idx + 1
                    continue 
            ...
            while idx < ('cd', 4).length:
                if idx >= ('cd', 4).length:
                    revert with 0, 50
                mem[(32 * idx) + ceil32(32 * ('cd', 4).length) + 129] = stor7
                if idx == -1:
                    revert with 0, 17
                idx = idx + 1
                continue 
