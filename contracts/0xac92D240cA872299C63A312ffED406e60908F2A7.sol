...
function byteCode(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return 32, 8946, code.data[5837 len 8914], mem[9042 len 14] >> 71056, arg1, 0 >> 71312, 0
}
...
function sub_f49126f8(?) payable {
    ...
    if feeds[address(arg1)]:
        revert with 0, 'PE'
    mem[9152 len 8928] = code.data[5837 len 8914], mem[9042 len 14]
    mem[18066] = address(arg1)
    mem[18130] = address(arg1)
    mem[18098] = 20
    ...
    create contract with 0 wei
                    code: code.data[5837 len 8914], address(create2.new_address), bool(arg2)
