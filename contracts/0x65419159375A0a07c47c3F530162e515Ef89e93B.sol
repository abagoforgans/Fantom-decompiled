...
function withdraw() {
    ...
    if eth.balance(this.address) and 30 > -1 / eth.balance(this.address):
        revert with 'NH{q', 17
    if eth.balance(this.address) and 40 > -1 / eth.balance(this.address):
        revert with 'NH{q', 17
    call 0x52cb8fef95e99c66cf6682e516509949b8324c12 with:
       value 30 * eth.balance(this.address) / 100 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    call 0xa5997430096bc83059788ebf22fd8282b655bdec with:
       value 30 * eth.balance(this.address) / 100 wei
         gas 2300 * is_zero(value) wei
    call 0xb8bde92bac8e429c2bb8e295f6f36f3dab707aae with:
...
function mint(uint256 arg1, string arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    ...
    if arg1 > 10:
        revert with 0, 'only 10 per transaction allowed'
    ...
    idx = 0
    while idx < arg1:
        if bool(stor13[stor12].field_0):
            if bool(stor13[stor12].field_0) == uint255(stor13[stor12].field_1) < 32:
                revert with 'NH{q', 34
            mem[0] = sha3(stor12, 13)
            if not mem[96]:
                stor13[stor12].field_0 = 0
                s = sha3(sha3(stor12, 13))
                while sha3(sha3(stor12, 13)) + (uint255(stor13[stor12].field_1) + 31 / 32) > s:
                    stor[s] = 0
                    s = s + 1
                    continue 
                if tokenByIndex.length >= maxSupply:
                ...
                if msg.sender:
                    ...
                    if ext_code.size(msg.sender) > 0:
                        ...
                        s = 0
                        while s < 0:
                            mem[mem[64] + s + 164] = mem[_1504 + s + 32]
                            s = s + 32
                            continue 
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2274] == Mask(32, 224, mem[_2274])
                        if Mask(32, 224, mem[_2274]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                else:
                    if tokenByIndex.length < 1:
                        revert with 'NH{q', 17
                    ...
                    if ext_code.size(msg.sender) > 0:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2275] == Mask(32, 224, mem[_2275])
                        if Mask(32, 224, mem[_2275]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
            else:
                stor13[stor12].field_0 = (2 * mem[96]) + 1
                t = sha3(sha3(stor12, 13))
                s = 128
                while mem[96] + 128 > s:
                    stor[t] = mem[s]
                    t = t + 1
                    s = s + 32
                    continue 
                s = sha3(sha3(stor12, 13)) + (Mask(251, 0, mem[96] + 31) >> 5)
                while sha3(sha3(stor12, 13)) + (uint255(stor13[stor12].field_1) + 31 / 32) > s:
                    stor[s] = 0
                    s = s + 1
                    continue 
                ...
                if msg.sender:
                    ...
                    if ext_code.size(msg.sender) > 0:
                        ...
                        s = 0
                        while s < 0:
                            mem[mem[64] + s + 164] = mem[_2284 + s + 32]
                            s = s + 32
                            continue 
                        require ext_code.size(msg.sender)
                        call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2776] == Mask(32, 224, mem[_2776])
                        if Mask(32, 224, mem[_2776]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                else:
                    if tokenByIndex.length < 1:
                        revert with 'NH{q', 17
                    ...
                    if ext_code.size(msg.sender) > 0:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2777] == Mask(32, 224, mem[_2777])
                        if Mask(32, 224, mem[_2777]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        else:
            if bool(stor13[stor12].field_0) == stor13[stor12].field_1 % 128 < 32:
                revert with 'NH{q', 34
            mem[0] = sha3(stor12, 13)
            if not mem[96]:
                stor13[stor12].field_0 = 0
                s = sha3(sha3(stor12, 13))
                while sha3(sha3(stor12, 13)) + (stor13[stor12].field_1 % 128 + 31 / 32) > s:
                    stor[s] = 0
                    s = s + 1
                    continue 
                if tokenByIndex.length >= maxSupply:
                ...
                if msg.sender:
                    ...
                    if ext_code.size(msg.sender) > 0:
                        ...
                        s = 0
                        while s < 0:
                            mem[mem[64] + s + 164] = mem[_1507 + s + 32]
                            s = s + 32
                            continue 
                        require ext_code.size(msg.sender)
                        call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2280] == Mask(32, 224, mem[_2280])
                        if Mask(32, 224, mem[_2280]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                else:
                    if tokenByIndex.length < 1:
                        revert with 'NH{q', 17
                    ...
                    if ext_code.size(msg.sender) > 0:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2281] == Mask(32, 224, mem[_2281])
                        if Mask(32, 224, mem[_2281]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
            else:
                stor13[stor12].field_0 = (2 * mem[96]) + 1
                t = sha3(sha3(stor12, 13))
                ...
                if msg.sender:
                    ...
                    if ext_code.size(msg.sender) > 0:
                        ...
                        s = 0
                        while s < 0:
                            mem[mem[64] + s + 164] = mem[_2291 + s + 32]
                            s = s + 32
                            continue 
                        require ext_code.size(msg.sender)
                        call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2778] == Mask(32, 224, mem[_2778])
                        if Mask(32, 224, mem[_2778]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                else:
                    if tokenByIndex.length < 1:
                        revert with 'NH{q', 17
                    ...
                    if ext_code.size(msg.sender) > 0:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2779] == Mask(32, 224, mem[_2779])
                        if Mask(32, 224, mem[_2779]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        stor12++
        if idx == -1:
            revert with 'NH{q', 17
