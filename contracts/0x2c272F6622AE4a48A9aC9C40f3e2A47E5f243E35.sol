...
address sub_507c87cfAddress;
address etherAddress;
uint256 slippageFactor;
uint256 sub_532cdc7b;
...
function sub_507c87cf(?) {
    return sub_507c87cfAddress
}

function sub_532cdc7b(?) {
    return sub_532cdc7b
}

function sub_5ede7802(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    return bool(stor1[arg1])
}

function sub_8c845d3f(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
...
function setEtherAddress(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function sub_38fa8cf1(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_507c87cfAddress = address(arg1)
}

function sub_a3bd2bab(?) {
