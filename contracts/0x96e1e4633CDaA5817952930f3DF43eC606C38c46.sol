...
function balanceOfPool() payable {
    ...
    staticcall sub_a3afda1aAddress.userInfo(uint16 arg1, address arg2) with:
            gas gas_remaining wei
           args uint16(stor22.field_0), this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    call summitAddress.deposit(uint16 arg1, uint256 arg2, uint256 arg3, uint8 arg4) with:
         gas gas_remaining wei
        args 0, uint32(stor22.field_0), ext_call.return_data[0], 0, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function retireStrat() payable {
    ...
    require return_data.size >= 64
    require ext_code.size(summitAddress)
    call summitAddress.withdraw(uint16 arg1, uint256 arg2, uint256 arg3) with:
         gas gas_remaining wei
        args uint16(stor22.field_0), ext_call.return_data[32], 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(wantAddress)
    staticcall wantAddress.0x70a08231 with:
...
function withdraw(uint16 arg1) payable {
    require calldata.size - 4 >= 32
    if address(vaultAddress) != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(wantAddress)
    ...
    call summitAddress.withdraw(uint16 arg1, uint256 arg2, uint256 arg3) with:
         gas gas_remaining wei
        args uint16(stor22.field_0), arg1 - ext_call.return_data[0], 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(wantAddress)
    staticcall wantAddress.0x70a08231 with:
    ...
    if ext_call.return_data[0] > arg1:
        if tx.origin == owner:
            ...
            mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor3), uint32(stor3), uint16(arg1) << 208
            mem[324 len 0] = 0
            call wantAddress with:
               funct uint32(stor3)
                 gas gas_remaining wei
                args Mask(480, -256, Mask(224, 0, stor3), uint32(stor3), uint16(arg1) << 208) << 256, mem[324 len 4]
            ...
            if stor0:
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, arg1 - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor3)
                         gas gas_remaining wei
                        args Mask(224, 32, arg1 - (0 / WITHDRAWAL_MAX)) << 224, mem[388 len 4]
                else:
                    require arg1
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor3)
                         gas gas_remaining wei
                        args Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX)) << 224, mem[388 len 4]
                if not return_data.size:
        ...
        if tx.origin == owner:
            ...
            if stor0:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, ext_call.return_data[0] - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor3)
                         gas gas_remaining wei
                        args Mask(224, 32, ext_call.return_data[0] - (0 / WITHDRAWAL_MAX)) << 224, mem[388 len 4]
                else:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    mem[388 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor3)
                         gas gas_remaining wei
                        args Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX)) << 224, mem[388 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 'SafeMath: division by zero'
                mem[356 len return_data.size] = ext_call.return_data[0 len return_data.size]
...
function makeCustomTxn(address arg1, address arg2, address arg3, uint256 arg4) payable {
    ...
    if ext_call.return_data[0] >= arg4:
        ...
        idx = 96
        while 160 > idx:
            stor28[s].field_0 = mem[idx + 12 len 20]
            s = s + 1
            idx = idx + 32
            continue 
        idx = 2
        ...
        mem[228] = 160
        mem[324] = stor28.length
        if not stor28.length:
            require ext_code.size(arg3)
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor28.length
        else:
            mem[0] = 28
            mem[356] = address(stor28.field_0)
            idx = 356
            s = 0
            while (32 * stor28.length) + 356 > idx + 32:
            ...
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor28.length, mem[356 len 32 * stor28.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                mem[556] = 160
                mem[652] = stor28.length
                if not stor28.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor28.length
                else:
                    mem[0] = 28
                    mem[684] = address(stor28.field_0)
                    idx = 684
                    s = 0
                    while (32 * stor28.length) + 684 > idx + 32:
                        mem[idx + 32] = stor28[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor28.length, mem[684 len 32 * stor28.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                mem[ceil32(return_data.size) + 653] = stor28.length
                if not stor28.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                    ...
                    mem[0] = 28
                    mem[ceil32(return_data.size) + 685] = address(stor28.field_0)
                    idx = ceil32(return_data.size) + 685
                    s = 0
                    while ceil32(return_data.size) + (32 * stor28.length) + 685 > idx + 32:
                        mem[idx + 32] = stor28[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor28.length, mem[ceil32(return_data.size) + 685 len 32 * stor28.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            if return_data.size <= 0:
                ...
                if not return_data.size:
                    ...
                    mem[(2 * ceil32(return_data.size)) + 654] = stor28.length
                    if not stor28.length:
                        require ext_code.size(arg3)
                        call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                        ...
                        mem[0] = 28
                        mem[(2 * ceil32(return_data.size)) + 686] = address(stor28.field_0)
                        idx = (2 * ceil32(return_data.size)) + 686
                        s = 0
                        while (2 * ceil32(return_data.size)) + (32 * stor28.length) + 686 > idx + 32:
                            mem[idx + 32] = stor28[s].field_256
                            idx = idx + 32
                            s = s + 1
                            continue 
                        ...
                        call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args arg4, 0, 160, address(this.address), block.timestamp + 600, stor28.length, mem[(2 * ceil32(return_data.size)) + 686 len 32 * stor28.length]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                ...
                if not return_data.size:
                    ...
                    if not stor28.length:
                        ...
                        call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args arg4, 0, 160, address(this.address), block.timestamp + 600, stor28.length, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                    else:
                        mem[0] = 28
                        mem[(2 * ceil32(return_data.size)) + 686] = address(stor28.field_0)
                        idx = (2 * ceil32(return_data.size)) + 686
                        ...
                        call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args arg4, 0, 160, address(this.address), block.timestamp + 600, stor28.length, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) + (32 * stor28.length) - (2 * ceil32(return_data.size))]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[(2 * ceil32(return_data.size)) + 490 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    mem[64] = (4 * ceil32(return_data.size)) + 490
