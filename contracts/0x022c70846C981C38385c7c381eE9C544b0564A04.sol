...
#  - sub_7862de3d(?)
#
const sub_6cbac3b4(?) = '', 0, 0, 160, 192, 0, 0, None
...
function sub_c3c1829e(?) payable {
    ...
    require ('cd', 36).length / 2 <= test266151307()
    mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320] = ('cd', 36).length / 2
    mem[64] = (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (16 * Mask(251, 1, ('cd', 36).length)) + 352
    if not Mask(255, 1, ('cd', 36).length):
        idx = ('cd', 36).length / 2
        s = 0
        s = var56007
        while idx < ('cd', 36).length - 1:
            require idx - (('cd', 36).length / 2) < mem[96]
            _413 = mem[(32 * idx - (('cd', 36).length / 2)) + 128]
            require ext_code.size(mem[(32 * idx - (('cd', 36).length / 2)) + 140 len 20])
            staticcall mem[(32 * idx - (('cd', 36).length / 2)) + 140 len 20].getReserves() with:
                    gas gas_remaining wei
            mem[mem[64] len 96] = ext_call.return_data[0 len 96]
            ...
            require return_data.size >= 96
            _427 = mem[_423]
            require mem[_423] == mem[_423 + 18 len 14]
            _433 = mem[_423 + 32]
            require mem[_423 + 32] == mem[_423 + 50 len 14]
            ...
            if mem[(32 * idx) + 140 len 20] < mem[(32 * idx + 1) + 140 len 20]:
                ...
                if mem[(32 * idx) + 140 len 20] == mem[(32 * idx) + 140 len 20]:
                    require idx - (('cd', 36).length / 2) < mem[(32 * ('cd', 36).length) + 128]
                    require (10000 * mem[_423 + 18 len 14]) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
                    require idx - (('cd', 36).length / 2) < mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320]
                    mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 352] = s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160] * mem[_423 + 50 len 14] / (10000 * mem[_423 + 18 len 14]) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
                    idx = idx + 1
                    s = _413
                    s = s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160] * Mask(112, 0, _433) / (10000 * Mask(112, 0, _427)) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
                    continue 
            else:
                if not mem[(32 * idx + 1) + 140 len 20]:
                    revert with 0, 'MdexSwapFactory: ZERO_ADDRESS'
                ...
                if mem[(32 * idx + 1) + 140 len 20] == mem[(32 * idx) + 140 len 20]:
                    ...
                    continue 
            require idx - (('cd', 36).length / 2) < mem[(32 * ('cd', 36).length) + 128]
            require (10000 * mem[_423 + 50 len 14]) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
            require idx - (('cd', 36).length / 2) < mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320]
            mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 352] = s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160] * mem[_423 + 18 len 14] / (10000 * mem[_423 + 50 len 14]) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
            idx = idx + 1
            s = _413
            s = s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160] * Mask(112, 0, _427) / (10000 * Mask(112, 0, _433)) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
            continue 
        require mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320] - 1 < mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320]
        if mem[(32 * mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320] - 1) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 352] - var56007 >= var56001:
            ...
            var56001 = mem[(32 * mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320] - 1) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 352] - var56007
            var56002 = mem[(32 * mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320] - 1) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 352]
            var56003 = (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320
        ...
        while idx < mem[96]:
            ...
            t = t + 32
            continue 
        _507 = mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 288]
        mem[mem[64] + 160] = (32 * _441) + 192
        _509 = mem[_507]
        mem[mem[64] + (32 * _441) + 224] = mem[_507]
        mem[mem[64] + (32 * _441) + 256 len 32 * _509] = mem[_507 + 32 len 32 * _509]
        return mem[mem[64] len 160], (32 * _441) + 192, mem[mem[64] + 192 len (32 * _441) + (32 * _509) + 64]
    mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 352 len 16 * Mask(251, 1, ('cd', 36).length)] = call.data[calldata.size len 16 * Mask(251, 1, ('cd', 36).length)]
    idx = ('cd', 36).length / 2
    s = 0
    s = var56007
    while idx < ('cd', 36).length - 1:
        require idx - (('cd', 36).length / 2) < mem[96]
        _418 = mem[(32 * idx - (('cd', 36).length / 2)) + 128]
        require ext_code.size(mem[(32 * idx - (('cd', 36).length / 2)) + 140 len 20])
        staticcall mem[(32 * idx - (('cd', 36).length / 2)) + 140 len 20].getReserves() with:
                gas gas_remaining wei
        mem[mem[64] len 96] = ext_call.return_data[0 len 96]
        ...
        require return_data.size >= 96
        _428 = mem[_424]
        require mem[_424] == mem[_424 + 18 len 14]
        _434 = mem[_424 + 32]
        require mem[_424 + 32] == mem[_424 + 50 len 14]
        ...
        if mem[(32 * idx) + 140 len 20] < mem[(32 * idx + 1) + 140 len 20]:
            ...
            if mem[(32 * idx) + 140 len 20] == mem[(32 * idx) + 140 len 20]:
                require idx - (('cd', 36).length / 2) < mem[(32 * ('cd', 36).length) + 128]
                require (10000 * mem[_424 + 18 len 14]) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
                require idx - (('cd', 36).length / 2) < mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320]
                mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 352] = s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160] * mem[_424 + 50 len 14] / (10000 * mem[_424 + 18 len 14]) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
                idx = idx + 1
                s = _418
                s = s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160] * Mask(112, 0, _434) / (10000 * Mask(112, 0, _428)) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
                continue 
        else:
            if not mem[(32 * idx + 1) + 140 len 20]:
                revert with 0, 'MdexSwapFactory: ZERO_ADDRESS'
            ...
            if mem[(32 * idx + 1) + 140 len 20] == mem[(32 * idx) + 140 len 20]:
                ...
                continue 
        require idx - (('cd', 36).length / 2) < mem[(32 * ('cd', 36).length) + 128]
        require (10000 * mem[_424 + 50 len 14]) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
        require idx - (('cd', 36).length / 2) < mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320]
        mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 352] = s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160] * mem[_424 + 18 len 14] / (10000 * mem[_424 + 50 len 14]) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
        idx = idx + 1
        s = _418
        s = s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160] * Mask(112, 0, _428) / (10000 * Mask(112, 0, _434)) + (s * mem[(32 * idx - (('cd', 36).length / 2)) + (32 * ('cd', 36).length) + 160])
        continue 
    require mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320] - 1 < mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320]
    if mem[(32 * mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 320] - 1) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 352] - var56007 >= var56001:
        mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 160] = var56007
    ...
    while idx < _442:
        ...
        t = t + 32
        continue 
    _508 = mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 288]
    mem[_426 + 160] = (32 * _442) + 192
    _510 = mem[_508]
    mem[_426 + (32 * _442) + 224] = mem[_508]
    mem[_426 + (32 * _442) + 256 len 32 * _510] = mem[_508 + 32 len 32 * _510]
    return memory
      from mem[64]
       len _426 + (32 * _442) + (32 * _510) + -mem[64] + 256
}
