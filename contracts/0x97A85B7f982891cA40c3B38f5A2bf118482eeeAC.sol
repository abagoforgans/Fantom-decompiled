...
function sub_4db2c9f1(?) payable {
    ...
    if not arg2 / sub_607459f4:
        ...
        if arg2 / sub_607459f4 * stor6 / arg2 / sub_607459f4 != stor6:
            revert with 0, 'SafeMath: multiplication overflow'
        if arg2 / sub_607459f4 * stor6 / 10000 > arg2 / sub_607459f4:
            revert with 0, 'SafeMath: subtraction overflow', 0
        if arg2 / sub_607459f4 < arg2 / sub_607459f4 * stor6 / 10000:
            revert with 'NH{q', 17
        if not sub_607459f4:
            if eth.balance(this.address) < arg2 / sub_607459f4:
                revert with 0, 'No FTM Balance in Swapper'
            ...
            if sub_607459f4 and (arg2 / sub_607459f4) - (arg2 / sub_607459f4 * stor6 / 10000) > -1 / sub_607459f4:
                revert with 'NH{q', 17
            if not sub_607459f4:
                revert with 'NH{q', 18
            if (arg2 / sub_607459f4 * sub_607459f4) - (arg2 / sub_607459f4 * stor6 / 10000 * sub_607459f4) / sub_607459f4 != (arg2 / sub_607459f4) - (arg2 / sub_607459f4 * stor6 / 10000):
                revert with 0, 'SafeMath: multiplication overflow'
            if eth.balance(this.address) < arg2 / sub_607459f4:
                revert with 0, 'No FTM Balance in Swapper'
            require ext_code.size(stor0)
            call stor0.transfer(uint256 arg1, uint256 arg2, uint256 arg3) with:
                 gas gas_remaining wei
                args arg1, stor3, (arg2 / sub_607459f4 * sub_607459f4) - (arg2 / sub_607459f4 * stor6 / 10000 * sub_607459f4)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        call stor9 with:
           value arg2 / sub_607459f4 * stor6 / 10000 wei
             gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_e6876fc7(?) payable {
    ...
    if not msg.value:
        ...
        if not sub_607459f4:
            ...
            if sub_607459f4 and msg.value - (msg.value * stor6 / 10000) > -1 / sub_607459f4:
                revert with 'NH{q', 17
            if not sub_607459f4:
                revert with 'NH{q', 18
            if (msg.value * sub_607459f4) - (msg.value * stor6 / 10000 * sub_607459f4) / sub_607459f4 != msg.value - (msg.value * stor6 / 10000):
                revert with 0, 'SafeMath: multiplication overflow'
            require ext_code.size(stor0)
            staticcall stor0.balanceOf(uint256 arg1) with:
                    gas gas_remaining wei
            ...
            require return_data.size >= 32
            require ext_call.return_data[0] == ext_call.return_data[0]
            if ext_call.return_data[0] < (msg.value * sub_607459f4) - (msg.value * stor6 / 10000 * sub_607459f4):
                revert with 0, 'No Gold Balance in Swapper'
            require ext_code.size(stor0)
            call stor0.transfer(uint256 arg1, uint256 arg2, uint256 arg3) with:
                 gas gas_remaining wei
                args stor3, arg1, (msg.value * sub_607459f4) - (msg.value * stor6 / 10000 * sub_607459f4)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
