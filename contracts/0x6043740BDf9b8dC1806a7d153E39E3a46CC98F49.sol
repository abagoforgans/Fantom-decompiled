...
function pause() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    Mask(96, 0, stor15.field_160) = Mask(96, 0, not bool(uint8(stor15.field_160)))
}
...
function sub_43ca14f0(?) {
    if not sub_4202a912.length:
        ...
        while idx < sub_6eb0fc57.length:
            mem[0] = 1
            if uint8(sub_6eb0fc57[idx].field_1024):
                idx = idx + 1
                s = (5 * idx) + sha3(1)
                s = s
                continue 
    ...
    if not sub_4202a912.length:
        ...
        if tokenFeeAddress != supraAddress:
            if not return_data.size:
                ...
                if ext_code.size(tokenFeeAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[488 len 96] = 0, msg.sender, treasureAddress, Mask(224, 0, stor13.field_32)
                mem[612 len 4] = 0
                call tokenFeeAddress with:
                   funct uint32(stor15.field_0)
                     gas gas_remaining wei
                    args bridgeFee, mem[424 len 60], mem[584 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg1
                    if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
                ...
                if return_data.size <= 0:
                    if ext_code.size(tokenFeeAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 489 len 96] = 0, msg.sender, treasureAddress, Mask(224, 0, stor13.field_32)
                    mem[ceil32(return_data.size) + 613 len 4] = 0
                    call tokenFeeAddress with:
                       funct uint32(stor15.field_0)
                         gas gas_remaining wei
                        args bridgeFee, mem[ceil32(return_data.size) + 425 len 60], mem[ceil32(return_data.size) + 585 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg1
                        if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
        ...
        if tokenFeeAddress != supraAddress:
            ...
            if not return_data.size:
                ...
                if ext_code.size(supraAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[456 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor15.field_0), uint32(stor15.field_0), Mask(224, 0, stor13.field_32)
                mem[520 len 0] = 0
                call supraAddress with:
                   funct uint32(stor15.field_0)
                     gas gas_remaining wei
                ...
                if return_data.size <= 0:
                    if ext_code.size(supraAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 457 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor15.field_0), uint32(stor15.field_0), Mask(224, 0, stor13.field_32)
                    call supraAddress with:
                       funct uint32(stor15.field_0)
                         gas gas_remaining wei
