...
function sub_1b33697c(?) payable {
    ...
    if ceil32(arg1.length) <= arg1.length:
        _45 = sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])
        if msg.value < uint256(stor2[_45]):
            revert with 0, 'not enough was paid'
        require ext_code.size(stor[_45])
        call stor[_45].transferFrom(address arg1, address arg2, uint256 arg3) with:
             gas gas_remaining wei
            args stor3[_45], msg.sender, stor1[_45]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        _54 = sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])
        if msg.value < uint256(stor2[_54]):
            revert with 0, 'not enough was paid'
        require ext_code.size(stor[_54])
        call stor[_54].transferFrom(address arg1, address arg2, uint256 arg3) with:
             gas gas_remaining wei
            args stor3[_54], msg.sender, stor1[_54]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if msg.value and stor1.length > -1 / msg.value:
            revert with 'NH{q', 17
