...
function init() payable {
    ...
    stor5 = 0x3063f59bb1a5a98f301f572485e9666913cbc025
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if msg.sender == 0x6ab7f198b14767e56083fd7526472e0c45b1d77f:
        require ext_code.size(0x3063f59bb1a5a98f301f572485e9666913cbc025)
        staticcall 0x3063f59bb1a5a98f301f572485e9666913cbc025.0x4cdc9c63 with:
    ...
    if arg1 == 0x800b51e28d69268d34e2875232592be4a177a9e3:
        ...
        if arg1 == 0x3063f59bb1a5a98f301f572485e9666913cbc025:
            balanceOf[address(msg.sender)] -= arg2
            balanceOf[address(arg1)] += arg2
            emit Transfer(arg2, msg.sender, arg1);
        else:
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if arg2 == 0x800b51e28d69268d34e2875232592be4a177a9e3:
        ...
        if arg2 == 0x3063f59bb1a5a98f301f572485e9666913cbc025:
            balanceOf[address(arg1)] -= arg3
            balanceOf[address(arg2)] += arg3
            emit Transfer(arg3, arg1, arg2);
        else:
...
function bulkTransfer(address[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg2.length:
        ...
        if mem[(32 * idx) + 140 len 20] == 0x800b51e28d69268d34e2875232592be4a177a9e3:
            require idx < arg2.length
            require idx < arg1.length
            ...
            s = s
            t = t
            u = u + mem[(32 * idx) + (32 * arg1.length) + 160]
            continue 
        require idx < arg1.length
        require idx < arg2.length
        if mem[(32 * idx) + 140 len 20] == 0x3063f59bb1a5a98f301f572485e9666913cbc025:
            require idx < arg1.length
            mem[0] = mem[(32 * idx) + 140 len 20]
            mem[32] = 1
            balanceOf[mem[(32 * idx) + 140 len 20]] += mem[(32 * idx) + (32 * arg1.length) + 160]
            ...
            u = u + mem[(32 * idx) + (32 * arg1.length) + 160]
            continue 
        _123 = mem[(32 * idx) + (32 * arg1.length) + 160]
        require idx < arg2.length
        ...
        u = u + _89
        continue 
    balanceOf[0x6ab7f198b14767e56083fd7526472e0c45b1d77f] += t
    stor7 += t
    if balanceOf[address(msg.sender)] < u:
    ...
    if 0x32cfc998a98450b11d07f698992d8bf79f67876b != msg.sender:
        ...
        _158 = sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + (32 * arg2.length) + floor32(arg1.length) + 160 len (32 * arg1.length) - floor32(arg1.length)])
        mem[(32 * arg1.length) + (32 * arg2.length) + 224 len floor32(arg2.length)] = mem[(32 * arg1.length) + 160 len floor32(arg2.length)]
        emit BulkTransfer(Array(len=arg2.length, data=mem[(32 * arg1.length) + 160 len floor32(arg2.length)], mem[(32 * arg1.length) + (32 * arg2.length) + floor32(arg2.length) + 224 len (32 * arg2.length) - floor32(arg2.length)]), msg.sender, _158);
    else:
        if 0x6ab7f198b14767e56083fd7526472e0c45b1d77f != msg.sender:
            balanceOf[address(msg.sender)] -= u
            mem[(32 * arg1.length) + (32 * arg2.length) + 160 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
            _164 = sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + (32 * arg2.length) + floor32(arg1.length) + 160 len (32 * arg1.length) - floor32(arg1.length)])
            mem[(32 * arg1.length) + (32 * arg2.length) + 224 len floor32(arg2.length)] = mem[(32 * arg1.length) + 160 len floor32(arg2.length)]
            emit BulkTransfer(Array(len=arg2.length, data=mem[(32 * arg1.length) + 160 len floor32(arg2.length)], mem[(32 * arg1.length) + (32 * arg2.length) + floor32(arg2.length) + 224 len (32 * arg2.length) - floor32(arg2.length)]), msg.sender, _164);
        else:
            require ext_code.size(0x3063f59bb1a5a98f301f572485e9666913cbc025)
            staticcall 0x3063f59bb1a5a98f301f572485e9666913cbc025.0x4cdc9c63 with:
                    gas gas_remaining wei
            ...
            require return_data.size >= 32
            require ext_call.return_data[0]
            require u <= (31 * 10^15 * block.number) + (-31 * 10^15 * ext_call.return_data[0]) + balanceOf[0x6ab7f198b14767e56083fd7526472e0c45b1d77f] + -stor7 - 4900000 * 10^18
            require u <= balanceOf[0x6ab7f198b14767e56083fd7526472e0c45b1d77f] - stor7
            balanceOf[address(msg.sender)] -= u
            mem[(32 * arg1.length) + (32 * arg2.length) + 160 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
            _170 = sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + (32 * arg2.length) + floor32(arg1.length) + 160 len (32 * arg1.length) - floor32(arg1.length)])
            mem[(32 * arg1.length) + (32 * arg2.length) + 224 len floor32(arg2.length)] = mem[(32 * arg1.length) + 160 len floor32(arg2.length)]
            emit BulkTransfer(Array(len=arg2.length, data=mem[(32 * arg1.length) + 160 len floor32(arg2.length)], mem[(32 * arg1.length) + (32 * arg2.length) + floor32(arg2.length) + 224 len (32 * arg2.length) - floor32(arg2.length)]), msg.sender, _170);
    return 1
}
