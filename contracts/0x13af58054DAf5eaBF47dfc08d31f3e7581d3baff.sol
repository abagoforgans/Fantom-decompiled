...
function withdrawAll() {
    ...
    if not ext_call.return_data[0]:
        ...
        call sub_6a0f3a10Address.redeem(address arg1, uint256 arg2, address arg3, uint256 arg4, bytes arg5) with:
             gas gas_remaining wei
            args 0, uint32(stor21), 0 / ext_call.return_data[0], this.address, block.timestamp + 60, 160, 0, mem[356]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if 0 > principal:
            revert with 0, 'SafeMath: subtraction overflow'
        ...
        if not ext_call.return_data[0]:
            ...
            call sub_6a0f3a10Address.redeem(address arg1, uint256 arg2, address arg3, uint256 arg4, bytes arg5) with:
                 gas gas_remaining wei
                args address(sub_2a1b004fAddress), 0 / ext_call.return_data[0], this.address, block.timestamp + 60, 160, 0, mem[420]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if 0 > principal:
                revert with 0, 'SafeMath: subtraction overflow'
            ...
            if not ext_call.return_data[0] * ext_call.return_data[0] / 10^18:
                ...
                call sub_6a0f3a10Address.redeem(address arg1, uint256 arg2, address arg3, uint256 arg4, bytes arg5) with:
                     gas gas_remaining wei
                    args address(sub_2a1b004fAddress), 10^18 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 / ext_call.return_data[0], this.address, block.timestamp + 60, 160, 0, mem[420]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if ext_call.return_data[0] * ext_call.return_data[0] / 10^18 > principal:
                revert with 0, 'SafeMath: subtraction overflow'
            principal -= ext_call.return_data[0] * ext_call.return_data[0] / 10^18
        require ext_code.size(wantAddress)
        staticcall wantAddress.0x70a08231 with:
                gas gas_remaining wei
               args this.address
