    ...
    if not ext_call.return_data[0] / ext_call.return_data[0]:
        ...
        if not ext_call.return_data[0] / ext_call.return_data[0]:
            ...
            call stor7.removeLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, address arg6, uint256 arg7) with:
                 gas gas_remaining wei
                args address(stor15), stor14, ext_call.return_data[0], 0, 0, address(this.address), block.timestamp + 15
        else:
            ...
            if not ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]:
                ...
                call stor7.removeLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, address arg6, uint256 arg7) with:
                     gas gas_remaining wei
                    args address(stor15), stor14, ext_call.return_data[0], 0, 99 * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 100, address(this.address), block.timestamp + 15
    else:
        require ext_call.return_data[0] / ext_call.return_data[0]
        if ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] / ext_call.return_data[0] != ext_call.return_data[0]:
            revert with 0, 'SafeMath: multiplication overflow'
        if not ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]:
            ...
            if not ext_call.return_data[0] / ext_call.return_data[0]:
                ...
                call stor7.removeLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, address arg6, uint256 arg7) with:
                     gas gas_remaining wei
                    args address(stor15), stor14, ext_call.return_data[0], 99 * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 100, 0, address(this.address), block.timestamp + 15
            else:
                require ext_call.return_data[0] / ext_call.return_data[0]
                if ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] / ext_call.return_data[0] != ext_call.return_data[0]:
                    revert with 0, 'SafeMath: multiplication overflow'
                if not ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]:
                    ...
                    call stor7.removeLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, address arg6, uint256 arg7) with:
                         gas gas_remaining wei
                        args address(stor15), stor14, ext_call.return_data[0], 99 * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 100, 99 * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 100, address(this.address), block.timestamp + 15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
