...
function mint(address arg1, string arg2, uint256 arg3) payable {
    ...
    if arg1:
        if arg1:
            ...
            tokenOfOwnerByIndex[address(arg1)][stor3[address(arg1)]] = arg3
            stor8[arg3] = balanceOf[address(arg1)]
    else:
        if tokenByIndex.length < 1:
            revert with 0, 17
        if tokenByIndex.length - 1 >= tokenByIndex.length:
    ...
    if stor6[arg3].field_0:
        if stor6[arg3].field_0 == uint255(stor6[arg3].field_0) * 0.5 < 32:
            revert with 0, 34
        if arg2.length:
            stor6[arg3][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor6[arg3].field_0 = 0
            idx = 0
            while (uint255(stor6[arg3].field_0) * 0.5) + 31 / 32 > idx:
                stor6[arg3][idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if stor6[arg3].field_0 == stor6[arg3].field_1 < 32:
            revert with 0, 34
        if arg2.length:
            stor6[arg3][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor6[arg3].field_0 = 0
            idx = 0
            while stor6[arg3].field_1 + 31 / 32 > idx:
                stor6[arg3][idx].field_0 = 0
                idx = idx + 1
                continue 
}
