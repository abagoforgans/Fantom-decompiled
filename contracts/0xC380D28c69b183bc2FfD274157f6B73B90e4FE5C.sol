                ...
                if not block.timestamp - poolInfo[arg1].field_512:
                    ...
                    if not block.timestamp - poolInfo[arg1].field_512:
                        ...
                        if not (block.timestamp * sub_4359d3cb) - (poolInfo[arg1].field_512 * sub_4359d3cb):
                            ...
                            require (block.timestamp * sub_4359d3cb) - (poolInfo[arg1].field_512 * sub_4359d3cb)
                            ...
                            if not (block.timestamp * sub_4359d3cb * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_4359d3cb * poolInfo[arg1].field_256) / totalAllocPoint:
                                ...
                                require (block.timestamp * sub_4359d3cb * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_4359d3cb * poolInfo[arg1].field_256) / totalAllocPoint
                                ...
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero', 0
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (10^12 * (block.timestamp * sub_4359d3cb * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_4359d3cb * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
...
function sub_0e231622(?) payable {
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.timestamp * sub_4359d3cb * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_4359d3cb * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (block.timestamp * sub_4359d3cb * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_4359d3cb * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 'SafeMath: multiplication overflow'
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.timestamp * sub_4359d3cb * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_4359d3cb * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow', 0
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.timestamp * sub_4359d3cb * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_4359d3cb * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
    ...
    while idx < poolInfo.length:
        ...
        if not (block.timestamp * sub_4359d3cb) - (poolInfo[idx].field_512 * sub_4359d3cb):
            ...
            revert with memory
              from mem[64]
               len _251 + -mem[64] + 100
        require (block.timestamp * sub_4359d3cb) - (poolInfo[idx].field_512 * sub_4359d3cb)
        ...
        if not (block.timestamp * sub_4359d3cb * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_4359d3cb * poolInfo[idx].field_256) / totalAllocPoint:
            ...
            revert with memory
              from mem[64]
               len _250 + -mem[64] + 100
        require (block.timestamp * sub_4359d3cb * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_4359d3cb * poolInfo[idx].field_256) / totalAllocPoint
        ...
        if _154 > 0:
            require _154
            if poolInfo[idx].field_768 + (10^12 * (block.timestamp * sub_4359d3cb * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_4359d3cb * poolInfo[idx].field_256) / totalAllocPoint / _154) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
...
function sub_150a5a6f(?) payable {
    ...
    while idx < poolInfo.length:
        ...
        if _158 > 0:
            require _158
            if poolInfo[idx].field_768 + (10^12 * (block.timestamp * sub_4359d3cb * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_4359d3cb * poolInfo[idx].field_256) / totalAllocPoint / _158) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
...
function set(uint256 arg1, uint256 arg2, uint16 arg3, bool arg4) payable {
    ...
    if arg4:
        ...
        while idx < poolInfo.length:
            ...
            if _192 > 0:
                require _192
                if poolInfo[idx].field_768 + (10^12 * (block.timestamp * sub_4359d3cb * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_4359d3cb * poolInfo[idx].field_256) / totalAllocPoint / _192) < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.timestamp * sub_4359d3cb * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_4359d3cb * poolInfo[idx].field_256) / totalAllocPoint / _192
                poolInfo[idx].field_512 = block.timestamp
                idx = idx + 1
                continue 
            _297 = mem[64]
...
function add(uint256 arg1, address arg2, uint16 arg3, bool arg4) payable {
    ...
    if arg4:
        ...
        while idx < poolInfo.length:
            ...
            if _221 > 0:
                require _221
                if poolInfo[idx].field_768 + (10^12 * (block.timestamp * sub_4359d3cb * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_4359d3cb * poolInfo[idx].field_256) / totalAllocPoint / _221) < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.timestamp * sub_4359d3cb * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_4359d3cb * poolInfo[idx].field_256) / totalAllocPoint / _221
                poolInfo[idx].field_512 = block.timestamp
                idx = idx + 1
                continue 
            _324 = mem[64]
