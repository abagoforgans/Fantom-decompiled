...
function sub_f4305035(?) {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 3
        stor3[mem[(32 * idx) + 140 len 20]] = uint8(bool(mem[(32 * idx) + (32 * arg1.length) + 160]))
        idx = idx + 1
        continue 
}
...
function uniswapV2Call(address arg1, uint256 arg2, uint256 arg3, bytes arg4) {
    ...
    if cd[(arg4 + 36)]:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if mem[172 len 20] != 0xd528697008ac67a21818751a5e3c58c8dae54696:
            if mem[204 len 20] != 0xd528697008ac67a21818751a5e3c58c8dae54696:
                require ext_code.size(mem[204 len 20])
...
function sub_932832fc(?) {
    ...
    if not ext_call.return_data[64]:
        ...
        if address(arg3 - 0x147ac195469d07bad02a90006c84425fc9a2a3f) != 0xd528697008ac67a21818751a5e3c58c8dae54696:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if address(arg4 - 0x147ac195469d07bad02a90006c84425fc9a2a3f) == 0xd528697008ac67a21818751a5e3c58c8dae54696:
                require ext_code.size(0x152ee697f2e276fa89e96742e9bb9ab1f2e61be3)
                staticcall 0x152ee697f2e276fa89e96742e9bb9ab1f2e61be3.getPair(address arg1, address arg2) with:
                        gas gas_remaining wei
