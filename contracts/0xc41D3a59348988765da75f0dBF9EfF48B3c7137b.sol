...
function aggregate(address arg1, bytes[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[_86] = cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]
        require arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)] + 68 <= calldata.size
        mem[_86 + 32 len cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]] = call.data[arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 68 len cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]]
        mem[cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)] + _86 + 32] = 0
        mem[_55 + 32] = _86
        mem[t] = _55
        idx = idx + 1
        s = s + 32
    ...
    if not _54:
        ...
        while arg1.length < _112:
            mem[(32 * arg1.length) + 128] = s + -_108 - 96
            _155 = mem[arg1 + (32 * arg1.length) + 36]
            _156 = mem[mem[arg1 + (32 * arg1.length) + 36]]
            mem[s] = mem[mem[arg1 + (32 * arg1.length) + 36]]
            idx = 0
            while idx < _156:
                mem[idx + s + 32] = mem[idx + _155 + 32]
                idx = idx + 32
                continue 
            if ceil32(_156) > _156:
                mem[s + _156 + 32] = 0
