...
function sub_97aedadb(?) payable {
    ...
    while idx < cd[(cd[4] + ('cd', 4)[2] + 4)]:
        ...
        mem[_731] = cd[(cd[4] + ('cd', 4)[2] + cd[s] + 36)]
    ...
    while idx < cd[(cd[4] + ('cd', 4)[3] + 4)]:
        ...
        mem[_1616] = cd[(cd[4] + ('cd', 4)[3] + cd[s] + 36)]
    ...
    while idx < cd[(cd[4] + ('cd', 4)[4] + 4)]:
        ...
        mem[_2833] = cd[(cd[4] + ('cd', 4)[4] + cd[s] + 36)]
    ...
    if mem[mem[mem[224] + 32]] - 1 >= mem[mem[mem[224] + 32]]:
        revert with 'NH{q', 50
    _2847 = mem[(32 * mem[mem[mem[224] + 32]] - 1) + mem[mem[224] + 32] + 32]
    if 0 >= mem[mem[224]]:
        revert with 'NH{q', 50
    if 0 >= mem[mem[mem[224] + 32]]:
        revert with 'NH{q', 50
    if mem[mem[mem[224] + 32] + 44 len 20] != sub_b6a21b61Address:
        ...
        call address(_2838).0x23b872dd with:
             gas gas_remaining wei
            args msg.sender, address(this.address), _2854
        ...
        if uint16(var221002) <= var221001:
            ...
            if uint16(var225003) >= mem[mem[224]]:
                revert with 'NH{q', 50
            _22541 = mem[mem[(32 * uint16(var225003)) + mem[224] + 32]]
            s = mem[224]
            t = var304001
            u = var304003
            while _22541 >= 2:
                if uint16(t) > _22541 - 2:
                    if var225008 > -u - 1:
                        revert with 'NH{q', 17
                    ...
                    if mem[(32 * mem[mem[mem[224] + 32]] - 1) + mem[mem[224] + 32] + 44 len 20] != sub_b6a21b61Address:
                        ...
                        call address(_2847).0xa9059cbb with:
                             gas gas_remaining wei
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_22873] == bool(mem[_22873])
                    else:
                        if bool(mem[288]) != 1:
                            mem[mem[64] + 4] = msg.sender
                            mem[mem[64] + 36] = var225008 + u
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_22882] == bool(mem[_22882])
                        else:
                ...
                if mem[(32 * uint16(t)) + mem[(32 * uint16(var225003)) + mem[192] + 32] + 62 len 2] > 7:
                    ...
                    mem[mem[64] + 96] = 2
                    mem[64] = mem[64] + 192
                    mem[_22574 + 128 len 64] = call.data[calldata.size len 64]
                    if uint16(var225003) >= mem[mem[224]]:
                        revert with 'NH{q', 50
                    ...
                    if 0 >= mem[_22574 + 96]:
                        revert with 'NH{q', 50
                    mem[_22574 + 128] = mem[(32 * uint16(t)) + mem[(32 * uint16(var225003)) + mem[224] + 32] + 44 len 20]
                    if uint16(var225003) >= mem[mem[224]]:
                        revert with 'NH{q', 50
                    if uint16(t) > 65534:
                        revert with 'NH{q', 17
                    ...
                    if 1 >= mem[_22574 + 96]:
                        revert with 'NH{q', 50
                    mem[_22574 + 160] = mem[(32 * uint16(uint16(t) + 1)) + mem[(32 * uint16(var225003)) + mem[224] + 32] + 44 len 20]
                    if uint16(var225003) >= mem[mem[192]]:
                        revert with 'NH{q', 50
                    if uint16(t) >= mem[mem[(32 * uint16(var225003)) + mem[192] + 32]]:
                        revert with 'NH{q', 50
                    _22753 = mem[(32 * uint16(t)) + mem[(32 * uint16(var225003)) + mem[192] + 32] + 32]
                    if mem[(32 * uint16(t)) + mem[(32 * uint16(var225003)) + mem[192] + 32] + 62 len 2] >= sub_a5218fd8.length:
                        revert with 'NH{q', 50
                    mem[0] = 14
                    if 3600 > -block.timestamp - 1:
                        revert with 'NH{q', 17
                    mem[_22574 + 192] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                    mem[_22574 + 196] = u
                    mem[_22574 + 228] = 1
                    mem[_22574 + 260] = 160
                    mem[_22574 + 356] = mem[_22574 + 96]
                    idx = 0
                    u = _22574 + 128
                    v = _22574 + 388
                    while idx < mem[_22574 + 96]:
                        mem[v] = mem[u + 12 len 20]
                        _22541 = mem[mem[(32 * uint16(var225003)) + s + 32]]
                        idx = idx + 1
                        u = u + 32
                        v = v + 32
                        continue 
                    mem[_22574 + 292] = this.address
                    mem[_22574 + 324] = block.timestamp + 3600
                    require ext_code.size(sub_a5218fd8[uint16(_22753)])
                    call sub_a5218fd8[uint16(_22753)].mem[mem[64] len 4] with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len _22574 + (32 * mem[_22574 + 96]) + -mem[64] + 384]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _24493 = mem[64]
                    ...
                    require return_data.size >= 32
                    _24507 = mem[_24493]
                    require mem[_24493] <= test266151307()
                    require _24493 + mem[_24493] + 31 < _24493 + return_data.size
                    _24520 = mem[_24493 + mem[_24493]]
                    if mem[_24493 + mem[_24493]] > test266151307():
                        revert with 'NH{q', 65
                    if _24493 + ceil32(return_data.size) + floor32(mem[_24493 + mem[_24493]]) + 1 > test266151307() or floor32(mem[_24493 + mem[_24493]]) + 1 < 0:
                        revert with 'NH{q', 65
                    mem[64] = _24493 + ceil32(return_data.size) + floor32(mem[_24493 + mem[_24493]]) + 1
                    mem[_24493 + ceil32(return_data.size)] = _24520
                    require _24507 + (32 * _24520) + 32 <= return_data.size
                    idx = 0
                    u = _24493 + _24507 + 32
                    v = _24493 + ceil32(return_data.size) + 32
                    while idx < _24520:
                        require mem[u] == mem[u]
                        mem[v] = mem[u]
                        _22541 = mem[mem[(32 * uint16(var225003)) + s + 32]]
                    ...
                    s = mem[224]
                    t = uint16(t) + 1
                    u = mem[_24493 + ceil32(return_data.size) + 64]
                    continue 
            revert with 'NH{q', 17
        if var221007 < mem[96]:
            revert with 0, 'AmountOut is lower than expedted because of slippage rate'
        ...
        if mem[(32 * mem[mem[mem[224] + 32]] - 1) + mem[mem[224] + 32] + 44 len 20] != sub_b6a21b61Address:
            ...
            mem[64] = mem[64] + ceil32(return_data.size)
            require return_data.size >= 32
            require mem[_15868] == bool(mem[_15868])
        else:
            if bool(('cd', 4)[5]) != 1:
                mem[mem[64] + 4] = msg.sender
                mem[mem[64] + 36] = var221007
                ...
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 32
                require mem[_15874] == bool(mem[_15874])
            else:
    ...
    if msg.value == mem[128]:
        ...
        if uint16(var204002) <= var204001:
            ...
            if uint16(var208003) >= mem[mem[224]]:
                revert with 'NH{q', 50
            _22545 = mem[mem[(32 * uint16(var208003)) + mem[224] + 32]]
            s = mem[224]
            t = var287001
            u = var287003
            while _22545 >= 2:
                if uint16(t) > _22545 - 2:
                    if var208008 > -u - 1:
                        revert with 'NH{q', 17
                    ...
                    if mem[(32 * mem[mem[mem[224] + 32]] - 1) + mem[mem[224] + 32] + 44 len 20] != sub_b6a21b61Address:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_22879] == bool(mem[_22879])
                    else:
                        if bool(mem[288]) != 1:
                            mem[mem[64] + 4] = msg.sender
                            mem[mem[64] + 36] = var208008 + u
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_22890] == bool(mem[_22890])
                        else:
                ...
                if mem[(32 * uint16(t)) + mem[(32 * uint16(var208003)) + mem[192] + 32] + 62 len 2] > 7:
                    ...
                    mem[mem[64] + 96] = 2
                    mem[64] = mem[64] + 192
                    mem[_22578 + 128 len 64] = call.data[calldata.size len 64]
                    if uint16(var208003) >= mem[mem[224]]:
                        revert with 'NH{q', 50
                    ...
                    if 0 >= mem[_22578 + 96]:
                        revert with 'NH{q', 50
                    mem[_22578 + 128] = mem[(32 * uint16(t)) + mem[(32 * uint16(var208003)) + mem[224] + 32] + 44 len 20]
                    if uint16(var208003) >= mem[mem[224]]:
                        revert with 'NH{q', 50
                    if uint16(t) > 65534:
                        revert with 'NH{q', 17
                    ...
                    if 1 >= mem[_22578 + 96]:
                        revert with 'NH{q', 50
                    mem[_22578 + 160] = mem[(32 * uint16(uint16(t) + 1)) + mem[(32 * uint16(var208003)) + mem[224] + 32] + 44 len 20]
                    if uint16(var208003) >= mem[mem[192]]:
                        revert with 'NH{q', 50
                    if uint16(t) >= mem[mem[(32 * uint16(var208003)) + mem[192] + 32]]:
                        revert with 'NH{q', 50
                    _22755 = mem[(32 * uint16(t)) + mem[(32 * uint16(var208003)) + mem[192] + 32] + 32]
                    if mem[(32 * uint16(t)) + mem[(32 * uint16(var208003)) + mem[192] + 32] + 62 len 2] >= sub_a5218fd8.length:
                        revert with 'NH{q', 50
                    mem[0] = 14
                    if 3600 > -block.timestamp - 1:
                        revert with 'NH{q', 17
                    mem[_22578 + 192] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                    mem[_22578 + 196] = u
                    mem[_22578 + 228] = 1
                    mem[_22578 + 260] = 160
                    mem[_22578 + 356] = mem[_22578 + 96]
                    idx = 0
                    u = _22578 + 128
                    v = _22578 + 388
                    while idx < mem[_22578 + 96]:
                        mem[v] = mem[u + 12 len 20]
                        _22545 = mem[mem[(32 * uint16(var208003)) + s + 32]]
                        idx = idx + 1
                        u = u + 32
                        v = v + 32
                        continue 
                    mem[_22578 + 292] = this.address
                    mem[_22578 + 324] = block.timestamp + 3600
                    require ext_code.size(sub_a5218fd8[uint16(_22755)])
                    call sub_a5218fd8[uint16(_22755)].mem[mem[64] len 4] with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len _22578 + (32 * mem[_22578 + 96]) + -mem[64] + 384]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _24495 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    require return_data.size >= 32
                    _24513 = mem[_24495]
                    require mem[_24495] <= test266151307()
                    require _24495 + mem[_24495] + 31 < _24495 + return_data.size
                    _24522 = mem[_24495 + mem[_24495]]
                    if mem[_24495 + mem[_24495]] > test266151307():
                        revert with 'NH{q', 65
                    if _24495 + ceil32(return_data.size) + floor32(mem[_24495 + mem[_24495]]) + 1 > test266151307() or floor32(mem[_24495 + mem[_24495]]) + 1 < 0:
                        revert with 'NH{q', 65
                    mem[64] = _24495 + ceil32(return_data.size) + floor32(mem[_24495 + mem[_24495]]) + 1
                    mem[_24495 + ceil32(return_data.size)] = _24522
                    require _24513 + (32 * _24522) + 32 <= return_data.size
                    idx = 0
                    u = _24495 + _24513 + 32
                    v = _24495 + ceil32(return_data.size) + 32
                    while idx < _24522:
                        require mem[u] == mem[u]
                        mem[v] = mem[u]
                        _22545 = mem[mem[(32 * uint16(var208003)) + s + 32]]
                    ...
                    s = mem[224]
                    t = uint16(t) + 1
                    u = mem[_24495 + ceil32(return_data.size) + 64]
                    continue 
            revert with 'NH{q', 17
        if var204007 < mem[96]:
            revert with 0, 'AmountOut is lower than expedted because of slippage rate'
        ...
        if mem[(32 * mem[mem[mem[224] + 32]] - 1) + mem[mem[224] + 32] + 44 len 20] != sub_b6a21b61Address:
            ...
            mem[64] = mem[64] + ceil32(return_data.size)
            require return_data.size >= 32
            require mem[_15872] == bool(mem[_15872])
        else:
            if bool(('cd', 4)[5]) != 1:
                mem[mem[64] + 4] = msg.sender
                mem[mem[64] + 36] = var204007
                ...
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 32
                require mem[_15880] == bool(mem[_15880])
            else:
    ...
    call address(_2838).0x23b872dd with:
         gas gas_remaining wei
        args msg.sender, address(this.address), _2856
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _2867 = mem[64]
    ...
    if uint16(var222002) <= var222001:
        ...
        if uint16(var226003) >= mem[mem[224]]:
            revert with 'NH{q', 50
        _22543 = mem[mem[(32 * uint16(var226003)) + mem[224] + 32]]
        s = mem[224]
        t = var305001
        u = var305003
        while _22543 >= 2:
            if uint16(t) > _22543 - 2:
                if var226008 > -u - 1:
                    revert with 'NH{q', 17
                ...
                if mem[(32 * mem[mem[mem[224] + 32]] - 1) + mem[mem[224] + 32] + 44 len 20] != sub_b6a21b61Address:
                    ...
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    require mem[_22876] == bool(mem[_22876])
                else:
                    if bool(mem[288]) != 1:
                        mem[mem[64] + 4] = msg.sender
                        mem[mem[64] + 36] = var226008 + u
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_22886] == bool(mem[_22886])
                    else:
            ...
            if mem[(32 * uint16(t)) + mem[(32 * uint16(var226003)) + mem[192] + 32] + 62 len 2] > 7:
                ...
                mem[mem[64] + 96] = 2
                mem[64] = mem[64] + 192
                mem[_22576 + 128 len 64] = call.data[calldata.size len 64]
                if uint16(var226003) >= mem[mem[224]]:
                    revert with 'NH{q', 50
                ...
                if 0 >= mem[_22576 + 96]:
                    revert with 'NH{q', 50
                mem[_22576 + 128] = mem[(32 * uint16(t)) + mem[(32 * uint16(var226003)) + mem[224] + 32] + 44 len 20]
                if uint16(var226003) >= mem[mem[224]]:
                    revert with 'NH{q', 50
                if uint16(t) > 65534:
                    revert with 'NH{q', 17
                ...
                if 1 >= mem[_22576 + 96]:
                    revert with 'NH{q', 50
                mem[_22576 + 160] = mem[(32 * uint16(uint16(t) + 1)) + mem[(32 * uint16(var226003)) + mem[224] + 32] + 44 len 20]
                if uint16(var226003) >= mem[mem[192]]:
                    revert with 'NH{q', 50
                if uint16(t) >= mem[mem[(32 * uint16(var226003)) + mem[192] + 32]]:
                    revert with 'NH{q', 50
                _22754 = mem[(32 * uint16(t)) + mem[(32 * uint16(var226003)) + mem[192] + 32] + 32]
                if mem[(32 * uint16(t)) + mem[(32 * uint16(var226003)) + mem[192] + 32] + 62 len 2] >= sub_a5218fd8.length:
                    revert with 'NH{q', 50
                mem[0] = 14
                if 3600 > -block.timestamp - 1:
                    revert with 'NH{q', 17
                mem[_22576 + 192] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                mem[_22576 + 196] = u
                mem[_22576 + 228] = 1
                mem[_22576 + 260] = 160
                mem[_22576 + 356] = mem[_22576 + 96]
                idx = 0
                u = _22576 + 128
                v = _22576 + 388
                while idx < mem[_22576 + 96]:
                    mem[v] = mem[u + 12 len 20]
                    _22543 = mem[mem[(32 * uint16(var226003)) + s + 32]]
                    idx = idx + 1
                    u = u + 32
                    v = v + 32
                    continue 
                mem[_22576 + 292] = this.address
                mem[_22576 + 324] = block.timestamp + 3600
                require ext_code.size(sub_a5218fd8[uint16(_22754)])
                call sub_a5218fd8[uint16(_22754)].mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _22576 + (32 * mem[_22576 + 96]) + -mem[64] + 384]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _24494 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                require return_data.size >= 32
                _24510 = mem[_24494]
                require mem[_24494] <= test266151307()
                require _24494 + mem[_24494] + 31 < _24494 + return_data.size
                _24521 = mem[_24494 + mem[_24494]]
                if mem[_24494 + mem[_24494]] > test266151307():
                    revert with 'NH{q', 65
                if _24494 + ceil32(return_data.size) + floor32(mem[_24494 + mem[_24494]]) + 1 > test266151307() or floor32(mem[_24494 + mem[_24494]]) + 1 < 0:
                    revert with 'NH{q', 65
                mem[64] = _24494 + ceil32(return_data.size) + floor32(mem[_24494 + mem[_24494]]) + 1
                mem[_24494 + ceil32(return_data.size)] = _24521
                require _24510 + (32 * _24521) + 32 <= return_data.size
                idx = 0
                u = _24494 + _24510 + 32
                v = _24494 + ceil32(return_data.size) + 32
                while idx < _24521:
                    require mem[u] == mem[u]
                    mem[v] = mem[u]
                    _22543 = mem[mem[(32 * uint16(var226003)) + s + 32]]
                ...
                s = mem[224]
                t = uint16(t) + 1
                u = mem[_24494 + ceil32(return_data.size) + 64]
                continue 
        revert with 'NH{q', 17
    if var222007 < mem[96]:
        revert with 0, 'AmountOut is lower than expedted because of slippage rate'
    ...
    if mem[(32 * mem[mem[mem[224] + 32]] - 1) + mem[mem[224] + 32] + 44 len 20] != sub_b6a21b61Address:
        ...
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        require mem[_15870] == bool(mem[_15870])
    else:
        if bool(('cd', 4)[5]) != 1:
            mem[mem[64] + 4] = msg.sender
            mem[mem[64] + 36] = var222007
            ...
            mem[64] = mem[64] + ceil32(return_data.size)
            require return_data.size >= 32
            require mem[_15877] == bool(mem[_15877])
        else:
