            ...
            if poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    if not (block.number * arcPerBlock) - (poolInfo[arg1].field_512 * arcPerBlock):
                        ...
                        require (block.number * arcPerBlock) - (poolInfo[arg1].field_512 * arcPerBlock)
                        ...
                        call arcAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args devAddress, (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(arcAddress)
                        call arcAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args address(this.address), (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if not (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                            ...
                            require (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if 10^18 * (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^18:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                            if ext_call.return_data[0] <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_call.return_data[0]
                            if poolInfo[arg1].field_768 + (10^18 * (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                revert with 0, 'SafeMath: addition overflow'
                            poolInfo[arg1].field_768 += 10^18 * (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
...
function pendingArc(uint256 arg1, address arg2) payable {
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^18 * (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^18:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * arcPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * arcPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^18) - userInfo[arg1][address(arg2)].field_256)
}
    ...
    while idx < poolInfo.length:
        ...
        if not (block.number * arcPerBlock) - (poolInfo[idx].field_512 * arcPerBlock):
            ...
            revert with memory
              from mem[64]
               len _206 + -mem[64] + 100
        require (block.number * arcPerBlock) - (poolInfo[idx].field_512 * arcPerBlock)
        ...
        call arcAddress.0x40c10f19 with:
             gas gas_remaining wei
            args devAddress, (block.number * arcPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * arcPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * arcPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * arcPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(arcAddress)
        call arcAddress.0x40c10f19 with:
             gas gas_remaining wei
            args address(this.address), (block.number * arcPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * arcPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * arcPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * arcPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            ...
            revert with memory
              from mem[64]
               len _203 + -mem[64] + 100
        require (block.number * arcPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * arcPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if 10^18 * (block.number * arcPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * arcPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * arcPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * arcPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^18:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _202 = mem[64]
        mem[64] = mem[64] + 64
        mem[_202] = 26
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^18 * (block.number * arcPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * arcPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^18 * (block.number * arcPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * arcPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _218 = mem[64]
    ...
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][address(msg.sender)].field_0:
            ...
            if -userInfo[arg1][address(msg.sender)].field_256 > 0:
                ...
                require return_data.size >= 32
                if not ext_call.return_data[0]:
                    revert with 0, 'safeArcTransfer: Transfer failed'
        else:
