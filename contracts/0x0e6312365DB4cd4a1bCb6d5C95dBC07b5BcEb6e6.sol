...
function sub_778743ee(?) payable {
    ...
    require ext_code.size(sub_7419f946Address)
    call sub_7419f946Address.0x23b872dd with:
         gas gas_remaining wei
    ...
    if var108002 > -stor7[var108001].field_256 - 1:
        revert with 'NH{q', 17
    if var108002 > sha3(block.difficulty, block.timestamp, msg.sender, stor6) % sub_0f8fc9df:
        if var108001 == -1:
            revert with 'NH{q', 17
        var108001 = var108001 + 1
        var108002 = var108002 + stor7[var108001].field_256
        continue 
    if sha3(block.difficulty, block.timestamp, msg.sender, stor6) % sub_0f8fc9df >= var108002 + stor7[var108001].field_256:
        if var108002 > -stor7[var108001].field_256 - 1:
            revert with 'NH{q', 17
        if var108001 == -1:
            revert with 'NH{q', 17
    ...
    call sub_e64ce988Address.0x731133e9 with:
         gas gas_remaining wei
...
function sub_e9a0986b(?) payable {
    ...
    while idx < 8:
        ...
        if var135002 > _31 % sub_0f8fc9df:
            ...
            continue 
        if _31 % sub_0f8fc9df >= var135002 + stor7[var135001].field_256:
            if var135002 > -stor7[var135001].field_256 - 1:
                revert with 'NH{q', 17
            if var135001 == -1:
                revert with 'NH{q', 17
