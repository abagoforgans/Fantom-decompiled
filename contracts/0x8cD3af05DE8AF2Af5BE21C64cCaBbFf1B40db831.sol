...
function liquidDepositor() {
    return address(liquidDepositorAddress)
}
...
function sub_c28e9cc1(?) {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    address(liquidDepositorAddress) = 0
}
...
function sub_4c1c604d(?) {
    ...
    address(liquidDepositorAddress) = address(arg1)
}
...
function add(uint256 arg1, address arg2, address arg3, uint256 arg4) {
...
function sub_85b16510(?) {
    ...
    require arg1 < rewarder.length
    if not arg5:
        emit LogSetPool(arg2, bool(arg5), arg1, rewarder[arg1]);
    else:
        rewarder[arg1] = address(arg3)
        if arg5:
            emit LogSetPool(arg2, bool(arg5), arg1, address(arg3));
        else:
            require arg1 < rewarder.length
            emit LogSetPool(arg2, bool(arg5), arg1, rewarder[arg1]);
}
...
function sub_73a9d25a(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if address(arg1):
        require ext_code.size(address(liquidDepositorAddress))
        staticcall address(liquidDepositorAddress).balanceOf(address arg1) with:
                gas gas_remaining wei
               args address(arg1)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0]:
            if not address(liquidDepositorAddress):
                revert with 0, 'Invalid depositor'
            if not address(arg1):
                revert with 0, 'Invalid token'
            if ext_call.return_data[0]:
                require ext_code.size(address(liquidDepositorAddress))
                call address(liquidDepositorAddress).withdraw(uint256 arg1, address arg2) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0], address(arg1)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                emit 0xd750eff1: ext_call.return_data[0], address(arg1)
}

function migrate(uint256 arg1) {
    require calldata.size - 4 >= 32
    if not migratorAddress:
        revert with 0, 'MasterChefV2: no migrator set'
    require arg1 < lpToken.length
    ...
    require return_data.size >= 32
    require ext_code.size(lpToken[arg1])
    call lpToken[arg1].approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args migratorAddress, ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(migratorAddress)
    call migratorAddress.migrate(address arg1) with:
         gas gas_remaining wei
        args lpToken[arg1]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] != ext_call.return_data[0]:
        revert with 0, 'MasterChefV2: migrated balance must match'
    require arg1 < lpToken.length
    lpToken[arg1] = address(ext_call.return_data[0])
}

function sub_0b371f02(?) payable {
    mem[64] = 96
    require not msg.value
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    idx = 0
    while idx < lpToken.length:
        mem[0] = 7
        if owner != msg.sender:
            revert with 0, 'Ownable: caller is not the owner'
        if lpToken[idx]:
            mem[mem[64] + 4] = lpToken[idx]
            require ext_code.size(address(liquidDepositorAddress))
            staticcall address(liquidDepositorAddress).balanceOf(address arg1) with:
                    gas gas_remaining wei
                   args lpToken[idx]
            ...
            if mem[_25]:
                ...
                if mem[_25]:
                    ...
                    mem[mem[64] + 36] = lpToken[idx]
                    require ext_code.size(address(liquidDepositorAddress))
                    call address(liquidDepositorAddress).withdraw(uint256 arg1, address arg2) with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4], lpToken[idx]
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _33 = mem[64]
                    ...
                    require return_data.size >= 32
                    mem[mem[64]] = mem[_33]
                    mem[mem[64] + 32] = lpToken[idx]
                    emit 0xd750eff1: mem[mem[64]], lpToken[idx]
        idx = idx + 1
        continue 
}
...
function init(address arg1) {
    ...
    mem[ceil32(return_data.size) + 228 len 128] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), ext_call.return_data[0], mem[ceil32(return_data.size) + 228 len 28]
...
function sub_96eb72c1(?) {
    ...
    if address(arg1):
        ...
        if ext_call.return_data[0]:
            ...
            mem[(2 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 0, stor14)
            mem[(2 * ceil32(return_data.size)) + 128 len 4] = transfer(address arg1, uint256 arg2)
            mem[(2 * ceil32(return_data.size)) + 196 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor14), uint32(stor14), ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 196 len 28]
            ...
            if not return_data.size:
                ...
                if return_data.size:
                    ...
                    if not mem[(2 * ceil32(return_data.size)) + 228]:
                        revert with 0, 'BoringERC20: Transfer failed'
            emit 0x29b3cabf: ext_call.return_data[0], address(arg1)
}

function sub_f1cb6179(?) {
    require calldata.size - 4 >= 64
    ...
    if arg1 <= ext_call.return_data[0]:
        mem[ceil32(return_data.size) + 196 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor14), uint32(stor14), arg1, mem[ceil32(return_data.size) + 196 len 28]
        call address(arg2).mem[ceil32(return_data.size) + 196 len 4] with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if return_data.size:
                ...
                if not mem[ceil32(return_data.size) + 228]:
                    revert with 0, 'BoringERC20: Transfer failed'
        emit 0x29b3cabf: arg1, address(arg2)
    else:
        mem[ceil32(return_data.size) + 196 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor14), uint32(stor14), ext_call.return_data[0], mem[ceil32(return_data.size) + 196 len 28]
        call address(arg2).mem[ceil32(return_data.size) + 196 len 4] with:
             gas gas_remaining wei
            args mem[ceil32(return_data.size) + 200 len 64]
        if not return_data.size:
            ...
            if return_data.size:
                ...
                if not mem[ceil32(return_data.size) + 228]:
                    revert with 0, 'BoringERC20: Transfer failed'
        emit 0x29b3cabf: ext_call.return_data[0], address(arg2)
}

function sub_afece0a9(?) payable {
    mem[64] = 96
    require not msg.value
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    ...
    while idx < lpToken.length:
        ...
        if lpToken[idx]:
            ...
            if mem[_141]:
                ...
                if _142 <= mem[_153]:
                    _155 = mem[64]
                    mem[mem[64] + 36] = address(liquidDepositorAddress)
                    mem[mem[64] + 68] = _142
                    _157 = mem[64]
                    mem[mem[64]] = 68
                    mem[64] = mem[64] + 100
                    mem[_157 + 32] = mem[_157 + 36 len 28] or 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                    _160 = mem[_157]
                    s = 0
                    while s < _160:
                        mem[s + _155 + 100] = mem[s + _157 + 32]
                        s = s + 32
                        continue 
                    if ceil32(_160) <= _160:
                        call lpToken[idx].mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _160 + _155 + -mem[64] + 96]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'BoringERC20: Transfer failed'
                            if mem[96]:
                            ...
                            if return_data.size:
                                require return_data.size >= 32
                                require mem[_269 + 32] == bool(mem[_269 + 32])
                                if not mem[_269 + 32]:
                                    revert with 0, 'BoringERC20: Transfer failed'
                    else:
                        mem[_160 + _155 + 100] = 0
                        ...
                        if not return_data.size:
                            ...
                            if return_data.size:
                                require return_data.size >= 32
                                require mem[_270 + 32] == bool(mem[_270 + 32])
                                if not mem[_270 + 32]:
                                    revert with 0, 'BoringERC20: Transfer failed'
                    mem[mem[64]] = _142
                    mem[mem[64] + 32] = lpToken[idx]
                    emit 0x29b3cabf: _142, lpToken[idx]
                else:
                    _156 = mem[64]
                    mem[mem[64] + 36] = address(liquidDepositorAddress)
                    mem[mem[64] + 68] = _154
                    ...
                    mem[mem[64]] = 68
                    mem[64] = mem[64] + 100
                    mem[_161 + 32] = mem[_161 + 36 len 28] or 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                    _164 = mem[_161]
                    s = 0
                    while s < _164:
                        mem[s + _156 + 100] = mem[s + _161 + 32]
                        s = s + 32
                        continue 
                    if ceil32(_164) <= _164:
                        call lpToken[idx].mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _164 + _156 + -mem[64] + 96]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'BoringERC20: Transfer failed'
                            if mem[96]:
                            ...
                            if return_data.size:
                                require return_data.size >= 32
                                require mem[_271 + 32] == bool(mem[_271 + 32])
                                if not mem[_271 + 32]:
                                    revert with 0, 'BoringERC20: Transfer failed'
                    else:
                        mem[_164 + _156 + 100] = 0
                        ...
                        if not return_data.size:
                            ...
                            if return_data.size:
                                require return_data.size >= 32
                                require mem[_272 + 32] == bool(mem[_272 + 32])
                                if not mem[_272 + 32]:
                                    revert with 0, 'BoringERC20: Transfer failed'
                    mem[mem[64]] = _154
                    mem[mem[64] + 32] = lpToken[idx]
                    emit 0x29b3cabf: _154, lpToken[idx]
        idx = idx + 1
        continue 
}
...
function massUpdatePools(uint256[] arg1) payable {
    ...
    while idx < arg1.length:
        ...
        _204 = mem[64]
        mem[64] = mem[64] + 128
        mem[_204] = poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0
        mem[_204 + 32] = poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256
        mem[_204 + 64] = poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512
        mem[_204 + 96] = poolInfo[cd[((32 * idx) + arg1 + 36)]].field_768
        if block.number > poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256:
            ...
            staticcall lpToken[cd[((32 * idx) + arg1 + 36)]].balanceOf(address arg1) with:
                    gas gas_remaining wei
                   args address(this.address)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
            ...
            if not mem[_209]:
                ...
                emit LogUpdatePool(block.number, _210, poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0, cd[((32 * idx) + arg1 + 36)]);
            else:
                ...
                mem[_231] = mem[_230]
                mem[_231 + 32] = mem[_230 + 32]
                mem[_231 + 64] = mem[_230 + 64]
                mem[_231 + 96] = mem[_230 + 96]
                if not sub_4b509a80:
                    require _227
                    if not block.number - poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256:
                        ...
                        if not 0 / totalAllocPoint:
                            require _210
                            if (0 / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 < poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0:
                                revert with 0, 'SafeMath: addition overflow'
                            mem[_204] = (0 / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0
                            mem[_204 + 32] = block.number
                            require cd[((32 * idx) + arg1 + 36)] < poolInfo.length
                            mem[0] = 6
                            poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 += 0 / _210
                            poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 = block.number
                            mem[mem[64]] = block.number
                            mem[mem[64] + 32] = _210
                            mem[mem[64] + 64] = (0 / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0
                            emit LogUpdatePool(block.number, _210, (0 / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0, cd[((32 * idx) + arg1 + 36)]);
                        else:
                            if sub_9c6b4424 * 0 / totalAllocPoint / 0 / totalAllocPoint != sub_9c6b4424:
                                revert with 0, 'SafeMath: multiplication overflow'
                            require _210
                            if (sub_9c6b4424 * 0 / totalAllocPoint / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 < poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0:
                                revert with 0, 'SafeMath: addition overflow'
                            mem[_204] = (sub_9c6b4424 * 0 / totalAllocPoint / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0
                            mem[_204 + 32] = block.number
                            require cd[((32 * idx) + arg1 + 36)] < poolInfo.length
                            mem[0] = 6
                            poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 += sub_9c6b4424 * 0 / totalAllocPoint / _210
                            poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 = block.number
                            mem[mem[64]] = block.number
                            mem[mem[64] + 32] = _210
                            mem[mem[64] + 64] = (sub_9c6b4424 * 0 / totalAllocPoint / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0
                            emit LogUpdatePool(block.number, _210, (sub_9c6b4424 * 0 / totalAllocPoint / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0, cd[((32 * idx) + arg1 + 36)]);
                    else:
                        if (block.number * 0 / _227) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227) / block.number - poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 != 0 / _227:
                            revert with 0, 'SafeMath: multiplication overflow'
                        if not (block.number * 0 / _227) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227):
                            require totalAllocPoint
                            if not 0 / totalAllocPoint:
                                require _210
                                if (0 / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 < poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0:
                            ...
                            if (block.number * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / (block.number * 0 / _227) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227) != poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512:
                                revert with 0, 'SafeMath: multiplication overflow'
                            require totalAllocPoint
                            if not (block.number * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint:
                                require _210
                                if (0 / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 < poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0:
                                    revert with 0, 'SafeMath: addition overflow'
                                mem[_204] = (0 / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0
                                ...
                                if sub_9c6b4424 * (block.number * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint / (block.number * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint != sub_9c6b4424:
                                    revert with 0, 'SafeMath: multiplication overflow'
                                require _210
                                if (sub_9c6b4424 * (block.number * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 < poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0:
                                    revert with 0, 'SafeMath: addition overflow'
                                mem[_204] = (sub_9c6b4424 * (block.number * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0
                                mem[_204 + 32] = block.number
                                require cd[((32 * idx) + arg1 + 36)] < poolInfo.length
                                mem[0] = 6
                                poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 += sub_9c6b4424 * (block.number * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint / _210
                                poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 = block.number
                                mem[mem[64]] = block.number
                                mem[mem[64] + 32] = _210
                                mem[mem[64] + 64] = (sub_9c6b4424 * (block.number * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0
                                emit LogUpdatePool(block.number, _210, (sub_9c6b4424 * (block.number * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * 0 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0, cd[((32 * idx) + arg1 + 36)]);
                else:
                    if mem[_231 + 32] * sub_4b509a80 / sub_4b509a80 != mem[_231 + 32]:
                        revert with 0, 'SafeMath: multiplication overflow'
                    require _227
                    if not block.number - poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256:
                        require totalAllocPoint
                        ...
                        if (block.number * mem[_231 + 32] * sub_4b509a80 / _227) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * mem[_231 + 32] * sub_4b509a80 / _227) / block.number - poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 != mem[_231 + 32] * sub_4b509a80 / _227:
                            revert with 0, 'SafeMath: multiplication overflow'
                        if not (block.number * mem[_231 + 32] * sub_4b509a80 / _227) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * mem[_231 + 32] * sub_4b509a80 / _227):
                            require totalAllocPoint
                            if not 0 / totalAllocPoint:
                                require _210
                                if (0 / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 < poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0:
                            ...
                            if (block.number * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / (block.number * mem[_231 + 32] * sub_4b509a80 / _227) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * mem[_231 + 32] * sub_4b509a80 / _227) != poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512:
                                revert with 0, 'SafeMath: multiplication overflow'
                            require totalAllocPoint
                            if not (block.number * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint:
                                require _210
                                if (0 / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 < poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0:
                                    revert with 0, 'SafeMath: addition overflow'
                                mem[_204] = (0 / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0
                                ...
                                if sub_9c6b4424 * (block.number * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint / (block.number * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint != sub_9c6b4424:
                                    revert with 0, 'SafeMath: multiplication overflow'
                                require _210
                                if (sub_9c6b4424 * (block.number * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 < poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0:
                                    revert with 0, 'SafeMath: addition overflow'
                                mem[_204] = (sub_9c6b4424 * (block.number * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) - (poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 * mem[_231 + 32] * sub_4b509a80 / _227 * poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512) / totalAllocPoint / _210) + poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0
                                mem[_204 + 32] = block.number
                                require cd[((32 * idx) + arg1 + 36)] < poolInfo.length
                                mem[0] = 6
                                poolInfo[cd[((32 * idx) + arg1 + 36)]].field_0 = mem[_204]
                                poolInfo[cd[((32 * idx) + arg1 + 36)]].field_256 = block.number
                                _397 = mem[_204]
                                mem[mem[64]] = block.number
                                mem[mem[64] + 32] = _210
                                mem[mem[64] + 64] = _397
                                emit LogUpdatePool(block.number, _210, _397, cd[((32 * idx) + arg1 + 36)]);
        idx = idx + 1
        continue 
}
