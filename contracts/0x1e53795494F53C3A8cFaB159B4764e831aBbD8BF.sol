...
function sub_f24666cc(?) {
    ...
    call sub_dbd33e45Address.0x23b872dd with:
         gas gas_remaining wei
        args msg.sender, address(this.address), arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8fe6f47c(?) {
    ...
    call sub_85b374c3Address.0x23b872dd with:
         gas gas_remaining wei
        args msg.sender, address(this.address), arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_fb652d4c(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(sub_1458100bAddress)
    call sub_1458100bAddress.0x70a08231 with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function unstakeAll() {
    ...
    require ext_code.size(sub_f088996fAddress)
    call sub_f088996fAddress.0x441a3e70 with:
         gas gas_remaining wei
    ...
    call sub_63f96cf4Address.0x70a08231 with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdrawAll(address arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(sub_85b374c3Address)
    staticcall sub_85b374c3Address.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] > 0:
        ...
        require ext_call.return_data[0] == ext_call.return_data[0]
        require ext_code.size(sub_85b374c3Address)
        call sub_85b374c3Address.0xa9059cbb with:
             gas gas_remaining wei
        ...
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(sub_dbd33e45Address)
    call sub_dbd33e45Address.0x70a08231 with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] > 0:
        ...
        require ext_call.return_data[0] == ext_call.return_data[0]
        require ext_code.size(sub_dbd33e45Address)
        call sub_dbd33e45Address.0xa9059cbb with:
             gas gas_remaining wei
            args address(arg1), ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_5821ed0d(?) {
    ...
    if ext_call.return_data[0]:
        ...
        if ext_call.return_data[0] and ext_call.return_data[0] > -1 / ext_call.return_data[0]:
            revert with 'NH{q', 17
        if ext_call.return_data[0] * ext_call.return_data[0] / 10^18 > -eth.balance(msg.sender) - 1:
            revert with 'NH{q', 17
        if not ext_call.return_data[0]:
            revert with 'NH{q', 18
        require ext_code.size(sub_dbd33e45Address)
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] and ext_call.return_data[0] > -1 / (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0]:
            revert with 'NH{q', 17
        if 10000 < ext_call.return_data[0]:
            revert with 'NH{q', 17
        if -ext_call.return_data[0] + 10000 and (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0] > -1 / -ext_call.return_data[0] + 10000:
            revert with 'NH{q', 17
        if (10000 * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) - (ext_call.return_data[0] * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) / 10000 and 8000 > -1 / (10000 * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) - (ext_call.return_data[0] * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) / 10000:
            revert with 'NH{q', 17
        if 8000 * (10000 * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) - (ext_call.return_data[0] * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) / 10000 / 10000 <= 7 * 10^17:
            revert with 0, 'fmt amount too low'
        if 8000 * (10000 * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) - (ext_call.return_data[0] * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) / 10000 / 10000 >= 8 * 10^17:
            revert with 0, 'fmt amount too high'
        ...
        if block.timestamp > -61:
            revert with 'NH{q', 17
        if (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] <= 0:
            revert with 0, 'sell tomb amount must be greater than zero'
        if 8000 * (10000 * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) - (ext_call.return_data[0] * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) / 10000 / 10000 <= 0:
        ...
        mem[(6 * ceil32(return_data.size)) + 196] = (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0]
        idx = 0
        ...
        call sub_f6c6e5e8Address.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0], 8000 * (10000 * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) - (ext_call.return_data[0] * (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + eth.balance(msg.sender) / 2 / ext_call.return_data[0] * ext_call.return_data[0]) / 10000 / 10000, Array(len=2, data=mem[(6 * ceil32(return_data.size)) + 388 len 64]), address(this.address), block.timestamp + 60
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        revert with 0, 'we made it past the sale'
    require ext_code.size(sub_85b374c3Address)
    staticcall sub_85b374c3Address.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(sub_f088996fAddress)
    call sub_f088996fAddress.0xe2bbb158 with:
         gas gas_remaining wei
        args 0
    if not ext_call.success:
