...
function updateInfo() payable {
    ...
    if not sub_d373b52e.length:
        if sub_44951130.length:
            ...
            mem[var61005 len 160] = ext_call.return_data[0 len 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            sub_d373b52e.length++
            mem[0] = 3
            address(sub_d373b52e[sub_d373b52e.length]) = address(_4332)
            mem[96] = 0x70a0823100000000000000000000000000000000000000000000000000000000
            mem[100] = chefAddress
            if var65004:
                require ext_code.size(address(var69001))
                ...
                require ext_code.size(address(var75005))
                ...
                require ext_code.size(address(routerAddress))
                staticcall address(routerAddress).mem[var83003 len 4] with:
                        gas gas_remaining wei
                ...
                staticcall 0x30748322b6e34545dbe0788c421886aeb5297789.mem[var75003 len 4] with:
                        gas gas_remaining wei
                ...
                require return_data.size >= 32
                _11493 = mem[var79002]
                mem[0] = address(var79004)
                mem[32] = 6
                sub_1fbedece[address(var79004)] = _11493 * var79003
                mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
                require ext_code.size(chefAddress)
                staticcall chefAddress.mem[var83003 len 4] with:
                        gas gas_remaining wei
                       args mem[var83003 + 4 len var83004 - 4]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            mem[var57005 len 160] = ext_call.return_data[0 len 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 160
            _3629 = mem[var61002]
            sub_d373b52e.length++
            mem[0] = 3
            address(sub_d373b52e[sub_d373b52e.length]) = address(_3629)
            mem[96] = 0x70a0823100000000000000000000000000000000000000000000000000000000
            mem[100] = chefAddress
            if var61004:
                require ext_code.size(address(var65001))
                ...
                require return_data.size >= 32
                mem[96] = 0x902f1ac00000000000000000000000000000000000000000000000000000000
                require ext_code.size(address(var71005))
                staticcall var73002.mem[var73003 len 4] with:
                        gas gas_remaining wei
                       args mem[var73003 + 4 len var73004 - 4]
                mem[var73005 len 96] = ext_call.return_data[0 len 96]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 96
                mem[96] = 0xad5c464800000000000000000000000000000000000000000000000000000000
                require ext_code.size(address(routerAddress))
                staticcall address(routerAddress).mem[var79003 len 4] with:
                        gas gas_remaining wei
                       args mem[var79003 + 4 len var79004 - 4]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_code.size(address(var83009))
                # nil
            else:
                ...
                mem[96] = 0x5909c0d500000000000000000000000000000000000000000000000000000000
                require ext_code.size(0x30748322b6e34545dbe0788c421886aeb5297789)
                staticcall 0x30748322b6e34545dbe0788c421886aeb5297789.mem[var71003 len 4] with:
                        gas gas_remaining wei
                       args mem[var71003 + 4 len var71004 - 4]
                mem[var71005] = ext_call.return_data[0]
                if not ext_call.success:
                ...
                require return_data.size >= 32
                _10330 = mem[var75002]
                mem[0] = address(var75004)
                mem[32] = 6
                sub_1fbedece[address(var75004)] = _10330 * var75003
                mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
                require ext_code.size(chefAddress)
        ...
        if not sub_44951130.length:
            ...
            mem[var64005 len 160] = ext_call.return_data[0 len 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 160
            _4333 = mem[var68002]
            sub_d373b52e.length++
            mem[0] = 3
            address(sub_d373b52e[sub_d373b52e.length]) = address(_4333)
            mem[96] = 0x70a0823100000000000000000000000000000000000000000000000000000000
            mem[100] = chefAddress
            if var68004:
                require ext_code.size(address(var72001))
                ...
                require return_data.size >= 32
                mem[96] = 0x902f1ac00000000000000000000000000000000000000000000000000000000
                require ext_code.size(address(var78005))
                staticcall var80002.mem[var80003 len 4] with:
                        gas gas_remaining wei
                       args mem[var80003 + 4 len var80004 - 4]
                mem[var80005 len 96] = ext_call.return_data[0 len 96]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 96
                mem[96] = 0xad5c464800000000000000000000000000000000000000000000000000000000
                require ext_code.size(address(routerAddress))
                staticcall address(routerAddress).mem[var86003 len 4] with:
                        gas gas_remaining wei
                ...
                mem[96] = 0x5909c0d500000000000000000000000000000000000000000000000000000000
                require ext_code.size(0x30748322b6e34545dbe0788c421886aeb5297789)
                staticcall 0x30748322b6e34545dbe0788c421886aeb5297789.mem[var78003 len 4] with:
                        gas gas_remaining wei
                       args mem[var78003 + 4 len var78004 - 4]
                mem[var78005] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                _11496 = mem[var82002]
                mem[0] = address(var82004)
                mem[32] = 6
                sub_1fbedece[address(var82004)] = _11496 * var82003
                mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
                require ext_code.size(chefAddress)
                staticcall chefAddress.mem[var86003 len 4] with:
                        gas gas_remaining wei
                       args mem[var86003 + 4 len var86004 - 4]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            mem[var68005 len 160] = ext_call.return_data[0 len 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 160
            _5188 = mem[var72002]
            sub_d373b52e.length++
            mem[0] = 3
            address(sub_d373b52e[sub_d373b52e.length]) = address(_5188)
            mem[96] = 0x70a0823100000000000000000000000000000000000000000000000000000000
            mem[100] = chefAddress
            if var72004:
                require ext_code.size(address(var76001))
                ...
                require return_data.size >= 32
                mem[96] = 0x902f1ac00000000000000000000000000000000000000000000000000000000
                require ext_code.size(address(var82005))
                staticcall var84002.mem[var84003 len 4] with:
                        gas gas_remaining wei
                       args mem[var84003 + 4 len var84004 - 4]
                mem[var84005 len 96] = ext_call.return_data[0 len 96]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 96
                mem[96] = 0xad5c464800000000000000000000000000000000000000000000000000000000
                require ext_code.size(address(routerAddress))
                staticcall address(routerAddress).mem[var90003 len 4] with:
                        gas gas_remaining wei
                ...
                mem[96] = 0x5909c0d500000000000000000000000000000000000000000000000000000000
                require ext_code.size(0x30748322b6e34545dbe0788c421886aeb5297789)
                staticcall 0x30748322b6e34545dbe0788c421886aeb5297789.mem[var82003 len 4] with:
                        gas gas_remaining wei
                ...
                require return_data.size >= 32
                _12720 = mem[var86002]
                mem[0] = address(var86004)
                mem[32] = 6
                sub_1fbedece[address(var86004)] = _12720 * var86003
                mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
                require ext_code.size(chefAddress)
                staticcall chefAddress.mem[var90003 len 4] with:
                        gas gas_remaining wei
                       args mem[var90003 + 4 len var90004 - 4]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
