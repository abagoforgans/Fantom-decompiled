...
function setFeeMultiplier(uint256 arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 > 100:
        revert with 0, 'MULTIPLIER_OVERFLOW'
    feeMultiplier = arg1
}
...
function withdrawFees(address arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if fees[address(this.address)] < 0:
        revert with 0, 'ZERO_FEE'
...
function sub_853ec87e(?) payable {
    ...
    if False and block.gasprice > 0:
        revert with 'NH{q', 17
    if False and feeMultiplier > 0:
        revert with 'NH{q', 17
    if msg.value <= 0:
        revert with 0, 'INSUFFICIENT_FEE'
    if fees[address(this.address)] > -1:
        revert with 'NH{q', 17
    if msg.value < 0:
        revert with 'NH{q', 17
