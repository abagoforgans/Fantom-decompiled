    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_call.return_data[0]:
                ...
                mem[64] = mem[64] + 164
                mem[_2484 + 100] = 32
                mem[_2484 + 132] = 'SafeERC20: low-level call failed'
                if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(address(arg3)):
                    revert with 0, 'Address: call to non-contract'
                if not ext_code.hash(address(arg3)):
                    revert with 0, 'Address: call to non-contract'
                _2553 = mem[_2500]
                mem[_2484 + 164 len ceil32(mem[_2500])] = mem[_2500 + 32 len ceil32(mem[_2500])]
                if ceil32(_2553) > _2553:
                    mem[_2553 + _2484 + 164] = 0
                call address(arg3) with:
                     gas gas_remaining wei
                    args mem[_2484 + 168 len _2553 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
                    ...
                    mem[_2484 + 196 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
                            revert with ext_call.return_data[0 len return_data.size]
                        revert with 0, 'SafeERC20: low-level call failed'
                    if return_data.size:
                        require return_data.size >= 32
                        require mem[_2484 + 196] == bool(mem[_2484 + 196])
                        if not mem[_2484 + 196]:
                            revert with 0, 'SafeERC20: ERC20 operation did not succeed'
            else:
                require ext_call.return_data[0] >= 32
                require uint32(this.address), address(arg3) << 64 == bool(uint32(this.address), address(arg3) << 64)
                ...
                mem[64] = mem[64] + 164
                mem[_2485 + 100] = 32
                mem[_2485 + 132] = 'SafeERC20: low-level call failed'
                if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(address(arg3)):
                    revert with 0, 'Address: call to non-contract'
                if not ext_code.hash(address(arg3)):
                    revert with 0, 'Address: call to non-contract'
                _2556 = mem[_2502]
                mem[_2485 + 164 len ceil32(mem[_2502])] = mem[_2502 + 32 len ceil32(mem[_2502])]
                if ceil32(_2556) > _2556:
                    mem[_2556 + _2485 + 164] = 0
                call address(arg3) with:
                     gas gas_remaining wei
                    args mem[_2485 + 168 len _2556 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
                    ...
                    mem[_2485 + 196 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
                            revert with ext_call.return_data[0 len return_data.size]
                        revert with 0, 'SafeERC20: low-level call failed'
                    if return_data.size:
                        require return_data.size >= 32
                        require mem[_2485 + 196] == bool(mem[_2485 + 196])
                        if not mem[_2485 + 196]:
                            revert with 0, 'SafeERC20: ERC20 operation did not succeed'
        else:
            ...
            if not return_data.size:
                ...
                mem[64] = mem[64] + 164
                mem[_2486 + 100] = 32
                mem[_2486 + 132] = 'SafeERC20: low-level call failed'
                if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(address(arg3)):
                    revert with 0, 'Address: call to non-contract'
                if not ext_code.hash(address(arg3)):
                    revert with 0, 'Address: call to non-contract'
                _2559 = mem[_2504]
                mem[_2486 + 164 len ceil32(mem[_2504])] = mem[_2504 + 32 len ceil32(mem[_2504])]
                if ceil32(_2559) > _2559:
                    mem[_2559 + _2486 + 164] = 0
                call address(arg3) with:
                     gas gas_remaining wei
                    args mem[_2486 + 168 len _2559 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
                    ...
                    mem[_2486 + 196 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
                            revert with ext_call.return_data[0 len return_data.size]
                        revert with 0, 'SafeERC20: low-level call failed'
                    if return_data.size:
                        require return_data.size >= 32
                        require mem[_2486 + 196] == bool(mem[_2486 + 196])
                        if not mem[_2486 + 196]:
                            revert with 0, 'SafeERC20: ERC20 operation did not succeed'
            else:
                require return_data.size >= 32
                ...
                mem[64] = mem[64] + 164
                mem[_2487 + 100] = 32
                mem[_2487 + 132] = 'SafeERC20: low-level call failed'
                if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(address(arg3)):
                    revert with 0, 'Address: call to non-contract'
                if not ext_code.hash(address(arg3)):
                    revert with 0, 'Address: call to non-contract'
                _2562 = mem[_2506]
                mem[_2487 + 164 len ceil32(mem[_2506])] = mem[_2506 + 32 len ceil32(mem[_2506])]
                if ceil32(_2562) > _2562:
                    mem[_2562 + _2487 + 164] = 0
                call address(arg3) with:
                     gas gas_remaining wei
                    args mem[_2487 + 168 len _2562 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
                    ...
                    mem[_2487 + 196 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
                            revert with ext_call.return_data[0 len return_data.size]
                        revert with 0, 'SafeERC20: low-level call failed'
                    if return_data.size:
                        require return_data.size >= 32
                        require mem[_2487 + 196] == bool(mem[_2487 + 196])
                        if not mem[_2487 + 196]:
                            revert with 0, 'SafeERC20: ERC20 operation did not succeed'
}
