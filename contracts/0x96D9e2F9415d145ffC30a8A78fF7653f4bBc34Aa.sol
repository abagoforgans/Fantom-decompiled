...
function sub_a21cf17c(?) {
    ...
    if stor25 > 3333:
        revert with 0, 'No more free rides.'
    stor25++
    if not address(arg1):
        revert with 0, 'ERC721: mint to the zero address'
    if ownerOf[stor25]:
        revert with 0, 'ERC721: token already minted'
    stor16[stor25] = tokenByIndex.length
    tokenByIndex.length++
    tokenByIndex[tokenByIndex.length] = stor25
    if address(arg1):
        if address(arg1):
            if not address(arg1):
                revert with 0, 'ERC721: balance query for the zero address'
            tokenOfOwnerByIndex[address(arg1)][stor6[address(arg1)]] = stor25
            stor14[stor25] = balanceOf[address(arg1)]
    else:
        if tokenByIndex.length < 1:
            revert with 0, 17
        if tokenByIndex.length - 1 >= tokenByIndex.length:
            revert with 0, 50
        if stor16[stor25] >= tokenByIndex.length:
            revert with 0, 50
        tokenByIndex[stor16[stor25]] = tokenByIndex[tokenByIndex.length]
        stor16[stor15[stor15.length]] = stor16[stor25]
        stor16[stor25] = 0
    ...
    ownerOf[stor25] = address(arg1)
    emit Transfer(0, address(arg1), stor25);
    if ext_code.size(address(arg1)):
        ...
        call address(arg1).onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
             gas gas_remaining wei
            args 0, uint32(msg.sender), 0, stor25, 128, 0
