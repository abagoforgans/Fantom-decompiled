...
function sub_fa9f8983(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if bool(stor101[address(msg.sender)]) != 1:
...
function createAuction(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if tx.origin != msg.sender:
        revert with 0, 'createAuction: no contracts'
    ...
    create contract with 0 wei
                    code: code.data[10097 len 13242], arg1, stor103, arg2, arg3, sub_b36f6873, sub_b36f6873, msg.sender, feeCollectorAddress, msg.sender, sub_2f95fe6eAddress
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    stor101[address(create.new_address)] = 1
