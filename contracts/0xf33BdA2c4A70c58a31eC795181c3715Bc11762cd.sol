...
function claimTicket(uint256 arg1, uint256 arg2) payable {
    ...
    staticcall stor6.getMaxRange() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) payable {
    ...
    if arg1 == msg.sender:
        ...
        mem[mem[64] + (32 * _855) + 228 len 32 * _973] = mem[(32 * arg3.length) + 160 len 32 * _973]
        mem[mem[64] + 132] = (32 * _855) + (32 * _973) + 224
        _1087 = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
        mem[mem[64] + (32 * _855) + (32 * _973) + 228] = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
        ...
        if ceil32(_1087) <= _1087:
            ...
            revert with memory
              from mem[64]
               len ceil32(_1259) + _1239 + -mem[64] + 68
    ...
    mem[mem[64] + (32 * mem[96]) + 196] = mem[(32 * arg3.length) + 128]
    mem[mem[64] + (32 * _856) + 228 len 32 * _974] = mem[(32 * arg3.length) + 160 len 32 * _974]
    mem[mem[64] + 132] = (32 * _856) + (32 * _974) + 224
    _1088 = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
    mem[mem[64] + (32 * _856) + (32 * _974) + 228] = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
    ...
    if ceil32(_1088) <= _1088:
        ...
        call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
             gas gas_remaining wei
            args msg.sender, address(arg1), 160, mem[mem[64] + 100], (32 * _856) + (32 * _974) + 224, mem[mem[64] + 164 len ceil32(_1088) + (32 * _856) + (32 * _974) + 96]
        mem[mem[64]] = ext_call.return_data[0]
        if ext_call.success:
            _1202 = mem[64]
            mem[64] = mem[64] + ceil32(return_data.size)
        ...
        revert with memory
          from mem[64]
           len ceil32(_1265) + _1243 + -mem[64] + 68
