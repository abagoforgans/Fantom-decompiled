...
function createMarketItem(address arg1, uint256 arg2, uint256 arg3, uint256 arg4) payable {
    ...
    stor5[stor1].field_768 = arg4
    stor5[stor1].field_1024 = msg.sender
    stor5[stor1].field_1280 = 0
    stor5[stor1].field_1536 = 0
    stor5[stor1].field_1536 = arg3
...
function createMarketSale(address arg1, uint256 arg2, address arg3) payable {
    ...
    if stor5[arg2].field_768 / 100 and msg.value > -1 / stor5[arg2].field_768 / 100:
        revert with 'NH{q', 17
    if msg.value < stor5[arg2].field_768 / 100 * msg.value:
        revert with 'NH{q', 17
    call stor5[arg2].field_1024 with:
       value msg.value - (stor5[arg2].field_768 / 100 * msg.value) wei
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    stor5[arg2].field_1280 = msg.sender
    stor5[arg2].field_1792 = 1
    call arg3 with:
       value stor5[arg2].field_768 / 100 * msg.value wei
         gas 2300 * is_zero(value) wei
    stor2++
    call stor3 with:
...
function fetchMyNFTs() {
    ...
    while idx < stor1:
        ...
        mem[0] = idx + 1
        mem[32] = 5
        if stor5[idx + 1].field_1280 != msg.sender:
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            s = s
