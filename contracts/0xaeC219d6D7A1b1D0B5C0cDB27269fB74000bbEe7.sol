...
function mint(address arg1, string arg2) payable {
    ...
    if tokenOfOwnerByIndex[address(arg1)][1][stor14 + 1]:
        if stor3[stor14 + 1]:
            ...
            if stor13 == msg.sender:
                ...
                if stor5[stor2[stor3[arg3] - 1].field_256][address(msg.sender)]:
                    ...
                    if msg.sender == tokenByIndex[stor3[arg3] - 1].field_256:
                        ...
                        require stor3[arg3] - 1 < tokenByIndex.length
                        if tokenByIndex[stor3[arg3] - 1].field_256 != arg1:
                            revert with 0, 32, 41, 0x724552433732313a207472616e73666572206f6620746f6b656e2074686174206973206e6f74206f77, mem[525 len 23]
                        if not arg2:
                                ...
                                if tokenOfOwnerByIndex[address(arg2)][1][arg3]:
                                    if stor3[arg3]:
                                        ...
                                        if ext_code.size(arg2):
                                            ...
                                            call arg2.0x80 with:
                                                 gas gas_remaining wei
                                                args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, address(arg1), arg3, 128, 0) << 1024, mem[1028 len 4]
                                            if not return_data.size:
                                                require not ext_call.success
                                                revert with 0, 
                                                            32,
