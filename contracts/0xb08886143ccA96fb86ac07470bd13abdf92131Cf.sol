...
const lp = 0x30748322b6e34545dbe0788c421886aeb5297789
...
function deposit(uint256 arg1) payable {
    ...
    if not ext_code.size(0x30748322b6e34545dbe0788c421886aeb5297789):
        revert with 0, 'Address: call to non-contract'
    mem[292 len 96] = unknown_0x23b872dd(?????), msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
    mem[416 len 4] = 0
    mem[388 len 0] = 0
    call 0x30748322b6e34545dbe0788c421886aeb5297789 with:
         gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if not approve(address rg1, uint256 rg2), 0x16327e3fbdaca3bcf7e38f5a:
                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[534 len 22]
            require ext_code.size(0x30748322b6e34545dbe0788c421886aeb5297789)
            staticcall 0x30748322b6e34545dbe0788c421886aeb5297789.0xdd62ed3e with:
                    gas gas_remaining wei
            ...
            call 0x30748322b6e34545dbe0788c421886aeb5297789.0x37f6f093 with:
                 gas gas_remaining wei
