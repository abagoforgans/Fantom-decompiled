...
function sub_99c7bf23(?) {
    ...
    if not _118:
        ...
        while idx < _157:
            ...
            require idx < mem[(32 * ('cd', 4).length) + 128]
            _177 = mem[mem[(32 * idx) + (32 * ('cd', 4).length) + 160] + 32]
            mem[mem[64] + 4] = ('signextend', 15, ('mem', ('range', ('mem', ('range', ('add', 160, ('mask_shl', 251, 0, 5, ('var', 0)), ('mask_shl', 251, 0, 5, ('cd', ('add', 4, ('cd', 4))))), 32)), 32)))
            mem[mem[64] + 36] = ('signextend', 15, ('var', '_177'))
            mem[mem[64] + 68] = cd[36]
            require ext_code.size(address(_162))
            staticcall address(_162).get_dy(int128 rg1, int128 rg2, uint256 rg3) with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4], ('signextend', 15, ('var', '_177')), cd[36]
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _187 = mem[64]
            ...
            require idx < mem[_119]
            mem[(32 * idx) + _119 + 32] = mem[_187]
            _157 = mem[96]
            idx = idx + 1
            continue 
        mem[mem[64]] = 32
        ...
        mem[mem[64] + 64 len 32 * _173] = mem[_119 + 32 len 32 * _173]
        return 32, mem[mem[64] + 32 len (32 * _173) + 32]
    mem[_119 + 32 len 32 * _118] = call.data[calldata.size len 32 * _118]
    _158 = mem[96]
    idx = 0
    while idx < _158:
        require idx < mem[96]
        ...
        require idx < mem[(32 * ('cd', 4).length) + 128]
        require idx < mem[(32 * ('cd', 4).length) + 128]
        _179 = mem[mem[(32 * idx) + (32 * ('cd', 4).length) + 160] + 32]
        mem[mem[64] + 4] = ('signextend', 15, ('mem', ('range', ('mem', ('range', ('add', 160, ('mask_shl', 251, 0, 5, ('var', 0)), ('mask_shl', 251, 0, 5, ('cd', ('add', 4, ('cd', 4))))), 32)), 32)))
        mem[mem[64] + 36] = ('signextend', 15, ('var', '_179'))
        mem[mem[64] + 68] = cd[36]
        require ext_code.size(address(_165))
        staticcall address(_165).get_dy(int128 rg1, int128 rg2, uint256 rg3) with:
                gas gas_remaining wei
               args mem[mem[64] + 4], ('signextend', 15, ('var', '_179')), cd[36]
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _188 = mem[64]
    ...
    _175 = mem[_119]
    mem[mem[64] + 32] = mem[_119]
    mem[mem[64] + 64 len 32 * _175] = mem[_119 + 32 len 32 * _175]
    return 32, mem[mem[64] + 32 len (32 * _175) + 32]
}
