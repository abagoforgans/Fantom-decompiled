...
mapping of uint32 sub_7664a7e8;
...
function sub_7664a7e8(?) payable {
    require calldata.size - 4 >= 32
    return address(sub_7664a7e8[arg1])
}
...
function poolAddress(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_e5c7eb4a.length
    return address(sub_7664a7e8[stor0[arg1]])
}
...
function rewardToken(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    mem[160] = 0xd533a949740bb3306d119cc777fa900ba034cd52
...
function lockedAmount(address arg1, uint256 arg2) payable {
    ...
    require ext_code.size(address(sub_7664a7e8[stor0[arg2]]))
    staticcall address(sub_7664a7e8[stor0[arg2]]).balanceOf(address arg1) with:
...
function claimReward(address arg1, uint256 arg2) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(sub_7664a7e8[ext_call.return_data[12 len 20]]))
    call address(sub_7664a7e8[ext_call.return_data[12 len 20]]).claim_rewards() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function withdraw(address arg1, uint256 arg2, uint256 arg3) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(sub_7664a7e8[ext_call.return_data[12 len 20]]))
    call address(sub_7664a7e8[ext_call.return_data[12 len 20]]).withdraw(uint256 arg1) with:
         gas gas_remaining wei
        args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_90c90f3d(?) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(sub_7664a7e8[ext_call.return_data[12 len 20]]))
    staticcall address(sub_7664a7e8[ext_call.return_data[12 len 20]]).claimable_reward(address arg1, address arg2) with:
            gas gas_remaining wei
...
function sub_144ba61d(?) payable {
    ...
    if not ext_code.size(arg1):
        revert with 0, 'Address: call to non-contract'
    mem[292 len 96] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), Mask(224, 32, arg4) >> 32
    mem[416 len 4] = 0
    mem[388 len 0] = 0
    call arg1 with:
         gas gas_remaining wei
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), arg4
        if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
            revert with 0, 
                        32,
                        42,
...
function deposit(address arg1, uint256 arg2, uint256 arg3) payable {
    ...
    staticcall address(ext_call.return_data[0]).allowance(address arg1, address arg2) with:
            gas gas_remaining wei
           args address(this.address), address(sub_7664a7e8[ext_call.return_data[12 len 20]])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if not ext_code.size(address(ext_call.return_data[0])):
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, sub_7664a7e8[ext_call.return_data[12 len 20]]), uint32(sub_7664a7e8[ext_call.return_data[12 len 20]]), Mask(224, 32, arg3 + ext_call.return_data[0]) >> 32
    mem[324 len 0] = 0
    call address(ext_call.return_data[0]) with:
       funct uint32(sub_7664a7e8[ext_call.return_data[12 len 20]])
         gas gas_remaining wei
        args Mask(224, 32, arg3 + ext_call.return_data[0]) << 224, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), 
                        Mask(224, 0, sub_7664a7e8[ext_call.return_data[12 len 20]]),
                        uint32(sub_7664a7e8[ext_call.return_data[12 len 20]]),
                        arg3 + ext_call.return_data[0]
        if not approve(address arg1, uint256 arg2), Mask(224, 0, sub_7664a7e8[ext_call.return_data[12 len 20]]):
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(sub_7664a7e8[address(ext_call.return_data[0])]))
    call address(sub_7664a7e8[address(ext_call.return_data[0])]).deposit(uint256 arg1) with:
         gas gas_remaining wei
        args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
