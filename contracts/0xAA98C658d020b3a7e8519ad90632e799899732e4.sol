...
function balanceOfPool() payable {
    ...
    staticcall shareRewardPoolAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function calculateTotalPendingRewards() payable {
    require ext_code.size(shareRewardPoolAddress)
    staticcall shareRewardPoolAddress.earned(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        require ext_code.size(shareRewardPoolAddress)
        call shareRewardPoolAddress.0xb6b55f25 with:
             gas gas_remaining wei
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        require ext_code.size(shareRewardPoolAddress)
        call shareRewardPoolAddress.0x2e1a7d4d with:
             gas gas_remaining wei
