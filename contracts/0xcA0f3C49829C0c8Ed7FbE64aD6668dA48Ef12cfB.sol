...
function mint(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        if sub_51645e28Address != msg.sender:
            revert with 0, 'caller is not the owner or sRads'
    if not arg1:
    ...
    if arg1 == 57005:
        ...
        if not arg2:
            if 0 > arg2:
                revert with 0, 'SafeMath: subtraction overflow'
            if arg2 != arg2:
                revert with 0, 32, 34, 0xfe524144533a3a7472616e736665723a204275726e2076616c756520696e76616c69, mem[326 len 30]
            if msg.sender == 57005:
