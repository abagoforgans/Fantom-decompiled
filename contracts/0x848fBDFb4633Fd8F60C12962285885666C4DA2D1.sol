...
function bytes32ToString(bytes32 arg1) {
    require calldata.size - 4 >= 32
    mem[128] = code.data[16396 len 32]
    idx = 0
    while idx < 32:
        require idx < 32
...
function sub_886ae8ee(?) payable {
    mem[64] = 96
    require not msg.value
    require calldata.size - 4 >= 32
    mem[0] = arg1
    mem[32] = 106
    if stor106[arg1].field_3328 != 1:
        revert with 0, 'proposal isn't resolved'
    require stor106[arg1].field_256 <= 2
    if stor106[arg1].field_256:
        revert with 0, 'proposal is executable'
    if stor106[arg1].field_2816:
        revert with 0, 'winner ID is correct'
    require ext_code.size(stor102)
    staticcall stor102.getTotalWeight() with:
            gas gas_remaining wei
    mem[96] = ext_call.return_data[0]
    ...
    if ext_call.return_data[0] * stor106[arg1].field_512 / 10^18 <= stor106[arg1].field_3072:
        ...
        while idx < stor106[arg1].field_1536:
            ...
            revert with memory
              from mem[64]
               len _39 + -mem[64] + 100
    stor106[arg1].field_2816 = stor106[arg1].field_1536
}
