        ...
        if not arg2:
            ...
            while idx < sub_0e9d1b6f[msg.sender].field_0:
                ...
                if arg1 != sub_8b2a9fc5[stor11[msg.sender][idx].field_0]:
                    ...
                    continue 
                if sub_0e9d1b6f[msg.sender][idx].field_0:
                    if (sub_590e4957[address(arg1)] / ext_call.return_data[0] * arg2) + sub_3e58372d[stor11[msg.sender][idx].field_0] < sub_3e58372d[stor11[msg.sender][idx].field_0]:
                        revert with 0, 'w'
                    sub_3e58372d[stor11[msg.sender][idx].field_0] += sub_590e4957[address(arg1)] / ext_call.return_data[0] * arg2
                    if arg2 + sub_b3019e8c[stor11[msg.sender][idx].field_0] < sub_b3019e8c[stor11[msg.sender][idx].field_0]:
                        revert with 0, 'w'
                    sub_b3019e8c[stor11[msg.sender][idx].field_0] += arg2
                else:
                ...
                call sub_aa9c635eAddress.transfer(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
                    args msg.sender, sub_590e4957[address(arg1)] / ext_call.return_data[0] * arg2
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
        ...
        if not arg2 - (arg3 * arg2 / 100):
            ...
            while idx < sub_0e9d1b6f[msg.sender].field_0:
                ...
                if arg1 != sub_8b2a9fc5[stor11[msg.sender][idx].field_0]:
                    ...
                    continue 
                if sub_0e9d1b6f[msg.sender][idx].field_0:
                    if (arg2 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) - (arg3 * arg2 / 100 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) + sub_3e58372d[stor11[msg.sender][idx].field_0] < sub_3e58372d[stor11[msg.sender][idx].field_0]:
                        revert with 0, 'w'
                    sub_3e58372d[stor11[msg.sender][idx].field_0] = (arg2 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) - (arg3 * arg2 / 100 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) + sub_3e58372d[stor11[msg.sender][idx].field_0]
                    if arg2 + sub_b3019e8c[stor11[msg.sender][idx].field_0] < sub_b3019e8c[stor11[msg.sender][idx].field_0]:
                        revert with 0, 'w'
                    sub_b3019e8c[stor11[msg.sender][idx].field_0] += arg2
                else:
                ...
                call sub_aa9c635eAddress.transfer(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
                    args msg.sender, (arg2 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) - (arg3 * arg2 / 100 * sub_590e4957[address(arg1)] / ext_call.return_data[0])
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
