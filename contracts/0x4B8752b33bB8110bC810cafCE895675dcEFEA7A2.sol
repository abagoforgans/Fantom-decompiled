...
function onFlashLoan(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    require return_data.size >= 32
    _98 = mem[ceil32(return_data.size) + 960 len 4], Mask(224, 32, arg3) >> 32
    ...
    _99 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 960 len 4], Mask(224, 32, arg3) >> 32 + 960]
    ...
    mem[(2 * ceil32(return_data.size)) + 960] = _99
    require return_data.size >= _98 + (32 * _99) + 32
    mem[(2 * ceil32(return_data.size)) + 992 len 32 * _99] = mem[ceil32(return_data.size) + _98 + 992 len 32 * _99]
    require 1 < _99
    ...
    call address(_210).approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args sub_07a12994[address(cd[(arg5 + 68)])], cd[(arg5 + 164)]
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    mem[64] = mem[64] + 64
    require 0 < mem[_231]
    mem[_231 + 32] = sub_07a12994[address(cd[(arg5 + 68)])]
    mem[_231 + 64] = 0xc299823800000000000000000000000000000000000000000000000000000000
    mem[_231 + 68] = 32
    mem[_231 + 100] = mem[_231]
    idx = 0
    s = _231 + 32
    t = _231 + 132
    while idx < mem[_231]:
    ...
    call address(stor1.length).mem[mem[64] len 4] with:
         gas gas_remaining wei
        args mem[mem[64] + 4 len _231 + (32 * mem[_231]) + -mem[64] + 128]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _297 = mem[64]
    ...
    mem[_297 + ceil32(return_data.size)] = _299
    require return_data.size >= _298 + (32 * _299) + 32
    mem[_297 + ceil32(return_data.size) + 32 len 32 * _299] = mem[_297 + _298 + 32 len 32 * _299]
    require 0 < _299
    if mem[_297 + ceil32(return_data.size) + 32] != 0:
        revert with 0, 'Comptroller.enterMarkets failed.'
    ...
    staticcall address(_368).0x70a08231 with:
            gas gas_remaining wei
           args address(this.address)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    mem[64] = mem[64] + 96
    require 0 < mem[_395]
    mem[_395 + 32] = address(cd[(arg5 + 100)])
    require 1 < mem[_395]
    mem[_395 + 64] = wFTMAddress
    mem[_395 + 96] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[_395 + 100] = cd[(arg5 + 196)]
    mem[_395 + 132] = 1
    mem[_395 + 164] = 160
    ...
    require return_data.size >= _422 + (32 * _423) + 32
    mem[_421 + ceil32(return_data.size) + 32 len 32 * _423] = mem[_421 + _422 + 32 len 32 * _423]
    require 1 < _423
    if arg4 + arg3 < arg3:
    ...
    if not stor17.length:
        ...
        while idx < stor17.length:
            ...
            while s < _421:
                ...
                continue 
            if ceil32(_421) <= _421:
                mem[_416 + 36] = ceil32(_421) + 96
                _809 = mem[_407]
                mem[ceil32(_421) + _416 + 100] = mem[_407]
                s = 0
                while s < _809:
                    mem[s + ceil32(_421) + _416 + 132] = mem[s + _407 + 32]
                    s = s + 32
                    continue 
                if ceil32(_809) <= _809:
                    require ext_code.size(stor13)
                    staticcall stor13.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len ceil32(_809) + ceil32(_421) + _416 + -mem[64] + 128]
                    mem[mem[64] len 96] = ext_call.return_data[0 len 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1186 = mem[64]
                    ...
                    mem[_809 + ceil32(_421) + _416 + 132] = 0
                    require ext_code.size(stor13)
                    staticcall stor13.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len ceil32(_809) + ceil32(_421) + _416 + -mem[64] + 128]
        ...
        while idx < stor17.length:
            ...
            if ceil32(_1190) <= _1190:
                ...
                if ceil32(_1425) <= _1425:
                    ...
                    staticcall stor13.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len ceil32(_1425) + ceil32(_1190) + _1183 + -mem[64] + 128]
                    mem[mem[64] len 96] = ext_call.return_data[0 len 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1599 = mem[64]
                    ...
                    mem[_1425 + ceil32(_1190) + _1183 + 132] = 0
                    require ext_code.size(stor13)
                    staticcall stor13.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len ceil32(_1425) + ceil32(_1190) + _1183 + -mem[64] + 128]
    ...
    if not stor17.length:
        ...
        while idx < stor17.length:
            ...
            if ceil32(_1397) <= _1397:
                mem[_1392 + 36] = ceil32(_1397) + 96
                _1785 = mem[_1380]
                mem[ceil32(_1397) + _1392 + 100] = mem[_1380]
                s = 0
                while s < _1785:
                    mem[s + ceil32(_1397) + _1392 + 132] = mem[s + _1380 + 32]
                    s = s + 32
                    continue 
                if ceil32(_1785) <= _1785:
                    ...
                    staticcall stor13.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len ceil32(_1785) + ceil32(_1397) + _1392 + -mem[64] + 128]
                    mem[mem[64] len 96] = ext_call.return_data[0 len 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _2162 = mem[64]
                    ...
                    mem[_1785 + ceil32(_1397) + _1392 + 132] = 0
                    require ext_code.size(stor13)
                    staticcall stor13.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len ceil32(_1785) + ceil32(_1397) + _1392 + -mem[64] + 128]
                ...
                if ceil32(_1786) <= _1786:
                    ...
                    staticcall stor13.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len ceil32(_1786) + ceil32(_1397) + _1392 + -mem[64] + 128]
                    mem[mem[64] len 96] = ext_call.return_data[0 len 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _2164 = mem[64]
                    ...
                    mem[_1786 + ceil32(_1397) + _1392 + 132] = 0
                    require ext_code.size(stor13)
                    staticcall stor13.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len ceil32(_1786) + ceil32(_1397) + _1392 + -mem[64] + 128]
