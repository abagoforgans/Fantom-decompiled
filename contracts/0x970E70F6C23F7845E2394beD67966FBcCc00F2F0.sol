...
function splitFunds() {
    ...
    if eth.balance(this.address) and stor11 > -1 / eth.balance(this.address):
        revert with 0, 17
    call stor0 with:
       value eth.balance(this.address) * stor6 / 1000 wei
         gas 2300 * is_zero(value) wei
    require ext_call.success
    call stor1 with:
       value eth.balance(this.address) * stor7 / 1000 wei
         gas 2300 * is_zero(value) wei
    call stor2 with:
       value eth.balance(this.address) * stor8 / 1000 wei
         gas 2300 * is_zero(value) wei
    call stor3 with:
       value eth.balance(this.address) * stor9 / 1000 wei
         gas 2300 * is_zero(value) wei
    call stor4 with:
       value eth.balance(this.address) * stor10 / 1000 wei
         gas 2300 * is_zero(value) wei
    call stor5 with:
       value eth.balance(this.address) * stor11 / 1000 wei
         gas 2300 * is_zero(value) wei
}
