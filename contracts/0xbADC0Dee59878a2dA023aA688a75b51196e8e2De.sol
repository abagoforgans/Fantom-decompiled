...
function sub_f695b385(?) {
    ...
    mem[ceil32(arg1.length) + 192] = arg4
    ...
    require mem[ceil32(arg1.length) + mem[ceil32(arg1.length) + 288 len 4], 0 + 288] <= 4294967296 and mem[ceil32(arg1.length) + 288 len 4], 0 + (32 * mem[ceil32(arg1.length) + mem[ceil32(arg1.length) + 288 len 4], 0 + 288]) + 32 <= return_data.size
    if not uint8(stor0.field_8):
...
function balanceOfStakedWant() {
    ...
    if not sub_9409ff9d:
        ...
        require return_data.size >= 32
        require ext_code.size(sub_a7836e36Address)
        staticcall sub_a7836e36Address.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
