...
function sub_06bfaf04(?) payable {
    ...
    if not sub_27fff0db[address(arg1)]:
        if not sub_c9354337[address(arg1)].field_512:
            if arg2 <= sub_4a5d0943 * arg6 / 10000:
                if arg3 <= sub_7d969932 * arg6 / 10000:
                    return 1
        else:
            if arg2 <= sub_c9354337[address(arg1)].field_0 * arg6 / 10000:
                if arg3 <= sub_c9354337[address(arg1)].field_256 * arg6 / 10000:
                    return 1
        return 0
...
function check(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) payable {
    ...
    if not sub_27fff0db[address(msg.sender)]:
        if not sub_c9354337[address(msg.sender)].field_512:
            ...
            if arg1 <= sub_c9354337[address(msg.sender)].field_0 * arg5 / 10000:
                if arg2 <= sub_c9354337[address(msg.sender)].field_256 * arg5 / 10000:
                    return 1
        return 0
