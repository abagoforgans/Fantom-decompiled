...
function sub_0c55baa9(?) payable {
    ...
    if not bool(ceil32(return_data.size) + 2048 <= test266151307()):
        revert with 0, 65
    ...
    if not bool((4 * ceil32(return_data.size)) + 2112 <= test266151307()):
        revert with 0, 65
    require ext_code.size(this.address)
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
    if not bool((6 * ceil32(return_data.size)) + 2176 <= test266151307()):
        revert with 0, 65
    require ext_code.size(stor2)
    staticcall stor2.getSkills(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(6 * ceil32(return_data.size)) + 2176 len 1152] = ext_call.return_data[0 len 1152]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 1152
    require (6 * ceil32(return_data.size)) + 2207 < (6 * ceil32(return_data.size)) + return_data.size + 2176
    if not bool((7 * ceil32(return_data.size)) + 3328 <= test266151307()):
        revert with 0, 65
    require 1152 <= return_data.size
    idx = 0
    s = (6 * ceil32(return_data.size)) + 2176
    t = (7 * ceil32(return_data.size)) + 2176
    while idx < 36:
        ...
        t = t + 32
        continue 
    mem[(7 * ceil32(return_data.size)) + 3328] = ceil32(return_data.size) + 1888
    idx = 0
    s = (7 * ceil32(return_data.size)) + 2176
    t = (7 * ceil32(return_data.size)) + 4160
    while idx < 36:
    ...
    return ext_call.return_data[0], 
           ...
           0,
           0,
           mem[(7 * ceil32(return_data.size)) + 4160 len 1152]
}
...
function getNames(uint256 arg1) payable {
    ...
    require ceil32(return_data.size) + return_data.size + 288 > ceil32(return_data.size) + mem[ceil32(return_data.size) + 288 len 4], Mask(224, 32, arg1) >> 32 + 319
...
function sub_c05bc01f(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            ...
            _411 = mem[64]
            mem[64] = mem[64] + 1152
            mem[_411 len 1152] = call.data[calldata.size len 1152]
            mem[_384 + 128] = _411
            require ext_code.size(this.address)
            staticcall this.address.0xa01bf1c2 with:
                    gas gas_remaining wei
            ...
            mem[64] = mem[64] + 160
            mem[_426] = mem[_422]
            mem[_426 + 32] = mem[_422 + 32]
            mem[_426 + 64] = mem[_422 + 64]
            mem[_426 + 96] = mem[_422 + 96]
            mem[_426 + 128] = mem[_422 + 128]
            require ext_code.size(stor1)
            staticcall stor1.ability_scores(uint256 arg1) with:
                    gas gas_remaining wei
                   args _380
            ...
            require return_data.size >= 192
            _463 = mem[_459]
            require mem[_459] == mem[_459 + 28 len 4]
            _466 = mem[_459 + 32]
            require mem[_459 + 32] == mem[_459 + 60 len 4]
            _475 = mem[_459 + 64]
            require mem[_459 + 64] == mem[_459 + 92 len 4]
            _477 = mem[_459 + 96]
            require mem[_459 + 96] == mem[_459 + 124 len 4]
            _479 = mem[_459 + 128]
            require mem[_459 + 128] == mem[_459 + 156 len 4]
            _481 = mem[_459 + 160]
            require mem[_459 + 160] == mem[_459 + 188 len 4]
            require ext_code.size(this.address)
            staticcall this.address.0x877e3817 with:
                    gas gas_remaining wei
                   args _380
            ...
            mem[64] = mem[64] + ceil32(return_data.size)
            require return_data.size >= 1152
            require _508 + 31 < _508 + return_data.size
            _510 = mem[64]
            ...
            _525 = mem[64]
            mem[64] = mem[64] + 192
            mem[_525] = uint32(_463)
            mem[_525 + 32] = uint32(_466)
            mem[_525 + 64] = uint32(_475)
            mem[_525 + 96] = uint32(_477)
            mem[_525 + 128] = uint32(_479)
            mem[_525 + 160] = uint32(_481)
            mem[_524 + 96] = _525
            mem[_524 + 128] = _510
            if idx >= mem[ceil32(32 * ('cd', 4).length) + 97]:
                revert with 0, 50
            mem[(32 * idx) + ceil32(32 * ('cd', 4).length) + 129] = _524
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            continue 
        mem[mem[64]] = 32
        _382 = mem[ceil32(32 * ('cd', 4).length) + 97]
        mem[mem[64] + 32] = mem[ceil32(32 * ('cd', 4).length) + 97]
        idx = 0
        s = mem[64] + 64
        ...
        while idx < _382:
            ...
            _604 = mem[mem[t]]
            mem[s] = mem[mem[mem[t]]]
            mem[s + 32] = mem[_604 + 32]
            mem[s + 64] = mem[_604 + 64]
            mem[s + 96] = mem[_604 + 96]
            mem[s + 128] = mem[_604 + 128]
            _612 = mem[_600 + 32]
            mem[s + 160] = mem[mem[_600 + 32]]
            mem[s + 192] = mem[_612 + 32]
            _615 = mem[_600 + 64]
            mem[s + 224] = mem[mem[_600 + 64]]
            mem[s + 256] = mem[_615 + 32]
            _618 = mem[_600 + 96]
            mem[s + 288] = mem[mem[_600 + 96] + 28 len 4]
            mem[s + 320] = mem[_618 + 60 len 4]
            mem[s + 352] = mem[_618 + 92 len 4]
            mem[s + 384] = mem[_618 + 124 len 4]
            mem[s + 416] = mem[_618 + 156 len 4]
            mem[s + 448] = mem[_618 + 188 len 4]
            u = 0
            v = mem[_600 + 128]
            w = s + 480
            while u < 36:
                mem[w] = mem[v + 31 len 1]
                u = u + 1
                v = v + 32
                w = w + 32
                continue 
        ...
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 129] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 289
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 449] = 0
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 481] = 0
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 161] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 449
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 513] = 0
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 545] = 0
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 193] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 513
        ...
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 225] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 577
        mem[64] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 1921
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 769 len 1152] = call.data[calldata.size len 1152]
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 257] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 769
        mem[var30002] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 129
        s = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 289
        ...
        while idx - 1:
            ...
            mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 449] = 0
            mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 481] = 0
            mem[_529 + 32] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 449
            mem[64] = mem[64] + 64
            mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 513] = 0
            mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 545] = 0
            mem[_529 + 64] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 513
            mem[64] = mem[64] + 192
            mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 577] = 0
            mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 609] = 0
            mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 641] = 0
            ...
            mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 705] = 0
            mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 737] = 0
            mem[_529 + 96] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 577
            mem[64] = mem[64] + 1152
            mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 769 len 1152] = call.data[calldata.size len 1152]
            mem[_529 + 128] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 769
            mem[s + 32] = _529
            s = _530
            s = _529
            s = _529
        ...
        while idx < _628:
            ...
            _660 = mem[64]
            mem[64] = mem[64] + 1152
            mem[_660 len 1152] = call.data[calldata.size len 1152]
            mem[_634 + 128] = _660
            require ext_code.size(this.address)
            staticcall this.address.0xa01bf1c2 with:
                    gas gas_remaining wei
            ...
            mem[64] = mem[64] + 160
            mem[_666] = mem[_665]
            mem[_666 + 32] = mem[_665 + 32]
            mem[_666 + 64] = mem[_665 + 64]
            mem[_666 + 96] = mem[_665 + 96]
            mem[_666 + 128] = mem[_665 + 128]
            require ext_code.size(stor1)
            staticcall stor1.ability_scores(uint256 arg1) with:
                    gas gas_remaining wei
                   args _632
            ...
            require return_data.size >= 192
            _675 = mem[_674]
            require mem[_674] == mem[_674 + 28 len 4]
            _676 = mem[_674 + 32]
            require mem[_674 + 32] == mem[_674 + 60 len 4]
            _677 = mem[_674 + 64]
            require mem[_674 + 64] == mem[_674 + 92 len 4]
            _678 = mem[_674 + 96]
            require mem[_674 + 96] == mem[_674 + 124 len 4]
            _679 = mem[_674 + 128]
            require mem[_674 + 128] == mem[_674 + 156 len 4]
            _680 = mem[_674 + 160]
            require mem[_674 + 160] == mem[_674 + 188 len 4]
            require ext_code.size(this.address)
            staticcall this.address.0x877e3817 with:
                    gas gas_remaining wei
                   args _632
            ...
            mem[64] = mem[64] + ceil32(return_data.size)
            require return_data.size >= 1152
            require _695 + 31 < _695 + return_data.size
            _696 = mem[64]
            if mem[64] + 1152 < mem[64] or mem[64] + 1152 > test266151307():
                revert with 0, 65
            mem[64] = mem[64] + 1152
            ...
            _701 = mem[64]
            mem[64] = mem[64] + 192
            mem[_701] = uint32(_675)
            mem[_701 + 32] = uint32(_676)
            mem[_701 + 64] = uint32(_677)
            mem[_701 + 96] = uint32(_678)
            mem[_701 + 128] = uint32(_679)
            mem[_701 + 160] = uint32(_680)
            mem[_700 + 96] = _701
            mem[_700 + 128] = _696
            if idx >= mem[ceil32(32 * ('cd', 4).length) + 97]:
                revert with 0, 50
            mem[(32 * idx) + ceil32(32 * ('cd', 4).length) + 129] = _700
            if idx == -1:
                revert with 0, 17
            _628 = mem[96]
            idx = idx + 1
            continue 
        mem[mem[64]] = 32
        _633 = mem[ceil32(32 * ('cd', 4).length) + 97]
        mem[mem[64] + 32] = mem[ceil32(32 * ('cd', 4).length) + 97]
        idx = 0
        s = mem[64] + 64
        t = ceil32(32 * ('cd', 4).length) + 129
        while idx < _633:
            ...
            _705 = mem[mem[t]]
            mem[s] = mem[mem[mem[t]]]
            mem[s + 32] = mem[_705 + 32]
            mem[s + 64] = mem[_705 + 64]
            mem[s + 96] = mem[_705 + 96]
            mem[s + 128] = mem[_705 + 128]
            _711 = mem[_703 + 32]
            mem[s + 160] = mem[mem[_703 + 32]]
            mem[s + 192] = mem[_711 + 32]
            _714 = mem[_703 + 64]
            mem[s + 224] = mem[mem[_703 + 64]]
            mem[s + 256] = mem[_714 + 32]
            _717 = mem[_703 + 96]
            mem[s + 288] = mem[mem[_703 + 96] + 28 len 4]
            mem[s + 320] = mem[_717 + 60 len 4]
            mem[s + 352] = mem[_717 + 92 len 4]
            mem[s + 384] = mem[_717 + 124 len 4]
            mem[s + 416] = mem[_717 + 156 len 4]
            mem[s + 448] = mem[_717 + 188 len 4]
            u = 0
            v = mem[_703 + 128]
            w = s + 480
            while u < 36:
