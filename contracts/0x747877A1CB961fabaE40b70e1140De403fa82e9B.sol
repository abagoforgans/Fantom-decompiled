...
function transferOwnership(address arg1) payable {
    ...
    owner = arg1
    emit TransferOwnershipEvent(owner, arg1);
}
...
function toggleAdder(address arg1) payable {
    ...
    emit ToggleAdderEvent(msg.sender, arg1, bool(uint8(stor1[address(arg1)])));
}
...
function toggleSubtractor(address arg1) payable {
    ...
    emit ToggleSubtractorEvent(msg.sender, arg1, bool(uint8(stor2[address(arg1)])));
}
...
function subtractValue(address arg1, uint256 arg2) payable {
    ...
    if totalBalance < arg2:
        revert with 'NH{q', 17
    totalBalance -= arg2
    emit SubtractValueEvent(msg.sender, arg1, arg2);
}
...
function addValue(address arg1, uint256 arg2) payable {
    ...
    if totalBalance > -arg2 - 1:
        revert with 'NH{q', 17
    totalBalance += arg2
    emit AddValueEvent(msg.sender, arg1, arg2);
}
