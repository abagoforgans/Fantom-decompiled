                    ...
                    if wantLockedTotal >= arg2:
                        ...
                        if not wantLockedTotal:
                            ...
                            if wantLockedTotal <= ext_call.return_data[0]:
                                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 0, stor16.field_32)
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                                    args Mask(480, 0, stor16.field_0), mem[452 len 4]
                            else:
                                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), ext_call.return_data[0 len 28]
                                call wantAddress with:
                                   funct uint32(stor12)
    ...
    if not return_data.size:
        ...
        if sub_25c7ce6b >= 10000:
            if wantLockedTotal <= 0:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[456 len 64] = 0, address(poolAddress), Mask(224, 31, ext_call.return_data[0]) >> 31
                call wantAddress with:
                   funct uint32(stor31)
                     gas gas_remaining wei
            ...
            if not arg2:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[584 len 64] = 0, address(poolAddress), Mask(224, 31, ext_call.return_data[0]) >> 31
                call wantAddress with:
                   funct uint32(stor31)
                     gas gas_remaining wei
        ...
        if not arg2:
            if wantLockedTotal <= 0:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[520 len 64] = 0, address(poolAddress), Mask(224, 31, ext_call.return_data[0]) >> 31
                call wantAddress with:
                   funct uint32(stor31)
                     gas gas_remaining wei
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[648 len 64] = 0, address(poolAddress), Mask(224, 31, ext_call.return_data[0]) >> 31
            call wantAddress with:
               funct uint32(stor31)
                 gas gas_remaining wei
        ...
        if return_data.size <= 0:
            if sub_25c7ce6b >= 10000:
                if wantLockedTotal <= 0:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 457 len 64] = 0, address(poolAddress), Mask(224, 31, ext_call.return_data[0]) >> 31
                    call wantAddress with:
                       funct uint32(stor31)
                         gas gas_remaining wei
                ...
                if not arg2:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 585 len 64] = 0, address(poolAddress), Mask(224, 31, ext_call.return_data[0]) >> 31
                    call wantAddress with:
                       funct uint32(stor31)
                         gas gas_remaining wei
            ...
            if not arg2:
                if wantLockedTotal <= 0:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 521 len 64] = 0, address(poolAddress), Mask(224, 31, ext_call.return_data[0]) >> 31
                    call wantAddress with:
                       funct uint32(stor31)
                         gas gas_remaining wei
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 649 len 64] = 0, address(poolAddress), Mask(224, 31, ext_call.return_data[0]) >> 31
                call wantAddress with:
                   funct uint32(stor31)
                     gas gas_remaining wei
