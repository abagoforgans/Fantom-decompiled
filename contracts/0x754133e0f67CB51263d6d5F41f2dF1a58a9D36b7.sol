                ...
                if ceil32(_675) <= _675:
                    ...
                    if not return_data.size:
                        ...
                        if not mem[96]:
                            ...
                            call address(_1243).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require mem[96] >= 32
                            require mem[128] == bool(mem[128])
                            ...
                            call address(_1387).0xd0e30db0 with:
                                 gas gas_remaining wei
                    else:
                        ...
                        if not return_data.size:
                            ...
                            call address(_1247).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require return_data.size >= 32
                            ...
                            call address(_1391).0xd0e30db0 with:
                                 gas gas_remaining wei
                else:
                    mem[_675 + _648 + 164] = 0
                    call wantAddress.mem[_648 + 164 len 4] with:
                    ...
                    if not return_data.size:
                        ...
                        if not mem[96]:
                            ...
                            call address(_1251).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require mem[96] >= 32
                            require mem[128] == bool(mem[128])
                            ...
                            call address(_1395).0xd0e30db0 with:
                                 gas gas_remaining wei
                    else:
                        mem[64] = _648 + ceil32(return_data.size) + 165
                        mem[_648 + 164] = return_data.size
                        ...
                        if not return_data.size:
                            ...
                            call address(_1255).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require return_data.size >= 32
                            require mem[_648 + 196] == bool(mem[_648 + 196])
                            ...
                            call address(_1399).0xd0e30db0 with:
                                 gas gas_remaining wei
            else:
                ...
                if ceil32(_680) <= _680:
                    ...
                    if not return_data.size:
                        ...
                        if not mem[96]:
                            ...
                            call address(_1227).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require mem[96] >= 32
                            require mem[128] == bool(mem[128])
                            ...
                            call address(_1371).0xd0e30db0 with:
                                 gas gas_remaining wei
                    else:
                        ...
                        if not return_data.size:
                            ...
                            call address(_1231).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require return_data.size >= 32
                            ...
                            call address(_1375).0xd0e30db0 with:
                                 gas gas_remaining wei
                else:
                    mem[_680 + _652 + 164] = 0
                    call wantAddress.mem[_652 + 164 len 4] with:
                    ...
                    if not return_data.size:
                        ...
                        if not mem[96]:
                            ...
                            call address(_1235).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require mem[96] >= 32
                            require mem[128] == bool(mem[128])
                            ...
                            call address(_1379).0xd0e30db0 with:
                                 gas gas_remaining wei
                    else:
                        mem[64] = _652 + ceil32(return_data.size) + 165
                        mem[_652 + 164] = return_data.size
                        ...
                        if not return_data.size:
                            ...
                            call address(_1239).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require return_data.size >= 32
                            require mem[_652 + 196] == bool(mem[_652 + 196])
                            ...
                            call address(_1383).0xd0e30db0 with:
                                 gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _584 = mem[96]
                ...
                if ceil32(_679) <= _679:
                    ...
                    if not return_data.size:
                        ...
                        if not mem[96]:
                            ...
                            call address(_1275).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require mem[96] >= 32
                            require mem[128] == bool(mem[128])
                            ...
                            call address(_1419).0xd0e30db0 with:
                                 gas gas_remaining wei
                    else:
                        ...
                        if not return_data.size:
                            ...
                            call address(_1279).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require return_data.size >= 32
                            ...
                            call address(_1423).0xd0e30db0 with:
                                 gas gas_remaining wei
                else:
                    mem[_679 + _651 + 164] = 0
                    call wantAddress.mem[_651 + 164 len 4] with:
                    ...
                    if not return_data.size:
                        ...
                        if not mem[96]:
                            ...
                            call address(_1283).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require mem[96] >= 32
                            require mem[128] == bool(mem[128])
                            ...
                            call address(_1427).0xd0e30db0 with:
                                 gas gas_remaining wei
                    else:
                        mem[64] = _651 + ceil32(return_data.size) + 165
                        mem[_651 + 164] = return_data.size
                        ...
                        if not return_data.size:
                            ...
                            call address(_1287).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require return_data.size >= 32
                            require mem[_651 + 196] == bool(mem[_651 + 196])
                            ...
                            call address(_1431).0xd0e30db0 with:
                                 gas gas_remaining wei
            else:
                ...
                if ceil32(_683) <= _683:
                    ...
                    if not return_data.size:
                        ...
                        if not mem[96]:
                            ...
                            call address(_1259).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require mem[96] >= 32
                            require mem[128] == bool(mem[128])
                            ...
                            call address(_1403).0xd0e30db0 with:
                                 gas gas_remaining wei
                    else:
                        ...
                        if not return_data.size:
                            ...
                            call address(_1263).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require return_data.size >= 32
                            ...
                            call address(_1407).0xd0e30db0 with:
                                 gas gas_remaining wei
                else:
                    mem[_683 + _653 + 164] = 0
                    call wantAddress.mem[_653 + 164 len 4] with:
                    ...
                    if not return_data.size:
                        ...
                        if not mem[96]:
                            ...
                            call address(_1267).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require mem[96] >= 32
                            require mem[128] == bool(mem[128])
                            ...
                            call address(_1411).0xd0e30db0 with:
                                 gas gas_remaining wei
                    else:
                        mem[64] = _653 + ceil32(return_data.size) + 165
                        mem[_653 + 164] = return_data.size
                        ...
                        if not return_data.size:
                            ...
                            call address(_1271).0xd0e30db0 with:
                                 gas gas_remaining wei
                        else:
                            require return_data.size >= 32
                            require mem[_653 + 196] == bool(mem[_653 + 196])
                            ...
                            call address(_1415).0xd0e30db0 with:
                                 gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _585 = mem[96]
