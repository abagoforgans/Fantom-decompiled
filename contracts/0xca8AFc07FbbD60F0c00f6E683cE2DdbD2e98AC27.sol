...
function deposit(uint256 arg1) {
    ...
    if not arg1 * ext_call.return_data[0] / 10000:
        ...
        if not ext_code.size(stakeTokenAddress):
            revert with 0, 'Address: call to non-contract'
        if var45001 < 68:
            mem[var45001 + (2 * ceil32(return_data.size)) + 260] = mem[var45001 + (2 * ceil32(return_data.size)) + 128]
            var45001 = var45001 + 32
            continue 
        if var45001 > 68:
            mem[(2 * ceil32(return_data.size)) + 328] = 0
        call stakeTokenAddress.mem[(2 * ceil32(return_data.size)) + 260 len 4] with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(4 * ceil32(return_data.size)) + 264] = pid
            mem[(4 * ceil32(return_data.size)) + 296] = this.address
            require ext_code.size(address(masterChefAddress))
            staticcall address(masterChefAddress).0x93f1a40b with:
                    gas gas_remaining wei
                   args mem[(4 * ceil32(return_data.size)) + 264 len (5 * ceil32(return_data.size)) + 64]
            ...
            staticcall stakeTokenAddress.0x70a08231 with:
                    gas gas_remaining wei
                   args mem[(4 * ceil32(return_data.size)) + 264 len (7 * ceil32(return_data.size)) + 32]
            ...
            staticcall stakeTokenAddress.0xdd62ed3e with:
                    gas gas_remaining wei
                   args mem[(8 * ceil32(return_data.size)) + 264 len (13 * ceil32(return_data.size)) + 64]
            ...
            if ext_call.return_data[0] > !ext_call.return_data[0]:
                revert with 0, 17
            mem[(9 * ceil32(return_data.size)) + 296] = address(masterChefAddress)
            mem[(9 * ceil32(return_data.size)) + 328] = 2 * ext_call.return_data[0]
            mem[(9 * ceil32(return_data.size)) + 260] = (4 * ceil32(return_data.size)) + 68
            mem[(9 * ceil32(return_data.size)) + 296 len 28] = Mask(224, 0, stor3)
            mem[(9 * ceil32(return_data.size)) + 292 len 4] = approve(address arg1, uint256 arg2)
            mem[(9 * ceil32(return_data.size)) + 360] = 32
            mem[(9 * ceil32(return_data.size)) + 392] = 'SafeERC20: low-level call failed'
            if eth.balance(this.address) < 0:
                revert with 0, 'Address: insufficient balance for call'
            if not ext_code.size(stakeTokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(9 * ceil32(return_data.size)) + 424 len floor32((4 * ceil32(return_data.size)) + 99)] = approve(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), 2 * ext_call.return_data[0], mem[(9 * ceil32(return_data.size)) + 360 len floor32((4 * ceil32(return_data.size)) + 99) - 68]
            if floor32((4 * ceil32(return_data.size)) + 99) > (4 * ceil32(return_data.size)) + 68:
                mem[(14 * ceil32(return_data.size)) + 492] = 0
            call stakeTokenAddress.mem[(9 * ceil32(return_data.size)) + 424 len 4] with:
                 gas gas_remaining wei
                args mem[(9 * ceil32(return_data.size)) + 428 len (5 * ceil32(return_data.size)) + 64]
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
                ...
                mem[(9 * ceil32(return_data.size)) + 456 len return_data.size] = ext_call.return_data[0 len return_data.size]
                if not ext_call.success:
                    if return_data.size:
                        revert with ext_call.return_data[0 len return_data.size]
                    revert with 0, 'SafeERC20: low-level call failed'
                if return_data.size:
                    require return_data.size >= 32
                    require mem[(9 * ceil32(return_data.size)) + 456] == bool(mem[(9 * ceil32(return_data.size)) + 456])
                    if not mem[(9 * ceil32(return_data.size)) + 456]:
                        revert with 0, 'SafeERC20: ERC20 operation did not succeed'
        else:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 265] = pid
            mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = this.address
            require ext_code.size(address(masterChefAddress))
            staticcall address(masterChefAddress).0x93f1a40b with:
                    gas gas_remaining wei
                   args mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 265 len (5 * ceil32(return_data.size)) + 64]
            ...
            staticcall stakeTokenAddress.0x70a08231 with:
                    gas gas_remaining wei
                   args mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 265 len (7 * ceil32(return_data.size)) + 32]
            ...
            staticcall stakeTokenAddress.0xdd62ed3e with:
                    gas gas_remaining wei
                   args mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 265 len (13 * ceil32(return_data.size)) + 64]
            ...
            if ext_call.return_data[0] > !ext_call.return_data[0]:
                revert with 0, 17
            mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = address(masterChefAddress)
            mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = 2 * ext_call.return_data[0]
            mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = (4 * ceil32(return_data.size)) + 68
            mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 297 len 28] = Mask(224, 0, stor3)
            mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 293 len 4] = approve(address arg1, uint256 arg2)
            mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 361] = 32
            mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 393] = 'SafeERC20: low-level call failed'
            if eth.balance(this.address) < 0:
                revert with 0, 'Address: insufficient balance for call'
            if not ext_code.size(stakeTokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len floor32((4 * ceil32(return_data.size)) + 99)] = approve(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), 2 * ext_call.return_data[0], mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 361 len floor32((4 * ceil32(return_data.size)) + 99) - 68]
            if floor32((4 * ceil32(return_data.size)) + 99) > (4 * ceil32(return_data.size)) + 68:
                mem[(14 * ceil32(return_data.size)) + ceil32(return_data.size) + 493] = 0
            call stakeTokenAddress.mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 4] with:
                 gas gas_remaining wei
                args mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 429 len (5 * ceil32(return_data.size)) + 64]
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
                ...
                mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 457 len return_data.size] = ext_call.return_data[0 len return_data.size]
                if not ext_call.success:
                    if return_data.size:
                        revert with ext_call.return_data[0 len return_data.size]
                    revert with 0, 'SafeERC20: low-level call failed'
                if return_data.size:
                    require return_data.size >= 32
                    require mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 457] == bool(mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 457])
                    if not mem[(9 * ceil32(return_data.size)) + ceil32(return_data.size) + 457]:
                        revert with 0, 'SafeERC20: ERC20 operation did not succeed'
    require ext_code.size(address(masterChefAddress))
    call address(masterChefAddress).0xe2bbb158 with:
         gas gas_remaining wei
