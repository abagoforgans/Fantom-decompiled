    ...
    if msg.sender == owner:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(lpToken0Address):
                revert with 0, 'Address: call to non-contract'
            mem[488 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), 0
            ...
            if not return_data.size:
                ...
                call lpToken1Address with:
                   funct uint32(stor2)
                     gas gas_remaining wei
                    args 0, mem[ceil32(return_data.size) + 749 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), 0
                    if not approve(address arg1, uint256 arg2), Mask(224, 0, stor18):
            ...
            if not ext_code.size(lpToken0Address):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 489 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), 0
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                call lpToken1Address with:
                   funct uint32(stor2)
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), 0) << 256, mem[748 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), 0
                    if not approve(address arg1, uint256 arg2), Mask(224, 0, stor18):
