    ...
    if ext_call.return_data[0] > 0:
        ...
        if ext_call.return_data[0] >= ext_call.return_data[0]:
            ...
            call address(masterchefAddress).deposit(uint256 arg1, uint256 arg2, address arg3) with:
                 gas gas_remaining wei
                args poolId, ext_call.return_data[0], stor11
        else:
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    call address(masterchefAddress).deposit(uint256 arg1, uint256 arg2, address arg3) with:
                         gas gas_remaining wei
                        args poolId, ext_call.return_data[0], stor11, mem[(2 * ceil32(return_data.size)) + 526 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
