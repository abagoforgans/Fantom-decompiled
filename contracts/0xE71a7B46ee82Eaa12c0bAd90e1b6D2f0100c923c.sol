...
function sub_9fb63649(?) payable {
    ...
    if arg4.length / 2 > test266151307():
        revert with 'NH{q', 65
    if not Mask(255, 1, arg4.length):
        if var223002 < arg4.length / 2:
            if var235001 > 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
                revert with 'NH{q', 17
            # nil
        else:
            mem[(16 * Mask(251, 1, arg4.length)) + 128] = 32
            mem[(16 * Mask(251, 1, arg4.length)) + 160] = arg4.length / 2
            mem[(16 * Mask(251, 1, arg4.length)) + 192 len 16 * Mask(251, 1, arg4.length)] = mem[128 len 16 * Mask(251, 1, arg4.length)]
            return memory
              from (16 * Mask(251, 1, arg4.length)) + 128
               len (48 * Mask(255, 1, arg4.length)) + 64
    else:
        mem[128 len 16 * Mask(251, 1, arg4.length)] = call.data[calldata.size len 16 * Mask(251, 1, arg4.length)]
        if var224002 < arg4.length / 2:
            if var236001 > 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
                revert with 'NH{q', 17
            # nil
        else:
            mem[(16 * Mask(251, 1, arg4.length)) + 128] = 32
            mem[(16 * Mask(251, 1, arg4.length)) + 160] = arg4.length / 2
            mem[(16 * Mask(251, 1, arg4.length)) + 192 len 16 * Mask(251, 1, arg4.length)] = call.data[calldata.size len 16 * Mask(251, 1, arg4.length)]
            return memory
              from (16 * Mask(251, 1, arg4.length)) + 128
               len (48 * Mask(255, 1, arg4.length)) + 64
}
