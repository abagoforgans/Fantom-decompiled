...
function sub_092213c8(?) payable {
    ...
    mem[(32 * _25) + ceil32(return_data.size) + 132] = address(cd[68])
    mem[(32 * _25) + ceil32(return_data.size) + 164] = _51
    ...
    call address(cd[((32 * ('cd', 100).length - 1) + cd[100] + 36)]).approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args address(cd[68]), _51
    mem[(32 * _25) + ceil32(return_data.size) + 128] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require 1 < mem[ceil32(return_data.size) + 96]
    _57 = mem[ceil32(return_data.size) + 160]
    mem[(32 * _25) + ceil32(return_data.size) + 128] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[(32 * _25) + ceil32(return_data.size) + 132] = _57
    mem[(32 * _25) + ceil32(return_data.size) + 164] = 0
    mem[(32 * _25) + ceil32(return_data.size) + 228] = this.address
    mem[(32 * _25) + ceil32(return_data.size) + 260] = block.timestamp + 1000
    mem[(32 * _25) + ceil32(return_data.size) + 196] = 160
    mem[(32 * _25) + ceil32(return_data.size) + 292] = ('cd', 132).length
    mem[(32 * _25) + ceil32(return_data.size) + 324 len 32 * ('cd', 132).length] = call.data[cd[132] + 36 len 32 * ('cd', 132).length]
    mem[(32 * _25) + ceil32(return_data.size) + (32 * ('cd', 132).length) + 324] = 0
    require ext_code.size(address(cd[68]))
    call address(cd[68]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args _57, 0, 160, address(this.address), block.timestamp + 1000, ('cd', 132).length, call.data[cd[132] + 36 len floor32(('cd', 132).length)]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(32 * _25) + ceil32(return_data.size) + 128 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (32 * _25) + (2 * ceil32(return_data.size)) + 128
    require return_data.size >= 32
    _61 = mem[(32 * _25) + ceil32(return_data.size) + 128 len 4], Mask(224, 32, _57) >> 32
    require mem[(32 * _25) + ceil32(return_data.size) + 128 len 4], Mask(224, 32, _57) >> 32 <= 4294967296
    require mem[(32 * _25) + ceil32(return_data.size) + 128 len 4], Mask(224, 32, _57) >> 32 + 32 <= return_data.size
    require mem[mem[(32 * _25) + ceil32(return_data.size) + 128 len 4], Mask(224, 32, _57) >> 32 + (32 * _25) + ceil32(return_data.size) + 128] <= 4294967296 and mem[(32 * _25) + ceil32(return_data.size) + 128 len 4], Mask(224, 32, _57) >> 32 + (32 * mem[mem[(32 * _25) + ceil32(return_data.size) + 128 len 4], Mask(224, 32, _57) >> 32 + (32 * _25) + ceil32(return_data.size) + 128]) + 32 <= return_data.size
    mem[(32 * _25) + (2 * ceil32(return_data.size)) + 128] = mem[mem[(32 * _25) + ceil32(return_data.size) + 128 len 4], Mask(224, 32, _57) >> 32 + (32 * _25) + ceil32(return_data.size) + 128]
    mem[(32 * _25) + (2 * ceil32(return_data.size)) + 160 len floor32(mem[_61 + (32 * _25) + ceil32(return_data.size) + 128])] = mem[_61 + (32 * _25) + ceil32(return_data.size) + 160 len floor32(mem[_61 + (32 * _25) + ceil32(return_data.size) + 128])]
    require 1 < mem[(32 * _25) + (2 * ceil32(return_data.size)) + 128]
    ...
    call address(cd[((32 * ('cd', 132).length - 1) + cd[132] + 36)]).transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args msg.sender, mem[(32 * _25) + (2 * ceil32(return_data.size)) + 192]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
