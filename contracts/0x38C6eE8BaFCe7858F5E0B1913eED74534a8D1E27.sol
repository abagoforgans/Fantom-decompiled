...
function deposit(uint256 arg1, uint256 arg2) payable {
    ...
    call 0x2069b76afe6b734fb65d1d099e7ec64ee9cc76b2.transferFrom(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) with:
         gas gas_remaining wei
        args 4128814, arg1, 4128814, arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    totalSupply += arg2
    require ext_code.size(0xa815372aa3a36f511b215f831ec370f7acddbd7c)
    staticcall 0xa815372aa3a36f511b215f831ec370f7acddbd7c.userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args 0, msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
