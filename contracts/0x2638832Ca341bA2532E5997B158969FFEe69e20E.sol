...
function sub_3aa99232(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if 0, ext_call.return_data[4 len 28] != mem[160]:
    ...
    if address(arg1) == ext_call.return_data[12 len 20]:
        if address(arg1) == ext_call.return_data[12 len 20]:
            call address(arg2).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args Mask(112, 0, ext_call.return_data[0]) / 100, 0, address(this.address), 128, 64, arg1, Mask(112, 0, ext_call.return_data[0]) / 100
        else:
            call address(arg2).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args 0, Mask(112, 0, ext_call.return_data[0]) / 100, address(this.address), 128, 64, arg1, Mask(112, 0, ext_call.return_data[0]) / 100
    else:
        if address(arg1) == ext_call.return_data[12 len 20]:
            call address(arg2).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args Mask(112, 0, ext_call.return_data[32]) / 100, 0, address(this.address), 128, 64, arg1, Mask(112, 0, ext_call.return_data[32]) / 100
        else:
            call address(arg2).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args 0, Mask(112, 0, ext_call.return_data[32]) / 100, address(this.address), 128, 64, arg1, Mask(112, 0, ext_call.return_data[32]) / 100
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
