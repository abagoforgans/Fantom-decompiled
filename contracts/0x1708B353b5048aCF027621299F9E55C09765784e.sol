...
function sub_23cb2390(?) payable {
    ...
    address(stor9[stor3]) = arg2
    require ext_code.size(rewardToken1Address)
    staticcall rewardToken1Address.allowance(address arg1, address arg2) with:
            gas gas_remaining wei
           args address(this.address), address(stor9[stor3])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor9[stor3]), uint32(stor9[stor3]), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    mem[352 len 4] = 0
    mem[324 len 0] = 0
    call rewardToken1Address with:
       funct uint32(stor9[stor3])
         gas gas_remaining wei
        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor9[stor3]), uint32(stor9[stor3]), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor9[stor3]), uint32(stor9[stor3]), -1
        if not approve(address arg1, uint256 arg2), Mask(224, 0, stor9[stor3]):
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor13), uint32(stor13), ext_call.return_data[0 len 28]
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * sub_d68e1302 / 10000)) >> 32
                mem[452 len 0] = 0
                call lpPairAddress with:
                   funct uint32(stor13)
                     gas gas_remaining wei
            ...
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1) >> 32
                mem[452 len 0] = 0
                call lpPairAddress with:
                   funct uint32(stor13)
                     gas gas_remaining wei
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1 - (arg1 * sub_d68e1302 / 10000)) >> 32
                mem[452 len 0] = 0
                call lpPairAddress with:
                   funct uint32(stor13)
                     gas gas_remaining wei
        ...
        call masterChefAddress.withdraw(uint256 arg1, uint256 arg2) with:
             gas gas_remaining wei
            args stor11, arg1 - ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(lpPairAddress)
        staticcall lpPairAddress.balanceOf(address arg1) with:
        ...
        if ext_call.return_data[0] <= arg1:
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor13), uint32(stor13), ext_call.return_data[0 len 28]
                mem[516 len 0] = 0
                call lpPairAddress with:
                   funct uint32(stor13)
                     gas gas_remaining wei
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * sub_d68e1302 / 10000)) >> 32
                mem[516 len 0] = 0
                call lpPairAddress with:
                   funct uint32(stor13)
                     gas gas_remaining wei
