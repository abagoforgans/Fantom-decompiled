...
function tendTrigger(uint256 arg1) payable {
    ...
    if not mem[(32 * _57 - 1) + ceil32(return_data.size) + 224]:
        ...
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        if 10^12 * mem[(32 * _57 - 1) + ceil32(return_data.size) + 224]:
            if 1000000000000 * 10^18 * mem[(32 * _57 - 1) + ceil32(return_data.size) + 224] / 10^12 * mem[(32 * _57 - 1) + ceil32(return_data.size) + 224] != 10^18:
                revert with 0, 'SafeMath: multiplication overflow'
        if not mem[_110]:
            revert with 0, 'SafeMath: division by zero', 0
    return 0
...
function ethToWant(uint256 arg1) payable {
    ...
    mem[64] = mem[64] + ceil32(return_data.size)
    require return_data.size >= 32
    if not 10^12 * mem[(32 * _57 - 1) + ceil32(return_data.size) + 224]:
        if not mem[_110]:
            revert with 0, 'SafeMath: division by zero', 0
        return (0 / mem[_110])
    if 1000000000000 * 10^18 * mem[(32 * _57 - 1) + ceil32(return_data.size) + 224] / 10^12 * mem[(32 * _57 - 1) + ceil32(return_data.size) + 224] != 10^18:
    ...
    if not mem[_110]:
        revert with 0, 'SafeMath: division by zero', 0
    return (1000000000000 * 10^18 * mem[(32 * _57 - 1) + ceil32(return_data.size) + 224] / mem[_110])
}
...
function harvestTrigger(uint256 arg1) payable {
    ...
    if not mem[(32 * _315 - 1) + ceil32(return_data.size) + 224]:
        ...
        require return_data.size >= 32
        _628 = mem[_626]
        if not 10^12 * mem[(32 * _315 - 1) + ceil32(return_data.size) + 224]:
            _631 = mem[64]
            mem[64] = mem[64] + 64
            mem[_631] = 26
            ...
            if 1000000000000 * 10^18 * mem[(32 * _315 - 1) + ceil32(return_data.size) + 224] / 10^12 * mem[(32 * _315 - 1) + ceil32(return_data.size) + 224] != 10^18:
                revert with 0, 'SafeMath: multiplication overflow'
            _635 = mem[64]
            mem[64] = mem[64] + 64
            mem[_635] = 26
