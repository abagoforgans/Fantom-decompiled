...
function Falcon() payable {
    return falconAddress
}
        ...
        if ext_call.return_data[0]:
            if poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    require ext_code.size(falconAddress)
                    call falconAddress.mint(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        require block.number - poolInfo[arg1].field_512
                        if (block.number * sub_edefc9df) - (poolInfo[arg1].field_512 * sub_edefc9df) / block.number - poolInfo[arg1].field_512 != sub_edefc9df:
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not (block.number * sub_edefc9df) - (poolInfo[arg1].field_512 * sub_edefc9df):
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            require ext_code.size(falconAddress)
                            ...
                            require (block.number * sub_edefc9df) - (poolInfo[arg1].field_512 * sub_edefc9df)
                            if (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / (block.number * sub_edefc9df) - (poolInfo[arg1].field_512 * sub_edefc9df) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            ...
                            call falconAddress.mint(address arg1, uint256 arg2) with:
                                 gas gas_remaining wei
                                args devaddr, (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint / 12
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(falconAddress)
                            call falconAddress.mint(address arg1, uint256 arg2) with:
                                 gas gas_remaining wei
                                args address(this.address), (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint:
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                ...
                                require (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint
                                if 10^12 * (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (10^12 * (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
        poolInfo[arg1].field_512 = block.number
}

function sub_79638cc2(?) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(poolInfo[arg1].field_0)
    staticcall poolInfo[arg1].field_0.0x70a08231 with:
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * sub_edefc9df * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_edefc9df * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
...
function updateEmissionRate(uint256 arg1) payable {
    ...
    while idx < poolInfo.length:
        ...
        if not block.number - poolInfo[idx].field_512:
            ...
            revert with memory
              from mem[64]
               len _267 + -mem[64] + 100
        require block.number - poolInfo[idx].field_512
        if (block.number * sub_edefc9df) - (poolInfo[idx].field_512 * sub_edefc9df) / block.number - poolInfo[idx].field_512 != sub_edefc9df:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (block.number * sub_edefc9df) - (poolInfo[idx].field_512 * sub_edefc9df):
            _190 = mem[64]
            mem[64] = mem[64] + 64
            mem[_190] = 26
            ...
            revert with memory
              from mem[64]
               len _283 + -mem[64] + 100
        require (block.number * sub_edefc9df) - (poolInfo[idx].field_512 * sub_edefc9df)
        if (block.number * sub_edefc9df * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_edefc9df * poolInfo[idx].field_256) / (block.number * sub_edefc9df) - (poolInfo[idx].field_512 * sub_edefc9df) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _197 = mem[64]
        mem[64] = mem[64] + 64
        mem[_197] = 26
        ...
        call falconAddress.mint(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args devaddr, (block.number * sub_edefc9df * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_edefc9df * poolInfo[idx].field_256) / totalAllocPoint / 12
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * sub_edefc9df * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_edefc9df * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(falconAddress)
        call falconAddress.mint(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args address(this.address), (block.number * sub_edefc9df * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_edefc9df * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * sub_edefc9df * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_edefc9df * poolInfo[idx].field_256) / totalAllocPoint:
            _262 = mem[64]
            mem[64] = mem[64] + 64
            mem[_262] = 26
            ...
            revert with memory
              from mem[64]
               len _280 + -mem[64] + 100
        require (block.number * sub_edefc9df * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_edefc9df * poolInfo[idx].field_256) / totalAllocPoint
        if 10^12 * (block.number * sub_edefc9df * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_edefc9df * poolInfo[idx].field_256) / totalAllocPoint / (block.number * sub_edefc9df * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_edefc9df * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _279 = mem[64]
        mem[64] = mem[64] + 64
        mem[_279] = 26
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^12 * (block.number * sub_edefc9df * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_edefc9df * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^12 * (block.number * sub_edefc9df * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_edefc9df * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _298 = mem[64]
    ...
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][address(msg.sender)].field_0:
            ...
            if -userInfo[arg1][address(msg.sender)].field_256 <= 0:
                ...
                require ext_code.size(falconAddress)
                staticcall falconAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if -userInfo[arg1][address(msg.sender)].field_256 <= ext_call.return_data[0]:
                    call falconAddress.transfer(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                    ...
                    require return_data.size >= 32
                    if not ext_call.return_data[0]:
                        revert with 0, 32, 35, 0x737361666546616c636f6e5472616e736665723a207472616e73666572206661696c65, mem[327 len 29]
                    if arg2 <= 0:
                        if not userInfo[arg1][address(msg.sender)].field_0:
                            userInfo[arg1][address(msg.sender)].field_256 = 0
                        else:
                    ...
                    if not 0 / totalAllocPoint:
                        ...
                        if not userInfo[arg1][address(msg.sender)].field_0:
                            ...
                            if -userInfo[arg1][address(msg.sender)].field_256 > 0:
                                ...
                                require return_data.size >= 32
                                if not ext_call.return_data[0]:
                                    revert with 0, 32, 35, 0x737361666546616c636f6e5472616e736665723a207472616e73666572206661696c65, mem[583 len 29]
                        else:
                            require userInfo[arg1][address(msg.sender)].field_0
                            if userInfo[arg1][address(msg.sender)].field_0 * poolInfo[arg1].field_768 / userInfo[arg1][address(msg.sender)].field_0 != poolInfo[arg1].field_768:
