...
function zapOut(address arg1, uint256 arg2, address arg3) {
    ...
    if not return_data.size:
        ...
        if ext_call.return_data[0]:
            ...
            mem[360] = -1
            mem[292] = 68
            mem[328 len 28] = address(arg3) << 64
            ...
            if ext_code.size(arg1) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            mem[548 len 4] = 0
            mem[520 len 0] = 0
            call arg1 with:
                 gas gas_remaining wei
                args Mask(480, -256, approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[520 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2
                if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
                            ...
                            if not return_data.size:
                                ...
                                if not ext_call.success:
                                    revert with 0, 
                                                ...
                                                35,
                                                0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                mem[(32 * _9921) + (4 * ceil32(return_data.size)) + 721 len 29]
                            ('bool', 'ext_call.success')
                        ...
                        if not return_data.size:
                            ...
                            if not ext_call.success:
                                revert with 0, 
                                            ...
                                            35,
                                            0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                            mem[(32 * _9923) + (4 * ceil32(return_data.size)) + 721 len 29]
                        ('bool', 'ext_call.success')
                    if address(ext_call.return_data[0]) == address(stor1.field_0):
                        call arg3.removeLiquidityETH(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
                             gas gas_remaining wei
                            ...
                            if not return_data.size:
                                ...
                                if not ext_call.success:
                                    revert with 0, 
                                                ...
                                                35,
                                                0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                mem[(32 * _9926) + (4 * ceil32(return_data.size)) + 721 len 29]
                            ('bool', 'ext_call.success')
        ...
        if return_data.size <= 0:
            ...
            if ext_call.return_data[0]:
                ...
                if address(ext_call.return_data[0]) == address(stor1.field_0):
                    ...
                    mem[(32 * _6633) + ceil32(return_data.size) + ceil32(return_data.size) + 485 len 0] = None
                    call msg.sender with:
                       value ext_call.return_data[32] wei
                         gas gas_remaining wei
                    if not return_data.size:
                ...
                if ext_call.return_data[12 len 20] == address(stor1.field_0):
                    ...
                    if address(ext_call.return_data[0]) != address(stor1.field_0):
                        ...
                        require mem[ceil32(return_data.size) + ceil32(return_data.size) + 389] - 1 < mem[ceil32(return_data.size) + ceil32(return_data.size) + 389]
                        mem[(32 * _6635) + ceil32(return_data.size) + ceil32(return_data.size) + 485 len 0] = None
                        call msg.sender with:
                           value ext_call.return_data[32] wei
                             gas gas_remaining wei
                        if not return_data.size:
                    ...
                    require mem[ceil32(return_data.size) + ceil32(return_data.size) + 389] - 1 < mem[ceil32(return_data.size) + ceil32(return_data.size) + 389]
                    mem[(32 * _6636) + ceil32(return_data.size) + ceil32(return_data.size) + 485 len 0] = None
                    call msg.sender with:
                       value ext_call.return_data[32] wei
                         gas gas_remaining wei
                    if not return_data.size:
                ...
                mem[ceil32(return_data.size) + 329 len 28] = address(arg3) << 64
                ...
                if ext_code.size(arg1) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 457 len 64] = approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[ceil32(return_data.size) + 549 len 4] = 0
                mem[ceil32(return_data.size) + 521 len 0] = 0
                call arg1 with:
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 521 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2
                    if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_call.success:
                                revert with 0, 
                                            ...
                                            35,
                                            0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                            mem[(32 * _9932) + (4 * ceil32(return_data.size)) + 721 len 29]
                        ('bool', 'ext_call.success')
                    if address(ext_call.return_data[0]) == address(stor1.field_0):
                        call arg3.removeLiquidityETH(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
                             gas gas_remaining wei
                            ...
                            if not return_data.size:
                                ...
                                if not ext_call.success:
                                    revert with 0, 
                                                ...
                                                35,
                                                0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                mem[(32 * _9934) + (4 * ceil32(return_data.size)) + 721 len 29]
                            ('bool', 'ext_call.success')
                                ...
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    ...
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9938) + (4 * ceil32(return_data.size)) + 721 len 29]
                                else:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    32,
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9938) + (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 722 len 29]
                            else:
                                ...
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    ...
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9939) + (4 * ceil32(return_data.size)) + 721 len 29]
                                else:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    32,
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9939) + (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 722 len 29]
                            ('bool', 'ext_call.success')
                        call arg3.removeLiquidity(address rg1, address rg2, uint256 rg3, uint256 rg4, uint256 rg5, address rg6, uint256 rg7) with:
                             gas gas_remaining wei
                            args address(ext_call.return_data[0]), address(ext_call.return_data[0]), arg2, 0, 0, address(this.address), block.timestamp
                            ...
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 
                                                ...
                                                35,
                                                0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                mem[(32 * _9940) + (4 * ceil32(return_data.size)) + 721 len 29]
                            else:
                                if not ext_call.success:
                                    revert with 0, 
                                                32,
                                                35,
                                                0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                mem[(32 * _9940) + (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 722 len 29]
                            ('bool', 'ext_call.success')
                        if address(ext_call.return_data[0]) == address(stor1.field_0):
                            call arg3.removeLiquidityETH(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
                                 gas gas_remaining wei
                                ...
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    ...
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9942) + (4 * ceil32(return_data.size)) + 721 len 29]
                                else:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    32,
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9942) + (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 722 len 29]
                                ('bool', 'ext_call.success')
            ...
            if ext_call.return_data[0]:
                ...
                if address(ext_call.return_data[0]) == address(stor1.field_0):
                    ...
                    require mem[ceil32(return_data.size) + ceil32(return_data.size) + 389] - 1 < mem[ceil32(return_data.size) + ceil32(return_data.size) + 389]
                    mem[(32 * _6637) + ceil32(return_data.size) + ceil32(return_data.size) + 485 len 0] = None
                    call msg.sender with:
                       value ext_call.return_data[32] wei
                         gas gas_remaining wei
                    if not return_data.size:
                ...
                if ext_call.return_data[12 len 20] == address(stor1.field_0):
                    ...
                    if address(ext_call.return_data[0]) != address(stor1.field_0):
                        ...
                        require mem[ceil32(return_data.size) + ceil32(return_data.size) + 389] - 1 < mem[ceil32(return_data.size) + ceil32(return_data.size) + 389]
                        mem[(32 * _6639) + ceil32(return_data.size) + ceil32(return_data.size) + 485 len 0] = None
                        call msg.sender with:
                           value ext_call.return_data[32] wei
                             gas gas_remaining wei
                        if not return_data.size:
                    ...
                    require mem[ceil32(return_data.size) + ceil32(return_data.size) + 389] - 1 < mem[ceil32(return_data.size) + ceil32(return_data.size) + 389]
                    mem[(32 * _6640) + ceil32(return_data.size) + ceil32(return_data.size) + 485 len 0] = None
                    call msg.sender with:
                       value ext_call.return_data[32] wei
                         gas gas_remaining wei
                    if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    if address(ext_call.return_data[0]) == address(stor1.field_0):
                        ...
                        require mem[ceil32(return_data.size) + ceil32(return_data.size) + 553] - 1 < mem[ceil32(return_data.size) + ceil32(return_data.size) + 553]
                        mem[(32 * _9949) + ceil32(return_data.size) + ceil32(return_data.size) + 649 len 0] = None
                        call msg.sender with:
                           value ext_call.return_data[32] wei
                             gas gas_remaining wei
                        if not return_data.size:
                    ...
                    if ext_call.return_data[12 len 20] == address(stor1.field_0):
                        ...
                        if address(ext_call.return_data[0]) != address(stor1.field_0):
                            ...
                            require mem[ceil32(return_data.size) + ceil32(return_data.size) + 553] - 1 < mem[ceil32(return_data.size) + ceil32(return_data.size) + 553]
                            mem[(32 * _9951) + ceil32(return_data.size) + ceil32(return_data.size) + 649 len 0] = None
                            call msg.sender with:
                               value ext_call.return_data[32] wei
                                 gas gas_remaining wei
                            if not return_data.size:
                        ...
                        require mem[ceil32(return_data.size) + ceil32(return_data.size) + 553] - 1 < mem[ceil32(return_data.size) + ceil32(return_data.size) + 553]
                        mem[(32 * _9952) + ceil32(return_data.size) + ceil32(return_data.size) + 649 len 0] = None
                        call msg.sender with:
                           value ext_call.return_data[32] wei
                             gas gas_remaining wei
                        if not return_data.size:
                    ...
                    if return_data.size <= 0:
                            ...
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 
                                                ...
                                                35,
                                                0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                mem[(32 * _9953) + (4 * ceil32(return_data.size)) + 721 len 29]
                            else:
                                if not ext_call.success:
                                    revert with 0, 
                                                32,
                                                35,
                                                0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                mem[(32 * _9953) + (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 722 len 29]
                            ('bool', 'ext_call.success')
                        if ext_call.return_data[12 len 20] == address(stor1.field_0):
                            call arg3.removeLiquidityETH(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
                                 gas gas_remaining wei
                                ...
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    ...
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9956) + (4 * ceil32(return_data.size)) + 721 len 29]
                                else:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    32,
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9956) + (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 722 len 29]
                            else:
                                mem[(2 * ceil32(return_data.size)) + 458] = 2
                                mem[(2 * ceil32(return_data.size)) + 490] = address(ext_call.return_data[0])
                                mem[(2 * ceil32(return_data.size)) + 522] = address(stor1.field_0)
                                ...
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    ...
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9955) + (4 * ceil32(return_data.size)) + 721 len 29]
                                else:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    32,
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9955) + (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 722 len 29]
                            ('bool', 'ext_call.success')
                        call arg3.removeLiquidity(address rg1, address rg2, uint256 rg3, uint256 rg4, uint256 rg5, address rg6, uint256 rg7) with:
                             gas gas_remaining wei
                        ...
                        if mem[(4 * ceil32(return_data.size)) + 554] - 1 < mem[(4 * ceil32(return_data.size)) + 554]:
                            ...
                            mem[64] = (32 * _9954) + (6 * ceil32(return_data.size)) + 682
                            require return_data.size >= 32
                            ...
                            mem[(32 * _9954) + (6 * ceil32(return_data.size)) + 682] = mem[mem[(32 * _9954) + (4 * ceil32(return_data.size)) + 682 len 4], ext_call.return_data[32 len 28] + (32 * _9954) + (4 * ceil32(return_data.size)) + 682]
                            if mem[(32 * _9954) + (6 * ceil32(return_data.size)) + 682] - 1 < mem[(32 * _9954) + (6 * ceil32(return_data.size)) + 682]:
                    else:
                        require return_data.size >= 32
                        if not mem[ceil32(return_data.size) + 489]:
                            revert with 0, 
                            ...
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 
                                                ...
                                                35,
                                                0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                mem[(32 * _9957) + (4 * ceil32(return_data.size)) + 721 len 29]
                            else:
                                if not ext_call.success:
                                    revert with 0, 
                                                32,
                                                35,
                                                0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                mem[(32 * _9957) + (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 722 len 29]
                            ('bool', 'ext_call.success')
                        if ext_call.return_data[12 len 20] == address(stor1.field_0):
                            call arg3.removeLiquidityETH(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
                                 gas gas_remaining wei
                                ...
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    ...
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9960) + (4 * ceil32(return_data.size)) + 721 len 29]
                                else:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    32,
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9960) + (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 722 len 29]
                            else:
                                mem[(2 * ceil32(return_data.size)) + 458] = 2
                                mem[(2 * ceil32(return_data.size)) + 490] = address(ext_call.return_data[0])
                                mem[(2 * ceil32(return_data.size)) + 522] = address(stor1.field_0)
                                ...
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    ...
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9959) + (4 * ceil32(return_data.size)) + 721 len 29]
                                else:
                                    if not ext_call.success:
                                        revert with 0, 
                                                    32,
                                                    35,
                                                    0x6c5472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                                    mem[(32 * _9959) + (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 722 len 29]
                            ('bool', 'ext_call.success')
                        call arg3.removeLiquidity(address rg1, address rg2, uint256 rg3, uint256 rg4, uint256 rg5, address rg6, uint256 rg7) with:
                             gas gas_remaining wei
                            args address(ext_call.return_data[0]), address(ext_call.return_data[0]), arg2, 0, 0, address(this.address), block.timestamp, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        ...
                        if mem[(4 * ceil32(return_data.size)) + 554] - 1 < mem[(4 * ceil32(return_data.size)) + 554]:
                            ...
                            mem[64] = (32 * _9958) + (6 * ceil32(return_data.size)) + 682
                            require return_data.size >= 32
                            ...
                            mem[(32 * _9958) + (6 * ceil32(return_data.size)) + 682] = mem[mem[(32 * _9958) + (4 * ceil32(return_data.size)) + 682 len 4], ext_call.return_data[32 len 28] + (32 * _9958) + (4 * ceil32(return_data.size)) + 682]
                            if mem[(32 * _9958) + (6 * ceil32(return_data.size)) + 682] - 1 < mem[(32 * _9958) + (6 * ceil32(return_data.size)) + 682]:
    revert
}
