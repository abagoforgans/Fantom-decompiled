    ...
    while idx < ('cd', 4).length:
        ...
        if mem[_35 + 12 len 20] == this.address:
            ...
            if not stor2[mem[(32 * idx) + 128]]:
                ...
                mem[0] = mem[(32 * idx) + 128]
                mem[32] = 2
                stor2[mem[(32 * idx) + 128]] = sub_4a2fc9e8.length
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_f3c5d087(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        if mem[_45 + 12 len 20] != this.address:
            ...
            mem[0] = mem[(32 * idx) + 128]
            mem[32] = 2
            if stor2[mem[(32 * idx) + 128]]:
                if stor2[mem[(32 * idx) + 128]] < 1:
                    revert with 'NH{q', 17
                if sub_4a2fc9e8.length < 1:
                    revert with 'NH{q', 17
                if sub_4a2fc9e8.length - 1 != stor2[mem[(32 * idx) + 128]] - 1:
                    if sub_4a2fc9e8.length - 1 >= sub_4a2fc9e8.length:
                        revert with 'NH{q', 50
                    if stor2[mem[(32 * idx) + 128]] - 1 >= sub_4a2fc9e8.length:
                        revert with 'NH{q', 50
                    sub_4a2fc9e8[stor2[mem[(32 * idx) + 128]]] = sub_4a2fc9e8[sub_4a2fc9e8.length]
                    stor2[stor1[stor1.length]] = stor2[mem[(32 * idx) + 128]]
