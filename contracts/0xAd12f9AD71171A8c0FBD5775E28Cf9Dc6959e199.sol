...
function sub_1577cf4a(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_1577cf4a.length
    return sub_1577cf4a[arg1]
}
...
function balanceOfPool() payable {
    ...
    staticcall poolAddress.depositedTokens(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(poolAddress)
    call poolAddress.deposit(uint256 arg1) with:
         gas gas_remaining wei
...
function withdraw(uint256 arg1) payable {
    ...
    require ext_code.size(poolAddress)
    call poolAddress.0x2e1a7d4d with:
         gas gas_remaining wei
            ...
            if return_data.size <= 0:
                ...
                if not return_data.size:
                    ...
                    if not stor27.length:
                        ...
                        call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args arg4, 0, 160, address(this.address), block.timestamp + 600, stor27.length, mem[(2 * ceil32(return_data.size)) + 686 len 32 * stor27.length]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
