...
function sub_8788d082(?) {
    ...
    if address(('cd', 4)[0]) >= address(('cd', 4)[1]):
        call address(('cd', 4)[3]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
             gas gas_remaining wei
            args 0, 0, 0, address(this.address), 128, ('cd', 4).length, call.data[cd[4] + 36 len ('cd', 4).length], mem[('cd', 4).length + 260 len ceil32(('cd', 4).length) - ('cd', 4).length]
    else:
        call address(('cd', 4)[3]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
             gas gas_remaining wei
            args 0, 0, ('cd', 4)[7] << 144, address(this.address), 128, ('cd', 4).length, call.data[cd[4] + 36 len ('cd', 4).length], mem[('cd', 4).length + 260 len ceil32(('cd', 4).length) - ('cd', 4).length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
    ...
    if address(cd[(arg4 + 164)]) == address(cd[(arg4 + 196)]):
        if address(cd[(arg4 + 68)]) >= address(cd[(arg4 + 36)]):
            call address(cd[(arg4 + 164)]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                 gas gas_remaining wei
                args cd[(arg4 + 292)] << 144, 0, address(this.address), 128, 0
        else:
            call address(cd[(arg4 + 164)]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                 gas gas_remaining wei
        ...
        if address(cd[(arg4 + 68)]) >= address(cd[(arg4 + 100)]):
            call address(cd[(arg4 + 164)]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                 gas gas_remaining wei
                args cd[(arg4 + 292)] << 144, 0, address(cd[(arg4 + 196)]), 128, 0, None
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            if address(cd[(arg4 + 100)]) >= address(cd[(arg4 + 36)]):
                call address(cd[(arg4 + 196)]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
                    args cd[(arg4 + 324)] << 144, 0, address(this.address), 128, 0
            else:
                call address(cd[(arg4 + 196)]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
            ...
            if address(cd[(arg4 + 100)]) >= address(cd[(arg4 + 36)]):
                call address(cd[(arg4 + 196)]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
                    args cd[(arg4 + 324)] << 144, 0, address(this.address), 128, 0, 0
            else:
                call address(cd[(arg4 + 196)]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
