...
function sub_2a90133c(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_2a90133c.length
    return sub_2a90133c[arg1]
}
...
function sub_476cdff4(?) payable {
    ...
    staticcall address(sub_d6d300bfAddress).0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function retireStrat() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(sub_d6d300bfAddress))
    call address(sub_d6d300bfAddress).0xa9059cbb with:
         gas gas_remaining wei
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(address(sub_d6d300bfAddress)) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * sub_d68e1302 / 10000)) >> 32
                mem[452 len 0] = 0
                call address(sub_d6d300bfAddress) with:
                   funct uint32(stor12)
                     gas gas_remaining wei
            ...
            if not arg1:
                ...
                if ext_code.size(address(sub_d6d300bfAddress)) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1) >> 32
                mem[452 len 0] = 0
                call address(sub_d6d300bfAddress) with:
                   funct uint32(stor12)
                     gas gas_remaining wei
                ...
                if ext_code.size(address(sub_d6d300bfAddress)) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1 - (arg1 * sub_d68e1302 / 10000)) >> 32
                mem[452 len 0] = 0
                call address(sub_d6d300bfAddress) with:
                   funct uint32(stor12)
                     gas gas_remaining wei
        ...
        if ext_call.return_data[0] > arg1:
            if not arg1:
                ...
                if ext_code.size(address(sub_d6d300bfAddress)) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1) >> 32
                mem[516 len 0] = 0
                call address(sub_d6d300bfAddress) with:
                   funct uint32(stor12)
                     gas gas_remaining wei
                ...
                if ext_code.size(address(sub_d6d300bfAddress)) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1 - (arg1 * sub_d68e1302 / 10000)) >> 32
                call address(sub_d6d300bfAddress) with:
                   funct uint32(stor12)
                     gas gas_remaining wei
            ...
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(address(sub_d6d300bfAddress)) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * sub_d68e1302 / 10000)) >> 32
                mem[516 len 0] = 0
                call address(sub_d6d300bfAddress) with:
                   funct uint32(stor12)
                     gas gas_remaining wei
...
function panic() payable {
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if ext_code.size(fUSDTAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = 0, address(sub_d6d300bfAddress), 0
            call fUSDTAddress with:
               funct uint32(stor4)
                 gas gas_remaining wei
                ...
                if not ext_call.return_data[0]:
                    ...
                    if return_data.size <= 0:
                        if not ext_call.return_data[0]:
                            ...
                            staticcall fUSDTAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                ...
                if not ext_call.return_data[0]:
                    ...
                    if return_data.size <= 0:
                        if not ext_call.return_data[0]:
                            if ext_code.size(wftmAddress) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 617 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), 0
                            mem[ceil32(return_data.size) + 681 len 0] = 0
                            call wftmAddress with:
                               funct uint32(stor11)
                                 gas gas_remaining wei
                                args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), 0) << 256, mem[ceil32(return_data.size) + 681 len 4]
                        else:
                            require ext_call.return_data[0]
                            if ext_call.return_data[0] * treasuryFee / ext_call.return_data[0] != treasuryFee:
                                revert with 0, 
                            ...
                            if ext_code.size(wftmAddress) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 617 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, ext_call.return_data[0] * treasuryFee / 10000) >> 32
                            mem[ceil32(return_data.size) + 681 len 0] = 0
                            call wftmAddress with:
                               funct uint32(stor11)
                                 gas gas_remaining wei
