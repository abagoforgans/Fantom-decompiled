...
uint256 poolId;
array of address sub_c4e2a5d9;
array of address sub_4527f0cd;
address sub_af26781cAddress;
address sub_1d072194Address;
address sub_d6230c26Address;

function FEE_BATCH() payable {
    return FEE_BATCH
}

function sub_1d072194(?) payable {
    return sub_1d072194Address
}
...
function sub_4527f0cd(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_4527f0cd.length
    return sub_4527f0cd[arg1]
}
...
function sub_af26781c(?) payable {
    return sub_af26781cAddress
}
...
function sub_c4e2a5d9(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_c4e2a5d9.length
    return sub_c4e2a5d9[arg1]
}

function sub_d6230c26(?) payable {
    return sub_d6230c26Address
}
...
function sub_fdba1c45(?) payable {
    return sub_fdba1c45Address
}
        ...
        if tx.origin == owner:
            ...
            if paused:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor4)
                         gas gas_remaining wei
        ...
        if tx.origin == owner:
            ...
            if paused:
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor4)
                         gas gas_remaining wei
