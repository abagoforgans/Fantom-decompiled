...
const test3 = eth.balance(msg.sender)


address owner;
address sub_593a48c1Address;
address wftmAddress;
address sub_0a4f20f8Address;
address sub_1711063bAddress;
address uniRouterAddress;

function sub_0a4f20f8(?) {
    return sub_0a4f20f8Address
}

function sub_1711063b(?) {
    return sub_1711063bAddress
}
...
function sub_3e801400(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == bool(arg1)
    require ext_code.size(wftmAddress)
    call wftmAddress.deposit() with:
       value msg.value wei
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function test2(bool arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(wftmAddress)
    call wftmAddress.deposit() with:
       value eth.balance(msg.sender) wei
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function sub_fc2137dd(?) payable {
    ...
    staticcall sub_593a48c1Address.0xdd62ed3e with:
            gas gas_remaining wei
           args this.address, sub_0a4f20f8Address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if not ext_call.return_data[0]:
        ...
        call sub_593a48c1Address.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args sub_0a4f20f8Address, -1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(sub_0a4f20f8Address)
    call sub_0a4f20f8Address.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
       value msg.value wei
         gas gas_remaining wei
...
function sub_35c9de7e(?) payable {
    ...
    call sub_0a4f20f8Address.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
       value msg.value wei
         gas gas_remaining wei
        args sub_593a48c1Address, ext_call.return_data[0], arg2, arg3, msg.sender, arg4
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
...
function sub_07cf5b86(?) payable {
    ...
    if msg.value < ext_call.return_data[32]:
        revert with 0, 17
    if msg.value - ext_call.return_data[32] > 0:
        if msg.value < ext_call.return_data[32]:
            revert with 0, 17
        call msg.sender with:
           value msg.value - ext_call.return_data[32] wei
...
function sub_3fa09639(?) payable {
    ...
    staticcall sub_593a48c1Address.0xdd62ed3e with:
            gas gas_remaining wei
           args this.address, sub_1711063bAddress
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if not ext_call.return_data[0]:
        ...
        call sub_593a48c1Address.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args sub_1711063bAddress, -1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(sub_1711063bAddress)
    call sub_1711063bAddress.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
       value msg.value wei
         gas gas_remaining wei
        args sub_593a48c1Address, arg1, arg2, arg3, msg.sender, arg4
    if not ext_call.success:
...
function sub_9e3cb7cb(?) {
    ...
    require return_data.size >= 32
    require ext_code.size(sub_1711063bAddress)
    call sub_1711063bAddress.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
         gas gas_remaining wei
        args sub_593a48c1Address, address(arg1), ext_call.return_data[0], arg3, arg4, arg5, msg.sender, arg6
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    if arg2 < ext_call.return_data[0]:
...
function sub_f158cbc0(?) payable {
    ...
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    mem[ceil32(return_data.size) + 100] = this.address
    mem[ceil32(return_data.size) + 132] = sub_0a4f20f8Address
    require ext_code.size(sub_593a48c1Address)
    staticcall sub_593a48c1Address.0xdd62ed3e with:
            gas gas_remaining wei
           args this.address, sub_0a4f20f8Address
    ...
    if ext_call.return_data[0]:
        ...
        mem[(2 * ceil32(return_data.size)) + 132] = sub_0a4f20f8Address
        require ext_code.size(wftmAddress)
        ...
        if ext_call.return_data[0]:
            ...
            mem[(7 * ceil32(return_data.size)) + 228] = arg2
            mem[(7 * ceil32(return_data.size)) + 260] = arg3
            mem[(7 * ceil32(return_data.size)) + 292] = msg.sender
            mem[(7 * ceil32(return_data.size)) + 324] = arg4
            require ext_code.size(sub_0a4f20f8Address)
            call sub_0a4f20f8Address.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args sub_593a48c1Address, wftmAddress, ext_call.return_data[0], ext_call.return_data[0], arg2, arg3, msg.sender, arg4
            ...
            if arg1 - ext_call.return_data[0] > 0:
                ...
                mem[(8 * ceil32(return_data.size)) + 164] = arg1 - ext_call.return_data[0]
                ...
                if eth.balance(this.address) < 0:
                    revert with 0, 'Address: insufficient balance for call'
                if not ext_code.size(sub_593a48c1Address):
                    revert with 0, 'Address: call to non-contract'
                mem[(8 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1 - ext_call.return_data[0], 0
                mem[(8 * ceil32(return_data.size)) + 328] = 0
                call sub_593a48c1Address with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, arg1 - ext_call.return_data[0], 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, arg1 - ext_call.return_data[0], 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
            ...
            mem[(4 * ceil32(return_data.size)) + 100] = sub_0a4f20f8Address
            ...
            mem[(8 * ceil32(return_data.size)) + 260] = arg3
            mem[(8 * ceil32(return_data.size)) + 292] = msg.sender
            mem[(8 * ceil32(return_data.size)) + 324] = arg4
            require ext_code.size(sub_0a4f20f8Address)
            call sub_0a4f20f8Address.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args sub_593a48c1Address, wftmAddress, ext_call.return_data[0], ext_call.return_data[0], arg2, arg3, msg.sender, arg4
            ...
            if arg1 - ext_call.return_data[0] > 0:
                ...
                mem[(10 * ceil32(return_data.size)) + 164] = arg1 - ext_call.return_data[0]
                ...
                if not ext_code.size(sub_593a48c1Address):
                    revert with 0, 'Address: call to non-contract'
                mem[(10 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1 - ext_call.return_data[0], 0
        ...
        mem[(2 * ceil32(return_data.size)) + 100] = sub_0a4f20f8Address
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(4 * ceil32(return_data.size)) + 100] = this.address
        mem[(4 * ceil32(return_data.size)) + 132] = sub_0a4f20f8Address
        require ext_code.size(wftmAddress)
        staticcall wftmAddress.0xdd62ed3e with:
                gas gas_remaining wei
               args this.address, sub_0a4f20f8Address
        ...
        if ext_call.return_data[0]:
            ...
            mem[(6 * ceil32(return_data.size)) + 100] = sub_0a4f20f8Address
            ...
            mem[(10 * ceil32(return_data.size)) + 228] = arg2
            mem[(10 * ceil32(return_data.size)) + 260] = arg3
            mem[(10 * ceil32(return_data.size)) + 292] = msg.sender
            mem[(10 * ceil32(return_data.size)) + 324] = arg4
            require ext_code.size(sub_0a4f20f8Address)
            call sub_0a4f20f8Address.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args sub_593a48c1Address, wftmAddress, ext_call.return_data[0], ext_call.return_data[0], arg2, arg3, msg.sender, arg4
            mem[(10 * ceil32(return_data.size)) + 96 len 96] = ext_call.return_data[0 len 96]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 96
            if arg1 < ext_call.return_data[0]:
            ...
            if arg1 - ext_call.return_data[0] > 0:
                ...
                mem[(11 * ceil32(return_data.size)) + 164] = arg1 - ext_call.return_data[0]
                ...
                if not ext_code.size(sub_593a48c1Address):
                    revert with 0, 'Address: call to non-contract'
                mem[(11 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1 - ext_call.return_data[0], 0
    ...
    if msg.value - ext_call.return_data[32] > 0:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        emit Test(msg.value - ext_call.return_data[32], ext_call.return_data[0]);
    return ext_call.return_data[0], ext_call.return_data[32], ext_call.return_data[64]
}

function sub_fbe2f9d7(?) {
    require calldata.size - 4 >= 192
    require arg1 == address(arg1)
    if not arg2:
        revert with 0, 'amounts can't be 0'
    ...
    if ext_call.return_data[0]:
        ...
        if ext_call.return_data[0]:
            ...
            mem[(7 * ceil32(return_data.size)) + 228] = arg4
            mem[(7 * ceil32(return_data.size)) + 260] = arg5
            mem[(7 * ceil32(return_data.size)) + 292] = msg.sender
            mem[(7 * ceil32(return_data.size)) + 324] = arg6
            require ext_code.size(sub_0a4f20f8Address)
            call sub_0a4f20f8Address.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args sub_593a48c1Address, wftmAddress, ext_call.return_data[0], arg3, arg4, arg5, msg.sender, arg6
            mem[(7 * ceil32(return_data.size)) + 96 len 96] = ext_call.return_data[0 len 96]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 96
            ...
            if arg2 - ext_call.return_data[0] <= 0:
                ...
                if arg3 - ext_call.return_data[32] > 0:
                    if arg3 < ext_call.return_data[32]:
                        revert with 0, 17
                    mem[(8 * ceil32(return_data.size)) + 132] = msg.sender
                    mem[(8 * ceil32(return_data.size)) + 164] = arg3 - ext_call.return_data[32]
                    mem[(8 * ceil32(return_data.size)) + 96] = 68
                    mem[(8 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(8 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                    mem[(8 * ceil32(return_data.size)) + 196] = 32
                    ...
                    if not ext_code.size(address(arg1)):
                        revert with 0, 'Address: call to non-contract'
                    mem[(8 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg3 - ext_call.return_data[32], 0
                    mem[(8 * ceil32(return_data.size)) + 328] = 0
                    call address(arg1) with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, arg3 - ext_call.return_data[32], 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, arg3 - ext_call.return_data[32], 0) << 288)
                    if not return_data.size:
                        if not ext_call.success:
                            if ext_call.return_data[0]:
                                revert with memory
                ...
                mem[(8 * ceil32(return_data.size)) + 132] = arg2 - ext_call.return_data[0]
                require ext_code.size(sub_593a48c1Address)
                call sub_593a48c1Address.0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, arg2 - ext_call.return_data[0]
                ...
                if arg3 - ext_call.return_data[32] > 0:
                    if arg3 < ext_call.return_data[32]:
                        revert with 0, 17
                    mem[(10 * ceil32(return_data.size)) + 132] = msg.sender
                    mem[(10 * ceil32(return_data.size)) + 164] = arg3 - ext_call.return_data[32]
                    mem[(10 * ceil32(return_data.size)) + 96] = 68
                    mem[(10 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(10 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                    mem[(10 * ceil32(return_data.size)) + 196] = 32
                    ...
                    if not ext_code.size(address(arg1)):
                        revert with 0, 'Address: call to non-contract'
                    mem[(10 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg3 - ext_call.return_data[32], 0
                    mem[(10 * ceil32(return_data.size)) + 328] = 0
                    call address(arg1) with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, arg3 - ext_call.return_data[32], 0) >> 224
                         gas gas_remaining wei
            ...
            mem[(8 * ceil32(return_data.size)) + 228] = arg4
            mem[(8 * ceil32(return_data.size)) + 260] = arg5
            mem[(8 * ceil32(return_data.size)) + 292] = msg.sender
            mem[(8 * ceil32(return_data.size)) + 324] = arg6
            require ext_code.size(sub_0a4f20f8Address)
            call sub_0a4f20f8Address.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args sub_593a48c1Address, wftmAddress, ext_call.return_data[0], arg3, arg4, arg5, msg.sender, arg6
            ...
            if arg2 - ext_call.return_data[0] <= 0:
                ...
                mem[(10 * ceil32(return_data.size)) + 132] = arg2 - ext_call.return_data[0]
                require ext_code.size(sub_593a48c1Address)
                call sub_593a48c1Address.0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, arg2 - ext_call.return_data[0]
                ...
                if arg3 - ext_call.return_data[32] > 0:
                    if arg3 < ext_call.return_data[32]:
                        revert with 0, 17
                    mem[(11 * ceil32(return_data.size)) + 132] = msg.sender
                    mem[(11 * ceil32(return_data.size)) + 164] = arg3 - ext_call.return_data[32]
                    mem[(11 * ceil32(return_data.size)) + 96] = 68
                    mem[(11 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(11 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                    mem[(11 * ceil32(return_data.size)) + 196] = 32
                    ...
                    if not ext_code.size(address(arg1)):
                        revert with 0, 'Address: call to non-contract'
                    mem[(11 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg3 - ext_call.return_data[32], 0
                    mem[(11 * ceil32(return_data.size)) + 328] = 0
                    call address(arg1) with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, arg3 - ext_call.return_data[32], 0) >> 224
                         gas gas_remaining wei
        ...
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        mem[(6 * ceil32(return_data.size)) + 100] = this.address
        mem[(6 * ceil32(return_data.size)) + 132] = sub_0a4f20f8Address
        require ext_code.size(address(arg1))
        staticcall address(arg1).0xdd62ed3e with:
                gas gas_remaining wei
               args this.address, sub_0a4f20f8Address
        ...
        if ext_call.return_data[0]:
            ...
            mem[(7 * ceil32(return_data.size)) + 100] = sub_0a4f20f8Address
            ...
            mem[(10 * ceil32(return_data.size)) + 228] = arg4
            mem[(10 * ceil32(return_data.size)) + 260] = arg5
            mem[(10 * ceil32(return_data.size)) + 292] = msg.sender
            mem[(10 * ceil32(return_data.size)) + 324] = arg6
            require ext_code.size(sub_0a4f20f8Address)
            call sub_0a4f20f8Address.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args sub_593a48c1Address, wftmAddress, ext_call.return_data[0], arg3, arg4, arg5, msg.sender, arg6
            ...
            if arg2 - ext_call.return_data[0] <= 0:
                ...
                mem[(11 * ceil32(return_data.size)) + 132] = arg2 - ext_call.return_data[0]
                require ext_code.size(sub_593a48c1Address)
                call sub_593a48c1Address.0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, arg2 - ext_call.return_data[0]
                ...
                if arg3 - ext_call.return_data[32] > 0:
                    ...
                    mem[(12 * ceil32(return_data.size)) + 164] = arg3 - ext_call.return_data[32]
                    ...
                    if not ext_code.size(address(arg1)):
                        revert with 0, 'Address: call to non-contract'
                    mem[(12 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg3 - ext_call.return_data[32], 0
...
function sub_b16f3c1b(?) payable {
    ...
    if ext_call.return_data[0]:
        ...
        if ext_call.return_data[0]:
            ...
            if arg1 - ext_call.return_data[0] <= 0:
                ...
                if msg.value - ext_call.return_data[32] > 0:
                    if msg.value < ext_call.return_data[32]:
                        revert with 0, 17
                    mem[(8 * ceil32(return_data.size)) + 132] = msg.sender
                    mem[(8 * ceil32(return_data.size)) + 164] = msg.value - ext_call.return_data[32]
                    mem[(8 * ceil32(return_data.size)) + 96] = 68
                    mem[(8 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(8 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                    mem[(8 * ceil32(return_data.size)) + 196] = 32
                    ...
                    if not ext_code.size(wftmAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(8 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, msg.value - ext_call.return_data[32], 0
                    mem[(8 * ceil32(return_data.size)) + 328] = 0
                    call wftmAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, msg.value - ext_call.return_data[32], 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, msg.value - ext_call.return_data[32], 0) << 288)
                    if not return_data.size:
                        if not ext_call.success:
                            if ext_call.return_data[0]:
                                revert with memory
            ...
            if not return_data.size:
                ...
                if msg.value < ext_call.return_data[32]:
                    revert with 0, 17
                mem[(8 * ceil32(return_data.size)) + 296] = msg.sender
                mem[(8 * ceil32(return_data.size)) + 328] = msg.value - ext_call.return_data[32]
                ...
                if not ext_code.size(wftmAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(8 * ceil32(return_data.size)) + 424 len 96] = 0, msg.sender, msg.value - ext_call.return_data[32], 0
                mem[(8 * ceil32(return_data.size)) + 492] = 0
                call wftmAddress with:
                   funct Mask(32, 224, 0, msg.sender, msg.value - ext_call.return_data[32], 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, 0, msg.sender, msg.value - ext_call.return_data[32], 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
                    ...
                    return ext_call.return_data[0], 
                           ...
                           mem[(10 * ceil32(return_data.size)) + 520 len 17 * ceil32(return_data.size)]
                ...
                return ext_call.return_data[0], 
                       ext_call.return_data[32],
                       ext_call.return_data[64],
                       mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 521 len 17 * ceil32(return_data.size)]
            ...
            if msg.value < ext_call.return_data[32]:
                revert with 0, 17
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = msg.sender
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = msg.value - ext_call.return_data[32]
            ...
            if not ext_code.size(wftmAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, msg.sender, msg.value - ext_call.return_data[32], 0
            ...
            return ext_call.return_data[0], 
                   ext_call.return_data[32],
                   ext_call.return_data[64],
                   mem[(13 * ceil32(return_data.size)) + 522 len (19 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        mem[(4 * ceil32(return_data.size)) + 100] = sub_0a4f20f8Address
        mem[(4 * ceil32(return_data.size)) + 132] = -1
        require ext_code.size(wftmAddress)
        call wftmAddress.approve(address arg1, uint256 arg2) with:
        ...
        if arg1 - ext_call.return_data[0] <= 0:
            ...
            if msg.value - ext_call.return_data[32] > 0:
                if msg.value < ext_call.return_data[32]:
                    revert with 0, 17
                mem[(10 * ceil32(return_data.size)) + 132] = msg.sender
                mem[(10 * ceil32(return_data.size)) + 164] = msg.value - ext_call.return_data[32]
                mem[(10 * ceil32(return_data.size)) + 96] = 68
                mem[(10 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
                mem[(10 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                mem[(10 * ceil32(return_data.size)) + 196] = 32
                ...
                if not ext_code.size(wftmAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(10 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, msg.value - ext_call.return_data[32], 0
                mem[(10 * ceil32(return_data.size)) + 328] = 0
                call wftmAddress with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, msg.value - ext_call.return_data[32], 0) >> 224
                     gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if msg.value - ext_call.return_data[32] > 0:
                if msg.value < ext_call.return_data[32]:
                    revert with 0, 17
                mem[(10 * ceil32(return_data.size)) + 296] = msg.sender
                mem[(10 * ceil32(return_data.size)) + 328] = msg.value - ext_call.return_data[32]
                mem[(10 * ceil32(return_data.size)) + 260] = 68
                mem[(10 * ceil32(return_data.size)) + 292 len 4] = unknown_0xa9059cbb(?????)
                ...
                if not ext_code.size(wftmAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(10 * ceil32(return_data.size)) + 424 len 96] = 0, msg.sender, msg.value - ext_call.return_data[32], 0
        ...
        if msg.value < ext_call.return_data[32]:
            revert with 0, 17
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = msg.sender
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = msg.value - ext_call.return_data[32]
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = 68
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 293 len 4] = unknown_0xa9059cbb(?????)
        ...
        if not ext_code.size(wftmAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, msg.sender, msg.value - ext_call.return_data[32], 0
        ...
        return ext_call.return_data[0], 
               ext_call.return_data[32],
               ext_call.return_data[64],
               mem[(14 * ceil32(return_data.size)) + 522 len (3 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
    mem[(2 * ceil32(return_data.size)) + 100] = sub_0a4f20f8Address
    mem[(2 * ceil32(return_data.size)) + 132] = -1
    require ext_code.size(sub_593a48c1Address)
    call sub_593a48c1Address.approve(address arg1, uint256 arg2) with:
    ...
    if arg1 - ext_call.return_data[0] <= 0:
        ...
        if msg.value - ext_call.return_data[32] > 0:
            if msg.value < ext_call.return_data[32]:
                revert with 0, 17
            mem[(11 * ceil32(return_data.size)) + 132] = msg.sender
            mem[(11 * ceil32(return_data.size)) + 164] = msg.value - ext_call.return_data[32]
            mem[(11 * ceil32(return_data.size)) + 96] = 68
            mem[(11 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
            mem[(11 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
            mem[(11 * ceil32(return_data.size)) + 196] = 32
            ...
            if not ext_code.size(wftmAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(11 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, msg.value - ext_call.return_data[32], 0
            mem[(11 * ceil32(return_data.size)) + 328] = 0
            call wftmAddress with:
               funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, msg.value - ext_call.return_data[32], 0) >> 224
                 gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if msg.value - ext_call.return_data[32] > 0:
            if msg.value < ext_call.return_data[32]:
                revert with 0, 17
            mem[(11 * ceil32(return_data.size)) + 296] = msg.sender
            mem[(11 * ceil32(return_data.size)) + 328] = msg.value - ext_call.return_data[32]
            ...
            if not ext_code.size(wftmAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(11 * ceil32(return_data.size)) + 424 len 96] = 0, msg.sender, msg.value - ext_call.return_data[32], 0
    ...
    if msg.value < ext_call.return_data[32]:
        revert with 0, 17
    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = msg.sender
    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = msg.value - ext_call.return_data[32]
    ...
    if not ext_code.size(wftmAddress):
        revert with 0, 'Address: call to non-contract'
    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, msg.sender, msg.value - ext_call.return_data[32], 0
    ...
    return ext_call.return_data[0], 
           ext_call.return_data[32],
           ext_call.return_data[64],
           mem[(15 * ceil32(return_data.size)) + 522 len (3 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
}
