...
const sub_3aa2a062(?) = 6 * 10^16

const Reward = 5 * 10^16
...
function sub_be774a71(?) {
    ...
    if ('cd', 4).length and stor1 > -1 / ('cd', 4).length:
        revert with 0, 17
    call stor2 with:
       value ('cd', 4).length * stor1 wei
...
function sub_42c0b3ee(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        if idx >= ('cd', 36).length:
            revert with 0, 50
        if cd[((32 * idx) + cd[36] + 36)] and 6 * 10^16 > -1 / cd[((32 * idx) + cd[36] + 36)]:
            revert with 0, 17
        if s > !(6 * 10^16 * cd[((32 * idx) + cd[36] + 36)]):
            revert with 0, 17
        if idx >= ('cd', 4).length:
            revert with 0, 50
        if idx >= ('cd', 36).length:
        ...
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        s = s + (6 * 10^16 * cd[((32 * idx) + cd[36] + 36)])
        continue 
