                ...
                if poolInfo[arg1].field_512 >= bonusEndBlock:
                    ...
                    if not bonusEndBlock - poolInfo[arg1].field_512:
                        ...
                        if not -poolInfo[arg1].field_512 + block.number:
                            ...
                            if (-1 * poolInfo[arg1].field_512 * sushiPerBlock) + (block.number * sushiPerBlock) / -poolInfo[arg1].field_512 + block.number != sushiPerBlock:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                            if not (-1 * poolInfo[arg1].field_512 * sushiPerBlock) + (block.number * sushiPerBlock):
                                if totalAllocPoint <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require totalAllocPoint
                                require ext_code.size(sushiAddress)
                                ...
                                require (-1 * poolInfo[arg1].field_512 * sushiPerBlock) + (block.number * sushiPerBlock)
                                if (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / (-1 * poolInfo[arg1].field_512 * sushiPerBlock) + (block.number * sushiPerBlock) != poolInfo[arg1].field_256:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                                if totalAllocPoint <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require totalAllocPoint
                                ...
                                call sushiAddress.mint(address rg1, uint256 rg2) with:
                                     gas gas_remaining wei
                                    args devaddr, (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(sushiAddress)
                                call sushiAddress.mint(address rg1, uint256 rg2) with:
                                     gas gas_remaining wei
                                    args address(this.address), (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                    if ext_call.return_data[0] <= 0:
                                        revert with 0, 'SafeMath: division by zero'
                                    require ext_call.return_data[0]
                                    if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    ...
                                    require (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                    if 10^12 * (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
                                    if ext_call.return_data[0] <= 0:
                                        revert with 0, 'SafeMath: division by zero'
                                    require ext_call.return_data[0]
                                    if poolInfo[arg1].field_768 + (10^12 * (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[arg1].field_768 += 10^12 * (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
...
function pendingSushi(uint256 arg1, address arg2) payable {
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (-1 * poolInfo[arg1].field_512 * sushiPerBlock * poolInfo[arg1].field_256) + (block.number * sushiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        if (-1 * poolInfo[idx].field_512 * sushiPerBlock) + (block.number * sushiPerBlock) / -poolInfo[idx].field_512 + block.number != sushiPerBlock:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (-1 * poolInfo[idx].field_512 * sushiPerBlock) + (block.number * sushiPerBlock):
            _659 = mem[64]
            mem[64] = mem[64] + 64
            mem[_659] = 26
            ...
            revert with memory
              from mem[64]
               len _967 + -mem[64] + 100
        require (-1 * poolInfo[idx].field_512 * sushiPerBlock) + (block.number * sushiPerBlock)
        if (-1 * poolInfo[idx].field_512 * sushiPerBlock * poolInfo[idx].field_256) + (block.number * sushiPerBlock * poolInfo[idx].field_256) / (-1 * poolInfo[idx].field_512 * sushiPerBlock) + (block.number * sushiPerBlock) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _676 = mem[64]
        mem[64] = mem[64] + 64
        mem[_676] = 26
        ...
        call sushiAddress.mint(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args devaddr, (-1 * poolInfo[idx].field_512 * sushiPerBlock * poolInfo[idx].field_256) + (block.number * sushiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (-1 * poolInfo[idx].field_512 * sushiPerBlock * poolInfo[idx].field_256) + (block.number * sushiPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(sushiAddress)
        call sushiAddress.mint(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args address(this.address), (-1 * poolInfo[idx].field_512 * sushiPerBlock * poolInfo[idx].field_256) + (block.number * sushiPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (-1 * poolInfo[idx].field_512 * sushiPerBlock * poolInfo[idx].field_256) + (block.number * sushiPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            _934 = mem[64]
            mem[64] = mem[64] + 64
            mem[_934] = 26
            ...
            revert with memory
              from mem[64]
               len _964 + -mem[64] + 100
        require (-1 * poolInfo[idx].field_512 * sushiPerBlock * poolInfo[idx].field_256) + (block.number * sushiPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if 10^12 * (-1 * poolInfo[idx].field_512 * sushiPerBlock * poolInfo[idx].field_256) + (block.number * sushiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (-1 * poolInfo[idx].field_512 * sushiPerBlock * poolInfo[idx].field_256) + (block.number * sushiPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _963 = mem[64]
        mem[64] = mem[64] + 64
        mem[_963] = 26
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^12 * (-1 * poolInfo[idx].field_512 * sushiPerBlock * poolInfo[idx].field_256) + (block.number * sushiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^12 * (-1 * poolInfo[idx].field_512 * sushiPerBlock * poolInfo[idx].field_256) + (block.number * sushiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _994 = mem[64]
    ...
    if block.number <= poolInfo[arg1].field_512:
        if userInfo[arg1][address(msg.sender)].field_0 <= 0:
            ...
            if not userInfo[arg1][address(msg.sender)].field_0:
                ...
                if -userInfo[arg1][address(msg.sender)].field_256 > 0:
                    require ext_code.size(sushiAddress)
                    staticcall sushiAddress.balanceOf(address rg1) with:
                            gas gas_remaining wei
                           args this.address
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    if -userInfo[arg1][address(msg.sender)].field_256 <= ext_call.return_data[0]:
                        call sushiAddress.transfer(address rg1, uint256 rg2) with:
                             gas gas_remaining wei
