...
function sub_e7beda8b(?) payable {
    ...
    if not msg.value:
        revert with 0, 'amounts can't be 0'
    require ext_code.size(sub_593a48c1Address)
    call sub_593a48c1Address.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
    ...
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(sub_593a48c1Address)
    staticcall sub_593a48c1Address.allowance(address arg1, address arg2) with:
            gas gas_remaining wei
    ...
    if arg1 - ext_call.return_data[0] > 0:
        if arg1 < ext_call.return_data[0]:
            revert with 0, 17
        require ext_code.size(sub_593a48c1Address)
        call sub_593a48c1Address.transfer(address arg1, uint256 arg2) with:
             gas gas_remaining wei
...
function rescueFund(address arg1, address arg2) {
    ...
    if ext_call.return_data[0] > 0:
        ...
        mem[(2 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, ext_call.return_data[0], 0
...
function sub_fbe2f9d7(?) {
    ...
    if not ext_call.return_data[0]:
        ...
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(sub_593a48c1Address)
    staticcall sub_593a48c1Address.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_f158cbc0(?) payable {
    ...
    if ext_call.return_data[0]:
        ...
        if ext_call.return_data[0]:
            ...
            mem[(6 * ceil32(return_data.size)) + 324] = arg4
            require ext_code.size(sub_0a4f20f8Address)
            call sub_0a4f20f8Address.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args sub_593a48c1Address, wftmAddress, ext_call.return_data[0], msg.value, arg2, arg3, msg.sender, arg4
            ...
            if arg1 - ext_call.return_data[0] > 0:
                ...
                if not ext_code.size(sub_593a48c1Address):
                    revert with 0, 'Address: call to non-contract'
                mem[(7 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1 - ext_call.return_data[0], 0
                mem[(7 * ceil32(return_data.size)) + 328] = 0
                call sub_593a48c1Address with:
                   funct Mask(32, 224, transfer(address arg1, uint256 arg2), msg.sender, arg1 - ext_call.return_data[0], 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, transfer(address arg1, uint256 arg2), msg.sender, arg1 - ext_call.return_data[0], 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
            ...
            mem[(7 * ceil32(return_data.size)) + 196] = msg.value
            ...
            if arg1 - ext_call.return_data[0] > 0:
                ...
                if not ext_code.size(sub_593a48c1Address):
                    revert with 0, 'Address: call to non-contract'
                mem[(8 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1 - ext_call.return_data[0], 0
        ...
        if ext_call.return_data[0]:
            ...
            if arg1 - ext_call.return_data[0] > 0:
                ...
                if not ext_code.size(sub_593a48c1Address):
                    revert with 0, 'Address: call to non-contract'
                mem[(10 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1 - ext_call.return_data[0], 0
...
function sub_b16f3c1b(?) payable {
    ...
    if ext_call.return_data[0]:
            ...
            if arg1 - ext_call.return_data[0] <= 0:
                ...
                if msg.value - ext_call.return_data[32] > 0:
                    ...
                    if not ext_code.size(wftmAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(8 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, msg.value - ext_call.return_data[32], 0
                    mem[(8 * ceil32(return_data.size)) + 328] = 0
                    call wftmAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), msg.sender, msg.value - ext_call.return_data[32], 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, transfer(address arg1, uint256 arg2), msg.sender, msg.value - ext_call.return_data[32], 0) << 288)
                    if not return_data.size:
                        if not ext_call.success:
                            if ext_call.return_data[0]:
                                revert with memory
        ...
        if arg1 - ext_call.return_data[0] <= 0:
            ...
            if msg.value - ext_call.return_data[32] > 0:
                ...
                if not ext_code.size(wftmAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(10 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, msg.value - ext_call.return_data[32], 0
                mem[(10 * ceil32(return_data.size)) + 328] = 0
                call wftmAddress with:
                   funct Mask(32, 224, transfer(address arg1, uint256 arg2), msg.sender, msg.value - ext_call.return_data[32], 0) >> 224
                     gas gas_remaining wei
    ...
    if arg1 - ext_call.return_data[0] <= 0:
        ...
        if msg.value - ext_call.return_data[32] > 0:
            ...
            mem[(11 * ceil32(return_data.size)) + 128 len 4] = transfer(address arg1, uint256 arg2)
            ...
            if not ext_code.size(wftmAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(11 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, msg.value - ext_call.return_data[32], 0
    ...
    if not ext_code.size(sub_593a48c1Address):
        revert with 0, 'Address: call to non-contract'
    mem[(11 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1 - ext_call.return_data[0], 0
    mem[(11 * ceil32(return_data.size)) + 328] = 0
    call sub_593a48c1Address with:
       funct Mask(32, 224, transfer(address arg1, uint256 arg2), msg.sender, arg1 - ext_call.return_data[0], 0) >> 224
         gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if msg.value - ext_call.return_data[32] > 0:
            ...
            mem[(11 * ceil32(return_data.size)) + 292 len 4] = transfer(address arg1, uint256 arg2)
    ...
    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 293 len 4] = transfer(address arg1, uint256 arg2)
