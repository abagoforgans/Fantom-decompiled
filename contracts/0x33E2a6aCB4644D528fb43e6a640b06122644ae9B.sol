    ...
    while idx < ('cd', 132).length:
        ...
        while s < cd[196]:
            ...
            while t < ('cd', 36).length:
                ...
                v = v + 32
                continue 
            mem[_20 + 100] = address(cd[((32 * idx) + cd[132] + 36)])
            mem[_20 + 132] = cd[164]
            require ext_code.size(address(cd[4]))
            call address(cd[4]).mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _20 + (32 * ('cd', 36).length) + -mem[64] + 192]
            if not ext_call.success:
            _29 = mem[64]
...
function sub_888fbb94(?) payable {
    ...
    while idx < cd[(cd[4] + ('cd', 4)[3] + 4)]:
        ...
        while s < ('cd', 4)[5]:
            ...
            mem[mem[64]] = 0x8803dbee00000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = cd[((32 * idx) + cd[4] + ('cd', 4)[1] + 36)]
            ...
            call address(('cd', 4).length).swapTokensForExactTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args cd[((32 * idx) + cd[4] + ('cd', 4)[1] + 36)], ('cd', 4)[2], Array(len=cd[(cd[4] + ('cd', 4)[0] + 4)], data=mem[mem[64] + 196 len 32 * cd[(cd[4] + ('cd', 4)[0] + 4)]]), address(cd[((32 * idx) + cd[4] + ('cd', 4)[3] + 36)]), ('cd', 4)[4]
            if not ext_call.success:
            _45 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = mem[64] + ceil32(return_data.size)
            ...
            idx = 0
            t = _45 + _47 + 32
            u = _45 + ceil32(return_data.size) + 32
            while idx < _48:
                require mem[t] == mem[t]
                mem[u] = mem[t]
                require cd[(cd[4] + ('cd', 4)[3] + 4)] <= test266151307()
...
function sub_92c8124e(?) payable {
    ...
    if sub_362b426d == 2:
        ...
        if not cd[(cd[4] + ('cd', 4)[0] + 4)]:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(4 * ceil32(return_data.size)) + (32 * cd[(cd[4] + ('cd', 4)[0] + 4)]) + 132] = this.address
            require ext_code.size(address(cd[(cd[4] + ('cd', 4)[0] + 36)]))
            staticcall address(cd[(cd[4] + ('cd', 4)[0] + 36)]).balanceOf(address arg1) with:
                    gas gas_remaining wei
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[64] = (6 * ceil32(return_data.size)) + (32 * cd[(cd[4] + ('cd', 4)[0] + 4)]) + 128
            require return_data.size >= 32
            require ext_call.return_data[0] == ext_call.return_data[0]
            if ext_call.return_data[0] < ext_call.return_data[0]:
                revert with 'NH{q', 17
            mem[(6 * ceil32(return_data.size)) + (32 * cd[(cd[4] + ('cd', 4)[0] + 4)]) + 128] = ext_call.return_data[0]
            mem[(6 * ceil32(return_data.size)) + (32 * cd[(cd[4] + ('cd', 4)[0] + 4)]) + 160] = 0
