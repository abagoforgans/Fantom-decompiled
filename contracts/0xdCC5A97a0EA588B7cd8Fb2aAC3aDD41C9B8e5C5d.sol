...
mapping of uint256 sub_3b43f81a;
address stor19;
address stor20;
address stor21;
address stor22;
...
function sub_3b43f81a(?) {
    require calldata.size - 4 >= 32
    return sub_3b43f81a[arg1]
}
...
function royaltyInfo(uint256 arg1, uint256 arg2) {
    ...
    if arg2 / 1000 and royaltyFee > -1 / arg2 / 1000:
        revert with 0, 17
    return stor17, arg2 / 1000 * royaltyFee
}
...
function sub_17bd17b7(?) {
    ...
    if cd[4] <= !('cd', 36).length:
        if var27002 >= cd[4] + ('cd', 36).length:
        if var29001 >= ('cd', 36).length:
            revert with 0, 50
        sub_3b43f81a[var29001] = cd[((32 * var29001) + cd[36] + 36)]
        s = var29001
        idx = var29001
        while idx != -1:
            if cd[4] > !('cd', 36).length:
                revert with 0, 17
            if idx + 1 >= cd[4] + ('cd', 36).length:
            if idx + 1 >= ('cd', 36).length:
                revert with 0, 50
            mem[0] = idx + 1
            mem[32] = 18
            sub_3b43f81a[idx + 1] = cd[((32 * idx + 2) + cd[36] + 36)]
            s = idx + 1
            idx = idx + 1
            continue 
    revert with 0, 17
...
function sub_98dab0d0(?) payable {
    require 1 == bool(enableMinter)
    if mintFee > 0x1999999999999999999999999999999999999999999999999999999999999999:
        revert with 0, 17
    require msg.value == 10 * mintFee
    if 11 > !tokenCounter:
        revert with 0, 17
    require tokenCounter + 11 < maxMint
    if 10 * mintFee / 10 > 0x5555555555555555555555555555555555555555555555555555555555555555:
        revert with 0, 17
    if 10 * mintFee < 3 * 10 * mintFee / 10:
        revert with 0, 17
    if (10 * mintFee) - (3 * 10 * mintFee / 10) < 10 * mintFee / 5:
        revert with 0, 17
    call stor21 with:
       value (10 * mintFee) - (3 * 10 * mintFee / 10) - (10 * mintFee / 5) wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    call stor20 with:
       value 3 * 10 * mintFee / 10 wei
         gas 2300 * is_zero(value) wei
    call stor22 with:
       value 10 * mintFee / 5 wei
         gas 2300 * is_zero(value) wei
    # nil
}
