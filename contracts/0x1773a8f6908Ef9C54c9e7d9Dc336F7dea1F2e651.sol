...
address owner;
mapping of uint256 pendingReward;
mapping of uint8 stor7;
array of address holders;
uint256 minAmount;

function sub_05f35365(?) payable {
...
function pendingReward(address arg1, address arg2) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    return pendingReward[address(arg1)][address(arg2)]
}
...
function rewards(address arg1, address arg2) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    return pendingReward[arg1][arg2]
}
...
function distributeReward(address arg1, uint256 arg2) payable {
    ...
    while idx < holders.length:
        mem[0] = holders[idx]
        mem[32] = 0
        if balanceOf[stor8[idx]] >= minAmount:
            if arg2 and balanceOf[stor8[idx]] > -1 / arg2:
                revert with 'NH{q', 17
            if not totalSupply:
                revert with 'NH{q', 18
            if idx >= holders.length:
                revert with 'NH{q', 50
            mem[0] = arg1
            mem[32] = sha3(holders[idx], 6)
            if pendingReward[stor8[idx]][address(arg1)] > -(arg2 * balanceOf[stor8[idx]] / totalSupply) - 1:
                revert with 'NH{q', 17
            pendingReward[stor8[idx]][address(arg1)] += arg2 * balanceOf[stor8[idx]] / totalSupply
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
    emit DistributeReward(msg.sender, address(arg1), arg2);
}
