...
array of address sub_cbab22b2;
array of address sub_28e84a4b;
...
function sub_28e84a4b(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_28e84a4b.length
    return sub_28e84a4b[arg1]
}
...
function musd() payable {
    return musdAddress
}

function sub_cbab22b2(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_cbab22b2.length
    return sub_cbab22b2[arg1]
}
