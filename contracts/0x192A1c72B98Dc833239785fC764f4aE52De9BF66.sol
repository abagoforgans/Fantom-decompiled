...
const pairCodeHash = sha3(code.data[3463 len 14814])

const INIT_CODE_PAIR_HASH = sha3(code.data[3463 len 14784], mem[29760 len 2], Mask(224, 16, code.data[18249 len 28]) >> 16)
