...
function nonce(address arg1) payable {
    ...
    staticcall stor2.0x70ae92d2 with:
...
function withdraw(uint256 arg1, uint256 arg2) payable {
    ...
    staticcall sub_ac0e3952[arg1].field_768.totalSupply() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function gems(uint256 arg1) payable {
    ...
    if ceil32(_5) <= _5:
        ...
        if ceil32(_91) <= _91:
            ...
            mem[mem[64] + 64] = _171
            mem[mem[64] + 96] = _172
            return Array(len=_5, data=mem[mem[64] + 320 len ceil32(_91) + ceil32(_5) + 32]), 
                   ceil32(_5) + 320,
                   _171,
                   _172,
                   _173,
    ...
    if ceil32(_92) <= _92:
        ...
        mem[mem[64] + 64] = _176
        mem[mem[64] + 96] = _177
        return Array(len=_5, data=mem[mem[64] + 320 len ceil32(_92) + ceil32(_5) + 32]), 
               ceil32(_5) + 320,
               _176,
               _177,
               _178,
    ...
    if ceil32(_13) <= _13:
        ...
        if ceil32(_119) <= _119:
            ...
            if ext_call.return_data[0] >= -1 / mem[ceil32(return_data.size) + 192]:
                ...
                call stor2.safeTransferFrom(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) with:
                     gas gas_remaining wei
                    args address(this.address), sub_ac0e3952[arg1].field_512, arg1, mem[_267], 160, 0
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            if ext_call.return_data[0] >= -1 / mem[ceil32(return_data.size) + 192]:
                ...
                call stor2.safeTransferFrom(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) with:
                     gas gas_remaining wei
                    args address(this.address), sub_ac0e3952[arg1].field_512, arg1, mem[_269], 160, 0
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if 0 > !sub_ac0e3952[arg1].field_1024:
                    revert with 0, 17
        ...
        if ceil32(_120) <= _120:
            ...
            if ext_call.return_data[0] >= -1 / mem[ceil32(return_data.size) + 192]:
                ...
                call stor2.safeTransferFrom(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) with:
                     gas gas_remaining wei
                    args address(this.address), sub_ac0e3952[arg1].field_512, arg1, mem[_268], 160, 0
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if 0 > !sub_ac0e3952[arg1].field_1024:
                    revert with 0, 17
            ...
            if ext_call.return_data[0] >= -1 / mem[ceil32(return_data.size) + 192]:
                ...
                call stor2.safeTransferFrom(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) with:
                     gas gas_remaining wei
                    args address(this.address), sub_ac0e3952[arg1].field_512, arg1, mem[_270], 160, 0
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if 0 > !sub_ac0e3952[arg1].field_1024:
                    revert with 0, 17
