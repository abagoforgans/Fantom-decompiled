            ...
            if var33001 < uint256(sub_d6ca6c4c[arg1].field_0):
                ...
                while idx < uint256(sub_d6ca6c4c[arg1].field_0):
                    ...
                    if var49002 <= var49001:
                        ...
                        if 750 * 10^18 >= uint256(bets[arg1].field_1280):
                            if uint256(bets[arg1].field_1280) > 0x2aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa:
                                revert with 0, 17
                            uint256(bets[arg1].field_256) = 6 * uint256(bets[arg1].field_1280) / 100
                            ...
                            if uint256(bets[arg1].field_1280) > 0x3fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
                                revert with 0, 17
                            uint256(bets[arg1].field_256) = 4 * uint256(bets[arg1].field_1280) / 100
                            if uint256(bets[arg1].field_1280) < uint256(bets[arg1].field_256):
                                revert with 0, 17
                            uint256(bets[arg1].field_1280) -= uint256(bets[arg1].field_256)
                            if not uint256(bets[arg1].field_1024):
