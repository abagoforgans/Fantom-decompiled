...
function sub_65d4d5bf(?) payable {
    require calldata.size - 4 >= 32
    totalSupply = 25 * 10^6
    impact[0x7877ece589ef760f411f6c7655fe5a9786a580c4] = 10^6
    idx = 0
    while idx < 15000:
        require totalSupply
        mem[0] = 0x7877ece589ef760f411f6c7655fe5a9786a580c4
        mem[32] = 5
        pendingAmount[0x7877ece589ef760f411f6c7655fe5a9786a580c4] += arg1 * impact[0x7877ece589ef760f411f6c7655fe5a9786a580c4] / totalSupply
        idx = idx + 1
        continue 
}
