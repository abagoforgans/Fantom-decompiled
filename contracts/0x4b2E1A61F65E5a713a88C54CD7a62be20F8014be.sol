...
function sub_ad870b35(?) {
    ...
    if 1000 > sub_ef5b0e6e.length:
        ...
        stor12[arg1] = sub_ef5b0e6e.length
    else:
        if not arg3:
            return 0
        stor12[arg1] = stor12[arg2]
        stor12[arg2] = 0
        if stor12[arg1] < 1:
            revert with 0, 17
        if stor12[arg1] - 1 >= sub_ef5b0e6e.length:
            revert with 0, 50
        sub_ef5b0e6e[stor12[arg1]] = arg1
    return 1
}
...
function sub_42085e38(?) {
    ...
    staticcall 0x7426dbe5207c2b5dac57d8e55f0959fcd99661d4.dn(uint256 arg1, uint256 arg2) with:
            gas gas_remaining wei
           args arg1, sub_ef5b0e6e.length
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] >= sub_ef5b0e6e.length:
        revert with 0, 50
    return sub_ef5b0e6e[ext_call.return_data[0]]
}

function sub_dae513ad(?) {
    require calldata.size - 4 >= 64
    require arg1 == uint32(arg1)
    if uint32(arg1) > 0x28f5c28f5c28f5c28f5c28f5c28f5c28f5c28f5c28f5c28f5c28f5c28f5c28f:
        revert with 0, 17
    if 100 * uint32(arg1) > !arg2:
        revert with 0, 17
    require ext_code.size(0x7426dbe5207c2b5dac57d8e55f0959fcd99661d4)
    staticcall 0x7426dbe5207c2b5dac57d8e55f0959fcd99661d4.dn(uint256 arg1, uint256 arg2) with:
            gas gas_remaining wei
           args (100 * uint32(arg1)) + arg2, 100
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return (ext_call.return_data[28 len 4] < uint32(arg1))
}
    ...
    if not arg2:
        ...
        if 20 == sub_274ff91a[arg1].field_768 + 1:
            ...
            if bonusPool > bet:
                if bet > !stor13:
                    revert with 0, 17
                if sub_b298b771[msg.sender] > !(bet + stor13):
                    revert with 0, 17
                sub_b298b771[msg.sender] = sub_b298b771[msg.sender] + bet + stor13
                if bonusPool < stor13:
                    revert with 0, 17
                bonusPool -= stor13
            else:
