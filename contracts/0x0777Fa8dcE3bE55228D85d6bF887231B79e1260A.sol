...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    mem[ceil32(return_data.size) + 128] = DAIAddress
    ...
    call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3, 0, 160, address(this.address), block.timestamp + 100, 2, mem[ceil32(return_data.size) + 388 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(return_data.size) + 192 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (2 * ceil32(return_data.size)) + 192
    require return_data.size >= 32
    _42 = mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32
    ...
    _43 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 + 192]
    ...
    mem[(2 * ceil32(return_data.size)) + 224 len 32 * _43] = mem[ceil32(return_data.size) + _42 + 224 len 32 * _43]
    if arg3 > !arg4:
        revert with 0, 17
    ...
    mem[64] = mem[64] + ceil32(return_data.size)
    require return_data.size >= 32
    emit 0x874f886a: address(arg1), address(arg2), mem[_87]
}
