...
function panic() payable {
    ...
    mem[_416 + floor32(mem[_417]) + -(mem[_417] % 32) + 196 len mem[_417] % 32] = mem[_417 + floor32(mem[_417]) + -(mem[_417] % 32) + 64 len mem[_417] % 32]
    call tokenAddress with:
         gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if ext_code.size(0xe0654c8e6fd4d733349ac7e09f6f23da256bf475) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[_416 + 328 len 64] = 0, address(uniRouterAddress), 0
        mem[_416 + 420 len 4] = 0
        call 0xe0654c8e6fd4d733349ac7e09f6f23da256bf475 with:
           funct uint32(stor4)
             gas gas_remaining wei
            args 0, 0, mem[_416 + 392 len 4]
        if not return_data.size:
            if not ext_call.success:
                if mem[96] > 0:
                    revert with memory
        ...
        if return_data.size <= 0:
            ...
            if ext_code.size(0xe0654c8e6fd4d733349ac7e09f6f23da256bf475) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[_416 + ceil32(return_data.size) + 329 len 64] = 0, address(uniRouterAddress), 0
            mem[_416 + ceil32(return_data.size) + 421 len 4] = 0
            call 0xe0654c8e6fd4d733349ac7e09f6f23da256bf475 with:
               funct uint32(stor4)
                 gas gas_remaining wei
                args 0, 0, mem[_416 + ceil32(return_data.size) + 393 len 4]
            if not return_data.size:
                if not ext_call.success:
                    if mem[96] > 0:
                        revert with memory
                ...
                if return_data.size > 0:
                    ...
                    if not mem[_416 + ceil32(return_data.size) + 361]:
                        revert with 0, 
                                    ...
                                    42,
                                    0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                    mem[_416 + (2 * ceil32(return_data.size)) + 440 len 22]
        else:
            require return_data.size >= 32
            if not mem[_416 + 196]:
                revert with 0, 
            ...
            if not return_data.size:
                ...
                if not ext_call.success:
                    ...
                    revert with 0, 
                                'SafeERC20: low-level call failed',
                                mem[_416 + (2 * ceil32(return_data.size)) + 430 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                if return_data.size > 0:
                    require return_data.size >= 32
                    if not mem[_416 + ceil32(return_data.size) + 361]:
                        revert with 0, 
        ...
        if return_data.size <= 0:
            ...
            if not return_data.size:
                ...
                if return_data.size <= 0:
                    ...
                    mem[(2 * ceil32(return_data.size)) + 426] = 68
    ...
    if ext_call.return_data[0] - reserves >= arg1:
        if ext_call.return_data[0] - reserves > arg1:
            if tx.origin == owner:
                ...
                if paused:
                    ...
                    if not arg1:
                        ...
                        if ext_code.size(tokenAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1) >> 32
                        mem[544 len 4] = 0
                        mem[516 len 0] = 0
                        call tokenAddress with:
                           funct uint32(stor13)
                        ...
                        if ext_code.size(tokenAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1 - (arg1 * sub_d68e1302 / 10000)) >> 32
                        mem[544 len 4] = 0
                        call tokenAddress with:
                           funct uint32(stor13)
                             gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if ext_code.size(tokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - reserves) >> 32
                mem[416 len 4] = 0
                mem[388 len 0] = 0
                call tokenAddress with:
                   funct uint32(stor13)
                ...
                if paused:
                    ...
                    if not ext_call.return_data[0] - reserves:
                        ...
                        if ext_code.size(tokenAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - reserves) >> 32
                        mem[544 len 4] = 0
                        mem[516 len 0] = 0
                        call tokenAddress with:
                           funct uint32(stor13)
                        ...
                        if ext_code.size(tokenAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - reserves - ((ext_call.return_data[0] * sub_d68e1302) - (reserves * sub_d68e1302) / 10000)) >> 32
                        mem[544 len 4] = 0
                        mem[516 len 0] = 0
                        call tokenAddress with:
                           funct uint32(stor13)
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                mem[_4727 + floor32(mem[_4728]) + -(mem[_4728] % 32) + 196 len mem[_4728] % 32] = mem[_4728 + floor32(mem[_4728]) + -(mem[_4728] % 32) + 64 len mem[_4728] % 32]
                call tokenAddress with:
                     gas gas_remaining wei
                ...
                if paused:
                    ...
                    mem[_4879 + floor32(mem[_4880]) + -(mem[_4880] % 32) + 196 len mem[_4880] % 32] = mem[_4880 + floor32(mem[_4880]) + -(mem[_4880] % 32) + 64 len mem[_4880] % 32]
                    call tokenAddress with:
                         gas gas_remaining wei
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        mem[_5613 + floor32(mem[_5614]) + -(mem[_5614] % 32) + 196 len mem[_5614] % 32] = mem[_5614 + floor32(mem[_5614]) + -(mem[_5614] % 32) + 64 len mem[_5614] % 32]
                        call tokenAddress with:
                             gas gas_remaining wei
                        ...
                        mem[_5654 + floor32(mem[_5655]) + -(mem[_5655] % 32) + 196 len mem[_5655] % 32] = mem[_5655 + floor32(mem[_5655]) + -(mem[_5655] % 32) + 64 len mem[_5655] % 32]
                        call tokenAddress with:
                             gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                mem[_4827 + floor32(mem[_4828]) + -(mem[_4828] % 32) + 196 len mem[_4828] % 32] = mem[_4828 + floor32(mem[_4828]) + -(mem[_4828] % 32) + 64 len mem[_4828] % 32]
                call tokenAddress with:
                     gas gas_remaining wei
                ...
                if paused:
                    ...
                    mem[_4995 + floor32(mem[_4996]) + -(mem[_4996] % 32) + 196 len mem[_4996] % 32] = mem[_4996 + floor32(mem[_4996]) + -(mem[_4996] % 32) + 64 len mem[_4996] % 32]
                    call tokenAddress with:
                         gas gas_remaining wei
                    ...
                    if not arg1:
                        ...
                        mem[_5672 + floor32(mem[_5673]) + -(mem[_5673] % 32) + 196 len mem[_5673] % 32] = mem[_5673 + floor32(mem[_5673]) + -(mem[_5673] % 32) + 64 len mem[_5673] % 32]
                        call tokenAddress with:
                             gas gas_remaining wei
