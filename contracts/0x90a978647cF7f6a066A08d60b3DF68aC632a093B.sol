...
function sub_103d9908(?) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(stor[mem[arg1.length + 160 len ceil32(arg1.length)]][Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0)])
    staticcall stor[mem[arg1.length + 160 len ceil32(arg1.length)]][Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0)].quote(uint256 arg1, uint256 arg2, uint256 arg3) with:
            gas gas_remaining wei
           args arg4, ext_call.return_data[32] << 144, Mask(112, 0, ext_call.return_data[0])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return 0, 
           Mask(80, 0, ext_call.return_data[0]) << 144,
