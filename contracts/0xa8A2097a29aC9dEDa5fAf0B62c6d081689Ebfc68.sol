...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if not mem[_271]:
        revert with 0, 'no success on approving :('
    require 1 < mem[ceil32(return_data.size) + 96]
    _275 = mem[ceil32(return_data.size) + 160]
    require 1 < mem[ceil32(return_data.size) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 160]
    require 1 < _211
    _279 = mem[(6 * ceil32(return_data.size)) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 100)] + 36)]) + 256]
    mem[mem[64] + 4] = mem[ceil32(return_data.size) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 236 len 20]
    mem[mem[64] + 36] = _279
    require ext_code.size(address(_275))
    call address(_275).approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args mem[mem[64] + 4], _279
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _283 = mem[64]
    ...
    if not mem[_283]:
        revert with 0, 'no success on approving :('
    require 1 < mem[ceil32(return_data.size) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 160]
    _287 = mem[ceil32(return_data.size) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 224]
    require 1 < _211
    _289 = mem[(6 * ceil32(return_data.size)) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 100)] + 36)]) + 256]
    mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[mem[64] + 4] = _289
    mem[mem[64] + 36] = arg3 - 100
    mem[mem[64] + 68] = 160
    _292 = mem[ceil32(return_data.size) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + 128]
    ...
    call address(_287).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args _289, arg3 - 100, 160, address(this.address), block.timestamp + 900, mem[mem[64] + 164 len (32 * _292) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _320 = mem[64]
    ...
    require _321 + (32 * _322) + 32 <= return_data.size
    idx = 0
    s = _320 + _321 + 32
    t = _320 + ceil32(return_data.size) + 32
    while idx < _322:
        require mem[s] == mem[s]
        mem[t] = mem[s]
        idx = idx + 1
    ...
    _350 = mem[ceil32(return_data.size) + 128]
    if owner != msg.sender:
        revert with 0, 'not owner'
