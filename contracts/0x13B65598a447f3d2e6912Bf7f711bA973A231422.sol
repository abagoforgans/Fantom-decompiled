...
const name = 'YTCoinBETA'

const decimals = 18

const symbol = 'YTCoinBETA'
...
function sub_cd5346ca(?) payable {
    return bool(sub_cd5346ca)
}
...
function setInitializationPeriod(bool arg1) payable {
    require calldata.size - 4 >= 32
    require msg.sender == stor5
    sub_cd5346ca = uint8(arg1)
}
