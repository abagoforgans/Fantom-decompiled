...
const name = 'sbotunsafe3'

const decimals = 18

const symbol = 'sbotunsafe3'
...
function transfer(address arg1, uint256 arg2) {
    ...
    if not arg2:
        ...
        require 1 < mem[ceil32(return_data.size) + 192]
        _173 = mem[ceil32(return_data.size) + 256]
        if not mem[ceil32(return_data.size) + 256]:
            if slippage <= 0:
                revert with 0, ':divErr'
            require slippage
            mem[(32 * _109) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
            emit Log(mem[(32 * _109) + ceil32(return_data.size) + 224], 0 / slippage);
        else:
            if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                revert with 0, 
                            ...
                            mem[(32 * _109) + ceil32(return_data.size) + 325 len 31]
            if slippage <= 0:
                revert with 0, ':divErr'
            require slippage
            mem[(32 * _109) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
            emit Log(mem[(32 * _109) + ceil32(return_data.size) + 224], 100 * _173 / slippage);
        require arg2 <= balanceOf[msg.sender]
        ...
        mem[64] = ceil32(return_data.size) + 192
        require return_data.size >= 32
        _102 = mem[192 len 4], Mask(224, 32, 25 * arg2 / 100) >> 32
        ...
        require 1 < mem[ceil32(return_data.size) + 192]
        _172 = mem[ceil32(return_data.size) + 256]
        if not mem[ceil32(return_data.size) + 256]:
            if slippage <= 0:
                revert with 0, ':divErr'
            require slippage
            mem[(32 * _108) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
            emit Log(mem[(32 * _108) + ceil32(return_data.size) + 224], 0 / slippage);
        else:
            if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                revert with 0, 
                            32,
                            33,
                            0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            mem[(32 * _108) + ceil32(return_data.size) + 325 len 31]
            if slippage <= 0:
                revert with 0, ':divErr'
            require slippage
            mem[(32 * _108) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
            emit Log(mem[(32 * _108) + ceil32(return_data.size) + 224], 100 * _172 / slippage);
    ...
    if not arg3:
        ...
        if arg1 != this.address:
            ...
            if arg1 != ext_call.return_data[12 len 20]:
                ...
                mem[64] = ceil32(return_data.size) + 192
                require return_data.size >= 32
                _178 = mem[192 len 4], 0
                require mem[192 len 4], 0 <= 4294967296
                require mem[192 len 4], 0 + 32 <= return_data.size
                require mem[mem[192 len 4], 0 + 192] <= 4294967296 and mem[192 len 4], 0 + (32 * mem[mem[192 len 4], 0 + 192]) + 32 <= return_data.size
                mem[ceil32(return_data.size) + 192] = mem[mem[192 len 4], 0 + 192]
                _183 = mem[_178 + 192]
                mem[ceil32(return_data.size) + 224 len floor32(mem[_178 + 192])] = mem[_178 + 224 len floor32(mem[_178 + 192])]
                require 1 < mem[ceil32(return_data.size) + 192]
                _263 = mem[ceil32(return_data.size) + 256]
                if not mem[ceil32(return_data.size) + 256]:
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    mem[(32 * _183) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                    emit Log(mem[(32 * _183) + ceil32(return_data.size) + 224], 0 / slippage);
                else:
                    if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                        revert with 0, 
                                    32,
                                    33,
                                    0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(32 * _183) + ceil32(return_data.size) + 325 len 31]
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    mem[(32 * _183) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                    emit Log(mem[(32 * _183) + ceil32(return_data.size) + 224], 100 * _263 / slippage);
        require arg3 <= balanceOf[address(arg1)]
        ...
        if arg1 != this.address:
            ...
            if arg1 != ext_call.return_data[12 len 20]:
                ...
                mem[64] = ceil32(return_data.size) + 192
                require return_data.size >= 32
                _176 = mem[192 len 4], Mask(224, 32, 25 * arg3 / 100) >> 32
                ...
                require 1 < mem[ceil32(return_data.size) + 192]
                _262 = mem[ceil32(return_data.size) + 256]
                if not mem[ceil32(return_data.size) + 256]:
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    mem[(32 * _182) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                    emit Log(mem[(32 * _182) + ceil32(return_data.size) + 224], 0 / slippage);
                else:
                    if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                        revert with 0, 
                                    32,
                                    33,
                                    0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(32 * _182) + ceil32(return_data.size) + 325 len 31]
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    mem[(32 * _182) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                    emit Log(mem[(32 * _182) + ceil32(return_data.size) + 224], 100 * _262 / slippage);
