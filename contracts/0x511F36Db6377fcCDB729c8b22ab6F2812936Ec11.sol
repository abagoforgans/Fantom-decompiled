...
function sub_fbe2f9d7(?) {
    ...
    call sub_0a4f20f8Address.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
         gas gas_remaining wei
        args sub_593a48c1Address, wftmAddress, arg2, arg3, arg4, arg5, msg.sender, arg6
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    if arg2 < ext_call.return_data[0]:
...
function sub_aff91512(?) payable {
    ...
    if msg.value > 0:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    emit AddLiquidity(uint256 arg1, uint256 arg2, uint256 arg3):
                      0,
    return 0
}

function sub_b1fd191c(?) payable {
    require calldata.size - 4 >= 128
    if not arg1:
        revert with 0, 'amounts can't be 0'
    if not msg.value:
    ...
    if ext_call.return_data[0]:
        ...
        if arg1 - ext_call.return_data[0] > 0:
            ...
            if not ext_code.size(sub_593a48c1Address):
                revert with 0, 'Address: call to non-contract'
            mem[(4 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1 - ext_call.return_data[0], 0
            mem[(4 * ceil32(return_data.size)) + 328] = 0
            call sub_593a48c1Address with:
        ...
        if arg1 - ext_call.return_data[0] > 0:
            ...
            if not ext_code.size(sub_593a48c1Address):
                revert with 0, 'Address: call to non-contract'
            mem[(6 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1 - ext_call.return_data[0], 0
    ...
    if msg.value < ext_call.return_data[32]:
        revert with 0, 17
    emit AddLiquidity(ext_call.return_data[0], ext_call.return_data[32], ext_call.return_data[64]);
    return ext_call.return_data[0], ext_call.return_data[32], ext_call.return_data[64]
}

function sub_fcf053aa(?) payable {
    require calldata.size - 4 >= 128
    if not arg1:
        revert with 0, 'amounts can't be 0'
    if not msg.value:
    ...
    if msg.value - ext_call.return_data[32] > 0:
        if msg.value < ext_call.return_data[32]:
            revert with 0, 17
        if eth.balance(this.address) <= msg.value - ext_call.return_data[32]:
            call msg.sender with:
               value eth.balance(this.address) wei
                 gas 2300 * is_zero(value) wei
        else:
...
function sub_35c9de7e(?) payable {
    ...
    if ext_call.return_data[0]:
        ...
        if ext_call.return_data[0]:
            mem[(4 * ceil32(return_data.size)) + 164] = arg1
            mem[(4 * ceil32(return_data.size)) + 196] = msg.value
            ...
            call sub_0a4f20f8Address.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args sub_593a48c1Address, wftmAddress, arg1, msg.value, arg2, arg3, msg.sender, arg4
            mem[(4 * ceil32(return_data.size)) + 96 len 96] = ext_call.return_data[0 len 96]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 96
            ...
            if arg1 - ext_call.return_data[0] > 0:
                ...
                if not ext_code.size(sub_593a48c1Address):
                    revert with 0, 'Address: call to non-contract'
                mem[(7 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1 - ext_call.return_data[0], 0
                mem[(7 * ceil32(return_data.size)) + 328] = 0
                call sub_593a48c1Address with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, arg1 - ext_call.return_data[0], 0) >> 224
                     gas gas_remaining wei
...
function sub_b16f3c1b(?) payable {
    ...
    if msg.value - ext_call.return_data[32] > 0:
        ...
        call wftmAddress.withdraw(uint256 arg1) with:
             gas gas_remaining wei
            args (msg.value - ext_call.return_data[32])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    return ext_call.return_data[0], ext_call.return_data[32], ext_call.return_data[64]
}
...
function sub_eed40558(?) payable {
    ...
    if ext_call.return_data[0]:
        ...
        if ext_call.return_data[0]:
                    ...
                    if ext_call.return_data[0] > 0:
                        ...
                        if msg.value <= ext_call.return_data[0]:
                            if msg.value < 0:
                                revert with 0, 17
                            mem[(7 * ceil32(return_data.size)) + 132] = msg.sender
                            mem[(7 * ceil32(return_data.size)) + 164] = msg.value
                            mem[(7 * ceil32(return_data.size)) + 96] = 68
                            mem[(7 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
                            mem[(7 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                            mem[(7 * ceil32(return_data.size)) + 196] = 32
                            ...
                            if not ext_code.size(wftmAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(7 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, msg.value, 0
                            mem[(7 * ceil32(return_data.size)) + 328] = 0
                            call wftmAddress with:
                               funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, msg.value, 0) >> 224
                                 gas gas_remaining wei
                                args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, msg.value, 0) << 288)
                            if not return_data.size:
                                if not ext_call.success:
                                    if ext_call.return_data[0]:
                                        revert with memory
                ...
                if msg.value > 0:
                    ...
                    if ext_call.return_data[0] > 0:
                        ...
                        if msg.value <= ext_call.return_data[0]:
                            if msg.value < 0:
                                revert with 0, 17
                            mem[(7 * ceil32(return_data.size)) + 296] = msg.sender
                            mem[(7 * ceil32(return_data.size)) + 328] = msg.value
                            ...
                            if not ext_code.size(wftmAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(7 * ceil32(return_data.size)) + 424 len 96] = 0, msg.sender, msg.value, 0
                            mem[(7 * ceil32(return_data.size)) + 492] = 0
                            call wftmAddress with:
                               funct Mask(32, 224, 0, msg.sender, msg.value, 0) >> 224
                                 gas gas_remaining wei
                                args (Mask(512, -288, 0, msg.sender, msg.value, 0) << 288)
                            if not return_data.size:
                                if not ext_call.success:
                                    if ext_call.return_data[0]:
                                        revert with memory
                            ...
                            if not ext_code.size(wftmAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(8 * ceil32(return_data.size)) + 424 len 96] = 0, msg.sender, ext_call.return_data[0], 0
            ...
            if msg.value <= ext_call.return_data[0]:
                ...
                mem[(7 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = msg.value
                ...
                if not ext_code.size(wftmAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(7 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, msg.sender, msg.value, 0
                ...
                emit AddLiquidity(uint256 arg1, uint256 arg2, uint256 arg3):
                                  ...
                                  0,
                                  0,
                                  mem[(10 * ceil32(return_data.size)) + 522 len (3 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))],
                return 0, 0, 0, mem[(10 * ceil32(return_data.size)) + 522 len (3 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            ...
            if not ext_code.size(wftmAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, msg.sender, ext_call.return_data[0], 0
            ...
            emit AddLiquidity(uint256 arg1, uint256 arg2, uint256 arg3):
                              ...
                              0,
                              0,
                              mem[(12 * ceil32(return_data.size)) + 522 len (19 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))],
            return 0, 
                   0,
                   0,
                   mem[(12 * ceil32(return_data.size)) + 522 len (19 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                ...
                if ext_call.return_data[0] > 0:
                    ...
                    if msg.value <= ext_call.return_data[0]:
                        if msg.value < 0:
                            revert with 0, 17
                        mem[(8 * ceil32(return_data.size)) + 132] = msg.sender
                        mem[(8 * ceil32(return_data.size)) + 164] = msg.value
                        mem[(8 * ceil32(return_data.size)) + 96] = 68
                        mem[(8 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
                        mem[(8 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                        mem[(8 * ceil32(return_data.size)) + 196] = 32
                        ...
                        if not ext_code.size(wftmAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(8 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, msg.value, 0
                        mem[(8 * ceil32(return_data.size)) + 328] = 0
                        call wftmAddress with:
                           funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, msg.value, 0) >> 224
                             gas gas_remaining wei
                        ...
                        if not ext_code.size(wftmAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(10 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0
                ...
                if ext_call.return_data[0] > 0:
                    ...
                    if msg.value <= ext_call.return_data[0]:
                        if msg.value < 0:
                            revert with 0, 17
                        mem[(8 * ceil32(return_data.size)) + 296] = msg.sender
                        mem[(8 * ceil32(return_data.size)) + 328] = msg.value
                        mem[(8 * ceil32(return_data.size)) + 260] = 68
                        mem[(8 * ceil32(return_data.size)) + 292 len 4] = unknown_0xa9059cbb(?????)
                        mem[(8 * ceil32(return_data.size)) + 360] = 32
                        mem[(8 * ceil32(return_data.size)) + 392] = 'SafeERC20: low-level call failed'
                        ...
                        if not ext_code.size(wftmAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(8 * ceil32(return_data.size)) + 424 len 96] = 0, msg.sender, msg.value, 0
                        mem[(8 * ceil32(return_data.size)) + 492] = 0
                        call wftmAddress with:
                           funct Mask(32, 224, 0, msg.sender, msg.value, 0) >> 224
                             gas gas_remaining wei
                        ...
                        mem[(10 * ceil32(return_data.size)) + 328] = ext_call.return_data[0]
                        ...
                        if not ext_code.size(wftmAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(10 * ceil32(return_data.size)) + 424 len 96] = 0, msg.sender, ext_call.return_data[0], 0
        ...
        if msg.value <= ext_call.return_data[0]:
            if msg.value < 0:
                revert with 0, 17
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = msg.sender
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = msg.value
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = 68
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 293 len 4] = unknown_0xa9059cbb(?????)
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 361] = 32
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 393] = 'SafeERC20: low-level call failed'
            ...
            if not ext_code.size(wftmAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, msg.sender, msg.value, 0
            mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 493] = 0
            call wftmAddress with:
               funct Mask(32, 224, 0, msg.sender, msg.value, 0) >> 224
                 gas gas_remaining wei
        ...
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = ext_call.return_data[0]
        ...
        if not ext_code.size(wftmAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, msg.sender, ext_call.return_data[0], 0
        ...
        emit AddLiquidity(uint256 arg1, uint256 arg2, uint256 arg3):
                          ...
                          0,
                          0,
                          mem[(13 * ceil32(return_data.size)) + 522 len (3 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))],
        return 0, 0, 0, mem[(13 * ceil32(return_data.size)) + 522 len (3 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
    mem[(2 * ceil32(return_data.size)) + 100] = sub_0a4f20f8Address
    mem[(2 * ceil32(return_data.size)) + 132] = -1
    require ext_code.size(sub_593a48c1Address)
    call sub_593a48c1Address.approve(address arg1, uint256 arg2) with:
            ...
            if ext_call.return_data[0] > 0:
                ...
                if msg.value <= ext_call.return_data[0]:
                    if msg.value < 0:
                        revert with 0, 17
                    mem[(10 * ceil32(return_data.size)) + 132] = msg.sender
                    mem[(10 * ceil32(return_data.size)) + 164] = msg.value
                    mem[(10 * ceil32(return_data.size)) + 96] = 68
                    mem[(10 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(10 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                    mem[(10 * ceil32(return_data.size)) + 196] = 32
                    ...
                    if not ext_code.size(wftmAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(10 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, msg.value, 0
                    mem[(10 * ceil32(return_data.size)) + 328] = 0
                    call wftmAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, msg.value, 0) >> 224
                         gas gas_remaining wei
            ...
            if ext_call.return_data[0] > 0:
                ...
                if msg.value <= ext_call.return_data[0]:
                    if msg.value < 0:
                        revert with 0, 17
                    mem[(10 * ceil32(return_data.size)) + 296] = msg.sender
                    mem[(10 * ceil32(return_data.size)) + 328] = msg.value
                    mem[(10 * ceil32(return_data.size)) + 260] = 68
                    mem[(10 * ceil32(return_data.size)) + 292 len 4] = unknown_0xa9059cbb(?????)
                    mem[(10 * ceil32(return_data.size)) + 360] = 32
                    mem[(10 * ceil32(return_data.size)) + 392] = 'SafeERC20: low-level call failed'
                    ...
                    if not ext_code.size(wftmAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(10 * ceil32(return_data.size)) + 424 len 96] = 0, msg.sender, msg.value, 0
                    mem[(10 * ceil32(return_data.size)) + 492] = 0
                    call wftmAddress with:
                       funct Mask(32, 224, 0, msg.sender, msg.value, 0) >> 224
                         gas gas_remaining wei
                    ...
                    mem[(11 * ceil32(return_data.size)) + 328] = ext_call.return_data[0]
                    ...
                    if not ext_code.size(wftmAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(11 * ceil32(return_data.size)) + 424 len 96] = 0, msg.sender, ext_call.return_data[0], 0
    ...
    if msg.value <= ext_call.return_data[0]:
        if msg.value < 0:
            revert with 0, 17
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = msg.sender
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = msg.value
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = 68
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 293 len 4] = unknown_0xa9059cbb(?????)
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 361] = 32
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 393] = 'SafeERC20: low-level call failed'
        ...
        if not ext_code.size(wftmAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, msg.sender, msg.value, 0
        mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 493] = 0
        call wftmAddress with:
           funct Mask(32, 224, 0, msg.sender, msg.value, 0) >> 224
             gas gas_remaining wei
    ...
    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = ext_call.return_data[0]
    ...
    if not ext_code.size(wftmAddress):
        revert with 0, 'Address: call to non-contract'
    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, msg.sender, ext_call.return_data[0], 0
    ...
    return 0, 0, 0, mem[(14 * ceil32(return_data.size)) + 522 len (3 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
}
