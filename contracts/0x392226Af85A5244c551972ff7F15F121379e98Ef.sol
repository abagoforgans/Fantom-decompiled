...
function sub_0e52b9cf(?) {
    ...
    _38 = mem[(32 * cd[100]) + _20 + 32]
    require cd[100] < mem[96]
    _40 = mem[(32 * cd[100]) + 128]
    mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[mem[64] + 4] = cd[68]
    mem[mem[64] + 36] = 0
    mem[mem[64] + 68] = 160
    _43 = mem[_40]
    mem[mem[64] + 164] = mem[_40]
    idx = 0
    s = _40 + 32
    t = mem[64] + 196
    while idx < _43:
    ...
    call address(_38).swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args cd[68], 0, 160, address(this.address), block.timestamp + 5, mem[mem[64] + 164 len (32 * _43) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _53 = mem[64]
    ...
    require _53 + mem[_53] + 31 < _53 + return_data.size
    _55 = mem[_53 + mem[_53]]
    require mem[_53 + mem[_53]] <= test266151307()
    require _53 + ceil32(return_data.size) + (32 * mem[_53 + mem[_53]]) + 32 <= test266151307() and (32 * mem[_53 + mem[_53]]) + 32 >= 0
