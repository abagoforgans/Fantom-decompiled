...
const pairCodeHash = sha3(code.data[1823 len 8920])

const INIT_CODE_PAIR_HASH = sha3(code.data[1823 len 8896], mem[17984 len 8], Mask(128, 64, code.data[10727 len 16]) >> 64)
