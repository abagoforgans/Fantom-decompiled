...
function sub_3644620c(?) payable {
    return sub_3644620cAddress
}
...
function balanceOfPool() payable {
    require ext_code.size(sub_3644620cAddress)
    staticcall sub_3644620cAddress.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        require ext_code.size(sub_3644620cAddress)
        call sub_3644620cAddress.stake(uint256 arg1) with:
             gas gas_remaining wei
...
function retireStrat() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(sub_3644620cAddress)
    call sub_3644620cAddress.0x2e1a7d4d with:
         gas gas_remaining wei
        args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
