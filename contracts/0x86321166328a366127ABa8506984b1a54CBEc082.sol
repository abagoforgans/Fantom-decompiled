...
uint32 stor2;
address sub_5949bb24Address;
uint256 stor2;
uint32 stor3;
address vaultAddress;
uint256 stor3;
address sub_cbf2ef79Address;
...
function sub_5949bb24(?) payable {
    return address(sub_5949bb24Address)
}
...
function sub_cbf2ef79(?) payable {
    return sub_cbf2ef79Address
}
...
function sub_56cb5c34(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    address(sub_5949bb24Address) = arg1
}
...
function pause() payable {
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if ext_code.size(lpToken0Address) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = 0, address(sub_5949bb24Address), 0
            ...
            if not return_data.size:
                ...
                if ext_code.size(lpToken1Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[752 len 64] = 0, address(sub_5949bb24Address), 0
                ...
                if return_data.size <= 0:
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 753 len 64] = 0, address(sub_5949bb24Address), 0
                    call lpToken1Address with:
                       funct uint32(stor2)
                         gas gas_remaining wei
            ...
            if return_data.size <= 0:
                if ext_code.size(lpToken0Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 589 len 64] = 0, address(sub_5949bb24Address), 0
                call lpToken0Address with:
                   funct uint32(stor2)
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 754 len 64] = 0, address(sub_5949bb24Address), 0
                    call lpToken1Address with:
                       funct uint32(stor2)
                         gas gas_remaining wei
    ...
    if return_data.size > 0:
        ...
        if return_data.size <= 0:
            if ext_code.size(lpToken0Address) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 590 len 64] = 0, address(sub_5949bb24Address), 0
            call lpToken0Address with:
               funct uint32(stor2)
                 gas gas_remaining wei
            ...
            if return_data.size > 0:
                ...
                if ext_code.size(lpToken1Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 755 len 64] = 0, address(sub_5949bb24Address), 0
                call lpToken1Address with:
                   funct uint32(stor2)
                     gas gas_remaining wei
