...
#  - harvest()
#
const name = 'StrategyBooStakingRewards', 0
...
function sub_d2836c81(?) payable {
    return sub_d2836c81Address
}
...
function pendingReward() payable {
    require ext_code.size(sub_d2836c81Address)
    staticcall sub_d2836c81Address.0xa279b07f with:
            gas gas_remaining wei
...
function balanceOfStake() payable {
    require ext_code.size(sub_d2836c81Address)
    staticcall sub_d2836c81Address.userInfo(uint256 rg1, address rg2) with:
            gas gas_remaining wei
           args pid, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function tend() payable {
    ...
    if not emergencyExit:
        ...
        if ext_call.return_data[0]:
            require ext_code.size(sub_d2836c81Address)
            call sub_d2836c81Address.deposit(uint256 rg1, uint256 rg2) with:
                 gas gas_remaining wei
...
function initialize(address arg1, address arg2, address arg3, address arg4, address arg5, uint256 arg6) payable {
    ...
    if not return_data.size:
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        if sub_d2836c81Address:
            revert with 0, 'Strategy already initialized'
        maxReportDelay = 6300
        profitFactor = 1500
        debtThreshold = 1000000 * 10^18
        sub_d2836c81Address = arg5
        pid = arg6
    ...
    if arg1 <= ext_call.return_data[0]:
        ...
        if ext_call.return_data[0] < arg1 - ext_call.return_data[0]:
            if ext_call.return_data[0] > 0:
                mem[(2 * ceil32(return_data.size)) + 260] = ext_call.return_data[0]
                require ext_code.size(sub_d2836c81Address)
                call sub_d2836c81Address.withdraw(uint256 rg1, uint256 rg2) with:
                     gas gas_remaining wei
                    args pid, ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] >= arg1:
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(4 * ceil32(return_data.size)) + 388 len 96] = transfer(address rg1, uint256 rg2), msg.sender, arg1, 0
        ...
        mem[(4 * ceil32(return_data.size)) + 288] = 68
        mem[(4 * ceil32(return_data.size)) + 324 len 28] = Mask(224, 32, msg.sender) >> 32
        mem[(4 * ceil32(return_data.size)) + 320 len 4] = transfer(address rg1, uint256 rg2)
        mem[(4 * ceil32(return_data.size)) + 388] = 32
        mem[(4 * ceil32(return_data.size)) + 420] = 'SafeERC20: low-level call failed'
        if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(wantAddress):
            revert with 0, 'Address: call to non-contract'
        if not ext_code.hash(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(4 * ceil32(return_data.size)) + 452 len 96] = transfer(address rg1, uint256 rg2), msg.sender, ext_call.return_data[0], 0
        ...
        if not return_data.size:
            ...
            mem[(4 * ceil32(return_data.size)) + 484 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size:
                    revert with ext_call.return_data[0 len return_data.size]
                revert with 0, 'SafeERC20: low-level call failed'
            if return_data.size:
                require return_data.size >= 32
                require mem[(4 * ceil32(return_data.size)) + 484] == bool(mem[(4 * ceil32(return_data.size)) + 484])
                if not mem[(4 * ceil32(return_data.size)) + 484]:
                    revert with 0, 'SafeERC20: ERC20 operation did not succeed'
    ...
    if msg.sender == vaultAddress:
        ...
        if -1 <= ext_call.return_data[0]:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 64
            require bool((4 * ceil32(return_data.size)) + 224 <= test266151307())
            mem[(4 * ceil32(return_data.size)) + 160] = ext_call.return_data[0]
            ...
            if ext_call.return_data[0] < -ext_call.return_data[0] - 1:
                ...
                if ext_call.return_data[0] > 0:
                    if -ext_call.return_data[0] - 1 > 0:
                        mem[(4 * ceil32(return_data.size)) + 260] = -ext_call.return_data[0] - 1
                        require ext_code.size(sub_d2836c81Address)
                        call sub_d2836c81Address.withdraw(uint256 rg1, uint256 rg2) with:
                             gas gas_remaining wei
            ...
            if ext_call.return_data[0] >= -1:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(7 * ceil32(return_data.size)) + 388 len 96] = transfer(address rg1, uint256 rg2), address(arg1) << 64, 0, ext_call.return_data[0], 0
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(7 * ceil32(return_data.size)) + 324] = arg1
                mem[(7 * ceil32(return_data.size)) + 356] = ext_call.return_data[0]
                mem[(7 * ceil32(return_data.size)) + 288] = 68
                mem[(7 * ceil32(return_data.size)) + 324 len 28] = address(arg1) << 64
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(7 * ceil32(return_data.size)) + 452 len 96] = transfer(address rg1, uint256 rg2), address(arg1) << 64, 0, ext_call.return_data[0], 0
        ...
        if -1 <= ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] < -ext_call.return_data[0] - 1:
                ...
                if ext_call.return_data[0] > 0:
                    if -ext_call.return_data[0] - 1 > 0:
                        mem[(6 * ceil32(return_data.size)) + 260] = -ext_call.return_data[0] - 1
                        require ext_code.size(sub_d2836c81Address)
                        call sub_d2836c81Address.withdraw(uint256 rg1, uint256 rg2) with:
                             gas gas_remaining wei
                            args pid, -ext_call.return_data[0] - 1
            ...
            if ext_call.return_data[0] >= -1:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(8 * ceil32(return_data.size)) + 452 len 96] = transfer(address rg1, uint256 rg2), address(arg1) << 64, 0, ext_call.return_data[0], 0
