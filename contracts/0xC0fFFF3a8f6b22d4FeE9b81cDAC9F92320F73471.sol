...
function royaltyInfo(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    if arg2 and 750 > -1 / arg2:
        revert with 0, 17
    return 0x51305da5a03d71de4160b3a5219d1f2c4cc50be5, 750 * arg2 / 10000
}
...
function mintItem(address arg1, string arg2) payable {
    ...
    if stor11[stor13].field_0:
        if stor11[stor13].field_0 == uint255(stor11[stor13].field_0) * 0.5 < 32:
            revert with 0, 34
        if arg2.length:
            ...
            idx = 0
            while (uint255(stor11[stor13].field_0) * 0.5) + 31 / 32 > idx:
