                ...
                if not arg1:
                    ...
                    if ceil32(mem[ceil32(stor15.length.field_1) + 192]) <= mem[ceil32(stor15.length.field_1) + 192]:
                        ...
                        emit PermanentURI(string arg1, uint256 arg2):
                                          32,
                                          mem[ceil32(stor15.length.field_1) + stor15.length.field_1 + 257 len ceil32(mem[ceil32(stor15.length.field_1) + 192]) + 32],
                                          arg1,
                else:
                    s = 0
                    idx = arg1
                    ...
                    mem[ceil32(stor15.length.field_1) + ceil32(s) + stor15.length.field_1 + mem[ceil32(stor15.length.field_1) + 128] + 256 len ceil32(mem[ceil32(stor15.length.field_1) + ceil32(s) + 160])] = mem[ceil32(stor15.length.field_1) + ceil32(s) + 192 len ceil32(mem[ceil32(stor15.length.field_1) + ceil32(s) + 160])]
                    if ceil32(mem[ceil32(stor15.length.field_1) + ceil32(s) + 160]) <= mem[ceil32(stor15.length.field_1) + ceil32(s) + 160]:
                        emit PermanentURI(Array(len=mem[ceil32(stor15.length.field_1) + ceil32(s) + 160], data=mem[ceil32(stor15.length.field_1) + ceil32(s) + stor15.length.field_1 + mem[ceil32(stor15.length.field_1) + 128] + 256 len ceil32(mem[ceil32(stor15.length.field_1) + ceil32(s) + 160])]), arg1);
                    else:
                        mem[ceil32(stor15.length.field_1) + ceil32(s) + stor15.length.field_1 + mem[ceil32(stor15.length.field_1) + 128] + mem[ceil32(stor15.length.field_1) + ceil32(s) + 160] + 256] = 0
                        emit PermanentURI(string arg1, uint256 arg2):
                                          32,
                                          mem[ceil32(stor15.length.field_1) + ceil32(s) + stor15.length.field_1 + mem[ceil32(stor15.length.field_1) + 128] + 224 len ceil32(mem[ceil32(stor15.length.field_1) + ceil32(s) + 160]) + 32],
                                          arg1,
        else:
            if bool(stor15.length) == stor15.length.field_1 < 32:
                revert with 'NH{q', 34
