...
function getToken0(address arg1) payable {
...
function getToken1(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(arg1)
...
function sub_d12a2e31(?) payable {
    ...
    if arg1 < arg2:
        ...
        if arg1 < arg2:
            if not arg1:
                revert with 0, 'UniswapV2Library: ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, factoryAddress, sha3(arg1, arg2), 0x9d6a514572482299fe260d57cf42a6dd12afda42484913ea67c57bba3fa77e21)))
            staticcall address(sha3(0, factoryAddress, sha3(arg1, arg2), 0x9d6a514572482299fe260d57cf42a6dd12afda42484913ea67c57bba3fa77e21)).getReserves() with:
                    gas gas_remaining wei
        else:
            if not arg2:
                revert with 0, 'UniswapV2Library: ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, factoryAddress, sha3(arg2, arg1), 0x9d6a514572482299fe260d57cf42a6dd12afda42484913ea67c57bba3fa77e21)))
            staticcall address(sha3(0, factoryAddress, sha3(arg2, arg1), 0x9d6a514572482299fe260d57cf42a6dd12afda42484913ea67c57bba3fa77e21)).getReserves() with:
                    gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
