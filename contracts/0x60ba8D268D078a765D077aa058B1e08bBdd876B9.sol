...
function deposit() payable {
    ...
    if ext_call.return_data[0]:
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[292 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), ext_call.return_data[0 len 28]
        mem[356 len 0] = 0
        call wantAddress with:
           funct uint32(stor18)
             gas gas_remaining wei
        ...
        if not return_data.size:
            if not ext_call.success:
                revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), ext_call.return_data[0]
            if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor18):
                revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[402 len 22]
        else:
            mem[324 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
...
function withdraw(uint256 arg1) payable {
    ...
    if not ext_code.size(wantAddress):
        revert with 0, 'Address: call to non-contract'
    if ext_call.return_data[0] <= arg1:
        mem[356 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), ext_call.return_data[0 len 28]
        mem[420 len 0] = 0
        call wantAddress with:
           funct uint32(stor3)
             gas gas_remaining wei
        ...
        mem[356 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, arg1) >> 32
        mem[420 len 0] = 0
        call wantAddress with:
           funct uint32(stor3)
             gas gas_remaining wei
...
function unpause() payable {
    ...
    call wantAddress with:
       funct uint32(stor18)
         gas gas_remaining wei
        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[356 len 4]
    if not return_data.size:
        if not ext_call.success:
        ...
        if ext_call.return_data[0]:
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[488 len 64] = 0, address(masterchefAddress), ext_call.return_data[0 len 28]
            call wantAddress with:
               funct uint32(stor18)
                 gas gas_remaining wei
                args ext_call.return_data[0], mem[392 len 28], mem[552 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), -1
                if not approve(address arg1, uint256 arg2), Mask(224, 0, stor18):
        ...
        if not ext_call.success:
            ...
            revert with 0, 
                        ...
                        0xfe5361666545524332303a206c6f772d6c6576656c2063616c6c206661696c656420696e2073747261746567,
                        mem[272 len 20],
                        Mask(96, 0, approve(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff)
        if return_data.size:
            require return_data.size >= 32
            if not mem[324]:
                revert with 0, 
        ...
        if ext_call.return_data[0]:
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 489 len 64] = 0, address(masterchefAddress), ext_call.return_data[0 len 28]
            call wantAddress with:
               funct uint32(stor18)
                 gas gas_remaining wei
                args ext_call.return_data[0], mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 553 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), -1
                if not approve(address arg1, uint256 arg2), Mask(224, 0, stor18):
                ...
                if not ext_call.success:
                    ...
                    revert with 0, 
                                ...
                                ext_call.return_data[0 len 28] << 160,
