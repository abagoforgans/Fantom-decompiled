...
function sub_dfd143c7(?) payable {
    ...
    if not _175 % 32:
        ...
        return address(ext_call.return_data[0]), 
               address(ext_call.return_data[0]),
               Array(len=mem[_175 + floor32(_23) + (2 * ceil32(return_data.size)) + 416 len mem[ceil32(return_data.size) + 96] + 32], data=mem[floor32(_23) + (2 * ceil32(return_data.size)) + 160], mem[_175 + floor32(_23) + (2 * ceil32(return_data.size)) + mem[ceil32(return_data.size) + 96] + 480 len floor32(mem[floor32(_23) + (2 * ceil32(return_data.size)) + 160]) + 32]),
               ext_call.return_data[0] << 248,
               address(ext_call.return_data[0]),
    ...
    return address(ext_call.return_data[0]), 
           address(ext_call.return_data[0]),
           Array(len=mem[floor32(_175) + floor32(_23) + (2 * ceil32(return_data.size)) + 448 len mem[ceil32(return_data.size) + 96] + 32], data=mem[floor32(_23) + (2 * ceil32(return_data.size)) + 160], mem[floor32(_175) + floor32(_23) + (2 * ceil32(return_data.size)) + mem[ceil32(return_data.size) + 96] + 512 len floor32(mem[floor32(_23) + (2 * ceil32(return_data.size)) + 160]) + 32]),
           ext_call.return_data[0] << 248,
           address(ext_call.return_data[0]),
        ...
        if not _20 % 32:
            ...
            if not _289 % 32:
                ...
                if not mem[_20 + (2 * ceil32(return_data.size)) + 128] % 32:
                    return address(arg2), 
                           Array(len=mem[ceil32(return_data.size) + 96], data=mem[_289 + _20 + (2 * ceil32(return_data.size)) + 384 len mem[_20 + (2 * ceil32(return_data.size)) + 128] + mem[ceil32(return_data.size) + 96] + 32]),
                           ext_call.return_data[0] << 248,
                           address(arg1),
            ...
            if not mem[_20 + (2 * ceil32(return_data.size)) + 128] % 32:
                return address(arg2), 
                       Array(len=mem[ceil32(return_data.size) + 96], data=mem[floor32(_289) + _20 + (2 * ceil32(return_data.size)) + 416 len mem[_20 + (2 * ceil32(return_data.size)) + 128] + mem[ceil32(return_data.size) + 96] + 32]),
                       ext_call.return_data[0] << 248,
                       address(arg1),
                       mem[ceil32(return_data.size) + 96] + 224,
                       ext_call.return_data[0] << 248
