...
function sub_e12b1d04(?) payable {
    ...
    mem[(2 * ceil32(return_data.size)) + 228 len 128] = unknown_0x23b872dd(?????), address(this.address) << 64, 0, msg.sender, ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 228 len 28]
    call address(arg1).mem[(2 * ceil32(return_data.size)) + 228 len 4] with:
         gas gas_remaining wei
