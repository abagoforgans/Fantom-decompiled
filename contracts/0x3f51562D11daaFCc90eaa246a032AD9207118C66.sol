...
function sub_749a4021(?) payable {
    ...
    staticcall address(arg2).0xb574f283 with:
            gas gas_remaining wei
           args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(address(arg2))
    staticcall address(arg2).0xfc895991 with:
            gas gas_remaining wei
           args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function equip(uint256 arg1, address arg2, uint256 arg3) payable {
    ...
    staticcall arg2.0x6730d593 with:
            gas gas_remaining wei
           args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(arg2)
    staticcall arg2.0xb574f283 with:
            gas gas_remaining wei
           args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(arg2)
    staticcall arg2.0xfc895991 with:
            gas gas_remaining wei
           args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if sub_1658e9aa[arg1][ext_call.return_data[0]].field_512:
        ...
        staticcall sub_1658e9aa[arg1][ext_call.return_data[0]].field_0.0xb574f283 with:
                gas gas_remaining wei
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(sub_1658e9aa[arg1][ext_call.return_data[0]].field_0)
        call sub_1658e9aa[arg1][ext_call.return_data[0]].field_0.0x23b872dd with:
             gas gas_remaining wei
        ...
        require ext_code.size(sub_1658e9aa[arg1][ext_call.return_data[0]].field_0)
        staticcall sub_1658e9aa[arg1][ext_call.return_data[0]].field_0.0xfc895991 with:
                gas gas_remaining wei
               args sub_1658e9aa[arg1][ext_call.return_data[0]].field_256
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
