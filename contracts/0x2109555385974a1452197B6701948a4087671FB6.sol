...
function sub_8cdcf40a(?) payable {
    ...
    if 1 >= _77:
        revert with 'NH{q', 50
    _182 = mem[ceil32(return_data.size) + 256]
    if not arg7:
        ...
        if mem[ceil32(return_data.size) + 256] and arg7 > -1 / mem[ceil32(return_data.size) + 256]:
            revert with 'NH{q', 17
        if not arg7:
            revert with 'NH{q', 18
        if mem[ceil32(return_data.size) + 256] * arg7 / arg7 != mem[ceil32(return_data.size) + 256]:
