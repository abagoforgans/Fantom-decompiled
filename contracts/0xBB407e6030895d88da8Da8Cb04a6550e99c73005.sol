...
function sub_27d73e63(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if stor16:
        revert with 0, 'Max Supply has been locked'
    stor16 = 1
}
...
function ipfsTokenURI(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ownerOf[arg1]
    if stor15[arg1].field_0:
            ...
            if stor15[arg1].field_1:
                if 31 < stor15[arg1].field_1:
                    ...
                    while stor15[arg1].field_1 + 96 > idx:
                        ...
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, stor15[arg1].field_1), data=mem[128 len ceil32(stor15[arg1].field_1)])
        ...
        if ceil32(stor15[arg1].field_1) > stor15[arg1].field_1:
            mem[ceil32(stor15[arg1].field_1) + stor15[arg1].field_1 + 192] = 0
        return Array(len=2 * Mask(256, -1, stor15[arg1].field_1), data=mem[128 len ceil32(stor15[arg1].field_1)], mem[(2 * ceil32(stor15[arg1].field_1)) + 192 len 2 * ceil32(stor15[arg1].field_1)]), 
    if stor15[arg1].field_0 == stor15[arg1].field_1 < 32:
        revert with 'NH{q', 34
    if stor15[arg1].field_0:
        if stor15[arg1].field_0 == stor15[arg1].field_1 < 32:
...
function mint(address arg1, string arg2) payable {
    ...
    if tokenByIndex.length > -2:
        revert with 'NH{q', 17
    if tokenByIndex.length + 1 > maxSupply:
        revert with 0, 'cannot mint over max supply'
    if not arg1:
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ownerOf[stor8.length + 1]
    require not stor16
    if stor15[stor8.length + 1].field_0:
        if stor15[stor8.length + 1].field_0 == stor15[stor8.length + 1].field_1 < 32:
            revert with 'NH{q', 34
        if arg2.length:
            stor15[stor8.length + 1][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor15[stor8.length + 1].field_0 = 0
            idx = 0
            while stor15[stor8.length + 1].field_1 + 31 / 32 > idx:
