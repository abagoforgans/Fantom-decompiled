...
function lockedAmount(address arg1, uint256 arg2) payable {
    ...
    staticcall sub_7664a7e8[stor0[arg2]].balanceOf(address arg1) with:
...
function sub_90c90f3d(?) payable {
    ...
    staticcall sub_7664a7e8[ext_call.return_data[12 len 20]].claimable_reward(address arg1, address arg2) with:
            gas gas_remaining wei
