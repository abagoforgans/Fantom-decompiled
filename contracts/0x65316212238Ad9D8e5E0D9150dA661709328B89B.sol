...
function mint(address arg1, string arg2) payable {
    ...
    if stor3[stor14 + 1]:
        ...
        if not ext_code.size(arg1):
            ...
            mem[420 len 160] = unknown_0x150b7a02(?????), msg.sender, 0, stor14 + 1, 128, 0
            mem[608 len 4] = 0
            call arg1.0x80 with:
                 gas gas_remaining wei
        ...
        if not ext_code.size(arg1):
            ...
            if not ext_code.size(arg1):
                revert with 0, 'Address: call to non-contract'
            mem[484 len 160] = unknown_0x150b7a02(?????), msg.sender, 0, stor14 + 1, 128, 0
            mem[672 len 4] = 0
            call arg1.0x80 with:
                 gas gas_remaining wei
                            ...
                            if tokenOfOwnerByIndex[address(arg2)][1][arg3]:
                                if stor3[arg3]:
                                    ...
                                    if ext_code.size(arg2):
                                        ...
                                        if not ext_code.size(arg2):
                                            revert with 0, 'Address: call to non-contract'
                                        mem[804 len 160] = unknown_0x150b7a02(?????), msg.sender, address(arg1), arg3, 128, 0
                                        mem[992 len 4] = 0
                                        call arg2.0x80 with:
                                             gas gas_remaining wei
                                    ...
                                    if ext_code.size(arg2):
                                        ...
                                        if not ext_code.size(arg2):
                                            revert with 0, 'Address: call to non-contract'
                                        mem[868 len 160] = unknown_0x150b7a02(?????), msg.sender, address(arg1), arg3, 128, 0
                                        mem[1056 len 4] = 0
                                        call arg2.0x80 with:
                                             gas gas_remaining wei
                                ...
                                if stor3[arg3]:
                                    ...
                                    if ext_code.size(arg2):
                                        ...
                                        call arg2.0x80 with:
                                             gas gas_remaining wei
                                            args Mask(1248, -1024, unknown_0x150b7a02(?????), msg.sender, address(arg1), arg3, 128, 0) << 1024, mem[964 len 4]
                                        if not return_data.size:
                                            require not ext_call.success
                                            revert with 0, 
                                                        32,
                                ...
                                if tokenOfOwnerByIndex[address(arg2)][1][arg3]:
                                    ...
                                    if stor3[arg3]:
                                        ...
                                        if ext_code.size(arg2):
                                            ...
                                            call arg2.0x80 with:
                                                 gas gas_remaining wei
                                                args Mask(1248, -1024, unknown_0x150b7a02(?????), msg.sender, address(arg1), arg3, 128, 0) << 1024, mem[1028 len 4]
                                            if not return_data.size:
                                                require not ext_call.success
                                                revert with 0, 
                                                            32,
