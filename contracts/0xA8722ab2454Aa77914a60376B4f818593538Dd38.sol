...
const name = 32, 33, 0xfe53747261746567793c50726f746f636f6c4e616d653e3c546f6b656e54797065, mem[161 len 31] / 0.00390625, 0
...
function harvest() payable {
    ...
    if msg.sender == keeperAddress:
        ...
        if not stor11:
            ...
            require ext_code.size(vaultAddress)
            call vaultAddress.report(uint256 arg1, uint256 arg2, uint256 arg3) with:
                 gas gas_remaining wei
                args 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            if not stor1:
                ...
                if not healthCheckAddress:
                    stor1 = 1
                else:
                    require ext_code.size(healthCheckAddress)
                    staticcall healthCheckAddress.check(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) with:
                            gas gas_remaining wei
                           args 0, 0, 0, ext_call.return_data[0], ext_call.return_data[192]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    if not ext_call.return_data[0]:
                        revert with 0, '!healthcheck'
            ...
            if ext_call.return_data[0] < ext_call.return_data[0]:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 288
                require bool((4 * ceil32(return_data.size)) + 512 <= test266151307())
            else:
                if ext_call.return_data[0] <= ext_call.return_data[0]:
                    if 0 > ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow', 0
            ...
            if not stor1:
                ...
                if not healthCheckAddress:
                    ...
                    staticcall healthCheckAddress.check(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) with:
                            gas gas_remaining wei
                           args 0, 0, ext_call.return_data[0], ext_call.return_data[0], ext_call.return_data[192]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                ...
                if not stor11:
                    ...
                    if ext_call.return_data[0] < ext_call.return_data[0]:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 288
                        require bool((6 * ceil32(return_data.size)) + 512 <= test266151307())
                    else:
                        if ext_call.return_data[0] <= ext_call.return_data[0]:
                            if 0 > ext_call.return_data[0]:
                                revert with 0, 'SafeMath: subtraction overflow', 0
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 288
                            require bool((6 * ceil32(return_data.size)) + 448 <= test266151307())
                        else:
                            if ext_call.return_data[0] > ext_call.return_data[0]:
                                revert with 0, 'SafeMath: subtraction overflow', 0
                            if 0 > ext_call.return_data[0]:
                    ...
                    if not stor11:
                        ...
                        if ext_call.return_data[0] < ext_call.return_data[0]:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 288
                            require bool((7 * ceil32(return_data.size)) + 512 <= test266151307())
                        else:
                            if ext_call.return_data[0] <= ext_call.return_data[0]:
                                if 0 > ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: subtraction overflow', 0
                                ...
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require return_data.size >= 288
                                require bool((7 * ceil32(return_data.size)) + 448 <= test266151307())
                            else:
                                if ext_call.return_data[0] > ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: subtraction overflow', 0
                                if 0 > ext_call.return_data[0]:
                    ...
                    if not stor11:
                        ...
                        if ext_call.return_data[0] < ext_call.return_data[0]:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 288
                            require bool((8 * ceil32(return_data.size)) + 512 <= test266151307())
                        else:
                            if ext_call.return_data[0] <= ext_call.return_data[0]:
                                if 0 > ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: subtraction overflow', 0
                                ...
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require return_data.size >= 288
                                require bool((8 * ceil32(return_data.size)) + 448 <= test266151307())
                            else:
                                if ext_call.return_data[0] > ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: subtraction overflow', 0
                                if 0 > ext_call.return_data[0]:
