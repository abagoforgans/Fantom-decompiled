...
function sub_81ea7610(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require arg1 < sub_81ea7610.length
    return sub_81ea7610[arg1]
}
...
function sub_9dbcb1d3(?) {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    require arg2 == arg2
    require msg.sender == owner
    require arg2 <= sub_e21a0624
    if block.timestamp < sub_fcbc49a0:
        revert with 'NH{q', 17
    require block.timestamp - sub_fcbc49a0 >= 790000
    call address(arg1) with:
       value arg2 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    sub_fcbc49a0 = block.timestamp
}
...
function burnForEth(uint256 arg1) {
    ...
    if ether and 10^18 > -1 / ether:
        revert with 'NH{q', 17
    if not totalSupply:
        revert with 'NH{q', 18
    if 10^18 * ether / totalSupply and arg1 > -1 / 10^18 * ether / totalSupply:
        revert with 'NH{q', 17
    if not msg.sender:
    ...
    call msg.sender with:
       value 10^18 * ether / totalSupply * arg1 / 10^18 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    sub_3d357096 = 10^18 * ether / totalSupply
    if ether < 10^18 * ether / totalSupply * arg1 / 10^18:
        revert with 'NH{q', 17
    ether -= 10^18 * ether / totalSupply * arg1 / 10^18
}

function mintForEth() payable {
    if not stor26[address(msg.sender)]:
        if sub_81ea7610.length < 100:
            sub_81ea7610.length++
            sub_81ea7610[sub_81ea7610.length] = msg.sender
    ...
    if msg.value and 9 > -1 / msg.value:
        revert with 'NH{q', 17
    if ether > -(9 * msg.value / 10) - 1:
        revert with 'NH{q', 17
    ether += 9 * msg.value / 10
    if sub_e21a0624 > -(msg.value / 10) - 1:
        revert with 'NH{q', 17
    sub_e21a0624 += msg.value / 10
    if ether and 10^18 > -1 / ether:
        revert with 'NH{q', 17
    if not totalSupply:
        revert with 'NH{q', 18
...
function name() {
    if bool(stor34.length):
        if bool(stor34.length) == stor34.length.field_1 < 32:
            revert with 'NH{q', 34
        if bool(stor34.length):
            if bool(stor34.length) == stor34.length.field_1 < 32:
                revert with 'NH{q', 34
            if stor34.length.field_1:
                if 31 < stor34.length.field_1:
                    mem[128] = uint256(stor34.field_0)
                    idx = 128
                    s = 0
                    while stor34.length.field_1 + 96 > idx:
                        mem[idx + 32] = stor34[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, stor34.length.field_1), data=mem[128 len ceil32(stor34.length.field_1)])
                mem[128] = 256 * stor34.length.field_8
        else:
            if bool(stor34.length) == stor34.length.field_1 < 32:
                revert with 'NH{q', 34
            if stor34.length.field_1:
                if 31 < stor34.length.field_1:
                    ...
                    return Array(len=2 * Mask(256, -1, stor34.length.field_1), data=mem[128 len ceil32(stor34.length.field_1)])
                mem[128] = 256 * stor34.length.field_8
        mem[ceil32(stor34.length.field_1) + 192 len ceil32(stor34.length.field_1)] = mem[128 len ceil32(stor34.length.field_1)]
        if ceil32(stor34.length.field_1) > stor34.length.field_1:
            mem[ceil32(stor34.length.field_1) + stor34.length.field_1 + 192] = 0
        return Array(len=2 * Mask(256, -1, stor34.length.field_1), data=mem[128 len ceil32(stor34.length.field_1)], mem[(2 * ceil32(stor34.length.field_1)) + 192 len 2 * ceil32(stor34.length.field_1)]), 
    if bool(stor34.length) == stor34.length.field_1 < 32:
        revert with 'NH{q', 34
    if bool(stor34.length):
        if bool(stor34.length) == stor34.length.field_1 < 32:
        ...
        if stor34.length.field_1:
            if 31 < stor34.length.field_1:
                ...
                while stor34.length.field_1 + 96 > idx:
                    ...
                    s = s + 1
                    continue 
                return Array(len=stor34.length % 128, data=mem[128 len ceil32(stor34.length.field_1)])
            mem[128] = 256 * stor34.length.field_8
    else:
        if bool(stor34.length) == stor34.length.field_1 < 32:
            revert with 'NH{q', 34
    ...
    if ceil32(stor34.length.field_1) > stor34.length.field_1:
        mem[ceil32(stor34.length.field_1) + stor34.length.field_1 + 192] = 0
    return Array(len=stor34.length % 128, data=mem[128 len ceil32(stor34.length.field_1)], mem[(2 * ceil32(stor34.length.field_1)) + 192 len 2 * ceil32(stor34.length.field_1)]), 
}

function symbol() {
    if bool(stor35.length):
        if bool(stor35.length) == stor35.length.field_1 < 32:
            revert with 'NH{q', 34
        if bool(stor35.length):
            if bool(stor35.length) == stor35.length.field_1 < 32:
                revert with 'NH{q', 34
            if stor35.length.field_1:
                if 31 < stor35.length.field_1:
                    mem[128] = uint256(stor35.field_0)
                    idx = 128
                    s = 0
                    while stor35.length.field_1 + 96 > idx:
                        mem[idx + 32] = stor35[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, stor35.length.field_1), data=mem[128 len ceil32(stor35.length.field_1)])
                mem[128] = 256 * stor35.length.field_8
        else:
            if bool(stor35.length) == stor35.length.field_1 < 32:
                revert with 'NH{q', 34
            if stor35.length.field_1:
                if 31 < stor35.length.field_1:
                    ...
                    return Array(len=2 * Mask(256, -1, stor35.length.field_1), data=mem[128 len ceil32(stor35.length.field_1)])
                mem[128] = 256 * stor35.length.field_8
        mem[ceil32(stor35.length.field_1) + 192 len ceil32(stor35.length.field_1)] = mem[128 len ceil32(stor35.length.field_1)]
        if ceil32(stor35.length.field_1) > stor35.length.field_1:
            mem[ceil32(stor35.length.field_1) + stor35.length.field_1 + 192] = 0
        return Array(len=2 * Mask(256, -1, stor35.length.field_1), data=mem[128 len ceil32(stor35.length.field_1)], mem[(2 * ceil32(stor35.length.field_1)) + 192 len 2 * ceil32(stor35.length.field_1)]), 
    if bool(stor35.length) == stor35.length.field_1 < 32:
        revert with 'NH{q', 34
    if bool(stor35.length):
        if bool(stor35.length) == stor35.length.field_1 < 32:
        ...
        if stor35.length.field_1:
            if 31 < stor35.length.field_1:
                ...
                while stor35.length.field_1 + 96 > idx:
                    ...
                    s = s + 1
                    continue 
                return Array(len=stor35.length % 128, data=mem[128 len ceil32(stor35.length.field_1)])
            mem[128] = 256 * stor35.length.field_8
    else:
        if bool(stor35.length) == stor35.length.field_1 < 32:
            revert with 'NH{q', 34
    ...
    if ceil32(stor35.length.field_1) > stor35.length.field_1:
        mem[ceil32(stor35.length.field_1) + stor35.length.field_1 + 192] = 0
    return Array(len=stor35.length % 128, data=mem[128 len ceil32(stor35.length.field_1)], mem[(2 * ceil32(stor35.length.field_1)) + 192 len 2 * ceil32(stor35.length.field_1)]), 
}
    ...
    if msg.sender == this.address:
        ...
        if sub_a2b0488f <= sub_16b9fde4:
            if stakers.length > 0:
                ...
                while idx < 5:
                    if count < stakers.length:
                        mem[0] = stakers[stor6]
                        mem[32] = 19
                        if bool(stor19[stor5[stor6]]) == 1:
                            if count >= stakers.length:
                                revert with 'NH{q', 50
                            require stakingBal[stor5[stor6]] > 0
                            if not totalLP:
                                revert with 'NH{q', 18
                            if stakingBal[stor5[stor6]] / totalLP and sub_76e7b8c3 > -1 / stakingBal[stor5[stor6]] / totalLP:
                                revert with 'NH{q', 17
                            if share[stor5[stor6]] > (-1 * stakingBal[stor5[stor6]] / totalLP * sub_76e7b8c3) - 1:
                                revert with 'NH{q', 17
                            mem[0] = stakers[stor6]
                            mem[32] = 20
                            share[stor5[stor6]] += stakingBal[stor5[stor6]] / totalLP * sub_76e7b8c3
                        if count == -1:
                            revert with 'NH{q', 17
                        count++
                        if idx == -1:
            ...
            if stakers.length <= 0:
                ...
                if stakers.length < 1:
                    revert with 'NH{q', 17
                if not stakers.length - 1:
                    revert with 'NH{q', 18
                if block.timestamp % stakers.length - 1 >= stakers.length:
                    revert with 'NH{q', 50
                if share[stor5[block.timestamp % stor5.length - 1]] > -sub_16b9fde4 - 1:
                    revert with 'NH{q', 17
                share[stor5[block.timestamp % stor5.length - 1]] += sub_16b9fde4
                sub_a2b0488f = 0
                if stakers.length > 0:
                    idx = 0
                    while idx < 5:
