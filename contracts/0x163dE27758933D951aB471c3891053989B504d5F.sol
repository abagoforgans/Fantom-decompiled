...
function getPosition(uint256 arg1) payable {
    ...
    if arg1 >= position.length:
        revert with 0, 50
    return position[arg1].field_0, 
           position[arg1].field_256,
           position[arg1].field_512,
           position[arg1].field_768,
           position[arg1].field_1024,
           position[arg1].field_1280,
           position[arg1].field_1536,
           position[arg1].field_1792
}
...
function sub_016e4b51(?) payable {
    ...
    if ceil32(_423) <= _423:
        ...
        if ceil32(_423) <= _423:
            ...
            if _418 and mem[_994] > -1 / _418:
                revert with 0, 17
            position.length++
            position[position.length].field_0 = block.timestamp
            position[position.length].field_256 = msg.sender
            position[position.length].field_512 = arg1
            position[position.length].field_768 = arg2
            position[position.length].field_1024 = address(arg3)
            position[position.length].field_1280 = address(arg4)
            position[position.length].field_1536 = _418
            position[position.length].field_1792 = _418 * mem[_994] / 10^18
        ...
        position[position.length].field_1280 = address(arg4)
        position[position.length].field_1536 = _418
        position[position.length].field_1792 = _418 * mem[_996] / 10^18
        emit 0x102c3eb8: arg1, arg2, address(arg3), address(arg4)
    ...
    if ceil32(_423) <= _423:
        ...
        position[position.length].field_1280 = address(arg4)
        position[position.length].field_1536 = _418
        position[position.length].field_1792 = _418 * mem[_998] / 10^18
        emit 0x102c3eb8: arg1, arg2, address(arg3), address(arg4)
    ...
    position[position.length].field_1280 = address(arg4)
    position[position.length].field_1536 = _418
    position[position.length].field_1792 = _418 * mem[_1000] / 10^18
    emit 0x102c3eb8: arg1, arg2, address(arg3), address(arg4)
