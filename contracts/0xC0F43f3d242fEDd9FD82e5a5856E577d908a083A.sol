...
function balanceOfPool() payable {
    ...
    staticcall poolAddress.getUserInfo(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    if ext_call.return_data[0]:
        require ext_code.size(poolAddress)
        call poolAddress.stakeTokens(uint256 arg1) with:
             gas gas_remaining wei
...
function retireStrat() payable {
    if address(vaultAddress) != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(poolAddress)
    call poolAddress.emergencyWithdraw() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(wantAddress)
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        if ext_call.return_data[0] > arg1:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(poolAddress)
        call poolAddress.withdrawStake(uint256 arg1) with:
             gas gas_remaining wei
