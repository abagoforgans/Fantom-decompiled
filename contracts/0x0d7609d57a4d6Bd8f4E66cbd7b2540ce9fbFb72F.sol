    ...
    if arg1 == msg.sender:
        ...
        if stor12 == msg.sender:
            ...
            if ext_code.size(arg2):
                ...
                mem[(32 * _724) + (32 * mem[96]) + mem[64] + 260 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])] = mem[(32 * arg3.length) + (32 * arg4.length) + 192 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])]
                if not _796 % 32:
                    require ext_code.size(arg2)
                    call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                         gas gas_remaining wei
                        args msg.sender, address(arg1), Array(len=mem[96], data=mem[mem[64] + 196 len _796 + (32 * _724) + (32 * mem[96]) + 64]), (32 * mem[96]) + 192, (32 * _724) + (32 * mem[96]) + 224
                else:
                    mem[floor32(_796) + (32 * _724) + (32 * mem[96]) + mem[64] + 260] = mem[floor32(_796) + (32 * _724) + (32 * mem[96]) + mem[64] + -(_796 % 32) + 292 len _796 % 32]
                    require ext_code.size(arg2)
                    call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                         gas gas_remaining wei
                        args msg.sender, address(arg1), Array(len=mem[96], data=mem[mem[64] + 196 len floor32(_796) + (32 * _724) + (32 * mem[96]) + 96]), (32 * mem[96]) + 192, (32 * _724) + (32 * mem[96]) + 224
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
            ...
            if stor13 == msg.sender:
                ...
                if ext_code.size(arg2):
                    ...
                    if not _802 % 32:
                        ...
                        call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                             gas gas_remaining wei
                            args msg.sender, address(arg1), 160, mem[mem[64] + 100 len _802 + (32 * _730) + (32 * _647) + 160]
                    else:
                        mem[floor32(_802) + (32 * _730) + (32 * _647) + mem[64] + 260] = mem[floor32(_802) + (32 * _730) + (32 * _647) + mem[64] + -(_802 % 32) + 292 len _802 % 32]
                        require ext_code.size(arg2)
                        call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                             gas gas_remaining wei
                            args msg.sender, address(arg1), 160, mem[mem[64] + 100 len floor32(_802) + (32 * _730) + (32 * _647) + 192]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
