...
const sub_c49592a0(?) = 0xf640259e4032ef4f7e0a1b7a14b2473373c0245c
...
uint256 stor4;
array of address sub_18bd4e5a;
array of address sub_9f435b0b;
array of address sub_384dd6f7;

function sub_18bd4e5a(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_18bd4e5a.length
    return sub_18bd4e5a[arg1]
}
...
function retireStrat() payable {
    if address(vaultAddress) != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(0x9083ea3756bde6ee6f27a6e996806fbd37f6f093)
    call 0x9083ea3756bde6ee6f27a6e996806fbd37f6f093.emergencyWithdraw(uint256 rg1) with:
         gas gas_remaining wei
        args poolId
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function pause() payable {
    ...
    if ext_code.size(lpPairAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address rg1, uint256 rg2), 0x9083ea3756bde6ee6f27a6e9, 0, 0
    mem[324 len 0] = 0
    call lpPairAddress.0x37f6f093 with:
         gas gas_remaining wei
        args Mask(480, -256, approve(address rg1, uint256 rg2), 0x9083ea3756bde6ee6f27a6e9, 0, 0) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address rg1, uint256 rg2), 0x9083ea3756bde6ee6f27a6e9, 0, 0
        if not approve(address rg1, uint256 rg2), 0x9083ea3756bde6ee6f27a6e9:
            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        if eth.balance(this.address) < 0:
        ...
        if ext_code.size(0x5cc61a78f164885776aa610fb0fe1257df78e59b) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
        ...
        if not return_data.size:
            ...
            if ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
            ...
            if not return_data.size:
                ...
                if ext_code.size(lpToken0Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[752 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
                ...
                if not return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[916 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 917 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
                    call lpToken1Address.0xdc33ae52 with:
                         gas gas_remaining wei
                ...
                if ext_code.size(lpToken0Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 753 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
                call lpToken0Address.0xdc33ae52 with:
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 918 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
                    call lpToken1Address.0xdc33ae52 with:
                         gas gas_remaining wei
        ...
        if ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 589 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
        call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0xdc33ae52 with:
             gas gas_remaining wei
        ...
        if ext_code.size(lpToken0Address) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + 754 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
        call lpToken0Address.0xdc33ae52 with:
             gas gas_remaining wei
        ...
        if ext_code.size(0x5cc61a78f164885776aa610fb0fe1257df78e59b) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 425 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
        call 0x5cc61a78f164885776aa610fb0fe1257df78e59b.0xdc33ae52 with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 590 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
            call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0xdc33ae52 with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if ext_code.size(lpToken0Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 755 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
                ...
                if return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(4 * ceil32(return_data.size)) + 920 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
                    call lpToken1Address.0xdc33ae52 with:
                         gas gas_remaining wei
    ...
    if ext_code.size(lpToken1Address) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 919 len 64] = 0, 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52, 0
