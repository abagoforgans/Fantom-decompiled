...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if not address(cd[(arg5 + 132)]):
        ...
        staticcall address(cd[(arg5 + 68)]).factory() with:
                gas gas_remaining wei
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
        mem[(6 * ceil32(return_data.size)) + 548] = address(cd[(arg5 + 164)])
        mem[(6 * ceil32(return_data.size)) + 580] = address(cd[(arg5 + 196)])
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
                gas gas_remaining wei
               args address(cd[(arg5 + 164)]), address(cd[(arg5 + 196)])
        ...
        staticcall address(cd[(arg5 + 100)]).factory() with:
                gas gas_remaining wei
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
        mem[(8 * ceil32(return_data.size)) + 548] = address(cd[(arg5 + 164)])
        mem[(8 * ceil32(return_data.size)) + 580] = address(cd[(arg5 + 196)])
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
                gas gas_remaining wei
               args address(cd[(arg5 + 164)]), address(cd[(arg5 + 196)])
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[(11 * ceil32(return_data.size)) + 548] = address(cd[(arg5 + 68)])
        mem[(11 * ceil32(return_data.size)) + 580] = ext_call.return_data[0]
        require ext_code.size(address(cd[(arg5 + 164)]))
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        mem[(12 * ceil32(return_data.size)) + 544] = 2
        mem[(12 * ceil32(return_data.size)) + 576] = address(cd[(arg5 + 164)])
        mem[(12 * ceil32(return_data.size)) + 608] = address(cd[(arg5 + 196)])
        mem[(12 * ceil32(return_data.size)) + 640] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[(12 * ceil32(return_data.size)) + 644] = ext_call.return_data[0]
        mem[(12 * ceil32(return_data.size)) + 676] = 1
        mem[(12 * ceil32(return_data.size)) + 708] = 160
        mem[(12 * ceil32(return_data.size)) + 804] = 2
        idx = 0
        s = (12 * ceil32(return_data.size)) + 576
        t = (12 * ceil32(return_data.size)) + 836
        while idx < 2:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
        ...
        mem[(12 * ceil32(return_data.size)) + 772] = block.timestamp
        require ext_code.size(address(cd[(arg5 + 68)]))
        call address(cd[(arg5 + 68)]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], 1, Array(len=2, data=mem[(12 * ceil32(return_data.size)) + 836 len 64]), address(this.address), block.timestamp
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(12 * ceil32(return_data.size)) + 640 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (13 * ceil32(return_data.size)) + 640
        require return_data.size >= 32
        _164 = mem[(12 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28]
        require mem[(12 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] <= test266151307()
        require (12 * ceil32(return_data.size)) + return_data.size + 640 > (12 * ceil32(return_data.size)) + mem[(12 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 671
        _166 = mem[(12 * ceil32(return_data.size)) + mem[(12 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640]
        require mem[(12 * ceil32(return_data.size)) + mem[(12 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640] <= test266151307()
        require (32 * mem[(12 * ceil32(return_data.size)) + mem[(12 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640]) + 32 >= 0 and (13 * ceil32(return_data.size)) + (32 * mem[(12 * ceil32(return_data.size)) + mem[(12 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640]) + 672 <= test266151307()
        mem[64] = (13 * ceil32(return_data.size)) + (32 * mem[(12 * ceil32(return_data.size)) + mem[(12 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640]) + 672
        mem[(13 * ceil32(return_data.size)) + 640] = mem[(12 * ceil32(return_data.size)) + mem[(12 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640]
        require return_data.size >= _164 + (32 * _166) + 32
        mem[(13 * ceil32(return_data.size)) + 672 len 32 * _166] = mem[(12 * ceil32(return_data.size)) + _164 + 672 len 32 * _166]
        ...
        mem[64] = mem[64] + 96
        require 0 < mem[_311]
        mem[_311 + 32] = address(cd[(arg5 + 196)])
        require 1 < mem[_311]
        mem[_311 + 64] = address(cd[(arg5 + 164)])
        mem[_311 + 96] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[_311 + 100] = _300
        mem[_311 + 132] = 1
        mem[_311 + 164] = 160
        mem[_311 + 260] = mem[_311]
        idx = 0
        s = _311 + 32
        t = _311 + 292
        while idx < mem[_311]:
            ...
            t = t + 32
            continue 
        mem[_311 + 196] = this.address
        mem[_311 + 228] = block.timestamp
        require ext_code.size(address(cd[(arg5 + 100)]))
        call address(cd[(arg5 + 100)]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _311 + (32 * mem[_311]) + -mem[64] + 288]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _418 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        mem[_418 + ceil32(return_data.size)] = _422
        require return_data.size >= _420 + (32 * _422) + 32
        mem[_418 + ceil32(return_data.size) + 32 len 32 * _422] = mem[_418 + _420 + 32 len 32 * _422]
        require ext_code.size(address(cd[(arg5 + 164)]))
        staticcall address(cd[(arg5 + 164)]).0x70a08231 with:
                gas gas_remaining wei
               args address(this.address)
        ...
        call address(cd[(arg5 + 164)]).approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args address(this.address), _524
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _530 = mem[64]
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
        mem[(4 * ceil32(return_data.size)) + 548] = address(cd[(arg5 + 164)])
        mem[(4 * ceil32(return_data.size)) + 580] = address(cd[(arg5 + 196)])
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
                gas gas_remaining wei
               args address(cd[(arg5 + 164)]), address(cd[(arg5 + 196)])
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
        mem[(7 * ceil32(return_data.size)) + 548] = address(cd[(arg5 + 196)])
        mem[(7 * ceil32(return_data.size)) + 580] = address(cd[(arg5 + 228)])
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
                gas gas_remaining wei
               args address(cd[(arg5 + 196)]), address(cd[(arg5 + 228)])
        mem[(7 * ceil32(return_data.size)) + 544] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        staticcall address(cd[(arg5 + 132)]).factory() with:
                gas gas_remaining wei
        mem[(8 * ceil32(return_data.size)) + 544] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
        mem[(10 * ceil32(return_data.size)) + 548] = address(cd[(arg5 + 228)])
        mem[(10 * ceil32(return_data.size)) + 580] = address(cd[(arg5 + 164)])
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
                gas gas_remaining wei
               args address(cd[(arg5 + 228)]), address(cd[(arg5 + 164)])
        mem[(10 * ceil32(return_data.size)) + 544] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[(12 * ceil32(return_data.size)) + 548] = address(cd[(arg5 + 68)])
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        mem[(13 * ceil32(return_data.size)) + 544] = 2
        mem[(13 * ceil32(return_data.size)) + 576] = address(cd[(arg5 + 164)])
        mem[(13 * ceil32(return_data.size)) + 608] = address(cd[(arg5 + 196)])
        mem[(13 * ceil32(return_data.size)) + 640] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[(13 * ceil32(return_data.size)) + 644] = ext_call.return_data[0]
        mem[(13 * ceil32(return_data.size)) + 676] = 1
        mem[(13 * ceil32(return_data.size)) + 708] = 160
        mem[(13 * ceil32(return_data.size)) + 804] = 2
        idx = 0
        s = (13 * ceil32(return_data.size)) + 576
        t = (13 * ceil32(return_data.size)) + 836
        while idx < 2:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
            t = t + 32
            continue 
        mem[(13 * ceil32(return_data.size)) + 740] = this.address
        mem[(13 * ceil32(return_data.size)) + 772] = block.timestamp
        require ext_code.size(address(cd[(arg5 + 68)]))
        call address(cd[(arg5 + 68)]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], 1, Array(len=2, data=mem[(13 * ceil32(return_data.size)) + 836 len 64]), address(this.address), block.timestamp
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(13 * ceil32(return_data.size)) + 640 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (14 * ceil32(return_data.size)) + 640
        require return_data.size >= 32
        _163 = mem[(13 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28]
        require mem[(13 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] <= test266151307()
        require (13 * ceil32(return_data.size)) + return_data.size + 640 > (13 * ceil32(return_data.size)) + mem[(13 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 671
        _165 = mem[(13 * ceil32(return_data.size)) + mem[(13 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640]
        require mem[(13 * ceil32(return_data.size)) + mem[(13 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640] <= test266151307()
        require (32 * mem[(13 * ceil32(return_data.size)) + mem[(13 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640]) + 32 >= 0 and (14 * ceil32(return_data.size)) + (32 * mem[(13 * ceil32(return_data.size)) + mem[(13 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640]) + 672 <= test266151307()
        mem[64] = (14 * ceil32(return_data.size)) + (32 * mem[(13 * ceil32(return_data.size)) + mem[(13 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640]) + 672
        mem[(14 * ceil32(return_data.size)) + 640] = mem[(13 * ceil32(return_data.size)) + mem[(13 * ceil32(return_data.size)) + 640 len 4], ext_call.return_data[0 len 28] + 640]
        require return_data.size >= _163 + (32 * _165) + 32
        mem[(14 * ceil32(return_data.size)) + 672 len 32 * _165] = mem[(13 * ceil32(return_data.size)) + _163 + 672 len 32 * _165]
        mem[mem[64] + 4] = this.address
        require ext_code.size(address(cd[(arg5 + 196)]))
        staticcall address(cd[(arg5 + 196)]).0x70a08231 with:
                gas gas_remaining wei
        ...
        mem[64] = mem[64] + 96
        require 0 < mem[_309]
        mem[_309 + 32] = address(cd[(arg5 + 196)])
        require 1 < mem[_309]
        mem[_309 + 64] = address(cd[(arg5 + 228)])
        mem[_309 + 96] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[_309 + 100] = _299
        mem[_309 + 132] = 1
        mem[_309 + 164] = 160
        mem[_309 + 260] = mem[_309]
        idx = 0
        s = _309 + 32
        t = _309 + 292
        while idx < mem[_309]:
            ...
            t = t + 32
            continue 
        mem[_309 + 196] = this.address
        mem[_309 + 228] = block.timestamp
        require ext_code.size(address(cd[(arg5 + 100)]))
        call address(cd[(arg5 + 100)]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _309 + (32 * mem[_309]) + -mem[64] + 288]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _417 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        require _417 + return_data.size > _417 + mem[_417] + 31
        _421 = mem[_417 + mem[_417]]
        require mem[_417 + mem[_417]] <= test266151307()
        require (32 * mem[_417 + mem[_417]]) + 32 >= 0 and _417 + ceil32(return_data.size) + (32 * mem[_417 + mem[_417]]) + 32 <= test266151307()
        mem[64] = _417 + ceil32(return_data.size) + (32 * mem[_417 + mem[_417]]) + 32
        mem[_417 + ceil32(return_data.size)] = _421
        require return_data.size >= _419 + (32 * _421) + 32
        mem[_417 + ceil32(return_data.size) + 32 len 32 * _421] = mem[_417 + _419 + 32 len 32 * _421]
        mem[mem[64] + 4] = this.address
        ...
        mem[64] = mem[64] + 96
        require 0 < mem[_527]
        mem[_527 + 32] = address(cd[(arg5 + 228)])
        require 1 < mem[_527]
        mem[_527 + 64] = address(cd[(arg5 + 164)])
        mem[_527 + 96] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[_527 + 100] = _515
        mem[_527 + 132] = cd[(arg5 + 36)]
        mem[_527 + 164] = 160
        mem[_527 + 260] = mem[_527]
        idx = 0
        s = _527 + 32
        t = _527 + 292
        while idx < mem[_527]:
            ...
            t = t + 32
            continue 
        mem[_527 + 196] = this.address
        mem[_527 + 228] = block.timestamp
        require ext_code.size(address(cd[(arg5 + 132)]))
        call address(cd[(arg5 + 132)]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _527 + (32 * mem[_527]) + -mem[64] + 288]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _591 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        call address(cd[(arg5 + 164)]).approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args address(this.address), _634
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _637 = mem[64]
