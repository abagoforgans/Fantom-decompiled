...
function withdrawAll() {
    ...
    if not return_data.size:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_code.hash(tokenAAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
            revert with 0, 'SafeERC20: call to non-contract'
    ...
    if not paused:
        ...
        if ext_call.return_data[0] > 0:
            ...
            call wantAddress.0x2656dcdd with:
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), 0x2b2929e785374c651a81a638, 0, 0) << 256, mem[260 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'SafeERC20: low-level call failed'
                ...
                if ext_call.return_data[0]:
                    ...
                    staticcall wantAddress.0xdd62ed3e with:
                            gas gas_remaining wei
                           args address(this.address), 0x2b2929e785374c651a81a63878ab22742656dcdd
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    if ext_call.return_data[0]:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[296 len 64] = 0, 0x2b2929e785374c651a81a63878ab22742656dcdd, ext_call.return_data[0 len 28]
                call wantAddress.0x2656dcdd with:
                     gas gas_remaining wei
                    args ext_call.return_data[0], Mask(224, 32, 0, 0x2b2929e785374c651a81a63878ab22742656dcdd, ext_call.return_data[0 len 28]) >> 32, mem[360 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if not approve(address arg1, uint256 arg2), 0x2b2929e785374c651a81a638:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[ceil32(return_data.size) + 297 len 64] = 0, 0x2b2929e785374c651a81a63878ab22742656dcdd, ext_call.return_data[0 len 28]
                call wantAddress.0x2656dcdd with:
                     gas gas_remaining wei
                    args ext_call.return_data[0], Mask(224, 32, 0, 0x2b2929e785374c651a81a63878ab22742656dcdd, ext_call.return_data[0 len 28]) >> 32, mem[ceil32(return_data.size) + 361 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if not approve(address arg1, uint256 arg2), 0x2b2929e785374c651a81a638:
...
function withdraw(uint256 arg1) {
    ...
    if ext_call.return_data[0] >= arg1:
        if not arg1:
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'SafeERC20: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = 0, address(ext_call.return_data[0]), Mask(224, 32, arg1 - (arg1 * withdrawalFee / 10000)) >> 32
            call wantAddress with:
                 gas gas_remaining wei
                args arg1 - (arg1 * withdrawalFee / 10000), Mask(224, 32, address(ext_call.return_data[0]), Mask(224, 32, arg1 - (arg1 * withdrawalFee / 10000)) >> 32) >> 32, mem[ceil32(return_data.size) + 489 len 4]
        if not return_data.size:
            require not ext_call.success
            revert with 0, 'SafeERC20: low-level call failed'
        ...
        if not arg1:
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'SafeERC20: call to non-contract'
            mem[ceil32(return_data.size) + 489 len 64] = 0, address(ext_call.return_data[0]), Mask(224, 32, arg1 - (arg1 * withdrawalFee / 10000)) >> 32
            call wantAddress with:
                 gas gas_remaining wei
                args arg1 - (arg1 * withdrawalFee / 10000), Mask(224, 32, address(ext_call.return_data[0]), Mask(224, 32, arg1 - (arg1 * withdrawalFee / 10000)) >> 32) >> 32, mem[ceil32(return_data.size) + 553 len 4]
        if not return_data.size:
            require not ext_call.success
            revert with 0, 'SafeERC20: low-level call failed'
