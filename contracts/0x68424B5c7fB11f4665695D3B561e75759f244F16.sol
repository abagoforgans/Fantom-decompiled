...
const rewardPool = 0x107983796dd5a2eb4893c4ed4b3717332c830f7a
...
function notify() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = unknown_0xa9059cbb(?????), 0x107983796dd5a2eb4893c4ed, 0, ext_call.return_data[0 len 28]
            mem[488 len 0] = 0
            call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0x2c830f7a with:
                 gas gas_remaining wei
            ...
            require ext_code.size(0x107983796dd5a2eb4893c4ed4b3717332c830f7a)
            call 0x107983796dd5a2eb4893c4ed4b3717332c830f7a.0x3c6b16ab with:
                 gas gas_remaining wei
            ...
            if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = unknown_0xa9059cbb(?????), 0x107983796dd5a2eb4893c4ed, 0, ext_call.return_data[0 len 28]
        ...
        if not return_data.size:
            ...
            if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = unknown_0xa9059cbb(?????), 0x107983796dd5a2eb4893c4ed, 0, Mask(224, 32, ext_call.return_data[0] - (5 * ext_call.return_data[0] / 1000)) >> 32
            mem[488 len 0] = 0
            call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0x2c830f7a with:
                 gas gas_remaining wei
            ...
            if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = unknown_0xa9059cbb(?????), 0x107983796dd5a2eb4893c4ed, 0, Mask(224, 32, ext_call.return_data[0] - (5 * ext_call.return_data[0] / 1000)) >> 32
