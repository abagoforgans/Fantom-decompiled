...
function execute(address arg1, uint256 arg2, address arg3, bytes arg4, bytes arg5) {
    ...
    if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == arg1:
        if arg1 != 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
            mem[196 len 64] = transfer(address rg1, uint256 rg2), address(cd[(arg5 + 36)]) << 64, 0, Mask(224, 32, eth.balance(this.address)) >> 32
            call arg1 with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
                                50,
                                0x444c696d69744f7264657273235f7472616e73666572416d6f756e743a20544f4b454e5f5452414e534645525f4641494c45,
                                mem[314 len 14]
                if not transfer(address rg1, uint256 rg2), address(cd[(arg5 + 36)]) << 64:
                    revert with 0, 
                                32,
                                50,
                                0x444c696d69744f7264657273235f7472616e73666572416d6f756e743a20544f4b454e5f5452414e534645525f4641494c45,
                        ...
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 
                                            32,
                                            48,
                                            0x534c696d69744f7264657273235f7472616e73666572416d6f756e743a2046544d5f5452414e534645525f4641494c45,
                                            uint128(cd[(arg4 + 68)])
                        else:
                            if not ext_call.success:
                                revert with 0, 
            ...
            if not return_data.size:
                ...
                if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == address(cd[(arg4 + 36)]):
                    ...
                    if address(cd[(arg4 + 36)]) == 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
                        ...
                        mem[196 len 64] = transfer(address rg1, uint256 rg2), address(arg3) << 64, 0, Mask(224, 32, eth.balance(this.address)) >> 32
                        call address(cd[(arg4 + 36)]) with:
                             gas gas_remaining wei
                ...
                if address(cd[(arg4 + 36)]) == 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
                    ...
                    mem[196 len 64] = transfer(address rg1, uint256 rg2), address(arg3) << 64, 0, ext_call.return_data[0 len 28]
                    call address(cd[(arg4 + 36)]) with:
                         gas gas_remaining wei
                ...
                if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == address(cd[(arg4 + 36)]):
                    ...
                    if address(cd[(arg4 + 36)]) == 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
                        ...
                        mem[ceil32(return_data.size) + 197 len 64] = transfer(address rg1, uint256 rg2), address(arg3) << 64, 0, Mask(224, 32, eth.balance(this.address)) >> 32
                        call address(cd[(arg4 + 36)]) with:
                             gas gas_remaining wei
                            args Mask(224, 32, eth.balance(this.address)) << 224, Mask(32, 224, arg5.length) >> 224
                        if not return_data.size:
                ...
                if address(cd[(arg4 + 36)]) == 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
                    ...
                    mem[ceil32(return_data.size) + 133 len 28] = address(arg3) << 64
                    mem[ceil32(return_data.size) + 129 len 4] = transfer(address rg1, uint256 rg2)
                    mem[ceil32(return_data.size) + 197 len 64] = transfer(address rg1, uint256 rg2), address(arg3) << 64, 0, ext_call.return_data[0 len 28]
                    call address(cd[(arg4 + 36)]) with:
                         gas gas_remaining wei
                        args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, Mask(32, 224, arg5.length) >> 224
                    if not return_data.size:
    ...
    require return_data.size >= 32
    if arg1 != 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
        mem[196 len 64] = transfer(address rg1, uint256 rg2), address(cd[(arg5 + 36)]) << 64, 0, ext_call.return_data[0 len 28]
        call arg1 with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == address(cd[(arg4 + 36)]):
                ...
                if address(cd[(arg4 + 36)]) == 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
                    ...
                    mem[296 len 64] = transfer(address rg1, uint256 rg2), address(arg3) << 64, 0, Mask(224, 32, eth.balance(this.address)) >> 32
                    call address(cd[(arg4 + 36)]) with:
                         gas gas_remaining wei
                        args Mask(224, 32, eth.balance(this.address)) << 224, Mask(32, 224, arg5.length) >> 224
                    if not return_data.size:
            ...
            if address(cd[(arg4 + 36)]) == 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
                ...
                mem[296 len 64] = transfer(address rg1, uint256 rg2), address(arg3) << 64, 0, ext_call.return_data[0 len 28]
                call address(cd[(arg4 + 36)]) with:
                   funct Mask(32, 224, cd[(arg4 + 68)]) >> 224
                     gas gas_remaining wei
                    args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, Mask(32, 224, arg5.length) >> 224
            ...
            if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == address(cd[(arg4 + 36)]):
                ...
                if address(cd[(arg4 + 36)]) == 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
                    ...
                    mem[ceil32(return_data.size) + 297 len 64] = transfer(address rg1, uint256 rg2), address(arg3) << 64, 0, Mask(224, 32, eth.balance(this.address)) >> 32
                    call address(cd[(arg4 + 36)]) with:
                         gas gas_remaining wei
                        args Mask(224, 32, eth.balance(this.address)) << 224, Mask(32, 224, arg5.length) >> 224
                    if not return_data.size:
            ...
            if address(cd[(arg4 + 36)]) == 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
                ...
                mem[ceil32(return_data.size) + 297 len 64] = transfer(address rg1, uint256 rg2), address(arg3) << 64, 0, ext_call.return_data[0 len 28]
                call address(cd[(arg4 + 36)]) with:
                     gas gas_remaining wei
                    args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, Mask(32, 224, arg5.length) >> 224
                if not return_data.size:
