...
address owner;
mapping of uint256 bunnyCount;
mapping of uint256 bunnyBurnCount;
uint256 stor13;
mapping of uint8 bunnyId;
array of uint256 bunnyName;
...
function getBunnyName(uint8 arg1) payable {
    return bunnyName[arg1 << 248][0 len bunnyName[arg1 << 248].length]
}

function getBunnyNameOfTokenId(uint256 arg1) payable {
    return bunnyName[stor14[arg1]][0 len bunnyName[stor14[arg1]].length]
}
...
function bunnyCount(uint8 arg1) payable {
    require calldata.size - 4 >= 32
    return bunnyCount[arg1]
}

function getBunnyId(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    return bunnyId[arg1]
}

function bunnyBurnCount(uint8 arg1) payable {
    require calldata.size - 4 >= 32
    return bunnyBurnCount[arg1]
}
...
function setBunnyName(uint8 arg1, string arg2) payable {
    require calldata.size - 4 >= 64
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    bunnyName[arg1 << 248] = (2 * arg2.length) + 1
    s = 0
    idx = arg2 + 36
    while arg2 + arg2.length + 36 > idx:
        bunnyName[arg1 << 248][s] = cd[idx]
        s = s + 1
        idx = idx + 32
        continue 
    idx = Mask(251, 0, arg2.length + 31) >> 5
    while bunnyName[arg1 << 248].length + 31 / 32 > idx:
        bunnyName[arg1 << 248][idx] = 0
        idx = idx + 1
        continue 
}
...
function mint(address arg1, string arg2, uint8 arg3) payable {
    ...
    stor13++
    bunnyId[stor13] = arg3
    if bunnyCount[arg3 << 248] + 1 < bunnyCount[arg3 << 248]:
    ...
    if stor3[stor13]:
        ...
        tokenByIndex[stor3[stor13] - 1].field_256 = arg1
        tokenByIndex[stor3[stor13] - 1].field_416 = 0
        ...
        uint256(stor8[stor13][]) = Array(len=arg2.length, data=arg2[all])
...
function burn(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if 1 > bunnyCount[stor14[arg1]]:
        revert with 0, 'SafeMath: subtraction overflow'
    bunnyCount[stor14[arg1]]--
    if bunnyBurnCount[stor14[arg1]] + 1 < bunnyBurnCount[stor14[arg1]]:
        revert with 0, 'SafeMath: addition overflow'
    bunnyBurnCount[stor14[arg1]]++
    if not stor3[arg1]:
        revert with 0, 
                    32,
                    41,
