...
function sub_54ad3bfa(?) {
    ...
    emit 0x38fde7d9: arg1, product[arg1].field_0, 0, 0, bool(uint8(product[arg1].field_0) >> 248), product[arg1].field_256, product[arg1].field_256, product[arg1].field_256, 0, 0, 0, 0, uint16(product[arg1].field_256) >> 240
}
...
function getLatestPrice(address arg1, uint256 arg2) {
    ...
    if not arg2:
        ...
        if ext_call.return_data[96] <= 0:
            revert with 0, '!timeStamp'
        require ext_code.size(product[arg2].field_0)
        staticcall product[arg2].field_0.0x313ce567 with:
                gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function openPosition(uint256 arg1, bool arg2, uint256 arg3) payable {
    ...
    if ext_call.return_data[96] <= 0:
        revert with 0, '!timeStamp'
    require ext_code.size(product[arg1].field_0)
    staticcall product[arg1].field_0.0x313ce567 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
        ...
        if stor9[cd[((32 * idx) + cd[4] + 36)]].field_0:
            if stor9[cd[((32 * idx) + cd[4] + 36)]].field_504:
                ...
                if mem[_75 + 96] <= 0:
                    revert with 0, '!timeStamp'
                require ext_code.size(product[stor9[cd[((32 * idx) + cd[4] + 36)]].field_0].field_0)
                staticcall product[stor9[cd[((32 * idx) + cd[4] + 36)]].field_0].field_0.0x313ce567 with:
                        gas gas_remaining wei
