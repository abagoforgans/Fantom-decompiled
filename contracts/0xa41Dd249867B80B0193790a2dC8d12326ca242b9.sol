...
address feeAddress;
uint256 sub_af703bee;
uint256 sub_eafa64d1;
uint256 sub_fa0220e4;
uint8 stor8; offset 160
uint128 stor8; offset 160
address sub_e036196aAddress;
...
function sub_e036196a(?) payable {
    return sub_e036196aAddress
}

function sub_eafa64d1(?) payable {
    return sub_eafa64d1
}

function sub_fa0220e4(?) payable {
    return sub_fa0220e4
}
...
function sub_442fb2f8(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_e036196aAddress = arg1
...
function sub_56fc6e86(?) payable {
    require calldata.size - 4 >= 32
    if not uint8(stor8.field_160):
        return 100
    require ext_code.size(sub_e036196aAddress)
    staticcall sub_e036196aAddress.0xd0d2a7b0 with:
    ...
    if ext_call.return_data[0] > 115:
        revert with 0, 'Maximum increase is 15%'
    return ext_call.return_data[0]
}

function sub_c06ef3e7(?) payable {
    require calldata.size - 4 >= 64
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 >= 365:
        return 1800
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 >= 180:
        return 1300
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 >= 93:
        return 1125
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 >= 31:
        return 1040
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 >= 15:
        return 1020
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 >= 7:
        return 1010
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 >= 3:
        return 1005
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 >= 1:
        return 1001
    return 1000
}
