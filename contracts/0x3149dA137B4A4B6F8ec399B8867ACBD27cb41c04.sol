...
function sub_12e8c01c(?) payable {
    return sub_12e8c01cAddress
}
...
function sub_e95f0328(?) payable {
    ...
    if not arg1:
        ...
        call lPtokenAddress.0x23b872dd with:
             gas gas_remaining wei
            args msg.sender, sub_12e8c01cAddress, 0
    else:
        if 5 * arg1 / arg1 != 5:
            revert with 0, 'SafeMath: multiplication overflow'
        require ext_code.size(lPtokenAddress)
        call lPtokenAddress.0x23b872dd with:
             gas gas_remaining wei
            args msg.sender, sub_12e8c01cAddress, 5 * arg1 / 1000
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    require ext_code.size(sub_90350d00Address)
    call sub_90350d00Address.deposit(uint256 rg1, uint256 rg2) with:
         gas gas_remaining wei
        args PID, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
            ...
            if not arg1:
                ...
                if 0 / totalSupply:
                    if 0 / totalSupply <= 0:
                        revert with 0, 'amount too low'
                    require ext_code.size(sub_90350d00Address)
                    call sub_90350d00Address.withdraw(uint256 rg1, uint256 rg2) with:
                         gas gas_remaining wei
    ...
    if rewardTokenAddress == stor9:
        ...
        if mem[_511 + 44 len 20] == stor10:
            ...
            while idx < _636:
                ...
                t = t + 32
                continue 
            mem[_635 + 100] = this.address
            mem[_635 + 132] = block.timestamp
            require ext_code.size(routerAddress)
            call routerAddress.mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _635 + (32 * _636) + -mem[64] + 192]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _664 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
