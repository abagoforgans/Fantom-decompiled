                ...
                if ext_call.success:
                    ...
                    if ext_call.success:
                        ...
                        if ext_call.success:
                            ...
                            call 0x297fddc5c33ef988dd03bd13e162ae084ea1fe57.claim(address arg1, address[] arg2) with:
                                 gas gas_remaining wei
                                args address(this.address), Array(len=2, data=ext_call.return_data[196 len 64])
                            if ext_call.success:
                                require ext_code.size(0x49c93a95dbcc9a6a4d8f77e59c038ce5020e82f8)
                                call 0x49c93a95dbcc9a6a4d8f77e59c038ce5020e82f8.0xe9fad8ee with:
                                     gas gas_remaining wei
                                    ...
                                    while ext_call.success:
                                        ...
                                        if mem[192] > ext_call.return_data[0]:
                                            ...
                                            call address(ext_call.return_data[0]).repay(address arg1, uint256 arg2, uint256 arg3, address arg4) with:
                                                 gas gas_remaining wei
                                                args address(ext_call.return_data[0]), ext_call.return_data[0], 2, 0, this.address
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                                            require return_data.size >= 32
                                            require ext_code.size(0x6c793c628fe2b480c5e6fb7957dda4b9291f9c9b)
                                            ...
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                                            require return_data.size >= 32
                                            mem[228] = (20000 * ext_call.return_data[0]) - (ext_call.return_data[32] * ext_call.return_data[0]) / 10000
                                            ...
                                            call address(ext_call.return_data[0]).repay(address arg1, uint256 arg2, uint256 arg3, address arg4) with:
                                                 gas gas_remaining wei
                                                args address(ext_call.return_data[0]), mem[192], 2, 0, this.address
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                                            require return_data.size >= 32
                                            require ext_code.size(0x6c793c628fe2b480c5e6fb7957dda4b9291f9c9b)
                                            ...
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                                            require return_data.size >= 32
                                            mem[228] = (20000 * mem[192]) - (ext_call.return_data[32] * mem[192]) / 10000
                                            mem[260] = this.address
                                            require ext_code.size(address(ext_call.return_data[0]))
                                            call address(ext_call.return_data[0]).withdraw(address arg1, uint256 arg2, address arg3) with:
                                                 gas gas_remaining wei
                                                args address(ext_call.return_data[0]), (20000 * mem[192]) - (ext_call.return_data[32] * mem[192]) / 10000, this.address
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        require return_data.size >= 32
