...
#  - retireStrat()
#
const unirouter = 0x53c153a0df7e050bbefbb70ee9632061f12795fb
...
const shareRewardPool = 0x90df158ff7c31ad1d81dddb1d8ab9d0ecbceda20
...
function sub_793f9e88(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_793f9e88.length
    return sub_793f9e88[arg1]
}
...
function pause() payable {
    ...
    if ext_code.size(lpPairAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address rg1, uint256 rg2), 0x90df158ff7c31ad1d81dddb1, 0, 0
    call lpPairAddress.0xcbceda20 with:
         gas gas_remaining wei
        args 0, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address rg1, uint256 rg2), 0x90df158ff7c31ad1d81dddb1, 0, 0
        if not approve(address rg1, uint256 rg2), 0x90df158ff7c31ad1d81dddb1:
            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        if ext_code.size(0x575f8738efda7f512e3654f277c77e80c7d2725) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
        call 0x0575f8738efda7f512e3654f277c77e80c7d2725.0xf12795fb with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
            call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0xf12795fb with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if ext_code.size(lpToken0Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[752 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
                call lpToken0Address.0xf12795fb with:
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[916 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
                    call lpToken1Address.0xf12795fb with:
                         gas gas_remaining wei
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 917 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
                    call lpToken1Address.0xf12795fb with:
                         gas gas_remaining wei
                ...
                if ext_code.size(lpToken0Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 753 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
                ...
                if not return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 918 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, 0) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256
                    call lpToken1Address with:
                       funct Mask(8 * -floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 68, 224, 4045903355) >> 224, mem[(2 * ceil32(return_data.size)) + 822 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
                         gas gas_remaining wei
        ...
        if ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 589 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
        ...
        call lpToken0Address with:
           funct Mask(8 * -floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 68, 224, 4045903355) >> 224, mem[(2 * ceil32(return_data.size)) + 658 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if ext_code.size(lpToken1Address) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 918 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
            call lpToken1Address.0xf12795fb with:
                 gas gas_remaining wei
        ...
        if ext_code.size(lpToken1Address) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 919 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
    ...
    if ext_code.size(0x575f8738efda7f512e3654f277c77e80c7d2725) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
    ...
    call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83 with:
       funct Mask(8 * -floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 68, 224, 4045903355) >> 224, mem[(2 * ceil32(return_data.size)) + 494 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
         gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if ext_code.size(lpToken0Address) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + 754 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
        call lpToken0Address.0xf12795fb with:
             gas gas_remaining wei
    ...
    if ext_code.size(lpToken0Address) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 755 len 64] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, 0
    ...
    if ext_code.size(lpToken1Address) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[(4 * ceil32(return_data.size)) + 920 len floor32((6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = approve(address rg1, uint256 rg2), 0x53c153a0df7e050bbefbb70e, 0, mem[(4 * ceil32(return_data.size)) + 824 len floor32((6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36]
