...
const input = 0xdd94754c2bc621ef8de2fd7a9df2bc5283e9479

const output = 0x4d9361a86d038c8ada3db2457608e2275b3e08d4
...
function deposit() payable {
    ...
    require ext_code.size(0xdd94754c2bc621ef8de2fd7a9df2bc5283e9479)
    staticcall 0xdd94754c2bc621ef8de2fd7a9df2bc5283e9479.balanceOf(address arg1) with:
...
function beforeDeposit() payable {
    if harvestOnDeposit:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(0x4d9361a86d038c8ada3db2457608e2275b3e08d4)
        staticcall 0x4d9361a86d038c8ada3db2457608e2275b3e08d4.balanceOf(address arg1) with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0]:
            ...
            if not return_data.size:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if lpToken0Address != 0x4d9361a86d038c8ada3db2457608e2275b3e08d4:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                if lpToken1Address != 0x4d9361a86d038c8ada3db2457608e2275b3e08d4:
                    if not outputToLp1Route.length:
                        require ext_code.size(unirouterAddress)
                        call unirouterAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
