...
function sub_d525d806(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    require arg2 == bool(arg2)
    return 32, 8957, code.data[5849 len 8893], mem[9021 len 3] >> 70888, address(arg1), bool(arg2), 0 >> 71400, 0
}
...
function sub_f49126f8(?) payable {
    ...
    if feeds[address(arg1)]:
        revert with 0, 'PE'
    mem[9152 len 8896] = code.data[5849 len 8893], mem[9021 len 3]
    mem[18045 len 64] = address(arg1), bool(arg2)
    mem[18141] = address(arg1)
    mem[18109] = 20
    create2 contract with 0 wei
                    salt: sha3(address(arg1))
                    code: mem[9152 len mem[9120]]
    require ext_code.size(create2.new_address)
    create contract with 0 wei
                    code: code.data[5849 len 8893], address(create2.new_address), bool(arg2)
    if not create.new_address:
        revert with ext_call.return_data[0 len return_data.size]
    feeds[address(arg1)] = address(create.new_address)
    stor2.length++
