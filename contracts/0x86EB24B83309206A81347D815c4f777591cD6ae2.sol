...
function balanceOfPool() payable {
    require ext_code.size(address(stor20))
    staticcall address(stor20).userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
...
function deposit() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(stor20))
    call address(stor20).deposit(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function retireStrat() payable {
    if address(vaultAddress) != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(address(stor20))
    call address(stor20).emergencyWithdraw(uint256 arg1) with:
         gas gas_remaining wei
        args poolId
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function panic() payable {
    ...
    mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor20), uint32(stor20), 0
    mem[324 len 0] = 0
    call wantAddress with:
       funct uint32(stor20)
         gas gas_remaining wei
        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor20), uint32(stor20), 0) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor20), uint32(stor20), 0
        if not approve(address arg1, uint256 arg2), Mask(224, 0, stor20):
...
function unpause() payable {
    ...
    staticcall wantAddress.allowance(address arg1, address arg2) with:
            gas gas_remaining wei
           args address(this.address), address(stor20)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_code.size(wantAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor20), uint32(stor20), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    call wantAddress with:
       funct uint32(stor20)
         gas gas_remaining wei
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor20), uint32(stor20), -1
        if not approve(address arg1, uint256 arg2), Mask(224, 0, stor20):
            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
...
function withdraw(uint256 arg1) payable {
    ...
    require ext_code.size(address(stor20))
    call address(stor20).withdraw(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    if ext_call.return_data[0] >= arg4:
        ...
        if not stor27.length:
            ...
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor27.length
        else:
            mem[0] = 27
            mem[356] = address(stor27.field_0)
            idx = 356
            s = 0
            while (32 * stor27.length) + 356 > idx + 32:
            ...
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor27.length, mem[356 len 32 * stor27.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                mem[556] = 160
                mem[652] = stor27.length
                if not stor27.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor27.length
                else:
                    mem[0] = 27
                    mem[684] = address(stor27.field_0)
                    idx = 684
                    s = 0
                    while (32 * stor27.length) + 684 > idx + 32:
                        mem[idx + 32] = stor27[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor27.length, mem[684 len 32 * stor27.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                mem[ceil32(return_data.size) + 653] = stor27.length
                if not stor27.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                    ...
                    mem[0] = 27
                    mem[ceil32(return_data.size) + 685] = address(stor27.field_0)
                    idx = ceil32(return_data.size) + 685
                    s = 0
                    while ceil32(return_data.size) + (32 * stor27.length) + 685 > idx + 32:
                        mem[idx + 32] = stor27[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor27.length, mem[ceil32(return_data.size) + 685 len 32 * stor27.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            if not return_data.size:
                ...
                mem[(2 * ceil32(return_data.size)) + 654] = stor27.length
                if not stor27.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor27.length, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                else:
                    mem[0] = 27
                    mem[(2 * ceil32(return_data.size)) + 686] = address(stor27.field_0)
                    idx = (2 * ceil32(return_data.size)) + 686
                    s = 0
                    while (2 * ceil32(return_data.size)) + (32 * stor27.length) + 686 > idx + 32:
                        mem[idx + 32] = stor27[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor27.length, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) + (32 * stor27.length) - (2 * ceil32(return_data.size))]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
