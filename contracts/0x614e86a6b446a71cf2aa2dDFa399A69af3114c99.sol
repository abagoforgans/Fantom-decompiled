    ...
    if not return_data.size:
        ...
        if return_data.size <= 0:
                ...
                if wantLockedTotal <= 0:
                    ...
                    if not isAutoComp:
                        ...
                        if not return_data.size:
                            ...
                            staticcall farmContractAddress.userInfo(uint256 arg1, address arg2) with:
                                    gas gas_remaining wei
                                   args pid, address(this.address), mem[(2 * ceil32(return_data.size)) + 526 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 64
                        wantLockedTotal = ext_call.return_data[0]
                ...
                if not arg2:
                    ...
                    if not isAutoComp:
                        ...
                        if not return_data.size:
                            ...
                            staticcall farmContractAddress.userInfo(uint256 arg1, address arg2) with:
                                    gas gas_remaining wei
                                   args pid, address(this.address), mem[(2 * ceil32(return_data.size)) + 654 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 64
                        wantLockedTotal = ext_call.return_data[0]
            ...
            if not arg2:
                ...
                if sharesTotal <= 0:
                    ...
                    if not isAutoComp:
                        ...
                        if not return_data.size:
                            ...
                            staticcall farmContractAddress.userInfo(uint256 arg1, address arg2) with:
                                    gas gas_remaining wei
                                   args pid, address(this.address), mem[(2 * ceil32(return_data.size)) + 590 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 64
                        wantLockedTotal = ext_call.return_data[0]
                ...
                if not isAutoComp:
                    ...
                    if not return_data.size:
                        ...
                        staticcall farmContractAddress.userInfo(uint256 arg1, address arg2) with:
                                gas gas_remaining wei
                               args pid, address(this.address), mem[(2 * ceil32(return_data.size)) + 718 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 64
                    wantLockedTotal = ext_call.return_data[0]
            ...
            if not arg2 * sub_25c7ce6b / 10000 * sharesTotal:
                ...
                stor1 = 1
                return (0 / wantLockedTotal / 10000)
        ('iszero', ('iszero', ('mul', ('div', ('mul', ('param', 'arg2'), ('stor', ('name', 'sub_25c7ce6b', 23))), 10000), ('stor', ('name', 'sharesTotal', 17)))))
        require arg2 * sub_25c7ce6b / 10000 * sharesTotal
        if arg2 * sub_25c7ce6b / 10000 * sharesTotal * entranceFeeFactor / arg2 * sub_25c7ce6b / 10000 * sharesTotal != entranceFeeFactor:
            revert with 0, 
                        32,
