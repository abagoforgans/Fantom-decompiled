...
function withdraw(uint256 arg1, uint256 arg2) payable {
    ...
    if arg2 > 0:
        ...
        call sub_e64ce988Address.safeTransferFrom(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) with:
             gas gas_remaining wei
            args 0, 0, msg.sender, arg1, arg2, 160, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    if (userInfo[address(msg.sender)].field_0 * accTokenPerShare) - userInfo[address(msg.sender)].field_256 > 0:
        require ext_code.size(sub_7419f946Address)
        call sub_7419f946Address.0xa9059cbb with:
             gas gas_remaining wei
            args msg.sender, (userInfo[address(msg.sender)].field_0 * accTokenPerShare) - userInfo[address(msg.sender)].field_256
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
