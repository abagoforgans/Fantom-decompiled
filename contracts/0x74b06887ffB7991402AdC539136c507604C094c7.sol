...
const pairCodeHash = sha3(code.data[1823 len 8916])

const INIT_CODE_PAIR_HASH = sha3(code.data[1823 len 8896], mem[17984 len 12], Mask(64, 96, code.data[10731 len 8]) >> 96)
