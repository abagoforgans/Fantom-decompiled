...
function sub_422e49f7(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            ...
            _298 = sha3(mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512 len 128])
            ...
            if cd[68] > 1:
                revert with 'NH{q', 33
            if cd[68]:
                _320 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 224]
                t = 0
                while t < stor4.length:
                    ...
                    if idx >= ('cd', 4).length:
                        revert with 'NH{q', 50
                    mem[(32 * idx) + 128] = stor7 + (50 * _298 % 4) + (50 * _302)
                    if s > -stor7 + (-50 * _298 % 4) + (-50 * _302) - 1:
                        revert with 'NH{q', 17
                    if idx == -1:
                        revert with 'NH{q', 17
                    idx = idx + 1
                    s = s + stor7 + (50 * _298 % 4) + (50 * _302)
                    t = _298
                    continue 
                revert with 0, 'Wrong class for the Heal Action!'
            _321 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 224]
            t = 0
        ...
        while idx < ('cd', 4).length:
            ...
            while t < 128:
                ...
                continue 
            mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 480] = 128
            _301 = sha3(mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512 len 128])
            _306 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 256]
            if sha3(mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512 len 128]) % 4 > -mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 256] - 1:
                revert with 'NH{q', 17
            if (sha3(mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512 len 128]) % 4) + mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 256] and 50 > -1 / (sha3(mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512 len 128]) % 4) + mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 256]:
                revert with 'NH{q', 17
            ...
            if cd[68] > 1:
                revert with 'NH{q', 33
            if cd[68]:
                _322 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 224]
                t = 0
                while t < stor4.length:
                    mem[0] = 4
                    if stor4[t] != _322:
                    ...
                    if idx >= ('cd', 4).length:
                        revert with 'NH{q', 50
                    mem[(32 * idx) + 128] = stor7 + (50 * _301 % 4) + (50 * _306)
                    if s > -stor7 + (-50 * _301 % 4) + (-50 * _306) - 1:
                        revert with 'NH{q', 17
                    if idx == -1:
                        revert with 'NH{q', 17
                    idx = idx + 1
                    s = s + stor7 + (50 * _301 % 4) + (50 * _306)
                    t = _301
                    continue 
                revert with 0, 'Wrong class for the Heal Action!'
            _323 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 224]
            t = 0
            while t < stor5.length:
                mem[0] = 5
                if stor5[t] != _323:
