...
function sub_5f35adb0(?) payable {
    return sub_5f35adb0Address
}
...
function sub_b3d295e6(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_b3d295e6.length
    return sub_b3d295e6[arg1]
}
