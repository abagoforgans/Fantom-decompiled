...
function balanceOfPool() payable {
    require ext_code.size(address(stor18))
    staticcall address(stor18).0x93f1a40b with:
            gas gas_remaining wei
...
function deposit() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(stor18))
    call address(stor18).enterStaking(uint256 arg1) with:
         gas gas_remaining wei
...
function retireStrat() payable {
    ...
    require return_data.size >= 64
    require ext_code.size(address(stor18))
    call address(stor18).leaveStaking(uint256 arg1) with:
         gas gas_remaining wei
        args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function unpause() payable {
    ...
    staticcall wantAddress.0xdd62ed3e with:
            gas gas_remaining wei
           args address(this.address), address(stor18)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_code.size(wantAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    call wantAddress with:
       funct uint32(stor18)
         gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if return_data.size <= 0:
            ...
            if not return_data.size:
                ...
                staticcall address(stor18).0x93f1a40b with:
                        gas gas_remaining wei
                       args poolId, address(this.address), mem[(2 * ceil32(return_data.size)) + 494 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        else:
            require return_data.size >= 32
            if not mem[292]:
                revert with 0, 
...
function makeCustomTxn(address arg1, address arg2, address arg3, uint256 arg4) payable {
    ...
    if ext_call.return_data[0] >= arg4:
        ...
        idx = 96
        while 160 > idx:
            stor25[s].field_0 = mem[idx + 12 len 20]
            s = s + 1
            idx = idx + 32
            continue 
        idx = 2
        ...
        if not stor25.length:
            ...
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor25.length
        else:
            mem[0] = 25
            mem[356] = address(stor25.field_0)
            idx = 356
            s = 0
            while (32 * stor25.length) + 356 > idx + 32:
            ...
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor25.length, mem[356 len 32 * stor25.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                mem[556] = 160
                mem[652] = stor25.length
                if not stor25.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor25.length
                else:
                    mem[0] = 25
                    mem[684] = address(stor25.field_0)
                    idx = 684
                    s = 0
                    while (32 * stor25.length) + 684 > idx + 32:
                        mem[idx + 32] = stor25[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor25.length, mem[684 len 32 * stor25.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                mem[ceil32(return_data.size) + 653] = stor25.length
                if not stor25.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                    ...
                    mem[0] = 25
                    mem[ceil32(return_data.size) + 685] = address(stor25.field_0)
                    idx = ceil32(return_data.size) + 685
                    s = 0
                    while ceil32(return_data.size) + (32 * stor25.length) + 685 > idx + 32:
                        mem[idx + 32] = stor25[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor25.length, mem[ceil32(return_data.size) + 685 len 32 * stor25.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            if not return_data.size:
                ...
                mem[(2 * ceil32(return_data.size)) + 654] = stor25.length
                if not stor25.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor25.length, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                else:
                    mem[0] = 25
                    mem[(2 * ceil32(return_data.size)) + 686] = address(stor25.field_0)
                    idx = (2 * ceil32(return_data.size)) + 686
                    s = 0
                    while (2 * ceil32(return_data.size)) + (32 * stor25.length) + 686 > idx + 32:
                        mem[idx + 32] = stor25[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor25.length, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) + (32 * stor25.length) - (2 * ceil32(return_data.size))]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
