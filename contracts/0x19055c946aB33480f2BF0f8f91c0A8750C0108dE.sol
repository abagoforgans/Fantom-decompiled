...
function _setUnderlyingSymbols(address[] arg1, string[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        require cd[((32 * idx) + arg1 + 36)] == address(cd[((32 * idx) + arg1 + 36)])
        mem[32] = 5
        mem[0] = sha3(address(cd[((32 * idx) + arg1 + 36)]), 5)
        underlyingSymbols[address(cd[((32 * idx) + arg1 + 36)])] = (2 * cd[(arg2 + cd[(arg2 + (32 * idx) + 36)] + 36)]) + 1
        s = sha3(sha3(address(cd[((32 * idx) + arg1 + 36)]), 5))
        ...
        while arg2 + cd[(arg2 + (32 * idx) + 36)] + cd[(arg2 + cd[(arg2 + (32 * idx) + 36)] + 36)] + 68 > t:
            ...
            continue 
        t = s
        while sha3(sha3(address(cd[((32 * idx) + arg1 + 36)]), 5)) + (underlyingSymbols[address(cd[((32 * idx) + arg1 + 36)])].length + 31 / 32) > t:
            stor[t] = 0
            t = t + 1
            continue 
        require idx < arg1.length
