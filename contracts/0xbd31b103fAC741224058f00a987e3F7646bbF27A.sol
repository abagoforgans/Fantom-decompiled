...
address owner;
address sub_8475667eAddress;
address devaddr;
uint256 sub_cba25b2f;
address feeAddress;
...
function sub_8475667e(?) payable {
    return sub_8475667eAddress
}
        ...
        if ext_call.return_data[0]:
            if poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    require ext_code.size(sub_8475667eAddress)
                    call sub_8475667eAddress.0x40c10f19 with:
                         gas gas_remaining wei
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if (block.number * sub_cba25b2f) - (poolInfo[arg1].field_512 * sub_cba25b2f) / block.number - poolInfo[arg1].field_512 != sub_cba25b2f:
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not (block.number * sub_cba25b2f) - (poolInfo[arg1].field_512 * sub_cba25b2f):
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_code.size(sub_8475667eAddress)
                            call sub_8475667eAddress.0x40c10f19 with:
                            ...
                            if (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / (block.number * sub_cba25b2f) - (poolInfo[arg1].field_512 * sub_cba25b2f) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_code.size(sub_8475667eAddress)
                            call sub_8475667eAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devaddr, (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint / 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(sub_8475667eAddress)
                            call sub_8475667eAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args this.address, (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint:
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if 10^12 * (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (10^12 * (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
        poolInfo[arg1].field_512 = block.number
}

function sub_dce307c7(?) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(poolInfo[arg1].field_0)
    staticcall poolInfo[arg1].field_0.0x70a08231 with:
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        if userInfo[arg1][address(arg2)].field_256 > 0:
            revert with 0, 'SafeMath: subtraction overflow'
        return -userInfo[arg1][address(arg2)].field_256
    if (10^12 * (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((10^12 * (block.number * sub_cba25b2f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_cba25b2f * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
    ...
    while idx < poolInfo.length:
        ...
        if not block.number - poolInfo[idx].field_512:
            ...
            revert with memory
              from mem[64]
               len _269 + -mem[64] + 100
        if (block.number * sub_cba25b2f) - (poolInfo[idx].field_512 * sub_cba25b2f) / block.number - poolInfo[idx].field_512 != sub_cba25b2f:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (block.number * sub_cba25b2f) - (poolInfo[idx].field_512 * sub_cba25b2f):
            _192 = mem[64]
            mem[64] = mem[64] + 64
            mem[_192] = 26
            ...
            revert with memory
              from mem[64]
               len _283 + -mem[64] + 100
        if (block.number * sub_cba25b2f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_cba25b2f * poolInfo[idx].field_256) / (block.number * sub_cba25b2f) - (poolInfo[idx].field_512 * sub_cba25b2f) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _199 = mem[64]
        mem[64] = mem[64] + 64
        mem[_199] = 26
        ...
        call sub_8475667eAddress.0x40c10f19 with:
             gas gas_remaining wei
            args devaddr, (block.number * sub_cba25b2f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_cba25b2f * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * sub_cba25b2f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_cba25b2f * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(sub_8475667eAddress)
        call sub_8475667eAddress.0x40c10f19 with:
             gas gas_remaining wei
            args this.address, (block.number * sub_cba25b2f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_cba25b2f * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * sub_cba25b2f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_cba25b2f * poolInfo[idx].field_256) / totalAllocPoint:
            _264 = mem[64]
            mem[64] = mem[64] + 64
            mem[_264] = 26
            ...
            revert with memory
              from mem[64]
               len _280 + -mem[64] + 100
        if 10^12 * (block.number * sub_cba25b2f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_cba25b2f * poolInfo[idx].field_256) / totalAllocPoint / (block.number * sub_cba25b2f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_cba25b2f * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _279 = mem[64]
        mem[64] = mem[64] + 64
        mem[_279] = 26
        ...
        if ext_call.return_data[0]:
            if (10^12 * (block.number * sub_cba25b2f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_cba25b2f * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^12 * (block.number * sub_cba25b2f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_cba25b2f * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _296 = mem[64]
    ...
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][msg.sender].field_0:
            ...
            if -userInfo[arg1][msg.sender].field_256:
                require ext_code.size(sub_8475667eAddress)
                staticcall sub_8475667eAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if -userInfo[arg1][msg.sender].field_256 <= ext_call.return_data[0]:
                    call sub_8475667eAddress.0xa9059cbb with:
                         gas gas_remaining wei
