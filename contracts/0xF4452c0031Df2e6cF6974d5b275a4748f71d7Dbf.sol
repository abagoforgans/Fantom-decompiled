...
function sub_1b35a4a6(?) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    mem[ceil32(return_data.size) + 196] = sub_2074215dAddress
    mem[ceil32(return_data.size) + 228] = daiAddress
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
            gas gas_remaining wei
           args sub_2074215dAddress, daiAddress
    mem[ceil32(return_data.size) + 192] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function sub_23db4bbc(?) payable {
    ...
    staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
            gas gas_remaining wei
           args sub_2074215dAddress, usdcAddress
    mem[ceil32(return_data.size) + 192] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function sub_b634efe2(?) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    mem[ceil32(return_data.size) + 196] = sub_7edd3da5Address
    mem[ceil32(return_data.size) + 228] = usdcAddress
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
            gas gas_remaining wei
           args sub_7edd3da5Address, usdcAddress
    mem[ceil32(return_data.size) + 192] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function sub_b1c0c6e8(?) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    mem[ceil32(return_data.size) + 196] = sub_208b0a18Address
    mem[ceil32(return_data.size) + 228] = sub_7edd3da5Address
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
            gas gas_remaining wei
           args sub_208b0a18Address, sub_7edd3da5Address
    mem[ceil32(return_data.size) + 192] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function sub_edc808a3(?) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    mem[ceil32(return_data.size) + 196] = sub_f87c3c7aAddress
    mem[ceil32(return_data.size) + 228] = sub_7edd3da5Address
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
            gas gas_remaining wei
           args sub_f87c3c7aAddress, sub_7edd3da5Address
    mem[ceil32(return_data.size) + 192] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function getPriceInUSD(address arg1) payable {
    ...
    staticcall address(ext_call.return_data[0]).getPair(address arg1, address arg2) with:
            gas gas_remaining wei
           args address(arg1), sub_7edd3da5Address
    mem[ceil32(return_data.size) + 192] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if not ext_call.return_data[31 len 1]:
        ...
        mem[64] = mem[64] + 96
        mem[_375] = mem[_372]
        mem[_375 + 32] = mem[_372 + 32]
        mem[_375 + 64] = mem[_372 + 64]
        if not uint8(_343):
            if _334 and mem[_375] > -1 / _334:
                revert with 0, 17
            mem[mem[64]] = _334 * mem[_375]
        else:
            if bool(bool(uint8(_343) < 78)) or bool(bool(uint8(_343) < 32)):
                ...
                if not 10^uint8(_343):
                    revert with 0, 18
                mem[mem[64]] = _334 * mem[_375] / 10^uint8(_343)
            else:
                s = 10
                t = 1
                idx = uint8(_343)
        ...
        if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
            ...
            if not uint8(_342):
                if _331 and mem[_374] > -1 / _331:
                    revert with 0, 17
                mem[mem[64]] = _331 * mem[_374]
            else:
                if bool(bool(uint8(_342) < 78)) or bool(bool(uint8(_342) < 32)):
                    ...
                    if not 10^uint8(_342):
                        revert with 0, 18
                    mem[mem[64]] = _331 * mem[_374] / 10^uint8(_342)
                else:
                    s = 10
                    t = 1
                    idx = uint8(_342)
