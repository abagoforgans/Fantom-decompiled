...
function sub_00f529c9(?) payable {
    ...
    staticcall address(coreAddress).getReserveConfiguration(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    staticcall addressesProvider.getPriceOracle() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function getReserveConfigurationData(address arg1) payable {
    ...
    require return_data.size >= 128
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveIsStableBorrowRateEnabled(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveLiquidationBonus(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveInterestRateStrategyAddress(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function calculateCollateralNeededInETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6) payable {
    ...
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveDecimals(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getReserveData(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveTotalLiquidity(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveTotalBorrowsStable(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveTotalBorrowsVariable(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveCurrentVariableBorrowRate(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveCurrentAverageStableBorrowRate(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveUtilizationRate(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveLiquidityCumulativeIndex(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveVariableBorrowsCumulativeIndex(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require ext_code.size(address(coreAddress))
    staticcall address(coreAddress).getReserveLastUpdate(address arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getUserReserveData(address arg1, address arg2) payable {
    ...
    if ext_call.return_data[0] == 1:
        ...
        if ext_call.return_data[0] != 2:
            ...
            require return_data.size >= 32
            require ext_code.size(address(coreAddress))
            staticcall address(coreAddress).getUserVariableBorrowCumulativeIndex(address arg1, address arg2) with:
                    gas gas_remaining wei
                   args address(arg1), arg2
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(address(coreAddress))
            staticcall address(coreAddress).getUserLastUpdate(address arg1, address arg2) with:
                    gas gas_remaining wei
                   args address(arg1), arg2
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(address(coreAddress))
            staticcall address(coreAddress).isUserUseReserveAsCollateralEnabled(address arg1, address arg2) with:
                    gas gas_remaining wei
                   args address(arg1), arg2
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function getUserAccountData(address arg1) payable {
    ...
    while idx < _4347:
        ...
        require ext_code.size(address(coreAddress))
        staticcall address(coreAddress).getUserBasicReserveData(address arg1, address arg2) with:
                gas gas_remaining wei
