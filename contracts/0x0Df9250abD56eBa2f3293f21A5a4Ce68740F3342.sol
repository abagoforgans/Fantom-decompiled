...
function deposit(uint256 arg1, uint256 arg2) payable {
    ...
    if arg2:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(poolInfo[arg1].field_0):
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = 0, poolInfo[arg1].field_256, Mask(224, 32, arg2 + ext_call.return_data[0]) >> 32
            call poolInfo[arg1].field_0 with:
               funct poolInfo[arg1].field_256
                 gas gas_remaining wei
                args arg2 + ext_call.return_data[0], mem[392 len 24], 0, mem[520 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg2
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            ...
            if not return_data.size:
                ...
                if not ext_code.size(poolInfo[arg1].field_0):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 457 len 64] = 0, poolInfo[arg1].field_256, Mask(224, 32, arg2 + ext_call.return_data[0]) >> 32
                mem[ceil32(return_data.size) + 549 len 4] = 0
                call poolInfo[arg1].field_0 with:
                   funct poolInfo[arg1].field_256
                     gas gas_remaining wei
                    args arg2 + ext_call.return_data[0], mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 521 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg2
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                ...
                if ext_call.return_data[0] + userInfo[arg1][msg.sender] < userInfo[arg1][msg.sender]:
                    revert with 0, 'SafeMath: addition overflow'
        ('ge', ('add', ('ext_call.return_data', 0, 32), ('stor', ('map', 'msg.sender', ('map', ('param', 'arg1'), ('name', 'userInfo', 4))))), ('stor', ('map', 'msg.sender', ('map', ('param', 'arg1'), ('name', 'userInfo', 4)))))
            ...
            if ext_call.return_data[0] <= userInfo[arg1][msg.sender]:
                ...
                if ext_call.return_data[0] >= -1:
                    ...
                    call poolInfo[arg1].field_0 with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                        args Mask(480, -256, unknown_0xa9059cbb(?????), msg.sender, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[324 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with unknown_0xa9059cbb(?????), msg.sender, -1
                        if not unknown_0xa9059cbb(?????), Mask(224, 32, msg.sender) >> 32:
