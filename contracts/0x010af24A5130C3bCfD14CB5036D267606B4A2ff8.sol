...
function sub_53de57e5(?) payable {
    ...
    if not ext_call.return_data[0]:
        revert with 0, 18
    if arg2 / ext_call.return_data[0] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] < 10^18 * arg2 / ext_call.return_data[0]:
        revert with 0, 'withdrawFromVault: not enough funds in vault'
    require ext_code.size(sub_c72cadceAddress)
    call sub_c72cadceAddress.0x23b872dd with:
         gas gas_remaining wei
        args address(arg1), this.address, 10^18 * arg2 / ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function sub_dce03fa6(?) payable {
    ...
    if not ext_call.return_data[0]:
        revert with 0, 18
    if arg1 / ext_call.return_data[0] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    require ext_code.size(sub_c72cadceAddress)
    staticcall sub_c72cadceAddress.0x70a08231 with:
            gas gas_remaining wei
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] < 10^18 * arg1 / ext_call.return_data[0]:
        revert with 0, 'withdrawFromVault: not enough funds in vault'
    require ext_code.size(sub_c72cadceAddress)
    call sub_c72cadceAddress.0x23b872dd with:
         gas gas_remaining wei
        args msg.sender, this.address, 10^18 * arg1 / ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
