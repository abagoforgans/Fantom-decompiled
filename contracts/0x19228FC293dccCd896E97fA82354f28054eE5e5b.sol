...
function mintToken(string arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    ...
    if contractOwner != msg.sender:
        revert with 0, 'Only owner can mint new token'
    ...
    if stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])]:
        revert with 0, 'A mint already exists for the informed chargeId'
...
function tokenURI(uint256 arg1) {
    ...
    mem[96] = 36
    mem[128 len 36] = 0xfe68747470733a2f2f7069782d6e66742e76657263656c2e6170702f6170692f6e667473
    if not arg1:
        mem[288 len 64] = 0xfe68747470733a2f2f7069782d6e66742e76657263656c2e6170702f6170692f6e667473, mem[164 len 28]
        mem[324] = '0'
        mem[325] = 32
        mem[357] = mem[256]
        mem[389 len ceil32(mem[256])] = mem[288 len ceil32(mem[256])]
        if ceil32(mem[256]) > mem[256]:
            mem[mem[256] + 389] = 0
        return Array(len=mem[256], data=mem[389 len ceil32(mem[256])])
    s = 0
    idx = arg1
    while idx:
        if s == -1:
