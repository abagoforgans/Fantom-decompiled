...
function sub_70e661b3(?) payable {
    require calldata.size - 4 >= 32
    return sub_70e661b3[arg1].field_0, sub_70e661b3[arg1].field_256, sub_70e661b3[arg1].field_512
}
...
function lockedAmount(address arg1, uint256 arg2) payable {
    ...
    staticcall address(sub_7664a7e8[stor0[arg2]]).0x70a08231 with:
...
function withdraw(address arg1, uint256 arg2, uint256 arg3) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(sub_7664a7e8[ext_call.return_data[12 len 20]]))
    call address(sub_7664a7e8[ext_call.return_data[12 len 20]]).0x2e1a7d4d with:
         gas gas_remaining wei
        args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit(address arg1, uint256 arg2, uint256 arg3) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(sub_7664a7e8[ext_call.return_data[12 len 20]]))
    call address(sub_7664a7e8[ext_call.return_data[12 len 20]]).deposit(uint256 arg1) with:
         gas gas_remaining wei
        args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
