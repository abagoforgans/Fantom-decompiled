...
const sub_8287fd4a(?) = 160000000 * 10^18
...
function burnMultisig() payable {
    if multisigAddress != msg.sender:
        revert with 0, 'must be multisig to burn'
    multisigAddress = 0
}

function updateMultisig(address arg1) payable {
    require calldata.size - 4 >= 32
    if multisigAddress != msg.sender:
        revert with 0, 'must be multisig to update'
    if not arg1:
        revert with 0, 'can't use zero address'
...
function mint(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    if multisigAddress != msg.sender:
        revert with 0, 'must be multisig to mint'
    if not arg1:
