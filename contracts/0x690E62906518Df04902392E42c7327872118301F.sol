...
function sub_564193cc(?) {
    ...
    call sub_80302093Address.mint(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function sub_2ec91737(?) {
    ...
    mem[260 len 64] = transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, Mask(224, 32, arg1) >> 32
    call tokenAddress with:
         gas gas_remaining wei
        args Mask(224, 32, arg1) << 224, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, arg1
...
function sendToken(uint256 arg1) {
    ...
    staticcall sub_32ca2876Address.balanceOf(address arg1) with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if bool(stor11[address(msg.sender)]) == 1:
        require ext_code.size(sub_80302093Address)
        call sub_80302093Address.burn(address arg1, uint256 arg2) with:
             gas gas_remaining wei
        ...
        if tokenFeeAddress != tokenAddress:
            ...
            if ext_code.size(tokenFeeAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[292 len 96] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, treasureAddress, Mask(224, 0, stor16.field_32)
            mem[416 len 4] = 0
            mem[388 len 0] = 0
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, treasureAddress, bridgeFee
