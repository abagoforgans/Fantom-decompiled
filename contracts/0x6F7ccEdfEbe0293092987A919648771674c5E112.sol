...
function onFlashLoan(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if 1 == bool(cd[(arg5 + 36)]):
        ...
        if stor3 == address(cd[(arg5 + 228)]):
            ...
            require return_data.size >= 32
            _422 = mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32
            ...
            _425 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32 + 448]
            ...
            mem[(4 * ceil32(return_data.size)) + 480 len 32 * _425] = mem[(2 * ceil32(return_data.size)) + _422 + 480 len 32 * _425]
            mem[mem[64] + 4] = this.address
            ...
            if mem[_841 + 12 len 20] == address(cd[(arg5 + 100)]):
                ...
                mem[_994 + 132] = block.timestamp + 1
                require ext_code.size(address(cd[(arg5 + 196)]))
                call address(cd[(arg5 + 196)]).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _994 + (32 * _997) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1213 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if mem[_858 + 12 len 20] == address(cd[(arg5 + 100)]):
                    ...
                    while idx < _1033:
                        ...
                        t = t + 32
                        continue 
                    mem[_1028 + 100] = this.address
                    mem[_1028 + 132] = block.timestamp + 1
                    require ext_code.size(address(cd[(arg5 + 196)]))
                    call address(cd[(arg5 + 196)]).mem[mem[64] len 4] with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len _1028 + (32 * _1033) + -mem[64] + 192]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1211 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if stor2 == address(cd[(arg5 + 228)]):
                ...
                mem[64] = (4 * ceil32(return_data.size)) + 448
                require return_data.size >= 32
                _421 = mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32
                require mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32 <= test266151307()
                require (2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32 + 479 < (2 * ceil32(return_data.size)) + return_data.size + 448
                _424 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32 + 448]
                require mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32 + 448] <= test266151307()
                require (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32 + 448]) + 32 >= 0 and (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32 + 448]) + 480 <= test266151307()
                mem[64] = (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32 + 448]) + 480
                mem[(4 * ceil32(return_data.size)) + 448] = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 448 len 4], Mask(224, 32, arg3) >> 32 + 448]
                require return_data.size >= _421 + (32 * _424) + 32
                mem[(4 * ceil32(return_data.size)) + 480 len 32 * _424] = mem[(2 * ceil32(return_data.size)) + _421 + 480 len 32 * _424]
                mem[mem[64] + 4] = this.address
                require ext_code.size(address(cd[(arg5 + 100)]))
                staticcall address(cd[(arg5 + 100)]).balanceOf(address rg1) with:
                        gas gas_remaining wei
                ...
                while idx < _852:
                    ...
                    t = t + 32
                    continue 
                mem[_849 + 100] = this.address
                mem[_849 + 132] = block.timestamp + 1
                require ext_code.size(address(cd[(arg5 + 228)]))
                call address(cd[(arg5 + 228)]).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _849 + (32 * _852) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1210 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        if not cd[(arg5 + 36)]:
            ...
            if mem[_839 + 12 len 20] == address(cd[(arg5 + 100)]):
                ...
                mem[_1495 + 132] = block.timestamp + 1
                require ext_code.size(address(cd[(arg5 + 196)]))
                call address(cd[(arg5 + 196)]).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _1495 + (32 * _1499) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1571 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if mem[_856 + 12 len 20] != address(cd[(arg5 + 100)]):
                    ...
                    while idx < _1498:
                        ...
                        t = t + 32
                        continue 
                    mem[_1494 + 100] = this.address
                    mem[_1494 + 132] = block.timestamp + 1
                    require ext_code.size(address(cd[(arg5 + 196)]))
                    call address(cd[(arg5 + 196)]).mem[mem[64] len 4] with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len _1494 + (32 * _1498) + -mem[64] + 192]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1570 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
