...
function sub_ec4a61b2(?) payable {
    return address(sub_ec4a61b2Address)
}
...
function balanceOfPool() payable {
    ...
    staticcall gaugeAddress.0x70a08231 with:
            gas gas_remaining wei
           args address(sub_ec4a61b2Address)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return ext_call.return_data[0]
...
function getHarvestable() payable {
    require ext_code.size(gaugeAddress)
    staticcall gaugeAddress.rewards(address arg1) with:
            gas gas_remaining wei
           args address(sub_ec4a61b2Address)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
            ...
            if return_data.size:
                ...
                if not mem[292]:
                    revert with 0, 
                                ...
                                0x6c5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                mem[ceil32(return_data.size) + 371 len 22]
        require ext_code.size(address(sub_ec4a61b2Address))
        call address(sub_ec4a61b2Address).deposit(address arg1, address arg2) with:
             gas gas_remaining wei
            args gaugeAddress, wantAddress
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
...
function withdrawAll() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(sub_ec4a61b2Address))
    call address(sub_ec4a61b2Address).withdraw(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
        args gaugeAddress, wantAddress, ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(wantAddress)
    staticcall wantAddress.0x70a08231 with:
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        call address(sub_ec4a61b2Address).withdraw(address arg1, address arg2, uint256 arg3) with:
             gas gas_remaining wei
            args gaugeAddress, wantAddress, arg1 - ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function harvest() payable {
    if stor3[msg.sender]:
        require ext_code.size(address(sub_ec4a61b2Address))
        call address(sub_ec4a61b2Address).0x354dd5c3 with:
             gas gas_remaining wei
            args gaugeAddress
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
