...
function safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) payable {
    ...
    if arg1 == msg.sender:
        ...
        mem[(32 * _16176) + (32 * _15714) + mem[64] + 260 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])] = mem[(32 * arg3.length) + (32 * arg4.length) + 192 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])]
        if not _16402 % 32:
            require ext_code.size(arg2)
            call arg2.0xbc197c81 with:
                 gas gas_remaining wei
                args msg.sender, address(arg1), 160, mem[mem[64] + 100], (32 * _16176) + (32 * _15714) + 224, mem[mem[64] + 164 len _16402 + (32 * _16176) + (32 * _15714) + 96]
            ...
            revert with 0, 32, mem[mem[64] + 36 len floor32(_16696) + 64]
        mem[floor32(_16402) + (32 * _16176) + (32 * _15714) + mem[64] + 260] = mem[floor32(_16402) + (32 * _16176) + (32 * _15714) + mem[64] + -(_16402 % 32) + 292 len _16402 % 32]
        require ext_code.size(arg2)
        call arg2.0xbc197c81 with:
             gas gas_remaining wei
            args msg.sender, address(arg1), 160, mem[mem[64] + 100], (32 * _16176) + (32 * _15714) + 224, mem[mem[64] + 164 len floor32(_16402) + (32 * _16176) + (32 * _15714) + 128]
        mem[mem[64]] = ext_call.return_data[0]
        if ext_call.success:
            require return_data.size >= 32
            if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
    ...
    while idx < allProxyRegistries.length:
        ...
        idx = 0
        while idx < 32 * _16408:
            mem[idx + (32 * mem[96]) + mem[64] + 228] = mem[idx + (32 * arg3.length) + 160]
            idx = idx + 32
            continue 
        mem[mem[64] + 132] = (32 * _16408) + (32 * _16191) + 224
        mem[(32 * _16408) + (32 * _16191) + mem[64] + 228] = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
        _16619 = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
        idx = 0
        while idx < _16619:
            mem[idx + (32 * _16408) + (32 * _16191) + mem[64] + 260] = mem[idx + (32 * arg3.length) + (32 * arg4.length) + 192]
            idx = idx + 32
            continue 
        if not _16619 % 32:
            require ext_code.size(arg2)
            call arg2.mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len 128], (32 * _16408) + (32 * _16191) + 224, mem[mem[64] + 164 len _16619 + (32 * _16408) + (32 * _16191) + 96]
            mem[mem[64]] = ext_call.return_data[0]
            if ext_call.success:
                require return_data.size >= 32
                if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
            ...
            if not mem[_16856 + ext_call.return_data[0]]:
                ...
                while idx < _16887:
                    ...
                    continue 
                if not _16887 % 32:
                    revert with 0, 32, mem[mem[64] + 36 len _16887 + 32]
                mem[floor32(_16887) + mem[64] + 68] = mem[floor32(_16887) + mem[64] + -(_16887 % 32) + 100 len _16887 % 32]
            revert with 0, 32, mem[mem[64] + 36 len floor32(_16887) + 64]
        mem[floor32(_16619) + (32 * _16408) + (32 * _16191) + mem[64] + 260] = mem[floor32(_16619) + (32 * _16408) + (32 * _16191) + mem[64] + -(_16619 % 32) + 292 len _16619 % 32]
        require ext_code.size(arg2)
        call arg2.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len 128], (32 * _16408) + (32 * _16191) + 224, mem[mem[64] + 164 len floor32(_16619) + (32 * _16408) + (32 * _16191) + 128]
        mem[mem[64]] = ext_call.return_data[0]
        if ext_call.success:
            require return_data.size >= 32
            if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
    ...
    mem[(32 * mem[96]) + mem[64] + 228 len floor32(mem[(32 * arg3.length) + 128])] = mem[(32 * arg3.length) + 160 len floor32(mem[(32 * arg3.length) + 128])]
    mem[mem[64] + 132] = (32 * _16405) + (32 * mem[96]) + 224
    mem[(32 * _16405) + (32 * mem[96]) + mem[64] + 228] = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
    ...
    if not _16616 % 32:
        ...
        call arg2.0xbc197c81 with:
             gas gas_remaining wei
            args msg.sender, address(arg1), 160, mem[mem[64] + 100 len _16616 + (32 * _16405) + (32 * _16188) + 160]
        mem[mem[64]] = ext_call.return_data[0]
        if ext_call.success:
            require return_data.size >= 32
            if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
    ...
    call arg2.0xbc197c81 with:
         gas gas_remaining wei
        args msg.sender, address(arg1), 160, mem[mem[64] + 100 len floor32(_16616) + (32 * _16405) + (32 * _16188) + 192]
    mem[mem[64]] = ext_call.return_data[0]
    if ext_call.success:
        require return_data.size >= 32
        if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
    ...
    if not mem[_16861 + ext_call.return_data[0]]:
        ...
        revert with 0, 32, mem[mem[64] + 36], 160, mem[mem[64] + 100 len floor32(_16899)]
