...
function mint(uint8 arg1) payable {
    ...
    while idx < arg1:
        ...
        if bool(stor9.length):
            if bool(stor9.length) == uint255(stor9.length.field_1) < 32:
                revert with 'NH{q', 34
            _165 = mem[64]
            mem[64] = mem[64] + ceil32(uint255(stor9.length.field_1)) + 32
            mem[_165] = uint255(stor9.length.field_1)
            if bool(stor9.length):
                if bool(stor9.length) == uint255(stor9.length.field_1) < 32:
                    revert with 'NH{q', 34
                if uint255(stor9.length.field_1):
                    if 31 >= uint255(stor9.length.field_1):
                        mem[_165 + 32] = 256 * Mask(248, 0, stor9.length.field_8)
                    else:
                        mem[_165 + 32] = uint256(stor9.field_0)
                        s = _165 + 32
                        t = sha3(9)
                        while _165 + uint255(stor9.length.field_1) > s:
                ...
                if bool(stor6[stor8].field_0):
                    if bool(stor6[stor8].field_0) == uint255(stor6[stor8].field_1) < 32:
                        revert with 'NH{q', 34
                    mem[0] = sha3(stor8, 6)
                    if not uint255(stor9.length.field_1):
                        ...
                        stor6[stor8].field_0 = (2 * uint255(stor9.length.field_1)) + 1
                        t = sha3(sha3(stor8, 6))
                        s = _165 + 32
                        while _165 + uint255(stor9.length.field_1) + 32 > s:
                            stor[t] = mem[s]
                            t = t + 1
                            s = s + 32
                            continue 
                        s = sha3(sha3(stor8, 6)) + (Mask(251, 0, uint255(stor9.length.field_1) + 31) >> 5)
                        while sha3(sha3(stor8, 6)) + (uint255(stor6[stor8].field_1) + 31 / 32) > s:
                            stor[s] = 0
                            s = s + 1
                            continue 
            ...
            s = _165 + 32
            t = sha3(9)
            while _165 + stor9.length.field_1 % 128 > s:
                mem[s + 32] = stor1[t].field_0
                s = s + 32
                t = t + 1
                continue 
        ...
        if bool(stor9.length) == stor9.length.field_1 % 128 < 32:
            revert with 'NH{q', 34
        _166 = mem[64]
        mem[64] = mem[64] + ceil32(stor9.length.field_1 % 128) + 32
        mem[_166] = stor9.length.field_1 % 128
        if bool(stor9.length):
            if bool(stor9.length) == uint255(stor9.length.field_1) < 32:
                revert with 'NH{q', 34
            if not uint255(stor9.length.field_1):
                ...
                if bool(stor6[stor8].field_0):
                    ...
                    if not stor9.length.field_1 % 128:
                        ...
                        stor6[stor8].field_0 = (2 * stor9.length.field_1 % 128) + 1
                        t = sha3(sha3(stor8, 6))
                        s = _166 + 32
                        while _166 + stor9.length.field_1 % 128 + 32 > s:
                            stor[t] = mem[s]
                            t = t + 1
                            s = s + 32
                            continue 
                        s = sha3(sha3(stor8, 6)) + (Mask(251, 0, stor9.length.field_1 % 128 + 31) >> 5)
                        while sha3(sha3(stor8, 6)) + (uint255(stor6[stor8].field_1) + 31 / 32) > s:
                            stor[s] = 0
                            s = s + 1
                            continue 
                ...
                continue 
            if 31 >= uint255(stor9.length.field_1):
                mem[_166 + 32] = 256 * Mask(248, 0, stor9.length.field_8)
                if not ownerOf[stor8]:
                    revert with 0, 'ERC721URIStorage: URI set of nonexistent token'
                mem[32] = 6
                if bool(stor6[stor8].field_0):
                ...
                idx = idx + 1
                continue 
            mem[_166 + 32] = uint256(stor9.field_0)
            s = _166 + 32
            t = sha3(9)
            while _166 + uint255(stor9.length.field_1) > s:
                mem[s + 32] = stor1[t].field_0
                s = s + 32
                t = t + 1
                continue 
        ...
        if not stor9.length.field_1 % 128:
            ...
            if 31 >= stor9.length.field_1 % 128:
                ...
                s = _166 + 32
                t = sha3(9)
                while _166 + stor9.length.field_1 % 128 > s:
                    mem[s + 32] = stor1[t].field_0
                    s = s + 32
                    t = t + 1
                    continue 
