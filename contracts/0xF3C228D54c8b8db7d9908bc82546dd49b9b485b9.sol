...
function permit(address arg1, address arg2, uint256 arg3, uint256 arg4, uint8 arg5, bytes32 arg6, bytes32 arg7) payable {
    ...
    if arg4 < block.timestamp:
        revert with 0, 'OperaSwap: EXPIRED'
    nonces[address(arg1)]++
    ...
    if not address(signer):
        revert with 0, 'OperaSwap: INVALID_SIGNATURE'
...
function sync() payable {
    if stor12 != 1:
        revert with 0, 'OperaSwap: LOCKED'
    stor12 = 0
    ...
    if ext_call.return_data[0] > test266151307():
        revert with 0, 'OperaSwap: OVERFLOW'
    if ext_call.return_data[0] > test266151307():
        revert with 0, 'OperaSwap: OVERFLOW'
...
function skim(address arg1) payable {
    ...
    if not return_data.size:
        ...
        revert with 0, 'OperaSwap: TRANSFER_FAILED'
    ...
    if ext_call.return_data[0] - Mask(112, 0, stor8.field_112) > ext_call.return_data[0]:
        revert with 0, 'ds-math-sub-underflow'
    mem[ceil32(return_data.size) + 425 len 64] = unknown_0xa9059cbb(?????), address(arg1) << 64, 0, Mask(224, 32, ext_call.return_data[0] - Mask(112, 0, stor8.field_112)) >> 32
