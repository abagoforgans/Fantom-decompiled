...
function setCanRoute(address arg1, bool arg2) {
    ...
    emit SetCanRoute(msg.sender, arg1, bool(stor9[address(arg1)]));
}
...
function lock(string arg1, bytes arg2) payable {
    ...
    require return_data.size >= 32
    _71 = mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, msg.value) >> 32
    ...
    _72 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, msg.value) >> 32 + 192]
    ...
    idx = 0
    s = ceil32(return_data.size) + _71 + 224
    ...
    if 1 >= _72:
        revert with 'NH{q', 50
    _139 = mem[(2 * ceil32(return_data.size)) + 256]
    if mem[(2 * ceil32(return_data.size)) + 256] and stor5[arg1[all]] > -1 / mem[(2 * ceil32(return_data.size)) + 256]:
        revert with 'NH{q', 17
    mem[mem[64] len arg1.length] = arg1[all]
    mem[mem[64] + arg1.length] = 4
    if _139 * stor5[arg1[all]] / 100000 > stor4[arg1[all]]:
        if 1 >= _72:
            revert with 'NH{q', 50
        _145 = mem[(2 * ceil32(return_data.size)) + 256]
        if mem[(2 * ceil32(return_data.size)) + 256] < _139 * stor5[arg1[all]] / 100000:
            revert with 'NH{q', 17
        if 0 >= _72:
            revert with 'NH{q', 50
        _151 = mem[(2 * ceil32(return_data.size)) + 224]
        if 1 >= _72:
            revert with 'NH{q', 50
        _153 = mem[(2 * ceil32(return_data.size)) + 256]
        mem[mem[64]] = mem[(2 * ceil32(return_data.size)) + 224]
        mem[mem[64] + 64] = stor4[arg1[all]]
        mem[mem[64] + 96] = stor5[arg1[all]]
        mem[mem[64] + 128] = _139 * stor5[arg1[all]] / 100000
        mem[mem[64] + 160] = _145 - (_139 * stor5[arg1[all]] / 100000)
        emit CalculateFee(_151, _153, stor4[arg1[all]], stor5[arg1[all]], _139 * stor5[arg1[all]] / 100000, _145 - (_139 * stor5[arg1[all]] / 100000));
        if _145 - (_139 * stor5[arg1[all]] / 100000) <= 0:
            revert with 0, 'R4'
        ...
        mem[_188 + ceil32(arg1.length) + 128] = arg2.length
        mem[_188 + ceil32(arg1.length) + 160 len arg2.length] = arg2[all]
        mem[_188 + ceil32(arg1.length) + arg2.length + 160] = 0
        mem[_188 + 64] = _145 - (_139 * stor5[arg1[all]] / 100000)
        emit Lock(string arg1, bytes arg2, string arg3, bytes arg4, uint256 arg5):
                  mem[mem[64] len _188 + ceil32(arg1.length) + ceil32(arg2.length) + -mem[64] + 160],
                  sha3(arg1[all]),
                  sha3(arg2[all]),
    else:
        mem[mem[64] len arg1.length] = arg1[all]
        ...
        if 0 >= _72:
            revert with 'NH{q', 50
        _156 = mem[(2 * ceil32(return_data.size)) + 224]
        if 1 >= _72:
            revert with 'NH{q', 50
        ...
        mem[mem[64] + 96] = stor5[arg1[all]]
        mem[mem[64] + 128] = _139 * stor5[arg1[all]] / 100000
        mem[mem[64] + 160] = _149 - stor4[arg1[all]]
        emit CalculateFee(_156, _158, stor4[arg1[all]], stor5[arg1[all]], _139 * stor5[arg1[all]] / 100000, _149 - stor4[arg1[all]]);
        if _149 - stor4[arg1[all]] <= 0:
            revert with 0, 'R4'
        mem[mem[64] len arg2.length] = arg2[all]
        mem[mem[64] + arg2.length] = 0
        mem[mem[64] len arg1.length] = arg1[all]
        ...
        mem[mem[64] + arg1.length + 128] = 0
        mem[mem[64] + 32] = ceil32(arg1.length) + 128
        mem[_191 + ceil32(arg1.length) + 128] = arg2.length
        mem[_191 + ceil32(arg1.length) + 160 len arg2.length] = arg2[all]
        mem[_191 + ceil32(arg1.length) + arg2.length + 160] = 0
        mem[_191 + 64] = _149 - stor4[arg1[all]]
        emit Lock(string arg1, bytes arg2, string arg3, bytes arg4, uint256 arg5):
                  mem[mem[64] len _191 + ceil32(arg1.length) + ceil32(arg2.length) + -mem[64] + 160],
                  sha3(arg1[all]),
                  sha3(arg2[all]),
}
