...
function zapandstake(uint256 arg1, address arg2, address arg3, uint256 arg4, uint256 arg5) {
    ...
    if not sub_2cde2aaa[address(ext_call.return_data[0])]:
        if block.timestamp + 600 < block.timestamp:
            revert with 0, 'w'
        mem[160] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
        ...
        mem[356 len floor32(ext_call.return_data[0])] = mem[128 len floor32(ext_call.return_data[0])]
        require ext_code.size(ROUTERAddress)
        call ROUTERAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args 0, ext_call.return_data[28 len 4], 0, 160, address(this.address), block.timestamp + 600, ext_call.return_data[0], mem[356 len 32 * ext_call.return_data[0]]
    else:
        if not sub_2cde2aaa[address(ext_call.return_data[0])]:
            if block.timestamp + 600 < block.timestamp:
                revert with 0, 'w'
            ...
            mem[160] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
            mem[164] = ext_call.return_data[0]
            mem[196] = ext_call.return_data[0] * sub_2cde2aaa[address(ext_call.return_data[0])]
            mem[260] = this.address
            mem[292] = block.timestamp + 600
            mem[228] = 160
            mem[324] = ext_call.return_data[0]
            ...
            call ROUTERAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, ext_call.return_data[28 len 4], ext_call.return_data[0] * sub_2cde2aaa[address(ext_call.return_data[0])], 160, address(this.address), block.timestamp + 600, ext_call.return_data[0], mem[356 len 32 * ext_call.return_data[0]]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(sub_2e73b45bAddress)
    staticcall sub_2e73b45bAddress.0x70a08231 with:
