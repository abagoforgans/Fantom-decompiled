...
function withdraw(uint256 arg1) payable {
    ...
    if arg1 >= ext_call.return_data[0]:
        mem[292 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), Mask(224, 32, arg1) >> 32
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if not ext_code.size(stakingTokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[684 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), Mask(224, 32, arg1) >> 32
                call stakingTokenAddress with:
                   funct uint32(stor6)
                     gas gas_remaining wei
                ...
                if not ext_code.size(stakingTokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 685 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), Mask(224, 32, arg1) >> 32
                call stakingTokenAddress with:
                   funct uint32(stor6)
                     gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_code.size(stakingTokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 686 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, arg1) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256
                call stakingTokenAddress with:
