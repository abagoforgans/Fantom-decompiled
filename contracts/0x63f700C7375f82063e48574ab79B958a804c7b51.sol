...
function sub_f05663a6(?) payable {
    return sub_f05663a6Address
}
...
function isOutdated() payable {
    require ext_code.size(sub_f05663a6Address)
    staticcall sub_f05663a6Address.0x5909c0d5 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(sub_f05663a6Address)
    staticcall sub_f05663a6Address.0x5a3d5493 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(sub_f05663a6Address)
    staticcall sub_f05663a6Address.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if uint32(block.timestamp) < blockTimestampLast:
        revert with 0, 17
    return uint32(uint32(block.timestamp) - blockTimestampLast) >= duration
}

function currentCumulativePrices(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(arg1)
    staticcall arg1.0x5909c0d5 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(arg1)
    staticcall arg1.0x5a3d5493 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    require ext_call.return_data[64] == ext_call.return_data[92 len 4]
    if ext_call.return_data[92 len 4] == uint32(block.timestamp):
        return ext_call.return_data[0], ext_call.return_data[0], uint32(block.timestamp)
    if uint32(block.timestamp) < ext_call.return_data[92 len 4]:
        revert with 0, 17
    if Mask(112, 0, ext_call.return_data[0]) <= 0:
        revert with 0, 'FixedPoint: DIV_BY_ZERO'
    ...
    if ext_call.return_data[0] > !(Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))):
        revert with 0, 17
    return ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[32]) << 112 / Mask(112, 0, ext_call.return_data[0])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))), 
           ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))),
           uint32(block.timestamp)
}

function sub_db9539b9(?) payable {
    require ext_code.size(sub_f05663a6Address)
    staticcall sub_f05663a6Address.0x5909c0d5 with:
            gas gas_remaining wei
    if not ext_call.success:
    ...
    if ext_call.return_data[92 len 4] == uint32(block.timestamp):
        ...
        if not uint32(uint32(block.timestamp) - blockTimestampLast):
            revert with 0, 18
        if Mask(224, 0, ext_call.return_data[0] - price0CumulativeLast / uint32(uint32(block.timestamp) - blockTimestampLast)) and 10^6 > -1 / Mask(224, 0, ext_call.return_data[0] - price0CumulativeLast / uint32(uint32(block.timestamp) - blockTimestampLast)):
            revert with 0, 17
        if 10^6 * Mask(224, 0, ext_call.return_data[0] - price0CumulativeLast / uint32(uint32(block.timestamp) - blockTimestampLast)) / 10^6 != Mask(224, 0, ext_call.return_data[0] - price0CumulativeLast / uint32(uint32(block.timestamp) - blockTimestampLast)):
            revert with 0, 'FixedPoint: MULTIPLICATION_OVERFLOW'
        return (Mask(32, 112, 10^6 * Mask(224, 0, ext_call.return_data[0] - price0CumulativeLast / uint32(uint32(block.timestamp) - blockTimestampLast))) >> 112)
    if uint32(block.timestamp) < ext_call.return_data[92 len 4]:
        revert with 0, 17
    if Mask(112, 0, ext_call.return_data[0]) <= 0:
        revert with 0, 'FixedPoint: DIV_BY_ZERO'
    ...
    if not uint32(uint32(block.timestamp) - blockTimestampLast):
        revert with 0, 18
    if Mask(224, 0, ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[32]) << 112 / Mask(112, 0, ext_call.return_data[0])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - price0CumulativeLast / uint32(uint32(block.timestamp) - blockTimestampLast)) and 10^6 > -1 / Mask(224, 0, ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[32]) << 112 / Mask(112, 0, ext_call.return_data[0])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - price0CumulativeLast / uint32(uint32(block.timestamp) - blockTimestampLast)):
        revert with 0, 17
    if 10^6 * Mask(224, 0, ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[32]) << 112 / Mask(112, 0, ext_call.return_data[0])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - price0CumulativeLast / uint32(uint32(block.timestamp) - blockTimestampLast)) / 10^6 != Mask(224, 0, ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[32]) << 112 / Mask(112, 0, ext_call.return_data[0])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - price0CumulativeLast / uint32(uint32(block.timestamp) - blockTimestampLast)):
        revert with 0, 'FixedPoint: MULTIPLICATION_OVERFLOW'
    return (Mask(32, 112, 10^6 * Mask(224, 0, ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[32]) << 112 / Mask(112, 0, ext_call.return_data[0])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - price0CumulativeLast / uint32(uint32(block.timestamp) - blockTimestampLast))) >> 112)
}
...
function sub_5d2407f9(?) payable {
    ...
    if ext_call.return_data[92 len 4] == uint32(block.timestamp):
        ...
        if ext_call.return_data[0] < price1CumulativeLast:
            revert with 0, 17
        if ext_call.return_data[0] - price1CumulativeLast and 10^12 > -1 / ext_call.return_data[0] - price1CumulativeLast:
            revert with 0, 17
        if not uint32(uint32(block.timestamp) - blockTimestampLast):
            revert with 0, 18
        if Mask(224, 0, (10^12 * ext_call.return_data[0]) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast)) and 10^18 > -1 / Mask(224, 0, (10^12 * ext_call.return_data[0]) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast)):
            revert with 0, 17
        if 10^18 * Mask(224, 0, (10^12 * ext_call.return_data[0]) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast)) / 10^18 != Mask(224, 0, (10^12 * ext_call.return_data[0]) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast)):
            revert with 0, 'FixedPoint: MULTIPLICATION_OVERFLOW'
        return (Mask(32, 112, 10^18 * Mask(224, 0, (10^12 * ext_call.return_data[0]) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast))) >> 112)
    if uint32(block.timestamp) < ext_call.return_data[92 len 4]:
        revert with 0, 17
    if Mask(112, 0, ext_call.return_data[0]) <= 0:
        revert with 0, 'FixedPoint: DIV_BY_ZERO'
    ...
    if ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) < price1CumulativeLast:
        revert with 0, 17
    if ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - price1CumulativeLast and 10^12 > -1 / ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - price1CumulativeLast:
        revert with 0, 17
    if not uint32(uint32(block.timestamp) - blockTimestampLast):
        revert with 0, 18
    if Mask(224, 0, (10^12 * ext_call.return_data[0]) + (10^12 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast)) and 10^18 > -1 / Mask(224, 0, (10^12 * ext_call.return_data[0]) + (10^12 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast)):
        revert with 0, 17
    if 10^18 * Mask(224, 0, (10^12 * ext_call.return_data[0]) + (10^12 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast)) / 10^18 != Mask(224, 0, (10^12 * ext_call.return_data[0]) + (10^12 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast)):
        revert with 0, 'FixedPoint: MULTIPLICATION_OVERFLOW'
    return (Mask(32, 112, 10^18 * Mask(224, 0, (10^12 * ext_call.return_data[0]) + (10^12 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast))) >> 112)
}

function sub_80e40f2a(?) payable {
    require ext_code.size(sub_f05663a6Address)
    staticcall sub_f05663a6Address.0x5909c0d5 with:
            gas gas_remaining wei
    if not ext_call.success:
    ...
    if block.timestamp < lastEpochTime + period:
        ...
        if ext_call.return_data[92 len 4] == uint32(block.timestamp):
            ...
            if uint32(uint32(block.timestamp) - blockTimestampLast):
                ...
                if not uint32(uint32(block.timestamp) - blockTimestampLast):
                    revert with 0, 18
                price1Average = Mask(224, 0, (10^12 * ext_call.return_data[0]) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast))
            ...
            if uint32(uint32(block.timestamp) - blockTimestampLast):
                ...
                if not uint32(uint32(block.timestamp) - blockTimestampLast):
                    revert with 0, 18
                price1Average = Mask(224, 0, (10^12 * ext_call.return_data[0]) + (10^12 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - (10^12 * price1CumulativeLast) / uint32(uint32(block.timestamp) - blockTimestampLast))
