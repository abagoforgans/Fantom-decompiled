...
function sub_ebd133da(?) {
    ...
    if not stor8.length:
        ...
        while idx < stor8.length:
            ...
            _55 = mem[64]
            mem[64] = mem[64] + 256
            mem[_55] = address(stor4[stor8[idx].field_0].field_0)
            mem[_55 + 32] = address(stor4[stor8[idx].field_0].field_256)
            mem[_55 + 64] = stor4[stor8[idx].field_0].field_512
            _56 = mem[64]
            mem[64] = mem[64] + (32 * stor4[stor8[idx].field_0].field_768) + 32
            mem[_56] = stor4[stor8[idx].field_0].field_768
            if not stor4[stor8[idx].field_0].field_768:
                mem[_55 + 96] = _56
                _58 = mem[64]
                mem[64] = mem[64] + (32 * stor4[stor8[idx].field_0].field_1024) + 32
                mem[_58] = stor4[stor8[idx].field_0].field_1024
                if stor4[stor8[idx].field_0].field_1024:
                    mem[0] = sha3(stor8[idx].field_0, 4) + 4
                    mem[_58 + 32] = stor4[stor8[idx].field_0][4].field_0
                    s = _58 + 32
                    t = sha3(sha3(stor8[idx].field_0, 4) + 4)
                    while _58 + (32 * stor4[stor8[idx].field_0].field_1024) > s:
                ...
                mem[0] = sha3(stor8[idx].field_0, 4) + 3
                mem[_56 + 32] = address(stor4[stor8[idx].field_0][3].field_0)
                s = _56 + 32
                t = sha3(sha3(stor8[idx].field_0, 4) + 3)
                while _56 + (32 * stor4[stor8[idx].field_0].field_768) > s:
                ...
                _140 = mem[64]
                mem[64] = mem[64] + (32 * stor4[stor8[idx].field_0].field_1024) + 32
                mem[_140] = stor4[stor8[idx].field_0].field_1024
                if stor4[stor8[idx].field_0].field_1024:
                    mem[0] = sha3(stor8[idx].field_0, 4) + 4
                    mem[_140 + 32] = stor4[stor8[idx].field_0][4].field_0
                    s = _140 + 32
                    t = sha3(sha3(stor8[idx].field_0, 4) + 4)
                    while _140 + (32 * stor4[stor8[idx].field_0].field_1024) > s:
                        mem[s + 32] = uint256(stor1[t])
                        s = s + 32
                        t = t + 1
                        continue 
                mem[_55 + 128] = _140
            mem[_55 + 160] = stor4[stor8[idx].field_0].field_1280
            mem[_55 + 192] = stor4[stor8[idx].field_0].field_1536
            mem[_55 + 224] = bool(uint8(stor4[stor8[idx].field_0].field_1792))
            if idx >= mem[96]:
                revert with 0, 50
            mem[(32 * idx) + 128] = _55
            if idx == -1:
        ...
        mem[(32 * stor8.length) + 224] = 96
        mem[(32 * stor8.length) + 256] = 96
        mem[(32 * stor8.length) + 288] = 0
        mem[(32 * stor8.length) + 320] = 0
        mem[(32 * stor8.length) + 352] = 0
        mem[var9001] = (32 * stor8.length) + 128
        s = var9001
        idx = var9002
        while idx - 1:
            mem[64] = mem[64] + 256
        ...
        while idx < stor8.length:
            ...
            _149 = mem[64]
            mem[64] = mem[64] + 256
            mem[_149] = address(stor4[stor8[idx].field_0].field_0)
            mem[_149 + 32] = address(stor4[stor8[idx].field_0].field_256)
            mem[_149 + 64] = stor4[stor8[idx].field_0].field_512
            _150 = mem[64]
            mem[64] = mem[64] + (32 * stor4[stor8[idx].field_0].field_768) + 32
            mem[_150] = stor4[stor8[idx].field_0].field_768
            if not stor4[stor8[idx].field_0].field_768:
                mem[_149 + 96] = _150
                _152 = mem[64]
                mem[64] = mem[64] + (32 * stor4[stor8[idx].field_0].field_1024) + 32
                mem[_152] = stor4[stor8[idx].field_0].field_1024
                if stor4[stor8[idx].field_0].field_1024:
                    mem[0] = sha3(stor8[idx].field_0, 4) + 4
                    mem[_152 + 32] = stor4[stor8[idx].field_0][4].field_0
                    s = _152 + 32
                    t = sha3(sha3(stor8[idx].field_0, 4) + 4)
                    while _152 + (32 * stor4[stor8[idx].field_0].field_1024) > s:
                        mem[s + 32] = uint256(stor1[t])
                        s = s + 32
                        t = t + 1
                        continue 
                ...
                mem[0] = sha3(stor8[idx].field_0, 4) + 3
                mem[_150 + 32] = address(stor4[stor8[idx].field_0][3].field_0)
                s = _150 + 32
                t = sha3(sha3(stor8[idx].field_0, 4) + 3)
                while _150 + (32 * stor4[stor8[idx].field_0].field_768) > s:
                    mem[s + 32] = address(stor1[t])
                    s = s + 32
                    t = t + 1
                    continue 
                ...
                _194 = mem[64]
                mem[64] = mem[64] + (32 * stor4[stor8[idx].field_0].field_1024) + 32
                mem[_194] = stor4[stor8[idx].field_0].field_1024
                if stor4[stor8[idx].field_0].field_1024:
                    mem[0] = sha3(stor8[idx].field_0, 4) + 4
                    mem[_194 + 32] = stor4[stor8[idx].field_0][4].field_0
                    s = _194 + 32
                    t = sha3(sha3(stor8[idx].field_0, 4) + 4)
                    while _194 + (32 * stor4[stor8[idx].field_0].field_1024) > s:
                        mem[s + 32] = uint256(stor1[t])
                        s = s + 32
                        t = t + 1
                        continue 
                mem[_149 + 128] = _194
            mem[_149 + 160] = stor4[stor8[idx].field_0].field_1280
            mem[_149 + 192] = stor4[stor8[idx].field_0].field_1536
            mem[_149 + 224] = bool(uint8(stor4[stor8[idx].field_0].field_1792))
            if idx >= mem[96]:
                revert with 0, 50
            mem[(32 * idx) + 128] = _149
            if idx == -1:
...
function sub_a0c59979(?) {
    ...
    mem[0] = stor5[arg1]
    idx = 0
    while idx < stor6[stor5[arg1]].field_0:
        if idx >= stor6[stor5[arg1]].field_0:
            revert with 0, 50
        if stor6[stor5[arg1]][idx].field_512 != arg1:
            if idx == -1:
                revert with 0, 17
            mem[0] = stor5[arg1]
            mem[32] = 6
            idx = idx + 1
            continue 
        if stor6[stor5[arg1]].field_0 < 1:
            revert with 0, 17
        if stor6[stor5[arg1]].field_0 - 1 >= stor6[stor5[arg1]].field_0:
            revert with 0, 50
        if idx >= stor6[stor5[arg1]].field_0:
            revert with 0, 50
        address(stor6[stor5[arg1]][idx].field_0) = address(stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_0)
        address(stor6[stor5[arg1]][idx].field_256) = address(stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_256)
        stor6[stor5[arg1]][idx].field_512 = stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_512
        stor6[stor5[arg1]][idx].field_768 = stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_768
        mem[0] = (8 * idx) + sha3(sha3(stor5[arg1], 6)) + 3
        if not stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_768:
            s = sha3(mem[0])
            while sha3((8 * idx) + sha3(sha3(stor5[arg1], 6)) + 3) + stor6[stor5[arg1]][idx].field_768 > s:
                stor[s] = 0
                mem[0] = stor5[arg1]
                mem[32] = 6
                s = s + 1
                continue 
            stor6[stor5[arg1]][idx].field_1024 = stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1024
            mem[0] = (8 * idx) + sha3(sha3(stor5[arg1], 6)) + 4
            if not stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1024:
                s = sha3(mem[0])
                while sha3((8 * idx) + sha3(sha3(stor5[arg1], 6)) + 4) + stor6[stor5[arg1]][idx].field_1024 > s:
                    stor[s] = 0
                    mem[0] = stor5[arg1]
                    mem[32] = 6
                    s = s + 1
                ...
                mem[0] = (8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 4
                t = sha3((8 * idx) + sha3(sha3(stor5[arg1], 6)) + 4)
                s = sha3(mem[0])
                while sha3((8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 4) + stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1024 > s:
                    stor[t] = stor[s]
                    mem[0] = stor5[arg1]
                    mem[32] = 6
                    t = t + 1
                    s = s + 1
                    continue 
                s = sha3((8 * idx) + sha3(sha3(stor5[arg1], 6)) + 4) + sha3((8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 4) + stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1024 - sha3(mem[0])
                while sha3((8 * idx) + sha3(sha3(stor5[arg1], 6)) + 4) + stor6[stor5[arg1]][idx].field_1024 > s:
                    stor[s] = 0
                    mem[0] = stor5[arg1]
                    mem[32] = 6
                    s = s + 1
                    continue 
            stor6[stor5[arg1]][idx].field_1280 = stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1280
            stor6[stor5[arg1]][idx].field_1536 = stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1536
            uint8(stor6[stor5[arg1]][idx].field_1792) = uint8(bool(uint8(stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1792)))
            if not stor6[stor5[arg1]].field_0:
                revert with 0, 49
            address(stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_0) = 0
            address(stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_256) = 0
            stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_512 = 0
            stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_768 = 0
            mem[0] = (8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 3
            s = sha3(mem[0])
            while sha3((8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 3) + stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_768 > s:
                stor[s] = 0
                mem[0] = stor5[arg1]
                mem[32] = 6
                s = s + 1
                continue 
            stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1024 = 0
            mem[0] = (8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 4
            s = sha3(mem[0])
            while sha3((8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 4) + stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1024 > s:
                stor[s] = 0
                ...
                s = s + 1
                continue 
            stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1280 = 0
            stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1536 = 0
            uint8(stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1792) = 0
            stor6[stor5[arg1]].field_0--
            if idx == -1:
                revert with 0, 17
            mem[0] = stor5[arg1]
            mem[32] = 6
            ...
            continue 
        mem[0] = (8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 3
        t = sha3((8 * idx) + sha3(sha3(stor5[arg1], 6)) + 3)
        s = sha3(mem[0])
        while sha3((8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 3) + stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_768 > s:
            stor[t] = stor[s]
            mem[0] = stor5[arg1]
            ...
            s = s + 1
            continue 
        s = sha3((8 * idx) + sha3(sha3(stor5[arg1], 6)) + 3) + sha3((8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 3) + stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_768 - sha3(mem[0])
        while sha3((8 * idx) + sha3(sha3(stor5[arg1], 6)) + 3) + stor6[stor5[arg1]][idx].field_768 > s:
            stor[s] = 0
            mem[0] = stor5[arg1]
            mem[32] = 6
        ...
        uint8(stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1792) = 0
        stor6[stor5[arg1]].field_0--
        if sha3((8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 4) + stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1024 == -1:
            revert with 0, 17
        mem[0] = stor5[arg1]
        mem[32] = 6
        s = sha3((8 * stor6[stor5[arg1]].field_0 - 1) + sha3(sha3(stor5[arg1], 6)) + 4) + stor6[stor5[arg1]][stor6[stor5[arg1]].field_0 - 1].field_1024 + 1
        continue 
...
function sub_31983366(?) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if ('cd', 36).length:
            ...
            if not mem[_1032]:
                ...
                if not ext_call.success:
                    ...
                    return 0
            if 10^16 > !stor4[cd[4]].field_1280:
                revert with 0, 17
            if stor1.length > !(stor4[cd[4]].field_1280 + 10^16):
                revert with 0, 17
            stor1.length = stor1.length + stor4[cd[4]].field_1280 + 10^16
            ...
            mem[mem[64] + (32 * mem[96]) + 228 len 32 * _1463] = mem[(32 * ('cd', 36).length) + ceil32(return_data.size) + 160 len 32 * _1463]
            mem[mem[64] + (32 * mem[96]) + (32 * _1463) + 228] = 0
            require ext_code.size(stor3)
            call stor3.safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                 gas gas_remaining wei
                args msg.sender, address(stor4[cd[4]].field_0), 160, (32 * mem[96]) + 192, (32 * mem[96]) + (32 * _1463) + 224, mem[96], mem[mem[64] + 196 len (32 * mem[96]) + (32 * _1463) + 32], 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            mem[mem[64] + (32 * mem[96]) + 196] = mem[(32 * ('cd', 36).length) + ceil32(return_data.size) + 128]
            mem[mem[64] + (32 * mem[96]) + 228 len 32 * _1462] = mem[(32 * ('cd', 36).length) + ceil32(return_data.size) + 160 len 32 * _1462]
            mem[mem[64] + 132] = (32 * mem[96]) + (32 * _1462) + 224
            mem[mem[64] + (32 * mem[96]) + (32 * _1462) + 228] = 0
            require ext_code.size(stor3)
            call stor3.safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                 gas gas_remaining wei
                args msg.sender, address(stor4[cd[4]].field_0), 160, mem[mem[64] + 100 len (32 * _1158) + (32 * _1462) + 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64] + 68] = stor4[cd[4]].field_512
            mem[mem[64] + 100] = 1
        ...
        if not ('cd', 36).length:
            ...
            mem[mem[64] + (32 * mem[96]) + 196] = mem[(32 * ('cd', 36).length) + ceil32(return_data.size) + 128]
            mem[mem[64] + (32 * mem[96]) + 228 len 32 * _1464] = mem[(32 * ('cd', 36).length) + ceil32(return_data.size) + 160 len 32 * _1464]
            mem[mem[64] + 132] = (32 * mem[96]) + (32 * _1464) + 224
            mem[mem[64] + (32 * mem[96]) + (32 * _1464) + 228] = 0
            require ext_code.size(stor3)
            call stor3.safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                 gas gas_remaining wei
                args msg.sender, address(stor4[cd[4]].field_0), 160, mem[mem[64] + 100 len (32 * mem[96]) + (32 * _1464) + 128], 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64] + 68] = stor4[cd[4]].field_512
            mem[mem[64] + 100] = 1
            ...
            mem[mem[64] + (32 * mem[96]) + 196] = mem[(32 * ('cd', 36).length) + ceil32(return_data.size) + 128]
            mem[mem[64] + (32 * mem[96]) + 228 len 32 * _1465] = mem[(32 * ('cd', 36).length) + ceil32(return_data.size) + 160 len 32 * _1465]
            mem[mem[64] + 132] = (32 * mem[96]) + (32 * _1465) + 224
            mem[mem[64] + (32 * mem[96]) + (32 * _1465) + 228] = 0
            require ext_code.size(stor3)
            call stor3.safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                 gas gas_remaining wei
                args msg.sender, address(stor4[cd[4]].field_0), 160, mem[mem[64] + 100 len (32 * _1167) + (32 * _1465) + 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64] + 68] = stor4[cd[4]].field_512
            mem[mem[64] + 100] = 1
