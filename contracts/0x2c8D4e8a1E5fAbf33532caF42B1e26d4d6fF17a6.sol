...
function sub_c06ef3e7(?) payable {
    require calldata.size - 4 >= 64
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 / 60 / 24 >= 365:
        return 1800
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 / 60 / 24 >= 180:
        return 1300
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 / 60 / 24 >= 93:
        return 1125
    if block.timestamp - sub_0110afd2[arg1][address(arg2)].field_512 / 60 / 60 / 24 >= 31:
        return 1040
