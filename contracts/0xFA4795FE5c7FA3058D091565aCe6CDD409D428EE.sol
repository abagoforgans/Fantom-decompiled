...
function sub_c05bc01f(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            ...
            mem[64] = mem[64] + 160
            mem[_316] = mem[_312]
            mem[_316 + 32] = mem[_312 + 32]
            mem[_316 + 64] = mem[_312 + 64]
            mem[_316 + 96] = mem[_312 + 96]
            mem[_316 + 128] = mem[_312 + 128]
            require ext_code.size(stor1)
            staticcall stor1.ability_scores(uint256 arg1) with:
                    gas gas_remaining wei
                   args _277
            ...
            require return_data.size >= 192
            _353 = mem[_344]
            require mem[_344] == mem[_344 + 28 len 4]
            _356 = mem[_344 + 32]
            require mem[_344 + 32] == mem[_344 + 60 len 4]
            _364 = mem[_344 + 64]
            require mem[_344 + 64] == mem[_344 + 92 len 4]
            _367 = mem[_344 + 96]
            require mem[_344 + 96] == mem[_344 + 124 len 4]
            _369 = mem[_344 + 128]
            require mem[_344 + 128] == mem[_344 + 156 len 4]
            _371 = mem[_344 + 160]
            require mem[_344 + 160] == mem[_344 + 188 len 4]
            require ext_code.size(this.address)
            staticcall this.address.0x877e3817 with:
                    gas gas_remaining wei
                   args _277
            ...
            _396 = mem[64]
            mem[64] = mem[64] + 192
            mem[_396] = uint32(_353)
            mem[_396 + 32] = uint32(_356)
            mem[_396 + 64] = uint32(_364)
            mem[_396 + 96] = uint32(_367)
            mem[_396 + 128] = uint32(_369)
            mem[_396 + 160] = uint32(_371)
            mem[_395 + 96] = _396
            if idx >= mem[ceil32(32 * ('cd', 4).length) + 97]:
                revert with 0, 50
            mem[(32 * idx) + ceil32(32 * ('cd', 4).length) + 129] = _395
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            continue 
        _276 = mem[64]
        mem[mem[64]] = 32
        _279 = mem[ceil32(32 * ('cd', 4).length) + 97]
        mem[mem[64] + 32] = mem[ceil32(32 * ('cd', 4).length) + 97]
        idx = 0
        s = mem[64] + 64
        ...
        while idx < _279:
            ...
            _410 = mem[mem[t]]
            mem[s] = mem[mem[mem[t]]]
            mem[s + 32] = mem[_410 + 32]
            mem[s + 64] = mem[_410 + 64]
            mem[s + 96] = mem[_410 + 96]
            mem[s + 128] = mem[_410 + 128]
            _417 = mem[_407 + 32]
            mem[s + 160] = mem[mem[_407 + 32]]
            mem[s + 192] = mem[_417 + 32]
            _420 = mem[_407 + 64]
            mem[s + 224] = mem[mem[_407 + 64]]
            mem[s + 256] = mem[_420 + 32]
            _423 = mem[_407 + 96]
            mem[s + 288] = mem[mem[_407 + 96] + 28 len 4]
            mem[s + 320] = mem[_423 + 60 len 4]
            mem[s + 352] = mem[_423 + 92 len 4]
            mem[s + 384] = mem[_423 + 124 len 4]
            mem[s + 416] = mem[_423 + 156 len 4]
            mem[s + 448] = mem[_423 + 188 len 4]
            idx = idx + 1
            s = s + 480
            t = t + 32
            continue 
    ...
    mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 129] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 257
    mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 417] = 0
    mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 449] = 0
    mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 161] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 417
    mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 481] = 0
    mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 513] = 0
    mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 193] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 481
    mem[64] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 737
    ...
    mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 225] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 545
    mem[var28002] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 129
    s = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 257
    ...
    while idx - 1:
        ...
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 417] = 0
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 449] = 0
        mem[_500 + 32] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 417
        mem[64] = mem[64] + 64
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 481] = 0
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 513] = 0
        mem[_500 + 64] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 481
        mem[64] = mem[64] + 192
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 545] = 0
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 577] = 0
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 609] = 0
        ...
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 673] = 0
        mem[ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 705] = 0
        mem[_500 + 96] = ceil32(32 * ('cd', 4).length) + (32 * ('cd', 4).length) + 545
        mem[s + 32] = _500
        s = _501
        s = _500
        s = _500
    ...
    while idx < _566:
        ...
        mem[64] = mem[64] + 160
        mem[_600] = mem[_599]
        mem[_600 + 32] = mem[_599 + 32]
        mem[_600 + 64] = mem[_599 + 64]
        mem[_600 + 96] = mem[_599 + 96]
        mem[_600 + 128] = mem[_599 + 128]
        require ext_code.size(stor1)
        staticcall stor1.ability_scores(uint256 arg1) with:
                gas gas_remaining wei
               args _569
        ...
        require return_data.size >= 192
        _609 = mem[_608]
        require mem[_608] == mem[_608 + 28 len 4]
        _610 = mem[_608 + 32]
        require mem[_608 + 32] == mem[_608 + 60 len 4]
        _611 = mem[_608 + 64]
        require mem[_608 + 64] == mem[_608 + 92 len 4]
        _612 = mem[_608 + 96]
        require mem[_608 + 96] == mem[_608 + 124 len 4]
        _613 = mem[_608 + 128]
        require mem[_608 + 128] == mem[_608 + 156 len 4]
        _614 = mem[_608 + 160]
        require mem[_608 + 160] == mem[_608 + 188 len 4]
        require ext_code.size(this.address)
        staticcall this.address.0x877e3817 with:
                gas gas_remaining wei
               args _569
        ...
        _628 = mem[64]
        mem[64] = mem[64] + 192
        mem[_628] = uint32(_609)
        mem[_628 + 32] = uint32(_610)
        mem[_628 + 64] = uint32(_611)
        mem[_628 + 96] = uint32(_612)
        mem[_628 + 128] = uint32(_613)
        mem[_628 + 160] = uint32(_614)
        mem[_627 + 96] = _628
        if idx >= mem[ceil32(32 * ('cd', 4).length) + 97]:
            revert with 0, 50
        mem[(32 * idx) + ceil32(32 * ('cd', 4).length) + 129] = _627
        if idx == -1:
            revert with 0, 17
        _566 = mem[96]
        idx = idx + 1
    ...
    _568 = mem[64]
    mem[mem[64]] = 32
    _570 = mem[ceil32(32 * ('cd', 4).length) + 97]
    mem[mem[64] + 32] = mem[ceil32(32 * ('cd', 4).length) + 97]
    idx = 0
    s = mem[64] + 64
    t = ceil32(32 * ('cd', 4).length) + 129
    while idx < _570:
        ...
        _632 = mem[mem[t]]
        mem[s] = mem[mem[mem[t]]]
        mem[s + 32] = mem[_632 + 32]
        mem[s + 64] = mem[_632 + 64]
        mem[s + 96] = mem[_632 + 96]
        mem[s + 128] = mem[_632 + 128]
        _638 = mem[_630 + 32]
        mem[s + 160] = mem[mem[_630 + 32]]
        mem[s + 192] = mem[_638 + 32]
        _641 = mem[_630 + 64]
        mem[s + 224] = mem[mem[_630 + 64]]
        mem[s + 256] = mem[_641 + 32]
        _644 = mem[_630 + 96]
        mem[s + 288] = mem[mem[_630 + 96] + 28 len 4]
        mem[s + 320] = mem[_644 + 60 len 4]
        mem[s + 352] = mem[_644 + 92 len 4]
        mem[s + 384] = mem[_644 + 124 len 4]
        mem[s + 416] = mem[_644 + 156 len 4]
        mem[s + 448] = mem[_644 + 188 len 4]
        idx = idx + 1
        s = s + 480
        t = t + 32
        continue 
