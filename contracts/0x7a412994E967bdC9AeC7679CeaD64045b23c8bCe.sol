...
function sub_6a61a2f4(?) payable {
    ...
    if eth.balance(msg.sender) > -msg.value - 1:
        revert with 'NH{q', 17
    if block.timestamp > -uint128(arg4) - 1:
        revert with 'NH{q', 17
    mem[96] = 2
    ...
    mem[292] = block.timestamp + uint128(arg4)
    ...
    call address(stor1[arg1]).swapExactETHForTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
       value msg.value wei
        ...
        args 1, Array(len=2, data=mem[356 len 64]), address(this.address), block.timestamp + uint128(arg4)
    ...
    if 0 >= mem[_65]:
        revert with 'NH{q', 50
    mem[_65 + 32] = address(arg3)
    if 1 >= mem[_65]:
        revert with 'NH{q', 50
    mem[_65 + 64] = 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83
    if arg2 > 2:
        revert with 'NH{q', 33
    mem[0] = arg2
    mem[32] = 1
    mem[_65 + 96] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
    mem[_65 + 100] = _64
    mem[_65 + 132] = 1
    mem[_65 + 164] = 160
    mem[_65 + 260] = mem[_65]
    ...
    while idx < mem[_65]:
        ...
        t = t + 32
        continue 
    mem[_65 + 196] = msg.sender
    mem[_65 + 228] = block.timestamp + uint128(arg4)
    ...
    idx = _82 + _83 + 32
    s = _82 + ceil32(return_data.size) + 32
