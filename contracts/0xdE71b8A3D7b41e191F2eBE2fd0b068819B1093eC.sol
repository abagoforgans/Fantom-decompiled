...
function sub_0c55baa9(?) payable {
    ...
    if not bool(ceil32(return_data.size) + 992 <= test266151307()):
        revert with 0, 65
    require ext_code.size(this.address)
    ...
    if not bool((2 * ceil32(return_data.size)) + 1120 <= test266151307()):
        revert with 0, 65
    require return_data.size >= 192
    if not bool((2 * ceil32(return_data.size)) + 1312 <= test266151307()):
        revert with 0, 65
    ...
    if not bool((4 * ceil32(return_data.size)) + 1376 <= test266151307()):
        revert with 0, 65
    require ext_code.size(this.address)
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
    if not bool((6 * ceil32(return_data.size)) + 1440 <= test266151307()):
        revert with 0, 65
    mem[(6 * ceil32(return_data.size)) + 1728] = ext_call.return_data[28 len 4]
    mem[(6 * ceil32(return_data.size)) + 1760] = ext_call.return_data[60 len 4]
    mem[(6 * ceil32(return_data.size)) + 1792] = ext_call.return_data[92 len 4]
    mem[(6 * ceil32(return_data.size)) + 1824] = ext_call.return_data[124 len 4]
    mem[(6 * ceil32(return_data.size)) + 1856] = ext_call.return_data[156 len 4]
    mem[(6 * ceil32(return_data.size)) + 1888] = ext_call.return_data[188 len 4]
    return ext_call.return_data[0], 
           ext_call.return_data[32],
           ext_call.return_data[64],
           ext_call.return_data[96],
           ext_call.return_data[128],
           mem[(6 * ceil32(return_data.size)) + 1728 len 192],
