    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                call address(masterchefAddress).emergencyWithdraw(uint256 arg1, address arg2) with:
                     gas gas_remaining wei
                    args poolId, address(this.address), mem[(2 * ceil32(return_data.size)) + 658 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
    else:
        mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
            if return_data.size > 0:
            ...
            if not return_data.size:
                ...
                if return_data.size <= 0:
                    ...
                    if not return_data.size:
                        ...
                        call address(masterchefAddress).emergencyWithdraw(uint256 arg1, address arg2) with:
                             gas gas_remaining wei
                            args poolId, address(this.address), mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 659 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                else:
                    require return_data.size >= 32
                    if not mem[ceil32(return_data.size) + 457]:
                        revert with 0, 
