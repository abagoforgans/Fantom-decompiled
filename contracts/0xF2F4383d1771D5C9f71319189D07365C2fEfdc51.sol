...
address isInitialized; offset 16
...
function migrate(address arg1) payable {
    ...
    require ext_code.size(isInitialized)
    call isInitialized.0xa7fc7a07 with:
...
function sub_516d16b9(?) payable {
    if not isInitialized:
        revert with 0, 'Lootbox is not initialized'
    require ext_code.size(isInitialized)
    staticcall isInitialized.0x516d16b9 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_01768052(?) payable {
    ...
    mem[100] = arg1
    require ext_code.size(isInitialized)
    staticcall isInitialized.0x1768052 with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_5213b7ff(?) payable {
    ...
    mem[100] = arg1
    require ext_code.size(isInitialized)
    staticcall isInitialized.0xbb0492f5 with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_5d610177(?) payable {
    ...
    require ext_code.size(isInitialized)
    staticcall isInitialized.0x5d610177 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[96 len return_data.size] = ext_call.return_data[0 len return_data.size]
