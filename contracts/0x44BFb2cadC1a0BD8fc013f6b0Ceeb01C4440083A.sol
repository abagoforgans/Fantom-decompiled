...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    require return_data.size >= 32
    _58 = mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3) >> 32
    ...
    _59 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3) >> 32 + 192]
    ...
    require return_data.size >= _58 + (32 * _59) + 32
    mem[(4 * ceil32(return_data.size)) + 224 len 32 * _59] = mem[(2 * ceil32(return_data.size)) + _58 + 224 len 32 * _59]
    if _59 < 1:
        revert with 0, 17
    if _59 - 1 >= _59:
        revert with 0, 50
    ...
    mem[mem[64] + 4] = arg3
    mem[mem[64] + 36] = mem[(32 * _59 - 1) + (4 * ceil32(return_data.size)) + 224]
    mem[mem[64] + 68] = 160
    mem[mem[64] + 164] = 2
    idx = 0
    s = (2 * ceil32(return_data.size)) + 128
    ...
    call address(cd[(arg5 + 68)]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3, mem[(32 * _59 - 1) + (4 * ceil32(return_data.size)) + 224], Array(len=2, data=mem[mem[64] + 196 len 64]), address(this.address), block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _125 = mem[64]
    ...
    _127 = mem[_125 + mem[_125]]
    if mem[_125 + mem[_125]] > test266151307():
        revert with 0, 65
    if _125 + ceil32(return_data.size) + ceil32(32 * mem[_125 + mem[_125]]) + 1 > test266151307() or ceil32(32 * mem[_125 + mem[_125]]) + 1 < 0:
        revert with 0, 65
    mem[64] = _125 + ceil32(return_data.size) + ceil32(32 * mem[_125 + mem[_125]]) + 1
    mem[_125 + ceil32(return_data.size)] = _127
    require return_data.size >= _126 + (32 * _127) + 32
    mem[_125 + ceil32(return_data.size) + 32 len 32 * _127] = mem[_125 + _126 + 32 len 32 * _127]
    if arg3 > !arg4:
        revert with 0, 17
    ...
    emit 0x874f886a: address(arg1), address(arg2), _158
}
