...
function addPool(address arg1, uint256 arg2) payable {
    ...
    require oracles.length + 1 <= test266151307()
    if not oracles.length + 1:
        require 0 < oracles.length + 1
        mem[128] = 100 * 10^6
        idx = 1
        while idx < oracles.length:
            ...
            staticcall oracles[idx].latestAnswer() with:
                    gas gas_remaining wei
            mem[(32 * oracles.length + 1) + 128] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require idx < oracles.length + 1
            mem[(32 * idx) + 128] = ext_call.return_data[0]
            idx = idx + 1
            continue 
        require poolInfo.length <= test266151307()
        mem[(32 * oracles.length + 1) + 128] = poolInfo.length
        if not poolInfo.length:
            idx = 1
            s = 0
            while idx < poolInfo.length:
                mem[0] = 3
                require poolInfo[idx].field_256 < oracles.length + 1
                if not poolInfo[idx].field_512:
                    require idx < poolInfo.length
                    mem[(32 * idx) + (32 * oracles.length + 1) + 160] = 0
                    require idx < poolInfo.length
                    if s < s:
                ...
                if mem[(32 * poolInfo[idx].field_256) + 128] * poolInfo[idx].field_512 / poolInfo[idx].field_512 != mem[(32 * poolInfo[idx].field_256) + 128]:
                    revert with 0, 
                                ...
                                mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 261 len 31]
                require idx < poolInfo.length
                mem[(32 * idx) + (32 * oracles.length + 1) + 160] = mem[(32 * poolInfo[idx].field_256) + 128] * poolInfo[idx].field_512
                require idx < poolInfo.length
                if mem[(32 * idx) + (32 * oracles.length + 1) + 160] + s < s:
                    revert with 0, 'SafeMath: addition overflow'
                idx = idx + 1
                s = mem[(32 * idx) + (32 * oracles.length + 1) + 160] + s
                continue 
            if not s:
                ...
                while idx < poolInfo.length:
                    ...
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
                        require ext_code.size(poolInfo[idx].field_0)
                        staticcall poolInfo[idx].field_0.balanceOf(address rg1) with:
                                gas gas_remaining wei
                               args this.address
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 160] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                ...
                if 100 * s / s != 100:
                    revert with 0, 
                                ...
                                mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 261 len 31]
                require 0 < poolInfo.length
                mem[(32 * oracles.length + 1) + 160] = 100 * s / 80 / 5
                idx = 0
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _1032 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
            ...
            mem[(32 * oracles.length + 1) + 160 len 32 * poolInfo.length] = call.data[calldata.size len 32 * poolInfo.length]
            idx = 1
            s = 0
            while idx < poolInfo.length:
                mem[0] = 3
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _1034 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
        ...
        mem[128 len 32 * oracles.length + 1] = call.data[calldata.size len 32 * oracles.length + 1]
        require 0 < oracles.length + 1
        mem[128] = 100 * 10^6
        idx = 1
        while idx < oracles.length:
        ...
        if not poolInfo.length:
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _1036 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _1038 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
...
function claim(uint256[] arg1) payable {
    ...
    if not oracles.length + 1:
        ...
        if not poolInfo.length:
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _1732 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _1734 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
        ...
        if not poolInfo.length:
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _1736 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _1738 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
                    ...
                    if not userInfo[cd[((32 * idx) + arg1 + 36)]][address(msg.sender)].field_0:
                        ...
                        if poolInfo[cd[((32 * idx) + arg1 + 36)]].field_1024 * userInfo[cd[((32 * idx) + arg1 + 36)]][address(msg.sender)].field_0 / userInfo[cd[((32 * idx) + arg1 + 36)]][address(msg.sender)].field_0 != poolInfo[cd[((32 * idx) + arg1 + 36)]].field_1024:
                            revert with 0, 
                                        ...
                                        33,
                                        0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 325 len 31]
                        userInfo[cd[((32 * idx) + arg1 + 36)]][address(msg.sender)].field_256 = poolInfo[cd[((32 * idx) + arg1 + 36)]].field_1024 * userInfo[cd[((32 * idx) + arg1 + 36)]][address(msg.sender)].field_0 / 10^12
                    idx = idx + 1
                    s = -userInfo[cd[((32 * idx) + arg1 + 36)]][address(msg.sender)].field_256 + s
                    continue 
    ...
    if s:
        ...
        call sub_9b8e5563Address.mint(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args msg.sender, s
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    if not oracles.length + 1:
        ...
        if not poolInfo.length:
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _24903 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _24905 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
        ...
        if not poolInfo.length:
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _24907 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
            ...
            if not s:
                ...
                while idx < poolInfo.length:
                    require idx < poolInfo.length
                    _24909 = mem[(32 * idx) + (32 * oracles.length + 1) + 160]
                    require idx < poolInfo.length
                    mem[0] = 3
                    if block.timestamp > poolInfo[idx].field_768:
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 164] = this.address
    ...
    if not startTime:
        ...
        if eth.balance(this.address) < 0:
            revert with 0, 
                        ...
                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 462 len 26]
        if not ext_code.size(poolInfo[arg1].field_0):
            revert with 0, 'Address: call to non-contract'
        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 356 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, arg2) >> 32
        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 480 len 4] = 0
        call poolInfo[arg1].field_0 with:
             gas gas_remaining wei
            args arg2, mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 292 len 60], mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 452 len 4]
        if not return_data.size:
            if not ext_call.success:
                if oracles.length + 1:
                    revert with memory
                      from 128
                       len oracles.length + 1
                revert with 0, 'SafeERC20: low-level call failed'
            if oracles.length + 1:
                require oracles.length + 1 >= 32
                if not mem[128]:
                    revert with 0, 
                                32,
                                42,
                                0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 466 len 14],
                                0,
                                mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 484 len 4]
            ...
            if not arg2 + userInfo[arg1][msg.sender].field_0:
                ...
                if (arg2 * poolInfo[arg1].field_1024) + (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_1024) / arg2 + userInfo[arg1][msg.sender].field_0 != poolInfo[arg1].field_1024:
                    revert with 0, 
                                ...
                                33,
                                0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 457 len 23],
                                0,
                                mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 484 len 4]
            ...
            mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 388 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size:
                    revert with ext_call.return_data[0 len return_data.size]
                revert with 0, 'SafeERC20: low-level call failed'
            if return_data.size:
                require return_data.size >= 32
                if not mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 388]:
                    revert with 0, 
                                32,
                                42,
                                0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + ceil32(return_data.size) + 467 len 22]
            if arg2 + userInfo[arg1][msg.sender].field_0 < userInfo[arg1][msg.sender].field_0:
                revert with 0, 'SafeMath: addition overflow'
            userInfo[arg1][msg.sender].field_0 += arg2
            if not arg2 + userInfo[arg1][msg.sender].field_0:
                ...
                if (arg2 * poolInfo[arg1].field_1024) + (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_1024) / arg2 + userInfo[arg1][msg.sender].field_0 != poolInfo[arg1].field_1024:
                    revert with 0, 
                                ...
                                33,
                                0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + ceil32(return_data.size) + 458 len 31]
                userInfo[arg1][msg.sender].field_256 = (arg2 * poolInfo[arg1].field_1024) + (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_1024) / 10^12
    else:
        if sub_334d0bbd.length <= 0:
            if userInfo[arg1][msg.sender].field_0:
            ...
            if eth.balance(this.address) < 0:
                revert with 0, 
                            ...
                            38,
                            0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c,
                            mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 526 len 26]
            if not ext_code.size(poolInfo[arg1].field_0):
                revert with 0, 'Address: call to non-contract'
            mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 420 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, arg2) >> 32
            mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 544 len 4] = 0
            call poolInfo[arg1].field_0 with:
                 gas gas_remaining wei
                args arg2, mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 356 len 60], mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 516 len 4]
            if not return_data.size:
                if not ext_call.success:
                    if oracles.length + 1:
                        revert with memory
                ...
                if oracles.length + 1:
                    ...
                    if not mem[128]:
                        revert with 0, 
                                    ...
                                    42,
                                    0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                    mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 530 len 14],
                                    0,
                                    mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 548 len 4]
                if arg2 + userInfo[arg1][msg.sender].field_0 < userInfo[arg1][msg.sender].field_0:
                    revert with 0, 'SafeMath: addition overflow'
                userInfo[arg1][msg.sender].field_0 += arg2
                if not arg2 + userInfo[arg1][msg.sender].field_0:
                    ...
                    if (arg2 * poolInfo[arg1].field_1024) + (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_1024) / arg2 + userInfo[arg1][msg.sender].field_0 != poolInfo[arg1].field_1024:
                        revert with 0, 
                                    ...
                                    33,
                                    0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 521 len 23],
                                    0,
                                    mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 548 len 4]
                    userInfo[arg1][msg.sender].field_256 = (arg2 * poolInfo[arg1].field_1024) + (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_1024) / 10^12
            else:
                mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 452 len return_data.size] = ext_call.return_data[0 len return_data.size]
                if not ext_call.success:
                    if return_data.size:
                        revert with ext_call.return_data[0 len return_data.size]
                    revert with 0, 'SafeERC20: low-level call failed'
                if return_data.size:
                    require return_data.size >= 32
                    if not mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 452]:
                        revert with 0, 
                                    32,
                                    42,
                                    0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                    mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + ceil32(return_data.size) + 531 len 22]
                if arg2 + userInfo[arg1][msg.sender].field_0 < userInfo[arg1][msg.sender].field_0:
                    revert with 0, 'SafeMath: addition overflow'
                userInfo[arg1][msg.sender].field_0 += arg2
                if not arg2 + userInfo[arg1][msg.sender].field_0:
                    ...
                    if (arg2 * poolInfo[arg1].field_1024) + (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_1024) / arg2 + userInfo[arg1][msg.sender].field_0 != poolInfo[arg1].field_1024:
                        revert with 0, 
                                    ...
                                    33,
                                    0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + ceil32(return_data.size) + 522 len 31]
                    userInfo[arg1][msg.sender].field_256 = (arg2 * poolInfo[arg1].field_1024) + (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_1024) / 10^12
    if arg1:
                                        ...
                                        if block.timestamp - poolInfo[arg1].field_768:
                                            if (block.timestamp * rewardsPerSecond) - (poolInfo[arg1].field_768 * rewardsPerSecond) / block.timestamp - poolInfo[arg1].field_768 != rewardsPerSecond:
                                                ...
                                                if (block.timestamp * rewardsPerSecond) - (poolInfo[arg1].field_768 * rewardsPerSecond):
                                                    if (block.timestamp * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) - (poolInfo[arg1].field_768 * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) / (block.timestamp * rewardsPerSecond) - (poolInfo[arg1].field_768 * rewardsPerSecond) != mem[(32 * arg1) + (32 * oracles.length + 1) + 160]:
                                                        revert with 0, 
                                                                    32,
                                                                    33,
                                                                    0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                                        ...
                                                        if 100 * s / 80 <= 0:
                                                            ...
                                                            require 100 * s / 80
                                                            if (block.timestamp * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) - (poolInfo[arg1].field_768 * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) / 100 * s / 80:
                                                                if 10^12 * (block.timestamp * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) - (poolInfo[arg1].field_768 * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) / 100 * s / 80 / (block.timestamp * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) - (poolInfo[arg1].field_768 * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) / 100 * s / 80 != 10^12:
                                                                    revert with 0, 
                                                                                32,
                                                                                33,
                                                                                0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                                                    ...
                                                                    if ext_call.return_data[0] <= 0:
                                                                        ...
                                                                        require ext_call.return_data[0]
                                                                        if (10^12 * (block.timestamp * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) - (poolInfo[arg1].field_768 * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) / 100 * s / 80 / ext_call.return_data[0]) + poolInfo[arg1].field_1024 < poolInfo[arg1].field_1024:
                                                                            revert with 0, 'SafeMath: addition overflow'
                                                                        else:
                                                                            if userInfo[arg1][address(arg2)].field_0:
                                                                                if (10^12 * (block.timestamp * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) - (poolInfo[arg1].field_768 * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) / 100 * s / 80 / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_1024 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.timestamp * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) - (poolInfo[arg1].field_768 * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) / 100 * s / 80 / ext_call.return_data[0]) + poolInfo[arg1].field_1024:
                                                                                    revert with 0, 
                                                                                                32,
                                                                                                33,
                                                                                                0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                                                                    ...
                                                                                    if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.timestamp * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) - (poolInfo[arg1].field_768 * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) / 100 * s / 80 / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_1024 * userInfo[arg1][address(arg2)].field_0) / 10^12:
                                                                                        revert with 0, 'SafeMath: subtraction overflow'
                                                                                    else:
                                                                                        mem[(32 * oracles.length + 1) + (32 * poolInfo.length) + 160] = ((10^12 * (block.timestamp * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) - (poolInfo[arg1].field_768 * rewardsPerSecond * mem[(32 * arg1) + (32 * oracles.length + 1) + 160]) / 100 * s / 80 / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_1024 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256
                                                                                        return memory
                                                                                          from (32 * oracles.length + 1) + (32 * poolInfo.length) + 160
                                                                                           len 32
                                                                            else:
                                                                                if userInfo[arg1][address(arg2)].field_256 > 0:
                                                                                    revert with 0, 'SafeMath: subtraction overflow'
