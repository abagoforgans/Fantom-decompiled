...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        balanceOf[57005] += 10 * arg2 / 100
        emit Transfer((10 * arg2 / 100), msg.sender, 57005);
        if 10 * arg2 / 100 > arg2:
            revert with 0, 'SafeMath: subtraction overflow'
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if not arg3:
        ...
        if 10 * arg3 / arg3 != 10:
            revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
        balanceOf[57005] += 10 * arg3 / 100
        emit Transfer((10 * arg3 / 100), arg1, 57005);
        if 10 * arg3 / 100 > arg3:
            revert with 0, 'SafeMath: subtraction overflow'
