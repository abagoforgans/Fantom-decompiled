                                    ...
                                    if not Mask(112, 0, ext_call.return_data[0]):
                                        if arg4 <= Mask(112, 0, ext_call.return_data[32]):
                                            if Mask(112, 0, ext_call.return_data[32]) - arg4:
                                                if Mask(112, 0, ext_call.return_data[32]) - arg4:
                                                    if (998 * Mask(112, 0, ext_call.return_data[32])) - (998 * arg4) / Mask(112, 0, ext_call.return_data[32]) - arg4 == 998:
                                                        if (998 * Mask(112, 0, ext_call.return_data[32])) - (998 * arg4):
                                                            if (0 / (998 * Mask(112, 0, ext_call.return_data[32])) - (998 * arg4)) + 1 >= 0 / (998 * Mask(112, 0, ext_call.return_data[32])) - (998 * arg4):
                                                                return (0 / (998 * Mask(112, 0, ext_call.return_data[32])) - (998 * arg4)) + 1, 0, uint8(ext_call.return_data[0])
                                    else:
                                                            ...
                                                            if arg4 <= Mask(112, 0, ext_call.return_data[32]):
                                                                if Mask(112, 0, ext_call.return_data[32]) - arg4:
                                                                    if Mask(112, 0, ext_call.return_data[32]) - arg4:
                                                                        if (998 * Mask(112, 0, ext_call.return_data[32])) - (998 * arg4) / Mask(112, 0, ext_call.return_data[32]) - arg4 == 998:
                                                                            if (998 * Mask(112, 0, ext_call.return_data[32])) - (998 * arg4):
                                                                                if (1000 * Mask(112, 0, ext_call.return_data[0]) * arg4 / (998 * Mask(112, 0, ext_call.return_data[32])) - (998 * arg4)) + 1 >= 1000 * Mask(112, 0, ext_call.return_data[0]) * arg4 / (998 * Mask(112, 0, ext_call.return_data[32])) - (998 * arg4):
                            ...
                            if not ext_call.return_data[18 len 14]:
                                if 998 * arg4 >= 0:
                                    if 998 * arg4:
                                        ...
                                        if 0 / 998 * arg4 != 1:
                                            if 0 / 998 * arg4:
                                                return 0 / 998 * arg4, 1, uint8(ext_call.return_data[0])
                                        require ext_code.size(arg2)
                                        staticcall arg2.decimals() with:
                                                gas gas_remaining wei
                                        if not ext_call.success:
                                        ...
                                        if (1000 * ext_call.return_data[18 len 14]) + (998 * arg4) >= 1000 * ext_call.return_data[18 len 14]:
                                            if (1000 * ext_call.return_data[18 len 14]) + (998 * arg4):
                                                ...
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                                                require return_data.size >= 32
                                                if 0 / (1000 * Mask(112, 0, ext_call.return_data[0])) + (998 * arg4) != 1:
                                                    if 0 / (1000 * Mask(112, 0, ext_call.return_data[0])) + (998 * arg4):
                                                        return 0 / (1000 * Mask(112, 0, ext_call.return_data[0])) + (998 * arg4), 1, uint8(ext_call.return_data[0])
                                                require ext_code.size(arg2)
                                                staticcall arg2.decimals() with:
                                                        gas gas_remaining wei
                                                if not ext_call.success:
                                        ...
                                        if 998 * arg4 >= 0:
                                            if 998 * arg4:
                                                ...
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                                                require return_data.size >= 32
                                                if 998 * arg4 * Mask(112, 0, ext_call.return_data[32]) / 998 * arg4 != 1:
                                                    if 998 * arg4 * Mask(112, 0, ext_call.return_data[32]) / 998 * arg4:
                                                        return 998 * arg4 * Mask(112, 0, ext_call.return_data[32]) / 998 * arg4, 1, uint8(ext_call.return_data[0])
                                                require ext_code.size(arg2)
                                                staticcall arg2.decimals() with:
                                                        gas gas_remaining wei
                                                if not ext_call.success:
                                                ...
                                                if (1000 * ext_call.return_data[18 len 14]) + (998 * arg4) >= 1000 * ext_call.return_data[18 len 14]:
                                                    if (1000 * ext_call.return_data[18 len 14]) + (998 * arg4):
                                                        ...
                                                        if not ext_call.success:
                                                            revert with ext_call.return_data[0 len return_data.size]
                                                        require return_data.size >= 32
                                                        if 998 * arg4 * Mask(112, 0, ext_call.return_data[32]) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (998 * arg4) != 1:
                                                            if 998 * arg4 * Mask(112, 0, ext_call.return_data[32]) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (998 * arg4):
                                ...
                                if 1000 * ext_call.return_data[50 len 14]:
                                    ...
                                    if not Mask(112, 0, ext_call.return_data[32]):
                                        if arg4 <= Mask(112, 0, ext_call.return_data[0]):
                                            if Mask(112, 0, ext_call.return_data[0]) - arg4:
                                                if Mask(112, 0, ext_call.return_data[0]) - arg4:
                                                    if (998 * Mask(112, 0, ext_call.return_data[0])) - (998 * arg4) / Mask(112, 0, ext_call.return_data[0]) - arg4 == 998:
                                                        if (998 * Mask(112, 0, ext_call.return_data[0])) - (998 * arg4):
                                                            if (0 / (998 * Mask(112, 0, ext_call.return_data[0])) - (998 * arg4)) + 1 >= 0 / (998 * Mask(112, 0, ext_call.return_data[0])) - (998 * arg4):
                                                                return (0 / (998 * Mask(112, 0, ext_call.return_data[0])) - (998 * arg4)) + 1, 0, uint8(ext_call.return_data[0])
                                    else:
                                                            ...
                                                            if arg4 <= Mask(112, 0, ext_call.return_data[0]):
                                                                if Mask(112, 0, ext_call.return_data[0]) - arg4:
                                                                    if Mask(112, 0, ext_call.return_data[0]) - arg4:
                                                                        if (998 * Mask(112, 0, ext_call.return_data[0])) - (998 * arg4) / Mask(112, 0, ext_call.return_data[0]) - arg4 == 998:
                                                                            if (998 * Mask(112, 0, ext_call.return_data[0])) - (998 * arg4):
                                                                                if (1000 * Mask(112, 0, ext_call.return_data[32]) * arg4 / (998 * Mask(112, 0, ext_call.return_data[0])) - (998 * arg4)) + 1 >= 1000 * Mask(112, 0, ext_call.return_data[32]) * arg4 / (998 * Mask(112, 0, ext_call.return_data[0])) - (998 * arg4):
                                        ...
                                        if (1000 * ext_call.return_data[50 len 14]) + (998 * arg4) >= 1000 * ext_call.return_data[50 len 14]:
                                            if (1000 * ext_call.return_data[50 len 14]) + (998 * arg4):
                                                ...
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                                                require return_data.size >= 32
                                                if 0 / (1000 * Mask(112, 0, ext_call.return_data[32])) + (998 * arg4) != 1:
                                                    if 0 / (1000 * Mask(112, 0, ext_call.return_data[32])) + (998 * arg4):
                                                        return 0 / (1000 * Mask(112, 0, ext_call.return_data[32])) + (998 * arg4), 1, uint8(ext_call.return_data[0])
                                                require ext_code.size(arg2)
                                                staticcall arg2.decimals() with:
                                                        gas gas_remaining wei
                                                if not ext_call.success:
                                        ...
                                        if 998 * arg4 >= 0:
                                            if 998 * arg4:
                                                ...
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                                                require return_data.size >= 32
                                                if 998 * arg4 * Mask(112, 0, ext_call.return_data[0]) / 998 * arg4 != 1:
                                                    if 998 * arg4 * Mask(112, 0, ext_call.return_data[0]) / 998 * arg4:
                                                        return 998 * arg4 * Mask(112, 0, ext_call.return_data[0]) / 998 * arg4, 1, uint8(ext_call.return_data[0])
                                                require ext_code.size(arg2)
                                                staticcall arg2.decimals() with:
                                                        gas gas_remaining wei
                                                if not ext_call.success:
                                                ...
                                                if (1000 * ext_call.return_data[50 len 14]) + (998 * arg4) >= 1000 * ext_call.return_data[50 len 14]:
                                                    if (1000 * ext_call.return_data[50 len 14]) + (998 * arg4):
                                                        ...
                                                        if not ext_call.success:
                                                            revert with ext_call.return_data[0 len return_data.size]
                                                        require return_data.size >= 32
                                                        if 998 * arg4 * Mask(112, 0, ext_call.return_data[0]) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (998 * arg4) != 1:
                                                            if 998 * arg4 * Mask(112, 0, ext_call.return_data[0]) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (998 * arg4):
