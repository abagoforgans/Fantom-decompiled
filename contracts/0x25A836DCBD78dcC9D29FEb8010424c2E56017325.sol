...
mapping of uint256 sub_e34be38a;
mapping of uint8 stor208;
...
function sub_e34be38a(?) {
    require calldata.size - 4 >= 32
    return sub_e34be38a[arg1]
}
...
function pools(uint256 arg1) {
    ...
    while stor202[arg1].length + 96 > idx:
        mem[idx + 32] = stor202[(10 * arg1) + s].field_256
        idx = idx + 32
        s = s + 1
        continue 
    return Array(len=stor202[arg1].length, data=mem[128 len ceil32(stor202[arg1].length)]), 
           ...
           stor202[arg1].field_2048,
           bool(stor202[arg1].field_2304)
}
...
function addWhitelist(uint256 arg1, address[] arg2) {
    ...
    while idx < arg2.length:
        ...
        mem[32] = sha3(arg1, 212)
        stor212[arg1][mem[(32 * idx) + 140 len 20]] = 1
        idx = idx + 1
        continue 
}
...
function removeWhitelist(uint256 arg1, address[] arg2) {
    ...
    while idx < arg2.length:
        ...
        mem[0] = mem[(32 * idx) + 140 len 20]
        mem[32] = sha3(arg1, 212)
        stor212[arg1][mem[(32 * idx) + 140 len 20]] = 0
        idx = idx + 1
        continue 
}
