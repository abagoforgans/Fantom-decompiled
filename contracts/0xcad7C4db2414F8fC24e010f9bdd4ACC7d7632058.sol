                        ...
                        if withdrawFeeFactor >= 10000:
                            ...
                            if arg2 <= ext_call.return_data[0]:
                                if wantLockedTotal >= arg2:
                                    ...
                                    if ext_code.size(wantAddress) <= 0:
                                        revert with 0, 'Address: call to non-contract'
                                    mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg2) >> 32
                                    call wantAddress with:
                                       funct uint32(stor12)
                                         gas gas_remaining wei
                            ...
                            if not arg2:
                                ...
                                if 0 <= ext_call.return_data[0]:
                                    if wantLockedTotal >= 0:
                                        ...
                                        if ext_code.size(wantAddress) <= 0:
                                            revert with 0, 'Address: call to non-contract'
                                        mem[580 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), 0
                                        call wantAddress with:
                                           funct uint32(stor12)
                                             gas gas_remaining wei
                                        ...
                                        if ext_code.size(wantAddress) <= 0:
                                            revert with 0, 'Address: call to non-contract'
                                        mem[580 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 0, stor16.field_32)
                                        call wantAddress with:
                                           funct uint32(stor12)
                                             gas gas_remaining wei
                                    ...
                                    if wantLockedTotal >= ext_call.return_data[0]:
                                        ...
                                        if ext_code.size(wantAddress) <= 0:
                                            revert with 0, 'Address: call to non-contract'
                                        mem[580 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), ext_call.return_data[0 len 28]
                                        call wantAddress with:
                                           funct uint32(stor12)
                                             gas gas_remaining wei
                                ...
                                if arg2 * withdrawFeeFactor / 10000 <= ext_call.return_data[0]:
                                    if wantLockedTotal >= arg2 * withdrawFeeFactor / 10000:
                                        ...
                                        if ext_code.size(wantAddress) <= 0:
                                            revert with 0, 'Address: call to non-contract'
                                        mem[580 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg2 * withdrawFeeFactor / 10000) >> 32
                                        call wantAddress with:
                                           funct uint32(stor12)
                                             gas gas_remaining wei
                            ...
                            if arg2 * sub_9ccccc15 / 10000 <= 0:
                                ...
                                if arg2 - (arg2 * sub_9ccccc15 / 10000) <= ext_call.return_data[0]:
                                    if wantLockedTotal >= arg2 - (arg2 * sub_9ccccc15 / 10000):
                                        ...
                                        if ext_code.size(wantAddress) <= 0:
                                            revert with 0, 'Address: call to non-contract'
                                        mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg2 - (arg2 * sub_9ccccc15 / 10000)) >> 32
                                        call wantAddress with:
                                           funct uint32(stor12)
                                             gas gas_remaining wei
                                ...
                                if arg2 * sub_9ccccc15 / 10000 <= 0:
                                    ...
                                    if -arg2 * sub_9ccccc15 / 10000 <= ext_call.return_data[0]:
                                        if wantLockedTotal >= -arg2 * sub_9ccccc15 / 10000:
                                            ...
                                            if ext_code.size(wantAddress) <= 0:
                                                revert with 0, 'Address: call to non-contract'
                                            mem[580 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, -arg2 * sub_9ccccc15 / 10000) >> 32
                                            call wantAddress with:
                                               funct uint32(stor12)
                                                 gas gas_remaining wei
                                ...
                                if arg2 * sub_9ccccc15 / 10000 <= 0:
                                    ...
                                    if (arg2 * withdrawFeeFactor / 10000) - (arg2 * sub_9ccccc15 / 10000) <= ext_call.return_data[0]:
                                        if wantLockedTotal >= (arg2 * withdrawFeeFactor / 10000) - (arg2 * sub_9ccccc15 / 10000):
                                            ...
                                            if ext_code.size(wantAddress) <= 0:
                                                revert with 0, 'Address: call to non-contract'
                                            mem[580 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, (arg2 * withdrawFeeFactor / 10000) - (arg2 * sub_9ccccc15 / 10000)) >> 32
                                            call wantAddress with:
                                               funct uint32(stor12)
                                                 gas gas_remaining wei
