...
function totalSupply() {
    require stor3
    return ((10^6 * block.timestamp - stor7 / 60 / stor3 * stor4) + 24 * 10^6)
}
...
function tokensToClaim(address arg1) {
    ...
    return ((24 * 10^6 * 10^12 * balanceOf[address(arg1)].field_256 / balanceOf[address(arg1)].field_768) + (10^6 * block.timestamp - stor7 / 60 / stor3 * stor4 * 10^12 * balanceOf[address(arg1)].field_256 / balanceOf[address(arg1)].field_768) / 10^12)
}
...
function allInfoFor(address arg1) {
    ...
    return (10^6 * block.timestamp - stor7 / 60 / stor3 * stor4) + 24 * 10^6, 
           ...
           (24 * 10^6 * 10^12 * balanceOf[address(arg1)].field_256 / balanceOf[address(arg1)].field_768) + (10^6 * block.timestamp - stor7 / 60 / stor3 * stor4 * 10^12 * balanceOf[address(arg1)].field_256 / balanceOf[address(arg1)].field_768) / 10^12
}
