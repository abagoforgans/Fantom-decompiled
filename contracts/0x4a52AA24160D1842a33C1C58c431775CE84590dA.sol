...
function harvest() payable {
    ...
    if ext_call.return_data[0]:
        ...
        mem[164] = 333 * ext_call.return_data[0] / 1000 / 2
        mem[96] = 68
        ...
        if not ext_code.size(sub_9935d7beAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32
        mem[352 len 4] = 0
        call sub_9935d7beAddress with:
           funct uint32(stor4)
             gas gas_remaining wei
        ...
        if not return_data.size:
            if not ext_call.success:
                revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 333 * ext_call.return_data[0] / 1000 / 2
            ...
            mem[264] = 333 * ext_call.return_data[0] / 1000 / 2
            mem[296] = 0
            ...
            if not sub_ad381466.length:
                ...
                call address(unirouterAddress).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args Mask(255, 1, 333 * ext_call.return_data[0] / 1000), 0, 160, address(treasuryAddress), block.timestamp, sub_ad381466.length
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[260 len return_data.size] = ext_call.return_data[0 len return_data.size]
                mem[64] = ceil32(return_data.size) + 260
                require return_data.size >= 32
                _984 = mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32
                require mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 <= 4294967296
                require mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 32 <= return_data.size
                require mem[mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 260] <= 4294967296 and mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + (32 * mem[mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 260]) + 32 <= return_data.size
                mem[ceil32(return_data.size) + 260] = mem[mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 260]
                _1004 = mem[_984 + 260]
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(sub_9935d7beAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(32 * _1004) + ceil32(return_data.size) + 456 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
                    mem[(32 * _1004) + ceil32(return_data.size) + 520 len 0] = 0
                    call sub_9935d7beAddress with:
                       funct uint32(stor5)
                         gas gas_remaining wei
                        args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _1004) + ceil32(return_data.size) + 520 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 333 * ext_call.return_data[0] / 1000 / 2
                    if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
                ...
                call address(unirouterAddress).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args Mask(255, 1, 333 * ext_call.return_data[0] / 1000), 0, 160, address(treasuryAddress), block.timestamp, sub_ad381466.length, mem[456 len 32 * sub_ad381466.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[260 len return_data.size] = ext_call.return_data[0 len return_data.size]
                mem[64] = ceil32(return_data.size) + 260
                require return_data.size >= 32
                _2545 = mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32
                require mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 <= 4294967296
                require mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 32 <= return_data.size
                require mem[mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 260] <= 4294967296 and mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + (32 * mem[mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 260]) + 32 <= return_data.size
                mem[ceil32(return_data.size) + 260] = mem[mem[260 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 260]
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(sub_9935d7beAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(32 * _2632) + ceil32(return_data.size) + 456 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
                    mem[(32 * _2632) + ceil32(return_data.size) + 520 len 0] = 0
                    call sub_9935d7beAddress with:
                       funct uint32(stor5)
                         gas gas_remaining wei
                        args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _2632) + ceil32(return_data.size) + 520 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 333 * ext_call.return_data[0] / 1000 / 2
                    if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
        ...
        if not return_data.size:
            ...
            mem[ceil32(return_data.size) + 265] = 333 * ext_call.return_data[0] / 1000 / 2
            ...
            if not sub_ad381466.length:
                ...
                require return_data.size >= 32
                _973 = mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32
                require mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 <= 4294967296
                require mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 32 <= return_data.size
                require mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261] <= 4294967296 and mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261]) + 32 <= return_data.size
                mem[ceil32(return_data.size) + ceil32(return_data.size) + 261] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261]
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(sub_9935d7beAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(32 * _996) + ceil32(return_data.size) + ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
                    mem[(32 * _996) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 0] = 0
                    call sub_9935d7beAddress with:
                       funct uint32(stor5)
                         gas gas_remaining wei
                        args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _996) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 333 * ext_call.return_data[0] / 1000 / 2
                    if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
            ...
            call address(unirouterAddress).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args Mask(255, 1, 333 * ext_call.return_data[0] / 1000), 0, 160, address(treasuryAddress), block.timestamp, sub_ad381466.length, mem[ceil32(return_data.size) + 457 len 32 * sub_ad381466.length]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[ceil32(return_data.size) + 261 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = ceil32(return_data.size) + ceil32(return_data.size) + 261
            require return_data.size >= 32
            _2547 = mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32
            require mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 <= 4294967296
            require mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 32 <= return_data.size
            require mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261] <= 4294967296 and mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261]) + 32 <= return_data.size
            mem[ceil32(return_data.size) + ceil32(return_data.size) + 261] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261]
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.size(sub_9935d7beAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(32 * _2649) + ceil32(return_data.size) + ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
                mem[(32 * _2649) + ceil32(return_data.size) + ceil32(return_data.size) + 549 len 4] = 0
                call sub_9935d7beAddress with:
                   funct uint32(stor5)
                     gas gas_remaining wei
                    args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _2649) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 333 * ext_call.return_data[0] / 1000 / 2
                if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
        ...
        if not sub_ad381466.length:
            ...
            mem[64] = ceil32(return_data.size) + ceil32(return_data.size) + 261
            require return_data.size >= 32
            _987 = mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32
            require mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 <= 4294967296
            require mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 32 <= return_data.size
            require mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261] <= 4294967296 and mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261]) + 32 <= return_data.size
            mem[ceil32(return_data.size) + ceil32(return_data.size) + 261] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261]
            ...
            if not ext_code.size(sub_9935d7beAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(32 * _1006) + ceil32(return_data.size) + ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
            mem[(32 * _1006) + ceil32(return_data.size) + ceil32(return_data.size) + 549 len 4] = 0
            call sub_9935d7beAddress with:
               funct uint32(stor5)
                 gas gas_remaining wei
                args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _1006) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 333 * ext_call.return_data[0] / 1000 / 2
                if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
        ...
        mem[64] = ceil32(return_data.size) + ceil32(return_data.size) + 261
        require return_data.size >= 32
        _2549 = mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32
        require mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 <= 4294967296
        require mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 32 <= return_data.size
        require mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261] <= 4294967296 and mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261]) + 32 <= return_data.size
        mem[ceil32(return_data.size) + ceil32(return_data.size) + 261] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 261 len 4], Mask(224, 32, 333 * ext_call.return_data[0] / 1000) >> 32 + 261]
        ...
        if ext_call.return_data[0]:
            ...
            if not ext_code.size(sub_9935d7beAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(32 * _2666) + ceil32(return_data.size) + ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
            mem[(32 * _2666) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 0] = 0
            call sub_9935d7beAddress with:
               funct uint32(stor5)
                 gas gas_remaining wei
                args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _2666) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 333 * ext_call.return_data[0] / 1000 / 2
                if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
    ...
    if not return_data.size:
        ...
        if not sub_ad381466.length:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.size(sub_9935d7beAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(32 * _1008) + ceil32(return_data.size) + 456 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
                mem[(32 * _1008) + ceil32(return_data.size) + 520 len 0] = 0
                call sub_9935d7beAddress with:
                   funct uint32(stor5)
                     gas gas_remaining wei
                    args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _1008) + ceil32(return_data.size) + 520 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 0
                if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.size(sub_9935d7beAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(32 * _2700) + ceil32(return_data.size) + 456 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
                mem[(32 * _2700) + ceil32(return_data.size) + 520 len 0] = 0
                call sub_9935d7beAddress with:
                   funct uint32(stor5)
                     gas gas_remaining wei
                    args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _2700) + ceil32(return_data.size) + 520 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 0
                if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
    ...
    if not return_data.size:
        ...
        if not sub_ad381466.length:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.size(sub_9935d7beAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(32 * _998) + ceil32(return_data.size) + ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
                mem[(32 * _998) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 0] = 0
                call sub_9935d7beAddress with:
                   funct uint32(stor5)
                     gas gas_remaining wei
                    args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _998) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 0
                if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
        ...
        if not ext_call.return_data[0]:
            ...
            if not ext_code.size(sub_9935d7beAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(32 * _2717) + ceil32(return_data.size) + ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
            mem[(32 * _2717) + ceil32(return_data.size) + ceil32(return_data.size) + 549 len 4] = 0
            call sub_9935d7beAddress with:
               funct uint32(stor5)
                 gas gas_remaining wei
                args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _2717) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 0
            if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
    ...
    if not sub_ad381466.length:
        ...
        if not ext_call.return_data[0]:
            ...
            if not ext_code.size(sub_9935d7beAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(32 * _1010) + ceil32(return_data.size) + ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
            mem[(32 * _1010) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 0] = 0
            call sub_9935d7beAddress with:
               funct uint32(stor5)
                 gas gas_remaining wei
                args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _1010) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 0
            if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_code.size(sub_9935d7beAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(32 * _2734) + ceil32(return_data.size) + ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, 667 * ext_call.return_data[0] / 1000) >> 32
        mem[(32 * _2734) + ceil32(return_data.size) + ceil32(return_data.size) + 549 len 4] = 0
        call sub_9935d7beAddress with:
           funct uint32(stor5)
             gas gas_remaining wei
            args Mask(224, 32, 667 * ext_call.return_data[0] / 1000) << 224, mem[(32 * _2734) + ceil32(return_data.size) + ceil32(return_data.size) + 521 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 0
        if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor4):
