...
function setTaxFee(uint256 arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 <= 0:
        revert with 0, 'CashSwap: Tax Fee out of range!'
    if arg1 > 1000:
        revert with 0, 'CashSwap: Tax Fee out of range!'
    taxFee = arg1
    emit TaxFeeSet(arg1);
                ...
                if stor12[address(arg1)]:
                    ...
                    if not arg2:
                        ...
                        if taxFeeTotal < taxFeeTotal:
                            revert with 0, 'SafeMath: addition overflow'
                        if not msg.sender:
                            revert with 0, 32, 37, 0x7745524332303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[425 len 27]
                        if not arg1:
        ...
        if uint8(stor14.field_0):
            ...
            if msg.sender == uniswapV2PairAddress:
                ...
                if balanceOf[address(this.address)] < minTokenBeforeSwap:
                    ...
                    if not isTaxActive:
                        if not msg.sender:
                            revert with 0, 'wERC20: transfer from the zero addres'
                        if not arg1:
                        ...
                        if stor12[address(msg.sender)]:
                            ...
                            if stor12[address(arg1)]:
                                ...
                                if not arg2:
                                    if not msg.sender:
                                        revert with 0, 'wERC20: transfer from the zero addres', mem[425 len 27]
                                    if not this.address:
                                    ...
                                    if taxFeeTotal < taxFeeTotal:
                                        revert with 0, 'SafeMath: addition overflow'
                                    if not msg.sender:
                                        revert with 0, 32, 37, 0x7745524332303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[585 len 27]
                                    if not arg1:
            ...
            if stakingPoolAddress != msg.sender:
                if arg3 > allowance[address(arg1)][address(msg.sender)]:
                    revert with 0, 
                                32,
                                43,
                                0x7343617368537761703a207472616e7366657220616d6f756e74206578636565647320616c6c6f77616e63,
                                mem[267 len 21],
                                mem[309 len 11]
                if not arg1:
