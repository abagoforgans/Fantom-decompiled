...
function depositAll() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            call address(ext_call.return_data[0]) with:
                 gas gas_remaining wei
                args ext_call.return_data[0], mem[424 len 60], mem[584 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, 0x2569c0423b69ab70250d5b2fc66803195cb54acd, 0
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if not return_data.size:
            ...
            if ext_code.size(address(ext_call.return_data[0])) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[488 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * sub_54747a70 / 10000)) >> 32
            mem[612 len 4] = 0
            call address(ext_call.return_data[0]) with:
                 gas gas_remaining wei
                args ext_call.return_data[0] - (ext_call.return_data[0] * sub_54747a70 / 10000), mem[424 len 60], mem[584 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), 
                                msg.sender,
            ...
            if return_data.size <= 0:
                ...
                if ext_code.size(address(ext_call.return_data[0])) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 489 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * sub_54747a70 / 10000)) >> 32
                mem[ceil32(return_data.size) + 613 len 4] = 0
                call address(ext_call.return_data[0]) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0] - (ext_call.return_data[0] * sub_54747a70 / 10000), mem[ceil32(return_data.size) + 425 len 60], mem[ceil32(return_data.size) + 585 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with unknown_0x23b872dd(?????), 
                                    msg.sender,
