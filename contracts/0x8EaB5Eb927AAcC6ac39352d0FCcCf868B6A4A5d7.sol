...
function sub_3b67612f(?) {
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length - 1:
            ...
            _215 = mem[(32 * idx) + (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 288]
            mem[mem[64]] = 0x1f00ca7400000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = _215
            mem[mem[64] + 36] = 64
            _221 = mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 160]
            ...
            staticcall address(_211).getAmountsIn(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args _215, 64, mem[mem[64] + 68 len (32 * _221) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _247 = mem[64]
        ...
        while idx < ('cd', 36).length - 1:
            ...
            _213 = mem[(32 * idx) + 128]
            require idx < mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 256]
            _217 = mem[(32 * idx) + (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 288]
            mem[mem[64]] = 0x1f00ca7400000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = _217
            mem[mem[64] + 36] = 64
            _222 = mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 160]
            mem[mem[64] + 68] = mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 160]
            s = 0
            t = (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192
            u = mem[64] + 100
            ...
            staticcall address(_213).getAmountsIn(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args _217, 64, mem[mem[64] + 68 len (32 * _222) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _248 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
    ...
    mem[mem[64]] = mem[(32 * mem[(32 * ('cd', 4).length) + 128] - 1) + (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 288]
    return memory
      from mem[64]
       len 32
}
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length - 1:
            ...
            while s < _221:
                ...
                continue 
            require ext_code.size(address(_211))
            staticcall address(_211).getAmountsOut(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args _215, 64, mem[mem[64] + 68 len (32 * _221) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        ...
        while idx < ('cd', 36).length - 1:
            ...
            while s < _222:
                ...
                continue 
            require ext_code.size(address(_213))
            staticcall address(_213).getAmountsOut(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args _217, 64, mem[mem[64] + 68 len (32 * _222) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function sub_008bf8b3(?) {
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length - 1:
            ...
            staticcall address(_251).getAmountsOut(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args _255, 64, mem[mem[64] + 68 len (32 * _259) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _287 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
    ...
    while idx < ('cd', 36).length - 1:
        ...
        staticcall address(_253).getAmountsOut(uint256 arg1, address[] arg2) with:
                gas gas_remaining wei
               args _257, 64, mem[mem[64] + 68 len (32 * _260) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _288 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if ceil32(_1297) <= _1297:
                    ...
                    if not return_data.size:
                        ...
                        if return_data.size <= 0:
                            ...
                            mem[_1269 + ceil32(return_data.size) + ceil32(return_data.size) + 261] = _2125
                            ...
                            require _1269 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_1269 + ceil32(return_data.size) + mem[_1269 + ceil32(return_data.size) + 261 len 4], Mask(224, 32, _1230) >> 32 + 261]) + 293 <= test266151307() and (32 * mem[_1269 + ceil32(return_data.size) + mem[_1269 + ceil32(return_data.size) + 261 len 4], Mask(224, 32, _1230) >> 32 + 261]) + 32 >= 0
                            mem[64] = _1269 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_1269 + ceil32(return_data.size) + mem[_1269 + ceil32(return_data.size) + 261 len 4], Mask(224, 32, _1230) >> 32 + 261]) + 293
                            mem[_1269 + ceil32(return_data.size) + ceil32(return_data.size) + 261] = _2126
                    ...
                    if not return_data.size:
                        ...
                        if return_data.size <= 0:
                            ...
                            require _1269 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_1269 + ceil32(return_data.size) + mem[_1269 + ceil32(return_data.size) + 261 len 4], Mask(224, 32, _1230) >> 32 + 261]) + 293 <= test266151307() and (32 * mem[_1269 + ceil32(return_data.size) + mem[_1269 + ceil32(return_data.size) + 261 len 4], Mask(224, 32, _1230) >> 32 + 261]) + 32 >= 0
                            mem[64] = _1269 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_1269 + ceil32(return_data.size) + mem[_1269 + ceil32(return_data.size) + 261 len 4], Mask(224, 32, _1230) >> 32 + 261]) + 293
                            mem[_1269 + ceil32(return_data.size) + ceil32(return_data.size) + 261] = _2129
                            ...
                            require _1269 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_1269 + ceil32(return_data.size) + mem[_1269 + ceil32(return_data.size) + 261 len 4], Mask(224, 32, _1230) >> 32 + 261]) + 293 <= test266151307() and (32 * mem[_1269 + ceil32(return_data.size) + mem[_1269 + ceil32(return_data.size) + 261 len 4], Mask(224, 32, _1230) >> 32 + 261]) + 32 >= 0
                            mem[64] = _1269 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_1269 + ceil32(return_data.size) + mem[_1269 + ceil32(return_data.size) + 261 len 4], Mask(224, 32, _1230) >> 32 + 261]) + 293
                            mem[_1269 + ceil32(return_data.size) + ceil32(return_data.size) + 261] = _2130
