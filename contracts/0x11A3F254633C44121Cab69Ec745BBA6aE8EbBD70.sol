...
function byteCode(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return 32, 7346, code.data[5986 len 7314], mem[7442 len 14] >> 58256, arg1, 0 >> 58512, 0
}
...
function deploy(address arg1) payable {
    ...
    if feeds[address(arg1)]:
        revert with 0, 'PE'
    mem[7552 len 7328] = code.data[5986 len 7314], mem[7442 len 14]
    mem[14866] = arg1
    mem[14930] = address(arg1)
    mem[14898] = 20
    create2 contract with 0 wei
                    salt: sha3(arg1)
                    code: mem[7552 len mem[7520]]
