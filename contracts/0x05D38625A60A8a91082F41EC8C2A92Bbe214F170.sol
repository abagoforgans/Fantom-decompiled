    ...
    if finalValue:
        ...
        if finalValue + arg1 <= totalUsers:
            ...
            while idx < finalValue + arg1:
                ...
                call balanceKeeperAddress.userAddresses(uint256 arg1) with:
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        if ext_call.return_data[0] < sub_0047ea0c:
            revert with 'NH{q', 17
        currentPortion = ext_call.return_data[0] - sub_0047ea0c
        require ext_code.size(balanceKeeperAddress)
