...
function accumulated(address arg1) payable {
    ...
    if stor4[address(arg1)]:
        ...
        if not block.timestamp - stor4[address(arg1)]:
            ...
            if block.timestamp - stor4[address(arg1)]:
        ...
        if not block.timestamp - stor5[address(arg1)]:
            ...
            if block.timestamp - stor5[address(arg1)]:
...
function claim() payable {
    ...
    if stor4[address(msg.sender)]:
        ...
        if not block.timestamp - stor4[address(msg.sender)]:
            ...
            if totalSupply + (0 / SECONDS_IN_A_DAY) < totalSupply:
                revert with 0, 'SafeMath: addition overflow'
            totalSupply += 0 / SECONDS_IN_A_DAY
            if balanceOf[address(msg.sender)] + (0 / SECONDS_IN_A_DAY) < balanceOf[address(msg.sender)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(msg.sender)] += 0 / SECONDS_IN_A_DAY
            emit Transfer((0 / SECONDS_IN_A_DAY), 0, msg.sender);
            return (0 / SECONDS_IN_A_DAY)
        require block.timestamp - stor4[address(msg.sender)]
        ...
        if not msg.sender:
            revert with 0, 'ERC20: mint to the zero address'
        if totalSupply + ((block.timestamp * sub_5954c6a1) - (stor4[address(msg.sender)] * sub_5954c6a1) / SECONDS_IN_A_DAY) < totalSupply:
            revert with 0, 'SafeMath: addition overflow'
        totalSupply += (block.timestamp * sub_5954c6a1) - (stor4[address(msg.sender)] * sub_5954c6a1) / SECONDS_IN_A_DAY
        if balanceOf[address(msg.sender)] + ((block.timestamp * sub_5954c6a1) - (stor4[address(msg.sender)] * sub_5954c6a1) / SECONDS_IN_A_DAY) < balanceOf[address(msg.sender)]:
            revert with 0, 'SafeMath: addition overflow'
    ...
    if not msg.sender:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + ((block.timestamp * sub_5954c6a1) - (stor5[address(msg.sender)] * sub_5954c6a1) / SECONDS_IN_A_DAY) < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += (block.timestamp * sub_5954c6a1) - (stor5[address(msg.sender)] * sub_5954c6a1) / SECONDS_IN_A_DAY
    if balanceOf[address(msg.sender)] + ((block.timestamp * sub_5954c6a1) - (stor5[address(msg.sender)] * sub_5954c6a1) / SECONDS_IN_A_DAY) < balanceOf[address(msg.sender)]:
        revert with 0, 'SafeMath: addition overflow'
