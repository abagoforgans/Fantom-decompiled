...
function safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) payable {
    ...
    if arg1 == msg.sender:
        ...
        mem[(32 * _8979) + (32 * _8755) + mem[64] + 260 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])] = mem[(32 * arg3.length) + (32 * arg4.length) + 192 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])]
        if not _9205 % 32:
            require ext_code.size(arg2)
            call arg2.0xbc197c81 with:
                 gas gas_remaining wei
                args msg.sender, address(arg1), 160, mem[mem[64] + 100 len _9205 + (32 * _8979) + (32 * _8755) + 160]
        ...
        mem[floor32(_9205) + (32 * _8979) + (32 * _8755) + mem[64] + 260] = mem[floor32(_9205) + (32 * _8979) + (32 * _8755) + mem[64] + -(_9205 % 32) + 292 len _9205 % 32]
        require ext_code.size(arg2)
        call arg2.0xbc197c81 with:
             gas gas_remaining wei
    ...
    while idx < allProxyRegistries.length:
        ...
        if not _9422 % 32:
            ...
            while idx < _9690:
                ...
                continue 
            if not _9690 % 32:
                revert with 0, 32, mem[mem[64] + 36 len _9690 + 32]
            mem[floor32(_9690) + mem[64] + 68] = mem[floor32(_9690) + mem[64] + -(_9690 % 32) + 100 len _9690 % 32]
            revert with 0, 32, mem[mem[64] + 36 len floor32(_9690) + 64]
    ...
    if not _9419 % 32:
        ...
        call arg2.0xbc197c81 with:
             gas gas_remaining wei
            args msg.sender, address(arg1), 160, mem[mem[64] + 100], (32 * _9208) + (32 * mem[96]) + 224, mem[mem[64] + 164 len _9419 + (32 * _9208) + (32 * mem[96]) + 96]
        mem[mem[64]] = ext_call.return_data[0]
        if ext_call.success:
            require return_data.size >= 32
            if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
        ...
        if not mem[_9657 + ext_call.return_data[0]]:
            ...
            revert with 0, 32, mem[mem[64] + 36], 160, mem[mem[64] + 100 len floor32(_9683)]
    ...
    call arg2.0xbc197c81 with:
         gas gas_remaining wei
        args msg.sender, address(arg1), 160, mem[mem[64] + 100], (32 * _9208) + (32 * _8991) + 224, mem[mem[64] + 164 len floor32(_9419) + (32 * _9208) + (32 * _8991) + 128]
    mem[mem[64]] = ext_call.return_data[0]
    if ext_call.success:
        require return_data.size >= 32
        if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
