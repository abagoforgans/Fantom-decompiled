...
function setTransferFee(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
    if arg1 > 2500:
        revert with 0, 'Fee cannot be greater than 25%'
    if arg1:
        stor5 = 1
    else:
        stor5 = 0
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if not stor5:
        ...
        if stor8[address(arg2)]:
            ...
            if not arg1:
                revert with 0, 32, 37, 0x7245524332303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[361 len 27]
            if not arg2:
