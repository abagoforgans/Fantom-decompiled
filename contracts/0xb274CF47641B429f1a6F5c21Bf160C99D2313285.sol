...
function changeFee(uint256 arg1) {
    require calldata.size - 4 >= 32
    if msg.sender != 0xf4cb4eab20236d95b1475f20d101fb509fdcb587:
        revert with 0, '!owner'
    fee = arg1
}
...
function pay() payable {
    if sub_248b8725 == -1:
        revert with 0, 17
    sub_248b8725++
    if not payments[msg.sender]:
        if sub_3d7832e8 == -1:
            revert with 0, 17
        sub_3d7832e8++
    if payments[msg.sender] > !msg.value:
        revert with 0, 17
    payments[msg.sender] += msg.value
    if totalIncome > !msg.value:
        revert with 0, 17
...
function sub_fa706183(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    sub_b8cbdd4a[msg.sender] = address(create2.new_address)
    if sub_2867baac > -2:
        revert with 0, 17
    sub_2867baac++
    if totalIncome > !msg.value:
