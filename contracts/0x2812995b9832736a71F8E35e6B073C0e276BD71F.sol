...
function sub_40ff98fc(?) {
    ...
    create contract with 0 wei
                    code: code.data[1954 len 974], address(arg1)
...
function sub_94485923(?) {
    ...
    while idx < ('cd', 4).length:
        if idx >= mem[96]:
            revert with 'NH{q', 50
        _14 = mem[(32 * idx) + 128]
        mem[floor32(('cd', 4).length) + 97 len 974] = code.data[1954 len 974]
        mem[floor32(('cd', 4).length) + 1071] = address(_14)
        create contract with 0 wei
                        code: code.data[1954 len 974], address(_14)
        if not create.new_address:
            revert with ext_call.return_data[0 len return_data.size]
        if idx == -1:
            revert with 'NH{q', 17
...
function sub_3ae1040d(?) {
    ...
    while idx < _5:
        ...
        mem[mem[64] len 974] = code.data[1954 len 974]
        mem[mem[64] + 974] = address(_21)
        create contract with 0 wei
                        code: code.data[1954 len 974], address(_21)
        if not create.new_address:
            revert with ext_call.return_data[0 len return_data.size]
        if idx == -1:
            revert with 'NH{q', 17
