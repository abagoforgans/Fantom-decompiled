...
function sub_61338cee(?) payable {
    ...
    mem[ceil32(arg1.length) + (32 * arg2.length) + floor32(arg1.length) + -(arg1.length % 32) + 192 len arg1.length % 32] = mem[floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32]
    mem[arg1.length + ceil32(arg1.length) + (32 * arg2.length) + 160] = 1
    _100 = sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[ceil32(arg1.length) + (32 * arg2.length) + floor32(arg1.length) + 160 len (arg1.length % 32) + 32])
    ...
    require ext_code.size(stor[_100])
    staticcall stor[_100].getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
    ...
    require return_data.size >= 32
    _137 = mem[ceil32(arg1.length) + (32 * arg2.length) + 160 len 4], Mask(224, 32, arg3) >> 32
    ...
    _140 = mem[_137 + ceil32(arg1.length) + (32 * arg2.length) + 160]
    mem[ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 192 len floor32(mem[_137 + ceil32(arg1.length) + (32 * arg2.length) + 160])] = mem[_137 + ceil32(arg1.length) + (32 * arg2.length) + 192 len floor32(mem[_137 + ceil32(arg1.length) + (32 * arg2.length) + 160])]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).kLast() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(32 * _140) + ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 224] = ext_call.return_data[0]
    mem[(32 * _140) + ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 192] = 64
    mem[(32 * _140) + ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 256] = mem[ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 160]
    mem[(32 * _140) + ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 288 len floor32(mem[ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 160])] = mem[ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 192 len floor32(mem[ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 160])]
    return 64, 
           ext_call.return_data[0],
           mem[(32 * _140) + ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 256 len (32 * mem[ceil32(arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 160]) + 32]
}
