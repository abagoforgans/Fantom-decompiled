...
function createNFT(address arg1, string arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    ...
    if stor6[stor7].field_0:
        if stor6[stor7].field_0 == uint255(stor6[stor7].field_0) * 0.5 < 32:
            revert with 0, 34
        if arg2.length:
            ...
            idx = 0
            while (uint255(stor6[stor7].field_0) * 0.5) + 31 / 32 > idx:
