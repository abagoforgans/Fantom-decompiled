...
function relay(string[] arg1, uint64[] arg2, uint64[] arg3, uint64[] arg4) payable {
    ...
    while idx < _374:
        ...
        s = 0
        while s < _468:
            mem[_467 + s] = mem[_466 + s + 32]
            s = s + 32
            continue 
        mem[_467 + _468] = 1
        stor[sha3(mem[mem[64] len _467 + _468 + -mem[64] + 32])].field_0 = mem[_458 + 24 len 8]
        stor[sha3(mem[mem[64] len _467 + _468 + -mem[64] + 32])].field_64 = mem[_458 + 56 len 8]
        stor[sha3(mem[mem[64] len _467 + _468 + -mem[64] + 32])].field_128 = mem[_458 + 88 len 8]
        require idx < mem[96]
        if ceil32(_468) <= _468:
            _537 = mem[(32 * idx) + 128]
            _538 = mem[64]
            _547 = mem[mem[(32 * idx) + 128]]
            s = 0
            while s < _547:
                mem[_538 + s] = mem[_537 + s + 32]
                s = s + 32
                continue 
            if ceil32(_547) <= _547:
                _594 = sha3(mem[mem[64] len _538 + _547 - mem[64]])
                require idx < mem[_96]
                require idx < mem[_188]
                ...
                mem[_538 + _547] = 0
                _602 = sha3(mem[mem[64] len _538 + _547 - mem[64]])
                require idx < mem[_96]
                require idx < mem[_188]
            ...
            s = 0
            while s < _548:
                mem[_546 + s] = mem[_545 + s + 32]
                s = s + 32
                continue 
            if ceil32(_548) <= _548:
                _597 = sha3(mem[mem[64] len _546 + _548 - mem[64]])
                require idx < mem[_96]
                require idx < mem[_188]
                ...
                mem[_546 + _548] = 0
                _607 = sha3(mem[mem[64] len _546 + _548 - mem[64]])
                require idx < mem[_96]
                require idx < mem[_188]
...
function sub_1be0ac6a(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[_200] = cd[(cd[4] + cd[s] + 36)]
        require cd[4] + cd[s] + cd[(cd[4] + cd[s] + 36)] + 68 <= calldata.size
        mem[_200 + 32 len cd[(cd[4] + cd[s] + 36)]] = call.data[cd[4] + cd[s] + 68 len cd[(cd[4] + cd[s] + 36)]]
        mem[_200 + cd[(cd[4] + cd[s] + 36)] + 32] = 0
        mem[t] = _200
        idx = idx + 1
        s = s + 32
        t = t + 32
    ...
    while idx < ('cd', 36).length:
        ...
        mem[_403] = cd[(cd[36] + cd[s] + 36)]
        require cd[36] + cd[s] + cd[(cd[36] + cd[s] + 36)] + 68 <= calldata.size
        mem[_403 + 32 len cd[(cd[36] + cd[s] + 36)]] = call.data[cd[36] + cd[s] + 68 len cd[(cd[36] + cd[s] + 36)]]
        mem[_403 + cd[(cd[36] + cd[s] + 36)] + 32] = 0
        mem[t] = _403
        idx = idx + 1
        s = s + 32
        t = t + 32
    ...
    s = var38001
    s = var38002
    while _201 + (32 * ('cd', 36).length) + 31:
        mem[64] = mem[64] + 96
        mem[_402 + (32 * _400) + 32] = 0
        mem[_402 + (32 * _400) + 64] = 0
        mem[_402 + (32 * _400) + 96] = 0
        mem[cd[36] + (32 * ('cd', 36).length) + 68] = _402 + (32 * _400) + 32
        s = cd[36] + (32 * ('cd', 36).length) + 68
        s = _201 + (32 * ('cd', 36).length) + 31
        continue 
    idx = 0
    while idx < _400:
        require idx < mem[96]
