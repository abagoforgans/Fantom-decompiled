...
function sub_4af0d349(?) payable {
    ...
    require return_data.size >= 32
    _32 = mem[(32 * arg2.length) + 128 len 4], Mask(224, 32, arg1) >> 32
    ...
    _35 = mem[_32 + (32 * arg2.length) + 128]
    mem[(32 * arg2.length) + ceil32(return_data.size) + 160 len floor32(mem[_32 + (32 * arg2.length) + 128])] = mem[_32 + (32 * arg2.length) + 160 len floor32(mem[_32 + (32 * arg2.length) + 128])]
    require sub_e7492977.length - 1 < mem[(32 * arg2.length) + ceil32(return_data.size) + 128]
    if mem[(32 * sub_e7492977.length - 1) + (32 * arg2.length) + ceil32(return_data.size) + 160] <= arg1:
    mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 164] = arg1
    mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 196] = arg1
    mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 260] = this.address
    mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 292] = 9999999999999999999
    mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 228] = 160
    mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 324] = arg2.length
    mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 356 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
    require ext_code.size(sushiRouterAddress)
    call sushiRouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args arg1, arg1, Array(len=arg2.length, data=call.data[arg2 + 36 len floor32(arg2.length)], mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + floor32(arg2.length) + 356 len (32 * arg2.length) - floor32(arg2.length)]), address(this.address), 9999999999999999999
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (32 * _35) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160
    require return_data.size >= 32
    require mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160 len 4], Mask(224, 32, arg1) >> 32 <= 4294967296
    require mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160 len 4], Mask(224, 32, arg1) >> 32 + 32 <= return_data.size
    require mem[mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160 len 4], Mask(224, 32, arg1) >> 32 + (32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160] <= 4294967296 and mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160 len 4], Mask(224, 32, arg1) >> 32 + (32 * mem[mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160 len 4], Mask(224, 32, arg1) >> 32 + (32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160]) + 32 <= return_data.size
    mem[(32 * _35) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160] = mem[mem[(32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160 len 4], Mask(224, 32, arg1) >> 32 + (32 * _35) + (32 * arg2.length) + ceil32(return_data.size) + 160]
    require arg2.length - 1 < mem[(32 * _35) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160]
}
