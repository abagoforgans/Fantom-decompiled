        ...
        if not sharesTotal * arg2:
            ...
            if not isAutoComp:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            return (0 / wantLockedTotal / 10000)
    ('mul', ('stor', ('name', 'sharesTotal', 15)), ('param', 'arg2'))
    if entranceFeeFactor * sharesTotal * arg2 / sharesTotal * arg2 != entranceFeeFactor:
        revert with 0, 
                    32,
                    33,
            ...
            if wantLockedTotal >= arg2:
                if not arg2:
                    ...
                    if 0 / wantLockedTotal <= sharesTotal:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg2) >> 32
                        call wantAddress with:
                           funct uint32(stor10)
                             gas gas_remaining wei
                        ...
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), arg2
                ...
                if not wantLockedTotal:
                    ...
                    if 0 / wantLockedTotal <= sharesTotal:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 0, stor14.field_32)
                        call wantAddress with:
                           funct uint32(stor10)
                             gas gas_remaining wei
                        ...
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), wantLockedTotal
                            if not transfer(address rg1, uint256 rg2), Mask(224, 0, stor10):
                                revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                        else:
                            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
