...
function updatePool(uint256 arg1) payable {
    ...
    poolInfo[arg1].field_1024 = poolInfo[arg1].field_1024
    emit UpdatePool(poolInfo[arg1].field_512, ext_call.return_data[0], poolInfo[arg1].field_768 + (10^12 * (block.timestamp * rewardPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * rewardPerSecond * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]), arg1);
    return poolInfo[arg1].field_0, 
           poolInfo[arg1].field_256,
           poolInfo[arg1].field_512,
           poolInfo[arg1].field_768 + (10^12 * (block.timestamp * rewardPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * rewardPerSecond * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]),
    ...
    while idx < arg1.length:
        ...
        if block.timestamp - poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512:
            ...
            if not mem[_37]:
                ...
                emit UpdatePool(poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512, _38, poolInfo[cd[((32 * idx) + arg1 + 36)]].field_768, cd[((32 * idx) + arg1 + 36)]);
            else:
                ...
                mem[mem[64] + 32] = _38
                mem[mem[64] + 64] = _58
                emit UpdatePool(poolInfo[cd[((32 * idx) + arg1 + 36)]].field_512, _38, _58, cd[((32 * idx) + arg1 + 36)]);
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        continue 
        ...
        if userInfo[idx][msg.sender].field_0:
            ...
            if not block.timestamp - poolInfo[idx].field_512:
                ...
                if not mem[_99]:
                    ...
                    emit UpdatePool(poolInfo[idx].field_512, _100, poolInfo[idx].field_768, idx);
                    if userInfo[idx][msg.sender].field_0 and poolInfo[idx].field_768 > -1 / userInfo[idx][msg.sender].field_0:
                        revert with 0, 17
                    if userInfo[idx][msg.sender].field_0 * poolInfo[idx].field_768 / 10^12 < userInfo[idx][msg.sender].field_256:
                        revert with 0, 17
                    ...
                    mem[mem[64] + 32] = _100
                    mem[mem[64] + 64] = _139
                    emit UpdatePool(poolInfo[idx].field_512, _100, _139, idx);
                    _148 = mem[_92 + 96]
