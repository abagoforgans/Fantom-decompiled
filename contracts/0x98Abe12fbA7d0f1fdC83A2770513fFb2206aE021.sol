...
function claim() payable {
    ...
    if not block.timestamp - sub_4b94f120:
        ...
        if not tokenBoughtTotal[msg.sender] / sub_08d09957[msg.sender]:
            revert with 0, 'SafeMath: division by zero'
        if 0 / tokenBoughtTotal[msg.sender] / sub_08d09957[msg.sender] > sub_08d09957[msg.sender]:
            revert with 0, 'SafeMath: subtraction overflow'
        sub_08d09957[msg.sender] -= 0 / tokenBoughtTotal[msg.sender] / sub_08d09957[msg.sender]
        require ext_code.size(stor4)
        call stor4.0xa9059cbb with:
             gas gas_remaining wei
            args msg.sender, 0 / tokenBoughtTotal[msg.sender] / sub_08d09957[msg.sender]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        emit TokenClaim(msg.sender, 0 / tokenBoughtTotal[msg.sender] / sub_08d09957[msg.sender]);
    else:
        ...
        if (100 * block.timestamp) - (100 * sub_4b94f120) / 600 <= 10000:
            if not tokenBoughtTotal[msg.sender]:
                ...
                if (100 * block.timestamp) - (100 * sub_4b94f120) / 600 * tokenBoughtTotal[msg.sender] / 10000 / tokenBoughtTotal[msg.sender] / sub_08d09957[msg.sender] > sub_08d09957[msg.sender]:
                    revert with 0, 'SafeMath: subtraction overflow'
                sub_08d09957[msg.sender] -= (100 * block.timestamp) - (100 * sub_4b94f120) / 600 * tokenBoughtTotal[msg.sender] / 10000 / tokenBoughtTotal[msg.sender] / sub_08d09957[msg.sender]
                require ext_code.size(stor4)
                call stor4.0xa9059cbb with:
                     gas gas_remaining wei
            ...
            if not tokenBoughtTotal[msg.sender]:
                ...
                if 10000 * tokenBoughtTotal[msg.sender] / 10000 / tokenBoughtTotal[msg.sender] / sub_08d09957[msg.sender] > sub_08d09957[msg.sender]:
                    revert with 0, 'SafeMath: subtraction overflow'
                sub_08d09957[msg.sender] -= 10000 * tokenBoughtTotal[msg.sender] / 10000 / tokenBoughtTotal[msg.sender] / sub_08d09957[msg.sender]
                require ext_code.size(stor4)
                call stor4.0xa9059cbb with:
                     gas gas_remaining wei
