...
array of uint256 sub_ef4b00b6;
mapping of uint256 sub_5e5e036d;
array of struct sub_1017e256;
mapping of uint8 stor9;
mapping of uint8 stor10;

function sub_1017e256(?) payable {
    require calldata.size - 4 >= 96
    require arg1 == arg1
    require arg2 == address(arg2)
    require arg3 == arg3
    require arg3 < uint256(sub_1017e256[arg1][arg2].field_0)
    return uint256(sub_1017e256[arg1][arg2][arg3].field_0)
}

function sub_5e5e036d(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == address(arg2)
    return sub_5e5e036d[arg1][arg2]
}
...
function sub_ef4b00b6(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    require arg2 < sub_ef4b00b6[arg1]
    return sub_ef4b00b6[arg1][arg2]
}
...
function sub_917646bf(?) payable {
    ...
    while idx < sub_d349e3ef.length:
        ...
        if sub_5e5e036d[stor3[idx]][address(arg1)] < arg2:
            s = 0
            while s < uint256(sub_1017e256[stor3[idx]][address(arg1)].field_0):
                if uint256(sub_1017e256[stor3[idx]][address(arg1)][s].field_0) and arg2 > -1 / uint256(sub_1017e256[stor3[idx]][address(arg1)][s].field_0):
                    revert with 'NH{q', 17
                if not sub_5e5e036d[stor3[idx]][address(arg1)]:
                    revert with 'NH{q', 18
                if s >= uint256(sub_1017e256[stor3[idx]][address(arg1)].field_0):
                    revert with 'NH{q', 50
                if uint256(sub_1017e256[stor3[idx]][address(arg1)][s].field_0) * arg2 / sub_5e5e036d[stor3[idx]][address(arg1)] < uint256(sub_1017e256[stor3[idx]][address(arg1)][s].field_0):
                    revert with 'NH{q', 17
                mem[32] = 6
                if s >= sub_ef4b00b6[stor3[idx]]:
                    revert with 'NH{q', 50
                if sub_ef4b00b6[stor3[idx]][s] > -(uint256(sub_1017e256[stor3[idx]][address(arg1)][s].field_0) * arg2 / sub_5e5e036d[stor3[idx]][address(arg1)]) + uint256(sub_1017e256[stor3[idx]][address(arg1)][s].field_0) - 1:
                    revert with 'NH{q', 17
                sub_ef4b00b6[stor3[idx]][s] = sub_ef4b00b6[stor3[idx]][s] + (uint256(sub_1017e256[stor3[idx]][address(arg1)][s].field_0) * arg2 / sub_5e5e036d[stor3[idx]][address(arg1)]) - uint256(sub_1017e256[stor3[idx]][address(arg1)][s].field_0)
                if s >= uint256(sub_1017e256[stor3[idx]][address(arg1)].field_0):
                    revert with 'NH{q', 50
                mem[0] = sha3(address(arg1), sha3(sub_d349e3ef[idx], 8))
                uint256(sub_1017e256[stor3[idx]][address(arg1)][s].field_0) = uint256(sub_1017e256[stor3[idx]][address(arg1)][s].field_0) * arg2 / sub_5e5e036d[stor3[idx]][address(arg1)]
                if s == -1:
                    revert with 'NH{q', 17
                s = s + 1
                continue 
            mem[0] = address(arg1)
            mem[32] = sha3(sub_d349e3ef[idx], 7)
            sub_5e5e036d[stor3[idx]][address(arg1)] = arg2
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_ce3ffb20(?) payable {
    ...
    if not stor9[cd[36]][address(msg.sender)]:
        ...
        while idx < sub_d349e3ef.length:
            ...
            continue 
        if not s:
            revert with 0, 'not an active vote'
        if ('cd', 4).length != uint256(stor5[cd[36]].field_0):
            revert with 0, 'number of votes doesn't match number of variants'
        idx = 0
        s = 0
        while idx < ('cd', 4).length:
            if idx >= ('cd', 4).length:
        ...
        sub_5e5e036d[cd[36]][address(msg.sender)] = s * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length
    else:
        mem[floor32(('cd', 4).length) + 97] = uint256(sub_1017e256[cd[36]][address(msg.sender)].field_0)
        if not uint256(sub_1017e256[cd[36]][address(msg.sender)].field_0):
            idx = 0
            while idx < uint256(sub_1017e256[cd[36]][address(msg.sender)].field_0):
                if idx >= uint256(sub_1017e256[cd[36]][address(msg.sender)].field_0):
                    revert with 'NH{q', 50
                mem[32] = 6
                if idx >= sub_ef4b00b6[cd[36]]:
                    revert with 'NH{q', 50
                mem[0] = sha3(cd[36], 6)
                if sub_ef4b00b6[cd[36]][idx] < mem[(32 * idx) + floor32(('cd', 4).length) + 129]:
                    revert with 'NH{q', 17
                sub_ef4b00b6[cd[36]][idx] -= mem[(32 * idx) + floor32(('cd', 4).length) + 129]
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
                continue 
            ...
            while idx < ('cd', 4).length:
                ...
                s = s + mem[(32 * idx) + 128]
                continue 
            mem[floor32(('cd', 4).length) + (32 * uint256(sub_1017e256[cd[36]][address(msg.sender)].field_0)) + 133] = msg.sender
            require ext_code.size(balanceKeeperAddress)
            call balanceKeeperAddress.userBalance(address rg1) with:
                 gas gas_remaining wei
                args msg.sender
            mem[floor32(('cd', 4).length) + (32 * uint256(sub_1017e256[cd[36]][address(msg.sender)].field_0)) + 129] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_call.return_data[0] == ext_call.return_data[0]
            ...
            mem[floor32(('cd', 4).length) + 129] = uint256(sub_1017e256[cd[36]][address(msg.sender)].field_0)
            idx = floor32(('cd', 4).length) + 129
            s = 0
            while floor32(('cd', 4).length) + (32 * uint256(sub_1017e256[cd[36]][address(msg.sender)].field_0)) + 97 > idx:
                mem[idx + 32] = uint256(sub_1017e256[cd[36]][address(msg.sender)][s].field_256)
                idx = idx + 32
                s = s + 1
                continue 
            idx = 0
            ...
            if ext_call.return_data[0] < s * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length:
                revert with 0, 'balance is smaller than the sum of votes'
            sub_5e5e036d[cd[36]][address(msg.sender)] = s * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length
    uint256(sub_1017e256[cd[36]][address(msg.sender)].field_0) = ('cd', 4).length
    if not ('cd', 4).length:
        idx = 0
        while uint256(sub_1017e256[cd[36]][address(msg.sender)].field_0) > idx:
            uint256(sub_1017e256[cd[36]][address(msg.sender)][idx].field_0) = 0
            idx = idx + 1
            continue 
    else:
        s = 0
        ...
        while (32 * ('cd', 4).length) + 128 > idx:
            uint256(sub_1017e256[cd[36]][address(msg.sender)][s].field_0) = mem[idx]
            s = s + 1
            idx = idx + 32
            continue 
    ...
    while idx < ('cd', 4).length:
        ...
        if idx >= sub_ef4b00b6[cd[36]]:
            revert with 'NH{q', 50
        mem[0] = sha3(cd[36], 6)
        if sub_ef4b00b6[cd[36]][idx] > -mem[(32 * idx) + 128] - 1:
            revert with 'NH{q', 17
        sub_ef4b00b6[cd[36]][idx] += mem[(32 * idx) + 128]
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_615d58db(?) payable {
    ...
    if bool(stor4[stor2].field_0):
        ...
        if mem[96]:
            ...
            mem[0] = sha3(voteCount, 5)
            if not mem[ceil32(ceil32(('cd', 4).length)) + 97]:
                idx = 0
                while sha3(sha3(voteCount, 5)) + uint256(stor5[stor2].field_0) > idx + sha3(mem[0]):
                ...
                if not _1416:
                    ...
                    mem[32] = 6
                    _1444 = mem[_1434]
                    sub_ef4b00b6[stor2] = mem[_1434]
                    mem[0] = sha3(voteCount, 6)
                    if not _1444:
                        idx = 0
                        while sub_ef4b00b6[stor2] > idx:
                            sub_ef4b00b6[stor2][idx] = 0
                            idx = idx + 1
                            continue 
                    else:
                        s = 0
                ...
                while ceil32(ceil32(('cd', 4).length)) + (32 * mem[ceil32(ceil32(('cd', 4).length)) + 97]) + 129 > idx:
                    ...
                    continue 
                idx = s
                while sha3(sha3(voteCount, 5)) + uint256(stor5[stor2].field_0) > idx:
                ...
                if not _1432:
                    ...
                    if not _1482:
                        ...
                        while sub_ef4b00b6[stor2] > idx:
                            ...
                            continue 
    sub_d349e3ef.length++
    sub_d349e3ef[sub_d349e3ef.length] = voteCount
    if voteCount == -1:
        revert with 'NH{q', 17
    voteCount++
}
