...
function sub_2324c4f1(?) payable {
    ...
    call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], arg3, Array(len=3, data=mem[(6 * ceil32(return_data.size)) + 420 len 96]), msg.sender, block.timestamp + 10
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    _63 = mem[(6 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28]
    ...
    _64 = mem[(6 * ceil32(return_data.size)) + mem[(6 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 224]
    ...
    mem[(7 * ceil32(return_data.size)) + 256 len 32 * _64] = mem[(6 * ceil32(return_data.size)) + _63 + 256 len 32 * _64]
    if 2 >= _64:
        revert with 0, 50
    _87 = mem[(7 * ceil32(return_data.size)) + 320]
    ...
    emit 0xc9f8219e: ext_call.return_data[0], _87, msg.sender, address(arg2)
    return _87
}
