...
array of uint8 stor-15;
array of uint256 stor-16;
...
function getTokenData(uint256 arg1) payable {
    ...
    if arg1 - 1 >= 20:
        revert with 'NH{q', 50
    mem[24672] = stor-15[arg1]
    idx = 24672
    s = 0
    while 49248 > idx + 32:
        mem[idx + 32] = stor-15[-(0.03125 / s + 1) + s + (-1 * 0.03125 / s + 1 * s) + 1]
        idx = idx + 32
        s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
        continue 
    mem[49248] = stor-16[arg1]
    idx = 0
    s = 24672
    t = 49280
    while idx < 768:
        ...
        t = t + 32
        continue 
    return stor-16[arg1], mem[49280 len 24576]
}
...
function sub_e4fda8ef(?) payable {
    ...
    if var86002 < 48:
        ...
        while arg1 - 1 < 20:
            ...
            if s >= 48:
                revert with 'NH{q', 50
            mem[(32 * s) + 1632] = stor((0.03125 / (3 * 16 * uint16(arg2)) + s) + (25 * arg1) - 15)[uint8((3 * 16 * uint16(arg2)) + s)]
            if s == -1:
                revert with 'NH{q', 17
            if arg1 < 1:
                revert with 'NH{q', 17
            ...
            while idx < 48:
                ...
                t = t + 32
                continue 
            return stor-16[arg1], mem[3200 len 1536]
        revert with 'NH{q', 50
    if arg1 - 1 >= 20:
        revert with 'NH{q', 50
    mem[3168] = stor-16[arg1]
...
function mintPublic() payable {
    if stor8[address(msg.sender)] >= MAX_PER_ADDRESS:
    ...
    if ownerOf[stor510 + 1]:
        revert with 0, 'ERC721: token already minted'
    if balanceOf[address(msg.sender)] > -2:
        revert with 'NH{q', 17
    balanceOf[address(msg.sender)]++
    ownerOf[stor510 + 1] = msg.sender
    ...
    if ext_code.size(msg.sender) <= 0:
        ...
        if totalMinted >= 20:
            revert with 'NH{q', 50
        stor9[stor510] = 'PixelPerfect0-16x16'
        mem[2752] = uint8(block.hash(block.number) % 255)
        mem[2784] = uint8(block.difficulty % 255)
        mem[2816] = uint8(address(block.coinbase) % 255)
        idx = 0
        while idx < 82:
            s = 0
            while s < 3:
                ...
                if mem[(32 * idx) + 158 len 2] + s >= 768:
                    revert with 'NH{q', 50
                stor[(0.03125 / mem[(32 * idx) + 158 len 2] + s) + (25 * stor510) + 10] = mem[(32 * s) + 2783 len 1] * 256^(mem[(32 * idx) + 158 len 2] + s % 32) or !(255 * 256^(mem[(32 * idx) + 158 len 2] + s % 32)) and stor[(0.03125 / mem[(32 * idx) + 158 len 2] + s) + (25 * stor510) + 10]
                if s == -1:
                    revert with 'NH{q', 17
                s = s + 1
                continue 
        ...
        if totalMinted >= 20:
            revert with 'NH{q', 50
        stor9[stor510] = 'PixelPerfect0-16x16'
        mem[ceil32(return_data.size) + 2752] = uint8(block.hash(block.number) % 255)
        mem[ceil32(return_data.size) + 2784] = uint8(block.difficulty % 255)
        mem[ceil32(return_data.size) + 2816] = uint8(address(block.coinbase) % 255)
        idx = 0
        while idx < 82:
            s = 0
            while s < 3:
                ...
                if mem[(32 * idx) + ceil32(return_data.size) + 158 len 2] + s >= 768:
                    revert with 'NH{q', 50
                stor[(0.03125 / mem[(32 * idx) + ceil32(return_data.size) + 158 len 2] + s) + (25 * stor510) + 10] = mem[(32 * s) + ceil32(return_data.size) + 2783 len 1] * 256^(mem[(32 * idx) + ceil32(return_data.size) + 158 len 2] + s % 32) or !(255 * 256^(mem[(32 * idx) + ceil32(return_data.size) + 158 len 2] + s % 32)) and stor[(0.03125 / mem[(32 * idx) + ceil32(return_data.size) + 158 len 2] + s) + (25 * stor510) + 10]
                if s == -1:
                    revert with 'NH{q', 17
                s = s + 1
                continue 
