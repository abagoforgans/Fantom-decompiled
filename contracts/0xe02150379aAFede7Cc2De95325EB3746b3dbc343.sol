...
const sub_44157b6d(?) = 20000 * 10^18

const sub_5868c32a(?) = 469000

const sub_a85e7f6c(?) = 5000 * 10^18
...
address stor8;
uint256 salePrice;
uint256 sub_2f4189c3;
uint256 sub_d3ebb9de;
uint256 startBlock;
uint256 endBlock;
mapping of uint256 sub_a9b0714a;
...
function sub_a9b0714a(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    return sub_a9b0714a[arg1]
}
...
function setStartBlock(uint256 arg1) payable {
    ...
    if arg1 > -469001:
        revert with 0, 17
    endBlock = arg1 + 469000
    emit StartBlockChanged(arg1, arg1 + 469000);
}
...
function sub_8dba3c30(?) payable {
    ...
    if sub_2f4189c3 <= 0:
        revert with 0, 'No more preMnstr remains!'
    ...
    if ext_call.return_data[0] <= 0:
        revert with 0, 'No more preMnstr left!'
    if arg1 <= 0:
        revert with 0, 'not enough usdc provided'
    if arg1 > sub_d3ebb9de:
        revert with 0, 'preMnstr Presale hardcap reached'
    if 5000 * 10^18 <= sub_a9b0714a[msg.sender]:
        revert with 0, 'user has already purchased too much premnstr'
    if arg1 > 0x119799812dea11197f27f0f6e885c8ba7eb31f476caf7411a863387:
        revert with 0, 17
    if not salePrice:
        revert with 0, 18
    if sub_2f4189c3 >= 10^12 * arg1 / salePrice:
        if 10^12 * arg1 / salePrice <= 0:
            revert with 0, 'user cannot purchase 0 premnstr'
        if 10^12 * arg1 / salePrice > sub_2f4189c3:
            revert with 0, 1
        ...
        if not return_data.size:
            ...
            mem[(2 * ceil32(return_data.size)) + 328] = 0x74b1f3aa435a577ddd4e3b44e6861c6be10a8b51
            ...
            if not ext_code.size(USDCAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 456 len 128] = 0, msg.sender, 0x74b1f3aa435a577ddd4e3b44e6861c6be10a8b51, arg1, 0
            mem[(2 * ceil32(return_data.size)) + 556] = 0
            call USDCAddress with:
               funct Mask(32, 224, 0, msg.sender, 0x74b1f3aa435a577ddd4e3b44e6861c6be10a8b51, arg1, 0) >> 224
                 gas gas_remaining wei
                args (Mask(768, -544, 0, msg.sender, 0x74b1f3aa435a577ddd4e3b44e6861c6be10a8b51, arg1, 0) << 544)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
            ...
            if sub_2f4189c3 < 10^12 * arg1 / salePrice:
                revert with 0, 17
            sub_2f4189c3 -= 10^12 * arg1 / salePrice
            if sub_a9b0714a[msg.sender] > !(10^12 * arg1 / salePrice):
                revert with 0, 17
            sub_a9b0714a[msg.sender] += 10^12 * arg1 / salePrice
            emit 0x7cf304e0: msg.sender, arg1, 10^12 * arg1 / salePrice
        else:
            ...
            mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = 0x74b1f3aa435a577ddd4e3b44e6861c6be10a8b51
            ...
            if not ext_code.size(USDCAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 457 len 128] = 0, msg.sender, 0x74b1f3aa435a577ddd4e3b44e6861c6be10a8b51, arg1, 0
            ...
            if not return_data.size:
                ...
                emit 0x7cf304e0: mem[(4 * ceil32(return_data.size)) + 458 len (6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 96]
    else:
        if sub_2f4189c3 <= 0:
            revert with 0, 'user cannot purchase 0 premnstr'
        if sub_2f4189c3 > sub_2f4189c3:
            revert with 0, 1
        mem[ceil32(return_data.size) + 100] = this.address
        require ext_code.size(stor8)
        staticcall stor8.0x70a08231 with:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if sub_2f4189c3 > ext_call.return_data[0]:
            revert with 0, 1
        mem[(2 * ceil32(return_data.size)) + 132] = msg.sender
        mem[(2 * ceil32(return_data.size)) + 164] = sub_2f4189c3
        mem[(2 * ceil32(return_data.size)) + 96] = 68
        mem[(2 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
        mem[(2 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
        mem[(2 * ceil32(return_data.size)) + 196] = 32
        ...
        if not ext_code.size(stor8):
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, sub_2f4189c3, 0
        mem[(2 * ceil32(return_data.size)) + 328] = 0
        call stor8 with:
           funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, sub_2f4189c3, 0) >> 224
             gas gas_remaining wei
            args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, sub_2f4189c3, 0) << 288)
        if not return_data.size:
            if not ext_call.success:
                if ext_call.return_data[0]:
                    revert with memory
            ...
            if sub_2f4189c3 < sub_2f4189c3:
                revert with 0, 17
            sub_2f4189c3 = 0
            if sub_a9b0714a[msg.sender] > !sub_2f4189c3:
                revert with 0, 17
            sub_a9b0714a[msg.sender] += sub_2f4189c3
            emit 0x7cf304e0: msg.sender, arg1, sub_2f4189c3
        else:
            mem[(2 * ceil32(return_data.size)) + 260] = return_data.size
            mem[(2 * ceil32(return_data.size)) + 292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
            ...
            if not return_data.size:
                ...
                mem[(4 * ceil32(return_data.size)) + 458] = msg.sender
                mem[(4 * ceil32(return_data.size)) + 490] = arg1
                mem[(4 * ceil32(return_data.size)) + 522] = sub_2f4189c3
                emit 0x7cf304e0: mem[(4 * ceil32(return_data.size)) + 458 len (6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 96]
    stor5 = 1
}
