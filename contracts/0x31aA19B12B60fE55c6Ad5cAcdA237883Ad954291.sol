        ...
        if not stor4[arg1].field_1024:
            ...
            if stor4[arg1].field_1280:
                ...
                return 32, address(stor4[arg1].field_0), 
                       ...
                       320,
                       (32 * stor4[arg1].field_768) + 352,
                       (32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + 384,
                       stor4[arg1].field_1536,
                       stor4[arg1].field_1792,
                       stor4[arg1].field_2048,
                       bool(uint8(stor4[arg1].field_2304)),
                       stor4[arg1].field_768,
                       mem[(32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1024) + (32 * stor4[arg1].field_1280) + 1216 len (32 * stor4[arg1].field_768) + (32 * stor4[arg1].field_1280) + (32 * stor4[arg1].field_1024) + 64]
    ...
    if not ext_call.return_data[0]:
        ...
        while idx < stor4[cd[4]].field_768:
            ...
            if idx >= stor4[cd[4]].field_1024:
                ...
                require return_data.size >= 32
                if mem[_609] < stor4[cd[4]][idx + 5].field_0:
                ...
                if stor4[cd[4]][idx + 4].field_0:
                    ...
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    if mem[_612] < stor4[cd[4]][idx + 5].field_0:
                        revert with 0, 'insufficient gem balance'
                    ...
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    if mem[_613] < stor4[cd[4]][idx + 5].field_0:
                        revert with 0, 'insufficient gem balance'
                    mem[mem[64] + 4] = _575
                    require ext_code.size(address(stor4[cd[4]][idx + 3].field_0))
                    staticcall address(stor4[cd[4]][idx + 3].field_0).tokenType(uint256 arg1) with:
        ...
        while idx < stor4[cd[4]].field_1280:
            ...
            t = t + 1
            continue 
        mem[_621 + 132] = (32 * _632) + (32 * stor4[cd[4]].field_1280) + 224
        mem[_621 + (32 * _632) + (32 * stor4[cd[4]].field_1280) + 228] = 0
        require ext_code.size(stor3)
        call stor3.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _621 + (32 * _632) + (32 * stor4[cd[4]].field_1280) + -mem[64] + 256]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not stor7.length:
            ...
            mem[mem[64] + 96] = 10^16
            emit 0x630aeb16: cd[4], msg.sender, 128, 10^16, mem[mem[64] + 128 len (32 * _1141) + 32]
        else:
            if stor6[cd[4]] >= stor7.length:
                revert with 0, 50
            if stor7[stor6[cd[4]]].field_0 != cd[4]:
                ...
                mem[mem[64] + 160 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                mem[mem[64] + 96] = 10^16
                emit 0x630aeb16: cd[4], msg.sender, 128, 10^16, mem[mem[64] + 128 len (32 * _1140) + 32]
            else:
                if stor7.length < 1:
                    revert with 0, 17
                if stor7.length - 1 == stor6[cd[4]]:
                    ...
                    mem[mem[64] + 160 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                    mem[mem[64] + 96] = 10^16
                    emit 0x630aeb16: cd[4], msg.sender, 128, 10^16, mem[mem[64] + 128 len (32 * _1138) + 32]
                else:
                    if stor7.length - 1 >= stor7.length:
                        revert with 0, 50
                    ...
                    mem[mem[64] + 160 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                    mem[mem[64] + 96] = 10^16
                    emit 0x630aeb16: cd[4], msg.sender, 128, 10^16, mem[mem[64] + 128 len (32 * _1139) + 32]
    else:
        ...
        while idx < stor4[cd[4]].field_768:
            ...
            if idx >= stor4[cd[4]].field_1024:
                ...
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 32
                if mem[_611] < stor4[cd[4]][idx + 5].field_0:
                    revert with 0, 'insufficient gem balance'
                mem[mem[64] + 4] = _573
                require ext_code.size(address(stor4[cd[4]][idx + 3].field_0))
                staticcall address(stor4[cd[4]][idx + 3].field_0).tokenType(uint256 arg1) with:
                ...
                if stor4[cd[4]][idx + 4].field_0:
                    ...
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    if mem[_614] < stor4[cd[4]][idx + 5].field_0:
                        revert with 0, 'insufficient gem balance'
                    mem[mem[64] + 4] = stor4[cd[4]][idx + 4].field_0
                    require ext_code.size(address(stor4[cd[4]][idx + 3].field_0))
                    staticcall address(stor4[cd[4]][idx + 3].field_0).tokenType(uint256 arg1) with:
                    ...
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    if mem[_615] < stor4[cd[4]][idx + 5].field_0:
                        revert with 0, 'insufficient gem balance'
                    mem[mem[64] + 4] = _578
                    require ext_code.size(address(stor4[cd[4]][idx + 3].field_0))
                    staticcall address(stor4[cd[4]][idx + 3].field_0).tokenType(uint256 arg1) with:
        ...
        while idx < stor4[cd[4]].field_1280:
            ...
            t = t + 1
            continue 
        mem[_625 + 132] = (32 * _637) + (32 * stor4[cd[4]].field_1280) + 224
        mem[_625 + (32 * _637) + (32 * stor4[cd[4]].field_1280) + 228] = 0
        require ext_code.size(stor3)
        call stor3.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _625 + (32 * _637) + (32 * stor4[cd[4]].field_1280) + -mem[64] + 256]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64] + 68] = stor4[cd[4]].field_512
        mem[mem[64] + 100] = 1
        ...
        if not stor7.length:
            ...
            emit 0x630aeb16: cd[4], msg.sender, 128, ext_call.return_data[0], mem[mem[64] + 128 len (32 * _1145) + 32]
        else:
            if stor6[cd[4]] >= stor7.length:
                revert with 0, 50
            if stor7[stor6[cd[4]]].field_0 != cd[4]:
                ...
                mem[mem[64] + 160 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                mem[mem[64] + 96] = ext_call.return_data[0]
                emit 0x630aeb16: cd[4], msg.sender, 128, ext_call.return_data[0], mem[mem[64] + 128 len (32 * _1144) + 32]
            else:
                if stor7.length < 1:
                    revert with 0, 17
                if stor7.length - 1 == stor6[cd[4]]:
                    ...
                    mem[mem[64] + 160 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                    mem[mem[64] + 96] = ext_call.return_data[0]
                    emit 0x630aeb16: cd[4], msg.sender, 128, ext_call.return_data[0], mem[mem[64] + 128 len (32 * _1142) + 32]
                else:
                    if stor7.length - 1 >= stor7.length:
                        revert with 0, 50
                    stor6[stor7[stor7.length].field_0] = stor6[cd[4]]
                    ...
                    mem[mem[64] + 160 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                    mem[mem[64] + 96] = ext_call.return_data[0]
                    emit 0x630aeb16: cd[4], msg.sender, 128, ext_call.return_data[0], mem[mem[64] + 128 len (32 * _1143) + 32]
    return 1
}
