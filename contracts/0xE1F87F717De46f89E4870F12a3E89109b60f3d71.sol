                                        ...
                                        if tokensPerEth * msg.value / 10^18 <= 0:
                                            ...
                                            if block.timestamp < deadline:
                                                if msg.value < 10^18:
                                                    ...
                                                    require not distributionFinished
                                                    require totalDistributed + (tokensPerEth * msg.value / 10^18) + (50 * tokensPerEth * msg.value / 10^18 / 5) >= totalDistributed
                                                    totalDistributed = totalDistributed + (tokensPerEth * msg.value / 10^18) + (50 * tokensPerEth * msg.value / 10^18 / 5)
                                                    require balanceOf[address(msg.sender)] + (tokensPerEth * msg.value / 10^18) + (50 * tokensPerEth * msg.value / 10^18 / 5) >= balanceOf[address(msg.sender)]
                                                    balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + (tokensPerEth * msg.value / 10^18) + (50 * tokensPerEth * msg.value / 10^18 / 5)
                                                    emit Distr(((tokensPerEth * msg.value / 10^18) + (50 * tokensPerEth * msg.value / 10^18 / 5)), msg.sender);
                                                    emit Transfer(((tokensPerEth * msg.value / 10^18) + (50 * tokensPerEth * msg.value / 10^18 / 5)), 0, msg.sender);
                                                    if totalDistributed < totalSupply:
                                                    else:
                                                        distributionFinished = 1
                                            else:
