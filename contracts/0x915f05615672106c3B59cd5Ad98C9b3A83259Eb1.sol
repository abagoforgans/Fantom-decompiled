...
function sub_d12a2e31(?) payable {
    ...
    if arg1 < arg2:
        ...
        if arg1 < arg2:
            if not arg1:
                revert with 0, 'UniswapV2Library: ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, factoryAddress, sha3(arg1, arg2), 0x2babb5aeb28267a3d05149540ccbaaf91e6cb454721441d7f7f425c0352b13d0)))
            staticcall address(sha3(0, factoryAddress, sha3(arg1, arg2), 0x2babb5aeb28267a3d05149540ccbaaf91e6cb454721441d7f7f425c0352b13d0)).getReserves() with:
                    gas gas_remaining wei
        else:
            if not arg2:
                revert with 0, 'UniswapV2Library: ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, factoryAddress, sha3(arg2, arg1), 0x2babb5aeb28267a3d05149540ccbaaf91e6cb454721441d7f7f425c0352b13d0)))
            staticcall address(sha3(0, factoryAddress, sha3(arg2, arg1), 0x2babb5aeb28267a3d05149540ccbaaf91e6cb454721441d7f7f425c0352b13d0)).getReserves() with:
                    gas gas_remaining wei
