...
function setStartBlock(uint256 arg1) payable {
    ...
    if arg1 > -263001:
        revert with 0, 17
    endBlock = arg1 + 263000
    emit StartBlockChanged(arg1, arg1 + 263000);
}
...
function sub_74324acd(?) payable {
    ...
    if sub_f34b1c85 >= 10^12 * arg1 / salePrice:
        ...
        if not return_data.size:
            ...
            if sub_3e428831[msg.sender] > !(10^12 * arg1 / salePrice):
                revert with 0, 17
            sub_3e428831[msg.sender] += 10^12 * arg1 / salePrice
