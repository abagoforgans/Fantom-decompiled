                        ...
                        if 0 <= ext_call.return_data[0]:
                            if wantLockedTotal >= 0:
                                ...
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
                                    args Mask(480, -256, transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0) << 256, mem[580 len 4]
                            else:
                                if wantLockedTotal > wantLockedTotal:
                                    revert with 0, 'SafeMath: subtraction overflow'
                                wantLockedTotal = 0
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 0, stor14.field_32)
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
                    ...
                    if not uint8(stor2.field_24):
                        ...
                        if arg2 * withdrawFeeFactor / 10000 <= ext_call.return_data[0]:
                            if wantLockedTotal >= arg2 * withdrawFeeFactor / 10000:
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg2 * withdrawFeeFactor / 10000) >> 32
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
