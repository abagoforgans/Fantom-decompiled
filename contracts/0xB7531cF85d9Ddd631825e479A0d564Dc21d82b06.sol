        ...
        if not burnActive:
            ...
            if not arg2:
                ...
                if 80 * arg2 / 800 <= 80:
                    if not arg1:
                        revert with 0, 32, 35, 0x6542455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[327 len 29]
                    if arg2 - (80 * arg2 / 800) > balanceOf[address(msg.sender)]:
                        revert with 0, 
                                    32,
                                    38,
                                    0x6542455032303a207472616e7366657220616d6f756e7420657863656564732062616c616e63,
                    ...
                    if 80 * arg2 / 800 > balanceOf[address(msg.sender)]:
                        revert with 0, 
                                    32,
                                    38,
                                    0x6542455032303a207472616e7366657220616d6f756e7420657863656564732062616c616e63,
                                    mem[294 len 26],
                                    mem[346 len 6]
                    balanceOf[address(msg.sender)] -= 80 * arg2 / 800
                    if balanceOf[0x6df85015509738f7454d5cd9f12362354536807] + (80 * arg2 / 800) < balanceOf[0x6df85015509738f7454d5cd9f12362354536807]:
                        revert with 0, 'SafeMath: addition overflow'
                    balanceOf[0x6df85015509738f7454d5cd9f12362354536807] += 80 * arg2 / 800
                    emit Transfer((80 * arg2 / 800), msg.sender, 0x6df85015509738f7454d5cd9f12362354536807);
                    if not msg.sender:
                    ...
                    if arg2 - (80 * arg2 / 800) > balanceOf[address(msg.sender)]:
                        revert with 0, 
                                    ...
                                    mem[390 len 26],
                                    mem[442 len 6]
                ('le', ('add', ('param', 'arg2'), ('mul', -1, ('div', ('mul', 80, ('param', 'arg2')), 800))), ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'balanceOf', 1))))
                balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] - arg2 + (80 * arg2 / 800)
                if balanceOf[address(arg1)] + arg2 - (80 * arg2 / 800) < balanceOf[address(arg1)]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 - (80 * arg2 / 800)
                emit Transfer((arg2 - (80 * arg2 / 800)), msg.sender, arg1);
    return 1
}
        ...
        if not burnActive:
            ...
            if not arg3:
                ...
                if 80 * arg3 / 800 <= 80:
                    if not arg2:
                        revert with 0, 32, 35, 0x6542455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[327 len 29]
                    if arg3 - (80 * arg3 / 800) > balanceOf[address(arg1)]:
                        revert with 0, 
                                    32,
                                    38,
                                    0x6542455032303a207472616e7366657220616d6f756e7420657863656564732062616c616e63,
                                    mem[294 len 26],
                                    mem[346 len 6]
                    balanceOf[address(arg1)] = balanceOf[address(arg1)] - arg3 + (80 * arg3 / 800)
                    if balanceOf[address(arg2)] + arg3 - (80 * arg3 / 800) < balanceOf[address(arg2)]:
                        revert with 0, 'SafeMath: addition overflow'
                    balanceOf[address(arg2)] = balanceOf[address(arg2)] + arg3 - (80 * arg3 / 800)
                    emit Transfer((arg3 - (80 * arg3 / 800)), arg1, arg2);
                    if arg3 > allowance[address(arg1)][address(msg.sender)]:
                        revert with 0, 
                                    32,
                                    40,
                    ...
                    if 80 * arg3 / 800 > balanceOf[address(arg1)]:
                        revert with 0, 
                                    32,
                                    38,
                                    0x6542455032303a207472616e7366657220616d6f756e7420657863656564732062616c616e63,
                                    mem[294 len 26],
                                    mem[346 len 6]
                    balanceOf[address(arg1)] -= 80 * arg3 / 800
                    if balanceOf[0x6df85015509738f7454d5cd9f12362354536807] + (80 * arg3 / 800) < balanceOf[0x6df85015509738f7454d5cd9f12362354536807]:
                        revert with 0, 'SafeMath: addition overflow'
                    balanceOf[0x6df85015509738f7454d5cd9f12362354536807] += 80 * arg3 / 800
                    emit Transfer((80 * arg3 / 800), arg1, 0x6df85015509738f7454d5cd9f12362354536807);
                    if not arg1:
                        revert with 0, 32, 37, 0xfe42455032303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[425 len 27]
                    if not arg2:
                        revert with 0, 32, 35, 0x6542455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[423 len 29]
