...
function sub_76759843(?) payable {
    return bool(sub_76759843)
}
...
function setIsTipCEO(bool arg1) payable {
    require calldata.size - 4 >= 32
    require msg.sender == sub_f2ba25fcAddress
    sub_76759843 = uint8(arg1)
}
    ...
    if not arg2:
        ...
        if not arg2:
            ...
            while idx < sub_0e9d1b6f[msg.sender].field_0:
                ...
                require return_data.size >= 32
                if sub_76759843:
                    if sub_590e4957[address(arg1)] / ext_call.return_data[0] * arg2 / 10^9 > 100:
                        if not sub_590e4957[address(arg1)] / ext_call.return_data[0] * arg2 / 10^9:
                            require ext_code.size(sub_aa9c635eAddress)
                            call sub_aa9c635eAddress.0xa9059cbb with:
                                 gas gas_remaining wei
                                args sub_f2ba25fcAddress, 0
                        else:
                            if sub_590e4957[address(arg1)] / ext_call.return_data[0] * arg2 / 10^9 / sub_590e4957[address(arg1)] / ext_call.return_data[0] * arg2 / 10^9 != 1:
                                revert with 0, 'ow'
                            require ext_code.size(sub_aa9c635eAddress)
                            call sub_aa9c635eAddress.0xa9059cbb with:
                                 gas gas_remaining wei
                                args sub_f2ba25fcAddress, sub_590e4957[address(arg1)] / ext_call.return_data[0] * arg2 / 10^9 / 100
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
        ...
        if not arg2 - (arg3 * arg2 / 100):
            ...
            while idx < sub_0e9d1b6f[msg.sender].field_0:
                ...
                require return_data.size >= 32
                if sub_76759843:
                    if (arg2 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) - (arg3 * arg2 / 100 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) / 10^9 > 100:
                        if not (arg2 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) - (arg3 * arg2 / 100 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) / 10^9:
                            require ext_code.size(sub_aa9c635eAddress)
                            call sub_aa9c635eAddress.0xa9059cbb with:
                                 gas gas_remaining wei
                                args sub_f2ba25fcAddress, 0
                        else:
                            if (arg2 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) - (arg3 * arg2 / 100 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) / 10^9 / (arg2 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) - (arg3 * arg2 / 100 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) / 10^9 != 1:
                                revert with 0, 'ow'
                            require ext_code.size(sub_aa9c635eAddress)
                            call sub_aa9c635eAddress.0xa9059cbb with:
                                 gas gas_remaining wei
                                args sub_f2ba25fcAddress, (arg2 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) - (arg3 * arg2 / 100 * sub_590e4957[address(arg1)] / ext_call.return_data[0]) / 10^9 / 100
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
