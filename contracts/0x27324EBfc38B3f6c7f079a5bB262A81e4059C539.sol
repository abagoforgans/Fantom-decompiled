...
function sub_80fc56f6(?) payable {
    ...
    if arg3 >= ext_call.return_data[0]:
        mem[292 len 64] = transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, Mask(224, 32, arg3) >> 32
        call arg1 with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if not ext_code.size(arg1):
                revert with 0, 'Address: call to non-contract'
            mem[488 len 64] = approve(address arg1, uint256 arg2), address(arg2) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call arg1 with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_code.size(arg1):
                    revert with 0, 'Address: call to non-contract'
                mem[684 len 64] = transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, Mask(224, 32, arg3) >> 32
                call arg1 with:
                     gas gas_remaining wei
                    args Mask(224, 32, arg3) << 224, mem[748 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address arg1, uint256 arg2), address(arg2) << 64, 0, 0
                    if not approve(address arg1, uint256 arg2), address(arg2) << 64:
                ...
                if not ext_code.size(arg1):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 685 len 64] = transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, Mask(224, 32, arg3) >> 32
                call arg1 with:
                     gas gas_remaining wei
            ...
            if not ext_code.size(arg1):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 489 len 64] = approve(address arg1, uint256 arg2), address(arg2) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            mem[ceil32(return_data.size) + 553 len 0] = 0
            call arg1 with:
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), address(arg2) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 553 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address arg1, uint256 arg2), address(arg2) << 64, 0, 0
                if not approve(address arg1, uint256 arg2), address(arg2) << 64:
                ...
                if not ext_call.success:
                    ...
                    revert with 0, 
                                ...
                                Mask(80, 0, approve(address arg1, uint256 arg2), address(arg2) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff)
                if return_data.size:
                    require return_data.size >= 32
                ...
                if not return_data.size:
                    ...
                    if not ext_call.success:
                        ...
                        revert with 0, 
                                    ...
                                    0x725361666545524332303a206c6f772d6c6576656c2063616c6c206661696c656420696e206d61737465,
                                    mem[ceil32(return_data.size) + 467 len 22],
                                    0, address(unirouterAddress), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff << 176,
