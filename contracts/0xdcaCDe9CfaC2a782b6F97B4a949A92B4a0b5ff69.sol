...
function acceptOffer(address arg1, uint256 arg2, address arg3) {
    ...
    if stor1 == 2:
        revert with 0, 32, 31, 0xfe5265656e7472616e637947756172643a207265656e7472616e742063616c6c
    stor1 = 2
    if not offers[address(arg1)][arg2][address(arg3)].field_256:
        revert with 0, 'offer not exists or expired'
    if offers[address(arg1)][arg2][address(arg3)].field_768 <= block.timestamp:
        revert with 0, 'offer not exists or expired'
    require ext_code.size(arg1)
    staticcall arg1.supportsInterface(bytes4 arg1) with:
            gas gas_remaining wei
    ...
    if not offers[address(arg1)][arg2][address(arg3)].field_512:
        ...
        mem[804 len 96] = unknown_0x23b872dd(?????), address(arg3) << 64, 0, msg.sender, 0
        mem[928 len 4] = 0
        call offers[address(arg1)][arg2][address(arg3)].field_0 with:
           funct uint32(msg.sender)
             gas gas_remaining wei
            args 0, mem[900 len 4]
    else:
        if offers[address(arg1)][arg2][address(arg3)].field_256 * offers[address(arg1)][arg2][address(arg3)].field_512 / offers[address(arg1)][arg2][address(arg3)].field_512 != offers[address(arg1)][arg2][address(arg3)].field_256:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[709 len 31]
        if eth.balance(this.address) < 0:
            revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[910 len 26]
        if not ext_code.size(offers[address(arg1)][arg2][address(arg3)].field_0):
            revert with 0, 'Address: call to non-contract'
        mem[804 len 96] = unknown_0x23b872dd(?????), address(arg3) << 64, 0, msg.sender, Mask(224, 32, offers[address(arg1)][arg2][address(arg3)].field_256 * offers[address(arg1)][arg2][address(arg3)].field_512) >> 32
        mem[928 len 4] = 0
        call offers[address(arg1)][arg2][address(arg3)].field_0 with:
           funct uint32(msg.sender)
             gas gas_remaining wei
            args Mask(224, 32, offers[address(arg1)][arg2][address(arg3)].field_256 * offers[address(arg1)][arg2][address(arg3)].field_512) << 480, mem[900 len 4]
    ...
    call address(ext_call.return_data[0]).validateItemSold(address arg1, uint256 arg2, uint256 arg3) with:
         gas gas_remaining wei
        args address(arg1), arg2, offers[address(arg1)][arg2][address(arg3)].field_256
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    sub_6bd3a64b[address(arg1)][arg2][address(msg.sender)].field_0 = 0
    sub_6bd3a64b[address(arg1)][arg2][address(msg.sender)].field_256 = 0
    ...
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
    if offers[address(arg1)][arg2][address(arg3)].field_0:
        staticcall address(ext_call.return_data[0]).0x41976e09 with:
                gas gas_remaining wei
               args offers[address(arg1)][arg2][address(arg3)].field_0
    else:
        staticcall address(ext_call.return_data[0]).wFTM() with:
                gas gas_remaining wei
        if not ext_call.success:
    ...
    require return_data.size >= 64
    if ext_call.return_data[63 len 1] < 18:
        emit ItemSold(arg2, offers[address(arg1)][arg2][address(arg3)].field_256, offers[address(arg1)][arg2][address(arg3)].field_0, ext_call.return_data[0] * 10^uint8(-ext_call.return_data[32] + 18), offers[address(arg1)][arg2][address(arg3)].field_512, msg.sender, arg3, arg1);
    else:
        require 10^uint8(ext_call.return_data[32] - 18)
        emit ItemSold(arg2, offers[address(arg1)][arg2][address(arg3)].field_256, offers[address(arg1)][arg2][address(arg3)].field_0, ext_call.return_data[0] / 10^uint8(ext_call.return_data[32] - 18), offers[address(arg1)][arg2][address(arg3)].field_512, msg.sender, arg3, arg1);
