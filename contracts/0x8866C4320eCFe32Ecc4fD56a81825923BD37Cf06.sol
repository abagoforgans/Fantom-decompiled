...
function sub_c64c39a9(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if operators[tx.origin] != 1:
...
function sub_adb574d4(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[32] = 2
        operators[mem[(32 * idx) + 140 len 20]] = 1
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
