    ...
    if address(arg1) == ext_call.return_data[12 len 20]:
        if address(arg1) == ext_call.return_data[12 len 20]:
            call address(arg2).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args Mask(112, 0, ext_call.return_data[0]) / 10, 0, address(this.address), 128, 64, arg1, Mask(112, 0, ext_call.return_data[0]) / 10
        else:
            call address(arg2).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args 0, Mask(112, 0, ext_call.return_data[0]) / 10, address(this.address), 128, 64, arg1, Mask(112, 0, ext_call.return_data[0]) / 10
    else:
        if address(arg1) == ext_call.return_data[12 len 20]:
            call address(arg2).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args Mask(112, 0, ext_call.return_data[32]) / 10, 0, address(this.address), 128, 64, arg1, Mask(112, 0, ext_call.return_data[32]) / 10
        else:
            call address(arg2).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args 0, Mask(112, 0, ext_call.return_data[32]) / 10, address(this.address), 128, 64, arg1, Mask(112, 0, ext_call.return_data[32]) / 10
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
