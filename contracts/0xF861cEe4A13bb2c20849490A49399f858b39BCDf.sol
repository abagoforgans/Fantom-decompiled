...
function byteCode(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    mem[7552 len 7328] = code.data[8312 len 7314], mem[7442 len 14]
    mem[14866] = arg1
    mem[14898] = 32
    mem[14930] = mem[7520]
    mem[14962 len ceil32(mem[7520])] = mem[7552 len ceil32(mem[7520])]
    if ceil32(mem[7520]) > mem[7520]:
        mem[mem[7520] + 14962] = 0
    return Array(len=mem[7520], data=mem[14962 len ceil32(mem[7520])])
}
...
function deploy(address arg1) payable {
    ...
    create2 contract with 0 wei
                    salt: sha3(arg1)
                    code: code.data[8312 len 7314], mem[7442 len 14] >> 58256, arg1
...
function workForFree(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(0x1ceb5cb57c4d4e2b2433641b95dd330a33185a44)
    call 0x1ceb5cb57c4d4e2b2433641b95dd330a33185a44.keepers(address rg1) with:
         gas gas_remaining wei
        args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function work(address arg1) payable {
    ...
    if not ext_call.return_data[0]:
        revert with 0, '!W'
    require ext_code.size(0x1ceb5cb57c4d4e2b2433641b95dd330a33185a44)
    staticcall 0x1ceb5cb57c4d4e2b2433641b95dd330a33185a44.KPRH() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    staticcall address(ext_call.return_data[0]).getQuoteLimit(uint256 rg1) with:
            gas gas_remaining wei
           args 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(0x1ceb5cb57c4d4e2b2433641b95dd330a33185a44)
    call 0x1ceb5cb57c4d4e2b2433641b95dd330a33185a44.receipt(address rg1, address rg2, uint256 rg3) with:
         gas gas_remaining wei
        args 0x1ceb5cb57c4d4e2b2433641b95dd330a33185a44, msg.sender, ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function current(address arg1, uint256 arg2, address arg3, bool arg4) payable {
    ...
    if arg4:
        ...
        if arg1 < arg3:
            require ext_code.size(feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg1'), ('param', 'arg3')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))])
            staticcall feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg1'), ('param', 'arg3')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))].current(address rg1, uint256 rg2, address rg3) with:
                    gas gas_remaining wei
                   args address(arg1), arg2, arg3
        else:
            require ext_code.size(feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg3'), ('param', 'arg1')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))])
            staticcall feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg3'), ('param', 'arg1')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))].current(address rg1, uint256 rg2, address rg3) with:
                    gas gas_remaining wei
                   args address(arg1), arg2, arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function quote(address arg1, uint256 arg2, address arg3, uint256 arg4, bool arg5) payable {
    ...
    if arg5:
        ...
        if arg1 < arg3:
            require ext_code.size(feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg1'), ('param', 'arg3')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))])
            staticcall feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg1'), ('param', 'arg3')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))].quote(address rg1, uint256 rg2, address rg3, uint256 rg4) with:
                    gas gas_remaining wei
                   args address(arg1), arg2, address(arg3), arg4
        else:
            require ext_code.size(feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg3'), ('param', 'arg1')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))])
            staticcall feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg3'), ('param', 'arg1')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))].quote(address rg1, uint256 rg2, address rg3, uint256 rg4) with:
                    gas gas_remaining wei
                   args address(arg1), arg2, address(arg3), arg4
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function work() payable {
    ...
    staticcall address(_61).getQuoteLimit(uint256 rg1) with:
            gas gas_remaining wei
           args 0
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    call 0x1ceb5cb57c4d4e2b2433641b95dd330a33185a44.receipt(address rg1, address rg2, uint256 rg3) with:
         gas gas_remaining wei
        args 0x1ceb5cb57c4d4e2b2433641b95dd330a33185a44, msg.sender, mem[_65]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function sample(address arg1, uint256 arg2, address arg3, uint256 arg4, uint256 arg5, bool arg6) payable {
    ...
    if arg1 < arg3:
        ...
        mem[168] = 85
        mem[0] = address(sha3(0, 6659063423423185226, sha3(arg1, arg3), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))
        mem[32] = 3
        mem[285] = 0xa79339800000000000000000000000000000000000000000000000000000000
        mem[289] = arg1
        mem[321] = arg2
        ...
        mem[417] = arg5
        require ext_code.size(feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg1'), ('param', 'arg3')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))])
        staticcall feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg1'), ('param', 'arg3')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))].sample(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5) with:
                gas gas_remaining wei
               args address(arg1), arg2, address(arg3), arg4, arg5
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    mem[253] = 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f
    mem[168] = 85
    mem[0] = address(sha3(0, 6659063423423185226, sha3(arg3, arg1), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))
    mem[32] = 3
    mem[285] = 0xa79339800000000000000000000000000000000000000000000000000000000
    mem[289] = arg1
    mem[321] = arg2
    ...
    mem[417] = arg5
    require ext_code.size(feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg3'), ('param', 'arg1')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))])
    staticcall feeds[address(sha3(0, 6659063423423185226, ('map', ('param', 'arg3'), ('param', 'arg1')), 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f))].sample(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5) with:
            gas gas_remaining wei
           args address(arg1), arg2, address(arg3), arg4, arg5
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
