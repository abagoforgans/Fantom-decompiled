...
function sub_3f4b28ab(?) {
    ...
    if not ('cd', 68).length:
        ...
        while idx < ('cd', 68).length - 1:
            ...
            if ext_call.return_data[0] >= _1084:
                ...
                mem[_1087 + (2 * ceil32(return_data.size)) + 164] = 1125899906842624
    ...
    while idx < ('cd', 68).length - 1:
        ...
        if ext_call.return_data[0] >= _1086:
            ...
            mem[_1088 + (2 * ceil32(return_data.size)) + 164] = 1125899906842624
...
function sub_964a9bc5(?) {
    ...
    if not ('cd', 68).length:
        ...
        while idx < ('cd', 68).length - 1:
            ...
            if ext_call.return_data[0] >= _1136:
                ...
                mem[_1139 + (2 * ceil32(return_data.size)) + 164] = 1125899906842624
    ...
    while idx < ('cd', 68).length - 1:
        ...
        if ext_call.return_data[0] >= _1138:
            ...
            mem[_1140 + (2 * ceil32(return_data.size)) + 164] = 1125899906842624
