    ...
    while idx < 10001:
        ...
        if not arg1 + idx:
            ...
            if not 0 / ext_call.return_data[0]:
                ...
                if totalSupply + (0 / ext_call.return_data[0]) > 0:
                    ...
                    if arg1 + idx < arg1:
                        revert with 0, 'SafeMath: addition overflow'
                    if arg1 + idx != (0 / totalSupply + (0 / ext_call.return_data[0])) + 1:
                        idx = idx + 1
                        continue 
                    if arg1 + idx < arg1:
                        revert with 0, 'SafeMath: addition overflow'
            ...
            if totalSupply + (0 / ext_call.return_data[0]) > 0:
                ...
                if arg1 + idx < arg1:
                    revert with 0, 'SafeMath: addition overflow'
                if arg1 + idx != ((ext_call.return_data[0] * 0 / ext_call.return_data[0]) + (arg1 * 0 / ext_call.return_data[0]) + (idx * 0 / ext_call.return_data[0]) / totalSupply + (0 / ext_call.return_data[0])) + 1:
                    idx = idx + 1
                    continue 
                if arg1 + idx < arg1:
                    revert with 0, 'SafeMath: addition overflow'
        ...
        if not (arg1 * totalSupply) + (idx * totalSupply) / ext_call.return_data[0]:
            ...
            if totalSupply + ((arg1 * totalSupply) + (idx * totalSupply) / ext_call.return_data[0]) > 0:
                ...
                if arg1 + idx < arg1:
                    revert with 0, 'SafeMath: addition overflow'
                if arg1 + idx != (0 / totalSupply + ((arg1 * totalSupply) + (idx * totalSupply) / ext_call.return_data[0])) + 1:
                    idx = idx + 1
                    continue 
                if arg1 + idx < arg1:
                    revert with 0, 'SafeMath: addition overflow'
        ...
        if totalSupply + ((arg1 * totalSupply) + (idx * totalSupply) / ext_call.return_data[0]) > 0:
            ...
            if arg1 + idx < arg1:
                revert with 0, 'SafeMath: addition overflow'
            if arg1 + idx != ((ext_call.return_data[0] * (arg1 * totalSupply) + (idx * totalSupply) / ext_call.return_data[0]) + (arg1 * (arg1 * totalSupply) + (idx * totalSupply) / ext_call.return_data[0]) + (idx * (arg1 * totalSupply) + (idx * totalSupply) / ext_call.return_data[0]) / totalSupply + ((arg1 * totalSupply) + (idx * totalSupply) / ext_call.return_data[0])) + 1:
                idx = idx + 1
                continue 
            if arg1 + idx < arg1:
                revert with 0, 'SafeMath: addition overflow'
