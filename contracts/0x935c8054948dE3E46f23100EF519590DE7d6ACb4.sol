...
#
const ownerNATIVEReward = 1000

const startTime = (453905 * 3600)

const NATIVEMaxSupply = 793792 * 10^18

const sub_af298ff9(?) = 2 * 10^16

const NATIVE = 0x6dd0bab4550245246f6c3ec971e0125019498d13
...
function getMultiplier(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0x6dd0bab4550245246f6c3ec971e0125019498d13)
    staticcall 0x6dd0bab4550245246f6c3ec971e0125019498d13.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] >= 793792 * 10^18:
        return 0
    if arg1 > arg2:
        revert with 0, 'SafeMath: subtraction overflow'
    return (arg2 - arg1)
...
function add(uint256 arg1, address arg2, address arg3) payable {
    ...
    if block.timestamp > 453905 * 3600:
        poolInfo[poolInfo.length].field_512 = block.timestamp
    else:
        poolInfo[poolInfo.length].field_512 = 453905 * 3600
...
function inCaseTokensGetStuck(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 == 0x6dd0bab4550245246f6c3ec971e0125019498d13:
        revert with 0, '!safe'
                ...
                if block.timestamp - poolInfo[arg1].field_512 > 0:
                    if not block.timestamp - poolInfo[arg1].field_512:
                        ...
                        if not 0 / totalAllocPoint:
                            require ext_code.size(0x6dd0bab4550245246f6c3ec971e0125019498d13)
                            call 0x6dd0bab4550245246f6c3ec971e0125019498d13.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 0
                        else:
                            ...
                            call 0x6dd0bab4550245246f6c3ec971e0125019498d13.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 1000 * 0 / totalAllocPoint / 10000
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(0x6dd0bab4550245246f6c3ec971e0125019498d13)
                        call 0x6dd0bab4550245246f6c3ec971e0125019498d13.0x40c10f19 with:
                        ...
                        if not (2 * 10^16 * block.timestamp) - (2 * 10^16 * poolInfo[arg1].field_512):
                            ...
                            if not (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint:
                                ...
                                if 1000 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint != 1000:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                                require ext_code.size(0x6dd0bab4550245246f6c3ec971e0125019498d13)
                                call 0x6dd0bab4550245246f6c3ec971e0125019498d13.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args owner, 1000 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / 10000
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(0x6dd0bab4550245246f6c3ec971e0125019498d13)
                            call 0x6dd0bab4550245246f6c3ec971e0125019498d13.0x40c10f19 with:
