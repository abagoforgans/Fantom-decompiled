...
function mint(address arg1, string arg2) payable {
    ...
    if not tokenOfOwnerByIndex[address(arg1)][1][stor11 + 1]:
        tokenOfOwnerByIndex[address(arg1)]++
    ...
    if stor3[stor11 + 1]:
        ...
        call arg1.0x80 with:
             gas gas_remaining wei
            args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenIdPointer + 1, 128, 0) << 1024, mem[644 len 4]
        if not return_data.size:
            require not ext_call.success
            revert with 0, 
                        32,
