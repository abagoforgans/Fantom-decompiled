...
function balanceOfPool() payable {
    ...
    staticcall masterChefAddress.userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args uint8(stor9.field_0), this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        call masterChefAddress.deposit(uint256 arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
            args uint8(stor9.field_0), ext_call.return_data[0], this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        call masterChefAddress.withdraw(uint256 arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
            args uint8(stor9.field_0), arg1 - ext_call.return_data[0], this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(lpPairAddress)
        staticcall lpPairAddress.0x70a08231 with:
...
function pause() payable {
    ...
    if ext_code.size(lpPairAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor9.field_0), uint32(stor9.field_0), 0
    call lpPairAddress with:
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor9.field_0), uint32(stor9.field_0), 0
        if not approve(address arg1, uint256 arg2), Mask(224, 0, stor9.field_0):
            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        if ext_code.size(sub_1dee25deAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = approve(address arg1, uint256 arg2), 0x16327e3fbdaca3bcf7e38f5a, 0, 0
        call sub_1dee25deAddress.0xdc33ae52 with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            call wftmAddress.0xdc33ae52 with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[916 len 64] = approve(address arg1, uint256 arg2), 0x16327e3fbdaca3bcf7e38f5a, 0, 0
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 917 len 64] = approve(address arg1, uint256 arg2), 0x16327e3fbdaca3bcf7e38f5a, 0, 0
                    call lpToken1Address.0xdc33ae52 with:
                         gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if ext_code.size(lpToken1Address) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 918 len 64] = approve(address arg1, uint256 arg2), 0x16327e3fbdaca3bcf7e38f5a, 0, 0
            call lpToken1Address.0xdc33ae52 with:
                 gas gas_remaining wei
        ...
        if ext_code.size(lpToken1Address) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 919 len 64] = approve(address arg1, uint256 arg2), 0x16327e3fbdaca3bcf7e38f5a, 0, 0
    ...
    if ext_code.size(lpToken1Address) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[(4 * ceil32(return_data.size)) + 920 len floor32((6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = approve(address arg1, uint256 arg2), 0x16327e3fbdaca3bcf7e38f5a, 0, mem[(4 * ceil32(return_data.size)) + 824 len floor32((6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36]
