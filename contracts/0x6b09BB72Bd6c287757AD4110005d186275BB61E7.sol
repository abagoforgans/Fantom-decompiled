...
function withdraw() {
    ...
    if eth.balance(this.address) < eth.balance(this.address) - (eth.balance(this.address) / 2) / 2:
        revert with 'NH{q', 17
    if eth.balance(this.address) - (eth.balance(this.address) - (eth.balance(this.address) / 2) / 2) < eth.balance(this.address) / 2:
        revert with 'NH{q', 17
    call stor15 with:
    ...
    call stor16 with:
       value eth.balance(this.address) - (eth.balance(this.address) / 2) / 2 wei
         gas 2300 * is_zero(value) wei
    call stor17 with:
       value eth.balance(this.address) - (eth.balance(this.address) - (eth.balance(this.address) / 2) / 2) - (eth.balance(this.address) / 2) wei
         gas 2300 * is_zero(value) wei
}
...
function mint(uint256 arg1) payable {
    ...
    if basePrice and arg1 > -1 / basePrice:
        revert with 'NH{q', 17
    if basePrice * arg1 > msg.value:
