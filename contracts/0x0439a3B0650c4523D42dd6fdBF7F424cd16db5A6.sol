                ...
                if not isAutoComp:
                    ...
                    if arg2 <= ext_call.return_data[0]:
                        if wantLockedTotal >= arg2:
                            mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg2) >> 32
                            call wantAddress with:
                               funct uint32(stor10)
                                 gas gas_remaining wei
                                args Mask(224, 32, arg2) << 224, mem[452 len 4]
                        else:
                            mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 0, stor14.field_32)
                            mem[452 len 0] = 0
                            call wantAddress with:
                               funct uint32(stor10)
                                 gas gas_remaining wei
                    ...
                    require ext_code.size(farmContractAddress)
                    if arg2:
                        call farmContractAddress.withdraw(uint256 arg1) with:
                             gas gas_remaining wei
                            args arg2
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    ...
                    if not isAutoComp:
                        ...
                        if 0 > ext_call.return_data[0]:
                            if wantLockedTotal >= ext_call.return_data[0]:
                                ...
                                mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 0, stor14.field_32)
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
                            ...
                            if wantLockedTotal >= 0:
                                mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
                        ...
                        if 0 <= ext_call.return_data[0]:
                            if wantLockedTotal < 0:
                                ...
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
                                    args Mask(480, -256, transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0) << 256, mem[516 len 4]
                        else:
                            if wantLockedTotal >= ext_call.return_data[0]:
                                mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), ext_call.return_data[0 len 28]
                                call wantAddress with:
                    ...
                    if not isAutoComp:
                        ...
                        if arg2 * withdrawFeeFactor / 10000 <= ext_call.return_data[0]:
                            if wantLockedTotal >= arg2 * withdrawFeeFactor / 10000:
                                mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg2 * withdrawFeeFactor / 10000) >> 32
                                mem[516 len 0] = 0
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
