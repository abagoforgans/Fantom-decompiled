...
function migrate(address arg1) {
    ...
    call address(stor19.field_16).withdrawAndHarvest(uint256 arg1, uint256 arg2, address arg3) with:
         gas gas_remaining wei
        args stor29, ext_call.return_data[0], arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function isActive() {
    ...
    mem[(2 * ceil32(return_data.size)) + 384] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 384 len 4], stor18 + 384]
    ...
    mem[_129] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 416] + 384]
...
function harvestTrigger(uint256 arg1) {
    ...
    mem[(4 * ceil32(return_data.size)) + 800] = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 800 len 4], stor18 + 800]
    ...
    mem[_195] = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 832] + 800]
