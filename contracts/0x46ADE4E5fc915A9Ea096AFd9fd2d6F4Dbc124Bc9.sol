...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    mem[(32 * _99) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 196] = arg3
    mem[(32 * _99) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 228] = 1
    ...
    require return_data.size >= 32
    require mem[(32 * _99) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 <= 4294967296
    require mem[(32 * _99) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 + 32 <= return_data.size
    require mem[mem[(32 * _99) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 + (32 * _99) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192] <= 4294967296 and mem[(32 * _99) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 + (32 * mem[mem[(32 * _99) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 + (32 * _99) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192]) + 32 <= return_data.size
    require 0 < cd[(arg5 + cd[(arg5 + 36)] + 36)]
    require ext_code.size(mem[140 len 20])
