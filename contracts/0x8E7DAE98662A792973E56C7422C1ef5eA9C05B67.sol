...
function buy() {
    ...
    call routerAddress.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
       value eth.balance(this.address) wei
         gas gas_remaining wei
        args 1, Array(len=2, data=mem[356 len 64]), 0xa6406f93725eaa05a09452bd1faa02d955990b05, block.timestamp + 120
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function sub_9c036dc1(?) {
    ...
    while idx < mem[_41]:
        ...
        t = t + 32
        continue 
    mem[_41 + 164] = 0xa6406f93725eaa05a09452bd1faa02d955990b05
