...
function lockLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, address arg6) payable {
    ...
    staticcall sub_7e8c95abAddress.0xe2fc90ca with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
        ...
        if not return_data.size:
            ...
            if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
                revert with 0, 
                            ...
                            uint32(arg3),
                            mem[356 len 4]
            mem[360 len 96] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(ext_call.return_data[0]), Mask(224, 32, arg4) >> 32
            mem[484 len 4] = uint32(arg4)
            call arg2 with:
                 gas gas_remaining wei
                args Mask(224, 32, arg4) << 480, mem[456 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
            ...
            if return_data.size:
                ...
                if not mem[260]:
                    revert with 0, 
                                ...
                                0x735472616e7366657248656c7065723a205452414e534645525f46524f4d5f4641494c45,
                                mem[ceil32(return_data.size) + 333 len 28]
            mem[ceil32(return_data.size) + 361 len 96] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(ext_call.return_data[0]), Mask(224, 32, arg4) >> 32
            mem[ceil32(return_data.size) + 485 len 4] = uint32(arg4)
            call arg2 with:
                 gas gas_remaining wei
                args Mask(224, 32, arg4) << 480, mem[ceil32(return_data.size) + 457 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
                ...
                if not ext_call.return_data[0]:
                    revert with 0, 'LP creation failed'
                mem[ceil32(return_data.size) + 461 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len 28]
                call address(ext_call.return_data[0]) with:
                   funct uint32(stor2)
                     gas gas_remaining wei
                    args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[ceil32(return_data.size) + 525 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'TransferHelper: APPROVE_FAILED'
                    if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
                    ...
                    if arg5 > 9999999999:
                        call address(sub_ef423206Address).0xdf41bc5f with:
                             gas gas_remaining wei
                            args address(ext_call.return_data[0]), ext_call.return_data[0], 9999999999, address(arg6), mem[(2 * ceil32(return_data.size)) + 594 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                    else:
                        call address(sub_ef423206Address).0xdf41bc5f with:
                             gas gas_remaining wei
                            args address(ext_call.return_data[0]), ext_call.return_data[0], arg5, address(arg6), mem[(2 * ceil32(return_data.size)) + 594 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            else:
                ...
                if not ext_call.success:
                    revert with 0, 
                                ...
                                36,
                                0x735472616e7366657248656c7065723a205452414e534645525f46524f4d5f4641494c45,
                                mem[(2 * ceil32(return_data.size)) + 466 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 28]
                if not return_data.size:
                    require ext_code.size(address(ext_call.return_data[0]))
                    call address(ext_call.return_data[0]).mint(address arg1) with:
                         gas gas_remaining wei
                        args address(this.address), mem[(2 * ceil32(return_data.size)) + 398 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_code.size(address(ext_call.return_data[0]))
                    ...
                    mem[(2 * ceil32(return_data.size)) + 462 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36]
                    call address(ext_call.return_data[0]) with:
                       funct Mask(8 * -floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 68, 0, stor2), mem[(2 * ceil32(return_data.size)) + 430 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
                         gas gas_remaining wei
                        args Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 4, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)) + 256, ext_call.return_data[0 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36]) << (8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)) - 256, mem[(2 * ceil32(return_data.size)) + floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 462 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + -floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 68]
                else:
                    require return_data.size >= 32
                    ...
                    mem[(2 * ceil32(return_data.size)) + 462 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36]
                    call address(ext_call.return_data[0]) with:
                       funct uint32(stor2), mem[(2 * ceil32(return_data.size)) + 430 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
                         gas gas_remaining wei
                        args Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 4, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)) + 256, ext_call.return_data[0 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36]) << (8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)) - 256, mem[(2 * ceil32(return_data.size)) + floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 462 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + -floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 68]
                if not return_data.size:
                    if not ext_call.success:
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_call.return_data[0]:
                            revert with 0, 'LP creation failed'
                        mem[(2 * ceil32(return_data.size)) + 462 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len 28]
                        call address(ext_call.return_data[0]) with:
                           funct uint32(stor2)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(2 * ceil32(return_data.size)) + 526 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 
                                            'TransferHelper: APPROVE_FAILED',
                        ...
                        if not return_data.size:
                            ...
                            if not ext_call.success:
                                revert with 0, 
                                            'TransferHelper: APPROVE_FAILED',
                                            mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 563 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(2 * ceil32(return_data.size)) + 494]:
                                    revert with 0, 
                            ...
                            if arg5 > 9999999999:
                                call address(sub_ef423206Address).0xdf41bc5f with:
                                     gas gas_remaining wei
                                    args address(ext_call.return_data[0]), ext_call.return_data[0], 9999999999, address(arg6), mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 595 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                            else:
                                call address(sub_ef423206Address).0xdf41bc5f with:
                                     gas gas_remaining wei
                                    args address(ext_call.return_data[0]), ext_call.return_data[0], arg5, address(arg6), mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 595 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            else:
                require return_data.size >= 32
                if not mem[260]:
                    revert with 0, 
