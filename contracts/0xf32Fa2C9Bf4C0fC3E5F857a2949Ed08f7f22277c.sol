                            ...
                            if -userInfo[address(msg.sender)].field_256 <= 0:
                                ...
                                if not return_data.size:
                                    ...
                                    if arg1 <= 0:
                                        ...
                                        if ext_code.size(address(poolInfo.field_0)) <= 0:
                                            revert with 0, 'Address: call to non-contract'
                                        mem[424 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
                                        mem[488 len 0] = 0
                                        call address(poolInfo.field_0) with:
                                           funct uint32(msg.sender)
                                             gas gas_remaining wei
                                    ...
                                    if arg1 <= 0:
                                        ...
                                        if ext_code.size(address(poolInfo.field_0)) <= 0:
                                            revert with 0, 'Address: call to non-contract'
                                        mem[ceil32(return_data.size) + 425 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
