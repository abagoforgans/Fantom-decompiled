            ...
            if tx.origin == owner:
                ...
                if paused:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, ext_call.return_data[0] - (500 * ext_call.return_data[0] / 100000)) >> 32
                        mem[452 len 0] = 0
                        call wantAddress with:
                           funct uint32(stor4)
                             gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if paused:
                    ...
                    if not arg1:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1 - (500 * arg1 / 100000)) >> 32
                        mem[452 len 0] = 0
                        call wantAddress with:
                           funct uint32(stor4)
                             gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if paused:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, ext_call.return_data[0] - (500 * ext_call.return_data[0] / 100000)) >> 32
                        mem[516 len 0] = 0
                        call wantAddress with:
                           funct uint32(stor4)
                             gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if paused:
                    ...
                    if not arg1:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1 - (500 * arg1 / 100000)) >> 32
                        mem[516 len 0] = 0
                        call wantAddress with:
                           funct uint32(stor4)
                             gas gas_remaining wei
