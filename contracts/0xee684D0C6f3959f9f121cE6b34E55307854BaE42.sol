...
function mint(string arg1) payable {
    ...
    if stor164[stor151].field_0:
        if stor164[stor151].field_0 == stor164[stor151].field_1 < 32:
            revert with 'NH{q', 34
        if arg1.length:
            stor164[stor151][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
            stor164[stor151].field_0 = 0
            idx = 0
            while stor164[stor151].field_1 + 31 / 32 > idx:
                stor164[stor151][idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if stor164[stor151].field_0 == stor164[stor151].field_1 < 32:
...
function tokenURI(uint256 arg1) payable {
    ...
    if stor164[arg1].field_0:
        if stor164[arg1].field_0 == stor164[arg1].field_1 < 32:
            revert with 'NH{q', 34
        if stor164[arg1].field_0:
            if stor164[arg1].field_0 == stor164[arg1].field_1 < 32:
                revert with 'NH{q', 34
            if stor164[arg1].field_1:
                if 31 < stor164[arg1].field_1:
                    mem[128] = stor164[arg1].field_0
                    idx = 128
                    s = 0
                    while stor164[arg1].field_1 + 96 > idx:
                        mem[idx + 32] = stor164[arg1][s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, stor164[arg1].field_1), data=mem[128 len ceil32(stor164[arg1].field_1)])
                mem[128] = 256 * stor164[arg1].field_8
        else:
            if stor164[arg1].field_0 == stor164[arg1].field_1 < 32:
                revert with 'NH{q', 34
            if stor164[arg1].field_1:
                if 31 < stor164[arg1].field_1:
                    ...
                    return Array(len=2 * Mask(256, -1, stor164[arg1].field_1), data=mem[128 len ceil32(stor164[arg1].field_1)])
                mem[128] = 256 * stor164[arg1].field_8
        mem[ceil32(stor164[arg1].field_1) + 224 len ceil32(stor164[arg1].field_1)] = mem[128 len ceil32(stor164[arg1].field_1)]
        if ceil32(stor164[arg1].field_1) > stor164[arg1].field_1:
            mem[ceil32(stor164[arg1].field_1) + stor164[arg1].field_1 + 224] = 0
        return Array(len=2 * Mask(256, -1, stor164[arg1].field_1), data=mem[128 len ceil32(stor164[arg1].field_1)], mem[(2 * ceil32(stor164[arg1].field_1)) + 224 len 2 * ceil32(stor164[arg1].field_1)]), 
    if stor164[arg1].field_0 == stor164[arg1].field_1 < 32:
        revert with 'NH{q', 34
    if stor164[arg1].field_0:
        if stor164[arg1].field_0 == stor164[arg1].field_1 < 32:
        ...
        if stor164[arg1].field_1:
            if 31 < stor164[arg1].field_1:
                ...
                while stor164[arg1].field_1 + 96 > idx:
                    ...
                    s = s + 1
                    continue 
                return Array(len=stor164[arg1].field_0, data=mem[128 len ceil32(stor164[arg1].field_1)])
            mem[128] = 256 * stor164[arg1].field_8
    else:
        if stor164[arg1].field_0 == stor164[arg1].field_1 < 32:
            revert with 'NH{q', 34
    ...
    if ceil32(stor164[arg1].field_1) > stor164[arg1].field_1:
        mem[ceil32(stor164[arg1].field_1) + stor164[arg1].field_1 + 224] = 0
    return Array(len=stor164[arg1].field_0, data=mem[128 len ceil32(stor164[arg1].field_1)], mem[(2 * ceil32(stor164[arg1].field_1)) + 224 len 2 * ceil32(stor164[arg1].field_1)]), 
}
