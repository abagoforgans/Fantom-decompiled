...
function skim(address arg1) {
    ...
    if arg1 == stor3:
        ...
        mem[ceil32(return_data.size) + 196 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), ext_call.return_data[0], mem[ceil32(return_data.size) + 196 len 28]
