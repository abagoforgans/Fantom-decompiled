...
function relock(address arg1, uint256 arg2, uint256 arg3, uint256 arg4) {
    ...
    if not numLocksForToken[address(arg1)][stor3[address(msg.sender)][2][address(arg1)][arg2].field_0].field_256:
        ...
        mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), 0
        call arg1 with:
           funct uint32(stor11)
             gas gas_remaining wei
            args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), 0) << 256, mem[388 len 4]
    else:
        ...
        numLocksForToken[address(arg1)][stor3[address(msg.sender)][2][address(arg1)][arg2].field_0].field_768 = arg4
        mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, numLocksForToken[address(arg1)][stor3[address(msg.sender)][2][address(arg1)][arg2].field_0].field_256 * stor8 / 1000) >> 32
        call arg1 with:
           funct uint32(stor11)
             gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            revert with 0, 
                        ...
                        mem[356 len 4]
        if not arg4:
            mem[392 len 64] = 0, address(stor11), 0
            call arg1 with:
               funct uint32(stor11)
                 gas gas_remaining wei
                args 0, Mask(224, 32, 0, address(stor11), 0) >> 32, mem[456 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'TransferHelper: TRANSFER_FAILED'
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            ...
            if arg4 * stor8 / arg4 != stor8:
                revert with 0, 
                            ...
                            uint32(arg4),
                            mem[356 len 4]
            mem[392 len 64] = 0, address(stor11), Mask(224, 32, arg4 * stor8 / 1000) >> 32
            call arg1 with:
               funct uint32(stor11)
                 gas gas_remaining wei
                args arg4 * stor8 / 1000, Mask(224, 32, address(stor11), Mask(224, 32, arg4 * stor8 / 1000) >> 32) >> 32, mem[456 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'TransferHelper: TRANSFER_FAILED'
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if return_data.size:
            ...
            if not mem[260]:
                revert with 0, 
                            ...
                            mem[ceil32(return_data.size) + 333 len 28]
        if not arg4:
            mem[ceil32(return_data.size) + 393 len 64] = 0, address(stor11), 0
            call arg1 with:
               funct uint32(stor11)
                 gas gas_remaining wei
                args 0, Mask(224, 32, 0, address(stor11), 0) >> 32, mem[ceil32(return_data.size) + 457 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'TransferHelper: TRANSFER_FAILED'
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            ...
            mem[ceil32(return_data.size) + 393 len 64] = 0, address(stor11), Mask(224, 32, arg4 * stor8 / 1000) >> 32
            call arg1 with:
               funct uint32(stor11)
                 gas gas_remaining wei
                args arg4 * stor8 / 1000, Mask(224, 32, address(stor11), Mask(224, 32, arg4 * stor8 / 1000) >> 32) >> 32, mem[ceil32(return_data.size) + 457 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'TransferHelper: TRANSFER_FAILED'
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if not arg2:
            ...
            if arg2 * stor8 / arg2 != stor8:
                revert with 0, 
                            ...
                            uint32(arg2),
                            mem[356 len 4]
            mem[392 len 64] = 0, address(stor11), Mask(224, 32, arg2 * stor8 / 1000) >> 32
            call arg1 with:
               funct uint32(stor11)
                 gas gas_remaining wei
                args arg2 * stor8 / 1000, Mask(224, 32, address(stor11), Mask(224, 32, arg2 * stor8 / 1000) >> 32) >> 32, mem[456 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'TransferHelper: TRANSFER_FAILED'
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if not arg2:
            ...
            if arg2 * stor8 / arg2 != stor8:
                revert with 0, 
                            ...
                            0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            mem[ceil32(return_data.size) + 330 len 31]
            mem[ceil32(return_data.size) + 393 len 64] = 0, address(stor11), Mask(224, 32, arg2 * stor8 / 1000) >> 32
            call arg1 with:
               funct uint32(stor11)
                 gas gas_remaining wei
                args arg2 * stor8 / 1000, Mask(224, 32, address(stor11), Mask(224, 32, arg2 * stor8 / 1000) >> 32) >> 32, mem[ceil32(return_data.size) + 457 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'TransferHelper: TRANSFER_FAILED'
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
