        ...
        if ext_call.return_data[0]:
            if poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    call sub_0714f3fcAddress.0x40c10f19 with:
                         gas gas_remaining wei
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not (block.number * sub_11ca2d51) - (poolInfo[arg1].field_512 * sub_11ca2d51):
                            ...
                            call sub_0714f3fcAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devaddr, (block.number * sub_11ca2d51 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_11ca2d51 * poolInfo[arg1].field_256) / totalAllocPoint / 4
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(sub_0714f3fcAddress)
                            call sub_0714f3fcAddress.0x40c10f19 with:
...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        call sub_0714f3fcAddress.0x40c10f19 with:
             gas gas_remaining wei
            args devaddr, (block.number * sub_11ca2d51 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_11ca2d51 * poolInfo[idx].field_256) / totalAllocPoint / 4
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
