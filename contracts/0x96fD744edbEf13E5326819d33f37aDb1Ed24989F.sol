...
function userVotedForOption(uint256 arg1, uint256 arg2, address arg3) payable {
    ...
    require arg2 == arg2
    require arg3 == arg3
    return bool(stor10[arg1][arg2][address(arg3)])
}
...
function sub_44083843(?) payable {
    ...
    while idx < activeRounds.length:
        ...
        idx = 0
        while idx < ('cd', 36).length:
            if not stor10[cd[4]][idx][address(msg.sender)]:
                stor10[cd[4]][idx][address(msg.sender)] = 1
        ...
        if not stor9[cd[4]][address(msg.sender)]:
            stor9[cd[4]][address(msg.sender)] = 1
...
function sub_ad77c86a(?) payable {
    ...
    if bool(stor4[stor2].field_0):
        ...
        if mem[96]:
            ...
            mem[32] = 5
            uint256(sub_5f378ce7[stor2].field_0) = mem[ceil32(ceil32(('cd', 4).length)) + 97]
            mem[0] = sha3(roundCount, 5)
            if not mem[ceil32(ceil32(('cd', 4).length)) + 97]:
                idx = 0
                while sha3(sha3(roundCount, 5)) + uint256(sub_5f378ce7[stor2].field_0) > idx + sha3(mem[0]):
                ...
                while ceil32(ceil32(('cd', 4).length)) + (32 * mem[ceil32(ceil32(('cd', 4).length)) + 97]) + 129 > idx:
                    ...
                    continue 
                idx = s
                while sha3(sha3(roundCount, 5)) + uint256(sub_5f378ce7[stor2].field_0) > idx:
