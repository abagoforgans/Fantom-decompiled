...
function sub_229a5511(?) payable {
    ...
    if msg.sender == adminAddress:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[192] = 15
        mem[224] = 'Borrow Complete'
        mem[292] = 32
        mem[324] = 15
        mem[356] = 'Borrow Complete'
        mem[371] = 0
        mem[256] = 100
        mem[292 len 28] = 0
        mem[288 len 4] = log(string arg1)
        staticcall 'console.log'.log(string arg1) with:
                gas gas_remaining wei
               args 0, 0, 15, 'Borrow Complete', 0
        ...
        call sub_f973c3d5Address.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args arg1, arg2, Array(len=2, data=mem[584 len 64]), address(this.address), -1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[388 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = ceil32(return_data.size) + 388
        require return_data.size >= 32
        _214 = mem[388 len 4], Mask(224, 32, arg1) >> 32
        require mem[388 len 4], Mask(224, 32, arg1) >> 32 <= test266151307()
        require mem[388 len 4], Mask(224, 32, arg1) >> 32 + 419 < return_data.size + 388
        _218 = mem[mem[388 len 4], Mask(224, 32, arg1) >> 32 + 388]
        if mem[mem[388 len 4], Mask(224, 32, arg1) >> 32 + 388] > test266151307():
            revert with 'NH{q', 65
        if ceil32(return_data.size) + floor32(mem[mem[388 len 4], Mask(224, 32, arg1) >> 32 + 388]) + 389 > test266151307() or floor32(mem[mem[388 len 4], Mask(224, 32, arg1) >> 32 + 388]) + 1 < 0:
            revert with 'NH{q', 65
        mem[64] = ceil32(return_data.size) + floor32(mem[mem[388 len 4], Mask(224, 32, arg1) >> 32 + 388]) + 389
        mem[ceil32(return_data.size) + 388] = mem[mem[388 len 4], Mask(224, 32, arg1) >> 32 + 388]
        ...
        staticcall 'console.log'.log(string arg1) with:
                gas gas_remaining wei
               args mem[_329 + 36 len mem[_329] - 4]
    else:
        if hardwareWalletAddress != msg.sender:
            revert with 0, 'Bitch this is my contract.'
        mem[96] = 2
        ...
        mem[64] = ceil32(return_data.size) + 388
        require return_data.size >= 32
        _216 = mem[388 len 4], Mask(224, 32, arg1) >> 32
        require mem[388 len 4], Mask(224, 32, arg1) >> 32 <= test266151307()
        require mem[388 len 4], Mask(224, 32, arg1) >> 32 + 419 < return_data.size + 388
        _220 = mem[mem[388 len 4], Mask(224, 32, arg1) >> 32 + 388]
        if mem[mem[388 len 4], Mask(224, 32, arg1) >> 32 + 388] > test266151307():
            revert with 'NH{q', 65
        if ceil32(return_data.size) + floor32(mem[mem[388 len 4], Mask(224, 32, arg1) >> 32 + 388]) + 389 > test266151307() or floor32(mem[mem[388 len 4], Mask(224, 32, arg1) >> 32 + 388]) + 1 < 0:
            revert with 'NH{q', 65
        ...
        staticcall 'console.log'.log(string arg1) with:
                gas gas_remaining wei
               args mem[_335 + 36 len mem[_335] - 4]
}
...
function sub_86c9f841(?) payable {
    ...
    if msg.sender == adminAddress:
        ...
        if not arg2:
            ...
            call sub_f973c3d5Address.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args arg3, 0, 160, address(this.address), -1, 2, mem[484 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[288 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = ceil32(return_data.size) + 288
