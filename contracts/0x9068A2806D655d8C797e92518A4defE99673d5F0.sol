...
function sub_dfd143c7(?) payable {
    ...
    if not _23 % 32:
        ...
        if not _173 % 32:
            ...
            return address(ext_call.return_data[0]), 
                   address(ext_call.return_data[0]),
                   Array(len=mem[_173 + _23 + (2 * ceil32(return_data.size)) + 384 len floor32(mem[ceil32(return_data.size) + 96]) + 64], data=mem[_23 + (2 * ceil32(return_data.size)) + 128], mem[_173 + _23 + (2 * ceil32(return_data.size)) + floor32(mem[ceil32(return_data.size) + 96]) + 480 len floor32(mem[_23 + (2 * ceil32(return_data.size)) + 128]) + 32]),
                   ext_call.return_data[0] << 248,
                   address(ext_call.return_data[0]),
                   mem[_173 + _23 + (2 * ceil32(return_data.size)) + 320],
                   ext_call.return_data[0] << 248
        ...
        return address(ext_call.return_data[0]), 
               address(ext_call.return_data[0]),
               Array(len=mem[floor32(_173) + _23 + (2 * ceil32(return_data.size)) + 416 len floor32(mem[ceil32(return_data.size) + 96]) + 64], data=mem[_23 + (2 * ceil32(return_data.size)) + 128], mem[floor32(_173) + _23 + (2 * ceil32(return_data.size)) + floor32(mem[ceil32(return_data.size) + 96]) + 512 len floor32(mem[_23 + (2 * ceil32(return_data.size)) + 128]) + 32]),
               ext_call.return_data[0] << 248,
               address(ext_call.return_data[0]),
               mem[floor32(_173) + _23 + (2 * ceil32(return_data.size)) + 352],
               ext_call.return_data[0] << 248
    ...
    if arg1 < arg2:
        ...
        if not _19 % 32:
            ...
            if not _287 % 32:
                ...
                return address(arg1), 
                       Array(len=mem[ceil32(return_data.size) + 96], data=mem[_287 + _19 + (2 * ceil32(return_data.size)) + 384 len floor32(mem[_19 + (2 * ceil32(return_data.size)) + 128]) + mem[ceil32(return_data.size) + 96] + 64]),
                       ext_call.return_data[0] << 248,
                       address(arg2),
                       mem[ceil32(return_data.size) + 96] + 224,
                       ext_call.return_data[0] << 248
            ...
            return address(arg1), 
                   Array(len=mem[ceil32(return_data.size) + 96], data=mem[floor32(_287) + _19 + (2 * ceil32(return_data.size)) + 416 len floor32(mem[_19 + (2 * ceil32(return_data.size)) + 128]) + mem[ceil32(return_data.size) + 96] + 64]),
                   ext_call.return_data[0] << 248,
                   address(arg2),
                   mem[ceil32(return_data.size) + 96] + 224,
                   ext_call.return_data[0] << 248
