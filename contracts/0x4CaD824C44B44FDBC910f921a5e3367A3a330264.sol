...
function withdraw(uint256 arg1) payable {
    ...
    call 0x5979959483b4aafa6a94ba8da6aa406c31d06cb6.withdraw(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 1, arg1
    if not ext_call.success:
...
function depositAll() payable {
    ...
    require ext_code.size(0x5979959483b4aafa6a94ba8da6aa406c31d06cb6)
    call 0x5979959483b4aafa6a94ba8da6aa406c31d06cb6.deposit(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function sub_4b44ceed(?) payable {
    ...
    if not sub_c7b2c2d1.length:
        ...
        mem[(32 * _29) + ceil32(return_data.size) + 356 len 0] = 0
        call 0x0021be370d5312f44cb42ce377bc9b8a0cef1a4c with:
           funct uint32(stor2)
             gas gas_remaining wei
        ...
        mem[(32 * _152) + ceil32(return_data.size) + 356 len 0] = 0
        call 0x0021be370d5312f44cb42ce377bc9b8a0cef1a4c with:
           funct uint32(stor2)
             gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c):
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 590 len 64] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0 len 28]
                mem[(2 * ceil32(return_data.size)) + 654 len 0] = 0
                call 0x0021be370d5312f44cb42ce377bc9b8a0cef1a4c with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                    args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(2 * ceil32(return_data.size)) + 654 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0]
                    if not transfer(address arg1, uint256 arg2), Mask(224, 32, msg.sender) >> 32:
...
function emergencyWithdrawAll() payable {
    if address(owner) != msg.sender:
        revert with 0, 'Owner required'
    require ext_code.size(0x5979959483b4aafa6a94ba8da6aa406c31d06cb6)
    call 0x5979959483b4aafa6a94ba8da6aa406c31d06cb6.emergencyWithdraw(uint256 arg1) with:
         gas gas_remaining wei
        args 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
