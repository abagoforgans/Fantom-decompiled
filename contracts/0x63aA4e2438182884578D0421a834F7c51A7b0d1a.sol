...
function sub_0e64fe49(?) payable {
    ...
    if not Mask(254, 0, ('cd', 4).length):
        ...
        while idx < ('cd', 4).length:
            ...
            mem[64] = mem[64] + 192
            require 0 < mem[_122]
            mem[_122 + 32] = Mask(200, 0, cd[((32 * idx) + cd[4] + 36)])
            require 1 < mem[_122]
            mem[_122 + 64] = 0
            require 2 < mem[_122]
            mem[_122 + 96] = 0
            ...
            mem[(128 * idx) + 128] = Mask(200, 0, cd[((32 * idx) + cd[4] + 36)])
            require 1 < mem[_122]
            if var79003 >= 0:
                idx = idx + 1
                continue 
            require (2 * var81004) + 1 < ('cd', 36).length
            require cd[((32 * var83001) + cd[36] + 36)] == address(cd[((32 * var83001) + cd[36] + 36)])
            require 2 * var83008 < ('cd', 36).length
            require cd[((64 * var83008) + cd[36] + 36)] == address(cd[((64 * var83008) + cd[36] + 36)])
            require 1 < mem[_122]
            if var83005 + 1 < 0:
                if 2 * var83008 + 1 < ('cd', 36).length:
                    require cd[((64 * var83008 + 1) + cd[36] + 36)] == address(cd[((64 * var83008 + 1) + cd[36] + 36)])
                    if (4 * idx) + var83005 < mem[96]:
                        _602 = mem[(32 * (4 * idx) + var83005) + 128]
                        if var83005 + 2 < mem[_122]:
                            _608 = mem[(32 * var83005 + 2) + _122 + 32]
                            require ext_code.size(address(cd[((32 * var83001) + cd[36] + 36)]))
                            staticcall address(cd[((32 * var83001) + cd[36] + 36)]).getReserves() with:
                                    gas gas_remaining wei
                            mem[_122 + 192 len 96] = ext_call.return_data[0 len 96]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            mem[64] = _122 + ceil32(return_data.size) + 192
                            require return_data.size >= 96
                            require ext_call.return_data[64] == ext_call.return_data[92 len 4]
                            if address(cd[((64 * var83008) + cd[36] + 36)]) < address(cd[((64 * var83008 + 1) + cd[36] + 36)]):
                                if address(cd[((64 * var83008) + cd[36] + 36)]) == address(cd[((64 * var83008) + cd[36] + 36)]):
                                    if (ext_call.return_data[0] * _608) + (10000 * ext_call.return_data[0]) + (10000 * _602) - (ext_call.return_data[0] * _608) - (_602 * _608):
                                        if (4 * idx) + var83005 + 1 < mem[96]:
                                            mem[(32 * (4 * idx) + var83005 + 1) + 128] = (_608 * ext_call.return_data[32] * ext_call.return_data[0]) + (10000 * ext_call.return_data[0] * ext_call.return_data[32]) + (10000 * _602 * ext_call.return_data[32]) - (10000 * ext_call.return_data[32] * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[32] * _608) - (_602 * ext_call.return_data[32] * _608) / (ext_call.return_data[0] * _608) + (10000 * ext_call.return_data[0]) + (10000 * _602) - (ext_call.return_data[0] * _608) - (_602 * _608)
                                            if 1 < mem[_122]:
                                                if var83005 + 1 >= 0:
                                                    idx = idx + 1
                                                    continue 
                                                if (2 * var83008 + 1) + 1 < ('cd', 36).length:
                                                    var83001 = (2 * var83008 + 1) + 1
                                                    var83005 = var83005 + 1
                                                    var83008 = var83008 + 1
                                                    continue 
                                else:
                                    if (ext_call.return_data[32] * _608) + (10000 * ext_call.return_data[32]) + (10000 * _602) - (ext_call.return_data[32] * _608) - (_602 * _608):
                                        if (4 * idx) + var83005 + 1 < mem[96]:
                                            mem[(32 * (4 * idx) + var83005 + 1) + 128] = (_608 * ext_call.return_data[0] * ext_call.return_data[32]) + (10000 * ext_call.return_data[32] * ext_call.return_data[0]) + (10000 * _602 * ext_call.return_data[0]) - (10000 * ext_call.return_data[0] * ext_call.return_data[32]) - (ext_call.return_data[32] * ext_call.return_data[0] * _608) - (_602 * ext_call.return_data[0] * _608) / (ext_call.return_data[32] * _608) + (10000 * ext_call.return_data[32]) + (10000 * _602) - (ext_call.return_data[32] * _608) - (_602 * _608)
                                            if 1 < mem[_122]:
                                                if var83005 + 1 >= 0:
                                                    idx = idx + 1
                                                    continue 
                ...
                if 1 < mem[_122]:
                    if 2 * var83008 + 1 < ('cd', 36).length:
                        require cd[((64 * var83008 + 1) + cd[36] + 36)] == address(cd[((64 * var83008 + 1) + cd[36] + 36)])
                        if (4 * idx) + var83005 < mem[96]:
                            _609 = mem[(32 * (4 * idx) + var83005) + 128]
                            if var83005 + 2 < mem[_122]:
                                _614 = mem[(32 * var83005 + 2) + _122 + 32]
                                require ext_code.size(address(cd[((32 * var83001) + cd[36] + 36)]))
                                staticcall address(cd[((32 * var83001) + cd[36] + 36)]).getReserves() with:
                                        gas gas_remaining wei
                                mem[_122 + 192 len 96] = ext_call.return_data[0 len 96]
                                ...
                                if address(cd[((64 * var83008) + cd[36] + 36)]) < address(cd[((64 * var83008 + 1) + cd[36] + 36)]):
                                    if address(cd[((64 * var83008) + cd[36] + 36)]) == address(cd[((64 * var83008) + cd[36] + 36)]):
                                        if (ext_call.return_data[0] * _614) + (10000 * ext_call.return_data[0]) + (10000 * _609) - (ext_call.return_data[0] * _614) - (_609 * _614):
                                            if (4 * idx) + var83005 + 1 < mem[96]:
                                                mem[(32 * (4 * idx) + var83005 + 1) + 128] = (_614 * ext_call.return_data[32] * ext_call.return_data[0]) + (10000 * ext_call.return_data[0] * ext_call.return_data[32]) + (10000 * _609 * ext_call.return_data[32]) - (10000 * ext_call.return_data[32] * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[32] * _614) - (_609 * ext_call.return_data[32] * _614) / (ext_call.return_data[0] * _614) + (10000 * ext_call.return_data[0]) + (10000 * _609) - (ext_call.return_data[0] * _614) - (_609 * _614)
                                                if 1 < mem[_122]:
                                                    if var83005 + 1 >= 0:
                                                        idx = idx + 1
                                                        continue 
                                        ...
                                        if (ext_call.return_data[32] * _614) + (10000 * ext_call.return_data[32]) + (10000 * _609) - (ext_call.return_data[32] * _614) - (_609 * _614):
                                            if (4 * idx) + var83005 + 1 < mem[96]:
                                                mem[(32 * (4 * idx) + var83005 + 1) + 128] = (_614 * ext_call.return_data[0] * ext_call.return_data[32]) + (10000 * ext_call.return_data[32] * ext_call.return_data[0]) + (10000 * _609 * ext_call.return_data[0]) - (10000 * ext_call.return_data[0] * ext_call.return_data[32]) - (ext_call.return_data[32] * ext_call.return_data[0] * _614) - (_609 * ext_call.return_data[0] * _614) / (ext_call.return_data[32] * _614) + (10000 * ext_call.return_data[32]) + (10000 * _609) - (ext_call.return_data[32] * _614) - (_609 * _614)
                                                if 1 < mem[_122]:
                                                    if var83005 + 1 >= 0:
                                                        idx = idx + 1
                                                        continue 
        ...
        while idx < ('cd', 4).length:
            ...
            mem[64] = mem[64] + 192
            require 0 < mem[_124]
            mem[_124 + 32] = Mask(200, 0, cd[((32 * idx) + cd[4] + 36)])
            require 1 < mem[_124]
            mem[_124 + 64] = 0
            require 2 < mem[_124]
            mem[_124 + 96] = 0
            ...
            if var84005 + 1 < 0:
                if 2 * var84008 + 1 < ('cd', 36).length:
                    ...
                    if (4 * idx) + var84005 < mem[96]:
                        _605 = mem[(32 * (4 * idx) + var84005) + 128]
                        if var84005 + 2 < mem[_124]:
                            _611 = mem[(32 * var84005 + 2) + _124 + 32]
                            require ext_code.size(address(cd[((32 * var84001) + cd[36] + 36)]))
                            staticcall address(cd[((32 * var84001) + cd[36] + 36)]).getReserves() with:
                                    gas gas_remaining wei
                            mem[_124 + 192 len 96] = ext_call.return_data[0 len 96]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            mem[64] = _124 + ceil32(return_data.size) + 192
                            require return_data.size >= 96
                            require ext_call.return_data[64] == ext_call.return_data[92 len 4]
                            if address(cd[((64 * var84008) + cd[36] + 36)]) < address(cd[((64 * var84008 + 1) + cd[36] + 36)]):
                                if address(cd[((64 * var84008) + cd[36] + 36)]) == address(cd[((64 * var84008) + cd[36] + 36)]):
                                    if (ext_call.return_data[0] * _611) + (10000 * ext_call.return_data[0]) + (10000 * _605) - (ext_call.return_data[0] * _611) - (_605 * _611):
                                        if (4 * idx) + var84005 + 1 < mem[96]:
                                            mem[(32 * (4 * idx) + var84005 + 1) + 128] = (_611 * ext_call.return_data[32] * ext_call.return_data[0]) + (10000 * ext_call.return_data[0] * ext_call.return_data[32]) + (10000 * _605 * ext_call.return_data[32]) - (10000 * ext_call.return_data[32] * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[32] * _611) - (_605 * ext_call.return_data[32] * _611) / (ext_call.return_data[0] * _611) + (10000 * ext_call.return_data[0]) + (10000 * _605) - (ext_call.return_data[0] * _611) - (_605 * _611)
                                            if 1 < mem[_124]:
                                                if var84005 + 1 >= 0:
                                                    idx = idx + 1
                                                    continue 
                                    ...
                                    if (ext_call.return_data[32] * _611) + (10000 * ext_call.return_data[32]) + (10000 * _605) - (ext_call.return_data[32] * _611) - (_605 * _611):
                                        if (4 * idx) + var84005 + 1 < mem[96]:
                                            mem[(32 * (4 * idx) + var84005 + 1) + 128] = (_611 * ext_call.return_data[0] * ext_call.return_data[32]) + (10000 * ext_call.return_data[32] * ext_call.return_data[0]) + (10000 * _605 * ext_call.return_data[0]) - (10000 * ext_call.return_data[0] * ext_call.return_data[32]) - (ext_call.return_data[32] * ext_call.return_data[0] * _611) - (_605 * ext_call.return_data[0] * _611) / (ext_call.return_data[32] * _611) + (10000 * ext_call.return_data[32]) + (10000 * _605) - (ext_call.return_data[32] * _611) - (_605 * _611)
                                            if 1 < mem[_124]:
                                                if var84005 + 1 >= 0:
                                                    idx = idx + 1
                                                    continue 
                ...
                if 1 < mem[_124]:
                    if 2 * var84008 + 1 < ('cd', 36).length:
                        require cd[((64 * var84008 + 1) + cd[36] + 36)] == address(cd[((64 * var84008 + 1) + cd[36] + 36)])
                        if (4 * idx) + var84005 < mem[96]:
                            _612 = mem[(32 * (4 * idx) + var84005) + 128]
                            if var84005 + 2 < mem[_124]:
                                _615 = mem[(32 * var84005 + 2) + _124 + 32]
                                require ext_code.size(address(cd[((32 * var84001) + cd[36] + 36)]))
                                staticcall address(cd[((32 * var84001) + cd[36] + 36)]).getReserves() with:
                                        gas gas_remaining wei
                                mem[_124 + 192 len 96] = ext_call.return_data[0 len 96]
                                ...
                                if address(cd[((64 * var84008) + cd[36] + 36)]) < address(cd[((64 * var84008 + 1) + cd[36] + 36)]):
                                    if address(cd[((64 * var84008) + cd[36] + 36)]) == address(cd[((64 * var84008) + cd[36] + 36)]):
                                        if (ext_call.return_data[0] * _615) + (10000 * ext_call.return_data[0]) + (10000 * _612) - (ext_call.return_data[0] * _615) - (_612 * _615):
                                            if (4 * idx) + var84005 + 1 < mem[96]:
                                                mem[(32 * (4 * idx) + var84005 + 1) + 128] = (_615 * ext_call.return_data[32] * ext_call.return_data[0]) + (10000 * ext_call.return_data[0] * ext_call.return_data[32]) + (10000 * _612 * ext_call.return_data[32]) - (10000 * ext_call.return_data[32] * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[32] * _615) - (_612 * ext_call.return_data[32] * _615) / (ext_call.return_data[0] * _615) + (10000 * ext_call.return_data[0]) + (10000 * _612) - (ext_call.return_data[0] * _615) - (_612 * _615)
                                                if 1 < mem[_124]:
                                                    if var84005 + 1 >= 0:
                                                        idx = idx + 1
                                                        continue 
                                        ...
                                        if (ext_call.return_data[32] * _615) + (10000 * ext_call.return_data[32]) + (10000 * _612) - (ext_call.return_data[32] * _615) - (_612 * _615):
                                            if (4 * idx) + var84005 + 1 < mem[96]:
                                                mem[(32 * (4 * idx) + var84005 + 1) + 128] = (_615 * ext_call.return_data[0] * ext_call.return_data[32]) + (10000 * ext_call.return_data[32] * ext_call.return_data[0]) + (10000 * _612 * ext_call.return_data[0]) - (10000 * ext_call.return_data[0] * ext_call.return_data[32]) - (ext_call.return_data[32] * ext_call.return_data[0] * _615) - (_612 * ext_call.return_data[0] * _615) / (ext_call.return_data[32] * _615) + (10000 * ext_call.return_data[32]) + (10000 * _612) - (ext_call.return_data[32] * _615) - (_612 * _615)
                                                if 1 < mem[_124]:
                                                    if var84005 + 1 >= 0:
                                                        idx = idx + 1
                                                        continue 
