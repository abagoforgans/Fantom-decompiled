...
function swapOut(address arg1, uint256 arg2) payable {
    ...
    if not return_data.size:
        ...
        if not msg.sender:
            revert with 0, 32, 33, 0x2e45524332303a206275726e2066726f6d20746865207a65726f20616464726573, mem[297 len 31]
        if arg2 > balanceOf[address(msg.sender)]:
            revert with 0, 32, 34, 0x7345524332303a206275726e20616d6f756e7420657863656564732062616c616e63, mem[262 len 26], uint32(arg2), 0
    else:
        ...
        if arg2 > balanceOf[address(msg.sender)]:
            revert with 0, 
                        ...
                        mem[ceil32(return_data.size) + 263 len 30],
                        mem[ceil32(return_data.size) + 323 len 2]
