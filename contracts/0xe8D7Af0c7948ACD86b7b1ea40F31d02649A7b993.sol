...
function buy(uint256 arg1, address arg2) payable {
    ...
    if not arg1 / price:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if (1000 * arg1 / price / 10^9) + sub_08d09957[address(msg.sender)] < sub_08d09957[address(msg.sender)]:
            revert with 0, 'SafeMath: addition overflow'
        sub_08d09957[address(msg.sender)] += 1000 * arg1 / price / 10^9
        if (1000 * arg1 / price / 10^9) + tokenBoughtTotal[address(msg.sender)] < tokenBoughtTotal[address(msg.sender)]:
            revert with 0, 'SafeMath: addition overflow'
