            ...
            while t < ('cd', 68).length:
                ...
                if not ext_call.success:
                    ...
                    if mem[_154] < 1:
                        ...
                        if mem[_154] - 1:
                            if not bool(mem[_154] - 1 < 78) and not bool(mem[_154] - 1 < 32):
                                v = 10
                                w = 1
                                u = mem[_154] - 1
                                while u > 1:
                                ...
                                if w > -1 / v:
                                    ...
                                    if idx >= ('cd', 36).length:
                                        ...
                                        if not w * v:
                                            ...
                                            if cd[((32 * idx) + cd[36] + 36)] / w * v < 2:
                                                revert with 'NH{q', 17
                                            else:
                                                if (cd[((32 * idx) + cd[36] + 36)] / w * v) - 2 >= stor12.length:
                                                    revert with 'NH{q', 50
                                                else:
                                                    mem[0] = 12
                                                    if s >= ('cd', 4).length:
                                                        ...
                                                        if t >= ('cd', 68).length:
                                                            ...
                                                            require ext_code.size(stor12[(cd[((32 * idx) + cd[36] + 36)] / w * v) - 2].field_256)
                                                            staticcall stor12[(cd[((32 * idx) + cd[36] + 36)] / w * v) - 2].field_256.getPair(address arg1, address arg2) with:
                                                                    gas gas_remaining wei
                                                                        ...
                                                                        if t >= ('cd', 68).length:
                                                                            ...
                                                                            if not ext_call.success:
                                                                                ...
                                                                                if mem[_465] < 2:
                                                                                    ...
                                                                                    if mem[_465] - 2:
                                                                                        if not bool(mem[_465] - 2 < 78) and not bool(mem[_465] - 2 < 32):
                                                                                            v = 10
                                                                                            w = 1
                                                                                            u = mem[_465] - 2
                                                                                            while u > 1:
                                                                                                            ...
                                                                                                            if t >= ('cd', 68).length:
                                                                                                                ...
                                                                                                                if not ext_call.success:
                                                                                                                    ...
                                                                                                                    if mem[_607] < 2:
                                                                                                                        ...
                                                                                                                        if mem[_607] - 2:
                                                                                                                            if not bool(mem[_607] - 2 < 78) and not bool(mem[_607] - 2 < 32):
                                                                                                                                v = 10
                                                                                                                                w = 1
                                                                                                                                u = mem[_607] - 2
                                                                                                                                while u > 1:
                                                                                                                        ...
                                                                                                                        if t >= ('cd', 68).length:
                                                                                                                            ...
                                                                                                                            if not ext_call.success:
                                                                                                                                ...
                                                                                                                                if mem[_666] < 2:
                                                                                                                                    ...
                                                                                                                                    if mem[_666] - 2:
                                                                                                                                        if not bool(mem[_666] - 2 < 78) and not bool(mem[_666] - 2 < 32):
                                                                                                                                            v = 10
                                                                                                                                            w = 1
                                                                                                                                            u = mem[_666] - 2
                                                                                                                                            while u > 1:
                                                                                                            ...
                                                                                                            if t >= ('cd', 68).length:
                                                                                                                ...
                                                                                                                if not ext_call.success:
                                                                                                                    ...
                                                                                                                    if mem[_529] < 2:
                                                                                                                        ...
                                                                                                                        if mem[_529] - 2:
                                                                                                                            if not bool(mem[_529] - 2 < 78) and not bool(mem[_529] - 2 < 32):
                                                                                                                                v = 10
                                                                                                                                w = 1
                                                                                                                                u = mem[_529] - 2
                                                                                                                                while u > 1:
                                                                                                                        ...
                                                                                                                        if t >= ('cd', 68).length:
                                                                                                                            ...
                                                                                                                            if not ext_call.success:
                                                                                                                                ...
                                                                                                                                if mem[_548] < 2:
                                                                                                                                    ...
                                                                                                                                    if mem[_548] - 2:
                                                                                                                                        if not bool(mem[_548] - 2 < 78) and not bool(mem[_548] - 2 < 32):
                                                                                                                                            v = 10
                                                                                                                                            w = 1
                                                                                                                                            u = mem[_548] - 2
                                                                                                                                            while u > 1:
                                                                                                    ...
                                                                                                    if t >= ('cd', 68).length:
                                                                                                        ...
                                                                                                        if not ext_call.success:
                                                                                                            ...
                                                                                                            if mem[_521] < 2:
                                                                                                                ...
                                                                                                                if mem[_521] - 2:
                                                                                                                    if not bool(mem[_521] - 2 < 78) and not bool(mem[_521] - 2 < 32):
                                                                                                                        v = 10
                                                                                                                        w = 1
                                                                                                                        u = mem[_521] - 2
                                                                                                                        while u > 1:
                                                                                                                ...
                                                                                                                if t >= ('cd', 68).length:
                                                                                                                    ...
                                                                                                                    if not ext_call.success:
                                                                                                                        ...
                                                                                                                        if mem[_544] < 2:
                                                                                                                            ...
                                                                                                                            if mem[_544] - 2:
                                                                                                                                if not bool(mem[_544] - 2 < 78) and not bool(mem[_544] - 2 < 32):
                                                                                                                                    v = 10
                                                                                                                                    w = 1
                                                                                                                                    u = mem[_544] - 2
                                                                                                                                    while u > 1:
                                ...
                                if 10^(mem[_154] - 1) > -1:
                                    ...
                                    if idx >= ('cd', 36).length:
                                        ...
                                        if not 10^(mem[_154] - 1):
                                            revert with 'NH{q', 18
                                        else:
                                            if cd[((32 * idx) + cd[36] + 36)] / 10^(mem[_154] - 1) < 2:
                                                revert with 'NH{q', 17
                                            else:
                                                if (cd[((32 * idx) + cd[36] + 36)] / 10^(mem[_154] - 1)) - 2 >= stor12.length:
                                                    revert with 'NH{q', 50
                                                else:
                                                    mem[0] = 12
                                                    if s >= ('cd', 4).length:
                                                        ...
                                                        if t >= ('cd', 68).length:
                                                            ...
                                                            mem[mem[64] + 4] = address(cd[((32 * s) + cd[4] + 36)])
                                                            mem[mem[64] + 36] = address(cd[((32 * t) + cd[68] + 36)])
                                                            require ext_code.size(stor12[(cd[((32 * idx) + cd[36] + 36)] / 10^(_155 - 1)) - 2].field_256)
                                                            staticcall stor12[(cd[((32 * idx) + cd[36] + 36)] / 10^(_155 - 1)) - 2].field_256.getPair(address arg1, address arg2) with:
                                                                    gas gas_remaining wei
                                                                   args address(cd[((32 * s) + cd[4] + 36)]), address(cd[((32 * t) + cd[68] + 36)])
                                                            mem[mem[64]] = ext_call.return_data[0]
                                                            if not ext_call.success:
                                                                        ...
                                                                        if t >= ('cd', 68).length:
                                                                            ...
                                                                            if not ext_call.success:
                                                                                ...
                                                                                if mem[_195] < 2:
                                                                                    ...
                                                                                    if mem[_195] - 2:
                                                                                        if not bool(mem[_195] - 2 < 78) and not bool(mem[_195] - 2 < 32):
                                                                                            v = 10
                                                                                            w = 1
                                                                                            u = mem[_195] - 2
                                                                                            while u > 1:
                                                                                                            ...
                                                                                                            if t >= ('cd', 68).length:
                                                                                                                ...
                                                                                                                if not ext_call.success:
                                                                                                                    ...
                                                                                                                    if mem[_245] < 2:
                                                                                                                        ...
                                                                                                                        if mem[_245] - 2:
                                                                                                                            if not bool(mem[_245] - 2 < 78) and not bool(mem[_245] - 2 < 32):
                                                                                                                                v = 10
                                                                                                                                w = 1
                                                                                                                                u = mem[_245] - 2
                                                                                                                                while u > 1:
                                                                                                                        ...
                                                                                                                        if t >= ('cd', 68).length:
                                                                                                                            ...
                                                                                                                            if not ext_call.success:
                                                                                                                                ...
                                                                                                                                if mem[_283] < 2:
                                                                                                                                    ...
                                                                                                                                    if mem[_283] - 2:
                                                                                                                                        if not bool(mem[_283] - 2 < 78) and not bool(mem[_283] - 2 < 32):
                                                                                                                                            v = 10
                                                                                                                                            w = 1
                                                                                                                                            u = mem[_283] - 2
                                                                                                                                            while u > 1:
                                                                                                            ...
                                                                                                            if t >= ('cd', 68).length:
                                                                                                                ...
                                                                                                                if not ext_call.success:
                                                                                                                    ...
                                                                                                                    if mem[_230] < 2:
                                                                                                                        ...
                                                                                                                        if mem[_230] - 2:
                                                                                                                            if not bool(mem[_230] - 2 < 78) and not bool(mem[_230] - 2 < 32):
                                                                                                                                v = 10
                                                                                                                                w = 1
                                                                                                                                u = mem[_230] - 2
                                                                                                                                while u > 1:
                                                                                                                        ...
                                                                                                                        if t >= ('cd', 68).length:
                                                                                                                            ...
                                                                                                                            if not ext_call.success:
                                                                                                                                ...
                                                                                                                                if mem[_268] < 2:
                                                                                                                                    ...
                                                                                                                                    if mem[_268] - 2:
                                                                                                                                        if not bool(mem[_268] - 2 < 78) and not bool(mem[_268] - 2 < 32):
                                                                                                                                            v = 10
                                                                                                                                            w = 1
                                                                                                                                            u = mem[_268] - 2
                                                                                                                                            while u > 1:
                                                                                                    ...
                                                                                                    if t >= ('cd', 68).length:
                                                                                                        ...
                                                                                                        if not ext_call.success:
                                                                                                            ...
                                                                                                            if mem[_219] < 2:
                                                                                                                ...
                                                                                                                if mem[_219] - 2:
                                                                                                                    if not bool(mem[_219] - 2 < 78) and not bool(mem[_219] - 2 < 32):
                                                                                                                        v = 10
                                                                                                                        w = 1
                                                                                                                        u = mem[_219] - 2
                                                                                                                        while u > 1:
                                                                                                                ...
                                                                                                                if t >= ('cd', 68).length:
                                                                                                                    ...
                                                                                                                    if not ext_call.success:
                                                                                                                        ...
                                                                                                                        if mem[_262] < 2:
                                                                                                                            ...
                                                                                                                            if mem[_262] - 2:
                                                                                                                                if not bool(mem[_262] - 2 < 78) and not bool(mem[_262] - 2 < 32):
                                                                                                                                    v = 10
                                                                                                                                    w = 1
                                                                                                                                    u = mem[_262] - 2
                                                                                                                                    while u > 1:
                            ...
                            if idx >= ('cd', 36).length:
                                ...
                                if cd[((32 * idx) + cd[36] + 36)] < 2:
                                    ...
                                    if cd[((32 * idx) + cd[36] + 36)] - 2 >= stor12.length:
                                        revert with 'NH{q', 50
                                    else:
                                        mem[0] = 12
                                        if s >= ('cd', 4).length:
                                            ...
                                            if t >= ('cd', 68).length:
                                                ...
                                                mem[mem[64] + 4] = address(cd[((32 * s) + cd[4] + 36)])
                                                mem[mem[64] + 36] = address(cd[((32 * t) + cd[68] + 36)])
                                                require ext_code.size(stor12[cd[((32 * idx) + cd[36] + 36)] - 2].field_256)
                                                staticcall stor12[cd[((32 * idx) + cd[36] + 36)] - 2].field_256.getPair(address arg1, address arg2) with:
                                                        gas gas_remaining wei
                                                       args address(cd[((32 * s) + cd[4] + 36)]), address(cd[((32 * t) + cd[68] + 36)])
                                                mem[mem[64]] = ext_call.return_data[0]
                                                if not ext_call.success:
                                                            ...
                                                            if t >= ('cd', 68).length:
                                                                ...
                                                                if not ext_call.success:
                                                                    ...
                                                                    if mem[_191] < 2:
                                                                        ...
                                                                        if mem[_191] - 2:
                                                                            if not bool(mem[_191] - 2 < 78) and not bool(mem[_191] - 2 < 32):
                                                                                v = 10
                                                                                w = 1
                                                                                u = mem[_191] - 2
                                                                                while u > 1:
                                                                                                ...
                                                                                                if t >= ('cd', 68).length:
                                                                                                    ...
                                                                                                    if not ext_call.success:
                                                                                                        ...
                                                                                                        if mem[_246] < 2:
                                                                                                            ...
                                                                                                            if mem[_246] - 2:
                                                                                                                if not bool(mem[_246] - 2 < 78) and not bool(mem[_246] - 2 < 32):
                                                                                                                    v = 10
                                                                                                                    w = 1
                                                                                                                    u = mem[_246] - 2
                                                                                                                    while u > 1:
                                                                                                            ...
                                                                                                            if t >= ('cd', 68).length:
                                                                                                                ...
                                                                                                                if not ext_call.success:
                                                                                                                    ...
                                                                                                                    if mem[_285] < 2:
                                                                                                                        ...
                                                                                                                        if mem[_285] - 2:
                                                                                                                            if not bool(mem[_285] - 2 < 78) and not bool(mem[_285] - 2 < 32):
                                                                                                                                v = 10
                                                                                                                                w = 1
                                                                                                                                u = mem[_285] - 2
                                                                                                                                while u > 1:
                                                                                                ...
                                                                                                if t >= ('cd', 68).length:
                                                                                                    ...
                                                                                                    if not ext_call.success:
                                                                                                        ...
                                                                                                        if mem[_220] < 2:
                                                                                                            ...
                                                                                                            if mem[_220] - 2:
                                                                                                                if not bool(mem[_220] - 2 < 78) and not bool(mem[_220] - 2 < 32):
                                                                                                                    v = 10
                                                                                                                    w = 1
                                                                                                                    u = mem[_220] - 2
                                                                                                                    while u > 1:
                                                                                                            ...
                                                                                                            if t >= ('cd', 68).length:
                                                                                                                ...
                                                                                                                if not ext_call.success:
                                                                                                                    ...
                                                                                                                    if mem[_263] < 2:
                                                                                                                        ...
                                                                                                                        if mem[_263] - 2:
                                                                                                                            if not bool(mem[_263] - 2 < 78) and not bool(mem[_263] - 2 < 32):
                                                                                                                                v = 10
                                                                                                                                w = 1
                                                                                                                                u = mem[_263] - 2
                                                                                                                                while u > 1:
                                                                                        ...
                                                                                        if t >= ('cd', 68).length:
                                                                                            ...
                                                                                            if not ext_call.success:
                                                                                                ...
                                                                                                if mem[_206] < 2:
                                                                                                    ...
                                                                                                    if mem[_206] - 2:
                                                                                                        if not bool(mem[_206] - 2 < 78) and not bool(mem[_206] - 2 < 32):
                                                                                                            v = 10
                                                                                                            w = 1
                                                                                                            u = mem[_206] - 2
                                                                                                            while u > 1:
                                                                                                    ...
                                                                                                    if t >= ('cd', 68).length:
                                                                                                        ...
                                                                                                        if not ext_call.success:
                                                                                                            ...
                                                                                                            if mem[_255] < 2:
                                                                                                                ...
                                                                                                                if mem[_255] - 2:
                                                                                                                    if not bool(mem[_255] - 2 < 78) and not bool(mem[_255] - 2 < 32):
                                                                                                                        v = 10
                                                                                                                        w = 1
                                                                                                                        u = mem[_255] - 2
                                                                                                                        while u > 1:
