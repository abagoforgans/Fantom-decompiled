...
function getContractBalance() {
    ...
    staticcall sub_8f125a2eAddress.balanceOf(address rg1) with:
    ...
    if endTime >= block.timestamp:
        if availableTokens:
            if saleActive:
                revert with 0, 'DUMBSeed: sale has not ended'
    require ext_code.size(sub_8f125a2eAddress)
    call sub_8f125a2eAddress.0xc4b53e74 with:
         gas gas_remaining wei
        args address(this.address), availableTokens
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function withdrawUSDC(address arg1, uint256 arg2) {
    ...
    staticcall USDCAddress.balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(USDCAddress)
    call USDCAddress.transfer(address rg1, uint256 rg2) with:
         gas gas_remaining wei
...
function buy(uint256 arg1) payable {
    ...
    call USDCAddress.approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args address(this.address), arg1 * saleInfo[address(msg.sender)].field_0 / uint16(stor12.field_16)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    if not ext_call.return_data[0]:
        revert with 0, 'DUMBSeed: sender must approve USDC'
    require ext_code.size(USDCAddress)
    call USDCAddress.transferFrom(address rg1, address rg2, uint256 rg3) with:
         gas gas_remaining wei
        args msg.sender, address(this.address), arg1 * saleInfo[address(msg.sender)].field_0 / uint16(stor12.field_16)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    if not ext_call.return_data[0]:
        revert with 0, 'DUMBSeed: buy failed'
...
function sub_e97d765a(?) {
    ...
    if 2016 * 24 * 3600 > -liquidityLaunch - 1:
        revert with 'NH{q', 17
    if block.timestamp <= liquidityLaunch + (2016 * 24 * 3600):
        if saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100 < saleInfo[address(msg.sender)].field_768:
            revert with 'NH{q', 17
        return ((saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) - saleInfo[address(msg.sender)].field_768)
    if block.timestamp < liquidityLaunch + (2016 * 24 * 3600):
        revert with 'NH{q', 17
    if 1 > -(block.timestamp + -liquidityLaunch - (2016 * 24 * 3600) / 168 * 24 * 3600) - 1:
        revert with 'NH{q', 17
    if (block.timestamp + -liquidityLaunch - (2016 * 24 * 3600) / 168 * 24 * 3600) + 1 and saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12 > -1 / (block.timestamp + -liquidityLaunch - (2016 * 24 * 3600) / 168 * 24 * 3600) + 1:
        revert with 'NH{q', 17
    if saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100 > -(saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) + (-1 * block.timestamp + -liquidityLaunch - (2016 * 24 * 3600) / 168 * 24 * 3600 * saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) - 1:
        revert with 'NH{q', 17
    if (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) + (saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) + (block.timestamp + -liquidityLaunch - (2016 * 24 * 3600) / 168 * 24 * 3600 * saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) < saleInfo[address(msg.sender)].field_768:
        revert with 'NH{q', 17
    return ((saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) + (saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) + (block.timestamp + -liquidityLaunch - (2016 * 24 * 3600) / 168 * 24 * 3600 * saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) - saleInfo[address(msg.sender)].field_768)
}
...
function sub_ebbb7213(?) {
    ...
    if liquidityLaunch <= endTime:
        ...
        if block.timestamp <= liquidityLaunch + (2016 * 24 * 3600):
            ...
            if (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) + (saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) + (block.timestamp + -liquidityLaunch - (2016 * 24 * 3600) / 168 * 24 * 3600 * saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) < saleInfo[address(msg.sender)].field_768:
                revert with 'NH{q', 17
            if (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) + (saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) + (block.timestamp + -liquidityLaunch - (2016 * 24 * 3600) / 168 * 24 * 3600 * saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) - saleInfo[address(msg.sender)].field_768 <= 0:
                revert with 0, 'DUMBSeed: no DUMB available'
            if arg1 <= 0:
                revert with 0, 'DUMBSeed: amount incorrect'
            if arg1 > (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) + (saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) + (block.timestamp + -liquidityLaunch - (2016 * 24 * 3600) / 168 * 24 * 3600 * saleInfo[address(msg.sender)].field_512 - (saleInfo[address(msg.sender)].field_512 * sub_3bf2f4ff / 100) / 12) - saleInfo[address(msg.sender)].field_768:
                revert with 0, 'DUMBSeed: amount incorrect'
    if saleInfo[address(msg.sender)].field_768 > -arg1 - 1:
        revert with 'NH{q', 17
    saleInfo[address(msg.sender)].field_768 += arg1
    require ext_code.size(sub_8f125a2eAddress)
    call sub_8f125a2eAddress.transfer(address rg1, uint256 rg2) with:
         gas gas_remaining wei
