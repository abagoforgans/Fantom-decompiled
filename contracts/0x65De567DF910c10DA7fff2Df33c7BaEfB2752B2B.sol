...
function sub_092213c8(?) payable {
    ...
    call address(cd[((32 * ('cd', 100).length - 1) + cd[100] + 36)]).approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args address(cd[68]), mem[ceil32(return_data.size) + 128]
    mem[(32 * _25) + ceil32(return_data.size) + 128] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require 0 < mem[ceil32(return_data.size) + 96]
    _57 = mem[ceil32(return_data.size) + 128]
    ...
    require 0 < mem[(32 * _25) + (2 * ceil32(return_data.size)) + 128]
    ...
    call address(cd[((32 * ('cd', 132).length - 1) + cd[132] + 36)]).transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args msg.sender, mem[(32 * _25) + (2 * ceil32(return_data.size)) + 160]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
