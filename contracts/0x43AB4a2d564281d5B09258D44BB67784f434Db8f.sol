...
function emergencyWithdraw(uint256 arg1) payable {
    ...
    if not userInfo[arg1][msg.sender]:
        ...
        require arg1 < poolInfo.length
        require ext_code.size(poolInfo[arg1].field_256)
        call poolInfo[arg1].field_256.withdraw(address rg1, uint256 rg2) with:
             gas gas_remaining wei
        ...
        if not ext_code.size(poolInfo[arg1].field_0):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, ext_call.return_data[0] * userInfo[arg1][msg.sender] / ext_call.return_data[0]) >> 32
        call poolInfo[arg1].field_0 with:
           funct uint32(msg.sender)
             gas gas_remaining wei
            args Mask(224, 32, ext_call.return_data[0] * userInfo[arg1][msg.sender] / ext_call.return_data[0]) << 224, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0] * userInfo[arg1][msg.sender] / ext_call.return_data[0]
            if not unknown_0xa9059cbb(?????), Mask(224, 32, msg.sender) >> 32:
                revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if return_data.size:
                ...
                if not mem[292]:
                    revert with 0, 
                                ...
                                0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                mem[ceil32(return_data.size) + 371 len 22]
        emit EmergencyWithdraw((ext_call.return_data[0] * userInfo[arg1][msg.sender] / ext_call.return_data[0]), msg.sender, arg1);
...
function deposit(uint256 arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(poolInfo[arg1].field_0):
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = approve(address rg1, uint256 rg2), poolInfo[arg1].field_256, poolInfo[arg1].field_256, Mask(224, 32, arg2 + ext_call.return_data[0]) >> 32
            call poolInfo[arg1].field_0 with:
               funct poolInfo[arg1].field_256
                 gas gas_remaining wei
                args Mask(224, 32, arg2 + ext_call.return_data[0]) << 224, mem[520 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg2
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0] + userInfo[arg1][msg.sender] < userInfo[arg1][msg.sender]:
                revert with 0, 'SafeMath: addition overflow'
            ...
            if not ext_code.size(poolInfo[arg1].field_0):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 457 len 64] = approve(address rg1, uint256 rg2), poolInfo[arg1].field_256, poolInfo[arg1].field_256, Mask(224, 32, arg2 + ext_call.return_data[0]) >> 32
            mem[ceil32(return_data.size) + 549 len 4] = 0
            call poolInfo[arg1].field_0 with:
               funct poolInfo[arg1].field_256
                 gas gas_remaining wei
                args Mask(224, 32, arg2 + ext_call.return_data[0]) << 224, mem[ceil32(return_data.size) + 521 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg2
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
    ...
    if not userInfo[arg1][msg.sender]:
        ...
        if -1 <= 0 / ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] >= -1:
                mem[260 len 64] = unknown_0xa9059cbb(?????), msg.sender, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                call poolInfo[arg1].field_0 with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    if not ext_call.success:
                        revert with unknown_0xa9059cbb(?????), msg.sender, -1
                    if not unknown_0xa9059cbb(?????), Mask(224, 32, msg.sender) >> 32:
                        revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                else:
                    mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
