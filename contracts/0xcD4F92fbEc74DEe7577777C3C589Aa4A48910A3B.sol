...
function deposit() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(cTokenAddress)
    call cTokenAddress.mint(uint256 rg1) with:
         gas gas_remaining wei
...
function aprAfterDeposit(uint256 arg1) payable {
    ...
    staticcall address(ext_call.return_data[0]).getSupplyRate(uint256 rg1, uint256 rg2, uint256 rg3, uint256 rg4) with:
            gas gas_remaining wei
...
function emergencyWithdraw(uint256 arg1) payable {
    ...
    if msg.sender == address(strategyAddress):
        mem[100] = arg1
        require ext_code.size(cTokenAddress)
        call cTokenAddress.redeemUnderlying(uint256 rg1) with:
             gas gas_remaining wei
            args arg1
...
function withdraw(uint256 arg1) payable {
    ...
    if msg.sender == address(strategyAddress):
        ...
        require ext_code.size(cTokenAddress)
        call cTokenAddress.balanceOfUnderlying(address rg1) with:
             gas gas_remaining wei
            args this.address
        mem[96] = ext_call.return_data[0]
        if not ext_call.success:
        ...
        if arg1 <= 2 * ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] >= 2 * ext_call.return_data[0]:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), 2 * ext_call.return_data[0], 0
                mem[(2 * ceil32(return_data.size)) + 328] = 0
                call wantAddress with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), 2 * ext_call.return_data[0], 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), 2 * ext_call.return_data[0], 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
        ...
        if msg.sender == ext_call.return_data[12 len 20]:
            ...
            if arg1 <= 2 * ext_call.return_data[0]:
                ...
                if ext_call.return_data[0] >= 2 * ext_call.return_data[0]:
                    mem[(4 * ceil32(return_data.size)) + 132] = address(strategyAddress)
                    mem[(4 * ceil32(return_data.size)) + 164] = 2 * ext_call.return_data[0]
                    mem[(4 * ceil32(return_data.size)) + 96] = 68
                    mem[(4 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 0, stor1)
                    mem[(4 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                    mem[(4 * ceil32(return_data.size)) + 196] = 32
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(4 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), 2 * ext_call.return_data[0], 0
                    mem[(4 * ceil32(return_data.size)) + 328] = 0
                    call wantAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), 2 * ext_call.return_data[0], 0) >> 224
                         gas gas_remaining wei
            ...
            if arg1 <= 2 * ext_call.return_data[0]:
                ...
                if ext_call.return_data[0] >= 2 * ext_call.return_data[0]:
                    mem[(6 * ceil32(return_data.size)) + 132] = address(strategyAddress)
                    mem[(6 * ceil32(return_data.size)) + 164] = 2 * ext_call.return_data[0]
                    mem[(6 * ceil32(return_data.size)) + 96] = 68
                    mem[(6 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 0, stor1)
                    mem[(6 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                    mem[(6 * ceil32(return_data.size)) + 196] = 32
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(6 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), 2 * ext_call.return_data[0], 0
                    mem[(6 * ceil32(return_data.size)) + 328] = 0
                    call wantAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), 2 * ext_call.return_data[0], 0) >> 224
                         gas gas_remaining wei
