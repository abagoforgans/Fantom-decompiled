...
const getName = 'StrategySpiritFtmLpV1'
...
function sub_29b5478a(?) {
    return sub_29b5478aAddress
}
...
function balanceOfPool() {
    require ext_code.size(sub_6a0f3a10Address)
    staticcall sub_6a0f3a10Address.userInfo(uint256 rg1, address rg2) with:
            gas gas_remaining wei
           args sub_57e2a520, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        require ext_code.size(sub_6a0f3a10Address)
        call sub_6a0f3a10Address.deposit(uint256 rg1, uint256 rg2) with:
             gas gas_remaining wei
...
function withdrawAll() {
    ...
    require return_data.size >= 64
    require ext_code.size(sub_6a0f3a10Address)
    call sub_6a0f3a10Address.withdraw(uint256 rg1, uint256 rg2) with:
         gas gas_remaining wei
        args sub_57e2a520, ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
