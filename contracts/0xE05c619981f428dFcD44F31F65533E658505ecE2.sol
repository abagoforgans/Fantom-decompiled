...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    staticcall 0xa48d959ae2e88f1daa7d5f611e01908106de7598.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function recoverStrangeTokens(address arg1) payable {
    ...
    if arg1 == rewardAddress:
        revert with 0, '!token'
    if arg1 == 0xa48d959ae2e88f1daa7d5f611e01908106de7598:
        revert with 0, '!token'
...
function unpause() payable {
    ...
    require ext_code.size(0xa48d959ae2e88f1daa7d5f611e01908106de7598)
    staticcall 0xa48d959ae2e88f1daa7d5f611e01908106de7598.allowance(address arg1, address arg2) with:
            gas gas_remaining wei
    ...
    call 0xa48d959ae2e88f1daa7d5f611e01908106de7598.0xe126ace0 with:
         gas gas_remaining wei
        args Mask(480, -256, approve(address arg1, uint256 arg2), 0x2352b745561e7e6fcd03c093, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
        ...
        if not approve(address arg1, uint256 arg2), 0x2352b745561e7e6fcd03c093:
            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        require ext_code.size(0x841fad6eae12c286d1fd18d1d525dffa75c7effe)
        staticcall 0x841fad6eae12c286d1fd18d1d525dffa75c7effe.allowance(address arg1, address arg2) with:
                gas gas_remaining wei
        ...
        if ext_code.size(0x841fad6eae12c286d1fd18d1d525dffa75c7effe) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = 0, 0xa48d959ae2e88f1daa7d5f611e01908106de7598, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        if not return_data.size:
            ...
            staticcall rewardAddress.allowance(address arg1, address arg2) with:
                    gas gas_remaining wei
            ...
            if ext_code.size(rewardAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = approve(address arg1, uint256 arg2), 0xf491e7b69e4244ad4002bc14, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            ...
            if ext_code.size(rewardAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 589 len 64] = approve(address arg1, uint256 arg2), 0xf491e7b69e4244ad4002bc14, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            mem[ceil32(return_data.size) + 653 len 0] = 0
            call rewardAddress.0x7e38c29 with:
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), 0xf491e7b69e4244ad4002bc14, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 653 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address arg1, uint256 arg2), 0x2352b745561e7e6fcd03c093, 0, -1
                if not approve(address arg1, uint256 arg2), 0x2352b745561e7e6fcd03c093:
        ...
        if return_data.size <= 0:
            ...
            if ext_code.size(0x841fad6eae12c286d1fd18d1d525dffa75c7effe) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = 0, 0xa48d959ae2e88f1daa7d5f611e01908106de7598, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call 0x841fad6eae12c286d1fd18d1d525dffa75c7effe.0x6de7598 with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if ext_code.size(rewardAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 590 len 64] = approve(address arg1, uint256 arg2), 0xf491e7b69e4244ad4002bc14, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[(2 * ceil32(return_data.size)) + 654 len 0] = 0
                call rewardAddress.0x7e38c29 with:
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address arg1, uint256 arg2), 0xf491e7b69e4244ad4002bc14, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[(2 * ceil32(return_data.size)) + 654 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address arg1, uint256 arg2), 0x2352b745561e7e6fcd03c093, 0, -1
                    if not approve(address arg1, uint256 arg2), 0x2352b745561e7e6fcd03c093:
