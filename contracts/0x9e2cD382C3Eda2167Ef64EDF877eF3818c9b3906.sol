...
function setRoyalties(uint256 arg1, address arg2, uint256 arg3) payable {
    ...
    royaltyInfo[arg1].field_0 = arg2
    royaltyInfo[arg1].field_160 = arg3 % 16777216
}
...
function sub_af131f50(?) payable {
    ...
    if stor16[arg1].field_0:
        if stor16[arg1].field_0 == stor16[arg1].field_1 < 32:
            revert with 'NH{q', 34
        if arg4.length:
            stor16[arg1][].field_0 = Array(len=arg4.length, data=arg4[all])
        else:
            stor16[arg1].field_0 = 0
            idx = 0
            while stor16[arg1].field_1 + 31 / 32 > idx:
    ...
    if arg3 > 10000:
        revert with 0, 'ERC2981Royalties: Too high'
    royaltyInfo[arg1].field_0 = owner
    royaltyInfo[arg1].field_160 = arg3 % 16777216
}
