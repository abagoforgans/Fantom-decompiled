...
function sub_d6a4249e(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            ...
            mem[mem[64]] = 12
            mem[64] = mem[64] + 416
            mem[_199 + 32 len 384] = call.data[calldata.size len 384]
            if idx >= mem[96]:
                revert with 'NH{q', 50
            if 0 >= mem[_199]:
                revert with 'NH{q', 50
            mem[_199 + 32] = mem[(32 * idx) + 128]
            if idx >= mem[96]:
                revert with 'NH{q', 50
            require ext_code.size(stor2)
            staticcall stor2.summoner(uint256 arg1) with:
                    gas gas_remaining wei
                   args mem[(32 * idx) + 128]
            mem[_199 + 416 len 128] = ext_call.return_data[0 len 128]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[64] = _199 + ceil32(return_data.size) + 416
            ...
            if 4 >= mem[_199]:
                revert with 'NH{q', 50
            mem[_199 + 160] = ext_call.return_data[96]
            mem[_199 + 128] = ext_call.return_data[64]
            mem[_199 + 96] = ext_call.return_data[32]
            mem[_199 + 64] = ext_call.return_data[0]
            if idx >= mem[96]:
                revert with 'NH{q', 50
            require ext_code.size(stor5)
            staticcall stor5.ability_scores(uint256 arg1) with:
                    gas gas_remaining wei
                   args mem[(32 * idx) + 128]
            mem[_199 + ceil32(return_data.size) + 416 len 192] = ext_call.return_data[0 len 192]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[64] = _199 + (2 * ceil32(return_data.size)) + 416
            ...
            if 10 >= mem[_199]:
                revert with 'NH{q', 50
            mem[_199 + 352] = ext_call.return_data[188 len 4]
            mem[_199 + 320] = ext_call.return_data[156 len 4]
            mem[_199 + 288] = ext_call.return_data[124 len 4]
            mem[_199 + 256] = ext_call.return_data[92 len 4]
            mem[_199 + 224] = ext_call.return_data[60 len 4]
            mem[_199 + 192] = ext_call.return_data[28 len 4]
            if idx >= mem[96]:
                revert with 'NH{q', 50
            _277 = mem[(32 * idx) + 128]
            mem[_199 + (2 * ceil32(return_data.size)) + 420] = mem[(32 * idx) + 128]
            require ext_code.size(stor4)
            staticcall stor4.adventurers_log(uint256 arg1) with:
                    gas gas_remaining wei
                   args _277
            mem[_199 + (2 * ceil32(return_data.size)) + 416] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[64] = _199 + (4 * ceil32(return_data.size)) + 416
            require return_data.size >= 32
            require ext_call.return_data[0] == ext_call.return_data[0]
            if 11 >= mem[_199]:
                revert with 'NH{q', 50
            mem[_199 + 384] = ext_call.return_data[0]
            if idx >= mem[floor32(('cd', 4).length) + 97]:
                revert with 'NH{q', 50
            mem[(32 * idx) + floor32(('cd', 4).length) + 129] = _199
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            continue 
        _198 = mem[64]
        mem[mem[64]] = 32
        _201 = mem[floor32(('cd', 4).length) + 97]
        mem[mem[64] + 32] = mem[floor32(('cd', 4).length) + 97]
        idx = 0
        s = floor32(('cd', 4).length) + 129
        t = mem[64] + (32 * _201) + 64
        ...
        while idx < ('cd', 4).length:
            ...
            mem[mem[64]] = 12
            mem[64] = mem[64] + 416
            mem[_296 + 32 len 384] = call.data[calldata.size len 384]
            if idx >= mem[96]:
                revert with 'NH{q', 50
            if 0 >= mem[_296]:
                revert with 'NH{q', 50
            ...
            staticcall stor2.summoner(uint256 arg1) with:
                    gas gas_remaining wei
                   args mem[(32 * idx) + 128]
            mem[_296 + 416 len 128] = ext_call.return_data[0 len 128]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[64] = _296 + ceil32(return_data.size) + 416
            require return_data.size >= 128
            require ext_call.return_data[0] == ext_call.return_data[0]
            require ext_call.return_data[32] == ext_call.return_data[32]
            require ext_call.return_data[64] == ext_call.return_data[64]
            ...
            staticcall stor5.ability_scores(uint256 arg1) with:
                    gas gas_remaining wei
                   args mem[(32 * idx) + 128]
            mem[_296 + ceil32(return_data.size) + 416 len 192] = ext_call.return_data[0 len 192]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            if idx >= mem[96]:
                revert with 'NH{q', 50
            _339 = mem[(32 * idx) + 128]
            mem[_296 + (2 * ceil32(return_data.size)) + 420] = mem[(32 * idx) + 128]
            require ext_code.size(stor4)
            staticcall stor4.adventurers_log(uint256 arg1) with:
                    gas gas_remaining wei
                   args _339
            mem[_296 + (2 * ceil32(return_data.size)) + 416] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            if idx >= mem[floor32(('cd', 4).length) + 97]:
                revert with 'NH{q', 50
            mem[(32 * idx) + floor32(('cd', 4).length) + 129] = _296
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            continue 
        _295 = mem[64]
        mem[mem[64]] = 32
        _300 = mem[floor32(('cd', 4).length) + 97]
        mem[mem[64] + 32] = mem[floor32(('cd', 4).length) + 97]
        idx = 0
        s = floor32(('cd', 4).length) + 129
        t = mem[64] + (32 * _300) + 64
