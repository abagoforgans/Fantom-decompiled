...
function pause() payable {
    ...
    if return_data.size <= 0:
        ...
        if ext_code.size(lpToken0Address) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + 590 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), 0
        mem[(2 * ceil32(return_data.size)) + 654 len 0] = 0
        call lpToken0Address with:
           funct uint32(stor6)
             gas gas_remaining wei
            args Mask(480, -256, approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), 0) << 256, mem[(2 * ceil32(return_data.size)) + 654 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address rg1, uint256 rg2), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), 0
            if not approve(address rg1, uint256 rg2), Mask(224, 0, stor7.field_0):
