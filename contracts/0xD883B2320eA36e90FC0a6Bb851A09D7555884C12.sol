...
function safeMint(address arg1) {
    ...
    if tokenByIndex.length >= maxSupply:
        revert with 0, 'Not enough SGC remain'
    if not arg1:
...
function baseURI() {
    if bool(stor18.length):
        ...
        if ceil32(uint255(stor18.length.field_1)) > uint255(stor18.length.field_1):
            mem[ceil32(uint255(stor18.length.field_1)) + uint255(stor18.length.field_1) + 192] = 0
    ...
    if ceil32(stor18.length.field_1 % 128) > stor18.length.field_1 % 128:
        mem[ceil32(stor18.length.field_1 % 128) + stor18.length.field_1 % 128 + 192] = 0
...
function batchSetTokenURI(uint256[] arg1, string[] arg2) {
    ...
    while idx < arg2.length:
        ...
        mem[_39] = cd[(arg2 + cd[s] + 36)]
        require arg2 + cd[s] + cd[(arg2 + cd[s] + 36)] + 68 <= calldata.size
        mem[_39 + 32 len cd[(arg2 + cd[s] + 36)]] = call.data[arg2 + cd[s] + 68 len cd[(arg2 + cd[s] + 36)]]
        mem[_39 + cd[(arg2 + cd[s] + 36)] + 32] = 0
        mem[t] = _39
        idx = idx + 1
        s = s + 32
        t = t + 32
    ...
    while idx < mem[96]:
        ...
        mem[32] = 10
        _58 = mem[mem[(32 * idx) + floor32(arg1.length) + 129]]
        if bool(stor10[mem[(32 * idx) + 128]].field_0):
            if bool(stor10[mem[(32 * idx) + 128]].field_0) == uint255(stor10[mem[(32 * idx) + 128]].field_1) < 32:
                revert with 'NH{q', 34
            mem[0] = sha3(mem[(32 * idx) + 128], 10)
            if not _58:
                stor10[mem[(32 * idx) + 128]].field_0 = 0
                s = sha3(sha3(mem[(32 * idx) + 128], 10))
                while sha3(sha3(mem[(32 * idx) + 128], 10)) + (uint255(stor10[mem[(32 * idx) + 128]].field_1) + 31 / 32) > s:
                    stor[s] = 0
                    s = s + 1
                    continue 
            else:
                ...
                while mem[(32 * idx) + floor32(arg1.length) + 129] + _58 + 32 > t:
                    stor[s] = mem[t]
                    s = s + 1
                    t = t + 32
                    continue 
...
function mintNFT(uint256 arg1) payable {
    ...
    if arg1 > maxBuy:
        revert with 0, 'Mint amount over limit'
    if block.timestamp < startTime:
        revert with 0, 'Minting not started'
    idx = 0
    while idx < arg1:
        if tokenByIndex.length >= maxSupply:
            revert with 0, 'Not enough SGC remain'
