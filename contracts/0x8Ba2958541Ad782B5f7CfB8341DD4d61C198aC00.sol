...
function sub_b1c0c6e8(?) payable {
    ...
    require return_data.size + 192 > mem[192 len 4], 232830643 + 223
...
function sub_43be1230(?) payable {
    ...
    require ceil32(return_data.size) + return_data.size + 288 > ceil32(return_data.size) + mem[ceil32(return_data.size) + 288 len 4], 232830643 + 319
