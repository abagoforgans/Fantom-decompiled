...
function sub_80746d34(?) payable {
    return sub_80746d34Address
}
...
function paymentManager() payable {
...
function tokenURI(uint256 arg1) payable {
    ...
    require arg1 == arg1
    return 32, 80, 
           0xfe68747470733a2f2f676174657761792e70696e6174612e636c6f75642f697066732f516d536b4e727147784c4359516d675a4c37446a6a3933646a774c395262613950747238474e47775174374847, mem[208 len 16] >> 384,
           0
}
...
function sub_3c396497(?) payable {
    if not uint8(stor19.field_160):
        revert with 0, 'Diamonds are not mintable yet.'
    mem[100] = msg.sender
    require ext_code.size(sub_80746d34Address)
    staticcall sub_80746d34Address.0x70a08231 with:
    ...
    while idx < ext_call.return_data[0]:
        ...
        mem[mem[64] + 36] = idx
        require ext_code.size(sub_80746d34Address)
        staticcall sub_80746d34Address.0x2f745c59 with:
                gas gas_remaining wei
               args msg.sender, idx
