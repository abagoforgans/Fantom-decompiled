...
const NATIVE = 0x998d334b051d1f1d94361d6170677deb6e13d989
...
function getMultiplier(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0x998d334b051d1f1d94361d6170677deb6e13d989)
    staticcall 0x998d334b051d1f1d94361d6170677deb6e13d989.0x18160ddd with:
...
function add(uint256 arg1, address arg2, address arg3) payable {
    ...
    if block.number > 16357300:
        poolInfo[poolInfo.length].field_512 = block.number
    else:
        poolInfo[poolInfo.length].field_512 = 16357300
...
function inCaseTokensGetStuck(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 == 0x998d334b051d1f1d94361d6170677deb6e13d989:
        revert with 0, '!safe'
                ...
                if block.number - poolInfo[arg1].field_512 > 0:
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not 0 / totalAllocPoint:
                            require ext_code.size(0x998d334b051d1f1d94361d6170677deb6e13d989)
                            call 0x998d334b051d1f1d94361d6170677deb6e13d989.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 0
                        else:
