...
function enact() payable {
    ...
    require ext_code.size(tokenAddress)
    call tokenAddress.withdraw(uint256 arg1) with:
         gas gas_remaining wei
        args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(vaultAddress)
    call vaultAddress.depositBNB() with:
...
function retire(address arg1, address arg2) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if ext_call.return_data[0] > balance:
            mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), Mask(224, 0, stor3.field_32)
            mem[324 len 0] = 0
            call tokenAddress with:
               funct uint32(stor0)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), balance
                ...
                if ext_call.return_data[0]:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_call.return_data[0]:
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[588 len 64] = unknown_0xa9059cbb(?????), address(arg2) << 64, 0, 0
                            mem[652 len 0] = 0
                            call tokenAddress with:
                                 gas gas_remaining wei
                                args Mask(480, -256, unknown_0xa9059cbb(?????), address(arg2) << 64, 0, 0) << 256, mem[652 len 4]
                        else:
                            if 8 * ext_call.return_data[0] / ext_call.return_data[0] != 8:
                                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[525 len 31]
                            if eth.balance(this.address) < 0:
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[588 len 64] = unknown_0xa9059cbb(?????), address(arg2) << 64, 0, Mask(224, 32, 8 * ext_call.return_data[0] / 100) >> 32
                            mem[652 len 0] = 0
                            call tokenAddress with:
                                 gas gas_remaining wei
                        ...
                        if not ext_call.return_data[0]:
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 589 len 64] = unknown_0xa9059cbb(?????), address(arg2) << 64, 0, 0
                            mem[ceil32(return_data.size) + 653 len 0] = 0
                            call tokenAddress with:
                                 gas gas_remaining wei
                                args Mask(480, -256, unknown_0xa9059cbb(?????), address(arg2) << 64, 0, 0) << 256, mem[ceil32(return_data.size) + 653 len 4]
                        else:
                            if 8 * ext_call.return_data[0] / ext_call.return_data[0] != 8:
                                revert with 0, 
                                            32,
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 589 len 64] = unknown_0xa9059cbb(?????), address(arg2) << 64, 0, Mask(224, 32, 8 * ext_call.return_data[0] / 100) >> 32
                            mem[ceil32(return_data.size) + 653 len 0] = 0
                            call tokenAddress with:
                                 gas gas_remaining wei
                        ...
                        if not return_data.size:
                            ...
                            if not return_data.size:
                                if not ext_call.return_data[0]:
                                    ...
                                    if not ext_code.size(tokenAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[(2 * ceil32(return_data.size)) + 590 len 64] = unknown_0xa9059cbb(?????), address(arg2) << 64, 0, 0
                                    mem[(2 * ceil32(return_data.size)) + 654 len 0] = 0
                                    call tokenAddress with:
                                         gas gas_remaining wei
                                        args Mask(480, -256, unknown_0xa9059cbb(?????), address(arg2) << 64, 0, 0) << 256, mem[(2 * ceil32(return_data.size)) + 654 len 4]
                                else:
                                    if 8 * ext_call.return_data[0] / ext_call.return_data[0] != 8:
                                        revert with 0, 
                                                    32,
                                    ...
                                    if not ext_code.size(tokenAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[(2 * ceil32(return_data.size)) + 590 len 64] = unknown_0xa9059cbb(?????), address(arg2) << 64, 0, Mask(224, 32, 8 * ext_call.return_data[0] / 100) >> 32
                                    mem[(2 * ceil32(return_data.size)) + 654 len 0] = 0
                                    call tokenAddress with:
                                         gas gas_remaining wei
