...
function sub_18be87c2(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if not sub_0ea8956d[address(arg1)]:
        return 0
    ...
    require ext_code.size(sub_0ea8956d[address(arg1)])
    staticcall sub_0ea8956d[address(arg1)].quote(address arg1, uint256 arg2, address arg3, uint256 arg4) with:
            gas gas_remaining wei
           args address(ext_call.return_data[0]), 1, 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83, 2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if 10^18 * 10^(-uint8(ext_call.return_data[0]) + 18) * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] != 10^(-uint8(ext_call.return_data[0]) + 18):
        revert with 0, 'multiplication overflow', 0
    return (10^18 * 10^(-uint8(ext_call.return_data[0]) + 18) * ext_call.return_data[0])
}
