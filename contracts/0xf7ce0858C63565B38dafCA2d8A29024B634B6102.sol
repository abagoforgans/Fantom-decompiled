...
function sub_35c793ab(?) payable {
    ...
    return 32, 8433, code.data[7055 len 8369], mem[8497 len 15] >> 66696, address(arg1), address(arg2), 0 >> 67208, 0
}
...
function deploy(address arg1, address arg2) payable {
    ...
    if feeds[address(arg1)]:
        revert with 0, 'PE'
    mem[8640 len 8384] = code.data[7055 len 8369], mem[8497 len 15]
    mem[17009 len 64] = address(arg1), arg2
    mem[17105] = address(arg1)
    mem[17073] = 20
