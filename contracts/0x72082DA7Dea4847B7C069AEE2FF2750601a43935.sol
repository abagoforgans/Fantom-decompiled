...
function balanceOfPool() payable {
    ...
    staticcall 0x30b65159db82efcf8cede9861bc6b85336310eb2.0x93f1a40b with:
            gas gas_remaining wei
...
function deposit(uint256 arg1) payable {
    ...
    if arg1 > 0:
        require ext_code.size(0x30b65159db82efcf8cede9861bc6b85336310eb2)
        call 0x30b65159db82efcf8cede9861bc6b85336310eb2.0xe2bbb158 with:
             gas gas_remaining wei
            args poolId, arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] < arg1:
        ...
        require ext_code.size(0x30b65159db82efcf8cede9861bc6b85336310eb2)
        call 0x30b65159db82efcf8cede9861bc6b85336310eb2.0x441a3e70 with:
             gas gas_remaining wei
...
function panic() payable {
    ...
    if not return_data.size:
        ...
        require ext_code.size(0x30b65159db82efcf8cede9861bc6b85336310eb2)
        call 0x30b65159db82efcf8cede9861bc6b85336310eb2.0x5312ea8e with:
             gas gas_remaining wei
            args poolId
    else:
        mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
