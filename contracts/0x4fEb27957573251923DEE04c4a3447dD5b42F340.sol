...
function sub_9dd8aad5(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        call stor3.configureReserveAsCollateral(address arg1, uint256 arg2, uint256 arg3, uint256 arg4) with:
        ...
        if cd[((224 * idx) + cd[4] + 228)]:
            ...
            require ext_code.size(stor3)
            call stor3.enableBorrowingOnReserve(address arg1, bool arg2) with:
                 gas gas_remaining wei
        ...
        require ext_code.size(stor3)
        call stor3.setReserveFactor(address arg1, uint256 arg2) with:
             gas gas_remaining wei
