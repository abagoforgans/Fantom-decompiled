            ...
            if not return_data.size:
                ...
                if return_data.size <= 0:
                    ...
                    call wantAddress with:
                       funct uint32(stor7)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 489 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), 0
                        if not approve(address arg1, uint256 arg2), Mask(224, 0, stor7):
...
function unpause() payable {
    ...
    if ext_code.size(wantAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    call wantAddress with:
       funct uint32(stor6)
         gas gas_remaining wei
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), -1
        ...
        call wrappedAddress with:
           funct uint32(stor6)
             gas gas_remaining wei
            args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[488 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), -1
            if not approve(address arg1, uint256 arg2), Mask(224, 0, stor6):
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - (0 / WITHDRAWAL_MAX)) >> 32
                    mem[452 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1) >> 32
                call wantAddress with:
                   funct uint32(stor13)
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    if not ext_call.success:
                        revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), arg1
                    if not unknown_0xa9059cbb(?????), Mask(224, 0, stor13):
                        revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                else:
                    mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1 - (0 / WITHDRAWAL_MAX)) >> 32
                    mem[452 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), ext_call.return_data[0 len 28]
                mem[388 len 0] = 0
                call wantAddress with:
                   funct uint32(stor13)
                     gas gas_remaining wei
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1) >> 32
                mem[388 len 0] = 0
                call wantAddress with:
                   funct uint32(stor13)
                     gas gas_remaining wei
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1 - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
            ...
            if return_data.size <= 0:
                ...
                if not return_data.size:
                    ...
                    if not stor21.length:
                        ...
                        call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args arg4, 0, 160, address(this.address), block.timestamp + 600, stor21.length, mem[(2 * ceil32(return_data.size)) + 686 len 32 * stor21.length]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
...
function sub_675994d6(?) payable {
    ...
    if arg5 == 3:
        ...
        while outputToWantRoute.length > idx:
            ...
            continue 
        address(stor10) = arg4
        mem[260] = address(stor10)
        mem[292] = 0
        mem[224] = 68
        mem[260 len 28] = Mask(224, 0, stor10)
        mem[256 len 4] = approve(address arg1, uint256 arg2)
        mem[324] = 32
        mem[356] = 'SafeERC20: low-level call failed'
        if ext_code.size(wrappedAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[388 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0
        mem[480 len 4] = 0
        mem[452 len 0] = 0
        call wrappedAddress with:
           funct uint32(stor10)
             gas gas_remaining wei
            args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0) << 256, mem[452 len 4]
        if not return_data.size:
            if not ext_call.success:
                if wrappedAddress > 0:
                    revert with memory
            ...
            staticcall wrappedAddress.0xdd62ed3e with:
                    gas gas_remaining wei
                   args address(this.address), address(stor10)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0]:
            ...
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[552 len 64] = 0, address(stor10), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            mem[644 len 4] = 0
            call wrappedAddress with:
               funct uint32(stor10)
                 gas gas_remaining wei
            ...
            if return_data.size <= 0:
                ...
                mem[ceil32(return_data.size) + 425] = address(stor10)
                ...
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 553 len 64] = 0, address(stor10), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        if arg5 != 2:
            ...
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[324 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0
            mem[416 len 4] = 0
            mem[388 len 0] = 0
            call wrappedAddress with:
               funct uint32(stor10)
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0) << 256, mem[388 len 4]
            if not return_data.size:
                if not ext_call.success:
                    if wrappedAddress > 0:
                        revert with memory
                ...
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[488 len 64] = 0, address(stor10), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[580 len 4] = 0
                call wrappedAddress with:
                   funct uint32(stor10)
                     gas gas_remaining wei
                ...
                if return_data.size <= 0:
                    ...
                    mem[ceil32(return_data.size) + 361] = address(stor10)
                    ...
                    if ext_code.size(wrappedAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 489 len 64] = 0, address(stor10), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            ...
            while outputToWantRoute.length > idx:
                ...
                continue 
            address(stor10) = arg4
            mem[228] = address(stor10)
            mem[260] = 0
            mem[192] = 68
            mem[228 len 28] = Mask(224, 0, stor10)
            ...
            if not return_data.size:
                ...
                if wrappedAddress <= 0:
                    ...
                    if ext_code.size(wrappedAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[520 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                    mem[612 len 4] = 0
                    mem[584 len 0] = 0
                    call wrappedAddress with:
                       funct uint32(stor10)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[584 len 4]
                else:
                    require wrappedAddress >= 32
                    if not arg1:
                ...
                if return_data.size <= 0:
                    ...
                    mem[ceil32(return_data.size) + 393] = address(stor10)
                    ...
                    if ext_code.size(wrappedAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 521 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                    ...
                    call wrappedAddress with:
                       funct uint32(stor10)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 585 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            if wrappedAddress > 0:
                                revert with memory
