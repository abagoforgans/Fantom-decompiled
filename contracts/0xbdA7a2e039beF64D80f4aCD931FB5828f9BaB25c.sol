    ...
    if tokenFeeAddress != supraAddress:
        if not return_data.size:
            ...
            if ext_code.size(tokenFeeAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[488 len 96] = 0, msg.sender, treasureAddress, stor13
            mem[612 len 4] = 0
            ...
            if ext_code.size(tokenFeeAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 489 len 96] = 0, msg.sender, treasureAddress, stor13
        ...
        if not return_data.size:
            ...
            if ext_code.size(supraAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = 0, treasureAddress, stor13
            call supraAddress with:
               funct uint32(stor15.field_0)
                 gas gas_remaining wei
            ...
            if ext_code.size(supraAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 457 len 64] = 0, treasureAddress, stor13
            call supraAddress with:
               funct uint32(stor15.field_0)
                 gas gas_remaining wei
