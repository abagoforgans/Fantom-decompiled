            ...
            if tx.origin == owner:
                ...
                if stor0:
                    ...
                    if not arg1:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1 - (WITHDRAW_FEE * arg1 / 10000)) >> 32
                        mem[352 len 4] = 0
                        mem[324 len 0] = 0
                        call wantAddress with:
                           funct uint32(stor4)
                        ...
                        if not return_data.size:
                            if not ext_call.success:
                                revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), arg1 - (WITHDRAW_FEE * arg1 / 10000)
                            if not unknown_0xa9059cbb(?????), Mask(224, 0, stor4):
                                revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                            if not stor0:
                                require ext_code.size(wantAddress)
            ...
            if tx.origin == owner:
                ...
                if stor0:
                    ...
                    if not arg1:
                        ...
                        if not return_data.size:
                            if not ext_call.success:
                                revert with unknown_0xa9059cbb(?????), address(vaultAddress), arg1 - (WITHDRAW_FEE * arg1 / 10000)
                            if not uint32(this.address), Mask(224, 0, stor4):
                                revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                            if not stor0:
                                require ext_code.size(wantAddress)
