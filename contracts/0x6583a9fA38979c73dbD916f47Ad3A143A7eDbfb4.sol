...
#
const devAddress = 0x1109c5bb8abb99ca3bbeff6e60f5d3794f4e0473
...
function depositAll() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_code.size(address(ext_call.return_data[0])):
            revert with 0, 'Address: call to non-contract'
        mem[292 len 96] = unknown_0x23b872dd(?????), msg.sender, 0x1109c5bb8abb99ca3bbeff6e60f5d3794f4e0473, 0
        mem[416 len 4] = 0
        call address(ext_call.return_data[0]).0x4f4e0473 with:
             gas gas_remaining wei
            args 0, mem[388 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with unknown_0x23b872dd(?????), msg.sender, 0x1109c5bb8abb99ca3bbeff6e60f5d3794f4e0473, 0
        ...
        if not ext_code.size(address(ext_call.return_data[0])):
            revert with 0, 'Address: call to non-contract'
        mem[292 len 96] = unknown_0x23b872dd(?????), msg.sender, 0x1109c5bb8abb99ca3bbeff6e60f5d3794f4e0473, Mask(224, 32, sub_54747a70 * ext_call.return_data[0] / 10000) >> 32
        mem[416 len 4] = 0
        mem[388 len 0] = 0
        call address(ext_call.return_data[0]).0x4f4e0473 with:
             gas gas_remaining wei
