...
#
const startBlock = 20752561

const ownerNATIVEReward = 1111

const NATIVEMaxSupply = 1690420 * 10^18

const NATIVE = 0xdab6fbe1c944ddd665b3cf6167d08a2b8907ef79


address owner;
uint256 stor1;
uint256 nATIVEPerBlock;
uint256 sub_de699743;
...
function sub_a75646fd(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 > poolInfo.length:
        revert with 0, 'pid too high'
    sub_de699743 = arg1
}
...
function getMultiplier(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0xdab6fbe1c944ddd665b3cf6167d08a2b8907ef79)
    staticcall 0xdab6fbe1c944ddd665b3cf6167d08a2b8907ef79.0x18160ddd with:
...
function add(uint256 arg1, address arg2, address arg3) payable {
    ...
    if block.number > 20752561:
        poolInfo[poolInfo.length].field_512 = block.number
    else:
        poolInfo[poolInfo.length].field_512 = 20752561
...
function inCaseTokensGetStuck(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 == 0xdab6fbe1c944ddd665b3cf6167d08a2b8907ef79:
        revert with 0, '!safe'
                ...
                if block.number - poolInfo[arg1].field_512 > 0:
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not 0 / totalAllocPoint:
                            require ext_code.size(0xdab6fbe1c944ddd665b3cf6167d08a2b8907ef79)
                            call 0xdab6fbe1c944ddd665b3cf6167d08a2b8907ef79.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 0
                        else:
