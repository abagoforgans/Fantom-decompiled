...
const sub_327e4ce8(?) = (480 * 24 * 3600)

const COMMUNITY_FUND_POOL_ALLOCATION = 1750 * 10^18

const VESTING_DURATION = (8760 * 24 * 3600)

const DEV_FUND_POOL_ALLOCATION = 1750 * 10^18

const FARMING_POOL_REWARD_ALLOCATION = 17500 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    stor15 = 1
    if totalSupply + 17500 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 17500 * 10^18
    if balanceOf[address(arg1)] + 17500 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 17500 * 10^18
    emit Transfer(17500 * 10^18, 0, arg1);
}
