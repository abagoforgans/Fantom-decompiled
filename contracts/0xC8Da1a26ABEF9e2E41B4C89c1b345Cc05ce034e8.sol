...
function unlock() payable {
    ...
    if totalSupply > -500000000000000001:
        revert with 0, 17
    totalSupply += 5 * 10^17
    if balanceOf[address(msg.sender)] > -500000000000000001:
        revert with 0, 17
    balanceOf[address(msg.sender)] += 5 * 10^17
    emit 0xfeddf252: 5 * 10^17, 0, msg.sender
