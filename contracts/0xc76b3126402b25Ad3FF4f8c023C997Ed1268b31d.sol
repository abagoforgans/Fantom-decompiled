...
const name = 'White Claudia'

const decimals = 8

const symbol = 'CLAUDIA1'
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if totalSupply - (2 * arg2 / 20) < 10^16:
        ...
        if frozenOf[address(msg.sender)].field_0:
            ...
            frozenOf[address(arg1)].field_256 = frozenOf[address(arg1)].field_256 + arg2 - (2 * arg2 / 20)
            emit Transfer((arg2 - (2 * arg2 / 20)), msg.sender, arg1);
            if 2 * arg2 / 20 > 0:
                if totalFrozen <= 0:
                    totalSupply -= 2 * arg2 / 20
                    emit Transfer((2 * arg2 / 20), msg.sender, 0);
                    emit Burn((2 * arg2 / 20));
                else:
                    require totalFrozen
                    stor3 += Mask(192, 1, 2 * arg2 / 20) << 63 / totalFrozen
                    emit Transfer((2 * arg2 / 20 / 2), msg.sender, this.address);
                    totalSupply -= 2 * arg2 / 20 / 2
                    emit Transfer((2 * arg2 / 20 / 2), msg.sender, 0);
                    emit Burn((2 * arg2 / 20 / 2));
    return 1
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if totalSupply - (2 * arg3 / 20) < 10^16:
        ...
        if frozenOf[address(arg1)].field_0:
            ...
            frozenOf[address(arg2)].field_256 = frozenOf[address(arg2)].field_256 + arg3 - (2 * arg3 / 20)
            emit Transfer((arg3 - (2 * arg3 / 20)), arg1, arg2);
            if 2 * arg3 / 20 > 0:
                if totalFrozen <= 0:
                    totalSupply -= 2 * arg3 / 20
                    emit Transfer((2 * arg3 / 20), arg1, 0);
                    emit Burn((2 * arg3 / 20));
                else:
                    require totalFrozen
                    stor3 += Mask(192, 1, 2 * arg3 / 20) << 63 / totalFrozen
                    emit Transfer((2 * arg3 / 20 / 2), arg1, this.address);
                    totalSupply -= 2 * arg3 / 20 / 2
                    emit Transfer((2 * arg3 / 20 / 2), arg1, 0);
                    emit Burn((2 * arg3 / 20 / 2));
    return 1
}
...
function bulkTransfer(address[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 2
        if totalSupply - (2 * cd[((32 * idx) + arg2 + 36)] / 20) < 10^16:
            ...
            if frozenOf[address(msg.sender)].field_0:
                ...
                frozenOf[address(cd[((32 * idx) + arg1 + 36)])].field_256 = frozenOf[address(cd[((32 * idx) + arg1 + 36)])].field_256 + cd[((32 * idx) + arg2 + 36)] - (2 * cd[((32 * idx) + arg2 + 36)] / 20)
                mem[96] = cd[((32 * idx) + arg2 + 36)] - (2 * cd[((32 * idx) + arg2 + 36)] / 20)
                emit Transfer((cd[((32 * idx) + arg2 + 36)] - (2 * cd[((32 * idx) + arg2 + 36)] / 20)), msg.sender, address(cd[((32 * idx) + arg1 + 36)]));
                if 2 * cd[((32 * idx) + arg2 + 36)] / 20 > 0:
                    if totalFrozen <= 0:
                        totalSupply -= 2 * cd[((32 * idx) + arg2 + 36)] / 20
                        emit Transfer((2 * cd[((32 * idx) + arg2 + 36)] / 20), msg.sender, 0);
                        mem[96] = 2 * cd[((32 * idx) + arg2 + 36)] / 20
                        emit Burn((2 * cd[((32 * idx) + arg2 + 36)] / 20));
                    else:
                        require totalFrozen
                        stor3 += Mask(192, 1, 2 * cd[((32 * idx) + arg2 + 36)] / 20) << 63 / totalFrozen
                        emit Transfer((2 * cd[((32 * idx) + arg2 + 36)] / 20 / 2), msg.sender, this.address);
                        totalSupply -= 2 * cd[((32 * idx) + arg2 + 36)] / 20 / 2
                        emit Transfer((2 * cd[((32 * idx) + arg2 + 36)] / 20 / 2), msg.sender, 0);
                        mem[96] = 2 * cd[((32 * idx) + arg2 + 36)] / 20 / 2
                        emit Burn((2 * cd[((32 * idx) + arg2 + 36)] / 20 / 2));
        idx = idx + 1
        continue 
}
    ...
    if totalSupply - (2 * arg2 / 20) < 10^16:
        ...
        if frozenOf[address(msg.sender)].field_0:
            ...
            if uint32(ext_code.size(arg1)) > 0:
                ...
                call arg1.tokenCallback(address arg1, uint256 arg2, bytes arg3) with:
                     gas gas_remaining wei
                    args 0, uint32(msg.sender), arg2 - (2 * arg2 / 20), 96, arg3.length, arg3[all], mem[arg3.length + 228 len ceil32(arg3.length) - arg3.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0]
