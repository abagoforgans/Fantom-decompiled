...
function setConverter(address arg1, address arg2, address arg3) payable {
    ...
    converters[address(arg1)][address(arg2)] = arg3
}
...
function withdraw(address arg1, uint256 arg2) payable {
    ...
    if vaults[address(arg1)] != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(strategies[address(arg1)])
    call strategies[address(arg1)].withdraw(uint256 arg1) with:
         gas gas_remaining wei
        args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function earn(address arg1, uint256 arg2) payable {
    ...
    if not ext_code.hash(arg1):
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = transfer(address arg1, uint256 arg2), 0x961ec604086a2a116b4a05e4, 0, Mask(224, 32, arg2) >> 32
    mem[324 len 0] = 0
    call arg1.0xe734977e with:
         gas gas_remaining wei
        args Mask(224, 32, arg2) << 224, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with transfer(address arg1, uint256 arg2), 0x961ec604086a2a116b4a05e4, 0, arg2
        if not transfer(address arg1, uint256 arg2), 0x961ec604086a2a116b4a05e4:
