...
function getBorrowRateFor(address arg1) {
    ...
    if ext_call.return_data[0] > 0x44b82fa09b5a52cb98b405447c4a98187eebb22f008d5d64f9c394ae9:
        revert with 0, 17
    if 10^9 * ext_call.return_data[0] and 584 * 3600 > -1 / 10^9 * ext_call.return_data[0]:
        revert with 0, 17
    return (584 * 10^9 * 3600 * ext_call.return_data[0])
}
...
function deposit(address arg1, uint256 arg2) payable {
    ...
    mem[(2 * ceil32(return_data.size)) + 160] = _6634
