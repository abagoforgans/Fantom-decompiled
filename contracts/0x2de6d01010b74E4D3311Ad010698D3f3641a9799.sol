...
function balanceOfPool() payable {
    require ext_code.size(address(masterchefAddress))
    staticcall address(masterchefAddress).balanceOfStake() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function unpause() payable {
    ...
    if not return_data.size:
        ...
        if ext_call.return_data[0]:
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[488 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), ext_call.return_data[0 len 28]
            call wantAddress with:
               funct uint32(stor18)
                 gas gas_remaining wei
        ...
        if ext_call.return_data[0]:
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 489 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), ext_call.return_data[0 len 28]
            call wantAddress with:
               funct uint32(stor18)
                 gas gas_remaining wei
