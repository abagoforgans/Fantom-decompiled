...
function payRake(uint256 arg1) payable {
    ...
    if not 10^18 * arg1:
        ...
        if ext_code.size(0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, 0 / divisor) >> 32
        mem[388 len 0] = 0
        call 0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb with:
           funct uint32(stor3)
             gas gas_remaining wei
        ...
        if ext_code.size(0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, 10^18 * arg1 * devFee / divisor) >> 32
        mem[388 len 0] = 0
        call 0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb with:
           funct uint32(stor3)
             gas gas_remaining wei
    ...
    if not 10^18 * arg1:
        ...
        if ext_code.size(0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 553 len 64] = 0, address(treasuryAddress), Mask(224, 32, 0 / divisor) >> 32
        call 0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb with:
           funct uint32(stor4)
             gas gas_remaining wei
            args 0 / divisor, 0, mem[ceil32(return_data.size) + 617 len 4]
    else:
        require 10^18 * arg1
        ...
        if ext_code.size(0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 553 len 64] = 0, address(treasuryAddress), Mask(224, 32, 10^18 * arg1 * lpFee / divisor) >> 32
        call 0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb with:
           funct uint32(stor4)
             gas gas_remaining wei
            args 10^18 * arg1 * lpFee / divisor, 0, mem[ceil32(return_data.size) + 617 len 4]
    if not return_data.size:
        require not ext_call.success
        revert with 'SafeMath: division by zero'
    ...
    if not 10^18 * arg1:
        ...
        if ext_code.size(0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + 782 len 64] = 0, address(deadAddress), Mask(224, 32, 0 / divisor) >> 32
        call 0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb with:
           funct uint32(stor5)
             gas gas_remaining wei
            args 0 / divisor, mem[(2 * ceil32(return_data.size)) + 718 len 28], mem[(2 * ceil32(return_data.size)) + 846 len 4]
    else:
        require 10^18 * arg1
        ...
        if ext_code.size(0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + 782 len 64] = 0, address(deadAddress), Mask(224, 32, 10^18 * arg1 * burnFee / divisor) >> 32
        call 0x117db78176c8ede4f12fcd29d85cd96b91a4cbbb with:
           funct uint32(stor5)
             gas gas_remaining wei
            args 10^18 * arg1 * burnFee / divisor, mem[(2 * ceil32(return_data.size)) + 718 len 28], mem[(2 * ceil32(return_data.size)) + 846 len 4]
    if not return_data.size:
        require not ext_call.success
        revert with 'SafeMath: division by zero'
