...
function COIN() payable {
    require ext_code.size(0xffe2dadbbd172e3efe1a33fca8de77f11a472f)
    delegate 0xffe2dadbbd172e3efe1a33fca8de77f11a472f.WETH() with:
...
function factory() payable {
    require ext_code.size(0xffe2dadbbd172e3efe1a33fca8de77f11a472f)
    delegate 0xffe2dadbbd172e3efe1a33fca8de77f11a472f.0xc45a0155 with:
         gas gas_remaining wei
        args 
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function hasPool(address arg1) payable {
    ...
    require ext_code.size(0xffe2dadbbd172e3efe1a33fca8de77f11a472f)
    delegate 0xffe2dadbbd172e3efe1a33fca8de77f11a472f.0x1246dbf5 with:
         gas gas_remaining wei
        args arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getReserves(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0xffe2dadbbd172e3efe1a33fca8de77f11a472f)
    delegate 0xffe2dadbbd172e3efe1a33fca8de77f11a472f.0x3e99c1e4 with:
         gas gas_remaining wei
        args arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function coinQuote(address arg1, uint256 arg2) payable {
    ...
    require ext_code.size(0xffe2dadbbd172e3efe1a33fca8de77f11a472f)
    delegate 0xffe2dadbbd172e3efe1a33fca8de77f11a472f.ethQuote(address rg1, uint256 rg2) with:
         gas gas_remaining wei
...
function pairFor(address arg1, address arg2) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(0xffe2dadbbd172e3efe1a33fca8de77f11a472f)
    delegate 0xffe2dadbbd172e3efe1a33fca8de77f11a472f.pairFor(address rg1, address rg2, address rg3) with:
         gas gas_remaining wei
...
function getPair(address arg1, address arg2) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(0xffe2dadbbd172e3efe1a33fca8de77f11a472f)
    delegate 0xffe2dadbbd172e3efe1a33fca8de77f11a472f.getPair(address rg1, address rg2, address rg3) with:
         gas gas_remaining wei
        args address(delegate.return_data[0]), address(arg1), arg2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getPathForCoinToToken(address arg1) payable {
    ...
    mem[100] = arg1
    require ext_code.size(0xffe2dadbbd172e3efe1a33fca8de77f11a472f)
    delegate 0xffe2dadbbd172e3efe1a33fca8de77f11a472f.getPathForETHToToken(address rg1) with:
         gas gas_remaining wei
        args arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
