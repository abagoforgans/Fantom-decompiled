...
function updateInfo() payable {
    ...
    if sub_d373b52e.length:
        ...
        if not sub_44951130.length:
            ...
            sub_d373b52e.length++
            sub_d373b52e[sub_d373b52e.length].field_0 = mem[var69002 + 12 len 20]
            require var69004 < sub_d373b52e.length
            mem[0] = 3
            ...
            require return_data.size >= 160
            sub_d373b52e.length++
            sub_d373b52e[sub_d373b52e.length].field_0 = mem[var73002 + 12 len 20]
            require var73004 < sub_d373b52e.length
            mem[0] = 3
            mem[96] = 0x70a0823100000000000000000000000000000000000000000000000000000000
            mem[100] = chefAddress
        ...
        if sub_44951130.length:
            ...
            require return_data.size >= 160
            sub_d373b52e.length++
            sub_d373b52e[sub_d373b52e.length].field_0 = mem[var66002 + 12 len 20]
            require var66004 < sub_d373b52e.length
            mem[0] = 3
            mem[96] = 0x70a0823100000000000000000000000000000000000000000000000000000000
            mem[100] = chefAddress
            ...
            if ext_call.success:
                ...
                if ext_call.success:
                    require return_data.size >= 160
                    sub_d373b52e.length++
                    sub_d373b52e[sub_d373b52e.length].field_0 = mem[var62002 + 12 len 20]
                    require var62004 < sub_d373b52e.length
                    mem[0] = 3
                    mem[96] = 0x70a0823100000000000000000000000000000000000000000000000000000000
                    mem[100] = chefAddress
                        ...
                        if ext_call.success:
                            ...
                            if ext_call.success:
                                ...
                                while ext_call.success:
                                    ...
                                    require x + 1 < sub_d373b52e.length
                                    mem[0] = 3
                                    require ext_code.size(sub_d373b52e[x].field_256)
                                    staticcall sub_d373b52e[x].field_256.0x70a08231 with:
                                            gas gas_remaining wei
                                           args chefAddress
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    require return_data.size >= 32
                                    require ext_code.size(sub_d373b52e[x].field_256)
                                    staticcall sub_d373b52e[x].field_256.getReserves() with:
                                            gas gas_remaining wei
                                    ...
                                    require return_data.size >= 96
                                    require ext_code.size(sub_d373b52e[x].field_256)
                                    staticcall sub_d373b52e[x].field_256.0x18160ddd with:
                                            gas gas_remaining wei
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    require return_data.size >= 32
                                    require ext_call.return_data[0]
                                    require ext_code.size(sub_d373b52e[x].field_512)
                                    staticcall sub_d373b52e[x].field_512.0x18160ddd with:
                                            gas gas_remaining wei
                                    mem[96] = ext_call.return_data[0]
                                    s = 96
