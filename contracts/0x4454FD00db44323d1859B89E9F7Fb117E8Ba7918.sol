...
function getAssetPrice(address arg1) payable {
    ...
    mem[64] = ceil32(stor4[address(arg1)].length) + ceil32(return_data.size) + 128
    require return_data.size >= 32
    ...
    mem[ceil32(stor4[address(arg1)].length) + ceil32(return_data.size) + 128] = _515
        ...
        if ceil32(_515) <= _515:
            if not bool(stor2.length):
                ...
                if bool(stor2.length) != 1:
                    ...
                    staticcall stor1.getReferenceData(string arg1, string arg2) with:
                            gas gas_remaining wei
                           args Array(len=_515, data=mem[mem[64] + 100 len ceil32(_515) + ceil32(stor2.length.field_1) + 32]), ceil32(_515) + 96
                    mem[mem[64] len 96] = ext_call.return_data[0 len 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1449 = mem[64]
