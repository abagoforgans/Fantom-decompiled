        ...
        if ext_call.return_data[12 len 20] == stor1:
            ...
            if address(ext_call.return_data[0]) == stor1:
                ...
                if mem[_508]:
                    if msg.value < msg.value / 2:
                        revert with 'NH{q', 17
                    mem[mem[64] + 36] = mem[(32 * _132 - 1) + (4 * ceil32(return_data.size)) + 224]
                    mem[mem[64] + 68] = 0
                    mem[mem[64] + 100] = 0
                    mem[mem[64] + 132] = msg.sender
                    mem[mem[64] + 164] = block.timestamp
                    ...
                    call arg2.addLiquidityETH(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
                       value msg.value - (msg.value / 2) wei
                         gas gas_remaining wei
                        args address(ext_call.return_data[0]), mem[mem[64] + 36], 0, 0, msg.sender, block.timestamp
                    mem[mem[64] len 96] = ext_call.return_data[0 len 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _561 = mem[64]
                    ...
                    if not return_data.size:
                        ...
                        call arg2.addLiquidityETH(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
                           value msg.value - (msg.value / 2) wei
                             gas gas_remaining wei
                            args address(ext_call.return_data[0]), mem[(32 * _132 - 1) + (4 * ceil32(return_data.size)) + 224], 0, 0, msg.sender, block.timestamp
                    else:
            ...
            if mem[_1545]:
                ...
                if not return_data.size:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        mem[_1556 + (2 * ceil32(return_data.size)) + 232] = 42 * 10^18
                        ...
                        if ext_code.size(address(ext_call.return_data[0])) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[_1556 + (2 * ceil32(return_data.size)) + 328 len 96] = 0, address(arg2), 42 * 10^18, 0
                        mem[_1556 + (2 * ceil32(return_data.size)) + 396] = 0
                        call address(ext_call.return_data[0]) with:
                           funct Mask(32, 224, 0, address(arg2), 42 * 10^18, 0) >> 224
                             gas gas_remaining wei
                            args (Mask(512, -288, 0, address(arg2), 42 * 10^18, 0) << 288)
                        if not return_data.size:
                            if not ext_call.success:
                                if mem[96] > 0:
                                    revert with memory
                    ...
                    if ext_call.return_data[0]:
                        ...
                        mem[_1556 + ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 233] = 42 * 10^18
                        ...
                        if ext_code.size(address(ext_call.return_data[0])) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[_1556 + ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 329 len 96] = 0, address(arg2), 42 * 10^18, 0
