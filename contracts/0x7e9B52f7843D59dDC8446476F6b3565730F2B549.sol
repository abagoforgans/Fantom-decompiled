...
const rewardPool = 0xe5045fe6e0ff68c4ffd9e11edad489f45f1d36cb
...
function notify() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, 0xe5045fe6e0ff68c4ffd9e11edad489f45f1d36cb, ext_call.return_data[0 len 28]
            call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0x5f1d36cb with:
                 gas gas_remaining wei
            ...
            if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = 0, 0xe5045fe6e0ff68c4ffd9e11edad489f45f1d36cb, ext_call.return_data[0 len 28]
            call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0x5f1d36cb with:
                 gas gas_remaining wei
        ...
        require ext_code.size(0xe5045fe6e0ff68c4ffd9e11edad489f45f1d36cb)
        call 0xe5045fe6e0ff68c4ffd9e11edad489f45f1d36cb.0x3c6b16ab with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = unknown_0xa9059cbb(?????), 0xe5045fe6e0ff68c4ffd9e11e, 0, Mask(224, 32, ext_call.return_data[0] - (5 * ext_call.return_data[0] / 1000)) >> 32
            call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0x5f1d36cb with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = unknown_0xa9059cbb(?????), 0xe5045fe6e0ff68c4ffd9e11e, 0, Mask(224, 32, ext_call.return_data[0] - (5 * ext_call.return_data[0] / 1000)) >> 32
