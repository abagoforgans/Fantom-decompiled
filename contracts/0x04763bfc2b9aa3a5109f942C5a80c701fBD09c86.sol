...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    call address(_26).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3, 1, Array(len=cd[(arg5 + cd[(arg5 + 36)] + 36)], data=call.data[arg5 + cd[(arg5 + 36)] + 68 len floor32(cd[(arg5 + cd[(arg5 + 36)] + 36)])], mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + floor32(cd[(arg5 + cd[(arg5 + 36)] + 36)]) + 356 len (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) - floor32(cd[(arg5 + cd[(arg5 + 36)] + 36)])]), address(this.address), block.timestamp + 1200
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    _88 = mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 160 len 4], Mask(224, 32, arg3) >> 32
    ...
    _91 = mem[_88 + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 160]
    mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len floor32(mem[_88 + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 160])] = mem[_88 + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 192 len floor32(mem[_88 + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 160])]
    require 1 < cd[(arg5 + cd[(arg5 + 36)] + 36)]
    require ext_code.size(mem[172 len 20])
    staticcall mem[172 len 20].0x70a08231 with:
            gas gas_remaining wei
           args this.address
    mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require 1 < cd[(arg5 + cd[(arg5 + 36)] + 36)]
    ...
    require return_data.size >= 32
    require 1 < cd[(arg5 + cd[(arg5 + 68)] + 36)]
    _164 = mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + 192]
    require 1 < cd[(arg5 + cd[(arg5 + 36)] + 36)]
    require 0 < cd[(arg5 + cd[(arg5 + 36)] + 36)]
    ...
    mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 196] = arg3
    mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 228] = 1
    mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 292] = this.address
    mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 324] = block.timestamp + 1200
    mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 260] = 160
    mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 356] = cd[(arg5 + cd[(arg5 + 36)] + 36)]
    mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 388 len floor32(cd[(arg5 + cd[(arg5 + 36)] + 36)])] = mem[128 len floor32(cd[(arg5 + cd[(arg5 + 36)] + 36)])]
    require ext_code.size(address(_164))
    call address(_164).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3, 1, Array(len=cd[(arg5 + cd[(arg5 + 36)] + 36)], data=mem[128 len floor32(cd[(arg5 + cd[(arg5 + 36)] + 36)])], mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + floor32(cd[(arg5 + cd[(arg5 + 36)] + 36)]) + 388 len (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) - floor32(cd[(arg5 + cd[(arg5 + 36)] + 36)])]), address(this.address), block.timestamp + 1200
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (2 * ceil32(return_data.size)) + 192
    require return_data.size >= 32
    require mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 <= 4294967296
    require mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 + 32 <= return_data.size
    require mem[mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 + (32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192] <= 4294967296 and mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 + (32 * mem[mem[(32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3) >> 32 + (32 * _91) + (32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + ceil32(return_data.size) + 192]) + 32 <= return_data.size
    require ext_code.size(arg2)
