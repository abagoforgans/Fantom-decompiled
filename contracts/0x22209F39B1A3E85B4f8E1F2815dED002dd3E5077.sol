...
function updateBalance() payable {
    ...
    call address(stor29).balanceOfUnderlying(address arg1) with:
...
function farm() payable {
    ...
    if ext_code.size(wantAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor29), uint32(stor29), Mask(224, 31, ext_call.return_data[0]) >> 31
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor29), uint32(stor29), 2 * ext_call.return_data[0]
        if not approve(address arg1, uint256 arg2), Mask(224, 0, stor29):
            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
    else:
        mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
        ...
        if return_data.size > 0:
            ...
            if not mem[292]:
                revert with 0, 
                            ...
                            mem[ceil32(return_data.size) + 371 len 22]
    require ext_code.size(address(stor29))
    call address(stor29).mint(uint256 arg1) with:
         gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if wantLockedTotal <= 0:
            ...
            if not isAutoComp:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[456 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor29), uint32(stor29), Mask(224, 31, ext_call.return_data[0]) >> 31
                mem[520 len 0] = 0
                call wantAddress with:
                   funct uint32(stor29)
                     gas gas_remaining wei
        ...
        if not arg2:
            ...
            if not isAutoComp:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[584 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor29), uint32(stor29), Mask(224, 31, ext_call.return_data[0]) >> 31
                mem[648 len 0] = 0
                call wantAddress with:
                   funct uint32(stor29)
                     gas gas_remaining wei
        ...
        if return_data.size <= 0:
            if wantLockedTotal <= 0:
                ...
                if not isAutoComp:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 457 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor29), uint32(stor29), Mask(224, 31, ext_call.return_data[0]) >> 31
            ...
            if not arg2:
                ...
                if not isAutoComp:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 585 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor29), uint32(stor29), Mask(224, 31, ext_call.return_data[0]) >> 31
                ...
                if not isAutoComp:
                    ...
                    if wantLockedTotal >= arg2:
                        if not arg2:
                            ...
                            require ext_code.size(address(stor29))
                            call address(stor29).redeemUnderlying(uint256 arg1) with:
                                 gas gas_remaining wei
                                args arg2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
