        ...
        if not -withdrawFeeFactor + 10000:
            if not arg2:
                ...
                call wantAddress with:
                   funct uint32(stor14)
                     gas gas_remaining wei
                    args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor14), uint32(stor14), 0) << 256, mem[644 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 'SafeMath: division by zero'
                    ...
                    if not uint8(stor2.field_16):
                        ...
                        if 0 <= ext_call.return_data[0]:
                            if wantLockedTotal >= 0:
                                ...
                                if not ext_code.size(wantAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 809 len 64] = 0, address(sub_88f9e800Address), 0
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                                ...
                                if not ext_code.size(wantAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 809 len 64] = 0, address(sub_88f9e800Address), Mask(224, 0, stor16.field_32)
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                            ...
                            if wantLockedTotal >= ext_call.return_data[0]:
                                ...
                                if not ext_code.size(wantAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 809 len 64] = 0, address(sub_88f9e800Address), ext_call.return_data[0 len 28]
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                    ...
                    if not uint8(stor2.field_16):
                        ...
                        if withdrawFeeFactor * arg2 / 10000 <= ext_call.return_data[0]:
                            if wantLockedTotal >= withdrawFeeFactor * arg2 / 10000:
                                ...
                                if not ext_code.size(wantAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 809 len 64] = 0, address(sub_88f9e800Address), Mask(224, 32, withdrawFeeFactor * arg2 / 10000) >> 32
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                                    args withdrawFeeFactor * arg2 / 10000, mem[ceil32(return_data.size) + 745 len 28], mem[ceil32(return_data.size) + 873 len 4]
                                if not return_data.size:
                                    require not ext_call.success
                                    revert with 'SafeMath: division by zero'
                                mem[ceil32(return_data.size) + 841 len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not uint8(stor2.field_16):
                ...
                if not uint8(stor2.field_8):
                    ...
                    if withdrawFeeFactor * arg2 / 10000 <= ext_call.return_data[0]:
                        ...
                        stor1 = 1
                        return (sharesTotal * arg2 / wantLockedTotal)
                ('gt', ('div', ('mul', ('stor', ('name', 'withdrawFeeFactor', 22)), ('param', 'arg2')), 10000), ('ext_call.return_data', 0, 32))
                if wantLockedTotal >= ext_call.return_data[0]:
                    if ext_call.return_data[0] > wantLockedTotal:
                        revert with 0, 'SafeMath: subtraction overflow'
                    wantLockedTotal -= ext_call.return_data[0]
