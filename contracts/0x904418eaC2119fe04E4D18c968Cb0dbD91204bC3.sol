...
function mint(address arg1, string arg2) payable {
    ...
    if arg1:
        if arg1:
            ...
            tokenOfOwnerByIndex[address(arg1)][stor3[address(arg1)]] = currentTokenId
            stor9[stor12] = balanceOf[address(arg1)]
    else:
    ...
    ownerOf[stor12] = arg1
    emit Transfer(0, arg1, currentTokenId);
    ...
    if stor6[stor12].field_0:
        if stor6[stor12].field_0 == stor6[stor12].field_1 < 32:
            revert with 0, 34
        if arg2.length:
            stor6[stor12][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
        ...
        if arg2.length:
            ...
            while stor6[stor12].field_1 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
    mem[ceil32(arg2.length) + 128] = currentTokenId
    ...
    if not arg1:
        ...
        if arg1 != arg2:
            ...
            if balanceOf[address(arg1)] - 1 != stor9[arg3]:
                tokenOfOwnerByIndex[address(arg1)][stor9[arg3]] = tokenOfOwnerByIndex[address(arg1)][stor3[address(arg1)] - 1]
                stor9[stor8[address(arg1)][stor3[address(arg1)] - 1]] = stor9[arg3]
            stor9[arg3] = 0
