...
function sub_aecdaffa(?) payable {
    return sub_aecdaffa[arg1][0 len sub_aecdaffa[arg1].length]
}
...
function sub_dcbf9002(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        sub_aecdaffa[address(cd[((32 * idx) + cd[4] + 36)])] = (2 * cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)]) + 1
        ...
        while cd[36] + cd[(cd[36] + (32 * idx) + 36)] + cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)] + 68 > t:
            ...
            continue 
        t = s
        while sha3(sha3(address(cd[((32 * idx) + cd[4] + 36)]), 6)) + (sub_aecdaffa[address(cd[((32 * idx) + cd[4] + 36)])].length + 31 / 32) > t:
            stor[t] = 0
            t = t + 1
            continue 
        require idx < ('cd', 4).length
