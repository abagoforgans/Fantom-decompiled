...
function balanceOfPool() payable {
    ...
    staticcall sub_b55b335fAddress.0x70a08231 with:
...
function sub_d9bb7701(?) payable {
    ...
    staticcall sub_5035f273Address.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function retireStrat() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(sub_5035f273Address)
    call sub_5035f273Address.0xa9059cbb with:
         gas gas_remaining wei
