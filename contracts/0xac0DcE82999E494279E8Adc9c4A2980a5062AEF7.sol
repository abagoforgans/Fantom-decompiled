                    ...
                    if not block.number - poolInfo[idx].field_512:
                        ...
                        if not block.number - poolInfo[idx].field_512:
                            ...
                            if not (block.number * tokenPerBlock) - (poolInfo[idx].field_512 * tokenPerBlock):
                                ...
                                call tokenAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args devAddress, (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                mem[96] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
                                mem[100] = this.address
                                mem[132] = (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint
                                require ext_code.size(tokenAddress)
                                call tokenAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args this.address, (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                                    ...
                                    if ext_call.return_data[0] <= 0:
                                        revert with 0, 'SafeMath: division by zero'
                                    require ext_call.return_data[0]
                                    if (10^12 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[idx].field_768 += 10^12 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not (block.number * tokenPerBlock) - (poolInfo[arg1].field_512 * tokenPerBlock):
                            ...
                            call tokenAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devAddress, (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(tokenAddress)
                            call tokenAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args this.address, (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                ...
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if (10^12 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
...
function updateEmissionRate(uint256 arg1) payable {
    ...
    while idx < poolInfo.length:
        ...
        idx = idx + 1
        continue 
    emit EmissionRateUpdated(tokenPerBlock, arg1, msg.sender);
    tokenPerBlock = arg1
}
