...
#
const startBlock = 21037567

const ownerNATIVEReward = 1111

const NATIVEMaxSupply = 6647051 * 10^18

const NATIVE = 0xdb5ad0d8c8ace03609596165c748b6986ce79767


address owner;
uint256 stor1;
uint256 nATIVEPerBlock;
address sub_2015deecAddress;
...
function sub_2015deec(?) payable {
    return sub_2015deecAddress
}
...
function sub_0db8b1a0(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_2015deecAddress = arg1
}

function sub_62214f16(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 >= nATIVEPerBlock:
        revert with 0, 'New value must be lower'
    nATIVEPerBlock = arg1
}
...
function getMultiplier(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0xdb5ad0d8c8ace03609596165c748b6986ce79767)
    staticcall 0xdb5ad0d8c8ace03609596165c748b6986ce79767.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] >= 6647051 * 10^18:
        return 0
    if arg1 > arg2:
        revert with 0, 'SafeMath: subtraction overflow'
    return (arg2 - arg1)
...
function add(uint256 arg1, address arg2, address arg3) payable {
    ...
    if block.number > 21037567:
        poolInfo[poolInfo.length].field_512 = block.number
    else:
        poolInfo[poolInfo.length].field_512 = 21037567
...
function inCaseTokensGetStuck(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 == 0xdb5ad0d8c8ace03609596165c748b6986ce79767:
        revert with 0, '!safe'
                ...
                if block.number - poolInfo[arg1].field_512 > 0:
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not 0 / totalAllocPoint:
                            require ext_code.size(0xdb5ad0d8c8ace03609596165c748b6986ce79767)
                            call 0xdb5ad0d8c8ace03609596165c748b6986ce79767.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 0
                        else:
                        ...
                        if not (block.number * nATIVEPerBlock) - (poolInfo[arg1].field_512 * nATIVEPerBlock):
                            ...
                            require (block.number * nATIVEPerBlock) - (poolInfo[arg1].field_512 * nATIVEPerBlock)
                            ...
                            if not (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                ...
                                require (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                if 1111 * (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 1111:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                                require ext_code.size(0xdb5ad0d8c8ace03609596165c748b6986ce79767)
                                call 0xdb5ad0d8c8ace03609596165c748b6986ce79767.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args owner, 1111 * (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10000
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(0xdb5ad0d8c8ace03609596165c748b6986ce79767)
                            call 0xdb5ad0d8c8ace03609596165c748b6986ce79767.0x40c10f19 with:
                                 gas gas_remaining wei
                                args address(this.address), (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                if ext_call.return_data[0] <= 0:
                                ...
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (10^12 * (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
...
function pendingNATIVE(uint256 arg1, address arg2) payable {
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * nATIVEPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * nATIVEPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
