        ...
        if 10000 <= withdrawFeeFactor:
            ...
            if arg2 <= ext_call.return_data[0]:
                if wantLockedTotal >= arg2:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 0, stor13.field_32)
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor10)
                         gas gas_remaining wei
            ...
            if not arg2:
                ...
                if 0 <= ext_call.return_data[0]:
                    if wantLockedTotal >= 0:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 0, stor13.field_32)
                        mem[580 len 0] = 0
                        call wantAddress with:
                           funct uint32(stor10)
                             gas gas_remaining wei
                ...
                if withdrawFeeFactor * arg2 / 10000 <= ext_call.return_data[0]:
                    if wantLockedTotal >= withdrawFeeFactor * arg2 / 10000:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, withdrawFeeFactor * arg2 / 10000) >> 32
                        mem[580 len 0] = 0
                        call wantAddress with:
                           funct uint32(stor10)
                             gas gas_remaining wei
