...
function sub_9c170452(?) payable {
    ...
    call rewardToken1Address with:
       funct uint32(stor8[stor3])
         gas gas_remaining wei
        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor8[stor3]), uint32(stor8[stor3]), 0) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
        ...
        if ext_code.size(rewardToken1Address) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = 0, address(stor8[stor3]), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        mem[516 len 4] = 0
        call rewardToken1Address with:
           funct uint32(stor8[stor3])
             gas gas_remaining wei
        ...
        if return_data.size <= 0:
            ...
            if ext_code.size(rewardToken1Address) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = 0, address(stor8[stor3]), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
