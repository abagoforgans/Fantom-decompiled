...
mapping of uint256 sub_48d00736;
array of uint256 sub_ae543cb2;
...
function sub_48d00736(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == address(arg2)
    return sub_48d00736[arg1][address(arg2)]
}
...
function sub_ae543cb2(?) payable {
    ...
    require arg2 == address(arg2)
    require arg3 == arg3
    if arg3 >= sub_ae543cb2[arg1][address(arg2)]:
        revert with 'NH{q', 50
    return sub_ae543cb2[arg1][address(arg2)][arg3]
}
...
function userVotedInRound(uint256 arg1, address arg2) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    return bool(stor9[arg1][address(arg2)])
}
...
function sub_bc35784b(?) payable {
    ...
    while idx < activeRounds.length:
        mem[0] = address(arg1)
        mem[32] = sha3(activeRounds[idx], 7)
        if sub_48d00736[stor3[idx]][address(arg1)] < arg2:
            mem[0] = address(arg1)
            mem[32] = sha3(activeRounds[idx], 7)
            if sub_48d00736[stor3[idx]][address(arg1)]:
                s = 0
                while s < sub_ae543cb2[stor3[idx]][address(arg1)]:
                    if sub_ae543cb2[stor3[idx]][address(arg1)][s] and arg2 > -1 / sub_ae543cb2[stor3[idx]][address(arg1)][s]:
                        revert with 'NH{q', 17
                    if not sub_48d00736[stor3[idx]][address(arg1)]:
                        revert with 'NH{q', 18
                    if sub_ae543cb2[stor3[idx]][address(arg1)][s] * arg2 / sub_48d00736[stor3[idx]][address(arg1)] < sub_ae543cb2[stor3[idx]][address(arg1)][s]:
                        revert with 'NH{q', 17
                    if s >= sub_f5816e73[stor3[idx]]:
                        revert with 'NH{q', 50
                    if sub_f5816e73[stor3[idx]][s] > -(sub_ae543cb2[stor3[idx]][address(arg1)][s] * arg2 / sub_48d00736[stor3[idx]][address(arg1)]) + sub_ae543cb2[stor3[idx]][address(arg1)][s] - 1:
                        revert with 'NH{q', 17
                    sub_f5816e73[stor3[idx]][s] = sub_f5816e73[stor3[idx]][s] + (sub_ae543cb2[stor3[idx]][address(arg1)][s] * arg2 / sub_48d00736[stor3[idx]][address(arg1)]) - sub_ae543cb2[stor3[idx]][address(arg1)][s]
                    mem[32] = sha3(activeRounds[idx], 8)
                    if s >= sub_ae543cb2[stor3[idx]][address(arg1)]:
                        revert with 'NH{q', 50
                    mem[0] = sha3(address(arg1), sha3(activeRounds[idx], 8))
                    sub_ae543cb2[stor3[idx]][address(arg1)][s] = sub_ae543cb2[stor3[idx]][address(arg1)][s] * arg2 / sub_48d00736[stor3[idx]][address(arg1)]
                    if s == -1:
                        revert with 'NH{q', 17
                    s = s + 1
                    continue 
                mem[0] = address(arg1)
                mem[32] = sha3(activeRounds[idx], 7)
                sub_48d00736[stor3[idx]][address(arg1)] = arg2
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_6a2bd654(?) payable {
    ...
    while idx < activeRounds.length:
        ...
        if not stor9[cd[36]][address(msg.sender)]:
            sub_ae543cb2[cd[36]][address(msg.sender)] = ('cd', 4).length
            if not ('cd', 4).length:
                idx = sha3(sha3(address(msg.sender), sha3(cd[36], 8)))
                while sha3(sha3(address(msg.sender), sha3(cd[36], 8))) + sub_ae543cb2[cd[36]][address(msg.sender)] > idx:
                    uint256(stor[idx].field_0) = 0
                    idx = idx + 1
                    continue 
            else:
                t = sha3(sha3(address(msg.sender), sha3(cd[36], 8)))
                idx = 128
            ...
            mem[floor32(('cd', 4).length) + ceil32(return_data.size) + 97] = sub_ae543cb2[cd[36]][address(msg.sender)]
            if sub_ae543cb2[cd[36]][address(msg.sender)]:
                mem[floor32(('cd', 4).length) + ceil32(return_data.size) + 129] = sub_ae543cb2[cd[36]][address(msg.sender)]
                idx = floor32(('cd', 4).length) + ceil32(return_data.size) + 129
                t = sha3(sha3(address(msg.sender), sha3(cd[36], 8)))
                while floor32(('cd', 4).length) + ceil32(return_data.size) + (32 * sub_ae543cb2[cd[36]][address(msg.sender)]) + 97 > idx:
                    mem[idx + 32] = uint256(stor1[t])
                    idx = idx + 32
                    t = t + 1
                    continue 
            idx = 0
            while idx < sub_ae543cb2[cd[36]][address(msg.sender)]:
                if idx >= sub_ae543cb2[cd[36]][address(msg.sender)]:
                    revert with 'NH{q', 50
                mem[32] = 6
                if idx >= sub_f5816e73[cd[36]]:
                    revert with 'NH{q', 50
                mem[0] = sha3(cd[36], 6)
                if sub_f5816e73[cd[36]][idx] < mem[(32 * idx) + floor32(('cd', 4).length) + ceil32(return_data.size) + 129]:
                    revert with 'NH{q', 17
                sub_f5816e73[cd[36]][idx] -= mem[(32 * idx) + floor32(('cd', 4).length) + ceil32(return_data.size) + 129]
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
                continue 
            ...
            if not ('cd', 4).length:
                ...
                while sha3(sha3(address(msg.sender), sha3(cd[36], 8))) + sub_ae543cb2[cd[36]][address(msg.sender)] > idx:
                    ...
                    idx = idx + 1
                    continue 
        sub_48d00736[cd[36]][address(msg.sender)] = s * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length * ('cd', 4).length
        idx = 0
        while idx < ('cd', 4).length:
            if idx >= ('cd', 4).length:
                revert with 'NH{q', 50
            ...
            if idx >= sub_f5816e73[cd[36]]:
                revert with 'NH{q', 50
            mem[0] = sha3(cd[36], 6)
            if sub_f5816e73[cd[36]][idx] > -mem[(32 * idx) + 128] - 1:
                revert with 'NH{q', 17
            sub_f5816e73[cd[36]][idx] += mem[(32 * idx) + 128]
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            continue 
                ...
                if not _1432:
                    ...
                    if not _1482:
                        ...
                        while sub_f5816e73[stor2] > idx:
                            ...
                            continue 
    activeRounds.length++
    activeRounds[activeRounds.length] = roundCount
    if roundCount == -1:
        revert with 'NH{q', 17
    roundCount++
}
