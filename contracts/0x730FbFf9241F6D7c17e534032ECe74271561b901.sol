        ...
        if not ext_call.return_data[0]:
            ...
            if not 0 / ext_call.return_data[0]:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(sub_ee6822a7Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[260 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 0 / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
                    mem[324 len 0] = 0
                    call sub_ee6822a7Address with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                    ...
                    if not return_data.size:
                        if not ext_call.success:
                            revert with transfer(address arg1, uint256 arg2), msg.sender, 0 / 0 / ext_call.return_data[0] * arg1 / 10^18
                        if not transfer(address arg1, uint256 arg2), Mask(224, 32, msg.sender) >> 32:
                            revert with 0, 32, 42, 0x2e5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                        if eth.balance(this.address) < 0:
                            revert with 0, 32, 38, 0x2e416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[562 len 26]
                ...
                if not arg1:
                    ...
                    if not ext_code.size(sub_ee6822a7Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[260 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 10^18 * 0 / ext_call.return_data[0] / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
                    mem[324 len 0] = 0
                    call sub_ee6822a7Address with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                    ...
                    if not return_data.size:
                        if not ext_call.success:
                            revert with transfer(address arg1, uint256 arg2), 
                                        msg.sender,
                                        10^18 * 0 / ext_call.return_data[0] / 0 / ext_call.return_data[0] * arg1 / 10^18
                        if not transfer(address arg1, uint256 arg2), Mask(224, 32, msg.sender) >> 32:
                            revert with 0, 32, 42, 0x2e5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                        if eth.balance(this.address) < 0:
                            revert with 0, 32, 38, 0x2e416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[562 len 26]
            ...
            if not 0 / ext_call.return_data[0]:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(sub_ee6822a7Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[260 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 0 / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18) >> 32
                    mem[324 len 0] = 0
                    call sub_ee6822a7Address with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                    ...
                    if not return_data.size:
                        if not ext_call.success:
                            revert with transfer(address arg1, uint256 arg2), 
                                        msg.sender,
                                        0 / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18
                        if not transfer(address arg1, uint256 arg2), Mask(224, 32, msg.sender) >> 32:
                            revert with 0, 32, 42, 0x2e5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                        if eth.balance(this.address) < 0:
                            revert with 0, 32, 38, 0x2e416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[562 len 26]
                ...
                if not arg1:
                    ...
                    if not ext_code.size(sub_ee6822a7Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[260 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 10^18 * 0 / ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18) >> 32
                    mem[324 len 0] = 0
                    call sub_ee6822a7Address with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
        ...
        if not ext_call.return_data[0]:
            ...
            if not 10^18 * ext_call.return_data[0] / ext_call.return_data[0]:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(sub_ee6822a7Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[260 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
                    mem[324 len 0] = 0
                    call sub_ee6822a7Address with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
