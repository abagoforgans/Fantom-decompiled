...
function totalUsersInRound(uint256 arg1) payable {
    ...
    while idx < users.length:
        ...
        while s < totalRoundOptions[arg1].field_256:
            if t > !totalRoundOptions[arg1][2][s][1][stor6[idx]].field_0:
                revert with 0, 17
            if s == -1:
                revert with 0, 17
            mem[0] = arg1
...
function votesInRound(uint256 arg1) payable {
    ...
    while idx < totalRoundOptions[arg1].field_256:
        ...
        while s < users.length:
            ...
            continue 
        if 0 > !(t * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length):
            revert with 0, 17
        if idx == -1:
            revert with 0, 17
        mem[0] = arg1
