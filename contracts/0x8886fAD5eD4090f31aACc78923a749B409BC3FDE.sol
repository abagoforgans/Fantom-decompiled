...
function safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) payable {
    ...
    if arg1 == msg.sender:
        ...
        call arg2.0xbc197c81 with:
             gas gas_remaining wei
            args msg.sender, address(arg1), 160, mem[mem[64] + 100 len floor32(_16402) + (32 * _16176) + (32 * mem[96]) + 192]
        mem[mem[64]] = ext_call.return_data[0]
        if ext_call.success:
            require return_data.size >= 32
            if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
        ...
        if not mem[_16663 + ext_call.return_data[0]]:
            ...
            revert with memory
              from mem[64]
               len floor32(_16708) + _16706 + -mem[64] + 100
    ...
    while idx < allProxyRegistries.length:
        ...
        if not mem[_16866 + ext_call.return_data[0]]:
            ...
            if not _16909 % 32:
                revert with memory
                  from mem[64]
                   len _16909 + _16907 + -mem[64] + 68
            mem[floor32(_16909) + _16907 + 68] = mem[floor32(_16909) + _16907 + -(_16909 % 32) + 100 len _16909 % 32]
        revert with memory
          from mem[64]
    ...
    mem[(32 * _16405) + (32 * mem[96]) + mem[64] + 260 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])] = mem[(32 * arg3.length) + (32 * arg4.length) + 192 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])]
    if not _16616 % 32:
        require ext_code.size(arg2)
        call arg2.0xbc197c81 with:
             gas gas_remaining wei
            args msg.sender, address(arg1), 160, mem[mem[64] + 100 len _16616 + (32 * _16405) + (32 * mem[96]) + 160]
        mem[mem[64]] = ext_call.return_data[0]
        if ext_call.success:
            require return_data.size >= 32
            if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
        ...
        revert with memory
          from mem[64]
           len floor32(_16880) + _16878 + -mem[64] + 100
    mem[floor32(_16616) + (32 * _16405) + (32 * mem[96]) + mem[64] + 260] = mem[floor32(_16616) + (32 * _16405) + (32 * mem[96]) + mem[64] + -(_16616 % 32) + 292 len _16616 % 32]
    require ext_code.size(arg2)
    call arg2.0xbc197c81 with:
         gas gas_remaining wei
        args msg.sender, address(arg1), 160, mem[mem[64] + 100 len floor32(_16616) + (32 * _16405) + (32 * mem[96]) + 192]
    mem[mem[64]] = ext_call.return_data[0]
    if ext_call.success:
        require return_data.size >= 32
        if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
