...
function safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) payable {
    ...
    if arg1 == msg.sender:
        ...
        if not _16402 % 32:
            ...
            call arg2.0xbc197c81 with:
                 gas gas_remaining wei
                args msg.sender, address(arg1), Array(len=mem[96], data=mem[mem[64] + 196 len _16402 + (32 * _16176) + (32 * mem[96]) + 64]), (32 * mem[96]) + 192, (32 * _16176) + (32 * mem[96]) + 224
    ...
    while idx < allProxyRegistries.length:
        ...
        idx = 0
        while idx < 32 * _16408:
            mem[idx + (32 * _16191) + mem[64] + 228] = mem[idx + (32 * arg3.length) + 160]
            idx = idx + 32
            continue 
