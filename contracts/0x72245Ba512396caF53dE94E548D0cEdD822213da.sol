...
function aggregate(address arg1, bytes[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[_128] = cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]
        require arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)] + 68 <= calldata.size
        mem[_128 + 32 len cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]] = call.data[arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 68 len cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]]
        mem[_128 + cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)] + 32] = 0
        mem[_72 + 32] = _128
        mem[t] = _72
        idx = idx + 1
        s = s + 32
...
function blockAndAggregate(address arg1, bytes[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        if mem[64] + ceil32(ceil32(cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)])) + 1 > test266151307() or mem[64] + ceil32(ceil32(cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)])) + 1 < mem[64]:
            revert with 'NH{q', 65
        mem[64] = mem[64] + ceil32(ceil32(cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)])) + 1
        mem[_132] = cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]
        require arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)] + 68 <= calldata.size
        mem[_132 + 32 len cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]] = call.data[arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 68 len cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]]
        mem[_132 + cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)] + 32] = 0
        mem[_83 + 32] = _132
        mem[t] = _83
        idx = idx + 1
        s = s + 32
    ...
    if not _84:
        ...
        _307 = mem[96]
        s = 0
        while arg1.length < _307:
            if arg1.length >= mem[96]:
                revert with 'NH{q', 50
            _311 = mem[mem[(32 * arg1.length) + 128]]
            if arg1.length >= mem[96]:
                revert with 'NH{q', 50
            _314 = mem[mem[(32 * arg1.length) + 128] + 32]
            _315 = mem[64]
            _317 = mem[mem[mem[(32 * arg1.length) + 128] + 32]]
            idx = 0
            while idx < _317:
            ...
            if ceil32(_317) <= _317:
                ...
                if not return_data.size:
                    ...
                    mem[_358 + 32] = 96
                    if arg1.length >= mem[_85]:
                        revert with 'NH{q', 50
                    mem[(32 * arg1.length) + _85 + 32] = _358
                else:
                    _351 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                    ...
                    if arg1.length >= mem[_85]:
                        revert with 'NH{q', 50
                    mem[(32 * arg1.length) + _85 + 32] = _360
            else:
                mem[_315 + _317] = 0
                call address(_311).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if arg1.length >= mem[_85]:
                        revert with 'NH{q', 50
                    mem[(32 * arg1.length) + _85 + 32] = _364
                else:
                    _354 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                    ...
                    if arg1.length >= mem[_85]:
                        revert with 'NH{q', 50
                    mem[(32 * arg1.length) + _85 + 32] = _366
            if arg1.length == -1:
                revert with 'NH{q', 17
            _307 = mem[96]
            s = arg1.length + 1
...
function tryAggregate(bool arg1, address arg2, bytes[] arg3) payable {
    ...
    while idx < arg2.length:
        ...
        mem[_175] = cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)]
        require arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)] + 68 <= calldata.size
        mem[_175 + 32 len cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)]] = call.data[arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 68 len cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)]]
        mem[_175 + cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)] + 32] = 0
        mem[_101 + 32] = _175
        mem[t] = _101
        idx = idx + 1
        s = s + 32
    ...
    if not _99:
        ...
        while arg2.length < _206:
            mem[v] = u + -_199 - 64
            _290 = mem[arg2 + (32 * arg2.length) + 36]
            mem[u] = bool(mem[mem[arg2 + (32 * arg2.length) + 36]])
            _303 = mem[_290 + 32]
            mem[u + 32] = 64
            _312 = mem[_303]
            mem[u + 64] = mem[_303]
...
function tryBlockAndAggregate(bool arg1, address arg2, bytes[] arg3) payable {
    ...
    while idx < arg2.length:
        ...
        if mem[64] + ceil32(ceil32(cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)])) + 1 > test266151307() or mem[64] + ceil32(ceil32(cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)])) + 1 < mem[64]:
            revert with 'NH{q', 65
        mem[64] = mem[64] + ceil32(ceil32(cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)])) + 1
        mem[_162] = cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)]
        require arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)] + 68 <= calldata.size
        mem[_162 + 32 len cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)]] = call.data[arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 68 len cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)]]
        mem[_162 + cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)] + 32] = 0
        mem[_100 + 32] = _162
        mem[t] = _100
        idx = idx + 1
        s = s + 32
