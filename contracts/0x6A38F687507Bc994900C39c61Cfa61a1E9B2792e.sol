...
function recoverToken(uint256 arg1) {
    ...
    while idx < sub_a997a2b8.length:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(0x9ee6d281d77dedb1d65684c9137b7b3dc54f5d23)
        call 0x9ee6d281d77dedb1d65684c9137b7b3dc54f5d23.0x23b872dd with:
             gas gas_remaining wei
...
function cancelOffer(uint256 arg1) {
    ...
    while idx < stor7.length:
        ...
        while idx < uint256(sub_10ebe64a[arg1].field_0):
            ...
            continue 
        require ext_code.size(0x9ee6d281d77dedb1d65684c9137b7b3dc54f5d23)
        staticcall 0x9ee6d281d77dedb1d65684c9137b7b3dc54f5d23.0x6352211e with:
                gas gas_remaining wei
               args arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function offer(uint256 arg1, uint256 arg2) payable {
    ...
    if msg.value - (arg2 * sub_f420256b / 100) <= 0:
        ...
        call 0xfbc3c04845162f067a0b6f8934383e63899c3524.0x23b872dd with:
             gas gas_remaining wei
            args address(this.address), 0x5d7618693d74874b48d1685ab777a2f45d1af70a, mem[(32 * mem[ceil32(return_data.size) + 192] - 1) + ceil32(return_data.size) + 224]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(0xfbc3c04845162f067a0b6f8934383e63899c3524)
    ...
    if msg.value - ((100 * priceOfToken[arg1]) + (sub_fb815e69 * priceOfToken[arg1]) / 100) <= 0:
        ...
        if not priceOfToken[arg1] / sub_50376848 + 100:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(32 * _911) + ceil32(return_data.size) + 260] = 0x5d7618693d74874b48d1685ab777a2f45d1af70a
            mem[(32 * _911) + ceil32(return_data.size) + 292] = _1623
            require ext_code.size(0xfbc3c04845162f067a0b6f8934383e63899c3524)
            call 0xfbc3c04845162f067a0b6f8934383e63899c3524.0x23b872dd with:
                 gas gas_remaining wei
                args address(this.address), 0x5d7618693d74874b48d1685ab777a2f45d1af70a, _1623
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(32 * _910) + ceil32(return_data.size) + 260] = 0x5d7618693d74874b48d1685ab777a2f45d1af70a
            mem[(32 * _910) + ceil32(return_data.size) + 292] = _1622
            require ext_code.size(0xfbc3c04845162f067a0b6f8934383e63899c3524)
            call 0xfbc3c04845162f067a0b6f8934383e63899c3524.0x23b872dd with:
                 gas gas_remaining wei
                args address(this.address), 0x5d7618693d74874b48d1685ab777a2f45d1af70a, _1622
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
        ...
        if not priceOfToken[arg1] / sub_50376848 + 100:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(32 * _913) + ceil32(return_data.size) + 260] = 0x5d7618693d74874b48d1685ab777a2f45d1af70a
            mem[(32 * _913) + ceil32(return_data.size) + 292] = _1625
            require ext_code.size(0xfbc3c04845162f067a0b6f8934383e63899c3524)
            call 0xfbc3c04845162f067a0b6f8934383e63899c3524.0x23b872dd with:
                 gas gas_remaining wei
                args address(this.address), 0x5d7618693d74874b48d1685ab777a2f45d1af70a, _1625
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(32 * _912) + ceil32(return_data.size) + 260] = 0x5d7618693d74874b48d1685ab777a2f45d1af70a
            mem[(32 * _912) + ceil32(return_data.size) + 292] = _1624
            require ext_code.size(0xfbc3c04845162f067a0b6f8934383e63899c3524)
            call 0xfbc3c04845162f067a0b6f8934383e63899c3524.0x23b872dd with:
                 gas gas_remaining wei
                args address(this.address), 0x5d7618693d74874b48d1685ab777a2f45d1af70a, _1624
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
