...
function unstake(uint256 arg1) payable {
    ...
    require totalFrozen
    stor4 += arg1 / 100 << 64 / totalFrozen
    totalFrozen -= arg1
    frozenOf[msg.sender].field_256 -= arg1 / 100
    frozenOf[msg.sender].field_512 -= arg1
    frozenOf[msg.sender].field_1024 += -1 * arg1 * stor4
    emit 0xfeddf252: (arg1 - (arg1 / 100)), this.address, msg.sender
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if totalSupply - (arg2 / 100) < 1000000000 * 10^18:
        ...
        if frozenOf[address(msg.sender)].field_0:
            ...
            frozenOf[address(arg1)].field_256 = arg2 - (arg2 / 100) + frozenOf[address(arg1)].field_256
            ...
            if arg2 / 100:
                if not totalFrozen:
                    ...
                    require totalFrozen
                    stor4 += Mask(192, 1, arg2 / 100) << 63 / totalFrozen
                    emit 0xfeddf252: (arg2 / 100 / 2), msg.sender, this.address
                    totalSupply -= arg2 / 100 / 2
                    emit 0xfeddf252: (arg2 / 100 / 2), msg.sender, 0
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if totalSupply - (arg3 / 100) < 1000000000 * 10^18:
        ...
        if frozenOf[address(arg1)].field_0:
            ...
            frozenOf[address(arg2)].field_256 = arg3 - (arg3 / 100) + frozenOf[address(arg2)].field_256
            ...
            if arg3 / 100:
                if not totalFrozen:
                    ...
                    require totalFrozen
                    stor4 += Mask(192, 1, arg3 / 100) << 63 / totalFrozen
                    emit 0xfeddf252: (arg3 / 100 / 2), arg1, this.address
                    totalSupply -= arg3 / 100 / 2
                    emit 0xfeddf252: (arg3 / 100 / 2), arg1, 0
...
function bulkTransfer(address[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 3
        if totalSupply - (cd[((32 * idx) + arg2 + 36)] / 100) < 1000000000 * 10^18:
            ...
            if frozenOf[address(msg.sender)].field_0:
                ...
                frozenOf[address(cd[((32 * idx) + arg1 + 36)])].field_256 = cd[((32 * idx) + arg2 + 36)] - (cd[((32 * idx) + arg2 + 36)] / 100) + frozenOf[address(cd[((32 * idx) + arg1 + 36)])].field_256
                mem[96] = cd[((32 * idx) + arg2 + 36)] - (cd[((32 * idx) + arg2 + 36)] / 100)
                mem[0] = address(cd[((32 * idx) + arg1 + 36)])
                emit 0xfeddf252: (cd[((32 * idx) + arg2 + 36)] - (cd[((32 * idx) + arg2 + 36)] / 100)), msg.sender, address(cd[((32 * idx) + arg1 + 36)])
                if cd[((32 * idx) + arg2 + 36)] / 100:
                    if not totalFrozen:
                        totalSupply -= cd[((32 * idx) + arg2 + 36)] / 100
                        mem[0] = address(cd[((32 * idx) + arg1 + 36)])
                        emit 0xfeddf252: (cd[((32 * idx) + arg2 + 36)] / 100), msg.sender, 0
                        mem[96] = cd[((32 * idx) + arg2 + 36)] / 100
                        emit Burn((cd[((32 * idx) + arg2 + 36)] / 100));
                    else:
                        require totalFrozen
                        stor4 += Mask(192, 1, cd[((32 * idx) + arg2 + 36)] / 100) << 63 / totalFrozen
                        emit 0xfeddf252: (cd[((32 * idx) + arg2 + 36)] / 100 / 2), msg.sender, this.address
                        totalSupply -= cd[((32 * idx) + arg2 + 36)] / 100 / 2
                        mem[0] = address(cd[((32 * idx) + arg1 + 36)])
                        emit 0xfeddf252: (cd[((32 * idx) + arg2 + 36)] / 100 / 2), msg.sender, 0
