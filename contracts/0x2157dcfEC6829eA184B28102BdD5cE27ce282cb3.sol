...
function ethToWant(uint256 arg1) payable {
    ...
    if stor18 == wantAddress:
        return arg1
    require ext_code.size(0x3ce69a5bc730e49472a33cf9283ac5b1e26e282)
    delegate 0x3ce69a5bc730e49472a33cf9283ac5b1e26e282.fromETH(uint256 arg1, address arg2) with:
         gas gas_remaining wei
...
function initialize(address arg1, address arg2, address arg3, address arg4) payable {
    ...
    if not return_data.size:
        ...
        staticcall 0xf3b0611e2e4d2cd6ab4bb3e01ade211c3f42a8c3.ADDRESSES_PROVIDER() with:
                gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
