...
function sub_f6fcd88d(?) {
    ...
    if not _176:
        ...
        while idx < _219:
            ...
            require idx < mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 160]
            _239 = mem[mem[(32 * idx) + (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192] + 32]
            require idx < mem[(32 * ('cd', 4).length) + 128]
            _243 = mem[(32 * idx) + (32 * ('cd', 4).length) + 160]
            mem[mem[64] + 4] = ('signextend', 15, ('mem', ('range', ('mem', ('range', ('add', 192, ('mask_shl', 251, 0, 5, ('var', 0)), ('mask_shl', 251, 0, 5, ('cd', ('add', 4, ('cd', 4)))), ('mask_shl', 251, 0, 5, ('cd', ('add', 4, ('cd', 36))))), 32)), 32)))
            mem[mem[64] + 36] = ('signextend', 15, ('var', '_239'))
            mem[mem[64] + 68] = _243
            require ext_code.size(address(_224))
            staticcall address(_224).get_dy(int128 rg1, int128 rg2, uint256 rg3) with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4], ('signextend', 15, ('var', '_239')), _243
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _253 = mem[64]
            ...
            mem[(32 * idx) + _177 + 32] = mem[_253]
            _219 = mem[96]
            idx = idx + 1
            continue 
        mem[mem[64]] = 32
        _235 = mem[_177]
        mem[mem[64] + 32] = mem[_177]
        mem[mem[64] + 64 len 32 * _235] = mem[_177 + 32 len 32 * _235]
        return 32, mem[mem[64] + 32 len (32 * _235) + 32]
    mem[_177 + 32 len 32 * _176] = call.data[calldata.size len 32 * _176]
    _220 = mem[96]
    idx = 0
    while idx < _220:
        require idx < mem[96]
        ...
        require idx < mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 160]
        require idx < mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 160]
        _241 = mem[mem[(32 * idx) + (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 192] + 32]
        require idx < mem[(32 * ('cd', 4).length) + 128]
        _245 = mem[(32 * idx) + (32 * ('cd', 4).length) + 160]
        mem[mem[64] + 4] = ('signextend', 15, ('mem', ('range', ('mem', ('range', ('add', 192, ('mask_shl', 251, 0, 5, ('var', 0)), ('mask_shl', 251, 0, 5, ('cd', ('add', 4, ('cd', 4)))), ('mask_shl', 251, 0, 5, ('cd', ('add', 4, ('cd', 36))))), 32)), 32)))
        mem[mem[64] + 36] = ('signextend', 15, ('var', '_241'))
        mem[mem[64] + 68] = _245
        require ext_code.size(address(_227))
        staticcall address(_227).get_dy(int128 rg1, int128 rg2, uint256 rg3) with:
                gas gas_remaining wei
               args mem[mem[64] + 4], ('signextend', 15, ('var', '_241')), _245
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _254 = mem[64]
    ...
    _237 = mem[_177]
    mem[mem[64] + 32] = mem[_177]
    mem[mem[64] + 64 len 32 * _237] = mem[_177 + 32 len 32 * _237]
