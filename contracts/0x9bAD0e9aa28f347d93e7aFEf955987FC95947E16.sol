...
function sub_c66fe110(?) {
    ...
    call sub_5d33a1f4Address.balanceOf(address rg1) with:
         gas gas_remaining wei
        args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function setPriceForToken(uint256 arg1, uint256 arg2) {
    ...
    call nftAddress.ownerOf(uint256 rg1) with:
         gas gas_remaining wei
        args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if arg1 <= 0:
        revert with 0, 'New price must be greater than 0'
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit 0xcde1610a: arg2, sub_dcd6a95d[stor3][arg2], arg1, address(ext_call.return_data[0])
}
...
function purchaseToken(uint256 arg1) {
    ...
    require ext_code.size(nftAddress)
    call nftAddress.exists(uint256 rg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if sub_dcd6a95d[stor3][arg1] <= 0:
        revert with 0, 'Price is not set yet'
    require ext_code.size(sub_5d33a1f4Address)
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit 0xd6b7691c: arg1, sub_dcd6a95d[stor3][arg1], address(ext_call.return_data[0]), msg.sender
}
