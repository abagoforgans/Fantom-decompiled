...
function sub_be1482e6(?) payable {
    ...
    if arg1.length:
        stor0[address(msg.sender)][stor0[address(msg.sender)].field_0][].field_0 = Array(len=arg1.length, data=arg1[all])
    else:
        stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_0 = 0
        idx = 0
        while stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].length + 31 / 32 > idx:
            stor0[address(msg.sender)][(9 * stor0[address(msg.sender)].field_0) + idx].field_0 = 0
            idx = idx + 1
            continue 
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_256 = 0
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_257 = 6
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_264 = 0x686f6d69657300000000000000000000000000000000000000000000000000
    idx = 0
    while stor[('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'stor0', 0)) + (9 * stor0[address(msg.sender)].field_0) + 1].length + 31 / 32 > idx:
        stor[idx + sha3(('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'stor0', 0)) + (9 * stor0[address(msg.sender)].field_0) + 1)].field_0 = 0
        idx = idx + 1
        continue 
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_512 = 0
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_513 = 6
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_520 = 0x62756762757300000000000000000000000000000000000000000000000000
    idx = 0
    while stor[('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'stor0', 0)) + (9 * stor0[address(msg.sender)].field_0) + 2].length + 31 / 32 > idx:
        stor[idx + sha3(('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'stor0', 0)) + (9 * stor0[address(msg.sender)].field_0) + 2)].field_0 = 0
        idx = idx + 1
        continue 
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_768 = block.timestamp
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_1024 = 100
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_1280 = 5
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_1536 = 5
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_1792 = 5
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_2048 = 0
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_2304 = 0
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_2056 = 0
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_2304 = 0
    stor0[address(msg.sender)][stor0[address(msg.sender)].field_0].field_2064 = 0
