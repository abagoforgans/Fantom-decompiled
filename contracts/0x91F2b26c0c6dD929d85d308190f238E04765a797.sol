...
function sub_64f6f776(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        call stor6.claim(uint256 arg1) with:
...
function sub_4fca98e5(?) payable {
    ...
    idx = 0
    while idx < ('cd', 4).length:
        mem[96] = 0x8b691e6300000000000000000000000000000000000000000000000000000000
        mem[100] = cd[((32 * idx) + cd[4] + 36)]
        require ext_code.size(stor7)
        call stor7.burnRarityToken(uint256 arg1) with:
             gas gas_remaining wei
            args cd[((32 * idx) + cd[4] + 36)]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_5162d842(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        call stor0.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args address(cd[36]), cd[((32 * idx) + cd[4] + 36)]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if idx == -1:
            revert with 'NH{q', 17
...
function sub_d7d2ca23(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        call stor3.approve(uint256 arg1, uint256 arg2, uint256 arg3) with:
             gas gas_remaining wei
            args cd[((32 * idx) + cd[4] + 36)], cd[36], cd[68]
...
function sub_b1e716f6(?) payable {
    ...
    while idx < ('cd', 4).length:
        mem[mem[64] + 4] = cd[((32 * idx) + cd[4] + 36)]
        require ext_code.size(stor6)
        staticcall stor6.balanceOf(uint256 arg1) with:
                gas gas_remaining wei
               args cd[((32 * idx) + cd[4] + 36)]
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
        ...
        if mem[_11] > 0:
            ...
            mem[mem[64] + 68] = _12
            require ext_code.size(stor6)
            call stor6.transfer(uint256 arg1, uint256 arg2, uint256 arg3) with:
                 gas gas_remaining wei
                args cd[((32 * idx) + cd[4] + 36)], cd[36], _12
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _15 = mem[64]
...
function sub_24db19a0(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        if mem[_11] > 0:
            ...
            mem[mem[64] + 100] = _12
            require ext_code.size(stor3)
            call stor3.transferFrom(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) with:
                 gas gas_remaining wei
                args cd[((32 * idx) + cd[4] + 36)], cd[((32 * idx) + cd[4] + 36)], cd[36], _12
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _15 = mem[64]
...
function sub_6cece1c7(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        if mem[_11] > 0:
            ...
            mem[mem[64] + 100] = _12
            require ext_code.size(stor1)
            call stor1.transferFrom(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) with:
                 gas gas_remaining wei
                args cd[((32 * idx) + cd[4] + 36)], cd[((32 * idx) + cd[4] + 36)], cd[36], _12
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
...
function sub_5d3578df(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        if idx >= ('cd', 100).length:
            revert with 'NH{q', 50
        mem[96] = 0x65f1bfc400000000000000000000000000000000000000000000000000000000
        mem[100] = cd[((32 * idx) + cd[4] + 36)]
        mem[132] = uint8(cd[((32 * idx) + cd[36] + 36)])
        mem[164] = uint8(cd[((32 * idx) + cd[68] + 36)])
        mem[196] = cd[((32 * idx) + cd[100] + 36)]
        require ext_code.size(stor5)
        call stor5.craft(uint256 arg1, uint8 arg2, uint8 arg3, uint256 arg4) with:
             gas gas_remaining wei
...
function sub_435ed3d3(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            mem[mem[64] + 4] = cd[((32 * idx) + cd[4] + 36)]
            require ext_code.size(stor0)
            staticcall stor0.class(uint256 arg1) with:
                    gas gas_remaining wei
                   args cd[((32 * idx) + cd[4] + 36)]
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
...
function sub_0f95d9b6(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            mem[mem[64] + 4] = cd[((32 * idx) + cd[4] + 36)]
            require ext_code.size(stor6)
            staticcall stor6.claimed(uint256 arg1) with:
                    gas gas_remaining wei
                   args cd[((32 * idx) + cd[4] + 36)]
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
...
function sub_1b1b8ca5(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            ...
            if idx >= mem[96]:
                revert with 'NH{q', 50
            mem[(32 * idx) + 128] = mem[_28 + 12 len 20]
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            continue 
...
function sub_926cb576(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            require ext_code.size(stor5)
            staticcall stor5.items(uint256 arg1) with:
                    gas gas_remaining wei
                   args cd[((32 * idx) + cd[4] + 36)]
            ...
            if mem[64] + 128 > test266151307() or mem[64] + 128 < mem[64]:
                revert with 'NH{q', 65
            mem[64] = mem[64] + 128
            require mem[_44] == mem[_44 + 31 len 1]
            mem[_51] = mem[_44]
            require mem[_44 + 32] == mem[_44 + 63 len 1]
            mem[_51 + 32] = mem[_44 + 32]
            require mem[_44 + 64] == mem[_44 + 92 len 4]
            mem[_51 + 64] = mem[_44 + 64]
            require mem[_44 + 96] == mem[_44 + 96]
            mem[_51 + 96] = mem[_44 + 96]
            if idx >= mem[96]:
                revert with 'NH{q', 50
            mem[(32 * idx) + 128] = _51
            if idx == -1:
        ...
        while idx < _40:
            ...
            mem[t + 32] = mem[_73 + 63 len 1]
            mem[t + 64] = mem[_73 + 92 len 4]
            mem[t + 96] = mem[_73 + 96]
            idx = idx + 1
            s = s + 32
            t = t + 128
    ...
    while idx < ('cd', 4).length:
        ...
        mem[_104 + 32] = mem[_100 + 32]
        require mem[_100 + 64] == mem[_100 + 92 len 4]
        mem[_104 + 64] = mem[_100 + 64]
        require mem[_100 + 96] == mem[_100 + 96]
        mem[_104 + 96] = mem[_100 + 96]
        if idx >= mem[96]:
            revert with 'NH{q', 50
        mem[(32 * idx) + 128] = _104
        if idx == -1:
    ...
    while idx < _98:
        _113 = mem[s]
        mem[t] = mem[mem[s] + 31 len 1]
        mem[t + 32] = mem[_113 + 63 len 1]
        mem[t + 64] = mem[_113 + 92 len 4]
        mem[t + 96] = mem[_113 + 96]
        idx = idx + 1
        s = s + 32
        t = t + 128
        continue 
