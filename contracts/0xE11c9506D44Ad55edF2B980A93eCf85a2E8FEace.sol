...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if block.difficulty and block.timestamp > -1 / block.difficulty:
        revert with 'NH{q', 17
    if block.difficulty * block.timestamp % 5 > -2:
        revert with 'NH{q', 17
    stor12 = (block.difficulty * block.timestamp % 5) + 1
    if arg2 and stor12 > -1 / arg2:
        revert with 'NH{q', 17
    stor13 = arg2 * stor12 / 100
    ...
    if balanceOf[address(arg1)] > -arg2 + stor13 - 1:
        revert with 'NH{q', 17
    balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 - stor13
    ...
    if arg2 - stor13 <= 10^18:
        stor7[address(arg1)] = 0
    else:
        if arg2 - stor13 >= 100000000 * 10^18:
            stor7[address(arg1)] = 0
        else:
    ...
    if not stor9.length:
        ...
        idx = 0
        while stor9.length > idx:
            stor8[s].field_0 = stor9[idx].field_0
            s = s + 1
            idx = idx + 1
            continue 
        idx = stor9.length
    ...
    if balanceOf[stor11] > -stor13 - 1:
        revert with 'NH{q', 17
    balanceOf[stor11] += stor13
    emit Transfer(stor13, msg.sender, showWinnerAddress);
    emit Transfer((arg2 - stor13), msg.sender, arg1);
    return 1
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if balanceOf[address(arg2)] > -arg3 + stor13 - 1:
        revert with 'NH{q', 17
    balanceOf[address(arg2)] = balanceOf[address(arg2)] + arg3 - stor13
    ...
    if balanceOf[address(arg1)] - arg3 <= 10^18:
        ...
        if balanceOf[address(arg1)] - arg3 >= 100000000 * 10^18:
            ...
            stor7[address(arg1)] = 1
    if arg3 - stor13 <= 10^18:
        stor7[address(arg2)] = 0
    else:
        if arg3 - stor13 >= 100000000 * 10^18:
            stor7[address(arg2)] = 0
        else:
    ...
    if balanceOf[stor11] > -stor13 - 1:
        revert with 'NH{q', 17
    balanceOf[stor11] += stor13
    emit Transfer(stor13, arg1, showWinnerAddress);
    emit Transfer((arg3 - stor13), arg1, arg2);
