...
function tokenURI(uint256 arg1) payable {
    ...
    if stor10[arg1].length:
        ...
        if not _1083 % 32:
            return 32, mem[mem[96] + ceil32(stor10[arg1].length) + baseURI.length + 192 len _1083 + 32]
        mem[floor32(_1083) + mem[96] + ceil32(stor10[arg1].length) + baseURI.length + 224] = mem[floor32(_1083) + mem[96] + ceil32(stor10[arg1].length) + baseURI.length + -(_1083 % 32) + 256 len _1083 % 32]
        return 32, mem[mem[96] + ceil32(stor10[arg1].length) + baseURI.length + 192 len floor32(_1083) + 64]
    if not arg1:
