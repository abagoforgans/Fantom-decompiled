...
function sub_3461a553(?) payable {
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length:
            ...
            mem[64] = mem[64] + 96
            require 0 < mem[_219]
            mem[_219 + 32] = address(cd[68])
            require 1 < mem[_219]
            mem[_219 + 64] = address(cd[100])
            require 0 < mem[_219]
            if address(cd[68]) != address(cd[68]):
                revert with 0, 'ERR_PATH_TOKENS'
            require mem[_219] - 1 < mem[_219]
            if mem[(32 * mem[_219] - 1) + _219 + 44 len 20] != address(cd[100]):
                revert with 0, 'ERR_PATH_TOKENS'
            ...
            mem[_425 + ceil32(return_data.size)] = _430
            ...
            require 1 < _430
            require idx < mem[96]
            mem[(32 * idx) + 128] = mem[_425 + ceil32(return_data.size) + 64]
            idx = idx + 1
            continue 
        idx = 0
        s = 0
        ...
        if not ('cd', 36).length:
            ...
            while idx < ('cd', 36).length:
                ...
                mem[64] = mem[64] + 96
                require 0 < mem[_761]
                mem[_761 + 32] = address(cd[100])
                require 1 < mem[_761]
                mem[_761 + 64] = address(cd[68])
                require 0 < mem[_761]
                if address(cd[100]) != address(cd[100]):
                    revert with 0, 'ERR_PATH_TOKENS'
                require mem[_761] - 1 < mem[_761]
                if mem[(32 * mem[_761] - 1) + _761 + 44 len 20] != address(cd[68]):
                    revert with 0, 'ERR_PATH_TOKENS'
                ...
                require _905 + return_data.size > _905 + mem[_905] + 31
                _916 = mem[_905 + mem[_905]]
                require mem[_905 + mem[_905]] <= test266151307()
                require (32 * mem[_905 + mem[_905]]) + 32 >= 0 and _905 + ceil32(return_data.size) + (32 * mem[_905 + mem[_905]]) + 32 <= test266151307()
                mem[64] = _905 + ceil32(return_data.size) + (32 * mem[_905 + mem[_905]]) + 32
                mem[_905 + ceil32(return_data.size)] = _916
                require return_data.size >= _912 + (32 * _916) + 32
                t = _905 + _912 + 32
                ...
                while s < _916:
                    ...
                    continue 
                require 1 < _916
                require idx < mem[_594]
                mem[(32 * idx) + _594 + 32] = mem[_905 + ceil32(return_data.size) + 64]
                idx = idx + 1
                continue 
        else:
            mem[_594 + 32 len 32 * ('cd', 36).length] = call.data[calldata.size len 32 * ('cd', 36).length]
            idx = 0
            while idx < ('cd', 36).length:
                require cd[((32 * idx) + cd[36] + 36)] == address(cd[((32 * idx) + cd[36] + 36)])
                _764 = mem[64]
                ...
                mem[64] = mem[64] + 96
                require 0 < mem[_764]
                mem[_764 + 32] = address(cd[100])
                require 1 < mem[_764]
                mem[_764 + 64] = address(cd[68])
                require 0 < mem[_764]
                if address(cd[100]) != address(cd[100]):
                    revert with 0, 'ERR_PATH_TOKENS'
                require mem[_764] - 1 < mem[_764]
                if mem[(32 * mem[_764] - 1) + _764 + 44 len 20] != address(cd[68]):
                    revert with 0, 'ERR_PATH_TOKENS'
                ...
                require _907 + return_data.size > _907 + mem[_907] + 31
                _917 = mem[_907 + mem[_907]]
                require mem[_907 + mem[_907]] <= test266151307()
                require (32 * mem[_907 + mem[_907]]) + 32 >= 0 and _907 + ceil32(return_data.size) + (32 * mem[_907 + mem[_907]]) + 32 <= test266151307()
                mem[64] = _907 + ceil32(return_data.size) + (32 * mem[_907 + mem[_907]]) + 32
                mem[_907 + ceil32(return_data.size)] = _917
                require return_data.size >= _913 + (32 * _917) + 32
                t = _907 + _913 + 32
                ...
                require 1 < _917
                require idx < mem[_594]
                mem[(32 * idx) + _594 + 32] = mem[_907 + ceil32(return_data.size) + 64]
                idx = idx + 1
                continue 
        idx = 0
        t = 0
        while idx < mem[_594]:
            require idx < mem[_594]
            if mem[(32 * idx) + _594 + 32] <= t:
                idx = idx + 1
                t = t
                continue 
            require idx < mem[_594]
            idx = idx + 1
            t = mem[(32 * idx) + _594 + 32]
            continue 
        idx = 0
        while idx < mem[_594]:
            require idx < mem[_594]
        ...
        while idx < ('cd', 36).length:
            ...
            mem[64] = mem[64] + 96
            require 0 < mem[_222]
            mem[_222 + 32] = address(cd[68])
            require 1 < mem[_222]
            mem[_222 + 64] = address(cd[100])
            require 0 < mem[_222]
            if address(cd[68]) != address(cd[68]):
                revert with 0, 'ERR_PATH_TOKENS'
            require mem[_222] - 1 < mem[_222]
            if mem[(32 * mem[_222] - 1) + _222 + 44 len 20] != address(cd[100]):
                revert with 0, 'ERR_PATH_TOKENS'
            mem[_222 + 96] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
            mem[_222 + 100] = cd[4]
            mem[_222 + 132] = 64
            mem[_222 + 164] = mem[_222]
            s = 0
            t = _222 + 32
            u = _222 + 196
            while s < mem[_222]:
            ...
            staticcall address(cd[((32 * idx) + cd[36] + 36)]).mem[mem[64] len 4] with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4 len _222 + (32 * mem[_222]) + -mem[64] + 192]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _427 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            require _427 + return_data.size > _427 + mem[_427] + 31
            _431 = mem[_427 + mem[_427]]
            require mem[_427 + mem[_427]] <= test266151307()
            require (32 * mem[_427 + mem[_427]]) + 32 >= 0 and _427 + ceil32(return_data.size) + (32 * mem[_427 + mem[_427]]) + 32 <= test266151307()
            mem[64] = _427 + ceil32(return_data.size) + (32 * mem[_427 + mem[_427]]) + 32
            mem[_427 + ceil32(return_data.size)] = _431
            require return_data.size >= _429 + (32 * _431) + 32
            t = _427 + _429 + 32
            u = _427 + ceil32(return_data.size) + 32
            s = 0
            while s < _431:
                mem[u] = mem[t]
                t = t + 32
            ...
            require 1 < _431
            require idx < mem[96]
            mem[(32 * idx) + 128] = mem[_427 + ceil32(return_data.size) + 64]
            idx = idx + 1
            continue 
        idx = 0
        s = 0
        ...
        if not ('cd', 36).length:
            ...
            while idx < ('cd', 36).length:
                ...
                mem[64] = mem[64] + 96
                require 0 < mem[_767]
                mem[_767 + 32] = address(cd[100])
                require 1 < mem[_767]
                mem[_767 + 64] = address(cd[68])
                require 0 < mem[_767]
                if address(cd[100]) != address(cd[100]):
                    revert with 0, 'ERR_PATH_TOKENS'
                require mem[_767] - 1 < mem[_767]
                if mem[(32 * mem[_767] - 1) + _767 + 44 len 20] != address(cd[68]):
                    revert with 0, 'ERR_PATH_TOKENS'
                ...
                require _909 + return_data.size > _909 + mem[_909] + 31
                _918 = mem[_909 + mem[_909]]
                ...
                mem[_909 + ceil32(return_data.size)] = _918
                require return_data.size >= _914 + (32 * _918) + 32
                t = _909 + _914 + 32
                u = _909 + ceil32(return_data.size) + 32
                s = 0
                while s < _918:
                    mem[u] = mem[t]
                    t = t + 32
                ...
                mem[(32 * idx) + _595 + 32] = mem[_909 + ceil32(return_data.size) + 64]
                idx = idx + 1
                continue 
        else:
            mem[_595 + 32 len 32 * ('cd', 36).length] = call.data[calldata.size len 32 * ('cd', 36).length]
            idx = 0
            while idx < ('cd', 36).length:
                require cd[((32 * idx) + cd[36] + 36)] == address(cd[((32 * idx) + cd[36] + 36)])
                _770 = mem[64]
                ...
                mem[64] = mem[64] + 96
                require 0 < mem[_770]
                mem[_770 + 32] = address(cd[100])
                require 1 < mem[_770]
                mem[_770 + 64] = address(cd[68])
                require 0 < mem[_770]
                if address(cd[100]) != address(cd[100]):
                    revert with 0, 'ERR_PATH_TOKENS'
                require mem[_770] - 1 < mem[_770]
                if mem[(32 * mem[_770] - 1) + _770 + 44 len 20] != address(cd[68]):
                    revert with 0, 'ERR_PATH_TOKENS'
                mem[_770 + 96] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                mem[_770 + 100] = s
                mem[_770 + 132] = 64
                ...
                staticcall address(cd[((32 * idx) + cd[36] + 36)]).mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _770 + (32 * mem[_770]) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _911 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                require _911 + return_data.size > _911 + mem[_911] + 31
                _919 = mem[_911 + mem[_911]]
                require mem[_911 + mem[_911]] <= test266151307()
                require (32 * mem[_911 + mem[_911]]) + 32 >= 0 and _911 + ceil32(return_data.size) + (32 * mem[_911 + mem[_911]]) + 32 <= test266151307()
                mem[64] = _911 + ceil32(return_data.size) + (32 * mem[_911 + mem[_911]]) + 32
                mem[_911 + ceil32(return_data.size)] = _919
                require return_data.size >= _915 + (32 * _919) + 32
                t = _911 + _915 + 32
                u = _911 + ceil32(return_data.size) + 32
                s = 0
                while s < _919:
                    mem[u] = mem[t]
                    t = t + 32
                ...
                require 1 < _919
                require idx < mem[_595]
                mem[(32 * idx) + _595 + 32] = mem[_911 + ceil32(return_data.size) + 64]
                idx = idx + 1
                continue 
        idx = 0
        t = 0
        while idx < mem[_595]:
            require idx < mem[_595]
            if mem[(32 * idx) + _595 + 32] <= t:
                idx = idx + 1
                t = t
                continue 
            require idx < mem[_595]
            idx = idx + 1
            t = mem[(32 * idx) + _595 + 32]
            continue 
        idx = 0
        while idx < mem[_595]:
            require idx < mem[_595]
