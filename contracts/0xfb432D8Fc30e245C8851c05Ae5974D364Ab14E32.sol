...
function playerDetails(bytes32 arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    return address(playerDetails[arg1][arg2])
}
...
function getWhitelist() {
    ...
    staticcall stor6.getTokenList(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function collect(bytes32 arg1, uint256[2] arg2, string arg3, uint256 arg4, string arg5, uint256 arg6) payable {
    ...
    staticcall stor7.getUser(uint256 arg1) with:
            gas gas_remaining wei
           args mem[96]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if address(playerDetails[arg1][mem[96]]):
        revert with 0, 'One entry per stake'
    uint256(playerDetails[arg1][mem[96]]) = msg.sender or Mask(96, 160, uint256(playerDetails[arg1][mem[96]]))
    if stor5 != stakeToken[arg1]:
        ...
        if stor5 != stakeToken[arg1]:
            ...
            call stakeToken[arg1].transferFrom(address arg1, address arg2, uint256 arg3) with:
                 gas gas_remaining wei
        ...
        if stor5 == stakeToken[arg1]:
            ...
            require ext_code.size(stakeToken[arg1])
            staticcall stakeToken[arg1].balanceOf(address arg1) with:
                    gas gas_remaining wei
                   args this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function returnSidepot(bytes32 arg1, uint256 arg2, address arg3) payable {
    ...
    if var26002 > var26001:
        ...
        if arg2 == uint256(stor[(4 * var30001) + sha3(var30002)]):
            ...
            address(playerDetails[arg1][arg2]) = 0
...
function refund(bytes32 arg1, uint256 arg2, string arg3, bool arg4) {
    ...
    if stor5 == stakeToken[arg1]:
        ...
        require ext_code.size(stakeToken[arg1])
        staticcall stakeToken[arg1].allowance(address arg1, address arg2) with:
                gas gas_remaining wei
               args address(this.address), this.address
        mem[arg3.length + ceil32(arg3.length) + ceil32(return_data.size) + 160] = ext_call.return_data[0]
        if not ext_call.success:
    ...
    if var54002 > var54001:
        ...
        if not arg2:
            ...
            if stor5 == stakeToken[arg1]:
                ...
                if var56001 >= uint256(stakeMembers[arg1].field_0):
                    revert with 0, 50
                address(playerDetails[arg1][uint256(stor10[arg1][var56001].field_0)]) = 0
                if var56001 == -1:
                    revert with 0, 17
                mem[0] = arg1
                mem[32] = 10
