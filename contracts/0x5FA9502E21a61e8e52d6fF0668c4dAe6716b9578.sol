...
function roll(uint256 arg1, uint256 arg2) {
            ...
            if not ('cd', 4).length:
                ...
                if not ('cd', 4).length:
                    ...
                    if stor1 > -(sha3(block.timestamp, 0) % 20) - 2:
                        revert with 'NH{q', 17
                    if stor1 + (sha3(block.timestamp, 0) % 20) <= stor2 + (sha3(mem[_1413 + 32 len mem[_1413]]) % 20):
                        call stor4 with:
                           value 19 * 10^17 wei
                             gas 0 wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        sub_35670d2d[stor3] = 2
                    ...
                    if stor1 > -(sha3(block.timestamp, 0) % 20) - 2:
                        revert with 'NH{q', 17
                    if stor1 + (sha3(block.timestamp, 0) % 20) <= stor2 + (sha3(mem[_1416 + 32 len mem[_1416]]) % 20):
                        call stor4 with:
                           value 19 * 10^17 wei
                             gas 0 wei
                        if not ext_call.success:
                ...
                if not ('cd', 4).length:
                    ...
                    if stor1 > -(sha3(block.timestamp, 0) % 20) - 2:
                        revert with 'NH{q', 17
                    if stor1 + (sha3(block.timestamp, 0) % 20) <= stor2 + (sha3(mem[_1419 + 32 len mem[_1419]]) % 20):
                        call stor4 with:
                           value 19 * 10^17 wei
                             gas 0 wei
                        if not ext_call.success:
                    ...
                    if stor1 > -(sha3(block.timestamp, 0) % 20) - 2:
                        revert with 'NH{q', 17
                    if stor1 + (sha3(block.timestamp, 0) % 20) <= stor2 + (sha3(mem[_1422 + 32 len mem[_1422]]) % 20):
                        call stor4 with:
                           value 19 * 10^17 wei
                             gas 0 wei
                        if not ext_call.success:
        ...
        if stor1 <= 0:
            ...
            if not ('cd', 4).length:
                ...
                if not ('cd', 4).length:
                    ...
                    if stor1 > -(sha3(block.timestamp, 0) % 20) - 2:
                        revert with 'NH{q', 17
                    if stor1 + (sha3(block.timestamp, 0) % 20) <= stor2 + (sha3(mem[_1425 + 32 len mem[_1425]]) % 20):
                        call stor4 with:
                           value 19 * 10^17 wei
                             gas 0 wei
                        if not ext_call.success:
                    ...
                    if stor1 > -(sha3(block.timestamp, 0) % 20) - 2:
                        revert with 'NH{q', 17
                    if stor1 + (sha3(block.timestamp, 0) % 20) <= stor2 + (sha3(mem[_1428 + 32 len mem[_1428]]) % 20):
                        call stor4 with:
                           value 19 * 10^17 wei
                             gas 0 wei
                        if not ext_call.success:
                ...
                if not ('cd', 4).length:
                    ...
                    if stor1 > -(sha3(block.timestamp, 0) % 20) - 2:
                        revert with 'NH{q', 17
                    if stor1 + (sha3(block.timestamp, 0) % 20) <= stor2 + (sha3(mem[_1431 + 32 len mem[_1431]]) % 20):
                        call stor4 with:
                           value 19 * 10^17 wei
                             gas 0 wei
                        if not ext_call.success:
                    ...
                    if stor1 > -(sha3(block.timestamp, 0) % 20) - 2:
                        revert with 'NH{q', 17
                    if stor1 + (sha3(block.timestamp, 0) % 20) <= stor2 + (sha3(mem[_1434 + 32 len mem[_1434]]) % 20):
                        call stor4 with:
                           value 19 * 10^17 wei
                             gas 0 wei
                        if not ext_call.success:
