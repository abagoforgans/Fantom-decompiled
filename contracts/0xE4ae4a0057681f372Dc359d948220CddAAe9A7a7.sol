...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    require ext_code.size(mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 204 len 20])
    call mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 204 len 20].swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
    ...
    mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 100)] + 36)]) + 196] = this.address
    ...
    _103 = mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 224]
    mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 100)] + 36)]) + 196] = mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 236 len 20]
    mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 100)] + 36)]) + 228] = 0
    require ext_code.size(mem[172 len 20])
    ...
    require 1 < cd[(arg5 + cd[(arg5 + 36)] + 36)]
    require 1 < cd[(arg5 + cd[(arg5 + 100)] + 36)]
    _113 = mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 224]
    mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 100)] + 36)]) + 196] = mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 236 len 20]
    mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 100)] + 36)]) + 228] = ext_call.return_data[0]
    require ext_code.size(mem[172 len 20])
    call mem[172 len 20].approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args address(_113), ext_call.return_data[0]
    mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 100)] + 36)]) + 192] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if not ext_call.return_data[0]:
        revert with 0, 'no success :('
    require 1 < cd[(arg5 + cd[(arg5 + 100)] + 36)]
    mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 100)] + 36)]) + 388 len floor32(cd[(arg5 + cd[(arg5 + 68)] + 36)])] = call.data[arg5 + cd[(arg5 + 68)] + 68 len floor32(cd[(arg5 + cd[(arg5 + 68)] + 36)])]
    require ext_code.size(mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 236 len 20])
    call mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 236 len 20].swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 1, Array(len=cd[(arg5 + cd[(arg5 + 68)] + 36)], data=call.data[arg5 + cd[(arg5 + 68)] + 68 len floor32(cd[(arg5 + cd[(arg5 + 68)] + 36)])], mem[(32 * cd[(arg5 + cd[(arg5 + 36)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) + (32 * cd[(arg5 + cd[(arg5 + 100)] + 36)]) + floor32(cd[(arg5 + cd[(arg5 + 68)] + 36)]) + 388 len (32 * cd[(arg5 + cd[(arg5 + 68)] + 36)]) - floor32(cd[(arg5 + cd[(arg5 + 68)] + 36)])]), address(this.address), block.timestamp + 1200
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require 0 < cd[(arg5 + cd[(arg5 + 36)] + 36)]
    require ext_code.size(mem[140 len 20])
