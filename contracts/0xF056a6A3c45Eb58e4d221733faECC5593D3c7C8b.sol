...
const INIT_CODE_PAIR_HASH = sha3(code.data[1947 len 9088], mem[18368 len 7], Mask(144, 56, code.data[11042 len 18]) >> 56)
...
function createPair(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    if arg1 == arg2:
        revert with 0, 'Shiba: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'Shiba: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'Shiba: PAIR_EXISTS'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[1947 len 9113]
