...
function buyToken(address arg1, address[] arg2, address[] arg3) payable {
    ...
    while idx < arg2.length:
        ...
        t = t + 32
        continue 
    mem[floor32(arg2.length) + floor32(arg3.length) + 166] = this.address
    mem[floor32(arg2.length) + floor32(arg3.length) + 198] = block.timestamp + 60
    ...
    if mem[_154] >= _151:
        ...
        mem[_157 + 132] = block.timestamp + 60
        require ext_code.size(stor3)
        call stor3.mem[mem[64] len 4] with:
             gas gas_remaining wei
        ...
        mem[_164 + 132] = block.timestamp + 60
        require ext_code.size(stor3)
        call stor3.mem[mem[64] len 4] with:
             gas gas_remaining wei
