...
const sub_6fdc7199(?) = 0x3c6b3f09d2504606936b1a4decefad204687890000200000000000000000015
...
function investedUnderlyingBalance() payable {
    ...
    staticcall nextImplementation['rewardPool'].0x93f1a40b with:
            gas gas_remaining wei
...
function emergencyExit() payable {
    ...
    if msg.sender == ext_call.return_data[12 len 20]:
        require ext_code.size(nextImplementation['rewardPool'])
        call nextImplementation['rewardPool'].emergencyWithdraw(uint256 arg1, address arg2) with:
             gas gas_remaining wei
            args nTokens['poolId'], this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
