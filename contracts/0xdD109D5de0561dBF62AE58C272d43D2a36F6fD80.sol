...
function batchSend(address[] arg1, uint256 arg2) payable {
    ...
    require arg2 == arg2
    if not stor0:
        revert with 0, 'Initable: not Initd'
    if adminAddress != msg.sender:
        revert with 0, 'Ownable: caller is not the clonedBy'
    idx = 0
    while idx < arg1.length:
        if idx >= arg1.length:
            revert with 'NH{q', 50
        ...
        mem[32] = 1
        if balanceOf[mem[(32 * idx) + 140 len 20]] > -arg2 - 1:
            revert with 'NH{q', 17
        balanceOf[mem[(32 * idx) + 140 len 20]] += arg2
        mem[(32 * arg1.length) + 128] = arg2
        emit Transfer(arg2, 0, address(_28));
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_9ab8367e(?) payable {
    ...
    if stor0:
        revert with 0, 'Initable: Initd'
    if bool(stor5.length):
        if bool(stor5.length) == stor5.length.field_1 < 32:
            revert with 'NH{q', 34
        if arg4.length:
            stor5[].field_0 = Array(len=arg4.length, data=arg4[all])
        else:
            stor5.length = 0
            idx = 0
    ...
    if bool(stor6.length):
        if bool(stor6.length) == stor6.length.field_1 < 32:
            revert with 'NH{q', 34
        if arg5.length:
            stor6[].field_0 = Array(len=arg5.length, data=arg5[all])
        else:
            stor6.length = 0
            idx = 0
    ...
    if stor0:
        revert with 0, 'Initable: Initd'
    stor0 = 1
    mem[ceil32(arg4.length) + ceil32(arg5.length) + 160] = msg.sender
    emit 0x64b1a77f: Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[ceil32(arg4.length) + arg5.length + 192 len -arg5.length + ceil32(arg5.length)]
