...
function approve(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    staticcall rmAddress.getApproved(uint256 arg1) with:
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        require ext_code.size(rmAddress)
        staticcall rmAddress.ownerOf(uint256 arg1) with:
                gas gas_remaining wei
               args arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[12 len 20] != msg.sender:
            ...
            require ext_call.return_data[0] == ext_call.return_data[12 len 20]
            require ext_code.size(rmAddress)
            staticcall rmAddress.isApprovedForAll(address arg1, address arg2) with:
                    gas gas_remaining wei
