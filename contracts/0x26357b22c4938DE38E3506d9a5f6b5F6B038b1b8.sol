...
function sub_648f9003(?) payable {
    ...
    mem[(32 * arg2.length) + 128] = 0xab9b85c00000000000000000000000000000000000000000000000000000000
...
function sub_832ce533(?) payable {
    ...
    while idx < arg4.length:
        ...
        if not sub_6a0341b8.length:
            mem[mem[64]] = 0xab9b85c00000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = arg1
            mem[mem[64] + 68] = arg5
            mem[mem[64] + 36] = 96
            ...
            if not ext_call.success:
                ...
                if not _81 % 32:
                    ...
                    if not mem[_75 + ceil32(return_data.size)] % 32:
                        emit Log(string rg1):
                                 32,
                                 mem[_81 + _75 + ceil32(return_data.size) + 64 len mem[_75 + ceil32(return_data.size)] + 32],
                    else:
                        ...
                        emit Log(Array(len=mem[_75 + ceil32(return_data.size)], data=mem[_81 + _75 + ceil32(return_data.size) + 96 len floor32(mem[_75 + ceil32(return_data.size)]) + 32]));
                else:
                    ...
                    if not mem[_75 + ceil32(return_data.size)] % 32:
                        emit Log(string rg1):
                                 32,
                                 mem[floor32(_81) + _75 + ceil32(return_data.size) + 96 len mem[_75 + ceil32(return_data.size)] + 32],
                    else:
                        ...
                        emit Log(Array(len=mem[_75 + ceil32(return_data.size)], data=mem[floor32(_81) + _75 + ceil32(return_data.size) + 128 len floor32(mem[_75 + ceil32(return_data.size)]) + 32]));
                sub_8f7371e0++
        else:
            mem[0] = 0
