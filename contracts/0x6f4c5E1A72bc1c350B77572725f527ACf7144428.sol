...
function sub_f46ac5a4(?) {
    ...
    staticcall token[arg1].0x70a08231 with:
...
function sub_2361b002(?) {
    ...
    staticcall sub_7fc0771b[arg2].0xcd7724c3 with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_67b47b34(?) {
    require calldata.size - 4 >= 64
    require ext_code.size(sub_7fc0771b[arg2])
    staticcall sub_7fc0771b[arg2].0x2640f62c with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8ebbf7cf(?) {
    require calldata.size - 4 >= 64
    require ext_code.size(token[arg1])
    staticcall token[arg1].0xdd62ed3e with:
            gas gas_remaining wei
...
function sub_e2383661(?) {
    ...
    if owner != msg.sender:
        require msg.sender == controllerAddress
    require ext_code.size(token[arg1])
    call token[arg1].0xa9059cbb with:
         gas gas_remaining wei
        args address(arg2), arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_3d9fcd98(?) {
    ...
    if owner != msg.sender:
        require msg.sender == controllerAddress
    require ext_code.size(sub_7fc0771b[arg2])
    call sub_7fc0771b[arg2].0x95e3c50b with:
         gas gas_remaining wei
...
function sub_65f0ef22(?) payable {
    ...
    if owner != msg.sender:
        require msg.sender == controllerAddress
    require ext_code.size(sub_7fc0771b[arg2])
    call sub_7fc0771b[arg2].0xf39b5b9b with:
       value arg1 wei
         gas gas_remaining wei
...
function sub_444719d7(?) {
    ...
    if eth.balance(this.address) >= maxBuy:
        if bool(uint8(sub_16d74413)) == 1:
            staticcall sub_7fc0771b[arg1].0x2640f62c with:
                    gas gas_remaining wei
    ...
    if owner != msg.sender:
        require msg.sender == controllerAddress
    require ext_code.size(sub_7fc0771b[arg1])
    call sub_7fc0771b[arg1].0x95e3c50b with:
         gas gas_remaining wei
...
function sub_daca6256(?) {
    ...
    if eth.balance(this.address) >= maxBuy:
        if bool(uint8(sub_16d74413)) == 1:
            ...
            require return_data.size >= 32
            require ext_code.size(sub_7fc0771b[arg1])
            staticcall sub_7fc0771b[arg1].0xcd7724c3 with:
                    gas gas_remaining wei
                   args Mask(252, 0, stor2.field_4)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] > ext_call.return_data[0]:
            if owner != msg.sender:
                require msg.sender == controllerAddress
            require ext_code.size(sub_7fc0771b[arg1])
            call sub_7fc0771b[arg1].0xf39b5b9b with:
               value maxBuy wei
                 gas gas_remaining wei
                args 1, block.timestamp + 10000
        else:
