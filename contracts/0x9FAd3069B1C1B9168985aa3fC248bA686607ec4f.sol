...
const INITIAL_DISTRIBUTION = 100000 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    if not arg1:
        revert with 0, '!_distributionPool'
    Mask(96, 0, stor6.field_160) = 1
    if totalSupply + 100000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 100000 * 10^18
    if balanceOf[address(arg1)] + 100000 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 100000 * 10^18
    emit Transfer(100000 * 10^18, 0, arg1);
}
