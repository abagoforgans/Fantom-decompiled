...
function sub_f45f0b04(?) payable {
    return sub_f45f0b04Address
}
...
function sub_b975b8b2(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if adminAddress != msg.sender:
        revert with 0, 'only admin can approve shitcoins'
