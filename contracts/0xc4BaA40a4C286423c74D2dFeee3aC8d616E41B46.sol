...
function toggleIsPaused() {
    if owner != msg.sender:
        revert with 0, 'sOwnable: caller is not the owne'
    Mask(96, 0, stor8.field_160) = Mask(96, 0, not uint8(stor8.field_160))
    emit PauseToggled(bool(0 or uint8(not uint8(stor8.field_160))));
}
...
function createAuction(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) {
    ...
    call marketplaceAddress.0xa302069f with:
         gas gas_remaining wei
