...
function kinsTransfer(address arg1, uint256 arg2) payable {
    ...
    staticcall kinsAddress.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if arg2 <= ext_call.return_data[0]:
        if arg2:
            require ext_code.size(kinsAddress)
            call kinsAddress.transfer(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
...
function getKinsPrice(uint256 arg1) payable {
    ...
    if kinsAddress != poolInfo[arg1].field_256:
        if poolInfo[arg1].field_768 > poolInfo[arg1].field_1024:
            if poolInfo[arg1].field_1024 > poolInfo[arg1].field_768:
                revert with 0, 'SafeMath: subtraction overflow'
            if Mask(112, 0, ext_call.return_data[32]):
                return (10^(poolInfo[arg1].field_768 + -poolInfo[arg1].field_1024 + 18) * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]))
        else:
            if poolInfo[arg1].field_768 >= poolInfo[arg1].field_1024:
                ...
                if poolInfo[arg1].field_768 > poolInfo[arg1].field_1024:
                    revert with 0, 'SafeMath: subtraction overflow'
                if Mask(112, 0, ext_call.return_data[32]):
                    return (10^(-poolInfo[arg1].field_1024 + poolInfo[arg1].field_768 + 18) * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]))
    else:
        if poolInfo[arg1].field_768 > poolInfo[arg1].field_1024:
            if poolInfo[arg1].field_1024 > poolInfo[arg1].field_768:
                revert with 0, 'SafeMath: subtraction overflow'
            if Mask(112, 0, ext_call.return_data[0]):
                return (10^(poolInfo[arg1].field_768 + -poolInfo[arg1].field_1024 + 18) * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]))
        else:
            if poolInfo[arg1].field_768 >= poolInfo[arg1].field_1024:
                ...
                if poolInfo[arg1].field_768 > poolInfo[arg1].field_1024:
                    revert with 0, 'SafeMath: subtraction overflow'
                if Mask(112, 0, ext_call.return_data[0]):
                    return (10^(-poolInfo[arg1].field_1024 + poolInfo[arg1].field_768 + 18) * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]))
    revert
}
...
function getDepositValue(uint256 arg1, uint256 arg2) payable {
    ...
    staticcall poolInfo[arg2].field_0.totalSupply() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if kinsAddress != poolInfo[arg2].field_256:
        if poolInfo[arg2].field_768 > poolInfo[arg2].field_1024:
            if poolInfo[arg2].field_1024 > poolInfo[arg2].field_768:
                revert with 0, 'SafeMath: subtraction overflow'
