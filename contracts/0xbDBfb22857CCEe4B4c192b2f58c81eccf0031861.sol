...
function myListLength(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return myListLength[address(arg1)]
}
...
function list(uint256 arg1, uint256 arg2) {
    ...
    require ext_code.size(itemAddress)
    call itemAddress.safeTransferFrom(address arg1, address arg2, uint256 arg3) with:
    ...
    if not myListLength[msg.sender][1][arg1]:
        myListLength[msg.sender]++
        myListLength[msg.sender][myListLength[msg.sender]] = arg1
        myListLength[msg.sender][1][arg1] = myListLength[msg.sender]
...
function myListsAt(address arg1, uint256 arg2, uint256 arg3) {
    ...
    while idx < arg3:
        if arg2 > !idx:
            revert with 0, 17
        if arg2 + idx >= myListLength[address(arg1)]:
            revert with 0, 50
        if idx >= arg3:
            revert with 0, 50
        mem[(32 * idx) + 128] = stor[('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'myListLength', 6)) + arg2 + idx]
        if idx >= arg3:
            revert with 0, 50
        mem[0] = stor[('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'myListLength', 6)) + arg2 + idx]
        mem[32] = 7
...
function unlist(uint256 arg1) {
    ...
    if stor5[arg1]:
        ...
        stor4.length--
        stor5[arg1] = 0
    if myListLength[msg.sender][1][arg1]:
        if myListLength[msg.sender][1][arg1] < 1:
            revert with 0, 17
        if myListLength[msg.sender] < 1:
            revert with 0, 17
        if myListLength[msg.sender] - 1 != myListLength[msg.sender][1][arg1] - 1:
            if myListLength[msg.sender] - 1 >= myListLength[msg.sender]:
                revert with 0, 50
            if myListLength[msg.sender][1][arg1] - 1 >= myListLength[msg.sender]:
                revert with 0, 50
            myListLength[msg.sender][myListLength[msg.sender][1][arg1]] = myListLength[msg.sender][myListLength[msg.sender]]
            myListLength[msg.sender][1][myListLength[msg.sender][myListLength[msg.sender]]] = myListLength[msg.sender][1][arg1]
        if not myListLength[msg.sender]:
            revert with 0, 49
        myListLength[msg.sender][myListLength[msg.sender]] = 0
        myListLength[msg.sender]--
        myListLength[msg.sender][1][arg1] = 0
...
function buy(uint256 arg1) payable {
    ...
    if stor5[arg1]:
        ...
        stor4.length--
        stor5[arg1] = 0
    if myListLength[address(stor8[arg1])][1][arg1]:
        if myListLength[address(stor8[arg1])][1][arg1] < 1:
            revert with 0, 17
        if myListLength[address(stor8[arg1])] < 1:
            revert with 0, 17
        if myListLength[address(stor8[arg1])] - 1 != myListLength[address(stor8[arg1])][1][arg1] - 1:
            if myListLength[address(stor8[arg1])] - 1 >= myListLength[address(stor8[arg1])]:
                revert with 0, 50
            if myListLength[address(stor8[arg1])][1][arg1] - 1 >= myListLength[address(stor8[arg1])]:
                revert with 0, 50
            myListLength[address(stor8[arg1])][myListLength[address(stor8[arg1])][1][arg1]] = myListLength[address(stor8[arg1])][myListLength[address(stor8[arg1])]]
            myListLength[address(stor8[arg1])][1][myListLength[address(stor8[arg1])][myListLength[address(stor8[arg1])]]] = myListLength[address(stor8[arg1])][1][arg1]
        if not myListLength[address(stor8[arg1])]:
            revert with 0, 49
        myListLength[address(stor8[arg1])][myListLength[address(stor8[arg1])]] = 0
        myListLength[address(stor8[arg1])]--
        myListLength[address(stor8[arg1])][1][arg1] = 0
