            ...
            while u < stor5.length:
                ...
                if ceil32(_326) <= _326:
                    ...
                    if (sha3(mem[_356 + 32 len mem[_356]]) % 4) + mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257] and 30 > -1 / (sha3(mem[_356 + 32 len mem[_356]]) % 4) + mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257]:
                        revert with 'NH{q', 17
                    if stor7 > (-30 * sha3(mem[_356 + 32 len mem[_356]]) % 4) + (-30 * mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257]) - 1:
                        revert with 'NH{q', 17
                    if idx >= mem[floor32(('cd', 4).length) + 97]:
                        revert with 'NH{q', 50
                    mem[(32 * idx) + floor32(('cd', 4).length) + 129] = stor7 + (30 * sha3(mem[_356 + 32 len mem[_356]]) % 4) + (30 * mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257])
                    if s > -stor7 + (-30 * _358 % 4) + (-30 * _362) - 1:
                        revert with 'NH{q', 17
                    if idx == -1:
                        revert with 'NH{q', 17
                    idx = idx + 1
                    s = s + stor7 + (30 * _358 % 4) + (30 * _362)
                    t = _358
                    continue 
                mem[_311 + _326 + 192] = 0
                _363 = mem[64]
                ...
                if (sha3(mem[_363 + 32 len mem[_363]]) % 4) + mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257] and 30 > -1 / (sha3(mem[_363 + 32 len mem[_363]]) % 4) + mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257]:
                    revert with 'NH{q', 17
                if stor7 > (-30 * sha3(mem[_363 + 32 len mem[_363]]) % 4) + (-30 * mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257]) - 1:
                    revert with 'NH{q', 17
                if idx >= mem[floor32(('cd', 4).length) + 97]:
                    revert with 'NH{q', 50
                mem[(32 * idx) + floor32(('cd', 4).length) + 129] = stor7 + (30 * sha3(mem[_363 + 32 len mem[_363]]) % 4) + (30 * mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257])
                if s > -stor7 + (-30 * _365 % 4) + (-30 * _372) - 1:
                    revert with 'NH{q', 17
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
                s = s + stor7 + (30 * _365 % 4) + (30 * _372)
                t = _365
                continue 
            ...
            while u < stor5.length:
                ...
                if ceil32(_327) <= _327:
                    ...
                    if (sha3(mem[_359 + 32 len mem[_359]]) % 4) + mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257] and 30 > -1 / (sha3(mem[_359 + 32 len mem[_359]]) % 4) + mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257]:
                        revert with 'NH{q', 17
                    if stor7 > (-30 * sha3(mem[_359 + 32 len mem[_359]]) % 4) + (-30 * mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257]) - 1:
                        revert with 'NH{q', 17
                    if idx >= mem[floor32(('cd', 4).length) + 97]:
                        revert with 'NH{q', 50
                    mem[(32 * idx) + floor32(('cd', 4).length) + 129] = stor7 + (30 * sha3(mem[_359 + 32 len mem[_359]]) % 4) + (30 * mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257])
                    if s > -stor7 + (-30 * _361 % 4) + (-30 * _366) - 1:
                        revert with 'NH{q', 17
                    if idx == -1:
                        revert with 'NH{q', 17
                    idx = idx + 1
                    s = s + stor7 + (30 * _361 % 4) + (30 * _366)
                    t = _361
                    continue 
                mem[_315 + _327 + 192] = 0
                _367 = mem[64]
                ...
                if (sha3(mem[_367 + 32 len mem[_367]]) % 4) + mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257] and 30 > -1 / (sha3(mem[_367 + 32 len mem[_367]]) % 4) + mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257]:
                    revert with 'NH{q', 17
                if stor7 > (-30 * sha3(mem[_367 + 32 len mem[_367]]) % 4) + (-30 * mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257]) - 1:
                    revert with 'NH{q', 17
                if idx >= mem[floor32(('cd', 4).length) + 97]:
                    revert with 'NH{q', 50
                mem[(32 * idx) + floor32(('cd', 4).length) + 129] = stor7 + (30 * sha3(mem[_367 + 32 len mem[_367]]) % 4) + (30 * mem[floor32(('cd', 4).length) + (32 * ('cd', 4).length) + 257])
                if s > -stor7 + (-30 * _369 % 4) + (-30 * _375) - 1:
                    revert with 'NH{q', 17
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
                s = s + stor7 + (30 * _369 % 4) + (30 * _375)
                t = _369
                continue 
            revert with 0, 'Wrong class for the Attack Action!'
        if s > sub_e5aa0b62:
