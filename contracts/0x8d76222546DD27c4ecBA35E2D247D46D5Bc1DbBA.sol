...
function sub_422e49f7(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        idx = idx + 1
        continue 
    if not sub_322a1c8a[address(msg.sender)]:
        ...
        if ('cd', 4).length:
            ...
            while idx < ('cd', 4).length:
                ...
                _952 = sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128])
                _963 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288]
                ...
                if cd[68] > 1:
                    revert with 'NH{q', 33
                if cd[68]:
                    _997 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 256]
                    t = 0
                    while t < stor4.length:
                        ...
                        if idx >= mem[(32 * ('cd', 4).length) + 128]:
                            revert with 'NH{q', 50
                        mem[(32 * idx) + (32 * ('cd', 4).length) + 160] = stor7 + (50 * _952 % 4) + (50 * _963)
                        if s > -stor7 + (-50 * _952 % 4) + (-50 * _963) - 1:
                            revert with 'NH{q', 17
                        if idx == -1:
                            revert with 'NH{q', 17
                        idx = idx + 1
                        s = s + stor7 + (50 * _952 % 4) + (50 * _963)
                        t = _952
                        continue 
                    revert with 0, 'Wrong class for the Heal Action!'
                _998 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 256]
                t = 0
            ...
            while idx < ('cd', 4).length:
                ...
                while t < 128:
                    ...
                    continue 
                mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512] = 128
                _949 = sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128])
                _959 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288]
                if sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128]) % 4 > -mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288] - 1:
                    revert with 'NH{q', 17
                if (sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128]) % 4) + mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288] and 50 > -1 / (sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128]) % 4) + mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288]:
                    revert with 'NH{q', 17
                ...
                if cd[68] > 1:
                    revert with 'NH{q', 33
                if cd[68]:
                    _995 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 256]
                    t = 0
                    while t < stor4.length:
                        mem[0] = 4
                        if stor4[t] != _995:
                        ...
                        if idx >= mem[(32 * ('cd', 4).length) + 128]:
                            revert with 'NH{q', 50
                        mem[(32 * idx) + (32 * ('cd', 4).length) + 160] = stor7 + (50 * _949 % 4) + (50 * _959)
                        if s > -stor7 + (-50 * _949 % 4) + (-50 * _959) - 1:
                            revert with 'NH{q', 17
                        if idx == -1:
                            revert with 'NH{q', 17
                        idx = idx + 1
                        s = s + stor7 + (50 * _949 % 4) + (50 * _959)
                        t = _949
                        continue 
                    revert with 0, 'Wrong class for the Heal Action!'
                _996 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 256]
                t = 0
                while t < stor5.length:
                    mem[0] = 5
                    if stor5[t] != _996:
        ...
        if sub_322a1c8a[address(msg.sender)] > -7201:
            revert with 'NH{q', 17
        if sub_322a1c8a[address(msg.sender)] + (2 * 3600) > block.timestamp:
            revert with 0, 'Wait two hours before next set of actions!'
        if ('cd', 4).length > test266151307():
            revert with 'NH{q', 65
        mem[(32 * ('cd', 4).length) + 128] = ('cd', 4).length
        if ('cd', 4).length:
            ...
            while idx < ('cd', 4).length:
                ...
                while t < 128:
                    ...
                    continue 
                mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512] = 128
                _958 = sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128])
                _971 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288]
                if sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128]) % 4 > -mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288] - 1:
                    revert with 'NH{q', 17
                if (sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128]) % 4) + mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288] and 50 > -1 / (sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128]) % 4) + mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288]:
                    revert with 'NH{q', 17
                ...
                if cd[68] > 1:
                    revert with 'NH{q', 33
                if cd[68]:
                    _1001 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 256]
                    t = 0
                    while t < stor4.length:
                        mem[0] = 4
                        if stor4[t] != _1001:
                        ...
                        if idx >= mem[(32 * ('cd', 4).length) + 128]:
                            revert with 'NH{q', 50
                        mem[(32 * idx) + (32 * ('cd', 4).length) + 160] = stor7 + (50 * _958 % 4) + (50 * _971)
                        if s > -stor7 + (-50 * _958 % 4) + (-50 * _971) - 1:
                            revert with 'NH{q', 17
                        if idx == -1:
                            revert with 'NH{q', 17
                        idx = idx + 1
                        s = s + stor7 + (50 * _958 % 4) + (50 * _971)
                        t = _958
                        continue 
                    revert with 0, 'Wrong class for the Heal Action!'
                _1002 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 256]
                t = 0
                while t < stor5.length:
                    mem[0] = 5
                    if stor5[t] != _1002:
            ...
            while idx < ('cd', 4).length:
                ...
                while t < 128:
                    ...
                    continue 
                mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512] = 128
                _955 = sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128])
                _967 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288]
                if sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128]) % 4 > -mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288] - 1:
                    revert with 'NH{q', 17
                if (sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128]) % 4) + mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288] and 50 > -1 / (sha3(mem[(64 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 544 len 128]) % 4) + mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 288]:
                    revert with 'NH{q', 17
                ...
                if cd[68] > 1:
                    revert with 'NH{q', 33
                if cd[68]:
                    _999 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 256]
                    t = 0
                    while t < stor4.length:
                        mem[0] = 4
                        if stor4[t] != _999:
                        ...
                        if idx >= mem[(32 * ('cd', 4).length) + 128]:
                            revert with 'NH{q', 50
                        mem[(32 * idx) + (32 * ('cd', 4).length) + 160] = stor7 + (50 * _955 % 4) + (50 * _967)
                        if s > -stor7 + (-50 * _955 % 4) + (-50 * _967) - 1:
                            revert with 'NH{q', 17
                        if idx == -1:
                            revert with 'NH{q', 17
                        idx = idx + 1
                        s = s + stor7 + (50 * _955 % 4) + (50 * _967)
                        t = _955
                        continue 
                    revert with 0, 'Wrong class for the Heal Action!'
                _1000 = mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 256]
                t = 0
                while t < stor5.length:
                    mem[0] = 5
                    if stor5[t] != _1000:
