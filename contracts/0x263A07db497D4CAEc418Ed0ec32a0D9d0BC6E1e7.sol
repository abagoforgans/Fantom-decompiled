...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    mem[(7 * ceil32(return_data.size)) + 196] = arg3 / 3
    ...
    call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3 / 3, ext_call.return_data[0], Array(len=2, data=mem[(7 * ceil32(return_data.size)) + 388 len 64]), msg.sender, block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    _70 = mem[(7 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3 / 3) >> 32
    require mem[(7 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3 / 3) >> 32 <= test266151307()
    require (7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3 / 3) >> 32 + 223 < (7 * ceil32(return_data.size)) + return_data.size + 192
    _71 = mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3 / 3) >> 32 + 192]
    require mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3 / 3) >> 32 + 192] <= test266151307()
    require (8 * ceil32(return_data.size)) + (32 * mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3 / 3) >> 32 + 192]) + 224 <= test266151307() and (32 * mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3 / 3) >> 32 + 192]) + 32 >= 0
    mem[64] = (8 * ceil32(return_data.size)) + (32 * mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3 / 3) >> 32 + 192]) + 224
    mem[(8 * ceil32(return_data.size)) + 192] = _71
    require _70 + (32 * _71) + 32 <= return_data.size
    idx = 0
    s = (7 * ceil32(return_data.size)) + _70 + 224
    ...
    call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
         gas gas_remaining wei
        args stor0, _101, 97 * _101 / 100, arg3 / 3, address(this.address), block.timestamp
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[mem[64] + 36] = mem[_114]
    mem[mem[64] + 68] = 97 * _115 / 100
    mem[mem[64] + 100] = arg3 / 3
    mem[mem[64] + 132] = this.address
    mem[mem[64] + 164] = block.timestamp
    require ext_code.size(0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52)
    call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.removeLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
         gas gas_remaining wei
        args stor0, _115, 97 * _115 / 100, arg3 / 3, address(this.address), block.timestamp
    ...
    mem[mem[64] + ceil32(return_data.size) + 100] = _128
    mem[mem[64] + ceil32(return_data.size) + 132] = Mask(112, 0, ext_call.return_data[32])
    mem[mem[64] + ceil32(return_data.size) + 164] = Mask(112, 0, ext_call.return_data[0])
    require ext_code.size(0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52)
    staticcall 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.getAmountOut(uint256 arg1, uint256 arg2, uint256 arg3) with:
            gas gas_remaining wei
           args _128, ext_call.return_data[32] << 144, Mask(112, 0, ext_call.return_data[0])
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    mem[_129 + (2 * ceil32(return_data.size)) + 96] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
    mem[_129 + (2 * ceil32(return_data.size)) + 100] = _128
    mem[_129 + (2 * ceil32(return_data.size)) + 132] = ext_call.return_data[0]
    mem[_129 + (2 * ceil32(return_data.size)) + 164] = 160
    mem[_129 + (2 * ceil32(return_data.size)) + 260] = mem[_129]
    idx = 0
    s = _129 + 32
    t = _129 + (2 * ceil32(return_data.size)) + 292
    while idx < mem[_129]:
        mem[t] = mem[s + 12 len 20]
        idx = idx + 1
        s = s + 32
        t = t + 32
        continue 
    mem[_129 + (2 * ceil32(return_data.size)) + 196] = msg.sender
    mem[_129 + (2 * ceil32(return_data.size)) + 228] = block.timestamp
    require ext_code.size(0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52)
    call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.swapExactTokensForETH(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args _128, ext_call.return_data[0], 160, msg.sender, block.timestamp, mem[_129 + (2 * ceil32(return_data.size)) + 260 len (32 * mem[_129]) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[_129 + (2 * ceil32(return_data.size)) + 96 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = _129 + (4 * ceil32(return_data.size)) + 96
    require return_data.size >= 32
    _166 = mem[_129 + (2 * ceil32(return_data.size)) + 96 len 4], Mask(224, 32, _128) >> 32
    require mem[_129 + (2 * ceil32(return_data.size)) + 96 len 4], Mask(224, 32, _128) >> 32 <= test266151307()
    require _129 + (2 * ceil32(return_data.size)) + mem[_129 + (2 * ceil32(return_data.size)) + 96 len 4], Mask(224, 32, _128) >> 32 + 127 < _129 + (2 * ceil32(return_data.size)) + return_data.size + 96
    _167 = mem[_129 + (2 * ceil32(return_data.size)) + mem[_129 + (2 * ceil32(return_data.size)) + 96 len 4], Mask(224, 32, _128) >> 32 + 96]
    require mem[_129 + (2 * ceil32(return_data.size)) + mem[_129 + (2 * ceil32(return_data.size)) + 96 len 4], Mask(224, 32, _128) >> 32 + 96] <= test266151307()
    require _129 + (4 * ceil32(return_data.size)) + (32 * mem[_129 + (2 * ceil32(return_data.size)) + mem[_129 + (2 * ceil32(return_data.size)) + 96 len 4], Mask(224, 32, _128) >> 32 + 96]) + 128 <= test266151307() and (32 * mem[_129 + (2 * ceil32(return_data.size)) + mem[_129 + (2 * ceil32(return_data.size)) + 96 len 4], Mask(224, 32, _128) >> 32 + 96]) + 32 >= 0
    mem[64] = _129 + (4 * ceil32(return_data.size)) + (32 * mem[_129 + (2 * ceil32(return_data.size)) + mem[_129 + (2 * ceil32(return_data.size)) + 96 len 4], Mask(224, 32, _128) >> 32 + 96]) + 128
    mem[_129 + (4 * ceil32(return_data.size)) + 96] = _167
    require _166 + (32 * _167) + 32 <= return_data.size
    idx = 0
    s = _129 + (2 * ceil32(return_data.size)) + _166 + 128
    t = _129 + (4 * ceil32(return_data.size)) + 128
    while idx < _167:
        require mem[s] == mem[s]
        mem[t] = mem[s]
        idx = idx + 1
    ...
    mem[mem[64] + 4] = owner
    mem[mem[64] + 36] = _188 - ext_call.return_data[0] - arg4
    require ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83)
    call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args owner, _188 - ext_call.return_data[0] - arg4
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _191 = mem[64]
