...
function _fallback() payable {
    ...
    staticcall address(stor7.field_0).gas() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function waitToCross(uint32 arg1, uint32 arg2, uint256 arg3) {
    ...
    require return_data.size >= 32
    require ext_code.size(address(stor7.field_0))
    call address(stor7.field_0).addAllowance_OB(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
    ...
    require ext_code.size(address(stor7.field_0))
    call address(stor7.field_0).updateShares_OB(address arg1) with:
         gas gas_remaining wei
        args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
