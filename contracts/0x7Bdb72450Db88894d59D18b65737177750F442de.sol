...
function royaltyInfo(uint256 arg1, uint256 arg2) payable {
    ...
    if not stor16:
        revert with 'NH{q', 18
    return creator[arg1], arg2 * stor15 / stor16
}
...
function sub_ad406016(?) payable {
    ...
    staticcall stor17.0x126ff871 with:
...
function mint(string arg1) payable {
    ...
    if stor6[stor12].field_0:
        if stor6[stor12].field_0 == stor6[stor12].field_1 < 32:
            revert with 'NH{q', 34
        if arg1.length:
            stor6[stor12][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
