...
function sub_0dcfcc42(?) payable {
    ...
    require return_data.size >= 32
    _29 = mem[192 len 4], Mask(224, 32, arg3) >> 32
    ...
    _30 = mem[mem[192 len 4], Mask(224, 32, arg3) >> 32 + 192]
...
function sub_3e7b62de(?) payable {
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length:
            ...
            require 2 < _126
            require idx < mem[96]
            mem[(32 * idx) + 128] = mem[_122 + ceil32(return_data.size) + 96]
            idx = idx + 1
            continue 
    else:
        ...
        while idx < ('cd', 36).length:
            ...
            require 2 < _127
            require idx < mem[96]
            mem[(32 * idx) + 128] = mem[_123 + ceil32(return_data.size) + 96]
            idx = idx + 1
            continue 
    mem[mem[64]] = 32
...
function sub_6b1bdbc9(?) payable {
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length:
            ...
            require 2 < _162
            require idx < mem[96]
            mem[(32 * idx) + 128] = mem[_157 + ceil32(return_data.size) + 96]
            idx = idx + 1
            continue 
    else:
        mem[128 len 32 * ('cd', 36).length] = call.data[calldata.size len 32 * ('cd', 36).length]
        ...
        while idx < ('cd', 36).length:
            ...
            require 2 < _163
            require idx < mem[96]
            mem[(32 * idx) + 128] = mem[_159 + ceil32(return_data.size) + 96]
            idx = idx + 1
            continue 
    idx = 0
    s = 0
