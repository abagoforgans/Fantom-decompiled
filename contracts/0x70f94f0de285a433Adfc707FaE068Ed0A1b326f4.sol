        ...
        if tx.origin == owner:
            ...
            if paused:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(lpPairAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, ext_call.return_data[0] - (10 * ext_call.return_data[0] / 10000)) >> 32
                    mem[324 len 0] = 0
                    call lpPairAddress with:
                       funct uint32(stor4)
                         gas gas_remaining wei
        ...
        if tx.origin == owner:
            ...
            if paused:
                ...
                if not arg1:
                    ...
                    if ext_code.size(lpPairAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1 - (10 * arg1 / 10000)) >> 32
                    mem[324 len 0] = 0
                    call lpPairAddress with:
                       funct uint32(stor4)
                         gas gas_remaining wei
                    ...
                    if not return_data.size:
                        if not ext_call.success:
                            revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), arg1 - (10 * arg1 / 10000)
                        if not unknown_0xa9059cbb(?????), Mask(224, 0, stor4):
                            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                    else:
                        mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
...
function pause() payable {
    ...
    call lpPairAddress.0xcbceda20 with:
         gas gas_remaining wei
        args Mask(480, -256, approve(address rg1, uint256 rg2), 0x90df158ff7c31ad1d81dddb1, 0, 0) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
        ...
        if ext_code.size(0x575f8738efda7f512e3654f277c77e80c7d2725) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
        ...
        if not return_data.size:
            ...
            if ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
            ...
            if not return_data.size:
                ...
                if ext_code.size(lpToken0Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[752 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
                ...
                if not return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[916 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 917 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
                    call lpToken1Address.0xf12795fb with:
                         gas gas_remaining wei
                ...
                if ext_code.size(lpToken0Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 753 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
                call lpToken0Address.0xf12795fb with:
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 918 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
                    call lpToken1Address.0xf12795fb with:
                         gas gas_remaining wei
        ...
        if ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 589 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
        call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0xf12795fb with:
             gas gas_remaining wei
        ...
        if ext_code.size(lpToken0Address) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + 754 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
        call lpToken0Address.0xf12795fb with:
             gas gas_remaining wei
        ...
        if ext_code.size(0x575f8738efda7f512e3654f277c77e80c7d2725) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 425 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
        call 0x0575f8738efda7f512e3654f277c77e80c7d2725.0xf12795fb with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if ext_code.size(0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 590 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
            call 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83.0xf12795fb with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if ext_code.size(lpToken0Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 755 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
                ...
                if return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(4 * ceil32(return_data.size)) + 920 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
                    call lpToken1Address.0xf12795fb with:
                         gas gas_remaining wei
    ...
    if ext_code.size(lpToken1Address) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 919 len 64] = 0, 0x53c153a0df7e050bbefbb70ee9632061f12795fb, 0
