...
function getMultipleSortedTroves(int256 arg1, uint256 arg2) payable {
    ...
    if arg1 < 0:
        ...
        if arg2 <= ext_call.return_data[0] + arg1 + 1:
            ...
            while idx < -arg1 - 1:
                ...
                require ext_code.size(sortedTrovesAddress)
                staticcall sortedTrovesAddress.getPrev(address arg1) with:
                        gas gas_remaining wei
                       args address(s)
            ...
            if not arg2:
                ...
                while idx < arg2:
                    ...
                    staticcall troveManagerAddress.Troves(address arg1) with:
                            gas gas_remaining wei
                           args address(t)
                    ...
                    mem[_851 + 32] = _786
                    require ext_code.size(troveManagerAddress)
                    staticcall troveManagerAddress.rewardSnapshots(address arg1) with:
                            gas gas_remaining wei
                           args address(t)
    ...
    if arg1 >= ext_call.return_data[0]:
        ...
        return memory
          from mem[64]
           len ceil32(return_data.size) + -mem[64] + 192
    require ext_code.size(sortedTrovesAddress)
    staticcall sortedTrovesAddress.getFirst() with:
            gas gas_remaining wei
    mem[ceil32(return_data.size) + 96] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if arg2 <= ext_call.return_data[0] - arg1:
        ...
        while idx < arg1:
            mem[mem[64] + 4] = address(s)
            require ext_code.size(sortedTrovesAddress)
            staticcall sortedTrovesAddress.getNext(address arg1) with:
                    gas gas_remaining wei
                   args address(s)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
