...
function sub_e7d7ec45(?) payable {
    ...
    mem[ceil32(ceil32(('cd', 68).length)) + 161 len 2584] = code.data[12334 len 2584]
    idx = 0
    s = 96
    ...
    create contract with 0 wei
                    code: code.data[12334 len 2584], address(this.address), mem[ceil32(ceil32(('cd', 68).length)) + 2777 len 64], Array(len=('cd', 68).length, data=call.data[cd[68] + 36 len ('cd', 68).length])
...
function sub_3c1d98fc(?) payable {
    ...
    mem[ceil32(ceil32(('cd', 68).length)) + 161 len 10496] = code.data[1838 len 10496]
    idx = 0
    s = 96
    t = ceil32(ceil32(('cd', 68).length)) + 10721
    while idx < 2:
        mem[t] = mem[s + 12 len 20]
        idx = idx + 1
        s = s + 32
        ...
        continue 
    create contract with 0 wei
                    code: code.data[1838 len 10496], msg.sender, address(this.address), mem[ceil32(ceil32(('cd', 68).length)) + 10721 len 64], Array(len=('cd', 68).length, data=call.data[cd[68] + 36 len ('cd', 68).length])
    if not create.new_address:
        revert with ext_call.return_data[0 len return_data.size]
    stor0.length++
