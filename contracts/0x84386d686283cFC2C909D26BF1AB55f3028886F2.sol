    ...
    while idx < arg4.length:
            ...
            if not ext_call.success:
                ...
                if not _157 % 32:
                    ...
                    if not _352 % 32:
                        ...
                        if not _446 % 32:
                            emit Log(string rg1):
                                     32,
                                     mem[_352 + _157 + _151 + (2 * ceil32(return_data.size)) + 96 len _446 + 32],
                        else:
                            ...
                            emit Log(string rg1):
                                     32,
                                     mem[_352 + _157 + _151 + (2 * ceil32(return_data.size)) + 96 len floor32(_446) + 64],
                        sub_8f7371e0++
                        idx = idx + 1
                        continue 
                    ...
                    if not _455 % 32:
                        emit Log(string rg1):
                                 32,
                                 mem[floor32(_352) + _157 + _151 + (2 * ceil32(return_data.size)) + 128 len _455 + 32],
                    else:
                        ...
                        emit Log(string rg1):
                                 32,
                                 mem[floor32(_352) + _157 + _151 + (2 * ceil32(return_data.size)) + 128 len floor32(_455) + 64],
                    sub_8f7371e0++
                    s = ceil32(_455) + 1
                    continue 
                ...
                if not _353 % 32:
                    ...
                    if not _450 % 32:
                        emit Log(string rg1):
                                 32,
                                 mem[_353 + floor32(_157) + _151 + (2 * ceil32(return_data.size)) + 128 len _450 + 32],
                    else:
                        ...
                        emit Log(string rg1):
                                 32,
                                 mem[_353 + floor32(_157) + _151 + (2 * ceil32(return_data.size)) + 128 len floor32(_450) + 64],
                    sub_8f7371e0++
                    s = ceil32(_450) + 1
                    continue 
                ...
                if not _458 % 32:
                    emit Log(string rg1):
                             32,
                             mem[floor32(_353) + floor32(_157) + _151 + (2 * ceil32(return_data.size)) + 160 len _458 + 32],
                else:
                    ...
                    emit Log(string rg1):
                             32,
                             mem[floor32(_353) + floor32(_157) + _151 + (2 * ceil32(return_data.size)) + 160 len floor32(_458) + 64],
                sub_8f7371e0++
            idx = idx + 1
            continue 
        mem[0] = 0
        ...
        if not _354 % 32:
            ...
            if not _555 % 32:
                ...
                if not _593 % 32:
                    emit Log(string rg1):
                             32,
                             mem[_555 + _354 + _340 + (2 * ceil32(return_data.size)) + 96 len _593 + 32],
                else:
                    ...
                    emit Log(string rg1):
                             32,
                             mem[_555 + _354 + _340 + (2 * ceil32(return_data.size)) + 96 len floor32(_593) + 64],
            else:
                ...
                if not _601 % 32:
                    emit Log(string rg1):
                             32,
                             mem[floor32(_555) + _354 + _340 + (2 * ceil32(return_data.size)) + 128 len _601 + 32],
                else:
                    ...
                    emit Log(string rg1):
                             32,
                             mem[floor32(_555) + _354 + _340 + (2 * ceil32(return_data.size)) + 128 len floor32(_601) + 64],
            sub_8f7371e0++
            idx = idx + 1
            continue 
        ...
        if not _556 % 32:
            ...
            if not _597 % 32:
                emit Log(string rg1):
                         32,
                         mem[_556 + floor32(_354) + _340 + (2 * ceil32(return_data.size)) + 128 len _597 + 32],
            else:
                ...
                emit Log(string rg1):
                         32,
                         mem[_556 + floor32(_354) + _340 + (2 * ceil32(return_data.size)) + 128 len floor32(_597) + 64],
        else:
            ...
            if not _604 % 32:
                emit Log(string rg1):
                         32,
                         mem[floor32(_556) + floor32(_354) + _340 + (2 * ceil32(return_data.size)) + 160 len _604 + 32],
            else:
                ...
                emit Log(string rg1):
                         32,
                         mem[floor32(_556) + floor32(_354) + _340 + (2 * ceil32(return_data.size)) + 160 len floor32(_604) + 64],
        sub_8f7371e0++
        s = ceil32(_556) + 1
        continue 
}
