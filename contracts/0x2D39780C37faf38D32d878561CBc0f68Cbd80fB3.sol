...
function sub_fcf6237d(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        if cd[((32 * idx) + cd[36] + 36)] <= 0:
            revert with 0, 'DCM: Cannot enter cellar for 0 days'
        if idx >= ('cd', 36).length:
            revert with 'NH{q', 50
        if idx >= ('cd', 4).length:
            revert with 'NH{q', 50
        mem[0] = cd[((32 * idx) + cd[4] + 36)]
        mem[32] = 3
        if sub_1bd29448[cd[((32 * idx) + cd[4] + 36)]] > -cd[((32 * idx) + cd[36] + 36)] - 1:
            revert with 'NH{q', 17
        ...
        if cd[((32 * idx) + cd[36] + 36)] and 5 * 10^16 > -1 / cd[((32 * idx) + cd[36] + 36)]:
            revert with 'NH{q', 17
        if s > (-5 * 10^16 * cd[((32 * idx) + cd[36] + 36)]) - 1:
            revert with 'NH{q', 17
        if idx >= ('cd', 4).length:
            revert with 'NH{q', 50
        if idx >= ('cd', 36).length:
        ...
        emit 0x1cef0f87: msg.sender, cd[((32 * idx) + cd[4] + 36)], cd[((32 * idx) + cd[36] + 36)]
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
