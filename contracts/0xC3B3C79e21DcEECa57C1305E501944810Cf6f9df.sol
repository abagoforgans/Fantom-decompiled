...
function sortTokens(address arg1, address arg2) payable {
    ...
    if arg1 < arg2:
        ...
        if not _291 % 32:
            ...
            return address(arg1), 
                   Array(len=mem[ceil32(return_data.size) + 96], data=mem[_291 + floor32(_19) + (2 * ceil32(return_data.size)) + 416 len floor32(mem[floor32(_19) + (2 * ceil32(return_data.size)) + 160]) + mem[ceil32(return_data.size) + 96] + 64]),
                   ext_call.return_data[0] << 248,
                   address(arg2),
                   mem[ceil32(return_data.size) + 96] + 224,
                   ext_call.return_data[0] << 248
        ...
        return address(arg1), 
               Array(len=mem[ceil32(return_data.size) + 96], data=mem[floor32(_291) + floor32(_19) + (2 * ceil32(return_data.size)) + 448 len floor32(mem[floor32(_19) + (2 * ceil32(return_data.size)) + 160]) + mem[ceil32(return_data.size) + 96] + 64]),
               ext_call.return_data[0] << 248,
               address(arg2),
               mem[ceil32(return_data.size) + 96] + 224,
               ext_call.return_data[0] << 248
    ...
    if not _20 % 32:
        ...
        if not _289 % 32:
            ...
            return address(arg2), 
                   Array(len=mem[ceil32(return_data.size) + 96], data=mem[_289 + _20 + (2 * ceil32(return_data.size)) + 384 len floor32(mem[_20 + (2 * ceil32(return_data.size)) + 128]) + mem[ceil32(return_data.size) + 96] + 64]),
                   ext_call.return_data[0] << 248,
                   address(arg1),
                   mem[ceil32(return_data.size) + 96] + 224,
                   ext_call.return_data[0] << 248
        ...
        return address(arg2), 
               Array(len=mem[ceil32(return_data.size) + 96], data=mem[floor32(_289) + _20 + (2 * ceil32(return_data.size)) + 416 len floor32(mem[_20 + (2 * ceil32(return_data.size)) + 128]) + mem[ceil32(return_data.size) + 96] + 64]),
               ext_call.return_data[0] << 248,
               address(arg1),
               mem[ceil32(return_data.size) + 96] + 224,
               ext_call.return_data[0] << 248
