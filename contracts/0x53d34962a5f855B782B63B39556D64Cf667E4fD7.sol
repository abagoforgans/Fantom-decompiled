...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    mem[(8 * ceil32(return_data.size)) + 228] = 97 * ext_call.return_data[0] / 100
    ...
    call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3 / 3, 97 * ext_call.return_data[0] / 100, 160, msg.sender, block.timestamp, mem[(8 * ceil32(return_data.size)) + 356 len (32 * mem[ceil32(return_data.size) + 96]) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    mem[_133 + (2 * ceil32(return_data.size)) + 132] = 97 * ext_call.return_data[0] / 100
    ...
    call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.swapExactTokensForETH(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args _132, 97 * ext_call.return_data[0] / 100, 160, msg.sender, block.timestamp, mem[_133 + (2 * ceil32(return_data.size)) + 260 len (32 * mem[_133]) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
