...
function royaltyInfo(uint256 arg1, uint256 arg2) {
    ...
    require arg1 == arg1
    require arg2 == arg2
    if arg2 and uint256(stor22.field_0) > -1 / arg2:
        revert with 'NH{q', 17
    return stor18, arg2 * uint256(stor22.field_0) / 10000
}
...
function mint(uint256 arg1) payable {
    ...
    staticcall stor21.0x6352211e with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        revert with 0, 'You can only mint the pfp of a token you own!'
    if not msg.sender:
