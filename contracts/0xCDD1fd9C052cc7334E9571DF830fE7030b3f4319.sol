...
function sub_fd598e56(?) payable {
    ...
    if not arg1:
        ...
        if not ext_code.hash(stor4):
            revert with 0, 'SafeERC20: call to non-contract'
        mem[ceil32(return_data.size) + 393 len 64] = transfer(address arg1, uint256 arg2), msg.sender, 0
        call stor4 with:
           funct uint32(msg.sender)
             gas gas_remaining wei
            args Mask(480, -256, transfer(address arg1, uint256 arg2), msg.sender, 0) << 256, mem[ceil32(return_data.size) + 457 len 4]
    else:
