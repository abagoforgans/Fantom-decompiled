...
function sub_bc35784b(?) payable {
    ...
    while idx < stor3.length:
        ...
        if votesInRoundByUser[stor3[idx]][address(arg1)] < arg2:
            mem[0] = address(arg1)
            mem[32] = sha3(stor3[idx], 7)
            if votesInRoundByUser[stor3[idx]][address(arg1)]:
                ...
                while s < votesForOptionByUser[stor3[idx]][address(arg1)]:
                    ...
                    if not votesInRoundByUser[stor3[idx]][address(arg1)]:
                        revert with 'NH{q', 18
                    if votesForOptionByUser[stor3[idx]][address(arg1)][s] * arg2 / votesInRoundByUser[stor3[idx]][address(arg1)] < votesForOptionByUser[stor3[idx]][address(arg1)][s]:
                        revert with 'NH{q', 17
                    if s >= votesForOption[stor3[idx]]:
                        revert with 'NH{q', 50
                    if votesForOption[stor3[idx]][s] > -(votesForOptionByUser[stor3[idx]][address(arg1)][s] * arg2 / votesInRoundByUser[stor3[idx]][address(arg1)]) + votesForOptionByUser[stor3[idx]][address(arg1)][s] - 1:
                        revert with 'NH{q', 17
                    votesForOption[stor3[idx]][s] = votesForOption[stor3[idx]][s] + (votesForOptionByUser[stor3[idx]][address(arg1)][s] * arg2 / votesInRoundByUser[stor3[idx]][address(arg1)]) - votesForOptionByUser[stor3[idx]][address(arg1)][s]
                ...
                mem[0] = address(arg1)
                mem[32] = sha3(stor3[idx], 7)
                votesInRoundByUser[stor3[idx]][address(arg1)] = arg2
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
