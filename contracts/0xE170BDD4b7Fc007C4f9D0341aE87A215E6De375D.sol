...
function sub_422e49f7(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            ...
            _314 = sha3(mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512 len 128])
            _318 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 256]
            ...
            if cd[68] > 1:
                revert with 'NH{q', 33
            if cd[68]:
                _336 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 224]
                t = 0
                while t < stor4.length:
                    ...
                    if idx >= ('cd', 4).length:
                        revert with 'NH{q', 50
                    mem[(32 * idx) + 128] = stor7 + (50 * _314 % 4) + (50 * _318)
                    if s > -stor7 + (-50 * _314 % 4) + (-50 * _318) - 1:
                        revert with 'NH{q', 17
                    if block.timestamp > -43201:
                        revert with 'NH{q', 17
                    mem[0] = cd[((32 * idx) + cd[4] + 36)]
                    mem[32] = 11
                    log[cd[((32 * idx) + cd[4] + 36)]] = block.timestamp + (12 * 3600)
                    if idx == -1:
                        revert with 'NH{q', 17
                    idx = idx + 1
                    s = s + stor7 + (50 * _314 % 4) + (50 * _318)
                    t = _314
                    continue 
                revert with 0, 'Wrong class for the Heal Action!'
            _337 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 224]
            t = 0
        ...
        while idx < ('cd', 4).length:
            ...
            while t < 128:
                ...
                continue 
            mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 480] = 128
            _317 = sha3(mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512 len 128])
            _322 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 256]
            if sha3(mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512 len 128]) % 4 > -mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 256] - 1:
                revert with 'NH{q', 17
            if (sha3(mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512 len 128]) % 4) + mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 256] and 50 > -1 / (sha3(mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 512 len 128]) % 4) + mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 256]:
                revert with 'NH{q', 17
            ...
            if cd[68] > 1:
                revert with 'NH{q', 33
            if cd[68]:
                _338 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 224]
                t = 0
                while t < stor4.length:
                    mem[0] = 4
                    if stor4[t] != _338:
                    ...
                    if idx >= ('cd', 4).length:
                        revert with 'NH{q', 50
                    mem[(32 * idx) + 128] = stor7 + (50 * _317 % 4) + (50 * _322)
                    if s > -stor7 + (-50 * _317 % 4) + (-50 * _322) - 1:
                        revert with 'NH{q', 17
                    if block.timestamp > -43201:
                        revert with 'NH{q', 17
                    mem[0] = cd[((32 * idx) + cd[4] + 36)]
                    ...
                    if idx == -1:
                        revert with 'NH{q', 17
                    idx = idx + 1
                    s = s + stor7 + (50 * _317 % 4) + (50 * _322)
                    t = _317
                    continue 
                revert with 0, 'Wrong class for the Heal Action!'
            _339 = mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 224]
            t = 0
            while t < stor5.length:
                mem[0] = 5
                if stor5[t] != _339:
