        ...
        if treasuryFundLastClaimed < block.timestamp:
            ...
            if (block.timestamp * treasuryFundEmissionRate) - (treasuryFundLastClaimed * treasuryFundEmissionRate) > 0:
                if treasuryFundAddress:
                    ...
                    if balanceOf[stor10] > !((block.timestamp * treasuryFundEmissionRate) - (treasuryFundLastClaimed * treasuryFundEmissionRate)):
                        revert with 0, 17
                    balanceOf[stor10] = balanceOf[stor10] + (block.timestamp * treasuryFundEmissionRate) - (treasuryFundLastClaimed * treasuryFundEmissionRate)
        ...
        if treasuryFundLastClaimed < endTime:
            ...
            if (endTime * treasuryFundEmissionRate) - (treasuryFundLastClaimed * treasuryFundEmissionRate) > 0:
                if treasuryFundAddress:
                    ...
                    if balanceOf[stor10] > !((endTime * treasuryFundEmissionRate) - (treasuryFundLastClaimed * treasuryFundEmissionRate)):
                        revert with 0, 17
                    balanceOf[stor10] = balanceOf[stor10] + (endTime * treasuryFundEmissionRate) - (treasuryFundLastClaimed * treasuryFundEmissionRate)
