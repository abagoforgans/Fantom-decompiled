...
function sub_675994d6(?) payable {
    ...
    if arg5 == 3:
        ...
        call wrappedAddress with:
           funct uint32(stor8)
             gas gas_remaining wei
            args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0) << 256, mem[452 len 4]
        if not return_data.size:
            if not ext_call.success:
                if wrappedAddress > 0:
                    revert with memory
            ...
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[552 len 64] = 0, address(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            mem[644 len 4] = 0
            call wrappedAddress with:
               funct uint32(stor8)
                 gas gas_remaining wei
            ...
            if return_data.size <= 0:
                ...
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 553 len 64] = 0, address(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        if arg5 != 2:
            ...
            call wrappedAddress with:
               funct uint32(stor8)
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0) << 256, mem[388 len 4]
            if not return_data.size:
                if not ext_call.success:
                    if wrappedAddress > 0:
                        revert with memory
                ...
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[488 len 64] = 0, address(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[580 len 4] = 0
                call wrappedAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
                ...
                if return_data.size <= 0:
                    ...
                    if ext_code.size(wrappedAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 489 len 64] = 0, address(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            ...
            if not return_data.size:
                ...
                if return_data.size <= 0:
                    ...
                    call wrappedAddress with:
                       funct uint32(stor8)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 585 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            if wrappedAddress > 0:
                                revert with memory
