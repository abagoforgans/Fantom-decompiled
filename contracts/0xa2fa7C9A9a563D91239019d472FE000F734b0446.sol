...
function getMultipliedFee() {
    ...
    if not stor17:
        ...
        if not stor29:
            revert with 0, 'SafeMath: division by zero', 0
        if stor17 > !((stor28 * 0 / stor27) + (stor29 * 0 / stor27) - (block.timestamp * 0 / stor27) - (stor28 * stor17) - (stor29 * stor17) + (block.timestamp * stor17) / stor29):
            revert with 0, 17
    ...
    if not stor29:
        revert with 0, 'SafeMath: division by zero', 0
    if stor17 > !((stor28 * stor17 * stor26 / stor27) + (stor29 * stor17 * stor26 / stor27) - (block.timestamp * stor17 * stor26 / stor27) - (stor28 * stor17) - (stor29 * stor17) + (block.timestamp * stor17) / stor29):
        revert with 0, 17
