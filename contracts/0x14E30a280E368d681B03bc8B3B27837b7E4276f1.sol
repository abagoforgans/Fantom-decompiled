...
function pause() payable {
    ...
    if not return_data.size:
        ...
        call rewardTokenAddress.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args address(uniRouterAddress), 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                staticcall masterChefAddress.userInfo(uint256 arg1, address arg2) with:
                        gas gas_remaining wei
                       args uint8(stor7.field_0), address(this.address), mem[(2 * ceil32(return_data.size)) + 658 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 64
                require ext_code.size(masterChefAddress)
                call masterChefAddress.withdraw(uint256 arg1, uint256 arg2) with:
                     gas gas_remaining wei
                    args uint8(stor7.field_0), ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 658 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
    else:
        mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
            if return_data.size > 0:
        ...
        if return_data.size <= 0:
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    staticcall masterChefAddress.userInfo(uint256 arg1, address arg2) with:
                            gas gas_remaining wei
                           args uint8(stor7.field_0), address(this.address), mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 659 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 64
                    require ext_code.size(masterChefAddress)
                    call masterChefAddress.withdraw(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args uint8(stor7.field_0), ext_call.return_data[0], mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 659 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        else:
            require return_data.size >= 32
            if not mem[292]:
                revert with 0, 
