                                ...
                                if not mem[(32 * s) + mem[_579] + 44 len 20]:
                                    ...
                                    if address(_564) == 0x1111111111111111111111111111111111111111:
                                        ...
                                        while idx >= 32:
                                            ...
                                            idx = idx - 32
                                            continue 
                                        mem[_3108 + floor32(mem[_3109]) + 100] = mem[_3109 + -(mem[_3109] % 32) + floor32(mem[_3109]) + 64 len mem[_3109] % 32] or Mask(8 * -(mem[_3109] % 32) + 32, -(8 * -(mem[_3109] % 32) + 32) + 256, mem[_3108 + floor32(mem[_3109]) + 100])
                                        call address(_3070).mem[_3108 + 100 len 4] with:
                                             gas gas_remaining wei
                                            args mem[_3108 + 104 len _3366 - 4]
                                        if not return_data.size:
                                            if not ext_call.success:
                                                revert with 0, 'SafeERC20: low-level call failed'
                                            if not mem[96]:
                                                ...
                                                mem[_3108 + 100] = mem[(32 * s) + mem[_579] + 44 len 20]
                                                mem[_3108 + 132] = _4295
                                                mem[_3108 + 164] = 0
                                                emit Distributed(mem[_3108 + 100], _4295, 0);
                                            else:
                                                require mem[96] >= 32
                                                if not mem[128]:
                                                    revert with 0, 
                                                ...
                                                mem[_3108 + 132] = _4413
                                                mem[_3108 + 164] = 0
                                                emit Distributed(mem[_3108 + 100], _4413, 0);
                                        else:
                                            mem[64] = _3108 + ceil32(return_data.size) + 101
                                            mem[_3108 + 100] = return_data.size
                                            mem[_3108 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                            if not ext_call.success:
                                                revert with 0, 'SafeERC20: low-level call failed'
                                            if not return_data.size:
                                                require s < mem[mem[_579]]
                                                ...
                                                mem[_3108 + ceil32(return_data.size) + 101] = mem[(32 * s) + mem[_579] + 44 len 20]
                                                mem[_3108 + ceil32(return_data.size) + 133] = _4300
                                                mem[_3108 + ceil32(return_data.size) + 165] = 0
                                                emit Distributed(mem[_3108 + ceil32(return_data.size) + 101], _4300, 0);
                                            else:
                                                require return_data.size >= 32
                                                if not mem[_3108 + 132]:
                                                    revert with 0, 
                                                                32,
                                                                42,
                                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                                mem[_3108 + ceil32(return_data.size) + 211 len 22]
                                                require s < mem[mem[_579]]
                                                require s < mem[mem[_579 + 32]]
                                                _4416 = mem[(32 * s) + mem[_579 + 32] + 32]
                                                mem[_3108 + ceil32(return_data.size) + 101] = mem[(32 * s) + mem[_579] + 44 len 20]
                                                mem[_3108 + ceil32(return_data.size) + 133] = _4416
                                                mem[_3108 + ceil32(return_data.size) + 165] = 0
                                                emit Distributed(mem[_3108 + ceil32(return_data.size) + 101], _4416, 0);
                            else:
                                if mem[(32 * s) + mem[_579 + 32] + 32] * ext_call.return_data[0] / ext_call.return_data[0] != mem[(32 * s) + mem[_579 + 32] + 32]:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                                _2974 = mem[64]
