...
function executeNewDelay() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if stor9 + approvalDelay < stor9:
        revert with 0, 'SafeMath: addition overflow'
    if stor9 + approvalDelay >= block.timestamp:
...
function balanceToken() payable {
    require ext_code.size(address(strategyAddress))
    staticcall address(strategyAddress).balanceOfToken() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(singleTokenAddress)
    staticcall singleTokenAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function depositAll() payable {
    ...
    if not return_data.size:
        ...
        if not totalSupply:
            ...
            if ext_code.size(tokenAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[648 len 64] = 0, address(strategyAddress), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor12)
                 gas gas_remaining wei
                args ext_call.return_data[0], mem[584 len 28], mem[712 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), ext_call.return_data[0]
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if not totalSupply:
            ...
            if ext_code.size(tokenAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 649 len 64] = 0, address(strategyAddress), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor12)
                 gas gas_remaining wei
                args ext_call.return_data[0], mem[ceil32(return_data.size) + 585 len 28], mem[ceil32(return_data.size) + 713 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), ext_call.return_data[0]
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
    ...
    if not uint255(ext_call.return_data[0]):
        ...
        if not uint255(ext_call.return_data[0]):
            ...
            if ext_call.return_data[0] >= 0 / totalSupply:
                require ext_code.size(address(strategyAddress))
                call address(strategyAddress).withdrawToken(uint256 rg1) with:
                     gas gas_remaining wei
                    args (0 / totalSupply)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if ext_code.size(singleTokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 713 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                call singleTokenAddress with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                    args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[ceil32(return_data.size) + 777 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 'SafeMath: division by zero'
                ...
                if ext_code.size(singleTokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 841 len 64] = 0, msg.sender, ext_call.return_data[0 len 28]
                call singleTokenAddress with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                    args ext_call.return_data[0], mem[ceil32(return_data.size) + 777 len 28], mem[ceil32(return_data.size) + 905 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 'SafeMath: division by zero'
                ...
                if return_data.size > 0:
                    ...
                    if not mem[ceil32(return_data.size) + 873]:
                        revert with 0, 
                                    ...
                                    42,
                                    0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                    mem[(2 * ceil32(return_data.size)) + 952 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 22]
        else:
            require 2 * ext_call.return_data[0]
            ...
            if ext_call.return_data[0] >= 0 / totalSupply:
                ...
                if ext_call.return_data[0] >= 0 / totalSupply:
                    ...
                    if return_data.size <= 0:
                        if ext_code.size(singleTokenAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 841 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                        mem[ceil32(return_data.size) + 905 len 0] = 0
                        call singleTokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[ceil32(return_data.size) + 905 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[ceil32(return_data.size) + 873 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        ...
                        if return_data.size > 0:
                            ...
                            if not mem[ceil32(return_data.size) + 873]:
                                revert with 0, 
                                            ...
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(2 * ceil32(return_data.size)) + 952 len 22]
                    else:
                        require return_data.size >= 32
                        if not mem[708]:
                            revert with 0, 
        ...
        if not uint255(ext_call.return_data[0]):
            ...
            if ext_call.return_data[0] >= (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalSupply:
                ...
                if ext_code.size(singleTokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 713 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                mem[ceil32(return_data.size) + 777 len 0] = 0
                call singleTokenAddress with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                    args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[ceil32(return_data.size) + 777 len 4]
            ...
            if ext_call.return_data[0] >= (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalSupply:
                ...
                if ext_code.size(singleTokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 713 len 64] = 0, msg.sender, ext_call.return_data[0 len 28]
                call singleTokenAddress with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                    args ext_call.return_data[0], mem[ceil32(return_data.size) + 649 len 28], mem[ceil32(return_data.size) + 777 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 'SafeMath: division by zero'
                mem[ceil32(return_data.size) + 745 len return_data.size] = ext_call.return_data[0 len return_data.size]
