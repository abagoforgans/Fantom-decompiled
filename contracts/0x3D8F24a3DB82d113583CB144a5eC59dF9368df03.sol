...
function tokenURI(uint256 arg1) {
    ...
    require arg1 == arg1
    return 32, 80, 
           0xfe68747470733a2f2f676174657761792e70696e6174612e636c6f75642f697066732f516d51535a5142506272424b6365515a434a6e687973434b746d7a59337156635738775662334b4c4b46473176, mem[208 len 16] >> 384,
           0
}
...
function sub_3c396497(?) payable {
    ...
    while idx < ext_call.return_data[0]:
        ...
        mem[mem[64] + 36] = idx
        require ext_code.size(stor17)
        staticcall stor17.0x2f745c59 with:
                gas gas_remaining wei
               args msg.sender, idx
