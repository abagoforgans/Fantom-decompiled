...
function getPair(address arg1) payable {
    ...
    require arg1 == arg1
    return pair[arg1].field_0, pair[arg1].field_256, pair[arg1].field_512, bool(pair[arg1].field_544)
}
...
function getRate(address arg1, address arg2) payable {
    ...
    if ext_call.return_data[12 len 20] != arg1:
        ...
        return 10^18 * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]), uint8(ext_call.return_data[0])
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[31 len 1]
    return 10^18 * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]), uint8(ext_call.return_data[0])
}

function sub_9d47bbd0(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    require arg2 == address(arg2)
    require ext_code.size(sub_9478e212Address)
    ...
    if not ext_call.return_data[12 len 20]:
        return 0
    if not pair[ext_call.return_data[12 len 20]].field_544:
        revert with 0, 'CoffinPriceOracle: NOT_INITIALIZED'
    require ext_code.size(address(ext_call.return_data[0]))
    ...
    if uint32(block.timestamp) == uint32(ext_call.return_data[64]):
        ...
        if uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512) >= PERIOD:
            pair[address(ext_call.return_data[0])].field_0 = pair[ext_call.return_data[12 len 20]].field_0
            pair[address(ext_call.return_data[0])].field_256 = pair[ext_call.return_data[12 len 20]].field_256
            pair[address(ext_call.return_data[0])].field_512 = uint32(block.timestamp)
        if uint32(block.timestamp) < pair[ext_call.return_data[12 len 20]].field_512:
            revert with 0, 17
        if uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512) < PERIOD:
            revert with 0, 'CoffinPriceOracle: NOT_READY'
        ...
        if not uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512):
            revert with 0, 18
        if ext_call.return_data[0] - pair[ext_call.return_data[12 len 20]].field_0 / uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512) > 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
            revert with 0, 'CoffinPriceOracle: UINT224_OVERFLOW'
        if ext_call.return_data[0] < pair[ext_call.return_data[12 len 20]].field_256:
            revert with 0, 17
        if not uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512):
            revert with 0, 18
        if ext_call.return_data[0] - pair[ext_call.return_data[12 len 20]].field_256 / uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512) > 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
            revert with 0, 'CoffinPriceOracle: UINT224_OVERFLOW'
        return 4294967296 * ext_call.return_data[0] - pair[ext_call.return_data[12 len 20]].field_0 / uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512), 
               4294967296 * ext_call.return_data[0] - pair[ext_call.return_data[12 len 20]].field_256 / uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512),
               uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512)
    if uint32(block.timestamp) < uint32(ext_call.return_data[64]):
        revert with 0, 17
    ...
    if not uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512):
        revert with 0, 18
    if ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[32]) << 112 / Mask(112, 0, ext_call.return_data[0])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - pair[ext_call.return_data[12 len 20]].field_0 / uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512) > 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
        revert with 0, 'CoffinPriceOracle: UINT224_OVERFLOW'
    if ext_call.return_data[0] + (Mask(192, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) << 32 * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) < pair[ext_call.return_data[12 len 20]].field_256:
        revert with 0, 17
    if not uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512):
        revert with 0, 18
    if ext_call.return_data[0] + (Mask(192, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) << 32 * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - pair[ext_call.return_data[12 len 20]].field_256 / uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512) > 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
        revert with 0, 'CoffinPriceOracle: UINT224_OVERFLOW'
    return 4294967296 * ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[32]) << 112 / Mask(112, 0, ext_call.return_data[0])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - pair[ext_call.return_data[12 len 20]].field_0 / uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512), 
           4294967296 * ext_call.return_data[0] + (Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - uint32(ext_call.return_data[64]))) - pair[ext_call.return_data[12 len 20]].field_256 / uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512),
           uint32(uint32(block.timestamp) - pair[ext_call.return_data[12 len 20]].field_512)
}
...
function sub_28bcbb05(?) payable {
    ...
    if not ext_call.return_data[31 len 1]:
        ...
        _95 = mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 192 len 4], 0 + 192]
        ...
        require return_data.size >= _93 + (32 * _95) + 32
        mem[(6 * ceil32(return_data.size)) + 224 len 32 * _95] = mem[(4 * ceil32(return_data.size)) + _93 + 224 len 32 * _95]
        if 1 >= _95:
            revert with 0, 50
    ...
    if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
        ...
        _94 = mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, 10^uint8(ext_call.return_data[0])) >> 32 + 192]
        ...
        require return_data.size >= _91 + (32 * _94) + 32
        mem[(6 * ceil32(return_data.size)) + 224 len 32 * _94] = mem[(4 * ceil32(return_data.size)) + _91 + 224 len 32 * _94]
        if 1 >= _94:
            revert with 0, 50
