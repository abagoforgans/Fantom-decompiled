    ...
    if not arg3:
        ...
        if arg1 != this.address:
            ...
            if arg1 != ext_call.return_data[12 len 20]:
                ...
                mem[64] = ceil32(return_data.size) + 192
                require return_data.size >= 32
                _218 = mem[192 len 4], 0
                require mem[192 len 4], 0 <= 4294967296
                require mem[192 len 4], 0 + 32 <= return_data.size
                require mem[mem[192 len 4], 0 + 192] <= 4294967296 and mem[192 len 4], 0 + (32 * mem[mem[192 len 4], 0 + 192]) + 32 <= return_data.size
                mem[ceil32(return_data.size) + 192] = mem[mem[192 len 4], 0 + 192]
                _223 = mem[_218 + 192]
                mem[ceil32(return_data.size) + 224 len floor32(mem[_218 + 192])] = mem[_218 + 224 len floor32(mem[_218 + 192])]
                require 1 < mem[ceil32(return_data.size) + 192]
                if not mem[ceil32(return_data.size) + 256]:
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(32 * _223) + ceil32(return_data.size) + 516 len 0] = None
                    require ext_code.size(uniswapRouterAddress)
                    call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args 0, 0 / slippage, 160, address(this.address), block.timestamp, 2, mem[(32 * _223) + ceil32(return_data.size) + 516 len 64]
                else:
                    if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                        revert with 0, 
                                    32,
                                    33,
                                    0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(32 * _223) + ceil32(return_data.size) + 325 len 31]
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    require ext_code.size(uniswapRouterAddress)
                    ...
                    call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args 0, 100 * mem[ceil32(return_data.size) + 256] / slippage, 160, address(this.address), block.timestamp, 2, mem[(32 * _223) + ceil32(return_data.size) + 516 len 64]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        require arg3 <= balanceOf[address(arg1)]
        ...
        if arg1 != this.address:
            ...
            if arg1 != ext_call.return_data[12 len 20]:
                ...
                mem[64] = ceil32(return_data.size) + 192
                require return_data.size >= 32
                _216 = mem[192 len 4], Mask(224, 32, 25 * arg3 / 100) >> 32
                ...
                _222 = mem[_216 + 192]
                mem[ceil32(return_data.size) + 224 len floor32(mem[_216 + 192])] = mem[_216 + 224 len floor32(mem[_216 + 192])]
                require 1 < mem[ceil32(return_data.size) + 192]
                if not mem[ceil32(return_data.size) + 256]:
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(32 * _222) + ceil32(return_data.size) + 516 len 0] = None
                    require ext_code.size(uniswapRouterAddress)
                    call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args 25 * arg3 / 100, 0 / slippage, Array(len=2, data=mem[(32 * _222) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
                else:
                    if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                        revert with 0, 
                                    32,
                                    33,
                                    0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(32 * _222) + ceil32(return_data.size) + 325 len 31]
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    require ext_code.size(uniswapRouterAddress)
                    ...
                    call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args 25 * arg3 / 100, 100 * mem[ceil32(return_data.size) + 256] / slippage, Array(len=2, data=mem[(32 * _222) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
