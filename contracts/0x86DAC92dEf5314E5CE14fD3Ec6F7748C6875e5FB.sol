...
function getDecimalsOracle() {
    ...
    staticcall oracleAddress.decimals() with:
...
function withdrawTokens() {
    ...
    if block.timestamp < sub_54c21fb8:
        revert with 0, 'Claim period has not started yet'
    if stor1 == 2:
        revert with 0, 'ReentrancyGuard: reentrant call'
    stor1 = 2
...
function balanceOf(address arg1) {
    ...
    if not ext_call.return_data[31 len 1]:
        ...
        if not ext_call.return_data[32]:
            revert with 'NH{q', 18
        if sub_7d4833ad[address(arg1)] and 10^18 > -1 / sub_7d4833ad[address(arg1)]:
            revert with 'NH{q', 17
...
function remainingTokensByCurrentPrice() {
    ...
    if not ext_call.return_data[31 len 1]:
        ...
        if not ext_call.return_data[32]:
            revert with 'NH{q', 18
        if weiRaised and 10^18 > -1 / weiRaised:
            revert with 'NH{q', 17
        if not tokenPriceUSD / ext_call.return_data[32]:
            revert with 'NH{q', 18
...
function claimTokens() {
    ...
    if not ext_call.return_data[31 len 1]:
        ...
        if not ext_call.return_data[32]:
            revert with 'NH{q', 18
        if sub_7d4833ad[address(msg.sender)] and 10^18 > -1 / sub_7d4833ad[address(msg.sender)]:
            revert with 'NH{q', 17
        if not tokenPriceUSD / ext_call.return_data[32]:
            revert with 'NH{q', 18
...
function buyTokens() payable {
    ...
    if not ext_call.return_data[31 len 1]:
        ...
        if not tokenPriceUSD:
            revert with 'NH{q', 18
        if not sub_845b3fcd / tokenPriceUSD:
            revert with 'NH{q', 18
        ...
        require ext_call.return_data[0] == ext_call.return_data[31 len 1]
        if not ext_call.return_data[31 len 1]:
            if sub_845b3fcd and 1 > -1 / sub_845b3fcd:
                revert with 'NH{q', 17
            if not ext_call.return_data[32]:
                revert with 'NH{q', 18
            if weiRaised and 10^18 > -1 / weiRaised:
                revert with 'NH{q', 17
            if not sub_845b3fcd / ext_call.return_data[32]:
                revert with 'NH{q', 18
            if threshold < 10^18 * weiRaised / sub_845b3fcd / ext_call.return_data[32]:
                revert with 'NH{q', 17
            if threshold - (10^18 * weiRaised / sub_845b3fcd / ext_call.return_data[32]) <= 10^18 * msg.value / tokenPriceUSD / ext_call.return_data[32] / sub_845b3fcd / tokenPriceUSD:
            ...
            if not initialPrice:
                revert with 'NH{q', 18
            if tokenPriceUSD / initialPrice < 16:
                # nil
            else:
                emit PreBuyTokens(msg.value, msg.sender, 10^18 * msg.value / tokenPriceUSD / ext_call.return_data[32], tokenPriceUSD / ext_call.return_data[32]);
                stor1 = 1
            ...
            if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
                if 10^ext_call.return_data[31 len 1] > -1:
                    revert with 'NH{q', 17
                if sub_845b3fcd and 10^ext_call.return_data[31 len 1] > -1 / sub_845b3fcd:
                    revert with 'NH{q', 17
                if not ext_call.return_data[32]:
                    revert with 'NH{q', 18
                if weiRaised and 10^18 > -1 / weiRaised:
                    revert with 'NH{q', 17
                if not sub_845b3fcd * 10^ext_call.return_data[31 len 1] / ext_call.return_data[32]:
                    revert with 'NH{q', 18
                if threshold < 10^18 * weiRaised / sub_845b3fcd * 10^ext_call.return_data[31 len 1] / ext_call.return_data[32]:
                    revert with 'NH{q', 17
                if threshold - (10^18 * weiRaised / sub_845b3fcd * 10^ext_call.return_data[31 len 1] / ext_call.return_data[32]) <= 10^18 * msg.value / tokenPriceUSD / ext_call.return_data[32] / sub_845b3fcd / tokenPriceUSD:
                    revert with 0, 'There is no more tokens to sell'
                if 10^18 * msg.value / tokenPriceUSD / ext_call.return_data[32] and tokenPriceUSD > -1 / 10^18 * msg.value / tokenPriceUSD / ext_call.return_data[32]:
                    revert with 'NH{q', 17
                if sub_7d4833ad[address(msg.sender)] > -msg.value - 1:
                ...
                if t > -1 / s:
                    revert with 'NH{q', 17
                if sub_845b3fcd and t * s > -1 / sub_845b3fcd:
                    revert with 'NH{q', 17
                if not ext_call.return_data[32]:
                    revert with 'NH{q', 18
                if weiRaised and 10^18 > -1 / weiRaised:
                    revert with 'NH{q', 17
                if not sub_845b3fcd * t * s / ext_call.return_data[32]:
                    revert with 'NH{q', 18
                if threshold < 10^18 * weiRaised / sub_845b3fcd * t * s / ext_call.return_data[32]:
                    revert with 'NH{q', 17
                if threshold - (10^18 * weiRaised / sub_845b3fcd * t * s / ext_call.return_data[32]) <= 10^18 * msg.value / tokenPriceUSD / ext_call.return_data[32] / sub_845b3fcd / tokenPriceUSD:
                    revert with 0, 'There is no more tokens to sell'
                if 10^18 * msg.value / tokenPriceUSD / ext_call.return_data[32] and tokenPriceUSD > -1 / 10^18 * msg.value / tokenPriceUSD / ext_call.return_data[32]:
                    revert with 'NH{q', 17
                if sub_7d4833ad[address(msg.sender)] > -msg.value - 1:
        ...
        if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
            ...
            if not ext_call.return_data[31 len 1]:
                ...
                if threshold < 10^18 * weiRaised / sub_845b3fcd / ext_call.return_data[32]:
                    revert with 'NH{q', 17
                if threshold - (10^18 * weiRaised / sub_845b3fcd / ext_call.return_data[32]) <= 10^18 * msg.value / tokenPriceUSD * 10^uint8(ext_call.return_data[0]) / ext_call.return_data[32] / sub_845b3fcd / tokenPriceUSD:
                    revert with 0, 'There is no more tokens to sell'
                ...
                if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
                    ...
                    if threshold < 10^18 * weiRaised / sub_845b3fcd * 10^ext_call.return_data[31 len 1] / ext_call.return_data[32]:
                        revert with 'NH{q', 17
                    if threshold - (10^18 * weiRaised / sub_845b3fcd * 10^ext_call.return_data[31 len 1] / ext_call.return_data[32]) <= 10^18 * msg.value / tokenPriceUSD * 10^uint8(ext_call.return_data[0]) / ext_call.return_data[32] / sub_845b3fcd / tokenPriceUSD:
                        revert with 0, 'There is no more tokens to sell'
                    if 10^18 * msg.value / tokenPriceUSD * 10^uint8(ext_call.return_data[0]) / ext_call.return_data[32] and tokenPriceUSD > -1 / 10^18 * msg.value / tokenPriceUSD * 10^uint8(ext_call.return_data[0]) / ext_call.return_data[32]:
                        revert with 'NH{q', 17
                    if sub_7d4833ad[address(msg.sender)] > -msg.value - 1:
                    ...
                    if threshold < 10^18 * weiRaised / sub_845b3fcd * t * s / ext_call.return_data[32]:
                        revert with 'NH{q', 17
                    if threshold - (10^18 * weiRaised / sub_845b3fcd * t * s / ext_call.return_data[32]) <= 10^18 * msg.value / tokenPriceUSD * 10^uint8(ext_call.return_data[0]) / ext_call.return_data[32] / sub_845b3fcd / tokenPriceUSD:
                        revert with 0, 'There is no more tokens to sell'
                    if 10^18 * msg.value / tokenPriceUSD * 10^uint8(ext_call.return_data[0]) / ext_call.return_data[32] and tokenPriceUSD > -1 / 10^18 * msg.value / tokenPriceUSD * 10^uint8(ext_call.return_data[0]) / ext_call.return_data[32]:
                        revert with 'NH{q', 17
                    if sub_7d4833ad[address(msg.sender)] > -msg.value - 1:
            ...
            if not ext_call.return_data[31 len 1]:
                ...
                if threshold < 10^18 * weiRaised / sub_845b3fcd / ext_call.return_data[32]:
                    revert with 'NH{q', 17
                if threshold - (10^18 * weiRaised / sub_845b3fcd / ext_call.return_data[32]) <= 10^18 * msg.value / tokenPriceUSD * t * s / ext_call.return_data[32] / sub_845b3fcd / tokenPriceUSD:
                    revert with 0, 'There is no more tokens to sell'
                ...
                if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
                    ...
                    if threshold < 10^18 * weiRaised / sub_845b3fcd * 10^ext_call.return_data[31 len 1] / ext_call.return_data[32]:
                        revert with 'NH{q', 17
                    if threshold - (10^18 * weiRaised / sub_845b3fcd * 10^ext_call.return_data[31 len 1] / ext_call.return_data[32]) <= 10^18 * msg.value / tokenPriceUSD * t * s / ext_call.return_data[32] / sub_845b3fcd / tokenPriceUSD:
                        revert with 0, 'There is no more tokens to sell'
                    if 10^18 * msg.value / tokenPriceUSD * t * s / ext_call.return_data[32] and tokenPriceUSD > -1 / 10^18 * msg.value / tokenPriceUSD * t * s / ext_call.return_data[32]:
                        revert with 'NH{q', 17
                    if sub_7d4833ad[address(msg.sender)] > -msg.value - 1:
                    ...
                    if v > -1 / u:
                        revert with 'NH{q', 17
                    if sub_845b3fcd and v * u > -1 / sub_845b3fcd:
                        revert with 'NH{q', 17
                    if not ext_call.return_data[32]:
                        revert with 'NH{q', 18
                    if weiRaised and 10^18 > -1 / weiRaised:
                        revert with 'NH{q', 17
                    if not sub_845b3fcd * v * u / ext_call.return_data[32]:
                        revert with 'NH{q', 18
                    if threshold < 10^18 * weiRaised / sub_845b3fcd * v * u / ext_call.return_data[32]:
                        revert with 'NH{q', 17
                    if threshold - (10^18 * weiRaised / sub_845b3fcd * v * u / ext_call.return_data[32]) <= 10^18 * msg.value / tokenPriceUSD * t * s / ext_call.return_data[32] / sub_845b3fcd / tokenPriceUSD:
                        revert with 0, 'There is no more tokens to sell'
                    if 10^18 * msg.value / tokenPriceUSD * t * s / ext_call.return_data[32] and tokenPriceUSD > -1 / 10^18 * msg.value / tokenPriceUSD * t * s / ext_call.return_data[32]:
                        revert with 'NH{q', 17
                    if sub_7d4833ad[address(msg.sender)] > -msg.value - 1:
