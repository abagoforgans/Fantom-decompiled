...
function sub_5400ef52(?) {
    ...
    if address(arg1) != 0x92d5ebf3593a92888c25c0abef126583d4b5312e:
        staticcall address(arg1).get_dy(int128 rg1, int128 rg2, uint256 rg3) with:
                gas gas_remaining wei
               args ('signextend', 15, ('param', 'arg3')), ('signextend', 15, ('param', 'arg4')), arg2
    else:
        staticcall address(arg1).get_dy_underlying(int128 rg1, int128 rg2, uint256 rg3) with:
                gas gas_remaining wei
               args ('signextend', 15, ('param', 'arg3')), ('signextend', 15, ('param', 'arg4')), arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(address(arg1))
    if address(arg1) != 0x92d5ebf3593a92888c25c0abef126583d4b5312e:
        staticcall address(arg1).exchange(int128 rg1, int128 rg2, uint256 rg3, uint256 rg4) with:
                gas gas_remaining wei
               args ('signextend', 15, ('param', 'arg3')), ('signextend', 15, ('param', 'arg4')), arg2, 0
    else:
        staticcall address(arg1).exchange_underlying(int128 rg1, int128 rg2, uint256 rg3, uint256 rg4) with:
                gas gas_remaining wei
               args ('signextend', 15, ('param', 'arg3')), ('signextend', 15, ('param', 'arg4')), arg2, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
