...
function swap(address arg1, address arg2, uint256 arg3, uint256 arg4) payable {
    ...
    mem[260 len 64] = Mask(32, 224, sha3('transfer(address,uint256)')) >> 224, address(this.address) << 64, 0, Mask(224, 32, arg3) >> 32
    call arg1 with:
         gas gas_remaining wei
    ...
    if return_data.size:
        ...
        if not mem[292]:
            revert with 0, 'UniswapV2: TRANSFER_FAILED'
    mem[ceil32(return_data.size) + 425 len 128] = 1562486518, ('signextend', 15, ('signextend', 15, ('stor', ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'stor0', 0))))), ('signextend', 15, ('signextend', 15, ('stor', ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('name', 'stor0', 0))))), arg3, Mask(224, 32, arg4) >> 32
    mem[ceil32(return_data.size) + 581 len 4] = uint32(arg4)
    call sub_12ee98bbAddress with:
       funct uint32(arg3)
         gas gas_remaining wei
        args Mask(224, 32, arg4) << 736, mem[ceil32(return_data.size) + 553 len 4]
    if not return_data.size:
