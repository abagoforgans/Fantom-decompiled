...
function mint(string arg1) payable {
    ...
    if not tokenOfOwnerByIndex[address(msg.sender)][1][stor11 + 1]:
        tokenOfOwnerByIndex[address(msg.sender)]++
        tokenOfOwnerByIndex[address(msg.sender)][tokenOfOwnerByIndex[address(msg.sender)]] = stor11 + 1
        tokenOfOwnerByIndex[address(msg.sender)][1][stor11 + 1] = tokenOfOwnerByIndex[address(msg.sender)]
    if stor3[stor11 + 1]:
        require stor3[stor11 + 1] - 1 < tokenByIndex.length
        tokenByIndex[stor3[stor11 + 1] - 1].field_256 = msg.sender
        tokenByIndex[stor3[stor11 + 1] - 1].field_416 = 0
        emit Transfer(0, msg.sender, stor11 + 1);
        if ext_code.size(msg.sender) <= 0:
            if not stor3[stor11 + 1]:
                revert with 0, 
                            32,
                            44,
            ...
            stor8[stor11 + 1][] = Array(len=arg1.length, data=arg1[all])
            stor11++
            mem[ceil32(arg1.length) + 160] = stor11 + 1
            mem[ceil32(arg1.length) + 192] = 64
            mem[ceil32(arg1.length) + 224] = arg1.length
            emit Minted(Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 192 len (2 * ceil32(arg1.length)) + -arg1.length + 64]);
        else:
            ...
            mem[420 len 160] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, stor11 + 1, 128, 0
            mem[608 len 4] = 0
            mem[580 len 0] = 0
            call msg.sender.0x80 with:
                 gas gas_remaining wei
                args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, stor11 + 1, 128, 0) << 1024, mem[580 len 4]
            ...
            if not stor3[stor11 + 1]:
                revert with 0, 
                            ...
                            44,
                            0x6e4552433732314d657461646174613a2055524920736574206f66206e6f6e6578697374656e7420746f6b65,
                            mem[ceil32(return_data.size) + ceil32(arg1.length) + 565 len 20]
            stor8[stor11 + 1][] = Array(len=arg1.length, data=arg1[all])
            stor11++
            mem[ceil32(return_data.size) + ceil32(arg1.length) + 453] = stor11 + 1
            mem[ceil32(return_data.size) + ceil32(arg1.length) + 485] = 64
            mem[ceil32(return_data.size) + ceil32(arg1.length) + 517] = arg1.length
            emit Minted(Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[ceil32(return_data.size) + arg1.length + 485 len (2 * ceil32(arg1.length)) + -arg1.length + 64]);
    else:
        tokenByIndex.length++
        tokenByIndex[tokenByIndex.length].field_0 = stor11 + 1
        tokenByIndex[tokenByIndex.length].field_256 = msg.sender
        tokenByIndex[tokenByIndex.length].field_416 = 0
        stor3[stor11 + 1] = tokenByIndex.length
        emit Transfer(0, msg.sender, stor11 + 1);
        if ext_code.size(msg.sender) <= 0:
            if not stor3[stor11 + 1]:
                revert with 0, 
            ...
            stor8[stor11 + 1][] = Array(len=arg1.length, data=arg1[all])
            stor11++
            mem[ceil32(arg1.length) + 224] = stor11 + 1
            mem[ceil32(arg1.length) + 256] = 64
            mem[ceil32(arg1.length) + 288] = arg1.length
            emit Minted(Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 256 len (2 * ceil32(arg1.length)) + -arg1.length + 64]);
        else:
            if eth.balance(this.address) < 0:
                revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[590 len 26]
            if ext_code.size(msg.sender) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[484 len 160] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, stor11 + 1, 128, 0
            mem[672 len 4] = 0
            mem[644 len 0] = 0
            call msg.sender.0x80 with:
                 gas gas_remaining wei
                args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, stor11 + 1, 128, 0) << 1024, mem[644 len 4]
            if not return_data.size:
                require not ext_call.success
                revert with 0, 
                            32,
            ...
            if not stor3[stor11 + 1]:
                revert with 0, 
                            ...
                            44,
                            0x6e4552433732314d657461646174613a2055524920736574206f66206e6f6e6578697374656e7420746f6b65,
                            mem[ceil32(return_data.size) + ceil32(arg1.length) + 629 len 20]
            stor8[stor11 + 1][] = Array(len=arg1.length, data=arg1[all])
            stor11++
            mem[ceil32(return_data.size) + ceil32(arg1.length) + 517] = stor11 + 1
            mem[ceil32(return_data.size) + ceil32(arg1.length) + 549] = 64
            mem[ceil32(return_data.size) + ceil32(arg1.length) + 581] = arg1.length
            emit Minted(Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[ceil32(return_data.size) + arg1.length + 549 len (2 * ceil32(arg1.length)) + -arg1.length + 64]);
}
