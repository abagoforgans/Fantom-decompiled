...
function setGovAndRouter(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    if sub_cb971847Address:
        revert with 0, '!setGovAndRouter'
    if govAddress:
        revert with 0, '!setGovAndRouter'
    sub_cb971847Address = arg1
    govAddress = arg2
...
function convertDustToEarned() payable {
    ...
    if earnedAddress == token0Address:
        ...
        if ext_call.return_data[0] <= 0:
            ...
            require ext_code.size(token0Address)
            staticcall token0Address.allowance(address rg1, address rg2) with:
                    gas gas_remaining wei
                   args address(this.address), address(uniRouterAddress)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
                    ...
                    if 0 / wantLockedTotal <= sharesTotal:
                        ...
                        if 10000 <= sub_159a1f80:
                            ...
                            if not arg2:
                                ...
                                if not ext_code.size(wantAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, sub_159a1f80 * arg2 / 10000) >> 32
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                    ...
                    if not 0 / withdrawFeeFactor:
                        ...
                        if 0 / wantLockedTotal <= sharesTotal:
                            ...
                            if 10000 <= sub_159a1f80:
                                ...
                                if not ext_code.size(wantAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg2) >> 32
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                                ...
                                if not arg2:
                                    ...
                                    if not ext_code.size(wantAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[580 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), 0
                                    call wantAddress with:
                                       funct uint32(stor12)
                                         gas gas_remaining wei
                                    ...
                                    if not ext_code.size(wantAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[580 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, sub_159a1f80 * arg2 / 10000) >> 32
                                    call wantAddress with:
                                       funct uint32(stor12)
                                         gas gas_remaining wei
                ...
                if sharesTotal * wantLockedTotal / wantLockedTotal <= sharesTotal:
                    ...
                    if 10000 <= sub_159a1f80:
                        ...
                        if not wantLockedTotal:
                            ...
                            if not ext_code.size(wantAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[516 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, sub_159a1f80 * wantLockedTotal / 10000) >> 32
                            call wantAddress with:
                               funct uint32(stor12)
                                 gas gas_remaining wei
                        ...
                        if 0 / wantLockedTotal <= sharesTotal:
                            ...
                            if 10000 <= sub_159a1f80:
                                ...
                                if not wantLockedTotal:
                                    ...
                                    if not ext_code.size(wantAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[580 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, sub_159a1f80 * wantLockedTotal / 10000) >> 32
                                    call wantAddress with:
                                       funct uint32(stor12)
                                         gas gas_remaining wei
                    ...
                    if 0 / wantLockedTotal <= sharesTotal:
                        ...
                        if 10000 <= sub_159a1f80:
                            ...
                            if not ext_call.return_data[0]:
                                ...
                                if not ext_code.size(wantAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, sub_159a1f80 * ext_call.return_data[0] / 10000) >> 32
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                        ...
                        if 0 / wantLockedTotal <= sharesTotal:
                            ...
                            if 10000 <= sub_159a1f80:
                                ...
                                if not ext_call.return_data[0]:
                                    ...
                                    if not ext_code.size(wantAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[580 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, sub_159a1f80 * ext_call.return_data[0] / 10000) >> 32
                                    call wantAddress with:
                                       funct uint32(stor12)
                                         gas gas_remaining wei
...
function deposit(address arg1, uint256 arg2) payable {
    ...
    if not return_data.size:
            ...
            if not arg2:
                ...
                if not sharesTotal * arg2:
                    ...
                    if sharesTotal:
                        ...
                        stor1 = 1
                        return (entranceFeeFactor * sharesTotal * arg2 / wantLockedTotal / 10000)
            ('iszero', ('stor', ('name', 'sharesTotal', 17)))
            if not arg2:
                if not wantLockedTotal:
                    revert with 0, 'SafeMath: division by zero'
                if (0 / wantLockedTotal / 10000) + sharesTotal < sharesTotal:
                ...
                if not isAutoComp:
                    ...
                    if 2 * ext_call.return_data[0] < ext_call.return_data[0]:
                        revert with 0, 'SafeMath: addition overflow'
                    if eth.balance(this.address) < 0:
                        revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[818 len 26]
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[712 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 31, ext_call.return_data[0]) >> 31
                    call wantAddress with:
                       funct uint32(stor2.field_0)
                         gas gas_remaining wei
                        args Mask(224, 31, ext_call.return_data[0]) << 225, mem[776 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2
                        if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
                            revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[822 len 22]
                    else:
                        mem[744 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            ...
                            if not mem[744]:
                                revert with 0, 
                                            ...
                                            42,
                                            0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[ceil32(return_data.size) + 823 len 22]
                    require ext_code.size(farmContractAddress)
                    call farmContractAddress.deposit(uint256 rg1, uint256 rg2) with:
                         gas gas_remaining wei
                        args pid, ext_call.return_data[0]
        ...
        if not arg2:
            ...
            if 0 / wantLockedTotal / 10000:
                ...
                if not isAutoComp:
                    ...
                    if not return_data.size:
                        if not ext_call.success:
                            revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2
                        if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
                            revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[758 len 22]
                    else:
                ...
                if sharesTotal:
                    ...
                    if not isAutoComp:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[776 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 31, ext_call.return_data[0]) >> 31
                        call wantAddress with:
                           funct uint32(stor2.field_0)
                             gas gas_remaining wei
                            args Mask(224, 31, ext_call.return_data[0]) << 225, mem[840 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2
                            if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
                                revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[886 len 22]
                        else:
            ...
            stor1 = 1
            return (0 / wantLockedTotal / 10000)
        if sub_25c7ce6b * arg2 / arg2 != sub_25c7ce6b:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[393 len 23], 0, mem[420 len 4]
        if not wantLockedTotal:
            if (sub_25c7ce6b * arg2 / 10000) + sharesTotal < sharesTotal:
                revert with 0, 'SafeMath: addition overflow'
            sharesTotal += sub_25c7ce6b * arg2 / 10000
            if not isAutoComp:
                if (sub_25c7ce6b * arg2 / 10000) + wantLockedTotal < wantLockedTotal:
                    revert with 0, 'SafeMath: addition overflow'
                wantLockedTotal += sub_25c7ce6b * arg2 / 10000
            else:
                if not isAutoComp:
                    revert with 0, '!isAutoComp'
                require ext_code.size(wantAddress)
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            stor1 = 1
            return (sub_25c7ce6b * arg2 / 10000)
        if not sub_25c7ce6b * arg2 / 10000:
            if not wantLockedTotal:
                revert with 0, 'SafeMath: division by zero'
            if 0 / wantLockedTotal / 10000:
                if (0 / wantLockedTotal / 10000) + sharesTotal < sharesTotal:
            ...
            if sharesTotal * sub_25c7ce6b * arg2 / 10000 / sub_25c7ce6b * arg2 / 10000 != sharesTotal:
                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[457 len 31]
            if not sharesTotal * sub_25c7ce6b * arg2 / 10000:
                if not wantLockedTotal:
                    revert with 0, 'SafeMath: division by zero'
                if 0 / wantLockedTotal / 10000:
                    if (0 / wantLockedTotal / 10000) + sharesTotal < sharesTotal:
                ...
                if entranceFeeFactor * sharesTotal * sub_25c7ce6b * arg2 / 10000 / sharesTotal * sub_25c7ce6b * arg2 / 10000 != entranceFeeFactor:
                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[457 len 31]
                if not wantLockedTotal:
                    revert with 0, 'SafeMath: division by zero'
                if entranceFeeFactor * sharesTotal * sub_25c7ce6b * arg2 / 10000 / wantLockedTotal / 10000:
                    if (entranceFeeFactor * sharesTotal * sub_25c7ce6b * arg2 / 10000 / wantLockedTotal / 10000) + sharesTotal < sharesTotal:
                        revert with 0, 'SafeMath: addition overflow'
                    sharesTotal += entranceFeeFactor * sharesTotal * sub_25c7ce6b * arg2 / 10000 / wantLockedTotal / 10000
                    if not isAutoComp:
                        if (sub_25c7ce6b * arg2 / 10000) + wantLockedTotal < wantLockedTotal:
                            revert with 0, 'SafeMath: addition overflow'
                        wantLockedTotal += sub_25c7ce6b * arg2 / 10000
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    stor1 = 1
                    return (entranceFeeFactor * sharesTotal * sub_25c7ce6b * arg2 / 10000 / wantLockedTotal / 10000)
                if sharesTotal:
                    if (entranceFeeFactor * sharesTotal * sub_25c7ce6b * arg2 / 10000 / wantLockedTotal / 10000) + sharesTotal < sharesTotal:
                        revert with 0, 'SafeMath: addition overflow'
                    sharesTotal += entranceFeeFactor * sharesTotal * sub_25c7ce6b * arg2 / 10000 / wantLockedTotal / 10000
        ...
        if not sub_25c7ce6b * arg2 / 10000:
            ...
            stor1 = 1
            return (0 / wantLockedTotal / 10000)
        if entranceFeeFactor * sub_25c7ce6b * arg2 / 10000 / sub_25c7ce6b * arg2 / 10000 != entranceFeeFactor:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[585 len 31]
        if not wantLockedTotal:
            revert with 0, 'SafeMath: division by zero'
        if (entranceFeeFactor * sub_25c7ce6b * arg2 / 10000 / wantLockedTotal / 10000) + sharesTotal < sharesTotal:
            revert with 0, 'SafeMath: addition overflow'
        sharesTotal += entranceFeeFactor * sub_25c7ce6b * arg2 / 10000 / wantLockedTotal / 10000
        if not isAutoComp:
            if (sub_25c7ce6b * arg2 / 10000) + wantLockedTotal < wantLockedTotal:
                revert with 0, 'SafeMath: addition overflow'
            wantLockedTotal += sub_25c7ce6b * arg2 / 10000
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        stor1 = 1
        return (entranceFeeFactor * sub_25c7ce6b * arg2 / 10000 / wantLockedTotal / 10000)
        ...
        if not arg2:
            ...
            if eth.balance(this.address) < 0:
                revert with 0, 
                            ...
                            38,
                            0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c,
                            mem[ceil32(return_data.size) + 819 len 26]
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 713 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 31, ext_call.return_data[0]) >> 31
            mem[ceil32(return_data.size) + 805 len 4] = 0
            call wantAddress with:
               funct uint32(stor2.field_0)
                 gas gas_remaining wei
                args Mask(224, 31, ext_call.return_data[0]) << 225, mem[ceil32(return_data.size) + 777 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2
                if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
            ...
            call farmContractAddress.deposit(uint256 rg1, uint256 rg2) with:
                 gas gas_remaining wei
                args pid, ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 782 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            stor1 = 1
            return 0 / wantLockedTotal / 10000, 
    ...
    if not arg2:
        ...
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 777 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 31, ext_call.return_data[0]) >> 31
        mem[ceil32(return_data.size) + 869 len 4] = 0
        call wantAddress with:
           funct uint32(stor2.field_0)
             gas gas_remaining wei
            args Mask(224, 31, ext_call.return_data[0]) << 225, mem[ceil32(return_data.size) + 841 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2
            if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
        ...
        call farmContractAddress.deposit(uint256 rg1, uint256 rg2) with:
             gas gas_remaining wei
            args pid, ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 846 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        stor1 = 1
        return 0 / wantLockedTotal / 10000, 
