...
#
const sub_50df2bad(?) = 10000

const ownerNATIVEReward = 2000

const startTime = (454344 * 24 * 3600)

const NATIVEMaxSupply = 856864 * 10^18

const sub_a14328d4(?) = 9500

const sub_af298ff9(?) = 2 * 10^16

const NATIVE = 0x935a8c5beb73cb10be573a3f293d034bc85e9ffd


address owner;
uint256 stor1;
uint256 sub_e34be63c;
...
function getMultiplier(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0x935a8c5beb73cb10be573a3f293d034bc85e9ffd)
    staticcall 0x935a8c5beb73cb10be573a3f293d034bc85e9ffd.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] >= 856864 * 10^18:
        return 0
    if arg1 > arg2:
        revert with 0, 'SafeMath: subtraction overflow'
    return (arg2 - arg1)
...
function add(uint256 arg1, address arg2, address arg3) payable {
    ...
    if block.timestamp > 454344 * 24 * 3600:
        poolInfo[poolInfo.length].field_512 = block.timestamp
    else:
        poolInfo[poolInfo.length].field_512 = 454344 * 24 * 3600
...
function inCaseTokensGetStuck(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 == 0x935a8c5beb73cb10be573a3f293d034bc85e9ffd:
        revert with 0, '!safe'
                ...
                if block.timestamp - poolInfo[arg1].field_512 > 0:
                    if not block.timestamp - poolInfo[arg1].field_512:
                        ...
                        if not 0 / totalAllocPoint:
                            require ext_code.size(0x935a8c5beb73cb10be573a3f293d034bc85e9ffd)
                            call 0x935a8c5beb73cb10be573a3f293d034bc85e9ffd.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 0
                        else:
                            require 0 / totalAllocPoint
                            if 2000 * 0 / totalAllocPoint / 0 / totalAllocPoint != 2000:
                                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                            require ext_code.size(0x935a8c5beb73cb10be573a3f293d034bc85e9ffd)
                            call 0x935a8c5beb73cb10be573a3f293d034bc85e9ffd.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 2000 * 0 / totalAllocPoint / 10000
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(0x935a8c5beb73cb10be573a3f293d034bc85e9ffd)
                        call 0x935a8c5beb73cb10be573a3f293d034bc85e9ffd.0x40c10f19 with:
                        ...
                        if (2 * 10^16 * block.timestamp) - (2 * 10^16 * poolInfo[arg1].field_512) / block.timestamp - poolInfo[arg1].field_512 != 2 * 10^16:
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not (2 * 10^16 * block.timestamp) - (2 * 10^16 * poolInfo[arg1].field_512):
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            if not 0 / totalAllocPoint:
                            ...
                            require (2 * 10^16 * block.timestamp) - (2 * 10^16 * poolInfo[arg1].field_512)
                            if (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / (2 * 10^16 * block.timestamp) - (2 * 10^16 * poolInfo[arg1].field_512) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            if not (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint:
                                require ext_code.size(0x935a8c5beb73cb10be573a3f293d034bc85e9ffd)
                                call 0x935a8c5beb73cb10be573a3f293d034bc85e9ffd.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args owner, 0
                            else:
                                require (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint
                                if 2000 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint != 2000:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                                require ext_code.size(0x935a8c5beb73cb10be573a3f293d034bc85e9ffd)
                                call 0x935a8c5beb73cb10be573a3f293d034bc85e9ffd.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args owner, 2000 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / 10000
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(0x935a8c5beb73cb10be573a3f293d034bc85e9ffd)
                            call 0x935a8c5beb73cb10be573a3f293d034bc85e9ffd.0x40c10f19 with:
                                 gas gas_remaining wei
                                args address(this.address), (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint:
                                if ext_call.return_data[0] <= 0:
                                ...
                                require (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint
                                if 10^12 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (10^12 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
                    poolInfo[arg1].field_512 = block.timestamp
}
...
function pendingNATIVE(uint256 arg1, address arg2) payable {
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (2 * 10^16 * block.timestamp * poolInfo[arg1].field_256) - (2 * 10^16 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
