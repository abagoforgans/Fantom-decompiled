...
function updateRewardAmount(uint256 arg1) payable {
    ...
    if block.timestamp <= starttime:
        if not DURATION:
            ...
            if arg1 >= 0:
                call sub_daf5feb6Address.transferFrom(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args msg.sender, this.address, arg1
            else:
                call sub_daf5feb6Address.transfer(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
...
function withdraw(uint256 arg1) payable {
    ...
    call lptAddress.transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args msg.sender, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function stake(uint256 arg1) payable {
    ...
    balanceOf[msg.sender] += arg1
    require ext_code.size(lptAddress)
    call lptAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
        args msg.sender, this.address, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
