        ...
        if block.timestamp >= sub_50186dcb:
            ...
            if lockedAmount:
                ...
                if lockedAmount <= ext_call.return_data[0]:
                    ...
                    if not ext_code.size(sub_b6b86a34Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[456 len 64] = 0, address(devaddr), Mask(224, 0, stor4.field_32)
                    call sub_b6b86a34Address with:
                       funct uint32(stor2)
                         gas gas_remaining wei
                    ...
                    if not ext_code.size(sub_b6b86a34Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[456 len 64] = 0, address(devaddr), ext_call.return_data[0 len 28]
                    call sub_b6b86a34Address with:
                       funct uint32(stor2)
                         gas gas_remaining wei
            ...
            if not lockedAmount:
                ...
                if 0 / sub_50186dcb - lastUnlockTime:
                    ...
                    if 0 / sub_50186dcb - lastUnlockTime <= ext_call.return_data[0]:
                        ...
                        if not ext_code.size(sub_b6b86a34Address):
                            revert with 0, 'Address: call to non-contract'
                        mem[456 len 64] = 0, address(devaddr), Mask(224, 32, 0 / sub_50186dcb - lastUnlockTime) >> 32
                        call sub_b6b86a34Address with:
                           funct uint32(stor2)
                             gas gas_remaining wei
                ...
                if (block.timestamp * lockedAmount) - (lastUnlockTime * lockedAmount) / sub_50186dcb - lastUnlockTime:
                    ...
                    if (block.timestamp * lockedAmount) - (lastUnlockTime * lockedAmount) / sub_50186dcb - lastUnlockTime <= ext_call.return_data[0]:
                        ...
                        if not ext_code.size(sub_b6b86a34Address):
                            revert with 0, 'Address: call to non-contract'
                        mem[456 len 64] = 0, address(devaddr), Mask(224, 32, (block.timestamp * lockedAmount) - (lastUnlockTime * lockedAmount) / sub_50186dcb - lastUnlockTime) >> 32
                        call sub_b6b86a34Address with:
                           funct uint32(stor2)
                             gas gas_remaining wei
            ...
            if block.timestamp >= sub_50186dcb:
                ...
                if not lockedAmount:
                    ...
                    if lockedAmount <= ext_call.return_data[0]:
                        ...
                        if not ext_code.size(sub_b6b86a34Address):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 457 len 64] = 0, address(devaddr), Mask(224, 0, stor4.field_32)
                        call sub_b6b86a34Address with:
                           funct uint32(stor2)
                             gas gas_remaining wei
                        ...
                        if not ext_code.size(sub_b6b86a34Address):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 457 len 64] = 0, address(devaddr), ext_call.return_data[0 len 28]
                        call sub_b6b86a34Address with:
                           funct uint32(stor2)
                             gas gas_remaining wei
                ...
                if not lockedAmount:
                    ...
                    if not 0 / sub_50186dcb - lastUnlockTime:
                        ...
                        if 0 / sub_50186dcb - lastUnlockTime <= ext_call.return_data[0]:
                            ...
                            if not ext_code.size(sub_b6b86a34Address):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 457 len 64] = 0, address(devaddr), Mask(224, 32, 0 / sub_50186dcb - lastUnlockTime) >> 32
                            call sub_b6b86a34Address with:
                               funct uint32(stor2)
                                 gas gas_remaining wei
                    ...
                    if (block.timestamp * lockedAmount) - (lastUnlockTime * lockedAmount) / sub_50186dcb - lastUnlockTime:
                        ...
                        if (block.timestamp * lockedAmount) - (lastUnlockTime * lockedAmount) / sub_50186dcb - lastUnlockTime <= ext_call.return_data[0]:
                            ...
                            if not ext_code.size(sub_b6b86a34Address):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 457 len 64] = 0, address(devaddr), Mask(224, 32, (block.timestamp * lockedAmount) - (lastUnlockTime * lockedAmount) / sub_50186dcb - lastUnlockTime) >> 32
                            call sub_b6b86a34Address with:
                               funct uint32(stor2)
                                 gas gas_remaining wei
