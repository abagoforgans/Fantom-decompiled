...
function rebalance(address arg1) payable {
    ...
    if arg1 != lpToken0Address:
        if not lp1ToLp0Route.length:
            ...
            call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.0xf824f62e with:
                 gas gas_remaining wei
                args 0, Mask(31, 1, ext_call.return_data[0]), 0, 192, address(this.address), block.timestamp + 600, 0xd54307a8edfa93b1794861f091c714d752400d13, lp1ToLp0Route.length
        else:
            mem[388] = address(lp1ToLp0Route.field_0)
            idx = 388
            s = 0
            while (32 * lp1ToLp0Route.length) + 388 > idx + 32:
            ...
            call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.0xf824f62e with:
                 gas gas_remaining wei
                args 0, Mask(31, 1, ext_call.return_data[0]), 0, 192, address(this.address), block.timestamp + 600, 0xd54307a8edfa93b1794861f091c714d752400d13, lp1ToLp0Route.length, mem[388 len 32 * lp1ToLp0Route.length]
    else:
        if not lp0ToLp1Route.length:
            require ext_code.size(0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52)
            call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.0xf824f62e with:
                 gas gas_remaining wei
                args 0, Mask(31, 1, ext_call.return_data[0]), 0, 192, address(this.address), block.timestamp + 600, 0xd54307a8edfa93b1794861f091c714d752400d13, lp0ToLp1Route.length
        else:
            mem[388] = address(lp0ToLp1Route.field_0)
            idx = 388
            s = 0
            while (32 * lp0ToLp1Route.length) + 388 > idx + 32:
            ...
            call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.0xf824f62e with:
                 gas gas_remaining wei
                args 0, Mask(31, 1, ext_call.return_data[0]), 0, 192, address(this.address), block.timestamp + 600, 0xd54307a8edfa93b1794861f091c714d752400d13, lp0ToLp1Route.length, mem[388 len 32 * lp0ToLp1Route.length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
