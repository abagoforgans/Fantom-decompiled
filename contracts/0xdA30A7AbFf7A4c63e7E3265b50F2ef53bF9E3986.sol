...
function sub_33f0816d(?) payable {
    mem[64] = 96
    if owner != msg.sender:
        revert with 0, 'Caller is not owner'
    s = 0
    while 0 < sub_c502d2d0.length:
        mem[0] = 1
        mem[mem[64] + 4] = sub_c502d2d0
        require ext_code.size(stor2)
        call stor2.getApproved(uint256 arg1) with:
             gas gas_remaining wei
            args sub_c502d2d0
        ...
        if mem[_18 + 12 len 20] == this.address:
            s = s
            continue 
        if sub_c502d2d0.length < 1:
            revert with 'NH{q', 17
        if sub_c502d2d0.length - 1 >= sub_c502d2d0.length:
            revert with 'NH{q', 50
        if 0 >= sub_c502d2d0.length:
            revert with 'NH{q', 50
        sub_c502d2d0 = sub_c502d2d0[sub_c502d2d0.length]
        if not sub_c502d2d0.length:
            revert with 'NH{q', 49
        mem[0] = 1
        sub_c502d2d0[sub_c502d2d0.length] = 0
