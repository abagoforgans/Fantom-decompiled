...
function retireStrat() payable {
    ...
    require return_data.size >= 64
    require ext_code.size(address(masterchefAddress))
    call address(masterchefAddress).leaveStaking(uint256 arg1) with:
         gas gas_remaining wei
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        if ext_call.return_data[0] >= ext_call.return_data[0]:
            require ext_code.size(address(masterchefAddress))
            call address(masterchefAddress).enterStaking(uint256 arg1) with:
                 gas gas_remaining wei
                args ext_call.return_data[0]
        else:
            ...
            if not return_data.size:
                ...
                if return_data.size <= 0:
                    ...
                    call wantAddress with:
                       funct uint32(stor6)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 489 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0
                        if not approve(address arg1, uint256 arg2), Mask(224, 0, stor6):
    ...
    if arg5 != 3:
        if arg5 != 2:
            ...
            if not return_data.size:
                ...
                if ext_call.return_data[0]:
                    revert with 0, 
                                ...
                                0x645361666545524332303a20617070726f76652066726f6d206e6f6e2d7a65726f20746f206e6f6e2d7a65726f20616c6c6f77616e63,
                                mem[446 len 10]
                mem[360] = address(stor8)
                mem[392] = -1
                mem[324] = 68
                mem[360 len 28] = Mask(224, 0, stor8)
                mem[356 len 4] = approve(address arg1, uint256 arg2)
                mem[424] = 32
                mem[456] = 'SafeERC20: low-level call failed'
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[488 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[580 len 4] = 0
                call wrappedAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
                ...
                mem[ceil32(return_data.size) + 361] = address(stor8)
                mem[ceil32(return_data.size) + 393] = -1
                mem[ceil32(return_data.size) + 325] = 68
                mem[ceil32(return_data.size) + 361 len 28] = Mask(224, 0, stor8)
                ...
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 489 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            ...
            while outputToWantRoute.length > idx:
                ...
                continue 
            address(stor8) = arg4
            mem[228] = address(stor8)
            mem[260] = 0
            mem[192] = 68
            mem[228 len 28] = Mask(224, 0, stor8)
            mem[224 len 4] = approve(address arg1, uint256 arg2)
            mem[292] = 32
            mem[324] = 'SafeERC20: low-level call failed'
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[356 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0
            mem[448 len 4] = 0
            call wrappedAddress with:
               funct uint32(stor8)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if wrappedAddress <= 0:
                    ...
                    if ext_call.return_data[0]:
                        revert with 0, 
                                    ...
                                    0x645361666545524332303a20617070726f76652066726f6d206e6f6e2d7a65726f20746f206e6f6e2d7a65726f20616c6c6f77616e63,
                                    mem[478 len 10]
                    mem[392] = address(stor8)
                    mem[424] = -1
                    mem[356] = 68
                    mem[392 len 28] = Mask(224, 0, stor8)
                    mem[388 len 4] = approve(address arg1, uint256 arg2)
                    mem[456] = 32
                    mem[488] = 'SafeERC20: low-level call failed'
                    if ext_code.size(wrappedAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[520 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                    mem[612 len 4] = 0
                    mem[584 len 0] = 0
                    call wrappedAddress with:
                       funct uint32(stor8)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[584 len 4]
                else:
                    require wrappedAddress >= 32
                    if not arg1:
                ...
                mem[ceil32(return_data.size) + 393] = address(stor8)
                mem[ceil32(return_data.size) + 425] = -1
                mem[ceil32(return_data.size) + 357] = 68
                mem[ceil32(return_data.size) + 393 len 28] = Mask(224, 0, stor8)
                ...
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 521 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        while outputToWantRoute.length > idx:
            ...
            continue 
        address(stor8) = arg4
        mem[260] = address(stor8)
        mem[292] = 0
        mem[224] = 68
        mem[260 len 28] = Mask(224, 0, stor8)
        mem[256 len 4] = approve(address arg1, uint256 arg2)
        mem[324] = 32
        mem[356] = 'SafeERC20: low-level call failed'
        if ext_code.size(wrappedAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[388 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0
        mem[480 len 4] = 0
        call wrappedAddress with:
           funct uint32(stor8)
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if wrappedAddress <= 0:
                ...
                if ext_call.return_data[0]:
                    revert with 0, 
                                ...
                                0x645361666545524332303a20617070726f76652066726f6d206e6f6e2d7a65726f20746f206e6f6e2d7a65726f20616c6c6f77616e63,
                                mem[510 len 10]
                mem[424] = address(stor8)
                mem[456] = -1
                mem[388] = 68
                mem[424 len 28] = Mask(224, 0, stor8)
                mem[420 len 4] = approve(address arg1, uint256 arg2)
                mem[488] = 32
                mem[520] = 'SafeERC20: low-level call failed'
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[552 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[644 len 4] = 0
                mem[616 len 0] = 0
                call wrappedAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[616 len 4]
            else:
                require wrappedAddress >= 32
                if not arg1:
            ...
            mem[ceil32(return_data.size) + 425] = address(stor8)
            mem[ceil32(return_data.size) + 457] = -1
            mem[ceil32(return_data.size) + 389] = 68
            mem[ceil32(return_data.size) + 425 len 28] = Mask(224, 0, stor8)
            ...
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 553 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
