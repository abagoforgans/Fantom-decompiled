...
function latestRoundData() payable {
    ...
    require ext_code.size(yVaultAddress)
    staticcall yVaultAddress.pricePerShare() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[32] <= 0:
        ...
        if not 10^ext_call.return_data[0]:
            revert with 0, 'SafeMath: division by zero'
        return ext_call.return_data[0] << 176, 
               ext_call.return_data[0] * sub_e28a1b86 / 10^ext_call.return_data[0],
               ext_call.return_data[64],
               ext_call.return_data[96],
               Mask(80, 0, ext_call.return_data[128])
    ...
    if not 10^ext_call.return_data[0]:
        revert with 0, 'SafeMath: division by zero'
    return ext_call.return_data[0] << 176, 
           ext_call.return_data[0] * ext_call.return_data[32] / 10^ext_call.return_data[0],
           ext_call.return_data[64],
           ext_call.return_data[96],
           Mask(80, 0, ext_call.return_data[128])
}
