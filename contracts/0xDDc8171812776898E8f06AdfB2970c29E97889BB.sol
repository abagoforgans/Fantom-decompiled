...
function getProtocolNonce(address arg1) payable {
    ...
    staticcall arg1.0xa5212d9a with:
...
function getAddressFromFactory(bytes32 arg1) payable {
    ...
    staticcall protocolFactoryAddress.0x5515fe0a with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getFileClaimWindow(address arg1) payable {
    ...
    require arg1 == arg1
    require ext_code.size(arg1)
    staticcall arg1.0x81c4fb5b with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function validateClaim(address arg1, uint256 arg2, uint256 arg3, bool arg4) payable {
    ...
    if arg4:
        ...
        if not ext_code.hash(feeCurrencyAddress):
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), protocolClaims[address(arg1)][arg2][arg3].field_512, 0
        mem[ceil32(return_data.size) + 328] = 0
        call feeCurrencyAddress with:
           funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), protocolClaims[address(arg1)][arg2][arg3].field_512, 0) >> 224
             gas gas_remaining wei
            args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), protocolClaims[address(arg1)][arg2][arg3].field_512, 0) << 288)
...
function forceFileClaim(address arg1, bytes32 arg2, uint48 arg3) payable {
    require calldata.size - 4 >= 96
    require arg1 == arg1
    ...
    mem[(4 * ceil32(return_data.size)) + 512] = forceClaimFee
    protocolClaims[address(arg1)][ext_call.return_data[0]].field_0++
    protocolClaims[address(arg1)][ext_call.return_data[0]][protocolClaims[address(arg1)][ext_call.return_data[0]].field_0].field_0 = 1
    ...
    protocolClaims[address(arg1)][ext_call.return_data[0]][protocolClaims[address(arg1)][ext_call.return_data[0]].field_0].field_512 = forceClaimFee
    mem[(4 * ceil32(return_data.size)) + 580] = msg.sender
    mem[(4 * ceil32(return_data.size)) + 612] = this.address
    mem[(4 * ceil32(return_data.size)) + 644] = forceClaimFee
    mem[(4 * ceil32(return_data.size)) + 544] = 100
    mem[(4 * ceil32(return_data.size)) + 580 len 28] = Mask(224, 32, msg.sender) >> 32
    mem[(4 * ceil32(return_data.size)) + 576 len 4] = unknown_0x23b872dd(?????)
    ...
    if not ext_code.hash(feeCurrencyAddress):
        revert with 0, 'Address: call to non-contract'
    mem[(4 * ceil32(return_data.size)) + 740 len 128] = unknown_0x23b872dd(?????), msg.sender, address(this.address), forceClaimFee, 0
    mem[(4 * ceil32(return_data.size)) + 840] = 0
    call feeCurrencyAddress with:
       funct Mask(32, 224, unknown_0x23b872dd(?????), msg.sender, address(this.address), forceClaimFee, 0) >> 224
         gas gas_remaining wei
        args (Mask(768, -544, unknown_0x23b872dd(?????), msg.sender, address(this.address), forceClaimFee, 0) << 544)
    if not return_data.size:
        if not ext_call.success:
            if ext_call.return_data[0]:
                revert with memory
        ...
        if return_data.size:
            ...
            if not mem[(4 * ceil32(return_data.size)) + 772]:
                revert with 0, 'SafeERC20: ERC20 operation did not succeed'
    emit ClaimFiled(arg3 << 208, ext_call.return_data[0], protocolClaims[address(arg1)][ext_call.return_data[0]].field_0 - 1, forceClaimFee, 1, msg.sender, arg1);
}
...
function decideClaim(address arg1, uint256 arg2, uint256 arg3, bool arg4, uint16 arg5, uint16 arg6) payable {
    ...
    if block.timestamp - protocolClaims[address(arg1)][arg2][arg3].field_200 > maxClaimDecisionWindow - 3600:
        ...
        mem[ceil32(return_data.size) + 512 len 4] = unknown_0xa9059cbb(?????)
        ...
        if not ext_code.hash(feeCurrencyAddress):
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 644 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), protocolClaims[address(arg1)][arg2][arg3].field_512, 0
        ...
        if not arg4:
            ...
            if not ext_code.hash(feeCurrencyAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 644 len 96] = unknown_0xa9059cbb(?????), protocolClaims[address(arg1)][arg2][arg3].field_0, protocolClaims[address(arg1)][arg2][arg3].field_0, protocolClaims[address(arg1)][arg2][arg3].field_512, 0
            mem[ceil32(return_data.size) + 712] = 0
            call feeCurrencyAddress with:
               funct Mask(32, 224, unknown_0xa9059cbb(?????), protocolClaims[address(arg1)][arg2][arg3].field_0, protocolClaims[address(arg1)][arg2][arg3].field_0, protocolClaims[address(arg1)][arg2][arg3].field_512, 0) >> 224
                 gas gas_remaining wei
                args (Mask(512, -288, unknown_0xa9059cbb(?????), protocolClaims[address(arg1)][arg2][arg3].field_0, protocolClaims[address(arg1)][arg2][arg3].field_0, protocolClaims[address(arg1)][arg2][arg3].field_512, 0) << 288)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
...
function fileClaim(address arg1, bytes32 arg2, uint48 arg3) payable {
    ...
    if not stor10[address(arg1)]:
        ...
        if not ext_code.hash(feeCurrencyAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(4 * ceil32(return_data.size)) + 740 len 128] = unknown_0x23b872dd(?????), msg.sender, address(this.address), baseClaimFee, 0
        mem[(4 * ceil32(return_data.size)) + 840] = 0
        call feeCurrencyAddress with:
           funct Mask(32, 224, unknown_0x23b872dd(?????), msg.sender, address(this.address), baseClaimFee, 0) >> 224
             gas gas_remaining wei
            args (Mask(768, -544, unknown_0x23b872dd(?????), msg.sender, address(this.address), baseClaimFee, 0) << 544)
        if not return_data.size:
            if not ext_call.success:
                if ext_call.return_data[0]:
                    revert with memory
        ...
        if not ext_code.hash(feeCurrencyAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(4 * ceil32(return_data.size)) + 740 len 128] = unknown_0x23b872dd(?????), msg.sender, address(this.address), stor10[address(arg1)], 0
        mem[(4 * ceil32(return_data.size)) + 840] = 0
        call feeCurrencyAddress with:
           funct Mask(32, 224, unknown_0x23b872dd(?????), msg.sender, address(this.address), stor10[address(arg1)], 0) >> 224
             gas gas_remaining wei
            args (Mask(768, -544, unknown_0x23b872dd(?????), msg.sender, address(this.address), stor10[address(arg1)], 0) << 544)
        if not return_data.size:
            if not ext_call.success:
                if ext_call.return_data[0]:
                    revert with memory
