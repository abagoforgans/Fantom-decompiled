...
const pairCodeHash = sha3(code.data[1823 len 8918])

const INIT_CODE_PAIR_HASH = sha3(code.data[1823 len 8896], mem[17984 len 10], Mask(96, 80, code.data[10729 len 12]) >> 80)
