...
function getPrice() {
    if tokenByIndex.length < 1000:
        return 15 * 10^18
    if tokenByIndex.length > 0x2492492492492492492492492492492492492492492492492492492492492492:
        revert with 0, 17
    if 7 * tokenByIndex.length / 50 < 125:
        revert with 0, 17
    if (7 * tokenByIndex.length / 50) - 125 > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    return ((10^18 * 7 * tokenByIndex.length / 50) - 125 * 10^18)
}

function payout() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x8d1f0c53b3c2faae5a2db074dbfac191e4e2ce39 with:
       value eth.balance(this.address) / 2 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    call 0x68f5f8367eed81f6f7f9c463de6c4c0d2adb2cca with:
       value eth.balance(this.address) / 2 wei
         gas 2300 * is_zero(value) wei
}
...
function sub_1abcfa8a(?) payable {
    ...
    if tokenByIndex.length < 1000:
        if 15 * 10^18 > msg.value:
            revert with 0, 'not enough paid!'
    else:
        if tokenByIndex.length > 0x2492492492492492492492492492492492492492492492492492492492492492:
            revert with 0, 17
        if 7 * tokenByIndex.length / 50 < 125:
        ...
        if (7 * tokenByIndex.length / 50) - 125 > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
            revert with 0, 17
        if (10^18 * 7 * tokenByIndex.length / 50) - 125 * 10^18 > msg.value:
            revert with 0, 'not enough paid!'
    if tokenByIndex.length > 10000:
        revert with 0, 'supply depleted'
    if not msg.sender:
