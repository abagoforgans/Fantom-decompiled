...
function rely(address arg1) payable {
    ...
    if wards[address(msg.sender)] != 1:
        revert with 0, 'Spirit/not-authorized'
...
function burn(address arg1, uint256 arg2) payable {
    ...
    if balanceOf[address(arg1)] < arg2:
        revert with 0, 'Spirit/insufficient-balance'
    if arg1 != msg.sender:
        if allowance[address(arg1)][address(msg.sender)] != -1:
            if allowance[address(arg1)][address(msg.sender)] < arg2:
                revert with 0, 'Spirit/insufficient-allowance'
...
function permit(address arg1, address arg2, uint256 arg3, uint256 arg4, bool arg5, uint8 arg6, bytes32 arg7, bytes32 arg8) payable {
    ...
    if not arg1:
        revert with 0, 'Spirit/invalid-address-0'
    ...
    if arg1 != address(signer):
        revert with 0, 'Spirit/invalid-permit'
    if arg4:
        if block.timestamp > arg4:
            revert with 0, 'Spirit/permit-expired'
    nonces[address(arg1)]++
    if arg3 != nonces[address(arg1)]:
        revert with 0, 'Spirit/invalid-nonce'
    if arg5:
