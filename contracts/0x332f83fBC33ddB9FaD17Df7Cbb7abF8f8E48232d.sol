...
function sub_f50cd32c(?) payable {
    ...
    if address(cd[(cd[4] + ('cd', 4)[5] + 68)]):
        ...
        call address(cd[(cd[4] + ('cd', 4)[5] + 68)]).approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
    ...
    if eth.balance(cd[(cd[4] + ('cd', 4)[5] + 196)]):
        ...
        call address(cd[(cd[4] + ('cd', 4)[5] + 36)]).0x57e134d9 with:
             gas gas_remaining wei
        ...
        if ext_call.success:
            emit 0x245fa87d: address(cd[(cd[4] + ('cd', 4)[5] + 164)]), address(cd[(cd[4] + ('cd', 4)[5] + 196)]), cd[36]
        else:
            require ('cd', 4)[0] == address(('cd', 4)[0])
            require ('cd', 4)[0] == address(('cd', 4)[0])
            require ext_code.size(address(('cd', 4)[0]))
            staticcall address(('cd', 4)[0]).balanceOf(address arg1) with:
                    gas gas_remaining wei
                   args this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(address(('cd', 4)[0]))
            call address(('cd', 4)[0]).transfer(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args address(cd[(cd[4] + ('cd', 4)[5] + 196)]), ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_call.return_data[0] == bool(ext_call.return_data[0])
            emit 0x7a68b84f: address(cd[(cd[4] + ('cd', 4)[5] + 164)]), address(cd[(cd[4] + ('cd', 4)[5] + 196)]), cd[36]
    else:
        require ('cd', 4)[0] == address(('cd', 4)[0])
        ...
        if not ext_call.success:
            ...
            if ext_call.success:
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                emit 0x7a68b84f: address(cd[(cd[4] + ('cd', 4)[5] + 164)]), address(cd[(cd[4] + ('cd', 4)[5] + 196)]), cd[36] - stor1[address(('cd', 4)[0])]
}
