...
function oneOfOne(uint256 arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if bool(stor24[arg1].field_0):
        if bool(stor24[arg1].field_0) == uint255(stor24[arg1].field_1) < 32:
            revert with 'NH{q', 34
        if bool(stor24[arg1].field_0):
            if bool(stor24[arg1].field_0) == uint255(stor24[arg1].field_1) < 32:
                revert with 'NH{q', 34
            if uint255(stor24[arg1].field_1):
                if 31 < uint255(stor24[arg1].field_1):
                    mem[128] = uint256(stor24[arg1].field_0)
                    idx = 128
                    s = 0
                    while uint255(stor24[arg1].field_1) + 96 > idx:
                        mem[idx + 32] = uint256(stor24[arg1][s].field_256)
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, uint255(stor24[arg1].field_1)), data=mem[128 len ceil32(uint255(stor24[arg1].field_1))])
                mem[128] = 256 * Mask(248, 0, stor24[arg1].field_8)
        else:
            ...
            if stor24[arg1].field_1 % 128:
                if 31 < stor24[arg1].field_1 % 128:
                    ...
                    idx = 128
                    s = 0
                    while stor24[arg1].field_1 % 128 + 96 > idx:
                        mem[idx + 32] = uint256(stor24[arg1][s].field_256)
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, uint255(stor24[arg1].field_1)), data=mem[128 len ceil32(uint255(stor24[arg1].field_1))])
                mem[128] = 256 * Mask(248, 0, stor24[arg1].field_8)
        mem[ceil32(uint255(stor24[arg1].field_1)) + 192 len ceil32(uint255(stor24[arg1].field_1))] = mem[128 len ceil32(uint255(stor24[arg1].field_1))]
        if ceil32(uint255(stor24[arg1].field_1)) > uint255(stor24[arg1].field_1):
            mem[ceil32(uint255(stor24[arg1].field_1)) + uint255(stor24[arg1].field_1) + 192] = 0
        return Array(len=2 * Mask(256, -1, uint255(stor24[arg1].field_1)), data=mem[128 len ceil32(uint255(stor24[arg1].field_1))], mem[(2 * ceil32(uint255(stor24[arg1].field_1))) + 192 len 2 * ceil32(uint255(stor24[arg1].field_1))]), 
    if bool(stor24[arg1].field_0) == stor24[arg1].field_1 % 128 < 32:
        revert with 'NH{q', 34
    if bool(stor24[arg1].field_0):
        if bool(stor24[arg1].field_0) == uint255(stor24[arg1].field_1) < 32:
        ...
        if uint255(stor24[arg1].field_1):
            if 31 < uint255(stor24[arg1].field_1):
                ...
                while uint255(stor24[arg1].field_1) + 96 > idx:
                    ...
                    s = s + 1
                    continue 
                return Array(len=stor24[arg1].field_0 % 128, data=mem[128 len ceil32(stor24[arg1].field_1 % 128)])
            mem[128] = 256 * Mask(248, 0, stor24[arg1].field_8)
    else:
        if bool(stor24[arg1].field_0) == stor24[arg1].field_1 % 128 < 32:
            revert with 'NH{q', 34
        if stor24[arg1].field_1 % 128:
            if 31 < stor24[arg1].field_1 % 128:
                ...
                return Array(len=stor24[arg1].field_0 % 128, data=mem[128 len ceil32(stor24[arg1].field_1 % 128)])
            mem[128] = 256 * Mask(248, 0, stor24[arg1].field_8)
    mem[ceil32(stor24[arg1].field_1 % 128) + 192 len ceil32(stor24[arg1].field_1 % 128)] = mem[128 len ceil32(stor24[arg1].field_1 % 128)]
    if ceil32(stor24[arg1].field_1 % 128) > stor24[arg1].field_1 % 128:
        mem[ceil32(stor24[arg1].field_1 % 128) + stor24[arg1].field_1 % 128 + 192] = 0
    return Array(len=stor24[arg1].field_0 % 128, data=mem[128 len ceil32(stor24[arg1].field_1 % 128)], mem[(2 * ceil32(stor24[arg1].field_1 % 128)) + 192 len 2 * ceil32(stor24[arg1].field_1 % 128)]), 
}
...
function sub_24cf69c2(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[_108] = cd[(cd[4] + cd[s] + 36)]
        require cd[4] + cd[s] + cd[(cd[4] + cd[s] + 36)] + 68 <= calldata.size
        mem[_108 + 32 len cd[(cd[4] + cd[s] + 36)]] = call.data[cd[4] + cd[s] + 68 len cd[(cd[4] + cd[s] + 36)]]
        mem[_108 + cd[(cd[4] + cd[s] + 36)] + 32] = 0
        mem[t] = _108
        idx = idx + 1
        s = s + 32
        t = t + 32
    ...
    while idx < ('cd', 36).length:
        ...
        mem[_213] = cd[(cd[36] + cd[s] + 36)]
        require cd[36] + cd[s] + cd[(cd[36] + cd[s] + 36)] + 68 <= calldata.size
        mem[_213 + 32 len cd[(cd[36] + cd[s] + 36)]] = call.data[cd[36] + cd[s] + 68 len cd[(cd[36] + cd[s] + 36)]]
        mem[_213 + cd[(cd[36] + cd[s] + 36)] + 32] = 0
        mem[t] = _213
        idx = idx + 1
        s = s + 32
        t = t + 32
    ...
    while idx < ('cd', 68).length:
        ...
        mem[_318] = cd[(cd[68] + cd[s] + 36)]
        require cd[68] + cd[s] + cd[(cd[68] + cd[s] + 36)] + 68 <= calldata.size
        mem[_318 + 32 len cd[(cd[68] + cd[s] + 36)]] = call.data[cd[68] + cd[s] + 68 len cd[(cd[68] + cd[s] + 36)]]
        mem[_318 + cd[(cd[68] + cd[s] + 36)] + 32] = 0
        mem[t] = _318
        idx = idx + 1
        s = s + 32
        t = t + 32
