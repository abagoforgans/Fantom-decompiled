...
function mint(address arg1, string arg2) payable {
    ...
    if tokenOfOwnerByIndex[address(arg1)][1][stor11 + 1]:
        if stor3[stor11 + 1]:
            require stor3[stor11 + 1] - 1 < tokenByIndex.length
            tokenByIndex[stor3[stor11 + 1] - 1].field_256 = arg1
            ...
            if not ext_code.size(arg1):
                ...
                stor8[stor11 + 1][].field_0 = Array(len=arg2.length, data=arg2[all])
                call sub_3740ebb3Address with:
                   value msg.value wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                creators[stor11 + 1] = msg.sender
            ...
            mem[420 len 160] = unknown_0x150b7a02(?????), msg.sender, 0, tokenIdPointer + 1, 128, 0
            mem[608 len 4] = 0
            mem[580 len 0] = 0
            call arg1.0x80 with:
                 gas gas_remaining wei
                args Mask(1248, -1024, unknown_0x150b7a02(?????), msg.sender, 0, tokenIdPointer + 1, 128, 0) << 1024, mem[580 len 4]
        ...
        if not ext_code.size(arg1):
            revert with 0, 'Address: call to non-contract'
        mem[484 len 160] = unknown_0x150b7a02(?????), msg.sender, 0, tokenIdPointer + 1, 128, 0
        mem[672 len 4] = 0
        call arg1.0x80 with:
             gas gas_remaining wei
    ...
    tokenOfOwnerByIndex[address(arg1)][1][stor11 + 1] = tokenOfOwnerByIndex[address(arg1)]
    if stor3[stor11 + 1]:
        require stor3[stor11 + 1] - 1 < tokenByIndex.length
        tokenByIndex[stor3[stor11 + 1] - 1].field_256 = arg1
        tokenByIndex[stor3[stor11 + 1] - 1].field_416 = 0
    ...
    call arg1.0x80 with:
         gas gas_remaining wei
        args Mask(1248, -1024, unknown_0x150b7a02(?????), msg.sender, 0, tokenIdPointer + 1, 128, 0) << 1024, mem[644 len 4]
    if not return_data.size:
        require not ext_call.success
        revert with 0, 
                    32,
