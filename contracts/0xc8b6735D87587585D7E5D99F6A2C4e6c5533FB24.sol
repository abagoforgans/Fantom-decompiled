                                        ...
                                        while idx < ('cd', 100).length:
                                            ...
                                            if ceil32(mem[_4032]) <= mem[_4032]:
                                                ...
                                                call mem[(32 * ('cd', 100).length - 1) + 140 len 20].swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                                     gas gas_remaining wei
                                                    args cd[((32 * v + 1) + cd[164] + 36)], cd[(cd[196] + (32 * v + 1) + 36)], address(this.address), Array(len=mem[_4576], data=mem[_4576 + 196 len ceil32(mem[_4576])])
                                            else:
                                    ...
                                    if var112006 < ('cd', 196).length:
                                        ...
                                        while idx < ('cd', 100).length:
                                            ...
                                            if ceil32(mem[_4033]) <= mem[_4033]:
                                                ...
                                                call address(_4530).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4577]) + _4577 + -mem[64] + 192]
                                            else:
                                                ...
                                                call address(_4561).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4595]) + _4595 + -mem[64] + 192]
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 'NH{q', 50
                        if ('cd', 100).length < 1:
                                    ...
                                    if var108006 < ('cd', 196).length:
                                        ...
                                        while idx < ('cd', 100).length:
                                            ...
                                            if ceil32(mem[_4034]) <= mem[_4034]:
                                                ...
                                                if ('cd', 100).length - 1 >= mem[96]:
                                                    revert with 'NH{q', 50
                                                _4532 = mem[(32 * ('cd', 100).length - 1) + 128]
                                                if v + 1 >= ('cd', 164).length:
                                                    revert with 'NH{q', 50
                                                if v + 1 >= ('cd', 196).length:
                                                    revert with 'NH{q', 50
                                                ...
                                                require ext_code.size(address(_4532))
                                                call address(_4532).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                                     gas gas_remaining wei
                                                ...
                                                if ('cd', 100).length - 1 >= mem[96]:
                                                    revert with 'NH{q', 50
                                                _4562 = mem[(32 * ('cd', 100).length - 1) + 128]
                                                if v + 1 >= ('cd', 164).length:
                                                    revert with 'NH{q', 50
                                                if v + 1 >= ('cd', 196).length:
                                                    revert with 'NH{q', 50
                                                ...
                                                call address(_4562).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4597]) + _4597 + -mem[64] + 192]
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 'NH{q', 50
                        if ('cd', 100).length < 1:
                                        ...
                                        while idx < ('cd', 100).length:
                                            ...
                                            if ceil32(mem[_4035]) <= mem[_4035]:
                                                ...
                                                if ceil32(mem[_4579]) <= mem[_4579]:
                                                    require ext_code.size(mem[(32 * ('cd', 100).length - 1) + 140 len 20])
                                                    call mem[(32 * ('cd', 100).length - 1) + 140 len 20].mem[mem[64] len 4] with:
                                                         gas gas_remaining wei
                                                        args mem[mem[64] + 4 len ceil32(mem[_4579]) + _4579 + -mem[64] + 192]
                                                else:
                                                    mem[_4579 + mem[_4579] + 196] = 0
                                                    require ext_code.size(address(_4534))
                                                    call address(_4534).mem[mem[64] len 4] with:
                                                         gas gas_remaining wei
                                                        args mem[mem[64] + 4 len ceil32(mem[_4579]) + _4579 + -mem[64] + 192]
                                            else:
                                    ...
                                    if var113006 < ('cd', 196).length:
                                        ...
                                        while idx < ('cd', 100).length:
                                            ...
                                            if ceil32(mem[_4037]) <= mem[_4037]:
                                                ...
                                                call address(_4538).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4581]) + _4581 + -mem[64] + 192]
                                            else:
                                ...
                                if var111003 < ('cd', 164).length:
                                    if var113006 < ('cd', 196).length:
                                        ...
                                        while idx < ('cd', 100).length:
                                            ...
                                            idx = 0
                                            while idx < mem[_4039]:
                                                mem[idx + _4039 + 196] = mem[idx + _4039 + 32]
                                                idx = idx + 32
                                                continue 
                                            if ceil32(mem[_4039]) <= mem[_4039]:
                                                ...
                                                call u.mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4039]) + _4039 + -mem[64] + 192]
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                                                if v == -1:
                                                    revert with 'NH{q', 17
                                                ...
                                                mem[_4583 + 36] = cd[((32 * v + 1) + cd[164] + 36)]
                                                mem[_4583 + 68] = cd[(cd[196] + (32 * v + 1) + 36)]
                                                mem[_4583 + 100] = this.address
                                                mem[_4583 + 132] = 128
                                                mem[_4583 + 164] = mem[_4583]
                                                idx = 0
                                                while idx < mem[_4583]:
                                                    mem[idx + _4583 + 196] = mem[idx + _4583 + 32]
                                                    idx = idx + 32
                                                    continue 
                                                if ceil32(mem[_4583]) > mem[_4583]:
                                                    mem[_4583 + mem[_4583] + 196] = 0
                                                require ext_code.size(mem[(32 * ('cd', 100).length - 1) + 140 len 20])
                                                call mem[(32 * ('cd', 100).length - 1) + 140 len 20].swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                                     gas gas_remaining wei
                                                    args cd[((32 * v + 1) + cd[164] + 36)], cd[(cd[196] + (32 * v + 1) + 36)], address(this.address), Array(len=mem[_4583], data=mem[_4583 + 196 len ceil32(mem[_4583])])
                                            else:
                                                ...
                                                mem[_4607 + 36] = cd[((32 * v + 1) + cd[164] + 36)]
                                                mem[_4607 + 68] = cd[(cd[196] + (32 * v + 1) + 36)]
                                                ...
                                                while idx < mem[_4607]:
                                                    ...
                                                    idx = idx + 32
                                                    continue 
                                                if ceil32(mem[_4607]) > mem[_4607]:
                                                    mem[_4607 + mem[_4607] + 196] = 0
                                                require ext_code.size(mem[(32 * ('cd', 100).length - 1) + 140 len 20])
                                                call mem[(32 * ('cd', 100).length - 1) + 140 len 20].swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                                     gas gas_remaining wei
                                                    args cd[((32 * v + 1) + cd[164] + 36)], cd[(cd[196] + (32 * v + 1) + 36)], address(this.address), Array(len=mem[_4607], data=mem[_4607 + 196 len ceil32(mem[_4607])])
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 'NH{q', 50
                        if ('cd', 100).length < 1:
            ...
            if ceil32(_44) <= _44:
                ...
                if not return_data.size:
                                    ...
                                    if var109006 < ('cd', 196).length:
                                        ...
                                        while idx < ('cd', 100).length:
                                            ...
                                            if ceil32(mem[_4040]) <= mem[_4040]:
                                                ...
                                                if ('cd', 100).length - 1 >= mem[96]:
                                                    revert with 'NH{q', 50
                                                _4544 = mem[(32 * ('cd', 100).length - 1) + 128]
                                                if v + 1 >= ('cd', 164).length:
                                                    revert with 'NH{q', 50
                                                if v + 1 >= ('cd', 196).length:
                                                    revert with 'NH{q', 50
                                                ...
                                                require ext_code.size(address(_4544))
                                                call address(_4544).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4584]) + _4584 + -mem[64] + 192]
                                            else:
                                                ...
                                                call address(_4568).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4609]) + _4609 + -mem[64] + 192]
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 'NH{q', 50
                        if ('cd', 100).length < 1:
                    ...
                    if not return_data.size:
                                    ...
                                    if var109006 < ('cd', 196).length:
                                        ...
                                        while idx < ('cd', 100).length:
                                            ...
                                            if ceil32(mem[_4042]) <= mem[_4042]:
                                                ...
                                                call mem[(32 * ('cd', 100).length - 1) + 140 len 20].swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                                     gas gas_remaining wei
                                                    args cd[((32 * v + 1) + cd[164] + 36)], cd[(cd[196] + (32 * v + 1) + 36)], address(this.address), Array(len=mem[_4586], data=mem[_4586 + 196 len ceil32(mem[_4586])])
                                            else:
                                                ...
                                                if ('cd', 100).length - 1 >= mem[96]:
                                                    revert with 'NH{q', 50
                                                _4570 = mem[(32 * ('cd', 100).length - 1) + 128]
                                                if v + 1 >= ('cd', 164).length:
                                                    revert with 'NH{q', 50
                                                if v + 1 >= ('cd', 196).length:
                                                    revert with 'NH{q', 50
                                                ...
                                                call address(_4570).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4613]) + _4613 + -mem[64] + 192]
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 'NH{q', 50
                        if ('cd', 100).length < 1:
                        ...
                        call address(_1371) with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len ceil32(mem[_1387]) + _1387 + -mem[64] + 192]
            else:
                mem[_35 + _44 + 100] = 0
                call address(cd[36]) with:
                     gas gas_remaining wei
                                ...
                                if var112003 < ('cd', 164).length:
                                    if var114006 < ('cd', 196).length:
                                        ...
                                        while idx < ('cd', 100).length:
                                            ...
                                            idx = 0
                                            while idx < mem[_4047]:
                                                mem[idx + _4047 + 196] = mem[idx + _4047 + 32]
                                                idx = idx + 32
                                                continue 
                                            if ceil32(mem[_4047]) <= mem[_4047]:
                                                ...
                                                call u.mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4047]) + _4047 + -mem[64] + 192]
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                                                if v == -1:
                                                    revert with 'NH{q', 17
                                                ...
                                                if ('cd', 100).length - 1 >= mem[96]:
                                                    revert with 'NH{q', 50
                                                _4558 = mem[(32 * ('cd', 100).length - 1) + 128]
                                                if v + 1 >= ('cd', 164).length:
                                                    revert with 'NH{q', 50
                                                if v + 1 >= ('cd', 196).length:
                                                    revert with 'NH{q', 50
                                                ...
                                                mem[_4591 + 36] = cd[((32 * v + 1) + cd[164] + 36)]
                                                mem[_4591 + 68] = cd[(cd[196] + (32 * v + 1) + 36)]
                                                ...
                                                while idx < mem[_4591]:
                                                    ...
                                                    idx = idx + 32
                                                    continue 
                                                if ceil32(mem[_4591]) > mem[_4591]:
                                                    mem[_4591 + mem[_4591] + 196] = 0
                                                require ext_code.size(address(_4558))
                                                call address(_4558).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4591]) + _4591 + -mem[64] + 192]
                                            else:
                                                ...
                                                if ('cd', 100).length - 1 >= mem[96]:
                                                    revert with 'NH{q', 50
                                                _4575 = mem[(32 * ('cd', 100).length - 1) + 128]
                                                if v + 1 >= ('cd', 164).length:
                                                    revert with 'NH{q', 50
                                                if v + 1 >= ('cd', 196).length:
                                                    revert with 'NH{q', 50
                                                ...
                                                mem[_4623 + 36] = cd[((32 * v + 1) + cd[164] + 36)]
                                                mem[_4623 + 68] = cd[(cd[196] + (32 * v + 1) + 36)]
                                                mem[_4623 + 100] = this.address
                                                mem[_4623 + 132] = 128
                                                mem[_4623 + 164] = mem[_4623]
                                                idx = 0
                                                while idx < mem[_4623]:
                                                    mem[idx + _4623 + 196] = mem[idx + _4623 + 32]
                                                    idx = idx + 32
                                                    continue 
                                                if ceil32(mem[_4623]) > mem[_4623]:
                                                    mem[_4623 + mem[_4623] + 196] = 0
                                                require ext_code.size(address(_4575))
                                                call address(_4575).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len ceil32(mem[_4623]) + _4623 + -mem[64] + 192]
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 'NH{q', 50
                        if ('cd', 100).length < 1:
