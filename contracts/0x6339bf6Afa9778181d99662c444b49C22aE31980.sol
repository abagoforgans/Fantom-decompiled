...
function claimGold() payable {
    mem[64] = 96
    if var55002 >= sub_4a2fc9e8.length:
    if var61001 >= sub_4a2fc9e8.length:
        revert with 'NH{q', 50
    mem[0] = 3
    mem[96] = 0xd1d58b2500000000000000000000000000000000000000000000000000000000
    mem[var75003] = var75001
    require ext_code.size(sub_d486adccAddress)
    staticcall sub_d486adccAddress.mem[var81003 len 4] with:
            gas gas_remaining wei
...
function sub_8649fe86(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if var96002 >= sub_4a2fc9e8.length:
    if var102001 >= sub_4a2fc9e8.length:
        revert with 'NH{q', 50
    mem[0] = 3
    mem[96] = 0x5c58df200000000000000000000000000000000000000000000000000000000
    mem[var116003] = var116001
    require ext_code.size(rarityAddress)
    staticcall rarityAddress.mem[var122003 len 4] with:
            gas gas_remaining wei
           args mem[var122003 + 4 len var122004 - 4]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    # nil
}

function sub_f2b08e5d(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    ...
    while idx < ext_call.return_data[0]:
        ...
        call rarityAddress.0x42842e0e with:
             gas gas_remaining wei
            args address(arg1), msg.sender, _20
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if idx == -1:
            revert with 'NH{q', 17
...
function sub_67ad1d36(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(this.address)
    staticcall this.address.0xdfad1b51 with:
            gas gas_remaining wei
    mem[96] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    while idx < ext_call.return_data[0]:
        mem[mem[64] + 4] = idx
        require ext_code.size(this.address)
        staticcall this.address.0x4a2fc9e8 with:
                gas gas_remaining wei
               args idx
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
...
function sub_5a2b0db5(?) payable {
    ...
    while idx < ext_call.return_data[0]:
        ...
        call rarityAddress.0x42842e0e with:
             gas gas_remaining wei
            args address(arg1), address(this.address), _23
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[0] = _23
        mem[32] = 4
        if not stor4[_23]:
            sub_4a2fc9e8.length++
            sub_4a2fc9e8[sub_4a2fc9e8.length] = _23
            mem[0] = _23
            mem[32] = 4
...
function sub_f43cbeb5(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        call rarityAddress.0x42842e0e with:
             gas gas_remaining wei
            args msg.sender, address(this.address), _40
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if idx >= mem[96]:
            revert with 'NH{q', 50
        ...
        if mem[_47 + 12 len 20] == this.address:
            if idx >= mem[96]:
                revert with 'NH{q', 50
            mem[0] = mem[(32 * idx) + 128]
            mem[32] = 4
