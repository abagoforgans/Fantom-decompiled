...
function beforeWithdraw(uint256 arg1) payable {
    require calldata.size - 4 >= 32
        ...
        if ext_call.return_data[0] > arg1:
            if tx.origin == owner:
                ...
                if arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1 - (WITHDRAW_FEE * arg1 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, ext_call.return_data[0] - (WITHDRAW_FEE * ext_call.return_data[0] / WITHDRAWAL_MAX)) >> 32
                    mem[452 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            ...
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1 - (WITHDRAW_FEE * arg1 / WITHDRAWAL_MAX)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
...
function sub_cd7860b0(?) payable {
    ...
    if not arg5:
        ...
        if ext_call.return_data[0] >= arg4:
            ...
            call arg2 with:
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), address(arg1) << 64, 0, 0) << 256, mem[420 len 4]
            if not return_data.size:
                if not ext_call.success:
                    if arg2:
                        revert with memory
                ...
                if not ext_code.size(arg2):
                    revert with 0, 'Address: call to non-contract'
                mem[520 len 64] = 0, address(arg1), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[612 len 4] = 0
                call arg2 with:
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if not ext_code.size(arg2):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 521 len 64] = 0, address(arg1), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
