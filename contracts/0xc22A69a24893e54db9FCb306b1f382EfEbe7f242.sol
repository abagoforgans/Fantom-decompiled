...
function sub_be4ee1b9(?) {
    ...
    if ext_call.return_data[12 len 20] != address(ext_call.return_data[0]):
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        return ((ext_call.return_data[0] * 2222222222 * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0]) + (2222222222 * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0]))
    staticcall arg1.price1CumulativeLast() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return ((ext_call.return_data[0] * 2222222222 * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0]) + (2222222222 * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0]))
}
    ...
    if not sub_d373b52e.length:
        if not sub_44951130.length:
            ...
            if ext_call.success:
                ...
                mem[var54005 len 160] = ext_call.return_data[0 len 160]
                if ext_call.success:
                    ...
                    while ext_call.success:
                        ...
                        if address(ext_call.return_data[0]) == address(ext_call.return_data[0]):
                            ...
                            if address(ext_call.return_data[0]) != address(ext_call.return_data[0]):
                                ...
                                require return_data.size >= 32
                                mem[32] = 6
                                sub_1fbedece[0] = (ext_call.return_data[0] * 2222222222 * mem[114 len 14] / ext_call.return_data[0]) + (2222222222 * mem[146 len 14] / ext_call.return_data[0])
                            else:
                                ...
                                require return_data.size >= 32
                                mem[32] = 6
                                sub_1fbedece[0] = (ext_call.return_data[0] * 2222222222 * mem[146 len 14] / ext_call.return_data[0]) + (2222222222 * mem[114 len 14] / ext_call.return_data[0])
                        else:
