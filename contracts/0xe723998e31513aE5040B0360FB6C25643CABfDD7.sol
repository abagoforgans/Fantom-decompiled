...
function sub_f40a8e0d(?) payable {
    ...
    if wFTMAddress != address(ext_call.return_data[0]):
        ...
        staticcall sub_825db985Address.0x93f1a40b with:
                gas gas_remaining wei
...
function sub_959f7300(?) payable {
    ...
    if wFTMAddress != address(ext_call.return_data[0]):
        ...
        if wFTMAddress != address(ext_call.return_data[0]):
            ...
            staticcall sub_825db985Address.0x93f1a40b with:
                    gas gas_remaining wei
                   args 5, 0x2322f85dd0af3db5cb95e3ed4e75a5ed68a8a7fd
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0] and (ext_call.return_data[32] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32]) + (ext_call.return_data[0] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[32] / ext_call.return_data[0]) / ext_call.return_data[0] > -1 / ext_call.return_data[0]:
...
function sub_24bb47bd(?) payable {
    ...
    if wFTMAddress == address(ext_call.return_data[0]):
        ...
        if wFTMAddress != address(ext_call.return_data[0]):
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0] and (ext_call.return_data[32] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32]) + (ext_call.return_data[0] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[0] / ext_call.return_data[32] / 10^10) / ext_call.return_data[0] > -1 / ext_call.return_data[0]:
                revert with 0, 17
            return (ext_call.return_data[0] * (ext_call.return_data[32] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32]) + (ext_call.return_data[0] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[0] / ext_call.return_data[32] / 10^10) / ext_call.return_data[0] / 10^18)
        if ext_call.return_data[32] and 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[0] / ext_call.return_data[32] / 10^10 > -1 / ext_call.return_data[32]:
            revert with 0, 17
        if ext_call.return_data[0] and 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] > -1 / ext_call.return_data[0]:
            revert with 0, 17
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] and (ext_call.return_data[0] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32]) + (ext_call.return_data[32] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[0] / ext_call.return_data[32] / 10^10) / ext_call.return_data[0] > -1 / ext_call.return_data[0]:
            revert with 0, 17
        return (ext_call.return_data[0] * (ext_call.return_data[0] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32]) + (ext_call.return_data[32] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[0] / ext_call.return_data[32] / 10^10) / ext_call.return_data[0] / 10^18)
    if 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] and ext_call.return_data[32] > -1 / 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32]:
        revert with 0, 17
    if 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[32] > 0x6df37f675ef6eadf5ab9a2072d44268d97df837e6748956e5c6c2117:
        revert with 0, 17
    ...
    if wFTMAddress != address(ext_call.return_data[0]):
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] and (ext_call.return_data[32] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32]) + (ext_call.return_data[0] * 10^10 * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[32] / ext_call.return_data[0]) / ext_call.return_data[0] > -1 / ext_call.return_data[0]:
            revert with 0, 17
        return (ext_call.return_data[0] * (ext_call.return_data[32] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32]) + (ext_call.return_data[0] * 10^10 * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[32] / ext_call.return_data[0]) / ext_call.return_data[0] / 10^18)
    if ext_call.return_data[32] and 10^10 * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[32] / ext_call.return_data[0] > -1 / ext_call.return_data[32]:
        revert with 0, 17
    if ext_call.return_data[0] and 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] > -1 / ext_call.return_data[0]:
        revert with 0, 17
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] and (ext_call.return_data[0] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32]) + (ext_call.return_data[32] * 10^10 * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[32] / ext_call.return_data[0]) / ext_call.return_data[0] > -1 / ext_call.return_data[0]:
        revert with 0, 17
    return (ext_call.return_data[0] * (ext_call.return_data[0] * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32]) + (ext_call.return_data[32] * 10^10 * 1000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[32] * ext_call.return_data[32] / ext_call.return_data[0]) / ext_call.return_data[0] / 10^18)
}
