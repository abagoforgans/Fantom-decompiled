...
function redeem(uint256 arg1) payable {
    ...
    call gemAddress.safeTransferFrom(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) with:
         gas gas_remaining wei
        args 0, uint32(this.address), msg.sender, kind, arg1, 160, 0
...
function onERC1155Received(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if stor10 != 1:
        revert with 0, '!lock'
    stor10 = 2
    if gemAddress != msg.sender:
        revert with 0, 'not gem token'
    if arg3 != kind:
        revert with 0, 'bad kind'
    if arg4 <= 0:
        revert with 0, 'bad value'
    if arg5.length:
        revert with 0, 'bad data'
    if arg2 != arg1:
        revert with 0, 'from not operator'
    ...
    if balanceOf[address(arg2)] > !(10^18 * arg4):
        revert with 0, 17
    balanceOf[address(arg2)] += 10^18 * arg4
    emit Transfer((10^18 * arg4), 0, arg2);
    stor10 = 1
...
function sub_148f51f3(?) payable {
    ...
    if bool(stor9.length):
        ...
        if not ('cd', 100).length:
            ...
            stor9.length = (2 * ('cd', 100).length) + 1
            s = 0
            idx = cd[100] + 36
