...
function sub_d962ce43(?) payable {
    ...
    if not arg2 / sub_42a6003a:
        ...
        if arg2 / sub_42a6003a and 10^18 > -1 / arg2 / sub_42a6003a:
            revert with 'NH{q', 17
        if not arg2 / sub_42a6003a:
            revert with 'NH{q', 18
        if 10^18 * arg2 / sub_42a6003a / arg2 / sub_42a6003a != 10^18:
            revert with 0, 'SafeMath: multiplication overflow'
        if eth.balance(this.address) < 10^18 * arg2 / sub_42a6003a:
            revert with 0, 'Not enough FTM in vault for this transaction'
        require ext_code.size(stor2)
        staticcall stor2.balanceOf(uint256 arg1) with:
                gas gas_remaining wei
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        if not 10^18 * arg2 / sub_42a6003a:
            if 0 > 10^18 * arg2 / sub_42a6003a:
                revert with 0, 'SafeMath: subtraction overflow', 0
            if 10^18 * arg2 / sub_42a6003a < 0:
                revert with 'NH{q', 17
            call msg.sender with:
               value 10^18 * arg2 / sub_42a6003a wei
                 gas 2300 * is_zero(value) wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            call stor9 with:
                 gas 2300 wei
            emit Transfer((10^18 * arg2 / sub_42a6003a), arg1);
        else:
            if 10^18 * arg2 / sub_42a6003a and stor7 > -1 / 10^18 * arg2 / sub_42a6003a:
                revert with 'NH{q', 17
            if not 10^18 * arg2 / sub_42a6003a:
                revert with 'NH{q', 18
            if 10^18 * arg2 / sub_42a6003a * stor7 / 10^18 * arg2 / sub_42a6003a != stor7:
                revert with 0, 'SafeMath: multiplication overflow'
            if 10^18 * arg2 / sub_42a6003a * stor7 / 100 > 10^18 * arg2 / sub_42a6003a:
                revert with 0, 'SafeMath: subtraction overflow', 0
            if 10^18 * arg2 / sub_42a6003a < 10^18 * arg2 / sub_42a6003a * stor7 / 100:
                revert with 'NH{q', 17
            call msg.sender with:
               value (10^18 * arg2 / sub_42a6003a) - (10^18 * arg2 / sub_42a6003a * stor7 / 100) wei
                 gas 2300 * is_zero(value) wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            call stor9 with:
               value 10^18 * arg2 / sub_42a6003a * stor7 / 100 wei
                 gas 2300 * is_zero(value) wei
            emit Transfer(((10^18 * arg2 / sub_42a6003a) - (10^18 * arg2 / sub_42a6003a * stor7 / 100)), arg1);
    return 1
}
    ...
    if not sub_42a6003a:
        if not msg.value:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            call msg.sender with:
               value msg.value - (msg.value * stor7 / 100) wei
                 gas 2300 * is_zero(value) wei
        emit Transfer(0, arg1);
    else:
        ...
        if not msg.value:
            ...
            require return_data.size >= 32
            require ext_call.return_data[0] == ext_call.return_data[0]
            if ext_call.return_data[0] < sub_42a6003a * msg.value / 10^17:
                revert with 0, 'Not enough CRAFTING MATERIALS in vault'
            if stor10 > -msg.value - 1:
                revert with 'NH{q', 17
            if stor10 + msg.value < stor10:
            ...
            call stor2.transfer(uint256 arg1, uint256 arg2, uint256 arg3) with:
                 gas gas_remaining wei
                args stor4, arg1, sub_42a6003a * msg.value / 10^17
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_call.return_data[0] == bool(ext_call.return_data[0])
            ...
            call msg.sender with:
               value msg.value - (msg.value * stor7 / 100) wei
                 gas 2300 * is_zero(value) wei
        emit Transfer((sub_42a6003a * msg.value / 10^17), arg1);
    return 1
}
