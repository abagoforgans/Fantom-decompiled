...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    emit 0x6eddf252: arg1, arg2, arg3
}
...
function tokenURI(uint256 arg1) payable {
    ...
    if stor9[arg1].length:
        ...
        return 32, mem[stor9[arg1].length + ceil32(stor9[arg1].length) + ceil32(baseURI.length) + baseURI.length + 224 len ceil32(mem[ceil32(stor9[arg1].length) + ceil32(baseURI.length) + 160]) + 32], 
    if not arg1:
        ...
        return 32, mem[ceil32(stor9[arg1].length) + ceil32(baseURI.length) + baseURI.length + 289 len ceil32(mem[ceil32(stor9[arg1].length) + ceil32(baseURI.length) + 224]) + 32], 
    s = 0
    idx = arg1
    while idx:
        s = s + 1
...
function sub_6dff30aa(?) payable {
    ...
    if flashTokenAddress == sub_456dc17aAddress:
        ...
        staticcall flashTokenAddress.allowance(address rg1, address rg2) with:
                gas gas_remaining wei
        ...
        mem[64] = (4 * ceil32(return_data.size)) + 192
        require return_data.size >= 32
        _590 = mem[(2 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[64 len 28]
        ...
        _593 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[64 len 28] + 192]
        ...
        require return_data.size >= _590 + (32 * _593) + 32
        mem[(4 * ceil32(return_data.size)) + 224 len 32 * _593] = mem[(2 * ceil32(return_data.size)) + _590 + 224 len 32 * _593]
        require 0 < _593
        _1119 = mem[(4 * ceil32(return_data.size)) + 224]
        mem[mem[64] + 4] = flashTokenAddress
        mem[mem[64] + 36] = _1119
        require ext_code.size(lenderAddress)
        staticcall lenderAddress.flashFee(address rg1, uint256 rg2) with:
                gas gas_remaining wei
               args flashTokenAddress, _1119
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _1142 = mem[64]
        ...
        mem[_1167] = _1119
        mem[_1167 + 32] = _1145
        mem[_1167 + 64] = ext_call.return_data[32]
        mem[_1167 + 96] = ext_call.return_data[64]
        mem[_1167 + 128] = 0
        mem[_1167 + 160] = arg1
        _1172 = mem[64]
        mem[mem[64] + 32] = _1119
        ...
        _1195 = mem[64]
        mem[mem[64]] = 192
        mem[_1172 + 228] = this.address
        mem[_1172 + 260] = lenderAddress
        require ext_code.size(flashTokenAddress)
        staticcall flashTokenAddress.allowance(address rg1, address rg2) with:
                gas gas_remaining wei
               args address(this.address), lenderAddress
        mem[_1172 + 224] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if _1145 + _1119 < _1119:
            revert with 0, 'SafeMath: addition overflow'
        if _1145 + _1119 + ext_call.return_data[0] < ext_call.return_data[0]:
            revert with 0, 'SafeMath: addition overflow'
        mem[_1172 + ceil32(return_data.size) + 228] = lenderAddress
        mem[_1172 + ceil32(return_data.size) + 260] = _1145 + _1119 + ext_call.return_data[0]
        require ext_code.size(flashTokenAddress)
        call flashTokenAddress.approve(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args lenderAddress, _1145 + _1119 + ext_call.return_data[0]
        mem[_1172 + ceil32(return_data.size) + 224] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[64] = _1172 + (2 * ceil32(return_data.size)) + 224
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        mem[_1172 + (2 * ceil32(return_data.size)) + 224] = 0x5cffe9de00000000000000000000000000000000000000000000000000000000
        mem[_1172 + (2 * ceil32(return_data.size)) + 228] = this.address
        mem[_1172 + (2 * ceil32(return_data.size)) + 260] = flashTokenAddress
        mem[_1172 + (2 * ceil32(return_data.size)) + 292] = _1119
        mem[_1172 + (2 * ceil32(return_data.size)) + 324] = 128
        _1217 = mem[_1195]
        mem[_1172 + (2 * ceil32(return_data.size)) + 356] = mem[_1195]
        mem[_1172 + (2 * ceil32(return_data.size)) + 388 len ceil32(_1217)] = mem[_1195 + 32 len ceil32(_1217)]
        if ceil32(_1217) > _1217:
            mem[_1217 + _1172 + (2 * ceil32(return_data.size)) + 388] = 0
        require ext_code.size(lenderAddress)
        call lenderAddress.flashLoan(address rg1, address rg2, uint256 rg3, bytes rg4) with:
             gas gas_remaining wei
            args address(this.address), flashTokenAddress, _1119, 128, mem[_1172 + (2 * ceil32(return_data.size)) + 356 len ceil32(_1217) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        ...
        if not stor4[arg1]:
            revert with 0, 
                        32,
                        41,
                        0x724552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65, mem[_1172 + (4 * ceil32(return_data.size)) + 297 len 23] >> 72,
                        0
        require stor4[arg1] - 1 < tokenByIndex.length
        approved[arg1] = 0
        if not stor4[arg1]:
            revert with 0, 
                        32,
                        41,
                        0x724552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65, mem[_1172 + (4 * ceil32(return_data.size)) + 393 len 23] >> 72,
                        0
    ...
    if stor4[arg1]:
        ...
        tokenByIndex.length--
        stor4[arg1] = 0
    emit 0x6eddf252: tokenByIndex[stor4[arg1] - 1].field_256, 0, arg1
}
...
function onFlashLoan(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if 1 == bool(cd[(arg5 + 164)]):
        ...
        if flashTokenAddress == supplyTokenAddress:
            ...
            mem[(13 * ceil32(return_data.size)) + 544] = mem[(12 * ceil32(return_data.size)) + mem[(12 * ceil32(return_data.size)) + 544 len 4], 0 + 544]
