...
function sub_441c6b7b(?) payable {
    return sub_441c6b7bAddress
}
...
function sub_7f1792bd(?) payable {
    ...
    if not stor11:
        revert with 'NH{q', 18
    if sha3(stor8, block.coinbase) % stor11 < sha3(stor8, block.coinbase) % stor11 % 100:
        revert with 'NH{q', 17
    if not msg.sender:
    ...
    if stor6[stor8].field_0:
        ...
        if arg1.length:
            ...
            while stor6[stor8].field_1 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
    stor9[stor8] = (sha3(stor8, block.coinbase) % stor11) - (sha3(stor8, block.coinbase) % stor11 % 100)
    return stor8
}
...
function getEntityGenealogy(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    mem[0] = arg1
    if not stor9[arg1]:
...
function Claim(uint256 arg1) payable {
    ...
    require arg1 == arg1
    mem[100] = arg1
    require ext_code.size(sub_441c6b7bAddress)
    staticcall sub_441c6b7bAddress.0x6352211e with:
            gas gas_remaining wei
           args arg1
    ...
    if ext_code.size(msg.sender) > 0:
        ...
        call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
             gas gas_remaining wei
            args msg.sender, address(this.address), arg1, 128, 0
