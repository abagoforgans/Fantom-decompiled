    ...
    if currentRound:
        ...
        if not currentRound:
            ...
            if not eth.balance(this.address):
                ...
                mem[floor32(mem[(2 * ceil32(return_data.size)) + 19285] + (2 * ceil32(return_data.size)) + ceil32(s) + 38460) + 260] = mem[(2 * ceil32(return_data.size)) + 19285] + 28
                mem[floor32(mem[(2 * ceil32(return_data.size)) + 19285] + (2 * ceil32(return_data.size)) + ceil32(s) + 38460) + 292 len floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59)] = mem[(2 * ceil32(return_data.size)) + ceil32(s) + 19349 len mem[(2 * ceil32(return_data.size)) + 19285] + 28], Mask(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28, -(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28) + 256, 19020) >> -(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28) + 256
            else:
                call address(create2.new_address) with:
                   value eth.balance(this.address) wei
                     gas gas_remaining wei
                if return_data.size:
                    ...
                    mem[floor32(mem[(2 * ceil32(return_data.size)) + 19285] + (2 * ceil32(return_data.size)) + ceil32(s) + 38460) + 292 len floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59)] = mem[(2 * ceil32(return_data.size)) + ceil32(s) + 19349 len mem[(2 * ceil32(return_data.size)) + 19285] + 28], Mask(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28, -(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28) + 256, 19020) >> -(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28) + 256
            require ext_code.size(address(create2.new_address))
            if floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) <= mem[(2 * ceil32(return_data.size)) + 19285] + 28:
                call address(create2.new_address).0x45ca09f8 with:
                     gas gas_remaining wei
                    args Array(len=mem[(2 * ceil32(return_data.size)) + 19285] + 28, data=mem[(2 * ceil32(return_data.size)) + ceil32(s) + 19349 len mem[(2 * ceil32(return_data.size)) + 19285] + 28], Mask(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28, -(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28) + 256, 19020) >> -(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28) + 256), address(this.address), devAddr, rewardDistributorAddress, sub_2e41cf80, sub_3b11af5c, sub_ce702329, sub_4bfdba62
            else:
                call address(create2.new_address).0x45ca09f8 with:
                     gas gas_remaining wei
                    args Array(len=mem[(2 * ceil32(return_data.size)) + 19285] + 28, data=Mask(8 * mem[(2 * ceil32(return_data.size)) + 19285] + 28, -(8 * mem[(2 * ceil32(return_data.size)) + 19285] + 28) + 256, mem[(2 * ceil32(return_data.size)) + ceil32(s) + 19349 len mem[(2 * ceil32(return_data.size)) + 19285] + 28], Mask(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28, -(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28) + 256, 19020) >> -(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28) + 256) << (8 * mem[(2 * ceil32(return_data.size)) + 19285] + 28) - 256, Mask(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28, -(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28) + 256, 0) >> -(8 * floor32(mem[(2 * ceil32(return_data.size)) + 19285] + 59) + -mem[(2 * ceil32(return_data.size)) + 19285] - 28) + 256), address(this.address), devAddr, rewardDistributorAddress, sub_2e41cf80, sub_3b11af5c, sub_ce702329, sub_4bfdba62
    else:
        if currentRound == -1:
            revert with 0, 17
        currentRound++
                    ...
                    if not currentRound:
                        ...
                        if not s:
                            ...
                            if ceil32(_673) <= _673:
                                ...
                                _979 = mem[64]
                                mem[mem[64]] = _673 + _669 + -mem[64] + 28
                                mem[64] = _673 + _669 + 60
                                mem[_673 + _669 + 92 len 19020] = code.data[5363 len 19020]
                                mem[_673 + _669 + 60] = 19020
                                mem[64] = floor32(_673 + _669 + 19143)
