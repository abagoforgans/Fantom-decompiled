        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - (WITHDRAW_FEE * ext_call.return_data[0] / WITHDRAWAL_MAX)) >> 32
                    mem[452 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1 - (WITHDRAW_FEE * arg1 / WITHDRAWAL_MAX)) >> 32
                    mem[452 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, ext_call.return_data[0] - (WITHDRAW_FEE * ext_call.return_data[0] / WITHDRAWAL_MAX)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), Mask(224, 32, arg1 - (WITHDRAW_FEE * arg1 / WITHDRAWAL_MAX)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
