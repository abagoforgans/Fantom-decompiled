...
function claimMany(uint256[] arg1) payable {
    mem[64] = 96
    require calldata.size - 4 >= 32
    ...
    while idx < arg1.length:
        ...
        if ownerOf[cd[((32 * idx) + arg1 + 36)]]:
            revert with 0, 'ERC721: token already minted'
        stor9[cd[((32 * idx) + arg1 + 36)]] = tokenByIndex.length
        tokenByIndex.length++
        ...
        if msg.sender:
            if not msg.sender:
                ...
                if ext_code.size(msg.sender):
                    ...
                    call msg.sender.0x150b7a02 with:
                         gas gas_remaining wei
                        args msg.sender, 0, cd[((32 * idx) + arg1 + 36)], 128, 0
                ...
                if not msg.sender:
                    revert with 0, 'ERC721: balance query for the zero address'
                tokenOfOwnerByIndex[address(msg.sender)][stor3[address(msg.sender)]] = cd[((32 * idx) + arg1 + 36)]
                stor7[cd[((32 * idx) + arg1 + 36)]] = balanceOf[address(msg.sender)]
                if balanceOf[address(msg.sender)] > -2:
                    revert with 0, 17
                balanceOf[address(msg.sender)]++
                mem[0] = cd[((32 * idx) + arg1 + 36)]
            ...
            if tokenByIndex.length - 1 >= tokenByIndex.length:
                revert with 0, 50
            if stor9[cd[((32 * idx) + arg1 + 36)]] >= tokenByIndex.length:
                revert with 0, 50
            tokenByIndex[stor9[cd[((32 * idx) + arg1 + 36)]]] = tokenByIndex[tokenByIndex.length]
            stor9[stor8[stor8.length]] = stor9[cd[((32 * idx) + arg1 + 36)]]
