...
function sub_348d9d51(?) {
    ...
    if not stor4.length:
        ...
        _36 = mem[96]
        mem[(32 * stor4.length) + 160] = mem[96]
        idx = 0
        s = 128
        t = mem[64] + 64
        while idx < _36:
        ...
        return memory
          from mem[64]
           len (32 * stor4.length) + (32 * _36) + -mem[64] + 192
    ...
    return memory
      from mem[64]
       len (32 * stor4.length) + (32 * _37) + -mem[64] + 192
}
...
function sub_ccd5e661(?) {
    ...
    if not stor4.length:
        ...
        return memory
          from mem[64]
           len (32 * stor4.length) + (32 * _46) + -mem[64] + 192
    mem[128 len 32 * stor4.length] = call.data[calldata.size len 32 * stor4.length]
    s = 0
    idx = 0
    while idx < stor4.length:
    ...
    return memory
      from mem[64]
       len (32 * stor4.length) + (32 * _47) + -mem[64] + 192
}
