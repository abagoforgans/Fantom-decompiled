...
function recoverAccess(address arg1, address arg2, address arg3) payable {
    ...
    mem[128 len 4] = swapOwner(address rg1, address rg2, address rg3)
    mem[0] = sha3(swapOwner(address rg1, address rg2, address rg3), address(arg1) << 64, 0, address(arg2), arg3)
    mem[32] = 5
    if stor5[swapOwner(address rg1, address rg2, address rg3)][address(arg1) << 64][0][address(arg2)][arg3]:
        revert with 0, 'Recovery already executed'
    idx = 0
    s = 0
    while idx < friends.length:
        mem[0] = friends[idx]
        mem[32] = sha3(sha3(swapOwner(address rg1, address rg2, address rg3), address(arg1) << 64, 0, address(arg2), arg3), 6)
        if not stor6[swapOwner(address rg1, address rg2, address rg3)][address(arg1) << 64][0][address(arg2)][arg3][stor3[idx]]:
            if s != threshold:
                idx = idx + 1
                s = s
                continue 
            ...
            if s + 1 != threshold:
                ...
                s = s + 1
                continue 
        stor5[swapOwner(address rg1, address rg2, address rg3)][address(arg1) << 64][0][address(arg2)][arg3] = 1
        ...
        call managerAddress.execTransactionFromModule(address rg1, uint256 rg2, bytes rg3, uint8 rg4) with:
