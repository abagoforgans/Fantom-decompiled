...
function vote(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if not voters[msg.sender].field_0:
        revert with 0, 'Has no right to vote'
    if voters[msg.sender].field_256:
        revert with 0, 'Already voted.'
    voters[msg.sender].field_256 = 1
    voters[msg.sender].field_512 = arg1
    if arg1 >= proposals.length:
        revert with 0, 50
    if proposals[arg1].field_256 > !voters[msg.sender].field_0:
        revert with 0, 17
    proposals[arg1].field_256 += voters[msg.sender].field_0
}
...
function delegate(address arg1) payable {
    ...
    while voters[address(arg1)].field_264:
        ...
        continue 
    voters[msg.sender].field_256 = 1
    voters[msg.sender].field_264 = address(s)
    voters[msg.sender].field_512 = 0
    if not voters[address(s)].field_256:
        if voters[address(s)].field_0 > !voters[msg.sender].field_0:
            revert with 0, 17
        voters[address(s)].field_0 += voters[msg.sender].field_0
    else:
        if voters[address(s)].field_512 >= proposals.length:
            revert with 0, 50
        if proposals[stor1[address(s)].field_512].field_256 > !voters[msg.sender].field_0:
            revert with 0, 17
        proposals[stor1[address(s)].field_512].field_256 += voters[msg.sender].field_0
}
