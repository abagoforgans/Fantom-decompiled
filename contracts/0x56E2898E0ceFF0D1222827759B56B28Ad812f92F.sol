...
function getReferenceDataBulk(string[] arg1, string[] arg2) payable {
    ...
    while idx < arg2.length:
        ...
        mem[_215] = cd[(arg2 + cd[s] + 36)]
        require arg2 + cd[s] + cd[(arg2 + cd[s] + 36)] + 68 <= calldata.size
        mem[_215 + 32 len cd[(arg2 + cd[s] + 36)]] = call.data[arg2 + cd[s] + 68 len cd[(arg2 + cd[s] + 36)]]
        mem[_215 + cd[(arg2 + cd[s] + 36)] + 32] = 0
        mem[t] = _215
        idx = idx + 1
        s = s + 32
        t = t + 32
    ...
    if not _212:
        ...
        while idx < _212:
            ...
            while s < _326:
                ...
                continue 
            if ceil32(_326) <= _326:
                mem[_320 + 36] = ceil32(_326) + 96
                _418 = mem[_317]
                mem[_320 + ceil32(_326) + 100] = mem[_317]
                s = 0
                while s < _418:
                    mem[_320 + ceil32(_326) + s + 132] = mem[_317 + s + 32]
                    s = s + 32
                    continue 
                if ceil32(_418) <= _418:
                    require ext_code.size(refAddress)
    ...
    s = var38001
    s = var38002
    while _107 + (32 * arg2.length) + 31:
        mem[64] = mem[64] + 96
        mem[_214 + (32 * _212) + 32] = 0
        mem[_214 + (32 * _212) + 64] = 0
        mem[_214 + (32 * _212) + 96] = 0
        mem[arg2 + (32 * arg2.length) + 68] = _214 + (32 * _212) + 32
        s = arg2 + (32 * arg2.length) + 68
        s = _107 + (32 * arg2.length) + 31
        continue 
    idx = 0
    while idx < _212:
        require idx < mem[96]
        ...
        while s < _509:
            ...
            continue 
        if ceil32(_509) <= _509:
            mem[_502 + 36] = ceil32(_509) + 96
            _575 = mem[_499]
            mem[_502 + ceil32(_509) + 100] = mem[_499]
            s = 0
            while s < _575:
                mem[_502 + ceil32(_509) + s + 132] = mem[_499 + s + 32]
                s = s + 32
                continue 
            if ceil32(_575) <= _575:
                require ext_code.size(refAddress)
                staticcall refAddress.mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _502 + ceil32(_509) + ceil32(_575) + -mem[64] + 128]
                mem[mem[64] len 96] = ext_call.return_data[0 len 96]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _614 = mem[64]
                ...
                mem[_502 + ceil32(_509) + _575 + 132] = 0
                require ext_code.size(refAddress)
                staticcall refAddress.mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _502 + ceil32(_509) + ceil32(_575) + -mem[64] + 128]
            ...
            if ceil32(_576) <= _576:
                ...
                staticcall refAddress.mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _502 + ceil32(_509) + ceil32(_576) + -mem[64] + 128]
                mem[mem[64] len 96] = ext_call.return_data[0 len 96]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _615 = mem[64]
                ...
                mem[_502 + ceil32(_509) + _576 + 132] = 0
                require ext_code.size(refAddress)
                staticcall refAddress.mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _502 + ceil32(_509) + ceil32(_576) + -mem[64] + 128]
