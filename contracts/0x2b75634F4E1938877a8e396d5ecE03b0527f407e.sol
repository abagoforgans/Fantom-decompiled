...
address sub_0d4c55daAddress;
array of struct sub_994ee5ae;

function sub_0d4c55da(?) payable {
    return sub_0d4c55daAddress
}
...
function sub_a90840db(?) payable {
    idx = 0
    while idx < sub_994ee5ae[msg.sender].field_0:
        mem[0] = sha3(msg.sender, 7)
        mem[96] = 0x379607f500000000000000000000000000000000000000000000000000000000
        mem[100] = sub_994ee5ae[msg.sender][idx].field_0
        require ext_code.size(sub_0d4c55daAddress)
        call sub_0d4c55daAddress.claim(uint256 arg1) with:
             gas gas_remaining wei
            args sub_994ee5ae[msg.sender][idx].field_0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_d0a36b86(?) payable {
    ...
    while idx < sub_994ee5ae[msg.sender].field_0:
        ...
        mem[mem[64] + 4] = sub_994ee5ae[msg.sender][idx].field_0
        require ext_code.size(sub_0d4c55daAddress)
        staticcall sub_0d4c55daAddress.balanceOf(uint256 arg1) with:
                gas gas_remaining wei
               args sub_994ee5ae[msg.sender][idx].field_0
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
        ...
        mem[mem[64] + 68] = _16
        require ext_code.size(sub_0d4c55daAddress)
        call sub_0d4c55daAddress.transfer(uint256 arg1, uint256 arg2, uint256 arg3) with:
             gas gas_remaining wei
            args sub_994ee5ae[msg.sender][idx].field_0, arg1, _16
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
