...
function copy(uint256 arg1) payable {
    ...
    while idx < 31:
        ...
        while s < 12:
            ...
            call 0xfb5ea05bb8a5e38d3f54b6c5acd997f6b259a519.0xa14ef38e with:
                 gas gas_remaining wei
                args arg1, s
            ...
            mem[32] = 4
            if s >= sub_a14ef38e[arg1].field_0:
                revert with 'NH{q', 50
            mem[0] = sha3(arg1, 4)
            sub_a14ef38e[arg1][s].field_0 = _25
            if s == -1:
                revert with 'NH{q', 17
            s = s + 1
            continue 
...
function sub_d386480c(?) payable {
    ...
    if not sub_a14ef38e[arg1].field_0:
        idx = 1
        while idx < sub_a14ef38e[arg1].field_0:
            if idx >= mem[96]:
                revert with 'NH{q', 50
            _34 = mem[(32 * idx) + 128]
            mem[mem[64] + 4] = mem[(32 * idx) + 128]
            require ext_code.size(sub_4b30d6c2Address)
            call sub_4b30d6c2Address.adventurers_log(uint256 arg1) with:
                 gas gas_remaining wei
                args _34
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
            ...
            if block.timestamp > mem[_37]:
                mem[mem[64] + 4] = _34
                require ext_code.size(sub_4b30d6c2Address)
                call sub_4b30d6c2Address.level(uint256 arg1) with:
                     gas gas_remaining wei
                    args _34
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                ...
                require ext_code.size(sub_4b30d6c2Address)
                call sub_4b30d6c2Address.xp_required(uint256 arg1) with:
                     gas gas_remaining wei
                    args _42
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                ...
                mem[mem[64] + 4] = _34
                require ext_code.size(sub_4b30d6c2Address)
                call sub_4b30d6c2Address.xp(uint256 arg1) with:
                     gas gas_remaining wei
                    args _34
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                ...
                if mem[_49] < _46:
                    ...
                    mem[mem[64] + 4] = _34
                    require ext_code.size(sub_b46849f1Address)
                    call sub_b46849f1Address.claim(uint256 arg1) with:
                         gas gas_remaining wei
                        args _34
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
