...
function getCompBalanceMetadata(address arg1, address arg2) payable {
    ...
    require ext_code.size(arg1)
    staticcall arg1.0xb4b5ea57 with:
            gas gas_remaining wei
           args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(arg1)
    staticcall arg1.0x587cde1e with:
            gas gas_remaining wei
           args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getCompVotes(address arg1, address arg2, uint32[] arg3) payable {
    ...
    if not arg3.length:
        ...
        while idx < arg3.length:
            ...
            require ext_code.size(arg1)
            staticcall arg1.0x782d6fe1 with:
                    gas gas_remaining wei
...
function getAccountLimits(address arg1, address arg2) payable {
    ...
    mem[(4 * ceil32(return_data.size)) + 416] = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 416 len 4], address(arg2) << 64 + 416]
    ...
    mem[mem[64]] = 32
    mem[mem[64] + 32] = 160
    _33 = mem[(4 * ceil32(return_data.size)) + 416]
