...
function unwrap(uint256 arg1) payable {
    ...
    require ext_code.size(tokenAddress)
    call tokenAddress.safeTransferFrom(address rg1, address rg2, uint256 rg3, uint256 rg4, bytes rg5) with:
         gas gas_remaining wei
...
function wrap(uint256 arg1) payable {
    ...
    staticcall stor16.feeDivisor(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not ext_call.return_data[0]:
        ...
        if not msg.sender:
            revert with 0, 'ERC20: mint to the zero address'
        if arg1 - (arg1 / ext_call.return_data[0]) + totalSupply < totalSupply:
            revert with 0, 'SafeMath: addition overflow'
        totalSupply = arg1 - (arg1 / ext_call.return_data[0]) + totalSupply
        if arg1 - (arg1 / ext_call.return_data[0]) + balanceOf[address(msg.sender)] < balanceOf[address(msg.sender)]:
            revert with 0, 'SafeMath: addition overflow'
        balanceOf[address(msg.sender)] = arg1 - (arg1 / ext_call.return_data[0]) + balanceOf[address(msg.sender)]
        emit Transfer((arg1 - (arg1 / ext_call.return_data[0])), 0, msg.sender);
        if not stor16:
            revert with 0, 'ERC20: mint to the zero address'
        if (arg1 / ext_call.return_data[0]) + totalSupply < totalSupply:
            revert with 0, 'SafeMath: addition overflow'
        totalSupply += arg1 / ext_call.return_data[0]
        if (arg1 / ext_call.return_data[0]) + balanceOf[stor16] < balanceOf[stor16]:
            revert with 0, 'SafeMath: addition overflow'
        balanceOf[stor16] += arg1 / ext_call.return_data[0]
        emit Transfer((arg1 / ext_call.return_data[0]), 0, stor16);
}
