...
function sub_3d28289a(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require arg1 < sub_3d28289a.length
    return sub_3d28289a[arg1]
}
...
function sub_ef455455(?) {
    ...
    emit 0x550e15af: stor5, address(arg1)
    stor5 = address(arg1)
}
...
function sub_56afb487(?) {
    ...
    require arg1 == address(arg1)
    idx = 0
    while idx < sub_3d28289a.length:
        mem[0] = 4
        if sub_3d28289a[idx] == address(arg1):
            return 1
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
...
function sub_6bc8ecb5(?) payable {
    ...
    while idx < sub_3d28289a.length:
        mem[0] = 4
        if sub_3d28289a[idx] == msg.sender:
    ...
    if sub_3d28289a.length >= sub_3d28289a.length:
        revert with 'NH{q', 50
    sub_3d28289a[sub_3d28289a.length] = msg.sender
}
...
function sub_348d9d51(?) {
    ...
    while idx < sub_3d28289a.length:
        mem[0] = arg1
        mem[32] = sha3(sub_3d28289a[idx], 2)
        if sub_c0a5e34b[stor4[idx]][arg1] > 0:
            if idx >= sub_3d28289a.length:
                revert with 'NH{q', 50
            mem[0] = 4
            if mem[96] >= mem[96]:
                revert with 'NH{q', 50
            mem[(32 * mem[96]) + 128] = sub_3d28289a[idx]
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_f6cf2a16(?) {
    ...
    while idx < sub_3d28289a.length:
        ...
        staticcall sub_348d4be6Address.0xe985e9c5 with:
