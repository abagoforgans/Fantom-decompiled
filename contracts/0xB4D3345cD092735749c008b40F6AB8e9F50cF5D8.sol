...
function getPairFor(address arg1, address arg2, address arg3) payable {
    ...
    if arg2 < arg3:
        ...
        return address(sha3(0, arg1, sha3(arg2, arg3), 0x52178a9131f5551c2e56bf7cbf02aed8be8130e6493915a6b0c7602ac2125e54))
    if not arg3:
        revert with 0, 'UniswapV2Library: ZERO_ADDRESS'
    return address(sha3(0, arg1, sha3(arg3, arg2), 0x52178a9131f5551c2e56bf7cbf02aed8be8130e6493915a6b0c7602ac2125e54))
}
...
function sub_4ce6e8e6(?) payable {
    ...
    if arg2 < arg3:
        ...
        if arg2 < arg3:
            if not arg2:
                revert with 0, 'UniswapV2Library: ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, arg1, sha3(arg2, arg3), 0x52178a9131f5551c2e56bf7cbf02aed8be8130e6493915a6b0c7602ac2125e54)))
            staticcall address(sha3(0, arg1, sha3(arg2, arg3), 0x52178a9131f5551c2e56bf7cbf02aed8be8130e6493915a6b0c7602ac2125e54)).getReserves() with:
                    gas gas_remaining wei
        else:
            if not arg3:
                revert with 0, 'UniswapV2Library: ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, arg1, sha3(arg3, arg2), 0x52178a9131f5551c2e56bf7cbf02aed8be8130e6493915a6b0c7602ac2125e54)))
            staticcall address(sha3(0, arg1, sha3(arg3, arg2), 0x52178a9131f5551c2e56bf7cbf02aed8be8130e6493915a6b0c7602ac2125e54)).getReserves() with:
                    gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
