...
function sub_324388c6(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit 0xa2c60ed3: ext_call.return_data[0], sha3(arg2, arg3 << 192, arg4 << 192, arg5 << 192, arg6 << 192, arg7 << 192, uint64(arg8) << 96)
    require ext_code.size(address(arg6))
    staticcall address(arg6).balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if not address(cd[(arg5 + 132)]):
        ...
        require 1 < mem[_238]
        mem[_238 + 64] = address(cd[(arg5 + 164)])
        ...
        require return_data.size >= 32
        mem[_238 + ceil32(return_data.size) + 96] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
        mem[_238 + ceil32(return_data.size) + 100] = _235
        ...
        idx = 0
        s = _238 + 32
        t = _238 + ceil32(return_data.size) + 292
        while idx < mem[_238]:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
        ...
        mem[_238 + ceil32(return_data.size) + 228] = block.timestamp
        ...
        require return_data.size >= 32
        _356 = mem[_354]
        if ext_call.return_data[0] > mem[_354]:
            revert with 0, 'SafeMath: subtraction overflow'
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = -1
        require ext_code.size(address(cd[(arg5 + 164)]))
        ...
        if _356 - ext_call.return_data[0] <= cd[(arg5 + 36)]:
        ...
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        if ext_call.return_data[0] > mem[_200]:
            revert with 0, 'SafeMath: subtraction overflow'
        mem[mem[64] + 4] = this.address
        require ext_code.size(address(cd[(arg5 + 196)]))
        staticcall address(cd[(arg5 + 196)]).balanceOf(address arg1) with:
        ...
        mem[64] = mem[64] + 96
        require 0 < mem[_236]
        mem[_236 + 32] = address(cd[(arg5 + 196)])
        require 1 < mem[_236]
        mem[_236 + 64] = address(cd[(arg5 + 228)])
        mem[_236 + 100] = this.address
        require ext_code.size(address(cd[(arg5 + 228)]))
        staticcall address(cd[(arg5 + 228)]).balanceOf(address arg1) with:
                gas gas_remaining wei
               args this.address
        mem[_236 + 96] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[64] = _236 + ceil32(return_data.size) + 96
        require return_data.size >= 32
        mem[_236 + ceil32(return_data.size) + 96] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
        mem[_236 + ceil32(return_data.size) + 100] = _234
        mem[_236 + ceil32(return_data.size) + 132] = 1
        mem[_236 + ceil32(return_data.size) + 164] = 160
        mem[_236 + ceil32(return_data.size) + 260] = mem[_236]
        idx = 0
        s = _236 + 32
        t = _236 + ceil32(return_data.size) + 292
        while idx < mem[_236]:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
            t = t + 32
            continue 
        mem[_236 + ceil32(return_data.size) + 196] = this.address
        mem[_236 + ceil32(return_data.size) + 228] = block.timestamp
        require ext_code.size(address(cd[(arg5 + 100)]))
        call address(cd[(arg5 + 100)]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _236 + ceil32(return_data.size) + (32 * mem[_236]) + -mem[64] + 288]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64] + 4] = this.address
        require ext_code.size(address(cd[(arg5 + 228)]))
        ...
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        if ext_call.return_data[0] > mem[_353]:
            revert with 0, 'SafeMath: subtraction overflow'
        mem[mem[64] + 4] = this.address
        require ext_code.size(address(cd[(arg5 + 228)]))
        staticcall address(cd[(arg5 + 228)]).balanceOf(address arg1) with:
        ...
        mem[64] = mem[64] + 96
        require 0 < mem[_388]
        mem[_388 + 32] = address(cd[(arg5 + 228)])
        require 1 < mem[_388]
        mem[_388 + 64] = address(cd[(arg5 + 164)])
        mem[_388 + 100] = this.address
        require ext_code.size(address(cd[(arg5 + 164)]))
        staticcall address(cd[(arg5 + 164)]).balanceOf(address arg1) with:
                gas gas_remaining wei
               args this.address
        mem[_388 + 96] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[64] = _388 + ceil32(return_data.size) + 96
        require return_data.size >= 32
        mem[_388 + ceil32(return_data.size) + 96] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
        mem[_388 + ceil32(return_data.size) + 100] = _386
        mem[_388 + ceil32(return_data.size) + 132] = 1
        mem[_388 + ceil32(return_data.size) + 164] = 160
        mem[_388 + ceil32(return_data.size) + 260] = mem[_388]
        idx = 0
        s = _388 + 32
        t = _388 + ceil32(return_data.size) + 292
        while idx < mem[_388]:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
            t = t + 32
            continue 
        mem[_388 + ceil32(return_data.size) + 196] = this.address
        mem[_388 + ceil32(return_data.size) + 228] = block.timestamp
        require ext_code.size(address(cd[(arg5 + 132)]))
        call address(cd[(arg5 + 132)]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _388 + ceil32(return_data.size) + (32 * mem[_388]) + -mem[64] + 288]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64] + 4] = this.address
        require ext_code.size(address(cd[(arg5 + 164)]))
        ...
        require return_data.size >= 32
        _441 = mem[_440]
        if ext_call.return_data[0] > mem[_440]:
            revert with 0, 'SafeMath: subtraction overflow'
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = -1
        require ext_code.size(address(cd[(arg5 + 164)]))
        ...
        if _441 - ext_call.return_data[0] <= cd[(arg5 + 36)]:
            revert with 0, 'Trade failed to make profit'
        if arg4 + arg3 < arg3:
            revert with 0, 'SafeMath: addition overflow'
        mem[mem[64] + 4] = this.address
        ...
        while idx < arg2.length:
            ...
            if not mem[(32 * idx) + 300 len 20]:
                ...
                if not mem[_554 + 12 len 20]:
                    ...
                    mem[64] = mem[64] + 96
                    require 0 < mem[_633]
                    mem[_633 + 32] = address(arg3)
                    require 1 < mem[_633]
                    mem[_633 + 64] = address(arg4)
                    require 0 < mem[_633]
                    if address(arg3) != address(arg3):
                        revert with 0, 'ERR_PATH_TOKENS'
                    require mem[_633] - 1 < mem[_633]
                    if mem[(32 * mem[_633] - 1) + _633 + 44 len 20] != address(arg4):
                        revert with 0, 'ERR_PATH_TOKENS'
                    mem[_633 + 96] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                    mem[_633 + 100] = arg1
                    mem[_633 + 132] = 64
                    mem[_633 + 164] = mem[_633]
                    s = 0
                    t = _633 + 32
                    u = _633 + 196
                    while s < mem[_633]:
                    ...
                    staticcall address(_502).mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _633 + (32 * mem[_633]) + -mem[64] + 192]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1003 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        while idx < arg2.length:
            ...
            if not mem[(32 * idx) + 300 len 20]:
                ...
                if not mem[_558 + 12 len 20]:
                    ...
                    mem[64] = mem[64] + 96
                    require 0 < mem[_639]
                    mem[_639 + 32] = address(arg3)
                    require 1 < mem[_639]
                    mem[_639 + 64] = address(arg4)
                    require 0 < mem[_639]
                    if address(arg3) != address(arg3):
                        revert with 0, 'ERR_PATH_TOKENS'
                    require mem[_639] - 1 < mem[_639]
                    if mem[(32 * mem[_639] - 1) + _639 + 44 len 20] != address(arg4):
                        revert with 0, 'ERR_PATH_TOKENS'
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length:
            ...
            if not mem[(32 * idx) + 140 len 20]:
                ...
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 32
                require mem[_2309] == mem[_2309 + 12 len 20]
                if not mem[_2309 + 12 len 20]:
                    require idx < mem[(32 * ('cd', 36).length) + 288]
                    mem[(32 * idx) + (32 * ('cd', 36).length) + 320] = 0
                else:
                    _2384 = mem[64]
                    ...
                    mem[64] = mem[64] + 96
                    require 0 < mem[_2384]
                    mem[_2384 + 32] = address(cd[68])
                    require 1 < mem[_2384]
                    mem[_2384 + 64] = address(cd[100])
                    require 0 < mem[_2384]
                    if address(cd[68]) != address(cd[68]):
                        revert with 0, 'ERR_PATH_TOKENS'
                    require mem[_2384] - 1 < mem[_2384]
                    if mem[(32 * mem[_2384] - 1) + _2384 + 44 len 20] != address(cd[100]):
                        revert with 0, 'ERR_PATH_TOKENS'
                    mem[_2384 + 96] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                    mem[_2384 + 100] = cd[4]
                    mem[_2384 + 132] = 64
                    mem[_2384 + 164] = mem[_2384]
                    s = 0
                    t = _2384 + 32
                    u = _2384 + 196
                    while s < mem[_2384]:
                    ...
                    staticcall address(_2259).mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _2384 + (32 * mem[_2384]) + -mem[64] + 192]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _3394 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not _4422:
                ...
                while idx < _5398:
                    ...
                    if mem[(32 * idx) + 140 len 20] == address(_4410):
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_5517] == mem[_5517 + 12 len 20]
                        if not mem[_5517 + 12 len 20]:
                            require idx < mem[_4428]
                            mem[(32 * idx) + _4428 + 32] = 0
                        else:
                            _5676 = mem[64]
                            ...
                            mem[64] = mem[64] + 96
                            require 0 < mem[_5676]
                            mem[_5676 + 32] = address(cd[100])
                            require 1 < mem[_5676]
                            mem[_5676 + 64] = address(cd[132])
                            require 0 < mem[_5676]
                            if address(cd[100]) != address(cd[100]):
                                revert with 0, 'ERR_PATH_TOKENS'
                            require mem[_5676] - 1 < mem[_5676]
                            if mem[(32 * mem[_5676] - 1) + _5676 + 44 len 20] != address(cd[132]):
                                revert with 0, 'ERR_PATH_TOKENS'
                            mem[_5676 + 96] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                            mem[_5676 + 100] = s
                            mem[_5676 + 132] = 64
                            ...
                            staticcall address(_5419).mem[mem[64] len 4] with:
                                    gas gas_remaining wei
                                   args mem[mem[64] + 4 len _5676 + (32 * mem[_5676]) + -mem[64] + 192]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _6416 = mem[64]
                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                while idx < _5399:
                    ...
                    if mem[(32 * idx) + 140 len 20] == address(_4410):
                        ...
                        if not mem[_5521 + 12 len 20]:
                            ...
                            mem[64] = mem[64] + 96
                            require 0 < mem[_5682]
                            mem[_5682 + 32] = address(cd[100])
                            require 1 < mem[_5682]
                            mem[_5682 + 64] = address(cd[132])
                            require 0 < mem[_5682]
                            if address(cd[100]) != address(cd[100]):
                                revert with 0, 'ERR_PATH_TOKENS'
                            require mem[_5682] - 1 < mem[_5682]
                            if mem[(32 * mem[_5682] - 1) + _5682 + 44 len 20] != address(cd[132]):
                                revert with 0, 'ERR_PATH_TOKENS'
                            mem[_5682 + 96] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                            mem[_5682 + 100] = s
                            mem[_5682 + 132] = 64
                            ...
                            staticcall address(_5421).mem[mem[64] len 4] with:
                                    gas gas_remaining wei
                                   args mem[mem[64] + 4 len _5682 + (32 * mem[_5682]) + -mem[64] + 192]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _6420 = mem[64]
                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not _4425:
                ...
                while idx < _5400:
                    ...
                    if mem[(32 * idx) + 140 len 20] == address(_4414):
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_5525] == mem[_5525 + 12 len 20]
                        if not mem[_5525 + 12 len 20]:
                            require idx < mem[_4429]
                            mem[(32 * idx) + _4429 + 32] = 0
                        else:
                            _5688 = mem[64]
                            ...
                            mem[64] = mem[64] + 96
                            require 0 < mem[_5688]
                            mem[_5688 + 32] = address(cd[100])
                            require 1 < mem[_5688]
                            mem[_5688 + 64] = address(cd[132])
                            require 0 < mem[_5688]
                            if address(cd[100]) != address(cd[100]):
                                revert with 0, 'ERR_PATH_TOKENS'
                            require mem[_5688] - 1 < mem[_5688]
                            if mem[(32 * mem[_5688] - 1) + _5688 + 44 len 20] != address(cd[132]):
                                revert with 0, 'ERR_PATH_TOKENS'
                            mem[_5688 + 96] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                            mem[_5688 + 100] = s
                            mem[_5688 + 132] = 64
                            ...
                            staticcall address(_5423).mem[mem[64] len 4] with:
                                    gas gas_remaining wei
                                   args mem[mem[64] + 4 len _5688 + (32 * mem[_5688]) + -mem[64] + 192]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _6424 = mem[64]
                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                while idx < _5401:
                    ...
                    if mem[(32 * idx) + 140 len 20] == address(_4414):
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_5529] == mem[_5529 + 12 len 20]
                        if not mem[_5529 + 12 len 20]:
                            require idx < mem[_4429]
                            mem[(32 * idx) + _4429 + 32] = 0
                        else:
                            _5694 = mem[64]
                            ...
                            mem[64] = mem[64] + 96
                            require 0 < mem[_5694]
                            mem[_5694 + 32] = address(cd[100])
                            require 1 < mem[_5694]
                            mem[_5694 + 64] = address(cd[132])
                            require 0 < mem[_5694]
                            if address(cd[100]) != address(cd[100]):
                                revert with 0, 'ERR_PATH_TOKENS'
                            require mem[_5694] - 1 < mem[_5694]
                            if mem[(32 * mem[_5694] - 1) + _5694 + 44 len 20] != address(cd[132]):
                                revert with 0, 'ERR_PATH_TOKENS'
                            mem[_5694 + 96] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                            mem[_5694 + 100] = s
                            mem[_5694 + 132] = 64
                            ...
                            staticcall address(_5425).mem[mem[64] len 4] with:
                                    gas gas_remaining wei
                                   args mem[mem[64] + 4 len _5694 + (32 * mem[_5694]) + -mem[64] + 192]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _6428 = mem[64]
                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
