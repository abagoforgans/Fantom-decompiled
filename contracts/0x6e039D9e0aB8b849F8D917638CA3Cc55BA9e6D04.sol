...
#  - startRound()
#
const sub_9bc335d5(?) = sha3(code.data[4320 len 16157])
...
function sub_82566662(?) payable {
    return address(sha3(0, this.address, currentRound, sha3(code.data[4320 len 16157])))
}

function sub_c9d8852e(?) payable {
    require calldata.size - 4 >= 32
    return address(sha3(0, this.address, arg1, sha3(code.data[4320 len 16157])))
}
