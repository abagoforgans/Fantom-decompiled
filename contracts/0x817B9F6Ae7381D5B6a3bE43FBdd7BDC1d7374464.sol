...
function set() payable {
    ...
    call rarityAddress.0xa22cb465 with:
         gas gas_remaining wei
        args 0x2069b76afe6b734fb65d1d099e7ec64ee9cc76b2, 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(rarityAddress)
    call rarityAddress.0xa22cb465 with:
         gas gas_remaining wei
        args sub_8db45ccdAddress, 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(rarityAddress)
    call rarityAddress.0xa22cb465 with:
         gas gas_remaining wei
        args sub_0a8c638dAddress, 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(sub_1d423d76Address)
    call sub_1d423d76Address.0xb866c8a4 with:
         gas gas_remaining wei
        args this.address, sub_8db45ccdAddress, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    call sub_1d423d76Address.0xb866c8a4 with:
         gas gas_remaining wei
        args this.address, sub_0a8c638dAddress, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function sub_780ac25f(?) payable {
    ...
    while idx < ext_call.return_data[0]:
        ...
        mem[mem[64] + 4] = _50
        require ext_code.size(sub_8db45ccdAddress)
        call sub_8db45ccdAddress.unlist(uint256 arg1) with:
             gas gas_remaining wei
            args _50
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
