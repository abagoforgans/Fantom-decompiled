...
function sub_7f808e28(?) payable {
    ...
    while idx < 4:
        ...
        continue 
    stor12.field_0 % 4 = 0
    Mask(254, 0, stor12.field_2) = Mask(254, 0, Mask(32, 112, _28) >> 112 * _20)
...
function withdraw() payable {
    ...
    if msg.sender == owner:
        ...
        while idx < 4:
            ...
            continue 
        stor12.field_0 % 4 = 0
        Mask(254, 0, stor12.field_2) = Mask(254, 0, Mask(32, 112, _68) >> 112 * _42)
        ...
        while idx < 4:
            ...
            continue 
        stor12.field_0 % 4 = 0
        Mask(254, 0, stor12.field_2) = Mask(254, 0, Mask(32, 112, _70) >> 112 * _44)
        require ext_code.size(stor10)
        staticcall stor10.0x18160ddd with:
                gas gas_remaining wei
        if not ext_call.success:
