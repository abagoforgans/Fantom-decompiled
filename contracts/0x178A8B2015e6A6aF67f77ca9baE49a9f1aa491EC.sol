...
function _fallback() payable {
    if calldata.size < 4:
        ...
        if unknown_0x93a4d3b0(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x63d5502f(?????) <= uint32(call.func_hash) >> 224:
                ...
                if unknown_0x715018a6(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0x755bfdde(?????):
                ...
                if startPresale() == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0x144fa6d7(?????):
                        require unknown_0x42f39381(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        return presaleRate
                    require not msg.value
                    require calldata.size - 4 >= 32
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x93a4d3b0(?????):
                    if uint32(call.func_hash) >> 224 != unknown_0x9fcdec61(?????):
                        if unknown_0xa43be57b(?????) == uint32(call.func_hash) >> 224:
                            ...
                            require unknown_0xd68381ec(?????) == uint32(call.func_hash) >> 224
                            require not msg.value
                            if owner != msg.sender:
                                revert with 0, 'Ownable: caller is not the owner'
                            uint16(stor5.field_0) = 0
