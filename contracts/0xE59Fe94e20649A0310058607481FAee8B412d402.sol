...
function sub_db05fdc9(?) {
    return sub_db05fdc9Address
}
...
function enter() payable {
    ...
    if balances[msg.sender] > !msg.value:
        revert with 0, 17
    if balances[msg.sender] + msg.value > 500 * 10^18:
...
function lp() {
    ...
    staticcall 0x152ee697f2e276fa89e96742e9bb9ab1f2e61be3.getPair(address arg1, address arg2) with:
            gas gas_remaining wei
           args sub_db05fdc9Address, address(ext_call.return_data[0])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
