...
function mint() payable {
    ...
    if record[address(msg.sender)] > !(msg.value / 10^18):
        revert with 0, 17
    if record[address(msg.sender)] + (msg.value / 10^18) >= 10000:
        revert with 0, 'too greedy'
    mem[0] = msg.sender
    mem[32] = 251
    if 10000 < record[address(msg.sender)]:
        revert with 0, 17
    idx = 0
    while idx < -record[address(msg.sender)] + 10000:
        _130 = mem[64]
        mem[64] = mem[64] + 32
        mem[_130] = 0
        if not msg.sender:
...
function getSixth(uint256 arg1) {
    require calldata.size - 4 >= 32
    mem[96] = 5
    mem[128] = 0x5349585448000000000000000000000000000000000000000000000000000000
    ...
    if not arg1:
        ...
        mem[(32 * stor254.length) + 288] = 0x5349585448000000000000000000000000000000000000000000000000000000
    ...
    while idx:
        ...
        idx = idx / 10
        continue 
    mem[(32 * stor254.length) + ceil32(s) + 256] = 0x5349585448000000000000000000000000000000000000000000000000000000
