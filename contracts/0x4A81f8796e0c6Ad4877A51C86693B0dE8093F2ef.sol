...
function setMinter(address arg1, uint256 arg2) payable {
    ...
    if arg2 < minters_minted[address(arg1)]:
...
function mint(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    if not minters[msg.sender]:
        revert with 0, 'Only minter can interact'
    if minters_minted[msg.sender] > !arg2:
        revert with 0, 17
    minters_minted[msg.sender] += arg2
    if minters[msg.sender] < minters_minted[msg.sender] + arg2:
