...
function sub_7f81d5ad(?) payable {
    ...
    if sub_4551169d[arg1].field_768:
        if sub_4551169d[arg1].field_768 == uint255(sub_4551169d[arg1].field_768) * 0.5 < 32:
            revert with 0, 34
        if arg4.length:
            ...
            idx = 0
            while (uint255(sub_4551169d[arg1].field_768) * 0.5) + 31 / 32 > idx:
...
function sub_8cc2306a(?) payable {
    ...
    if sub_4551169d[arg1].field_768:
        ...
        if sub_4551169d[arg1].field_768:
            if sub_4551169d[arg1].field_768 == uint255(sub_4551169d[arg1].field_768) * 0.5 < 32:
                revert with 0, 34
            if Mask(256, -1, sub_4551169d[arg1].field_768):
                if 31 >= uint255(sub_4551169d[arg1].field_768) * 0.5:
                    mem[128] = 256 * sub_4551169d[arg1].field_776
                else:
                    mem[128] = sub_4551169d[arg1][3].field_0
                    idx = 128
                    s = 0
                    while (uint255(sub_4551169d[arg1].field_768) * 0.5) + 96 > idx:
        ...
        return bool(sub_4551169d[arg1].field_0), 
               ...
               Array(len=2 * Mask(256, -1, sub_4551169d[arg1].field_768), data=mem[128 len ceil32(uint255(sub_4551169d[arg1].field_768) * 0.5)])
    if sub_4551169d[arg1].field_768 == sub_4551169d[arg1].field_769 < 32:
        revert with 0, 34
    if sub_4551169d[arg1].field_768:
        if sub_4551169d[arg1].field_768 == uint255(sub_4551169d[arg1].field_768) * 0.5 < 32:
