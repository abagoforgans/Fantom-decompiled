...
function ballot() payable {
    ...
    while stor2.length + 96 > idx:
        ...
        s = s + 1
        continue 
    return stor1, Array(len=stor2.length, data=mem[128 len stor2.length]), stor3, stor4, bool(stor5), stor6, stor7
}

function winner() payable {
    if not stor5:
        revert with 0, 'Ballot is not finalized yet.'
    idx = 0
    s = 0
...
function finalize() payable {
    if chairpersonAddress != msg.sender:
        revert with 0, 'Only chairperson can finalize.'
    if block.timestamp <= stor4:
        revert with 0, 'Ballot is still active.'
    if stor5:
        revert with 0, 'Ballot is already finalized.'
    if stor6 != stor7:
        revert with 0, 'Missing voters feeds.'
    stor5 = 1
    idx = 0
    s = 0
    while idx < proposals.length:
...
function vote(uint256 arg1) payable {
    ...
    if block.timestamp < stor3:
        revert with 0, 'Ballot is not open yet.'
    if block.timestamp >= stor4:
        revert with 0, 'Ballot is already closed.'
...
function sub_ee2ef228(?) payable {
    ...
    if block.timestamp <= stor4:
        revert with 0, 'Ballot is still active.'
    if stor5:
        revert with 0, 'The ballot is already finalized.'
    if chairpersonAddress != msg.sender:
        revert with 0, 
                    32,
                    34,
                    0xfe4f6e6c79206368616972706572736f6e2063616e20666565642077656967687473,
                    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 294 len 30]
    idx = 0
    while idx < arg1.length:
        ...
        if votes[mem[(32 * idx) + 140 len 20]].field_256 > 0:
            ...
            require votes[mem[(32 * idx) + 140 len 20]].field_0 < proposals.length
            mem[0] = 8
            if proposals[stor9[mem[(32 * idx) + 140 len 20]].field_0].field_256 + mem[(32 * idx) + (32 * arg1.length) + 160] >= proposals[stor9[mem[(32 * idx) + 140 len 20]].field_0].field_256:
                require idx < arg2.length
                ...
                require idx < arg2.length
                require votes[mem[(32 * idx) + 140 len 20]].field_0 < proposals.length
                proposals[stor9[mem[(32 * idx) + 140 len 20]].field_0].field_256 += mem[(32 * idx) + (32 * arg1.length) + 160]
                mem[0] = 8
                proposals[stor9[mem[(32 * idx) + 140 len 20]].field_0].field_512++
                stor7++
        idx = idx + 1
        continue 
}
