            ...
            if arg2:
                ...
                if withdrawFeeFactor * arg2 / 10000 <= ext_call.return_data[0]:
                    if wantLockedTotal >= withdrawFeeFactor * arg2 / 10000:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, withdrawFeeFactor * arg2 / 10000) >> 32
                        call wantAddress with:
                           funct uint32(stor12)
                             gas gas_remaining wei
                    ...
                    if 0 <= ext_call.return_data[0]:
                        if wantLockedTotal >= 0:
                            ...
                            call wantAddress with:
                               funct uint32(stor12)
                                 gas gas_remaining wei
                                args Mask(480, -256, transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), 0) << 256, mem[580 len 4]
                        else:
                            if wantLockedTotal > wantLockedTotal:
                                revert with 0, 'SafeMath: subtraction overflow'
                            wantLockedTotal = 0
