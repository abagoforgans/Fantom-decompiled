...
function uri(uint256 arg1) payable {
    ...
    if not _10 % 32:
        if not arg1:
            ...
            if not mem[ceil32(return_data.size) + 96] + 1:
                ...
                return 32, mem[mem[64] + 32 len floor32(_1599) + 64]
            ...
            return 32, mem[mem[64] + 32 len floor32(_1602) + 64]
        s = 0
        idx = arg1
        while idx:
            s = s + 1
        ...
        if not s:
            ...
            if not s + mem[ceil32(return_data.size) + 96]:
                ...
                return 32, mem[mem[64] + 32 len floor32(_1887) + 64]
    ...
    if not arg1:
        ...
        if not mem[ceil32(return_data.size) + 96] + 1:
            ...
            return 32, mem[mem[64] + 32 len floor32(_1617) + 64]
    ...
    if not s + mem[ceil32(return_data.size) + 96]:
        ...
        return memory
          from mem[64]
           len floor32(_1905) + _1903 + -mem[64] + 96
    mem[floor32(_10) + ceil32(return_data.size) + ceil32(s) + 320 len s + mem[ceil32(return_data.size) + 96]] = call.data[calldata.size len s + mem[ceil32(return_data.size) + 96]]
    idx = 0
    t = 0
    while idx < mem[ceil32(return_data.size) + 96]:
