...
function sub_00b6ada2(?) payable {
    return sub_00b6ada2Address
}
...
function sub_50d8c74c(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_50d8c74c.length
    return sub_50d8c74c[arg1]
}
...
function sub_4c444923(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'wOwnable: caller is not the owne'
    if strategistAddress != msg.sender:
        revert with 0, '!auth'
    sub_fcec0dfaAddress = arg1
}
...
function sub_00f93d29(?) payable {
    require ext_code.size(aceAddress)
    staticcall aceAddress.pendingReward(uint256 arg1, address arg2) with:
            gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            call wantAddress with:
               funct uint32(stor7)
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), 0) << 256, mem[652 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0
                if not approve(address arg1, uint256 arg2), Mask(224, 0, stor6):
            ...
            call wantAddress with:
               funct uint32(stor7)
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), 0) << 256, mem[ceil32(return_data.size) + 653 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), 0
                if not approve(address arg1, uint256 arg2), Mask(224, 0, stor6):
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, ext_call.return_data[0] - (WITHDRAW_FEE * ext_call.return_data[0] / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1 - (WITHDRAW_FEE * arg1 / WITHDRAWAL_MAX)) >> 32
                    mem[452 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
        ...
        if ext_call.return_data[0] > arg1:
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1 - (WITHDRAW_FEE * arg1 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, ext_call.return_data[0] - (WITHDRAW_FEE * ext_call.return_data[0] / WITHDRAWAL_MAX)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
