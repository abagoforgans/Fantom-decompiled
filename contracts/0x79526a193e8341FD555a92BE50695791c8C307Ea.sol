...
function onFlashLoan(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    require (32 * mem[_75 + mem[_75]]) + 32 >= 0 and _75 + ceil32(return_data.size) + (32 * mem[_75 + mem[_75]]) + 32 <= test266151307()
    ...
    mem[_75 + ceil32(return_data.size) + 32 len 32 * _77] = mem[_75 + _76 + 32 len 32 * _77]
    mem[mem[64] + 4] = this.address
    require ext_code.size(address(cd[(arg5 + 100)]))
    staticcall address(cd[(arg5 + 100)]).balanceOf(address rg1) with:
            gas gas_remaining wei
    ...
    require return_data.size >= 32
    _126 = mem[_125]
    if ext_call.return_data[0] > mem[_125]:
        revert with 0, 'SafeMath: subtraction overflow'
    _128 = mem[352]
    mem[mem[64] + 4] = mem[396 len 20]
    mem[mem[64] + 36] = -1
    require ext_code.size(address(_128))
    call address(_128).approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args mem[mem[64] + 4], -1
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    mem[mem[64] + 36] = _126 - ext_call.return_data[0]
    mem[mem[64] + 68] = address(_137)
    require ext_code.size(address(_135))
    call address(_135).liquidateBorrow(address rg1, uint256 rg2, address rg3) with:
         gas gas_remaining wei
        args mem[mem[64] + 4], _126 - ext_call.return_data[0], address(_137)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[64] = mem[64] + ceil32(return_data.size)
    ...
    staticcall address(_142).balanceOf(address rg1) with:
            gas gas_remaining wei
           args address(this.address)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    staticcall address(_154).balanceOf(address rg1) with:
            gas gas_remaining wei
           args address(this.address)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    require return_data.size >= 32
    require ext_code.size(address(_154))
    call address(_154).redeem(uint256 rg1) with:
         gas gas_remaining wei
        args mem[_157]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
