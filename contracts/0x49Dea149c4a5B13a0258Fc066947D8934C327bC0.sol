...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    mem[(6 * ceil32(return_data.size)) + 192] = _40
    ...
    mem[_98 + ceil32(return_data.size) + 96] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
    mem[_98 + ceil32(return_data.size) + 100] = _97
    mem[_98 + ceil32(return_data.size) + 132] = ext_call.return_data[0]
    mem[_98 + ceil32(return_data.size) + 164] = 160
    mem[_98 + ceil32(return_data.size) + 260] = mem[_98]
    idx = 0
    s = _98 + 32
    t = _98 + ceil32(return_data.size) + 292
    while idx < mem[_98]:
        mem[t] = mem[s + 12 len 20]
        idx = idx + 1
        s = s + 32
        t = t + 32
        continue 
    mem[_98 + ceil32(return_data.size) + 196] = msg.sender
    mem[_98 + ceil32(return_data.size) + 228] = block.timestamp
    require ext_code.size(0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52)
    call 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52.swapExactTokensForETH(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args _97, ext_call.return_data[0], 160, msg.sender, block.timestamp, mem[_98 + ceil32(return_data.size) + 260 len (32 * mem[_98]) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[_98 + ceil32(return_data.size) + 96 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = _98 + (2 * ceil32(return_data.size)) + 96
    require return_data.size >= 32
    _131 = mem[_98 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _97) >> 32
    require mem[_98 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _97) >> 32 <= test266151307()
    require _98 + ceil32(return_data.size) + mem[_98 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _97) >> 32 + 127 < _98 + ceil32(return_data.size) + return_data.size + 96
    _132 = mem[_98 + ceil32(return_data.size) + mem[_98 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _97) >> 32 + 96]
    require mem[_98 + ceil32(return_data.size) + mem[_98 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _97) >> 32 + 96] <= test266151307()
    require _98 + (2 * ceil32(return_data.size)) + (32 * mem[_98 + ceil32(return_data.size) + mem[_98 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _97) >> 32 + 96]) + 128 <= test266151307() and (32 * mem[_98 + ceil32(return_data.size) + mem[_98 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _97) >> 32 + 96]) + 32 >= 0
    mem[64] = _98 + (2 * ceil32(return_data.size)) + (32 * mem[_98 + ceil32(return_data.size) + mem[_98 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _97) >> 32 + 96]) + 128
    mem[_98 + (2 * ceil32(return_data.size)) + 96] = _132
    require _131 + (32 * _132) + 32 <= return_data.size
    idx = 0
    s = _98 + ceil32(return_data.size) + _131 + 128
    t = _98 + (2 * ceil32(return_data.size)) + 128
    while idx < _132:
        require mem[s] == mem[s]
        mem[t] = mem[s]
        idx = idx + 1
