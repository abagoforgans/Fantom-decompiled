...
function sub_f994e6e9(?) payable {
    ...
    if (98 * ext_call.return_data[18 len 14]) + (-98 * ext_call.return_data[50 len 14]) - 9800 / 98 != ext_call.return_data[18 len 14] + -ext_call.return_data[50 len 14] - 100:
        revert with 0, 'ds-math-mul-overflow'
    if -uint8(ext_call.return_data[0]) > 0:
        revert with 0, 'ds-math-sub-underflow'
    return ((98 * ext_call.return_data[18 len 14]) + (-98 * ext_call.return_data[50 len 14]) + -uint8(ext_call.return_data[0]) - 9800)
}
