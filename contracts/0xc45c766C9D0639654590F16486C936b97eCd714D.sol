...
function sub_c1c00690(?) payable {
    ...
    if minted[address(msg.sender)] >= sub_cd772241:
            ...
            if bool(stor12.length) != 1:
                revert with memory
                  from ceil32(ceil32(arg2.length)) + 97
                   len -ceil32(ceil32(arg2.length)) - 97
            idx = 0
            s = 0
            while idx < stor12.length.field_1:
                mem[ceil32(ceil32(arg2.length)) + idx + 165] = stor12[s].field_0
                idx = idx + 32
                s = s + 1
                continue 
            revert with 0, 
                        32,
                        2 * Mask(256, -1, stor12.length.field_1),
                        mem[ceil32(ceil32(arg2.length)) + 165 len ceil32(stor12.length.field_1)]
        if bool(stor12.length) == stor12.length.field_1 < 32:
            revert with 'NH{q', 34
        if not bool(stor12.length):
        ...
        while idx < stor12.length.field_1:
            ...
            s = s + 1
            continue 
        revert with 0, 32, stor12.length % 128, mem[ceil32(ceil32(arg2.length)) + 165 len ceil32(stor12.length.field_1)]
    if current_supply >= max_supply:
        if bool(stor13.length):
            ...
            while idx < stor13.length.field_1:
                mem[ceil32(ceil32(arg2.length)) + idx + 165] = stor13[s].field_0
                idx = idx + 32
                s = s + 1
                continue 
            revert with 0, 
                        ...
                        mem[ceil32(ceil32(arg2.length)) + 165 len ceil32(stor13.length.field_1)]
        if bool(stor13.length) == stor13.length.field_1 < 32:
            revert with 'NH{q', 34
        if not bool(stor13.length):
        ...
        while idx < stor13.length.field_1:
            ...
            s = s + 1
            continue 
        revert with 0, 32, stor13.length % 128, mem[ceil32(ceil32(arg2.length)) + 165 len ceil32(stor13.length.field_1)]
    if msg.value < sub_1a4231a4:
        if bool(stor14.length):
            ...
            while idx < stor14.length.field_1:
                mem[ceil32(ceil32(arg2.length)) + idx + 165] = stor14[s].field_0
                idx = idx + 32
                s = s + 1
                continue 
            revert with 0, 
                        ...
                        mem[ceil32(ceil32(arg2.length)) + 165 len ceil32(stor14.length.field_1)]
        if bool(stor14.length) == stor14.length.field_1 < 32:
            revert with 'NH{q', 34
        if not bool(stor14.length):
        ...
        while idx < stor14.length.field_1:
            ...
            s = s + 1
            continue 
        revert with 0, 32, stor14.length % 128, mem[ceil32(ceil32(arg2.length)) + 165 len ceil32(stor14.length.field_1)]
    require ext_code.size(this.address)
    staticcall this.address.0x8da5cb5b with:
            gas gas_remaining wei
    if not ext_call.success:
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if minted[address(msg.sender)] > -2:
        revert with 'NH{q', 17
    ...
    if stor6[stor9].field_0:
        ...
        if arg2.length:
            ...
            while stor6[stor9].field_1 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
    emit 0xba60c5bf: msg.sender, address(arg1), current_supply
    emit SetURI(Array(len=arg2.length, data=arg2[all]), current_supply);
}
