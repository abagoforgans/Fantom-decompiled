...
function unwrap() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(stor1))
    staticcall address(stor1).allowance(address arg1, address arg2) with:
            gas gas_remaining wei
    ...
    if ext_call.return_data[0] >= ext_call.return_data[0]:
        ...
        require return_data.size >= 32
        require ext_code.size(address(stor1))
        call address(stor1).0x23b872dd with:
             gas gas_remaining wei
        ...
        staticcall address(stor1).allowance(address arg1, address arg2) with:
                gas gas_remaining wei
               args msg.sender, address(stor1)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] < ext_call.return_data[0]:
            if not ext_call.return_data[0]:
                if not ext_code.size(address(stor1)):
                    revert with 0, 'Address: call to non-contract'
                ...
                if return_data.size:
                    ...
                    if not mem[292]:
                        revert with 0, 
                                    ...
                                    mem[ceil32(return_data.size) + 371 len 22]
        require ext_code.size(address(stor1))
        call address(stor1).withdraw(uint256 arg1) with:
             gas gas_remaining wei
        ...
        if not ext_call.return_data[0]:
            if not ext_code.size(address(stor1)):
                revert with 0, 'Address: call to non-contract'
            mem[260 len 64] = approve(address arg1, uint256 arg2), address(this.address) << 64, 0, ext_call.return_data[0 len 28]
            mem[324 len 0] = 0
            call address(stor1) with:
                 gas gas_remaining wei
                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[324 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address arg1, uint256 arg2), address(this.address) << 64, 0, ext_call.return_data[0]
                ...
                if ext_call.return_data[0] < ext_call.return_data[0]:
                    ...
                    if not ext_code.size(address(stor1)):
                        revert with 0, 'Address: call to non-contract'
                    mem[424 len 64] = 0, address(stor1), ext_call.return_data[0 len 28]
                    call address(stor1) with:
                       funct uint32(stor1)
                         gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if ext_call.return_data[0] < ext_call.return_data[0]:
                        ...
                        if not ext_code.size(address(stor1)):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 425 len 64] = 0, address(stor1), ext_call.return_data[0 len 28]
                        call address(stor1) with:
                           funct uint32(stor1)
                             gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if ext_call.return_data[0] < ext_call.return_data[0]:
                    ...
                    if not ext_code.size(address(stor1)):
                        revert with 0, 'Address: call to non-contract'
                    mem[424 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0 len 28]
                    call address(stor1) with:
                       funct uint32(stor1)
                         gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if ext_call.return_data[0] >= ext_call.return_data[0]:
                        ...
                        if not ext_call.return_data[0]:
                            if not ext_code.size(address(stor1)):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 425 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0 len 28]
