...
function sub_16c4faa8(?) payable {
    ...
    return sub_16c4faa8[stor7[arg1[all]][arg2[all]]]
}
...
function sub_19f56b71(?) payable {
    ...
    if sub_b30b3245[arg1[all]][arg2[all]] >= totalTokens:
        revert with 0, 'token is not known'
    if totalTokenUsers[stor7[arg1[all]][arg2[all]]] <= 0:
        revert with 0, 'no token users'
    if arg3 >= totalTokenUsers[stor7[arg1[all]][arg2[all]]]:
        revert with 0, 'token user is not known'
    return tokenUser[stor7[arg1[all]][arg2[all]]][arg3]
}
...
function sub_5180602f(?) payable {
    ...
    require arg2 + arg2.length + 36 <= calldata.size
    require arg3 == arg3
    return bool(stor14[stor7[arg1[all]][arg2[all]]][arg3])
}
...
function sub_aab27467(?) payable {
    ...
    require arg2.length <= test266151307()
    require arg2 + arg2.length + 36 <= calldata.size
    return bool(stor8[arg1[all]][arg2[all]])
}
...
function sub_b30b3245(?) payable {
    ...
    require arg2.length <= test266151307()
    require arg2 + arg2.length + 36 <= calldata.size
    if not stor8[arg1[all]][arg2[all]]:
        revert with 0, 'token is not known'
...
function setCanAdd(address arg1, bool arg2) payable {
    ...
    emit SetCanAdd(msg.sender, arg1, bool(stor2[address(arg1)]));
}
...
function setCanOpen(address arg1, bool arg2) payable {
    ...
    emit SetCanOpen(msg.sender, arg1, bool(stor4[address(arg1)]));
}
...
function setCanSubtract(address arg1, bool arg2) payable {
    ...
    emit SetCanSubtract(msg.sender, arg1, bool(stor3[address(arg1)]));
}
...
function sub_544d189f(?) payable {
    ...
    require arg2.length <= test266151307()
    require arg2 + arg2.length + 36 <= calldata.size
    if stor8[arg1[all]][arg2[all]]:
        return totalTokenUsers[stor7[arg1[all]][arg2[all]]]
    else:
        return 0
}
...
function sub_074c9750(?) payable {
    ...
    if not stor8[arg1[all]][arg2[all]]:
        revert with 0, 'token is not known'
    return balance[stor7[arg1[all]][arg2[all]]][arg3]
}
...
function add(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if not ext_call.return_data[0]:
        revert with 0, 'user is not known'
    if not stor14[arg1][arg2]:
        if arg3 > 0:
            stor14[arg1][arg2] = 1
            tokenUser[arg1][stor10[arg1]] = arg2
...
function sub_2daf5799(?) payable {
    ...
    if not ext_call.return_data[0]:
        revert with 0, 'user is not known'
    if balance[stor7[arg1[all]][arg2[all]]][arg3] < arg4:
        revert with 'NH{q', 17
    balance[stor7[arg1[all]][arg2[all]]][arg3] -= arg4
    if sub_16c4faa8[stor7[arg1[all]][arg2[all]]] < arg4:
        revert with 'NH{q', 17
    sub_16c4faa8[stor7[arg1[all]][arg2[all]]] -= arg4
...
function sub_62882f4b(?) payable {
    ...
    if not ext_call.return_data[0]:
        revert with 0, 'user is not known'
    if not stor14[stor7[arg1[all]][arg2[all]]][arg3]:
        if arg4 > 0:
            stor14[stor7[arg1[all]][arg2[all]]][arg3] = 1
            tokenUser[stor7[arg1[all]][arg2[all]]][stor10[stor7[arg1[all]][arg2[all]]]] = arg3
            if totalTokenUsers[stor7[arg1[all]][arg2[all]]] == -1:
                revert with 'NH{q', 17
            totalTokenUsers[stor7[arg1[all]][arg2[all]]]++
    if balance[stor7[arg1[all]][arg2[all]]][arg3] > -arg4 - 1:
        revert with 'NH{q', 17
    balance[stor7[arg1[all]][arg2[all]]][arg3] += arg4
    if sub_16c4faa8[stor7[arg1[all]][arg2[all]]] > -arg4 - 1:
        revert with 'NH{q', 17
    sub_16c4faa8[stor7[arg1[all]][arg2[all]]] += arg4
...
function sub_1a1679e7(?) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    if not stor14[arg1][ext_call.return_data[0]]:
        if arg4 > 0:
            stor14[arg1][ext_call.return_data[0]] = 1
            tokenUser[arg1][stor10[arg1]] = ext_call.return_data[0]
            if totalTokenUsers[arg1] == -1:
                revert with 'NH{q', 17
            totalTokenUsers[arg1]++
...
function sub_5682ce8c(?) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    return bool(stor14[arg1][ext_call.return_data[0]])
}
...
function sub_5f2ecbb2(?) payable {
    ...
    mem[arg2.length + 96] = sha3(arg1[all], 7)
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    if balance[stor7[arg1[all]][arg2[all]]][ext_call.return_data[0]] < arg5:
        revert with 'NH{q', 17
    balance[stor7[arg1[all]][arg2[all]]][ext_call.return_data[0]] -= arg5
    if sub_16c4faa8[stor7[arg1[all]][arg2[all]]] < arg5:
        revert with 'NH{q', 17
    sub_16c4faa8[stor7[arg1[all]][arg2[all]]] -= arg5
...
function sub_fe3d2a5d(?) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    return bool(stor14[stor7[arg1[all]][arg2[all]]][ext_call.return_data[0]])
}
...
function sub_a3a49296(?) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    if not stor14[stor7[arg1[all]][arg2[all]]][ext_call.return_data[0]]:
        if arg5 > 0:
            stor14[stor7[arg1[all]][arg2[all]]][ext_call.return_data[0]] = 1
            tokenUser[stor7[arg1[all]][arg2[all]]][stor10[stor7[arg1[all]][arg2[all]]]] = ext_call.return_data[0]
            if totalTokenUsers[stor7[arg1[all]][arg2[all]]] == -1:
                revert with 'NH{q', 17
            totalTokenUsers[stor7[arg1[all]][arg2[all]]]++
    if balance[stor7[arg1[all]][arg2[all]]][ext_call.return_data[0]] > -arg5 - 1:
        revert with 'NH{q', 17
    balance[stor7[arg1[all]][arg2[all]]][ext_call.return_data[0]] += arg5
    if sub_16c4faa8[stor7[arg1[all]][arg2[all]]] > -arg5 - 1:
        revert with 'NH{q', 17
    sub_16c4faa8[stor7[arg1[all]][arg2[all]]] += arg5
...
function tokenAddressById(uint256 arg1) payable {
    ...
    if stor6[arg1].field_0:
        ...
        return Array(len=2 * Mask(256, -1, stor6[arg1].field_1), data=mem[128 len ceil32(stor6[arg1].field_1)], mem[(2 * ceil32(stor6[arg1].field_1)) + 192 len 2 * ceil32(stor6[arg1].field_1)]), 
    if stor6[arg1].field_0 == stor6[arg1].field_1 < 32:
        revert with 'NH{q', 34
    if stor6[arg1].field_0:
        if stor6[arg1].field_0 == stor6[arg1].field_1 < 32:
...
function sub_d41ebce1(?) payable {
    ...
    if not stor8[call.data[cd[4] + 36 len ('cd', 4).length]][call.data[cd[36] + 36 len ('cd', 36).length]]:
        if stor5[stor9].field_0:
            if stor5[stor9].field_0 == stor5[stor9].field_1 < 32:
                revert with 'NH{q', 34
            if not ('cd', 4).length:
                stor5[stor9].field_0 = 0
                idx = 0
                while stor5[stor9].field_1 + 31 / 32 > idx:
                    stor5[stor9][idx].field_0 = 0
                    idx = idx + 1
                    continue 
            else:
                stor5[stor9].field_0 = (2 * ('cd', 4).length) + 1
                s = 0
                idx = cd[4] + 36
                while cd[4] + ('cd', 4).length + 36 > idx:
                    stor5[stor9][s].field_0 = cd[idx]
                    s = s + 1
                    idx = idx + 32
                    continue 
        ...
        if stor6[stor9].field_0:
            ...
            if not ('cd', 36).length:
                ...
                stor6[stor9].field_0 = (2 * ('cd', 36).length) + 1
                s = 0
                idx = cd[36] + 36
                while cd[36] + ('cd', 36).length + 36 > idx:
                    stor6[stor9][s].field_0 = cd[idx]
                    s = s + 1
                    idx = idx + 32
                    continue 
        ...
        stor8[call.data[cd[4] + 36 len ('cd', 4).length]][call.data[cd[36] + 36 len ('cd', 36).length]] = 1
        if totalTokens == -1:
            revert with 'NH{q', 17
        totalTokens++
}
    ...
    if stor5[arg1].field_0:
        ...
        if stor6[arg1].field_0:
            ...
            if stor6[arg1].field_0:
                if stor6[arg1].field_0 == stor6[arg1].field_1 < 32:
                    revert with 'NH{q', 34
                if not stor6[arg1].field_1:
                    if ceil32(stor5[arg1].field_1) > stor5[arg1].field_1:
                        mem[ceil32(stor5[arg1].field_1) + ceil32(stor6[arg1].field_1) + stor5[arg1].field_1 + 256] = 0
                    mem[(2 * ceil32(stor5[arg1].field_1)) + ceil32(stor6[arg1].field_1) + 256] = stor6[arg1].field_1
                    mem[(2 * ceil32(stor5[arg1].field_1)) + ceil32(stor6[arg1].field_1) + 288 len ceil32(stor6[arg1].field_1)] = mem[ceil32(stor5[arg1].field_1) + 160 len ceil32(stor6[arg1].field_1)]
                    if ceil32(stor6[arg1].field_1) > stor6[arg1].field_1:
                        mem[(2 * ceil32(stor5[arg1].field_1)) + ceil32(stor6[arg1].field_1) + stor6[arg1].field_1 + 288] = 0
                else:
                    if 31 >= stor6[arg1].field_1:
                        mem[ceil32(stor5[arg1].field_1) + 160] = 256 * stor6[arg1].field_8
                    else:
                        mem[ceil32(stor5[arg1].field_1) + 160] = stor6[arg1].field_0
                        idx = ceil32(stor5[arg1].field_1) + 160
                        s = 0
                        while ceil32(stor5[arg1].field_1) + stor6[arg1].field_1 + 128 > idx:
                            mem[idx + 32] = stor6[arg1][s].field_256
                            idx = idx + 32
                            s = s + 1
                            continue 
                ...
                if not stor6[arg1].field_1:
                    ...
                    if ceil32(stor6[arg1].field_1) > stor6[arg1].field_1:
                        mem[(2 * ceil32(stor5[arg1].field_1)) + ceil32(stor6[arg1].field_1) + stor6[arg1].field_1 + 288] = 0
            return Array(len=2 * Mask(256, -1, stor5[arg1].field_1), data=mem[128 len ceil32(stor5[arg1].field_1)], 2 * Mask(256, -1, stor6[arg1].field_1), mem[ceil32(stor5[arg1].field_1) + 160 len ceil32(stor6[arg1].field_1)]), 
                   ceil32(stor5[arg1].field_1) + 96
        if stor6[arg1].field_0 == stor6[arg1].field_1 < 32:
            revert with 'NH{q', 34
        if stor6[arg1].field_0:
            if stor6[arg1].field_0 == stor6[arg1].field_1 < 32:
            ...
            if not stor6[arg1].field_1:
                ...
                if ceil32(stor6[arg1].field_1) > stor6[arg1].field_1:
                    mem[(2 * ceil32(stor5[arg1].field_1)) + ceil32(stor6[arg1].field_1) + stor6[arg1].field_1 + 288] = 0
        return Array(len=2 * Mask(256, -1, stor5[arg1].field_1), data=mem[128 len ceil32(stor5[arg1].field_1)], stor6[arg1].field_0, mem[ceil32(stor5[arg1].field_1) + 160 len ceil32(stor6[arg1].field_1)]), 
               ceil32(stor5[arg1].field_1) + 96
    if stor5[arg1].field_0 == stor5[arg1].field_1 < 32:
        revert with 'NH{q', 34
    if stor5[arg1].field_0:
    ...
    if stor6[arg1].field_0:
        ...
        if stor6[arg1].field_0:
            ...
            if not stor6[arg1].field_1:
                ...
                if ceil32(stor6[arg1].field_1) > stor6[arg1].field_1:
                    mem[(2 * ceil32(stor5[arg1].field_1)) + ceil32(stor6[arg1].field_1) + stor6[arg1].field_1 + 288] = 0
        return Array(len=stor5[arg1].field_0, data=mem[128 len ceil32(stor5[arg1].field_1)], 2 * Mask(256, -1, stor6[arg1].field_1), mem[ceil32(stor5[arg1].field_1) + 160 len ceil32(stor6[arg1].field_1)]), 
               ceil32(stor5[arg1].field_1) + 96
    if stor6[arg1].field_0 == stor6[arg1].field_1 < 32:
        revert with 'NH{q', 34
    if stor6[arg1].field_0:
        ...
        if not stor6[arg1].field_1:
            ...
            if ceil32(stor6[arg1].field_1) > stor6[arg1].field_1:
                mem[(2 * ceil32(stor5[arg1].field_1)) + ceil32(stor6[arg1].field_1) + stor6[arg1].field_1 + 288] = 0
    return Array(len=stor5[arg1].field_0, data=mem[128 len ceil32(stor5[arg1].field_1)], stor6[arg1].field_0, mem[ceil32(stor5[arg1].field_1) + 160 len ceil32(stor6[arg1].field_1)]), 
           ceil32(stor5[arg1].field_1) + 96
}
