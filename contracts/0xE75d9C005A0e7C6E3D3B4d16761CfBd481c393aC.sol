...
function toggleSale() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    Mask(248, 0, stor15.field_8) = Mask(248, 0, not bool(saleOpen))
}
...
function togglePreSale() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    uint256(stor15.field_0) = not bool(preSaleOpen) or Mask(248, 8, uint256(stor15.field_0))
}
...
function withdraw() {
    ...
    if eth.balance(this.address) and 20 > -1 / eth.balance(this.address):
        revert with 'NH{q', 17
    call 0x4a7642aa9b2faf4467b76346fbcb0c7135afbf0c with:
       value 20 * eth.balance(this.address) / 100 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if eth.balance(this.address) and 35 > -1 / eth.balance(this.address):
        revert with 'NH{q', 17
    call 0x23e0eec25afef80871e19e847df0d3354d7e4098 with:
       value 35 * eth.balance(this.address) / 100 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if eth.balance(this.address) and 45 > -1 / eth.balance(this.address):
        revert with 'NH{q', 17
    call 0x81eae876f52e9fce868976b26c742a83ea7ede20 with:
...
function mint() payable {
    ...
    if saleOpen:
        ...
        if bool(preSaleOpen) != 1:
            revert with 0, 'presale is not open'
        mem[100] = msg.sender
        require ext_code.size(0x3d7071e5647251035271aeb780d832b381fa730f)
        staticcall 0x3d7071e5647251035271aeb780d832b381fa730f.0x70a08231 with:
                gas gas_remaining wei
               args msg.sender
        ...
        require ext_code.size(0x17b28274f8c1d64b683ad097988fa5707b228f80)
        staticcall 0x17b28274f8c1d64b683ad097988fa5707b228f80.0x70a08231 with:
                gas gas_remaining wei
               args msg.sender
        ...
        if ext_call.return_data[0] <= 0:
            if ext_call.return_data[0] <= 0:
                revert with 0, 'you must hold a Gantom Stone or PepeTarot: Edition 0 to participate in the presale'
        if tokenByIndex.length >= maxSupply:
            revert with 0, 'supply depleted'
        ...
        if ext_code.size(msg.sender) > 0:
            ...
            mem[(2 * ceil32(return_data.size)) + 196] = stor12
