...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        mem[260 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1) >> 32
        ...
        if not return_data.size:
            if not ext_call.success:
                revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), arg1
        ...
        if ext_code.size(lpPairAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[324 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor12), uint32(stor12), ext_call.return_data[0 len 28]
        call lpPairAddress with:
           funct uint32(stor12)
             gas gas_remaining wei
...
function pause() payable {
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                call lpToken1Address.0x7e38c29 with:
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address arg1, uint256 arg2), 0xf491e7b69e4244ad4002bc14, 0, 0) << 256, mem[816 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address arg1, uint256 arg2), 0xcc0a87f7e7c693042a9cc703, 0, 0
                    if not approve(address arg1, uint256 arg2), 0xcc0a87f7e7c693042a9cc703:
    ...
    if return_data.size <= 0:
        ...
        if return_data.size <= 0:
            ...
            call lpToken1Address.0x7e38c29 with:
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), 0xf491e7b69e4244ad4002bc14, 0, 0) << 256, mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 819 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address arg1, uint256 arg2), 0xcc0a87f7e7c693042a9cc703, 0, 0
                if not approve(address arg1, uint256 arg2), 0xcc0a87f7e7c693042a9cc703:
