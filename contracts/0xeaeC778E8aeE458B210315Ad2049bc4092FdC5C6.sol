...
function sub_f50cd32c(?) payable {
    ...
    if eth.balance(cd[(cd[4] + ('cd', 4)[5] + 196)]):
        ...
        call address(cd[(cd[4] + ('cd', 4)[5] + 36)]).0x89fecbd5 with:
             gas gas_remaining wei
            args address(('cd', 4)[0]), 2 * 10^16, address(cd[(cd[4] + ('cd', 4)[5] + 132)]), address(cd[(cd[4] + ('cd', 4)[5] + 196)])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(address(cd[(cd[4] + ('cd', 4)[5] + 36)]))
        call address(cd[(cd[4] + ('cd', 4)[5] + 36)]).0x6ceaad4d with:
             gas gas_remaining wei
            args address(cd[(cd[4] + ('cd', 4)[5] + 68)]), cd[36] - 2 * 10^16, address(cd[(cd[4] + ('cd', 4)[5] + 100)]), address(cd[(cd[4] + ('cd', 4)[5] + 132)]), address(cd[(cd[4] + ('cd', 4)[5] + 164)]), address(cd[(cd[4] + ('cd', 4)[5] + 196)])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
