    ...
    if ext_call.return_data[12 len 20] == 0x85dec8c4b2680793661bca91a8f129607571863d:
        if ext_call.return_data[12 len 20] == 0x85dec8c4b2680793661bca91a8f129607571863d:
            if not Mask(112, 0, ext_call.return_data[32]):
                revert with 0, 18
            return Mask(112, 0, Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]))
        if not Mask(112, 0, ext_call.return_data[0]):
            revert with 0, 18
        return Mask(112, 0, Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[0]))
    if ext_call.return_data[12 len 20] == 0x85dec8c4b2680793661bca91a8f129607571863d:
        if not Mask(112, 0, ext_call.return_data[32]):
            revert with 0, 18
        return Mask(112, 0, Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[32]))
    if not Mask(112, 0, ext_call.return_data[0]):
        revert with 0, 18
    return Mask(112, 0, Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]))
}
    ...
    if ext_call.return_data[12 len 20] == 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83:
        if ext_call.return_data[12 len 20] == 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83:
            ...
            if not Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[32])):
                revert with 0, 18
            return Mask(112, 0, Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[32])))
        if Mask(112, 0, ext_call.return_data[0]) > 5192296858534827628530:
            revert with 0, 17
        if not Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[0])):
            revert with 0, 18
        return Mask(112, 0, Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[0])))
    if ext_call.return_data[12 len 20] == 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83:
        if Mask(112, 0, ext_call.return_data[32]) > 5192296858534827628530:
            revert with 0, 17
        if not Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[32])):
            revert with 0, 18
        return Mask(112, 0, Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[32])))
    if Mask(112, 0, ext_call.return_data[0]) > 5192296858534827628530:
        revert with 0, 17
    if not Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[0])):
        revert with 0, 18
    return Mask(112, 0, Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, 10^12 * Mask(112, 0, ext_call.return_data[0])))
}
