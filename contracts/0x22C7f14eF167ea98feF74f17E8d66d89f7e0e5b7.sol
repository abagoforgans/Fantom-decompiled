...
function sub_b90e94d1(?) payable {
    ...
    mem[64] = (32 * arg2.length) + ceil32(arg7.length) + 160
    mem[(32 * arg2.length) + 128] = arg7.length
    mem[(32 * arg2.length) + 160 len arg7.length] = arg7[all]
    mem[(32 * arg2.length) + arg7.length + 160] = 0
    idx = 0
    while idx < arg2.length:
        ...
        mem[mem[64] + 68] = address(_65)
        mem[mem[64] + 100] = arg3
        mem[mem[64] + 132] = arg4
        mem[mem[64] + 164] = arg5
        mem[mem[64] + 196] = arg6
        mem[mem[64] + 228] = 256
        mem[mem[64] + 260] = mem[(32 * arg2.length) + 128]
        _68 = mem[(32 * arg2.length) + 128]
        s = 0
        while s < _68:
            mem[mem[64] + s + 292] = mem[(32 * arg2.length) + s + 160]
            s = s + 32
            continue 
        if not _68 % 32:
            require ext_code.size(stor1.length)
            call stor1.length.mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _68 + _66 + -mem[64] + 288]
            if not ext_call.success:
                mem[mem[64]] = 32
                mem[mem[64] + 32] = 20
                ...
                require return_data.size >= 32
                _126 = mem[_123]
                require mem[_123] <= 4294967296
                require mem[_123] + 32 <= return_data.size
                require mem[mem[_123] + _123] <= 4294967296 and mem[_123] + mem[mem[_123] + _123] + 32 <= return_data.size
                mem[_123 + ceil32(return_data.size)] = mem[mem[_123] + _123]
                _134 = mem[_126 + _123]
                s = 0
                while s < _134:
                    mem[_123 + ceil32(return_data.size) + s + 32] = mem[_126 + _123 + s + 32]
                    s = s + 32
                    continue 
                if not _134 % 32:
                    mem[64] = _134 + _123 + ceil32(return_data.size) + 32
                    mem[_134 + _123 + ceil32(return_data.size) + 32] = 32
                    mem[_134 + _123 + ceil32(return_data.size) + 64] = mem[_123 + ceil32(return_data.size)]
                    s = 0
                    while s < mem[_123 + ceil32(return_data.size)]:
                        mem[_134 + _123 + ceil32(return_data.size) + s + 96] = mem[_123 + ceil32(return_data.size) + s + 32]
                        s = s + 32
                        continue 
                    if not mem[_123 + ceil32(return_data.size)] % 32:
                        emit Log(mem[mem[64] len mem[_123 + ceil32(return_data.size)] + _134 + _123 + ceil32(return_data.size) + -mem[64] + 96]);
                    else:
                        mem[floor32(mem[_123 + ceil32(return_data.size)]) + _134 + _123 + ceil32(return_data.size) + 96] = mem[floor32(mem[_123 + ceil32(return_data.size)]) + _134 + _123 + ceil32(return_data.size) + -(mem[_123 + ceil32(return_data.size)] % 32) + 128 len mem[_123 + ceil32(return_data.size)] % 32]
                        emit Log(mem[mem[64] len floor32(mem[_123 + ceil32(return_data.size)]) + _134 + _123 + ceil32(return_data.size) + -mem[64] + 128]);
                else:
                    mem[floor32(_134) + _123 + ceil32(return_data.size) + 32] = mem[floor32(_134) + _123 + ceil32(return_data.size) + -(_134 % 32) + 64 len _134 % 32]
                    mem[64] = floor32(_134) + _123 + ceil32(return_data.size) + 64
                    mem[floor32(_134) + _123 + ceil32(return_data.size) + 64] = 32
                    mem[floor32(_134) + _123 + ceil32(return_data.size) + 96] = mem[_123 + ceil32(return_data.size)]
                    s = 0
                    while s < mem[_123 + ceil32(return_data.size)]:
                        mem[floor32(_134) + _123 + ceil32(return_data.size) + s + 128] = mem[_123 + ceil32(return_data.size) + s + 32]
                        s = s + 32
                        continue 
                    if not mem[_123 + ceil32(return_data.size)] % 32:
                        emit Log(mem[mem[64] len mem[_123 + ceil32(return_data.size)] + floor32(_134) + _123 + ceil32(return_data.size) + -mem[64] + 128]);
                    else:
                        mem[floor32(mem[_123 + ceil32(return_data.size)]) + floor32(_134) + _123 + ceil32(return_data.size) + 128] = mem[floor32(mem[_123 + ceil32(return_data.size)]) + floor32(_134) + _123 + ceil32(return_data.size) + -(mem[_123 + ceil32(return_data.size)] % 32) + 160 len mem[_123 + ceil32(return_data.size)] % 32]
                        emit Log(mem[mem[64] len floor32(mem[_123 + ceil32(return_data.size)]) + floor32(_134) + _123 + ceil32(return_data.size) + -mem[64] + 160]);
                sub_8f7371e0++
        else:
            mem[floor32(_68) + _66 + 292] = mem[floor32(_68) + _66 + -(_68 % 32) + 324 len _68 % 32]
            require ext_code.size(stor1.length)
            call stor1.length.mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len floor32(_68) + _66 + -mem[64] + 320]
            if not ext_call.success:
                mem[mem[64]] = 32
                mem[mem[64] + 32] = 20
                mem[mem[64] + 64] = 'external call failed'
                ...
                require mem[mem[_128] + _128] <= 4294967296 and mem[_128] + mem[mem[_128] + _128] + 32 <= return_data.size
                mem[_128 + ceil32(return_data.size)] = mem[mem[_128] + _128]
                _136 = mem[_131 + _128]
                s = 0
                while s < _136:
                    mem[_128 + ceil32(return_data.size) + s + 32] = mem[_131 + _128 + s + 32]
                    s = s + 32
                    continue 
                if not _136 % 32:
                    mem[64] = _136 + _128 + ceil32(return_data.size) + 32
                    mem[_136 + _128 + ceil32(return_data.size) + 32] = 32
                    mem[_136 + _128 + ceil32(return_data.size) + 64] = mem[_128 + ceil32(return_data.size)]
                    s = 0
                    while s < mem[_128 + ceil32(return_data.size)]:
                        mem[_136 + _128 + ceil32(return_data.size) + s + 96] = mem[_128 + ceil32(return_data.size) + s + 32]
                        s = s + 32
                        continue 
                    if not mem[_128 + ceil32(return_data.size)] % 32:
                        emit Log(mem[mem[64] len mem[_128 + ceil32(return_data.size)] + _136 + _128 + ceil32(return_data.size) + -mem[64] + 96]);
                    else:
                        mem[floor32(mem[_128 + ceil32(return_data.size)]) + _136 + _128 + ceil32(return_data.size) + 96] = mem[floor32(mem[_128 + ceil32(return_data.size)]) + _136 + _128 + ceil32(return_data.size) + -(mem[_128 + ceil32(return_data.size)] % 32) + 128 len mem[_128 + ceil32(return_data.size)] % 32]
                        emit Log(mem[mem[64] len floor32(mem[_128 + ceil32(return_data.size)]) + _136 + _128 + ceil32(return_data.size) + -mem[64] + 128]);
                else:
                    mem[floor32(_136) + _128 + ceil32(return_data.size) + 32] = mem[floor32(_136) + _128 + ceil32(return_data.size) + -(_136 % 32) + 64 len _136 % 32]
                    mem[64] = floor32(_136) + _128 + ceil32(return_data.size) + 64
                    mem[floor32(_136) + _128 + ceil32(return_data.size) + 64] = 32
                    mem[floor32(_136) + _128 + ceil32(return_data.size) + 96] = mem[_128 + ceil32(return_data.size)]
                    s = 0
                    while s < mem[_128 + ceil32(return_data.size)]:
                        mem[floor32(_136) + _128 + ceil32(return_data.size) + s + 128] = mem[_128 + ceil32(return_data.size) + s + 32]
                        s = s + 32
                        continue 
                    if not mem[_128 + ceil32(return_data.size)] % 32:
                        emit Log(mem[mem[64] len mem[_128 + ceil32(return_data.size)] + floor32(_136) + _128 + ceil32(return_data.size) + -mem[64] + 128]);
                    else:
                        mem[floor32(mem[_128 + ceil32(return_data.size)]) + floor32(_136) + _128 + ceil32(return_data.size) + 128] = mem[floor32(mem[_128 + ceil32(return_data.size)]) + floor32(_136) + _128 + ceil32(return_data.size) + -(mem[_128 + ceil32(return_data.size)] % 32) + 160 len mem[_128 + ceil32(return_data.size)] % 32]
                        emit Log(mem[mem[64] len floor32(mem[_128 + ceil32(return_data.size)]) + floor32(_136) + _128 + ceil32(return_data.size) + -mem[64] + 160]);
                sub_8f7371e0++
        idx = idx + 1
        continue 
}
