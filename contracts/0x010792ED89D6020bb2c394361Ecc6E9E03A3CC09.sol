                ...
                if stor10[address(this.address)]:
                    ...
                    while idx < stor11.length:
                        ...
                        if stor4[stor11[idx]] > t:
                            ...
                            call uniswapV2RouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args (stor4[address(this.address)] / stor12 / 1000000 * 10^18) - stor29, 0, 160, address(this.address), block.timestamp, mem[_6048 + ceil32(return_data.size) + 260 len (32 * mem[_6048]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
        ...
        if t < stor12 / 1000000 * 10^18:
            ...
            if stor10[address(this.address)]:
                ...
                if t < stor12 / 1000000 * 10^18:
                    ...
                    call uniswapV2RouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args (stor4[address(this.address)] / stor12 / 1000000 * 10^18) - stor29, 0, 160, address(this.address), block.timestamp, mem[_6174 + ceil32(return_data.size) + 260 len (32 * mem[_6174]) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if eth.balance(this.address) > eth.balance(this.address):
                        revert with 0, 'SafeMath: subtraction overflow', 0
