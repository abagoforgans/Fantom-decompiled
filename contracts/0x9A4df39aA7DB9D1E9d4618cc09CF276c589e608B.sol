...
function royaltyInfo(uint256 arg1, uint256 arg2) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    if arg2 and stor355 > -1 / arg2:
        revert with 'NH{q', 17
    if not stor356:
        revert with 'NH{q', 18
    return creator[arg1], arg2 * stor355 / stor356
}
...
function sub_ad406016(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    require ext_code.size(stor357)
    staticcall stor357.0x126ff871 with:
...
function safeMint(string arg1) payable {
    ...
    if not stor353[address(msg.sender)]:
