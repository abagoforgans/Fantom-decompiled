...
function sub_775c6007(?) payable {
    ...
    staticcall masterAddress.getMultiplier(uint256 rg1, uint256 rg2) with:
            gas gas_remaining wei
    ...
    require ext_code.size(masterAddress)
    staticcall masterAddress.poolInfo(uint256 rg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(masterAddress)
    staticcall masterAddress.totalAllocPoint() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(masterAddress)
    staticcall masterAddress.0x63822a40 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
