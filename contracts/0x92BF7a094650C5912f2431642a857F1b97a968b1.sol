...
function sub_01ada78a(?) {
    return sub_01ada78aAddress
}

function sub_0abd9563(?) {
...
function sub_d7bd59d0(?) {
    require calldata.size - 4 >= 32
    return sub_3c526f98[arg1][msg.sender]
}

function sub_ddc8af61(?) {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
...
function sub_85fa74bc(?) {
    require calldata.size - 4 >= 64
    if stor2[arg1].field_2824:
        revert with 0, 'Campaign must be expired.'
    if stor2[arg1].field_2816:
...
function donate(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    if bool(stor2[arg1].field_2824) != 1:
    ...
    if stor2[arg1].field_768 >= stor2[arg1].field_512:
        stor2[arg1].field_2816 = 1
        stor2[arg1].field_2824 = 0
        require ext_code.size(stor6)
        call stor6.0xa9059cbb with:
             gas gas_remaining wei
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
    if 1 == bool(stor2[arg1].field_2824):
        if block.timestamp >= stor2[arg1].field_3072:
            stor2[arg1].field_2824 = 0
}

function sub_7fa9d037(?) {
    ...
    if stor2[arg1].field_1536:
        if stor2[arg1].field_1536 == uint255(stor2[arg1].field_1536) * 0.5 < 32:
            revert with 0, 34
        if arg3.length:
            stor2[arg1][6][].field_0 = Array(len=arg3.length, data=arg3[all])
        else:
    ...
    if stor2[arg1].field_1792:
        if stor2[arg1].field_1792 == uint255(stor2[arg1].field_1792) * 0.5 < 32:
            revert with 0, 34
        if arg4.length:
            stor2[arg1][7][].field_0 = Array(len=arg4.length, data=arg4[all])
        else:
            stor2[arg1].field_1792 = 0
            idx = 0
            while (uint255(stor2[arg1].field_1792) * 0.5) + 31 / 32 > idx:
                stor2[arg1][idx + 7].field_0 = 0
                idx = idx + 1
                continue 
    else:
        ...
        if arg4.length:
            ...
            stor2[arg1].field_1792 = 0
            idx = 0
            while stor2[arg1].field_1793 + 31 / 32 > idx:
                stor2[arg1][idx + 7].field_0 = 0
                idx = idx + 1
                continue 
}
