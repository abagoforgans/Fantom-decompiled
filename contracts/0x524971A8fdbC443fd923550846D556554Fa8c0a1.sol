...
uint256 sub_8e72e31b;
uint16 stor16;
uint256 stor16; offset 16
uint256 sub_6353f822;
uint256 minProfit;
...
function sub_3d3dc445(?) payable {
    if strategistAddress != msg.sender:
        revert with 0, '!strategist'
    Mask(96, 0, stor26.field_160) = Mask(96, 0, not uint8(stor26.field_160))
}

function sub_3b7fcc3b(?) payable {
...
function sub_a3182472(?) payable {
    ...
    staticcall stor21.getUserAccountData(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_831b1608(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 192
    return ((ext_call.return_data[160] - 10^18 / 10^15) + 9900)
}
...
function ethToWant(uint256 arg1) payable {
    ...
    if arg1 == -1:
        return arg1
    if stor20 == wantAddress:
        return arg1
    require ext_code.size(0xec1d984d6a043f9969ced0b5f128fd4617c1666d)
    delegate 0xec1d984d6a043f9969ced0b5f128fd4617c1666d.fromETH(uint256 arg1, address arg2) with:
         gas gas_remaining wei
...
function sub_638dcebd(?) payable {
    ...
    staticcall stor22.getAssetPrice(address arg1) with:
            gas gas_remaining wei
           args wantAddress
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_7b454884(?) payable {
    ...
    if arg1:
        require ext_code.size(stor21)
        call stor21.withdraw(address arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
        ...
        if arg1:
            require ext_code.size(stor21)
            call stor21.repay(address arg1, uint256 arg2, uint256 arg3, address arg4) with:
                 gas gas_remaining wei
...
function getMaxWithdrawable() payable {
    ...
    if 10000 * ext_call.return_data[0] / ext_call.return_data[96] > ext_call.return_data[0]:
        revert with 0, 'SafeMath: subtraction overflow', 0
    return (ext_call.return_data[0] - (10000 * ext_call.return_data[0] / ext_call.return_data[96]))
}
    ...
    if ext_call.return_data[160] > minHealth:
        ...
        if not ext_call.return_data[0]:
            ...
            if -ext_call.return_data[0]:
                if -9950 * ext_call.return_data[0] / -ext_call.return_data[0] != 9950:
                    revert with 0, 'SafeMath: multiplication overflow'
                if -9950 * ext_call.return_data[0] / 10000 >= minRebalanceAmount:
                    return (-9950 * ext_call.return_data[0] / 10000)
        else:
            ...
            if ext_call.return_data[0] > ext_call.return_data[128] * ext_call.return_data[0] / 10000:
                revert with 0, 'SafeMath: subtraction overflow', 0
            if (ext_call.return_data[128] * ext_call.return_data[0] / 10000) - ext_call.return_data[0]:
                if (9950 * ext_call.return_data[128] * ext_call.return_data[0] / 10000) - (9950 * ext_call.return_data[0]) / (ext_call.return_data[128] * ext_call.return_data[0] / 10000) - ext_call.return_data[0] != 9950:
                    revert with 0, 'SafeMath: multiplication overflow'
                if (9950 * ext_call.return_data[128] * ext_call.return_data[0] / 10000) - (9950 * ext_call.return_data[0]) / 10000 >= minRebalanceAmount:
                    return ((9950 * ext_call.return_data[128] * ext_call.return_data[0] / 10000) - (9950 * ext_call.return_data[0]) / 10000)
        return 0
    else:
        return 0
}
...
function sub_74cd8012(?) payable {
    ...
    mem[64] = (2 * ceil32(return_data.size)) + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], address(this.address) << 64 + 192]) + 224
    require return_data.size >= mem[ceil32(return_data.size) + 192 len 4], address(this.address) << 64 + (32 * _27) + 32
    mem[(2 * ceil32(return_data.size)) + 224 len 32 * _27] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], address(this.address) << 64 + 224 len 32 * _27]
    idx = 0
    s = 0
    while idx < _27:
        require idx < _27
...
function initialize(address arg1, address arg2, address arg3, address arg4) payable {
    ...
    if not return_data.size:
        ...
        sub_8d01f0ba = 5
        stor21 = 0x9fad24f572045c7869117160a571b2e50b10d068
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
        stor24 = ext_call.return_data[12 len 20]
        ...
        require ext_code.size(stor21)
        staticcall stor21.getConfiguration(address arg1) with:
                gas gas_remaining wei
               args wantAddress
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require bool((8 * ceil32(return_data.size)) + 292 <= test266151307())
        if not ext_call.return_data[30 len 2]:
            sub_8e72e31b = 0
        else:
            if 8125 * ext_call.return_data[30 len 2] / ext_call.return_data[30 len 2] != 8125:
                revert with 0, 'SafeMath: multiplication overflow'
            sub_8e72e31b = 8125 * uint16(ext_call.return_data[0]) / 10000
        uint16(stor16.field_0) = uint16(ext_call.return_data[0])
        Mask(240, 0, stor16.field_16) = 0
        uint8(stor26.field_160) = 0
        require ext_code.size(stor21)
        staticcall stor21.getReserveData(address arg1) with:
                gas gas_remaining wei
               args wantAddress
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 384
        require bool((10 * ceil32(return_data.size)) + 1156 <= test266151307())
        require return_data.size >= 32
        require bool((10 * ceil32(return_data.size)) + 1188 <= test266151307())
    else:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require bool((8 * ceil32(return_data.size)) + ceil32(return_data.size) + 293 <= test266151307())
        if not ext_call.return_data[30 len 2]:
            sub_8e72e31b = 0
        else:
            if 8125 * ext_call.return_data[30 len 2] / ext_call.return_data[30 len 2] != 8125:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 384
        require bool((10 * ceil32(return_data.size)) + ceil32(return_data.size) + 1157 <= test266151307())
        require return_data.size >= 32
        require bool((10 * ceil32(return_data.size)) + ceil32(return_data.size) + 1189 <= test266151307())
    ...
    stor19 = 0xf491e7b69e4244ad4002bc14e878a34207e38c29
...
function sub_63782b51(?) payable {
    ...
    mem[(8 * ceil32(return_data.size)) + 544] = _72
    ...
    if stor20 == 0xd8321aa83fb0a4ecd6348d4577431310a6e0814d:
        _113 = mem[64]
        mem[mem[64]] = 2
        mem[64] = mem[64] + 96
        require 0 < mem[_113]
        ...
        if stor20 == 0xd8321aa83fb0a4ecd6348d4577431310a6e0814d:
            ...
            staticcall stor19.mem[mem[64] len 4] with:
                    gas gas_remaining wei
...
function harvestTrigger(uint256 arg1) payable {
    ...
    require (32 * mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 544 len 4], address(this.address) << 64 + 544]) + 32 >= 0 and (8 * ceil32(return_data.size)) + (32 * mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 544 len 4], address(this.address) << 64 + 544]) + 576 <= test266151307()
    mem[64] = (8 * ceil32(return_data.size)) + (32 * mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 544 len 4], address(this.address) << 64 + 544]) + 576
    mem[(8 * ceil32(return_data.size)) + 544] = _84
...
function sub_2c6a9f95(?) payable {
    ...
    if arg2:
        ...
        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).0x17caf6f1 with:
                gas gas_remaining wei
        ...
        if not ext_call.return_data[0]:
            ...
            if stor20 == 0xd8321aa83fb0a4ecd6348d4577431310a6e0814d:
                ...
                require stor20 == 0xd8321aa83fb0a4ecd6348d4577431310a6e0814d
                ...
                while idx < 2:
                    ...
                    continue 
                require ext_code.size(stor19)
                staticcall stor19.getAmountsOut(uint256 arg1, address[] arg2) with:
                        gas gas_remaining wei
            ...
            if stor20 == wantAddress:
                ...
                mem[(8 * ceil32(return_data.size)) + 224] = stor20
