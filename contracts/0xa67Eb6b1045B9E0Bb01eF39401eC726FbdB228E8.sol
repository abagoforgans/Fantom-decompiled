    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0], 0
                mem[ceil32(return_data.size) + 328] = 0
                call wantAddress with:
                   funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0], 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0], 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0] > 0:
                            revert with memory
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 388 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0] - (0 / WITHDRAWAL_MAX), 0
                    mem[ceil32(return_data.size) + 456] = 0
                    call wantAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0] - (0 / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0] - (0 / WITHDRAWAL_MAX), 0) << 288)
                else:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 388 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX), 0
                    mem[ceil32(return_data.size) + 456] = 0
                    call wantAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0] > 0:
                            revert with memory
            ...
            if tx.origin == owner:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1, 0
                mem[ceil32(return_data.size) + 328] = 0
                call wantAddress with:
                   funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1, 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1, 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0] > 0:
                            revert with memory
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 388 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1 - (0 / WITHDRAWAL_MAX), 0
                    mem[ceil32(return_data.size) + 456] = 0
                    call wantAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1 - (0 / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1 - (0 / WITHDRAWAL_MAX), 0) << 288)
                else:
                    require arg1
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 388 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX), 0
                    mem[ceil32(return_data.size) + 456] = 0
                    call wantAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0] > 0:
                            revert with memory
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 324 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0], 0
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 452 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0] - (0 / WITHDRAWAL_MAX), 0
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 452 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX), 0
                    mem[(2 * ceil32(return_data.size)) + 520] = 0
                    call wantAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 324 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1, 0
                mem[(2 * ceil32(return_data.size)) + 392] = 0
                call wantAddress with:
                   funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1, 0) >> 224
                     gas gas_remaining wei
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 452 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1 - (0 / WITHDRAWAL_MAX), 0
                    mem[(2 * ceil32(return_data.size)) + 520] = 0
                    call wantAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1 - (0 / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 452 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX), 0
                    mem[(2 * ceil32(return_data.size)) + 520] = 0
                    call wantAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX), 0) >> 224
                         gas gas_remaining wei
