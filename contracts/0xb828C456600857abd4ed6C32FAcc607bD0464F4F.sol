...
function aggregate(address arg1, bytes[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[64] = mem[64] + 64
        mem[_56] = address(cd[(arg1 + cd[s] + 36)])
        ...
        mem[_80] = cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]
        require arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)] + 68 <= calldata.size
        mem[_80 + 32 len cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]] = call.data[arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 68 len cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)]]
        mem[cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)] + _80 + 32] = 0
        mem[_56 + 32] = _80
        mem[t] = _56
        idx = idx + 1
        s = s + 32
        ...
        while idx < _106:
            ...
            if ceil32(_121) <= _121:
                call address(_110).mem[mem[64] len 4] with:
                    ...
                    args mem[mem[64] + 4 len _121 + _114 + -mem[64] - 4]
        ...
        while idx < _154:
            ...
            if ceil32(_170) <= _170:
                call address(_160).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _170 + _165 + -mem[64] - 4]
                if not return_data.size:
                    require ext_call.success
                    require idx < mem[_55]
                    mem[(32 * idx) + _55 + 32] = 96
