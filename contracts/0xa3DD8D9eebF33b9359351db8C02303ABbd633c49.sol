...
function sub_4a655f9d(?) payable {
    ...
    if not sub_65108ea4.length:
        ...
        call uniRouterAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args 0, ext_call.return_data[28 len 4], 0, 160, recipientAddress, block.timestamp + 600, sub_65108ea4.length
    else:
        ...
        call uniRouterAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args 0, ext_call.return_data[28 len 4], 0, 160, recipientAddress, block.timestamp + 600, sub_65108ea4.length, mem[292 len 32 * sub_65108ea4.length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdraw() payable {
    ...
    mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8.field_0), uint32(stor8.field_0), ext_call.return_data[0 len 28]
    mem[324 len 0] = 0
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor8.field_0), uint32(stor8.field_0), ext_call.return_data[0]
        if not unknown_0xa9059cbb(?????), Mask(224, 0, stor8.field_0):
...
function sub_78f07508(?) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(uniRouterAddress)
    call uniRouterAddress.0xf1efacf9 with:
         gas gas_remaining wei
