...
function rebalanceShare() payable {
    return bool(uint8(rebalanceShare))
}
...
function _rebalanceShare() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    uint256(stor8) = not bool(uint8(rebalanceShare)) or Mask(248, 8, uint256(stor8))
}
...
function proposeNewDelay(uint256 arg1) payable {
    ...
    emit 0x291dd745: arg1
}

function sub_7e48d4ea(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if stor10 + delay < stor10:
        revert with 0, 'SafeMath: addition overflow'
    if stor10 + delay >= block.timestamp:
        revert with 0, 'Delay has not passed'
    delay = stor9
    emit 0x832f93a7: stor9
}
...
function upgradeStrat() payable {
    ...
    if stor7 + delay < stor7:
        revert with 0, 'SafeMath: addition overflow'
    if stor7 + delay >= block.timestamp:
        revert with 0, 'Delay has not passed'
    ...
    if not uint8(rebalanceShare):
        ...
        if not return_data.size:
            ...
            if not totalSupply:
                ...
                if ext_code.size(tokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[520 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), ext_call.return_data[0 len 28]
                call tokenAddress with:
                   funct uint32(stor13)
                     gas gas_remaining wei
                ...
                if ext_code.size(tokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[584 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), ext_call.return_data[0 len 28]
                mem[648 len 0] = 0
                call tokenAddress with:
                   funct uint32(stor13)
                     gas gas_remaining wei
            ...
            if return_data.size <= 0:
                ...
                if not totalSupply:
                    ...
                    if ext_code.size(tokenAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 521 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), ext_call.return_data[0 len 28]
                    ...
                    if ext_code.size(tokenAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 585 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor13), uint32(stor13), ext_call.return_data[0 len 28]
                    call tokenAddress with:
                       funct uint32(stor13)
                         gas gas_remaining wei
