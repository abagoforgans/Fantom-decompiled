...
function lockLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, address arg6) payable {
    ...
    if ext_call.return_data[12 len 20]:
        mem[228 len 96] = unknown_0x23b872dd(?????), msg.sender, address(ext_call.return_data[0]), Mask(224, 32, arg3) >> 32
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                mem[460 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len 28]
                ...
                if not ext_call.return_data[0]:
                    revert with 0, 'LP creation failed'
                mem[ceil32(return_data.size) + 461 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len 28]
                call address(ext_call.return_data[0]) with:
                   funct uint32(stor2)
                     gas gas_remaining wei
        ...
        require ext_code.size(swapFactoryAddress)
        call swapFactoryAddress.createPair(address rg1, address rg2) with:
             gas gas_remaining wei
            args address(arg1), arg2
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
