...
function panic() payable {
    ...
    if not return_data.size:
        ...
        call rewardTokenAddress with:
           funct uint32(stor6)
             gas gas_remaining wei
            args Mask(480, -256, approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), 0) << 256, mem[488 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address rg1, uint256 rg2), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), 0
            if not approve(address rg1, uint256 rg2), Mask(224, 0, stor7.field_0):
        ...
        if return_data.size <= 0:
            ...
            call rewardTokenAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
                args Mask(480, -256, approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), 0) << 256, mem[ceil32(return_data.size) + 489 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address rg1, uint256 rg2), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), 0
                if not approve(address rg1, uint256 rg2), Mask(224, 0, stor7.field_0):
                ...
                if return_data.size <= 0:
                    ...
                    if not return_data.size:
                        ...
                        if ext_code.size(lpToken1Address) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 755 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), 0
            ...
            if not return_data.size:
                ...
                if ext_code.size(lpToken0Address) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 589 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), 0
                ...
                if not return_data.size:
                    ...
                    if ext_code.size(lpToken1Address) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 754 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, 0) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256
                    call lpToken1Address with:
                    ...
                    if not return_data.size:
                        ...
                        if return_data.size <= 0:
                            ...
                            call lpToken1Address with:
                               funct uint32(stor6)
                                 gas gas_remaining wei
                                args Mask(480, -256, approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), 0) << 256, mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 819 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with approve(address rg1, uint256 rg2), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), 0
                                if not approve(address rg1, uint256 rg2), Mask(224, 0, stor7.field_0):
