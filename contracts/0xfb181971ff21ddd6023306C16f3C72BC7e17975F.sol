...
function farm() payable {
    ...
    call address(stor29).deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
         gas gas_remaining wei
            ...
            if withdrawFeeFactor >= 10000:
                ...
                if wantLockedTotal < arg2:
                    if not wantLockedTotal:
                        call address(stor29).withdraw(address arg1, uint256 arg2, address arg3) with:
                             gas gas_remaining wei
                            args wantAddress, 100, this.address
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(0x49c93a95dbcc9a6a4d8f77e59c038ce5020e82f8)
                        call 0x49c93a95dbcc9a6a4d8f77e59c038ce5020e82f8.exit() with:
                             gas gas_remaining wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(wantAddress)
                        ...
                        call address(stor29).withdraw(address arg1, uint256 arg2, address arg3) with:
                             gas gas_remaining wei
                            args wantAddress, wantLockedTotal, this.address
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(wantAddress)
                        staticcall wantAddress.0x70a08231 with:
                    ...
                    if not arg2:
                        ...
                        if not arg2:
                            ...
                            require arg2
                            if 900 * arg2 / arg2 != 900:
                                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                            require ext_call.return_data[0] > 900 * arg2 / 1000
                            require ext_code.size(stor30)
                            staticcall stor30.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                    ...
                    if wantLockedTotal >= arg2 * withdrawFeeFactor / 10000:
                        if not arg2 * withdrawFeeFactor / 10000:
                            ...
                            if not arg2 * withdrawFeeFactor / 10000:
                                ...
                                require arg2 * withdrawFeeFactor / 10000
                                if 900 * arg2 * withdrawFeeFactor / 10000 / arg2 * withdrawFeeFactor / 10000 != 900:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                require ext_call.return_data[0] > 900 * arg2 * withdrawFeeFactor / 10000 / 1000
                            require ext_code.size(stor30)
                            staticcall stor30.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
