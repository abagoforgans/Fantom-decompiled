...
function sub_b1fd191c(?) payable {
    ...
    if ext_call.return_data[0]:
        ...
        if arg1 - ext_call.return_data[0] > 0:
            ...
            if not ext_code.size(sub_593a48c1Address):
                revert with 0, 'Address: call to non-contract'
            mem[(4 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1 - ext_call.return_data[0], 0
            mem[(4 * ceil32(return_data.size)) + 328] = 0
            call sub_593a48c1Address with:
        ...
        if arg1 - ext_call.return_data[0] > 0:
            ...
            if not ext_code.size(sub_593a48c1Address):
                revert with 0, 'Address: call to non-contract'
            mem[(6 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1 - ext_call.return_data[0], 0
                    ...
                    if ext_call.return_data[0] > 0:
                        ...
                        if msg.value <= ext_call.return_data[0]:
                            ...
                            if not ext_code.size(wftmAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(7 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, msg.value, 0
                            mem[(7 * ceil32(return_data.size)) + 328] = 0
                            call wftmAddress with:
                               funct Mask(32, 224, transfer(address arg1, uint256 arg2), msg.sender, msg.value, 0) >> 224
                                 gas gas_remaining wei
                                args (Mask(512, -288, transfer(address arg1, uint256 arg2), msg.sender, msg.value, 0) << 288)
                            if not return_data.size:
                                if not ext_call.success:
                                    if ext_call.return_data[0]:
                                        revert with memory
            ...
            if msg.value > 0:
                ...
                if ext_call.return_data[0] > 0:
                    ...
                    if msg.value <= ext_call.return_data[0]:
                        ...
                        if not ext_code.size(wftmAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(8 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, msg.value, 0
                        mem[(8 * ceil32(return_data.size)) + 328] = 0
                        call wftmAddress with:
                           funct Mask(32, 224, transfer(address arg1, uint256 arg2), msg.sender, msg.value, 0) >> 224
                             gas gas_remaining wei
                        ...
                        if not ext_code.size(wftmAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(10 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0
        ...
        if msg.value > 0:
            ...
            if ext_call.return_data[0] > 0:
                ...
                if msg.value <= ext_call.return_data[0]:
                    ...
                    if not ext_code.size(wftmAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(10 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, msg.value, 0
                    mem[(10 * ceil32(return_data.size)) + 328] = 0
                    call wftmAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), msg.sender, msg.value, 0) >> 224
                         gas gas_remaining wei
                    ...
                    if not ext_code.size(wftmAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(11 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0
