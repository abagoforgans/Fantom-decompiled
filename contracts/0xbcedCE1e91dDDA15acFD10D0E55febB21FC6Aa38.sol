...
array of struct sub_d5fc6b4f;
mapping of uint256 sub_df8eb8f9;
mapping of uint256 sub_486d5f03;
mapping of uint256 rewards;
mapping of struct result;
mapping of uint256 sub_cc620d9e;
...
function sub_486d5f03(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return sub_486d5f03[arg1]
}

function result(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    return result[arg1][arg2].field_0, result[arg1][arg2].field_256
}

function sub_cc620d9e(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return sub_cc620d9e[arg1]
}

function sub_d5fc6b4f(?) payable {
    require calldata.size - 4 >= 96
    require arg1 == arg1
    require arg2 == arg2
    require arg3 == arg3
    require arg3 < sub_d5fc6b4f[arg1][arg2].field_0
    return sub_d5fc6b4f[arg1][arg2][arg3].field_0, 
           sub_d5fc6b4f[arg1][arg2][arg3].field_256,
           sub_d5fc6b4f[arg1][arg2][arg3].field_256,
           sub_d5fc6b4f[arg1][arg2][arg3].field_512,
           sub_d5fc6b4f[arg1][arg2][arg3].field_768,
           sub_d5fc6b4f[arg1][arg2][arg3].field_1024
}

function sub_df8eb8f9(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return sub_df8eb8f9[arg1]
}
...
function hit_die(uint256 arg1) payable {
    ...
    if ext_call.return_data[92 len 4] >= 10:
        ...
        if (sha3(block.timestamp, 0, 0) % 8) + 1 < 0 and uint32(ext_call.return_data[64]) - 10 / 2 < -(sha3(block.timestamp, 0, 0) % 8) + 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
            revert with 'NH{q', 17
        if (sha3(block.timestamp, 0, 0) % 8) + (uint32(ext_call.return_data[64]) - 10 / 2) + 1 > 0:
        ...
        if (sha3(block.timestamp, 0, 0) % 8) + 1 < 0 and --uint32(ext_call.return_data[64]) + 11 / 2 < -(sha3(block.timestamp, 0, 0) % 8) + 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
            revert with 'NH{q', 17
        if (sha3(block.timestamp, 0, 0) % 8) + -(-uint32(ext_call.return_data[64]) + 11 / 2) + 1 > 0:
