...
function balanceOfPool() payable {
    ...
    staticcall 0x9180583c1ab03587b545629dd60d2be0bf1df4f2.userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
...
function deposit(uint256 arg1) payable {
    ...
    if arg1 > 0:
        if ext_call.return_data[0] > 0:
            require ext_code.size(0x9180583c1ab03587b545629dd60d2be0bf1df4f2)
            call 0x9180583c1ab03587b545629dd60d2be0bf1df4f2.0xe2bbb158 with:
                 gas gas_remaining wei
                args poolId, arg1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        require ext_code.size(0x9180583c1ab03587b545629dd60d2be0bf1df4f2)
        call 0x9180583c1ab03587b545629dd60d2be0bf1df4f2.0x441a3e70 with:
             gas gas_remaining wei
                                    ...
                                    if not mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 787]:
                                        ...
                                        revert with memory
                                          from (4 * ceil32(return_data.size)) + 756
                                           len (6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 132
    require ext_code.size(0x9180583c1ab03587b545629dd60d2be0bf1df4f2)
    call 0x9180583c1ab03587b545629dd60d2be0bf1df4f2.emergencyWithdraw(uint256 arg1) with:
         gas gas_remaining wei
        args poolId
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
