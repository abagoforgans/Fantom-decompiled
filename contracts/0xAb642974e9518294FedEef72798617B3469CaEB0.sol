...
function safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) {
    ...
    if arg1 == msg.sender:
        ...
        if ext_code.size(arg2):
            ...
            mem[(32 * _638) + mem[64] + 228 len floor32(mem[(32 * arg3.length) + 128])] = mem[(32 * arg3.length) + 160 len floor32(mem[(32 * arg3.length) + 128])]
            mem[mem[64] + 132] = (32 * _721) + (32 * _638) + 224
            mem[(32 * _721) + (32 * _638) + mem[64] + 228] = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
            _793 = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
            mem[(32 * _721) + (32 * _638) + mem[64] + 260 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])] = mem[(32 * arg3.length) + (32 * arg4.length) + 192 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])]
            if not _793 % 32:
                require ext_code.size(arg2)
                call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                     gas gas_remaining wei
                    args msg.sender, address(arg1), 160, mem[mem[64] + 100], (32 * _721) + (32 * _638) + 224, mem[mem[64] + 164 len _793 + (32 * _721) + (32 * _638) + 96]
            else:
                mem[floor32(_793) + (32 * _721) + (32 * _638) + mem[64] + 260] = mem[floor32(_793) + (32 * _721) + (32 * _638) + mem[64] + -(_793 % 32) + 292 len _793 % 32]
                require ext_code.size(arg2)
                call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                     gas gas_remaining wei
                    args msg.sender, address(arg1), 160, mem[mem[64] + 100], (32 * _721) + (32 * _638) + 224, mem[mem[64] + 164 len floor32(_793) + (32 * _721) + (32 * _638) + 128]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
        ...
        if stor12 == msg.sender:
            ...
            if stor13 == msg.sender:
                ...
                if ext_code.size(arg2):
                    ...
                    mem[(32 * _647) + mem[64] + 228 len floor32(mem[(32 * arg3.length) + 128])] = mem[(32 * arg3.length) + 160 len floor32(mem[(32 * arg3.length) + 128])]
                    mem[mem[64] + 132] = (32 * _730) + (32 * _647) + 224
                    mem[(32 * _730) + (32 * _647) + mem[64] + 228] = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
                    _802 = mem[(32 * arg3.length) + (32 * arg4.length) + 160]
                    mem[(32 * _730) + (32 * _647) + mem[64] + 260 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])] = mem[(32 * arg3.length) + (32 * arg4.length) + 192 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])]
                    if not _802 % 32:
                        require ext_code.size(arg2)
                        call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                             gas gas_remaining wei
                            args msg.sender, address(arg1), 160, mem[mem[64] + 100], (32 * _730) + (32 * _647) + 224, mem[mem[64] + 164 len _802 + (32 * _730) + (32 * _647) + 96]
                    else:
                        mem[floor32(_802) + (32 * _730) + (32 * _647) + mem[64] + 260] = mem[floor32(_802) + (32 * _730) + (32 * _647) + mem[64] + -(_802 % 32) + 292 len _802 % 32]
                        require ext_code.size(arg2)
                        call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                             gas gas_remaining wei
                            args msg.sender, address(arg1), 160, mem[mem[64] + 100], (32 * _730) + (32 * _647) + 224, mem[mem[64] + 164 len floor32(_802) + (32 * _730) + (32 * _647) + 128]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
                ...
                if ext_code.size(arg2):
                    ...
                    mem[(32 * _727) + (32 * _644) + mem[64] + 260 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])] = mem[(32 * arg3.length) + (32 * arg4.length) + 192 len ceil32(mem[(32 * arg3.length) + (32 * arg4.length) + 160])]
                    if not _799 % 32:
                        require ext_code.size(arg2)
                        call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                             gas gas_remaining wei
                            args msg.sender, address(arg1), 160, mem[mem[64] + 100 len _799 + (32 * _727) + (32 * _644) + 160]
                    else:
                        mem[floor32(_799) + (32 * _727) + (32 * _644) + mem[64] + 260] = mem[floor32(_799) + (32 * _727) + (32 * _644) + mem[64] + -(_799 % 32) + 292 len _799 % 32]
                        require ext_code.size(arg2)
                        call arg2.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                             gas gas_remaining wei
                            args msg.sender, address(arg1), 160, mem[mem[64] + 100 len floor32(_799) + (32 * _727) + (32 * _644) + 192]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
