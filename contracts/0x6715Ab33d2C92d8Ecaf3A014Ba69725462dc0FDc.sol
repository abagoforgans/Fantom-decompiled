...
function sortTokens(address arg1, address arg2) payable {
    ...
    if not _292 % 32:
        ...
        return address(arg2), 
               Array(len=mem[ceil32(return_data.size) + 96], data=mem[_292 + floor32(_20) + (2 * ceil32(return_data.size)) + 416 len floor32(mem[floor32(_20) + (2 * ceil32(return_data.size)) + 160]) + mem[ceil32(return_data.size) + 96] + 64]),
               ext_call.return_data[0] << 248,
               address(arg1),
               mem[ceil32(return_data.size) + 96] + 224,
               ext_call.return_data[0] << 248
    ...
    return address(arg2), 
           Array(len=mem[ceil32(return_data.size) + 96], data=mem[floor32(_292) + floor32(_20) + (2 * ceil32(return_data.size)) + 448 len floor32(mem[floor32(_20) + (2 * ceil32(return_data.size)) + 160]) + mem[ceil32(return_data.size) + 96] + 64]),
           ext_call.return_data[0] << 248,
           address(arg1),
           mem[ceil32(return_data.size) + 96] + 224,
           ext_call.return_data[0] << 248
