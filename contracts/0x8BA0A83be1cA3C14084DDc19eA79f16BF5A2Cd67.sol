...
function isExcludedFromStaking(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return not not stor12[address(arg1)]
}

function AddressResetBuyLock() {
    if block.timestamp > -buyLockTime - 1:
        revert with 'NH{q', 17
    stor4[address(msg.sender)] = block.timestamp + buyLockTime
}
...
function getDividents(address arg1) {
    ...
    if profitPerShare * balanceOf[address(arg1)] < stor25[address(arg1)]:
        if 0 > -stor26[address(arg1)] - 1:
            revert with 'NH{q', 17
        return stor26[address(arg1)]
    if profitPerShare * balanceOf[address(arg1)] < stor25[address(arg1)]:
        revert with 'NH{q', 17
    if Mask(192, 64, (profitPerShare * balanceOf[address(arg1)]) - stor25[address(arg1)]) >> 64 > -stor26[address(arg1)] - 1:
        revert with 'NH{q', 17
...
function TeamSetTaxes(uint8 arg1, uint8 arg2, uint8 arg3, uint8 arg4, uint8 arg5, uint8 arg6) {
    ...
    uint8(stor18.field_24) = arg1
    uint8(stor18.field_32) = arg2
...
function BTCWithdraw() {
    ...
    if stor12[address(msg.sender)]:
        ...
        if stor26[address(msg.sender)]:
            if totalPayouts > -stor26[address(msg.sender)] - 1:
                revert with 'NH{q', 17
        ...
        if profitPerShare * balanceOf[address(msg.sender)] < stor25[address(msg.sender)]:
            ...
            if profitPerShare and balanceOf[address(msg.sender)] > -1 / profitPerShare:
                revert with 'NH{q', 17
            stor25[address(msg.sender)] = profitPerShare * balanceOf[address(msg.sender)]
            if stor26[address(msg.sender)] > -(Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor25[address(msg.sender)]) >> 64) - 1:
                revert with 'NH{q', 17
            stor26[address(msg.sender)] = 0
            if stor26[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor25[address(msg.sender)]) >> 64):
                if totalPayouts > -stor26[address(msg.sender)] + -(Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor25[address(msg.sender)]) >> 64) - 1:
                    revert with 'NH{q', 17
...
function sub_03fed058(?) {
    ...
    if uint8(stor18.field_32) > -uint8(stor18.field_40) + 255:
        revert with 'NH{q', 17
    if balanceOf[address(this.address)] >= sellLimit:
        if uint8(uint8(stor18.field_32) + uint8(stor18.field_40)):
            if sellLimit and uint8(stor18.field_32) > -1 / sellLimit:
                revert with 'NH{q', 17
            if not uint8(uint8(stor18.field_32) + uint8(stor18.field_40)):
                revert with 'NH{q', 18
            if sellLimit < sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)):
                revert with 'NH{q', 17
            if sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) < sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2:
                revert with 'NH{q', 17
            if -sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2 > -sellLimit - 1:
                revert with 'NH{q', 17
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor19.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor19.field_0)].field_0 = -(sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2) + sellLimit
            emit Approval((-(sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2) + sellLimit), this.address, address(stor19.field_0));
            ...
            mem[ceil32(return_data.size) + 196] = -(sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2) + sellLimit
            idx = 0
            s = 128
            ...
            call address(stor19.field_0).swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args -(sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2) + sellLimit, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if eth.balance(this.address) < eth.balance(this.address):
                revert with 'NH{q', 17
            if False and (sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40))) - (sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2) > 0:
                revert with 'NH{q', 17
            if not -(sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2) + sellLimit:
                revert with 'NH{q', 18
            if sub_f2b5b268 > -(0 / -(sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2) + sellLimit) - 1:
                revert with 'NH{q', 17
            sub_f2b5b268 += 0 / -(sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2) + sellLimit
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor19.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor19.field_0)].field_0 = sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2
            allowance[address(this.address)][address(stor19.field_0)].field_255 = 0
            emit Approval((sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2), this.address, address(stor19.field_0));
            require ext_code.size(address(stor19.field_0))
            call address(stor19.field_0).addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
               value 0 / -(sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40)) / 2) + sellLimit wei
                 gas gas_remaining wei
                args address(this.address), Mask(255, 1, sellLimit * uint8(stor18.field_32) / uint8(uint8(stor18.field_32) + uint8(stor18.field_40))), 0, 0, address(this.address), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
