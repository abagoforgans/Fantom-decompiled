...
function publicMint(uint256 arg1) payable {
    ...
    if sub_7943b75e > !arg1:
        revert with 0, 17
    if sub_7943b75e + arg1 >= sub_78c5939b:
        revert with 0, 'Can not mint that many'
    idx = 0
    while idx < arg1:
        _47 = mem[64]
