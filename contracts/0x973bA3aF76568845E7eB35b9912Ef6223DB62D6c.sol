...
function addOwner(address arg1, uint256 arg2) payable {
    ...
    if not stor3[msg.sender]:
        revert with 0, 'MultiSig: not owner'
    if stor7[msg.sender][('map', ('param', 'arg1'), ('param', 'arg2'))]:
    ...
    stor7[msg.sender][('map', ('param', 'arg1'), ('param', 'arg2'))] = 1
    ...
    if sub_9979ea89[arg1][arg2] >= threshold:
        ...
        while idx < owners.length:
            ...
            mem[32] = sha3(owners[idx], 7)
            stor7[stor2[idx]][('map', ('param', 'arg1'), ('param', 'arg2'))] = 0
            idx = idx + 1
            continue 
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if stor6[msg.sender][('map', ('param', 'arg1'), ('param', 'arg2'))]:
        revert with 0, 32, 34, 0x644d756c74695369673a20796f7527766520616c7265616479207369676e65642069, mem[282 len 30]
    sub_1eb515f3[arg1][arg2]++
    stor6[msg.sender][('map', ('param', 'arg1'), ('param', 'arg2'))] = 1
    ...
    if sub_1eb515f3[arg1][arg2] >= threshold:
        ...
        while idx < owners.length:
            mem[0] = sha3(arg1, arg2)
            mem[32] = sha3(owners[idx], 6)
            stor6[stor2[idx]][('map', ('param', 'arg1'), ('param', 'arg2'))] = 0
            idx = idx + 1
            continue 
        return 0
    else:
