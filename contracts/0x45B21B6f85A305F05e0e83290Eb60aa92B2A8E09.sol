...
function getHash(uint256 arg1) payable {
    ...
    if bool(stor3[arg1].field_0):
        if bool(stor3[arg1].field_0) == uint255(stor3[arg1].field_0) * 0.5 < 32:
            revert with 0, 34
        if bool(stor3[arg1].field_0):
            if bool(stor3[arg1].field_0) == uint255(stor3[arg1].field_0) * 0.5 < 32:
                revert with 0, 34
            if Mask(256, -1, stor3[arg1].field_0):
                if 31 < uint255(stor3[arg1].field_0) * 0.5:
                    ...
                    while ceil32(return_data.size) + (uint255(stor3[arg1].field_0) * 0.5) + 96 > idx:
                        ...
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, stor3[arg1].field_0), data=mem[ceil32(return_data.size) + 128 len ceil32(uint255(stor3[arg1].field_0) * 0.5)]), 
            ...
            if stor3[arg1].field_1 % 128:
                if 31 < stor3[arg1].field_1 % 128:
                    ...
                    return Array(len=2 * Mask(256, -1, stor3[arg1].field_0), data=mem[ceil32(return_data.size) + 128 len ceil32(uint255(stor3[arg1].field_0) * 0.5)]), 
                mem[ceil32(return_data.size) + 128] = 256 * Mask(248, 0, stor3[arg1].field_8)
        mem[ceil32(return_data.size) + ceil32(uint255(stor3[arg1].field_0) * 0.5) + 192 len ceil32(uint255(stor3[arg1].field_0) * 0.5)] = mem[ceil32(return_data.size) + 128 len ceil32(uint255(stor3[arg1].field_0) * 0.5)]
        if ceil32(uint255(stor3[arg1].field_0) * 0.5) > uint255(stor3[arg1].field_0) * 0.5:
            mem[ceil32(return_data.size) + ceil32(uint255(stor3[arg1].field_0) * 0.5) + (uint255(stor3[arg1].field_0) * 0.5) + 192] = 0
        return Array(len=2 * Mask(256, -1, stor3[arg1].field_0), data=mem[ceil32(return_data.size) + 128 len ceil32(uint255(stor3[arg1].field_0) * 0.5)], mem[ceil32(return_data.size) + (2 * ceil32(uint255(stor3[arg1].field_0) * 0.5)) + 192 len 2 * ceil32(uint255(stor3[arg1].field_0) * 0.5)]), 
    if bool(stor3[arg1].field_0) == stor3[arg1].field_1 % 128 < 32:
        revert with 0, 34
    if bool(stor3[arg1].field_0):
        if bool(stor3[arg1].field_0) == uint255(stor3[arg1].field_0) * 0.5 < 32:
...
function sub_08129e0b(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[_27] = cd[(cd[4] + cd[s] + 36)]
        require cd[4] + cd[s] + cd[(cd[4] + cd[s] + 36)] + 68 <= calldata.size
        mem[_27 + 32 len cd[(cd[4] + cd[s] + 36)]] = call.data[cd[4] + cd[s] + 68 len cd[(cd[4] + cd[s] + 36)]]
        mem[_27 + cd[(cd[4] + cd[s] + 36)] + 32] = 0
        mem[t] = _27
        s = s + 32
        t = t + 32
        idx = idx + 1
    ...
    if msg.sender == stor0:
        ...
        while idx < mem[96]:
            ...
            if bool(stor3[stor2].field_0):
                if bool(stor3[stor2].field_0) == uint255(stor3[stor2].field_0) * 0.5 < 32:
                    revert with 0, 34
                mem[0] = sha3(stor2, 3)
                if not _59:
                    stor3[stor2].field_0 = 0
                    s = sha3(sha3(stor2, 3))
                    while sha3(sha3(stor2, 3)) + ((uint255(stor3[stor2].field_0) * 0.5) + 31 / 32) > s:
                        stor[s] = 0
                        s = s + 1
                        continue 
                else:
            ...
            while sha3(sha3(stor2, 3)) + (stor3[stor2].field_1 % 128 + 31 / 32) > s:
                ...
                s = s + 1
                continue 
            if sha3(sha3(stor2, 3)) + (stor3[stor2].field_1 % 128 + 31 / 32) == -1:
                revert with 0, 17
            s = sha3(sha3(stor2, 3)) + (stor3[stor2].field_1 % 128 + 31 / 32) + 1
            continue 
    else:
        if stor1 != msg.sender:
            revert with 0, 'Ownable: caller is not the owner'
