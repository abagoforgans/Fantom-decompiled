...
function sub_e1c727a2(?) payable {
    ...
    require ext_call.return_data[64] == ext_call.return_data[92 len 4]
    require ext_code.size(tokenAAddress)
    staticcall tokenAAddress.decimals() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    require ext_code.size(tokenBAddress)
    staticcall tokenBAddress.decimals() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_call.return_data[12 len 20] != tokenAAddress:
        if not Mask(112, 0, ext_call.return_data[32]):
            ...
            if not 0 / Mask(112, 0, ext_call.return_data[0]):
                ...
                if 10^uint8(ext_call.return_data[0]) * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[0]) != 10^uint8(ext_call.return_data[0]):
                    revert with 0, 'SafeMath: multiplication overflow'
                if not Mask(112, 0, ext_call.return_data[32]):
                    revert with 0, 'SafeMath: division by zero', 0
