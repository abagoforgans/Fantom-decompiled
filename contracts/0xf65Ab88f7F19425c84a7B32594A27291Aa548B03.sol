...
const NATIVE = 0x34a142846dd1ac3264314cd178ac309c96d248c2
...
function getMultiplier(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0x34a142846dd1ac3264314cd178ac309c96d248c2)
    staticcall 0x34a142846dd1ac3264314cd178ac309c96d248c2.0x18160ddd with:
...
function inCaseTokensGetStuck(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 == 0x34a142846dd1ac3264314cd178ac309c96d248c2:
        revert with 0, '!safe'
                ...
                if block.number - poolInfo[arg1].field_512 > 0:
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not 0 / totalAllocPoint:
                            require ext_code.size(0x34a142846dd1ac3264314cd178ac309c96d248c2)
                            call 0x34a142846dd1ac3264314cd178ac309c96d248c2.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 0
                        else:
