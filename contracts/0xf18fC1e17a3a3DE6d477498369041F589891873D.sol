...
function totalUsersForOption(uint256 arg1, uint256 arg2) payable {
    ...
    while idx < users.length:
        ...
        if totalRoundOptions[arg1][2][arg2][1][stor6[idx]].field_0 <= 0:
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            s = s
...
function totalUsersInRound(uint256 arg1) payable {
    ...
    while idx < users.length:
        ...
        while s < totalRoundOptions[arg1].field_256:
            if t > -totalRoundOptions[arg1][2][s][1][stor6[idx]].field_0 - 1:
                revert with 'NH{q', 17
            if s == -1:
                revert with 'NH{q', 17
            mem[0] = arg1
            mem[32] = 4
            s = s + 1
            t = t + totalRoundOptions[arg1][2][s][1][stor6[idx]].field_0
            continue 
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
...
function votesForOption(uint256 arg1, uint256 arg2) payable {
    ...
    while idx < users.length:
        ...
        continue 
    return (s * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length)
}
...
function votesInRound(uint256 arg1) payable {
    ...
    while idx < totalRoundOptions[arg1].field_256:
        ...
        while s < users.length:
            ...
            continue 
        if 0 > (-1 * t * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length * users.length) - 1:
            revert with 'NH{q', 17
        if idx == -1:
            revert with 'NH{q', 17
        mem[0] = arg1
...
function checkVoteBalances(uint256 arg1) payable {
    ...
    while idx < activeRounds.length:
        ...
        staticcall balanceKeeperAddress.balance(uint256 arg1) with:
    ...
    while idx < activeRounds.length:
        ...
        if not stor5[cd[4]]:
            if s * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length * ('cd', 68).length > 0:
                users.length++
                users[users.length] = cd[4]
                stor5[cd[4]] = 1
        mem[floor32(('cd', 68).length) + ceil32(return_data.size) + 97] = 32
        mem[floor32(('cd', 68).length) + ceil32(return_data.size) + 129] = ('cd', 68).length
        idx = 0
        s = 128
        t = mem[64] + 64
        while idx < ('cd', 68).length:
            ...
            t = t + 32
            continue 
        emit CastVotes(mem[mem[64] len floor32(('cd', 68).length) + ceil32(return_data.size) + (32 * ('cd', 68).length) + -mem[64] + 161], msg.sender, cd[36], cd[4]);
    revert with 0, 'V3'
}
...
function sub_44083843(?) payable {
    ...
    while idx < ('cd', 36).length:
        ...
        t = t + 32
        continue 
    mem[floor32(('cd', 36).length) + 129] = address(msg.sender)
    mem[floor32(('cd', 36).length) + 149] = 0x3ed084c400000000000000000000000000000000000000000000000000000000
    mem[floor32(('cd', 36).length) + 153] = 64
    mem[floor32(('cd', 36).length) + 217] = 3
    mem[floor32(('cd', 36).length) + 249] = 'EVM'
    mem[floor32(('cd', 36).length) + 185] = 128
    mem[floor32(('cd', 36).length) + 281] = mem[floor32(('cd', 36).length) + 97]
    mem[floor32(('cd', 36).length) + 313 len ceil32(mem[floor32(('cd', 36).length) + 97])] = mem[floor32(('cd', 36).length) + 129 len ceil32(mem[floor32(('cd', 36).length) + 97])]
    if ceil32(mem[floor32(('cd', 36).length) + 97]) > mem[floor32(('cd', 36).length) + 97]:
        mem[floor32(('cd', 36).length) + mem[floor32(('cd', 36).length) + 97] + 313] = 0
    require ext_code.size(balanceKeeperAddress)
    staticcall balanceKeeperAddress.0x3ed084c4 with:
            gas gas_remaining wei
           args 64, 128, 3, 'EVM', mem[floor32(('cd', 36).length) + 97], mem[floor32(('cd', 36).length) + 313 len ceil32(mem[floor32(('cd', 36).length) + 97])]
    mem[floor32(('cd', 36).length) + 149] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[64] = floor32(('cd', 36).length) + ceil32(return_data.size) + 149
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    idx = 0
    while idx < activeRounds.length:
        ...
        while idx < ('cd', 36).length:
            ...
            s = s + mem[(32 * idx) + 128]
            continue 
        mem[floor32(('cd', 36).length) + ceil32(return_data.size) + 153] = ext_call.return_data[0]
        require ext_code.size(balanceKeeperAddress)
        staticcall balanceKeeperAddress.balance(uint256 arg1) with:
                gas gas_remaining wei
               args ext_call.return_data[0]
        mem[floor32(('cd', 36).length) + ceil32(return_data.size) + 149] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        ...
        if not stor5[ext_call.return_data[0]]:
            if s * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length * ('cd', 36).length > 0:
                users.length++
                users[users.length] = ext_call.return_data[0]
                stor5[ext_call.return_data[0]] = 1
        mem[floor32(('cd', 36).length) + (2 * ceil32(return_data.size)) + 149] = 32
        mem[floor32(('cd', 36).length) + (2 * ceil32(return_data.size)) + 181] = ('cd', 36).length
        idx = 0
        s = 128
        t = floor32(('cd', 36).length) + (2 * ceil32(return_data.size)) + 213
        while idx < ('cd', 36).length:
            mem[t] = mem[s]
            idx = idx + 1
            s = s + 32
            t = t + 32
            continue 
        emit CastVotes(Array(len=('cd', 36).length, data=mem[floor32(('cd', 36).length) + (2 * ceil32(return_data.size)) + 213 len 32 * ('cd', 36).length]), msg.sender, cd[4], ext_call.return_data[0]);
    revert with 0, 'V3'
}
...
function sub_ad77c86a(?) payable {
    ...
    while idx < ('cd', 36).length:
        ...
        mem[_291] = cd[(cd[36] + cd[s] + 36)]
        require cd[36] + cd[s] + cd[(cd[36] + cd[s] + 36)] + 68 <= calldata.size
        mem[_291 + 32 len cd[(cd[36] + cd[s] + 36)]] = call.data[cd[36] + cd[s] + 68 len cd[(cd[36] + cd[s] + 36)]]
        mem[_291 + cd[(cd[36] + cd[s] + 36)] + 32] = 0
        mem[t] = _291
        idx = idx + 1
        s = s + 32
        t = t + 32
    ...
    if bool(totalRoundOptions[stor7].field_0):
        ...
        if mem[96]:
            ...
            while idx < mem[ceil32(ceil32(('cd', 4).length)) + 97]:
                ...
                _1142 = mem[mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129]]
                if bool(totalRoundOptions[stor7][2][idx].field_0):
                    ...
                    if not _1142:
                        ...
                        while mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129] + _1142 + 32 > t:
                            stor[s] = mem[t]
                            s = s + 1
                            t = t + 32
                            continue 
            ...
            var91001 = ceil32(_1219)
            if ceil32(_1219) <= _1219:
                mem[mem[64] + 64] = ceil32(_1219) + 128
                _1379 = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                mem[_1183 + ceil32(_1219) + 128] = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                idx = 0
                ...
                mem[mem[64] + 64] = ceil32(_1219) + 128
                _1381 = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                mem[_1183 + ceil32(_1219) + 128] = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                idx = 0
                s = ceil32(ceil32(('cd', 4).length)) + 129
            ...
            while idx < mem[ceil32(ceil32(('cd', 4).length)) + 97]:
                ...
                mem[0] = idx
                mem[32] = sha3(totalRounds, 4) + 2
                _872 = mem[mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129]]
                if bool(totalRoundOptions[stor7][2][idx].field_0):
                    if bool(totalRoundOptions[stor7][2][idx].field_0) == uint255(totalRoundOptions[stor7][2][idx].field_1) < 32:
                        revert with 'NH{q', 34
                    mem[0] = sha3(idx, sha3(totalRounds, 4) + 2)
                    if not _872:
                        ...
                        s = sha3(sha3(idx, sha3(totalRounds, 4) + 2))
                        t = mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129] + 32
                        while mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129] + _872 + 32 > t:
                            stor[s] = mem[t]
                            s = s + 1
                            t = t + 32
                            continue 
            ...
            mem[mem[64] + 96] = mem[96]
            mem[mem[64] + 128 len ceil32(mem[96])] = mem[128 len ceil32(mem[96])]
            var86001 = ceil32(_946)
            if ceil32(_946) <= _946:
                mem[mem[64] + 64] = ceil32(_946) + 128
                _1202 = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                mem[_897 + ceil32(_946) + 128] = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                idx = 0
                s = ceil32(ceil32(('cd', 4).length)) + 129
                ...
                mem[mem[64] + 64] = ceil32(_946) + 128
                _1210 = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                mem[_897 + ceil32(_946) + 128] = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                idx = 0
                s = ceil32(ceil32(('cd', 4).length)) + 129
        ...
        if mem[96]:
            ...
            while idx < mem[ceil32(ceil32(('cd', 4).length)) + 97]:
                ...
                mem[0] = idx
                mem[32] = sha3(totalRounds, 4) + 2
                _1146 = mem[mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129]]
                if bool(totalRoundOptions[stor7][2][idx].field_0):
                    if bool(totalRoundOptions[stor7][2][idx].field_0) == uint255(totalRoundOptions[stor7][2][idx].field_1) < 32:
                        revert with 'NH{q', 34
                    mem[0] = sha3(idx, sha3(totalRounds, 4) + 2)
                    if not _1146:
                        ...
                        s = sha3(sha3(idx, sha3(totalRounds, 4) + 2))
                        t = mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129] + 32
                        while mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129] + _1146 + 32 > t:
                            stor[s] = mem[t]
                            s = s + 1
                            t = t + 32
                            continue 
            ...
            mem[mem[64] + 96] = mem[96]
            mem[mem[64] + 128 len ceil32(mem[96])] = mem[128 len ceil32(mem[96])]
            var92001 = ceil32(_1221)
            if ceil32(_1221) <= _1221:
                mem[mem[64] + 64] = ceil32(_1221) + 128
                _1380 = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                mem[_1184 + ceil32(_1221) + 128] = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                idx = 0
                s = ceil32(ceil32(('cd', 4).length)) + 129
                ...
                mem[mem[64] + 64] = ceil32(_1221) + 128
                _1382 = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                mem[_1184 + ceil32(_1221) + 128] = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                idx = 0
                s = ceil32(ceil32(('cd', 4).length)) + 129
            ...
            while idx < mem[ceil32(ceil32(('cd', 4).length)) + 97]:
                ...
                mem[0] = idx
                mem[32] = sha3(totalRounds, 4) + 2
                _884 = mem[mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129]]
                if bool(totalRoundOptions[stor7][2][idx].field_0):
                    if bool(totalRoundOptions[stor7][2][idx].field_0) == uint255(totalRoundOptions[stor7][2][idx].field_1) < 32:
                        revert with 'NH{q', 34
                    mem[0] = sha3(idx, sha3(totalRounds, 4) + 2)
                    if not _884:
                        ...
                        s = sha3(sha3(idx, sha3(totalRounds, 4) + 2))
                        t = mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129] + 32
                        while mem[(32 * idx) + ceil32(ceil32(('cd', 4).length)) + 129] + _884 + 32 > t:
                            stor[s] = mem[t]
                            s = s + 1
                            t = t + 32
                            continue 
            ...
            mem[mem[64] + 96] = mem[96]
            mem[mem[64] + 128 len ceil32(mem[96])] = mem[128 len ceil32(mem[96])]
            var87001 = ceil32(_953)
            if ceil32(_953) <= _953:
                mem[mem[64] + 64] = ceil32(_953) + 128
                _1206 = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                mem[_904 + ceil32(_953) + 128] = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                idx = 0
                s = ceil32(ceil32(('cd', 4).length)) + 129
                ...
                mem[mem[64] + 64] = ceil32(_953) + 128
                _1214 = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                mem[_904 + ceil32(_953) + 128] = mem[ceil32(ceil32(('cd', 4).length)) + 97]
                idx = 0
                s = ceil32(ceil32(('cd', 4).length)) + 129
