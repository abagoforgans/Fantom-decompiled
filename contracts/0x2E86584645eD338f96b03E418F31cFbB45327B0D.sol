...
function taxRate() {
    ...
    staticcall address(tombAddress).0x771a3a1d with:
...
function taxFreeTransferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
    call address(tombAddress).transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
...
function sub_73baccc0(?) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(tombAddress))
    staticcall address(tombAddress).allowance(address arg1, address arg2) with:
            gas gas_remaining wei
...
function sub_f1efacf9(?) {
    ...
    call uniRouterAddress.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
         gas gas_remaining wei
        args 0, uint32(stor2), wftmAddress, arg2, arg3, arg4, arg5, msg.sender, block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    require ext_code.size(address(tombAddress))
...
function sub_05a9b7f0(?) {
    ...
    require return_data.size >= 32
    require ext_code.size(wftmAddress)
    call wftmAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
        args msg.sender, this.address, arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
