...
function deposit(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if balanceOf[arg1] > !msg.value:
        revert with 0, 17
    balanceOf[arg1] += msg.value
    emit Transfer(msg.value, 1337, arg1);
}

function approve(uint256 arg1, uint256 arg2, uint256 arg3) {
    require calldata.size - 4 >= 96
    require ext_code.size(0x3194cbdc3dbcd3e11a07892e7ba5c3394048cc87)
    staticcall 0x3194cbdc3dbcd3e11a07892e7ba5c3394048cc87.getApproved(uint256 arg1) with:
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        require ext_code.size(0x3194cbdc3dbcd3e11a07892e7ba5c3394048cc87)
        staticcall 0x3194cbdc3dbcd3e11a07892e7ba5c3394048cc87.ownerOf(uint256 arg1) with:
                gas gas_remaining wei
               args arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
