                        ...
                        if rewardTokenAddress != 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83:
                            ...
                            if not return_data.size:
                                ...
                                if not arg1:
                                    ...
                                    if not ext_code.size(address(poolInfo.field_0)):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[452 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
                                    mem[576 len 4] = 0
                                    call address(poolInfo.field_0) with:
                                         gas gas_remaining wei
                                        args arg1, mem[388 len 60], mem[548 len 4]
                                    if not return_data.size:
                                        require not ext_call.success
                                        revert with 'SafeMath: division by zero'
                                ...
                                if not arg1:
                                    ...
                                    if not ext_code.size(address(poolInfo.field_0)):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[ceil32(return_data.size) + 453 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
                                    mem[ceil32(return_data.size) + 577 len 4] = 0
                                    call address(poolInfo.field_0) with:
                                         gas gas_remaining wei
                                        args arg1, mem[ceil32(return_data.size) + 389 len 60], mem[ceil32(return_data.size) + 549 len 4]
                                    if not return_data.size:
                                        require not ext_call.success
                                        revert with 'SafeMath: division by zero'
                                    ...
                                    if rewardTokenAddress != 0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83:
                                        ...
                                        if not return_data.size:
                                            ...
                                            if not arg1:
                                                ...
                                                if not ext_code.size(address(poolInfo.field_0)):
                                                    revert with 0, 'Address: call to non-contract'
                                                mem[708 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
                                                mem[832 len 4] = 0
                                                call address(poolInfo.field_0) with:
                                                     gas gas_remaining wei
                                                    args arg1, mem[644 len 60], mem[804 len 4]
                                                if not return_data.size:
                                                    require not ext_call.success
                                                    revert with 'SafeMath: subtraction overflow'
                                            ...
                                            if not arg1:
                                                ...
                                                if not ext_code.size(address(poolInfo.field_0)):
                                                    revert with 0, 'Address: call to non-contract'
                                                mem[ceil32(return_data.size) + 709 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
                                                mem[ceil32(return_data.size) + 833 len 4] = 0
                                                call address(poolInfo.field_0) with:
                                                     gas gas_remaining wei
                                                    args arg1, mem[ceil32(return_data.size) + 645 len 60], mem[ceil32(return_data.size) + 805 len 4]
                                                if not return_data.size:
                                                    require not ext_call.success
                                                    revert with 'SafeMath: subtraction overflow'
