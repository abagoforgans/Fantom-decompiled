    ...
    if not return_data.size:
        ...
        if not totalSupply:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.hash(tokenAddress):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[456 len 64] = 0, address(controllerAddress), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                call tokenAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
                    args ext_call.return_data[0] * min / 10000, Mask(224, 32, address(controllerAddress), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32) >> 32, mem[520 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.hash(tokenAddress):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[520 len 64] = 0, address(controllerAddress), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                call tokenAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
                    args ext_call.return_data[0] * min / 10000, Mask(224, 32, address(controllerAddress), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32) >> 32, mem[584 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if not totalSupply:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.hash(tokenAddress):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[ceil32(return_data.size) + 457 len 64] = 0, address(controllerAddress), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                call tokenAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
                    args ext_call.return_data[0] * min / 10000, Mask(224, 32, address(controllerAddress), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32) >> 32, mem[ceil32(return_data.size) + 521 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.hash(tokenAddress):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[ceil32(return_data.size) + 521 len 64] = 0, address(controllerAddress), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                call tokenAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
                    args ext_call.return_data[0] * min / 10000, Mask(224, 32, address(controllerAddress), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32) >> 32, mem[ceil32(return_data.size) + 585 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
    ...
    if not return_data.size:
        ...
        if not totalSupply:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.hash(tokenAddress):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[456 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                call tokenAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
                    args Mask(224, 32, ext_call.return_data[0] * min / 10000) << 224, mem[520 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.hash(tokenAddress):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[520 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                call tokenAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
                    args Mask(224, 32, ext_call.return_data[0] * min / 10000) << 224, mem[584 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if return_data.size <= 0:
            ...
            if not totalSupply:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.hash(tokenAddress):
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[ceil32(return_data.size) + 457 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                    mem[ceil32(return_data.size) + 549 len 4] = Mask(32, 64, ext_call.return_data[0] * min / 10000) >> 64
                    call tokenAddress with:
                       funct uint32(stor8)
                         gas gas_remaining wei
                        args Mask(224, 32, ext_call.return_data[0] * min / 10000) << 224, mem[ceil32(return_data.size) + 521 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, 'SafeERC20: low-level call failed'
                        if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                        ...
                        call address(controllerAddress).earn(address arg1, uint256 arg2) with:
                             gas gas_remaining wei
                            args stor5, ext_call.return_data[0] * min / 10000, mem[(2 * ceil32(return_data.size)) + 526 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            else:
                if 2 * ext_call.return_data[0] <= 0:
                    revert with 0, 'SafeMath: division by zero'
                require 2 * ext_call.return_data[0]
                ...
                if not ext_call.return_data[0]:
                    ...
                    call tokenAddress with:
                       funct uint32(stor8)
                         gas gas_remaining wei
                        args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), 0) << 256, mem[ceil32(return_data.size) + 585 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, 'SafeERC20: low-level call failed'
                        if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                    ...
                    if not ext_code.hash(tokenAddress):
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[ceil32(return_data.size) + 521 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                    mem[ceil32(return_data.size) + 613 len 4] = Mask(32, 64, ext_call.return_data[0] * min / 10000) >> 64
                    call tokenAddress with:
                       funct uint32(stor8)
                         gas gas_remaining wei
                        args Mask(224, 32, ext_call.return_data[0] * min / 10000) << 224, mem[ceil32(return_data.size) + 585 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, 'SafeERC20: low-level call failed'
                        if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                        ...
                        call address(controllerAddress).earn(address arg1, uint256 arg2) with:
                             gas gas_remaining wei
                            args stor5, ext_call.return_data[0] * min / 10000, mem[(2 * ceil32(return_data.size)) + 590 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        else:
            require return_data.size >= 32
            if not mem[260]:
                revert with 0, 
            ...
            if not totalSupply:
                ...
                if not ext_call.return_data[0]:
                    ...
                    call tokenAddress with:
                       funct uint32(stor8)
                         gas gas_remaining wei
                        args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), 0) << 256, mem[ceil32(return_data.size) + 521 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, 'SafeERC20: low-level call failed'
                        if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
