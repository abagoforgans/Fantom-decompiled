...
function transfer(address arg1, uint256 arg2) {
    ...
    if not arg2:
        ...
        require 1 < mem[ceil32(return_data.size) + 192]
        _333 = mem[ceil32(return_data.size) + 256]
        if not mem[ceil32(return_data.size) + 256]:
            if slippage <= 0:
                revert with 0, ':divErr'
            require slippage
            if 0 / slippage:
                mem[(32 * _189) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                emit Log(mem[(32 * _189) + ceil32(return_data.size) + 224], 0 / slippage);
                require ext_code.size(uniswapRouterAddress)
                staticcall uniswapRouterAddress.WETH() with:
                        gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(32 * _189) + ceil32(return_data.size) + 516 len 0] = None
                require ext_code.size(uniswapRouterAddress)
                call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args 0, 0 / slippage, 160, address(this.address), block.timestamp, 2, mem[(32 * _189) + ceil32(return_data.size) + 516 len 64]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        else:
            if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                revert with 0, 
                            ...
                            mem[(32 * _189) + ceil32(return_data.size) + 325 len 31]
            if slippage <= 0:
                revert with 0, ':divErr'
            require slippage
            if 100 * mem[ceil32(return_data.size) + 256] / slippage:
                mem[(32 * _189) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                emit Log(mem[(32 * _189) + ceil32(return_data.size) + 224], 100 * _333 / slippage);
                require ext_code.size(uniswapRouterAddress)
                staticcall uniswapRouterAddress.WETH() with:
                        gas gas_remaining wei
                if not ext_call.success:
                ...
                call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args 0, 100 * _333 / slippage, 160, address(this.address), block.timestamp, 2, mem[(32 * _189) + ceil32(return_data.size) + 516 len 64]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        require arg2 <= balanceOf[msg.sender]
        ...
        mem[64] = ceil32(return_data.size) + 192
        require return_data.size >= 32
        _182 = mem[192 len 4], Mask(224, 32, 25 * arg2 / 100) >> 32
        ...
        require 1 < mem[ceil32(return_data.size) + 192]
        _332 = mem[ceil32(return_data.size) + 256]
        if not mem[ceil32(return_data.size) + 256]:
            if slippage <= 0:
                revert with 0, ':divErr'
            require slippage
            if 0 / slippage:
                mem[(32 * _188) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                emit Log(mem[(32 * _188) + ceil32(return_data.size) + 224], 0 / slippage);
                require ext_code.size(uniswapRouterAddress)
                staticcall uniswapRouterAddress.WETH() with:
                        gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(32 * _188) + ceil32(return_data.size) + 516 len 0] = None
                require ext_code.size(uniswapRouterAddress)
                call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args 25 * arg2 / 100, 0 / slippage, Array(len=2, data=mem[(32 * _188) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        else:
            if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                revert with 0, 
                            ...
                            33,
                            0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            mem[(32 * _188) + ceil32(return_data.size) + 325 len 31]
            if slippage <= 0:
                revert with 0, ':divErr'
            require slippage
            if 100 * mem[ceil32(return_data.size) + 256] / slippage:
                mem[(32 * _188) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                emit Log(mem[(32 * _188) + ceil32(return_data.size) + 224], 100 * _332 / slippage);
                require ext_code.size(uniswapRouterAddress)
                staticcall uniswapRouterAddress.WETH() with:
                        gas gas_remaining wei
                if not ext_call.success:
                ...
                call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args 25 * arg2 / 100, 100 * _332 / slippage, Array(len=2, data=mem[(32 * _188) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
    ...
    if not arg3:
        ...
        if arg1 != this.address:
            ...
            if arg1 != ext_call.return_data[12 len 20]:
                ...
                mem[64] = ceil32(return_data.size) + 192
                require return_data.size >= 32
                _274 = mem[192 len 4], 0
                require mem[192 len 4], 0 <= 4294967296
                require mem[192 len 4], 0 + 32 <= return_data.size
                require mem[mem[192 len 4], 0 + 192] <= 4294967296 and mem[192 len 4], 0 + (32 * mem[mem[192 len 4], 0 + 192]) + 32 <= return_data.size
                mem[ceil32(return_data.size) + 192] = mem[mem[192 len 4], 0 + 192]
                _279 = mem[_274 + 192]
                mem[ceil32(return_data.size) + 224 len floor32(mem[_274 + 192])] = mem[_274 + 224 len floor32(mem[_274 + 192])]
                require 1 < mem[ceil32(return_data.size) + 192]
                _455 = mem[ceil32(return_data.size) + 256]
                if not mem[ceil32(return_data.size) + 256]:
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    if 0 / slippage:
                        mem[(32 * _279) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                        emit Log(mem[(32 * _279) + ceil32(return_data.size) + 224], 0 / slippage);
                        require ext_code.size(uniswapRouterAddress)
                        staticcall uniswapRouterAddress.WETH() with:
                                gas gas_remaining wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        mem[(32 * _279) + ceil32(return_data.size) + 516 len 0] = None
                        require ext_code.size(uniswapRouterAddress)
                        call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args 0, 0 / slippage, 160, address(this.address), block.timestamp, 2, mem[(32 * _279) + ceil32(return_data.size) + 516 len 64]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                else:
                    if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                        revert with 0, 
                                    ...
                                    33,
                                    0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(32 * _279) + ceil32(return_data.size) + 325 len 31]
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    if 100 * mem[ceil32(return_data.size) + 256] / slippage:
                        mem[(32 * _279) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                        emit Log(mem[(32 * _279) + ceil32(return_data.size) + 224], 100 * _455 / slippage);
                        require ext_code.size(uniswapRouterAddress)
                        staticcall uniswapRouterAddress.WETH() with:
                                gas gas_remaining wei
                        if not ext_call.success:
                        ...
                        call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args 0, 100 * _455 / slippage, 160, address(this.address), block.timestamp, 2, mem[(32 * _279) + ceil32(return_data.size) + 516 len 64]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
        require arg3 <= balanceOf[address(arg1)]
        ...
        if arg1 != this.address:
            ...
            if arg1 != ext_call.return_data[12 len 20]:
                ...
                mem[64] = ceil32(return_data.size) + 192
                require return_data.size >= 32
                _272 = mem[192 len 4], Mask(224, 32, 25 * arg3 / 100) >> 32
                ...
                _278 = mem[_272 + 192]
                mem[ceil32(return_data.size) + 224 len floor32(mem[_272 + 192])] = mem[_272 + 224 len floor32(mem[_272 + 192])]
                require 1 < mem[ceil32(return_data.size) + 192]
                ...
                if not mem[ceil32(return_data.size) + 256]:
                    ...
                    require slippage
                    if 0 / slippage:
                        mem[(32 * _278) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                        emit Log(mem[(32 * _278) + ceil32(return_data.size) + 224], 0 / slippage);
                        require ext_code.size(uniswapRouterAddress)
                        staticcall uniswapRouterAddress.WETH() with:
                                gas gas_remaining wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        mem[(32 * _278) + ceil32(return_data.size) + 516 len 0] = None
                        require ext_code.size(uniswapRouterAddress)
                        call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args 25 * arg3 / 100, 0 / slippage, Array(len=2, data=mem[(32 * _278) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                else:
                    if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                        revert with 0, 
                                    ...
                                    33,
                                    0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(32 * _278) + ceil32(return_data.size) + 325 len 31]
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    if 100 * mem[ceil32(return_data.size) + 256] / slippage:
                        mem[(32 * _278) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                        emit Log(mem[(32 * _278) + ceil32(return_data.size) + 224], 100 * _454 / slippage);
                        require ext_code.size(uniswapRouterAddress)
                        staticcall uniswapRouterAddress.WETH() with:
                                gas gas_remaining wei
                        if not ext_call.success:
                        ...
                        call uniswapRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args 25 * arg3 / 100, 100 * _454 / slippage, Array(len=2, data=mem[(32 * _278) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
