...
function earn() payable {
                    ...
                    if ceil32(_622) <= _622:
                        ...
                        if return_data.size:
                            ...
                            if return_data.size <= 0:
                                ...
                                mem[_609 + ceil32(return_data.size) + ceil32(return_data.size) + 325] = _1471
                                ...
                                require _609 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_609 + ceil32(return_data.size) + mem[_609 + ceil32(return_data.size) + 325 len 4], Mask(224, 32, _562) >> 32 + 325]) + 357 <= test266151307() and (32 * mem[_609 + ceil32(return_data.size) + mem[_609 + ceil32(return_data.size) + 325 len 4], Mask(224, 32, _562) >> 32 + 325]) + 32 >= 0
                                mem[64] = _609 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_609 + ceil32(return_data.size) + mem[_609 + ceil32(return_data.size) + 325 len 4], Mask(224, 32, _562) >> 32 + 325]) + 357
                                mem[_609 + ceil32(return_data.size) + ceil32(return_data.size) + 325] = _1472
                            ...
                            if mem[96] <= 0:
                                ...
                                if not mem[(32 * _1469 - 1) + _1441 + ceil32(return_data.size) + 32]:
                                    ...
                                    mem[_1977 + 132] = block.timestamp + sub_1b61e055
                                    require ext_code.size(uniRouterAddress)
                                    call uniRouterAddress.mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len _1977 + (32 * _2017) + -mem[64] + 192]
                            else:
                                require mem[96] >= 32
                                ...
                                if not mem[(32 * _1470 - 1) + _1442 + ceil32(return_data.size) + 32]:
                                    ...
                                    mem[_1964 + 132] = block.timestamp + sub_1b61e055
                                    require ext_code.size(uniRouterAddress)
                                    call uniRouterAddress.mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len _1964 + (32 * _2008) + -mem[64] + 192]
                                else:
                                    ...
                                    mem[_1979 + 132] = block.timestamp + sub_1b61e055
                                    require ext_code.size(uniRouterAddress)
                                    call uniRouterAddress.mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len _1979 + (32 * _2018) + -mem[64] + 192]
                    else:
                        mem[_609 + _622 + 164] = 0
                        call address(_574).mem[_609 + 164 len 4] with:
                             gas gas_remaining wei
                        ...
                        if return_data.size:
                            ...
                            if return_data.size <= 0:
                                ...
                                require _609 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_609 + ceil32(return_data.size) + mem[_609 + ceil32(return_data.size) + 325 len 4], Mask(224, 32, _562) >> 32 + 325]) + 357 <= test266151307() and (32 * mem[_609 + ceil32(return_data.size) + mem[_609 + ceil32(return_data.size) + 325 len 4], Mask(224, 32, _562) >> 32 + 325]) + 32 >= 0
                                mem[64] = _609 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_609 + ceil32(return_data.size) + mem[_609 + ceil32(return_data.size) + 325 len 4], Mask(224, 32, _562) >> 32 + 325]) + 357
                                mem[_609 + ceil32(return_data.size) + ceil32(return_data.size) + 325] = _1475
                                ...
                                require _609 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_609 + ceil32(return_data.size) + mem[_609 + ceil32(return_data.size) + 325 len 4], Mask(224, 32, _562) >> 32 + 325]) + 357 <= test266151307() and (32 * mem[_609 + ceil32(return_data.size) + mem[_609 + ceil32(return_data.size) + 325 len 4], Mask(224, 32, _562) >> 32 + 325]) + 32 >= 0
                                mem[64] = _609 + ceil32(return_data.size) + ceil32(return_data.size) + (32 * mem[_609 + ceil32(return_data.size) + mem[_609 + ceil32(return_data.size) + 325 len 4], Mask(224, 32, _562) >> 32 + 325]) + 357
                                mem[_609 + ceil32(return_data.size) + ceil32(return_data.size) + 325] = _1476
    ...
    if not mem[(32 * _898 - 1) + _890 + ceil32(return_data.size) + 32]:
        ...
        while idx < _1550:
            ...
            t = t + 32
            continue 
        mem[_1490 + 100] = this.address
        mem[_1490 + 132] = block.timestamp + sub_1b61e055
        require ext_code.size(uniRouterAddress)
        call uniRouterAddress.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _1490 + (32 * _1550) + -mem[64] + 192]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        mem[_1499 + 132] = block.timestamp + sub_1b61e055
        require ext_code.size(uniRouterAddress)
        call uniRouterAddress.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _1499 + (32 * _1559) + -mem[64] + 192]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        lastEarnBlock = block.number
        if not uint8(stor2.field_16):
