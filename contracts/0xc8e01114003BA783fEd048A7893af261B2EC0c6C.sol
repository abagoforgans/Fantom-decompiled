    ...
    if not arg3:
        ...
        if arg1 != this.address:
            ...
            if arg1 != ext_call.return_data[12 len 20]:
                ...
                require 1 < mem[ceil32(return_data.size) + 192]
                _267 = mem[ceil32(return_data.size) + 256]
                if not mem[ceil32(return_data.size) + 256]:
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    mem[(32 * _187) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                    emit Log(mem[(32 * _187) + ceil32(return_data.size) + 224], 0 / slippage);
                else:
                    if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                        revert with 0, 
                                    32,
                                    33,
                                    0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(32 * _187) + ceil32(return_data.size) + 325 len 31]
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    mem[(32 * _187) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                    emit Log(mem[(32 * _187) + ceil32(return_data.size) + 224], 100 * _267 / slippage);
        require arg3 <= balanceOf[address(arg1)]
        ...
        if arg1 != this.address:
            ...
            if arg1 != ext_call.return_data[12 len 20]:
                ...
                mem[64] = ceil32(return_data.size) + 192
                require return_data.size >= 32
                _180 = mem[192 len 4], Mask(224, 32, 25 * arg3 / 100) >> 32
                ...
                _186 = mem[_180 + 192]
                mem[ceil32(return_data.size) + 224 len floor32(mem[_180 + 192])] = mem[_180 + 224 len floor32(mem[_180 + 192])]
                require 1 < mem[ceil32(return_data.size) + 192]
                _266 = mem[ceil32(return_data.size) + 256]
                if not mem[ceil32(return_data.size) + 256]:
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    mem[(32 * _186) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                    emit Log(mem[(32 * _186) + ceil32(return_data.size) + 224], 0 / slippage);
                else:
                    if 100 * mem[ceil32(return_data.size) + 256] / mem[ceil32(return_data.size) + 256] != 100:
                        revert with 0, 
                                    32,
                                    33,
                                    0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(32 * _186) + ceil32(return_data.size) + 325 len 31]
                    if slippage <= 0:
                        revert with 0, ':divErr'
                    require slippage
                    mem[(32 * _186) + ceil32(return_data.size) + 224] = mem[ceil32(return_data.size) + 256]
                    emit Log(mem[(32 * _186) + ceil32(return_data.size) + 224], 100 * _266 / slippage);
