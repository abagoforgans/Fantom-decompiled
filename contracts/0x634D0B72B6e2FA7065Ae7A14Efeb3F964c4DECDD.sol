...
function sub_fbc44476(?) payable {
    ...
    mem[96] = 0x7ae1aed800000000000000000000000000000000000000000000000000000000
    require ext_code.size(stor1)
    staticcall stor1.mem[var129003 len 4] with:
            gas gas_remaining wei
           args mem[var129003 + 4 len var129004 - 4]
    mem[var129005] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[64] = ceil32(return_data.size) + 96
    require var133002 - var133001 >= 32
    require var143002 == var143001
    s = var149001
    t = var149007
    while t < s:
        if arg1 > -arg2 - 1:
        ...
        call stor0.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args address(this.address), mem[_215]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
