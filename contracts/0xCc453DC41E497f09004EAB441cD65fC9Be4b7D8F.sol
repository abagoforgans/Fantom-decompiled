...
const depositContractInitCodeHash = sha3(code.data[3795 len 788])
...
function depositAddressFor(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return address(sha3(0, this.address, sha3(arg1), sha3(code.data[3795 len 788])))
}
...
function _createDepositContract(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if sub_b09133bc[address(arg1)]:
    ...
    sub_b09133bc[address(arg1)] = address(create2.new_address)
