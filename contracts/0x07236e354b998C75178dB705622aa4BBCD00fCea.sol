...
#
#  - recoverERC20(address arg1, address arg2, uint256 arg3)
...
function initializeDefault() payable {
    ...
    if not rewardsDuration:
        revert with 0, 18
    rewardRate = ext_call.return_data[0] / rewardsDuration
...
function getRewardAndDistribute() payable {
    ...
    if not rewards[msg.sender]:
        revert with 0, 'BoostedStaking: rewards = 0'
    rewards[msg.sender] = 0
    emit RewardPaid(rewards[msg.sender], msg.sender);
    require ext_code.size(rewardsTokenAddress)
    call rewardsTokenAddress.withdrawTo(uint256 arg1, address arg2) with:
         gas gas_remaining wei
        args rewards[msg.sender], msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
