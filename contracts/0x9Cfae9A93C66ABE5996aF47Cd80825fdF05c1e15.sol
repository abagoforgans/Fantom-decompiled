...
const NATIVE = 0x5f1657896b38c4761dbc5484473c7a7c845910b6
...
function getMultiplier(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0x5f1657896b38c4761dbc5484473c7a7c845910b6)
    staticcall 0x5f1657896b38c4761dbc5484473c7a7c845910b6.0x18160ddd with:
...
function inCaseTokensGetStuck(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 == 0x5f1657896b38c4761dbc5484473c7a7c845910b6:
        revert with 0, '!safe'
                ...
                if block.number - poolInfo[arg1].field_512 > 0:
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not 0 / totalAllocPoint:
                            require ext_code.size(0x5f1657896b38c4761dbc5484473c7a7c845910b6)
                            call 0x5f1657896b38c4761dbc5484473c7a7c845910b6.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 0
                        else:
