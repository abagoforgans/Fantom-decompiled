        ...
        if -userInfo[address(msg.sender)].field_256 > 0:
            ...
            if (100000 * userInfo[address(msg.sender)].field_512 / 100000) - (1000 * burnFee * userInfo[address(msg.sender)].field_512 / 100000) <= ext_call.return_data[0]:
                ...
                if 1000 * userInfo[address(msg.sender)].field_512 / 100000 * burnFee <= ext_call.return_data[0]:
                    call farmTokenAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args address(stor9), 1000 * userInfo[address(msg.sender)].field_512 / 100000 * burnFee
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    ...
                    call farmTokenAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args address(stor9), ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    emit Claim(((100000 * userInfo[address(msg.sender)].field_512 / 100000) - (1000 * burnFee * userInfo[address(msg.sender)].field_512 / 100000)), msg.sender);
    ...
    if block.number <= stor4:
        if userInfo[address(msg.sender)].field_0 <= 0:
            if arg1 <= 0:
                ...
                mem[292 len 96] = unknown_0x23b872dd(?????), msg.sender, address(stor8), Mask(224, 32, (100000 * arg1 / 100000) - (1000 * burnFee * arg1 / 100000)) >> 32
                mem[416 len 4] = 0
                mem[388 len 0] = 0
                call stor3 with:
                   funct uint32(stor8)
                ...
                if not return_data.size:
                    if not ext_call.success:
                        revert with unknown_0x23b872dd(?????), msg.sender, address(stor8), (100000 * arg1 / 100000) - (1000 * burnFee * arg1 / 100000)
                    ...
                    if ext_code.size(stor3) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[488 len 96] = 0, msg.sender, address(stor9), Mask(224, 32, 1000 * arg1 / 100000 * burnFee) >> 32
                    mem[612 len 4] = 0
                    call stor3 with:
                       funct uint32(stor9)
                         gas gas_remaining wei
                    ...
                    if not return_data.size:
                        ...
                        if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                            revert with 0, 
                                        ...
                                        0,
                                        mem[616 len 4]
                        stor6 = stor6 + (100000 * arg1 / 100000) - (1000 * burnFee * arg1 / 100000)
                        if not userInfo[address(msg.sender)].field_0:
                            userInfo[address(msg.sender)].field_256 = 0
                        else:
                            require userInfo[address(msg.sender)].field_0
                    ...
                    if ext_code.size(stor3) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 489 len 96] = 0, msg.sender, address(stor9), Mask(224, 32, 1000 * arg1 / 100000 * burnFee) >> 32
                ...
                if (userInfo[address(msg.sender)].field_0 * stor5 / 10^12) - userInfo[address(msg.sender)].field_256 <= 0:
                    ...
                    if arg1 <= 0:
                        ...
                        if not return_data.size:
                            ...
                            if ext_code.size(stor3) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[488 len 96] = unknown_0x23b872dd(?????), msg.sender, address(stor9), Mask(224, 32, 1000 * arg1 / 100000 * burnFee) >> 32
                            mem[612 len 4] = 0
                            call stor3 with:
                               funct uint32(stor9)
                                 gas gas_remaining wei
                            ...
                            if return_data.size <= 0:
                                ...
                                if ext_code.size(stor3) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 489 len 96] = unknown_0x23b872dd(?????), msg.sender, address(stor9), Mask(224, 32, 1000 * arg1 / 100000 * burnFee) >> 32
                                mem[ceil32(return_data.size) + 613 len 4] = 0
                                call stor3 with:
                                   funct uint32(stor9)
                                     gas gas_remaining wei
