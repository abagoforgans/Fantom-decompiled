...
function getpair(address arg1) {
    require calldata.size - 4 >= 32
    require ext_code.size(0xf6488205957f0b4497053d6422f49e27944ee3dd)
    staticcall 0xf6488205957f0b4497053d6422f49e27944ee3dd.getPair(address arg1, address arg2) with:
            gas gas_remaining wei
           args stor0, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function swap(address arg1, address arg2) payable {
    ...
    if address(ext_call.return_data[0]):
        ...
        staticcall stor0.0xdd62ed3e with:
                gas gas_remaining wei
               args address(this.address), 0x845e76a8691423fbc4ecb8dd77556cb61c09ee25
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] < ext_call.return_data[0]:
            ...
            call stor0.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x845e76a8691423fbc4ecb8dd77556cb61c09ee25, -1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
