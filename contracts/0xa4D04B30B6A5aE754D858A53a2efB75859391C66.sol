...
function sub_a356aa65(?) {
    mem[96] = 7
    mem[64] = 352
    mem[128 len 224] = code.data[12936 len 224]
    idx = 1
    while idx <= 6:
        mem[0] = idx
        mem[32] = 12
...
function sub_c5ca93a7(?) {
    ...
    mem[128 len 32 * stor1[arg1].field_1536] = code.data[12936 len 32 * stor1[arg1].field_1536]
    mem[(32 * stor1[arg1].field_1536) + 128] = stor1[arg1].field_1536
    mem[(32 * stor1[arg1].field_1536) + 160 len 32 * stor1[arg1].field_1536] = code.data[12936 len 32 * stor1[arg1].field_1536]
    mem[(64 * stor1[arg1].field_1536) + 160] = stor1[arg1].field_1536
    mem[64] = (98 * stor1[arg1].field_1536) + 192
    mem[(64 * stor1[arg1].field_1536) + 192 len 32 * stor1[arg1].field_1536] = code.data[12936 len 32 * stor1[arg1].field_1536]
    idx = 1
    s = 0
    while idx <= stor1[arg1].field_1536:
        require s < mem[96]
...
function sub_12dd2129(?) {
    ...
    if sub_3a5b375d <= 0:
        ...
        stor1[stor3].field_768 = ext_call.return_data[0]
    else:
                ...
                if not stor1[stor3].field_2048:
                    ...
                    if stor1[stor3].field_768 < stor1[stor3].field_1024:
                        ...
                        while idx <= stor1[stor3].field_1536:
                            ...
                            continue 
                        uint8(stor1[stor3].field_1280) = 1
                        mem[0] = sub_7362c8fd + 1
                        mem[32] = 1
                        if stor1[stor5 + 1].field_0 != sub_7362c8fd + 1:
                            _297 = mem[64]
                            mem[64] = mem[64] + 288
                            mem[_297] = sub_7362c8fd + 1
                            mem[_297 + 32] = 0
                            mem[_297 + 64] = 0
                            mem[_297 + 96] = 0
                            mem[_297 + 128] = 0
                        ...
                        sub_7362c8fd++
                        stor1[stor3].field_256 = stor14
                        stor1[stor3].field_768 = mem[ceil32(return_data.size) + 192]
                    else:
                        if stor1[stor3].field_768 <= stor1[stor3].field_1024:
                            idx = 1
                            while idx <= stor1[stor3].field_1536:
