        ...
        if not userInfo[msg.sender].field_0:
            ...
            if not userInfo[msg.sender].field_0:
                ...
                if not (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 10^18) - userInfo[msg.sender].field_256:
                    ...
                    if not ext_code.hash(rewardTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 10^18) - userInfo[msg.sender].field_256) >> 32
                    mem[452 len 0] = 0
                    call rewardTokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                        ...
                        if not userInfo[msg.sender].field_0:
                            ...
                            if not userInfo[msg.sender].field_0:
                                ...
                                if not (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 10^18) - userInfo[msg.sender].field_256:
                                    ...
                                    if not ext_code.hash(rewardTokenAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[580 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 10^18) - userInfo[msg.sender].field_256) >> 32
                                    mem[644 len 0] = 0
                                    call rewardTokenAddress with:
                                       funct uint32(msg.sender)
                                         gas gas_remaining wei
                        ...
                        if not userInfo[msg.sender].field_0:
                            ...
                            if not userInfo[msg.sender].field_0:
                                ...
                                if not (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 10^18) - userInfo[msg.sender].field_256:
                                    ...
                                    if not ext_code.hash(rewardTokenAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[516 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 10^18) - userInfo[msg.sender].field_256) >> 32
                                    mem[580 len 0] = 0
                                    call rewardTokenAddress with:
                                       funct uint32(msg.sender)
                                         gas gas_remaining wei
