        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7), uint32(stor7), Mask(224, 32, ext_call.return_data[0] - (500 * ext_call.return_data[0] / 100000)) >> 32
                    mem[452 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor7)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7), uint32(stor7), Mask(224, 32, arg1 - (500 * arg1 / 100000)) >> 32
                    mem[452 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor7)
                         gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7), uint32(stor7), Mask(224, 32, ext_call.return_data[0] - (500 * ext_call.return_data[0] / 100000)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor7)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7), uint32(stor7), Mask(224, 32, arg1 - (500 * arg1 / 100000)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor7)
                         gas gas_remaining wei
...
function panic() payable {
    ...
    call wantAddress with:
       funct uint32(stor3)
         gas gas_remaining wei
        args Mask(480, -256, approve(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), 0) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 590 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 0
                mem[(2 * ceil32(return_data.size)) + 654 len 0] = 0
                call wantAddress with:
                   funct uint32(stor4)
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 0) << 256, mem[(2 * ceil32(return_data.size)) + 654 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), 0
                    if not approve(address rg1, uint256 rg2), Mask(224, 0, stor3):
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            call wantAddress with:
               funct uint32(stor4)
                 gas gas_remaining wei
                args Mask(480, -256, approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 0) << 256, mem[652 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), 0
                if not approve(address rg1, uint256 rg2), Mask(224, 0, stor3):
...
function unpause() payable {
    ...
    call wantAddress with:
       funct uint32(stor3)
         gas gas_remaining wei
        args Mask(480, -256, approve(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                call wantAddress with:
                   funct uint32(stor4)
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 653 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), -1
                    if not approve(address rg1, uint256 rg2), Mask(224, 0, stor3):
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 590 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[(2 * ceil32(return_data.size)) + 654 len 0] = 0
                call wantAddress with:
                   funct uint32(stor4)
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[(2 * ceil32(return_data.size)) + 654 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), -1
                    if not approve(address rg1, uint256 rg2), Mask(224, 0, stor3):
