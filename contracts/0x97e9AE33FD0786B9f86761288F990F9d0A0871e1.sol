...
function pancakeCall(address arg1, uint256 arg2, uint256 arg3, bytes arg4) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] < cd[(arg4 + 100)]:
        revert with 0, 'initialization failed'
    mem[96] = 2
    mem[128] = address(cd[(arg4 + 36)])
    ...
    require return_data.size >= 32
    _53 = mem[192 len 4], Mask(224, 32, cd[(arg4 + 100)]) >> 32
    ...
    mem[(32 * _56) + ceil32(return_data.size) + 224] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[(32 * _56) + ceil32(return_data.size) + 228] = cd[(arg4 + 100)]
    mem[(32 * _56) + ceil32(return_data.size) + 260] = 0
    mem[(32 * _56) + ceil32(return_data.size) + 324] = this.address
    mem[(32 * _56) + ceil32(return_data.size) + 356] = block.timestamp
    mem[(32 * _56) + ceil32(return_data.size) + 292] = 160
    mem[(32 * _56) + ceil32(return_data.size) + 388] = 2
    mem[(32 * _56) + ceil32(return_data.size) + 420 len 0] = None
    ...
    call address(cd[(arg4 + 164)]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args cd[(arg4 + 100)], 0, 160, address(this.address), block.timestamp, 2, mem[(32 * _56) + ceil32(return_data.size) + 420 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(32 * _56) + ceil32(return_data.size) + 224 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (32 * _56) + (2 * ceil32(return_data.size)) + 224
    require return_data.size >= 32
    _114 = mem[(32 * _56) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, cd[(arg4 + 100)]) >> 32
    require mem[(32 * _56) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, cd[(arg4 + 100)]) >> 32 <= 4294967296
    require mem[(32 * _56) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, cd[(arg4 + 100)]) >> 32 + 32 <= return_data.size
    require mem[(32 * _56) + ceil32(return_data.size) + mem[(32 * _56) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, cd[(arg4 + 100)]) >> 32 + 224] <= 4294967296 and mem[(32 * _56) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, cd[(arg4 + 100)]) >> 32 + (32 * mem[(32 * _56) + ceil32(return_data.size) + mem[(32 * _56) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, cd[(arg4 + 100)]) >> 32 + 224]) + 32 <= return_data.size
    mem[(32 * _56) + (2 * ceil32(return_data.size)) + 224] = mem[(32 * _56) + ceil32(return_data.size) + mem[(32 * _56) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, cd[(arg4 + 100)]) >> 32 + 224]
    mem[(32 * _56) + (2 * ceil32(return_data.size)) + 256 len floor32(mem[(32 * _56) + ceil32(return_data.size) + _114 + 224])] = mem[(32 * _56) + ceil32(return_data.size) + _114 + 256 len floor32(mem[(32 * _56) + ceil32(return_data.size) + _114 + 224])]
    require 1 < mem[(32 * _56) + (2 * ceil32(return_data.size)) + 224]
    ...
    call address(cd[(arg4 + 68)]).0xa9059cbb with:
         gas gas_remaining wei
        args tx.origin, mem[(32 * _56) + (2 * ceil32(return_data.size)) + 288] - _86
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit Success(address(arg1), address(cd[(arg4 + 36)]), arg2, arg3, mem[(32 * _56) + (2 * ceil32(return_data.size)) + 288] - _86);
}
