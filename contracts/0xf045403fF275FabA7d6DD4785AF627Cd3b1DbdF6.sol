...
function sub_ab0962dd(?) {
    ...
    mem[ceil32(arg1.length) + floor32(arg1.length) + -(arg1.length % 32) + 192 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[ceil32(arg1.length) + 128] = arg1.length
    _63 = sha3(sha3(mem[ceil32(arg1.length) + 160 len Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]]), sha3(address(msg.sender), 151))
    ...
    if not uint256(stor[_63]):
        ...
        if not stor1[_63]:
            ...
            mem[(2 * arg1.length) + ceil32(arg1.length) + 448] = stor2[_63]
            if not stor2[_63]:
                ...
                s = 0
                while (2 * arg1.length) + ceil32(arg1.length) + (32 * stor2[_63]) + 480 > idx + 32:
                ...
                emit ItemUpdated(address arg1, string arg2, address[] arg3, uint256[] arg4, uint256[] arg5, address arg6, uint256 arg7):
                                 mem[arg1.length + ceil32(arg1.length) + 160 len arg1.length + (32 * stor2[_63]) + 320],
                                 msg.sender,
        else:
            ...
            mem[(2 * arg1.length) + ceil32(arg1.length) + (32 * stor1[_63]) + 448] = stor2[_63]
            if not stor2[_63]:
                emit ItemUpdated(address arg1, string arg2, address[] arg3, uint256[] arg4, uint256[] arg5, address arg6, uint256 arg7):
                ...
                s = 0
                while (2 * arg1.length) + ceil32(arg1.length) + (32 * stor1[_63]) + (32 * stor2[_63]) + 480 > idx + 32:
                    mem[idx + 32] = uint256(stor[s + sha3(_63 + 2) + 1])
                    idx = idx + 32
                    s = s + 1
                    continue 
                emit ItemUpdated(address arg1, string arg2, address[] arg3, uint256[] arg4, uint256[] arg5, address arg6, uint256 arg7):
                                 mem[arg1.length + ceil32(arg1.length) + 160 len arg1.length + (32 * stor1[_63]) + (32 * stor2[_63]) + 320],
                                 msg.sender,
    else:
        ...
        if not stor1[_63]:
            ...
            mem[(2 * arg1.length) + ceil32(arg1.length) + (32 * uint256(stor[_63])) + 448] = stor2[_63]
            if not stor2[_63]:
                emit ItemUpdated(address arg1, string arg2, address[] arg3, uint256[] arg4, uint256[] arg5, address arg6, uint256 arg7):
                ...
                s = 0
                while (2 * arg1.length) + ceil32(arg1.length) + (32 * uint256(stor[_63])) + (32 * stor2[_63]) + 480 > idx + 32:
                    mem[idx + 32] = uint256(stor[s + sha3(_63 + 2) + 1])
                    idx = idx + 32
                    s = s + 1
                    continue 
                emit ItemUpdated(address arg1, string arg2, address[] arg3, uint256[] arg4, uint256[] arg5, address arg6, uint256 arg7):
                                 mem[arg1.length + ceil32(arg1.length) + 160 len arg1.length + (32 * uint256(stor[_63])) + (32 * stor2[_63]) + 320],
                                 msg.sender,
        else:
            ...
            mem[(2 * arg1.length) + ceil32(arg1.length) + (32 * uint256(stor[_63])) + (32 * stor1[_63]) + 448] = stor2[_63]
            if not stor2[_63]:
                emit ItemUpdated(address arg1, string arg2, address[] arg3, uint256[] arg4, uint256[] arg5, address arg6, uint256 arg7):
                                 mem[arg1.length + ceil32(arg1.length) + 160 len 96],
                ...
                s = 0
                while (2 * arg1.length) + ceil32(arg1.length) + (32 * uint256(stor[_63])) + (32 * stor1[_63]) + (32 * stor2[_63]) + 480 > idx + 32:
                    mem[idx + 32] = uint256(stor[s + sha3(_63 + 2) + 1])
                    idx = idx + 32
                    s = s + 1
                    continue 
                emit ItemUpdated(address arg1, string arg2, address[] arg3, uint256[] arg4, uint256[] arg5, address arg6, uint256 arg7):
                                 mem[arg1.length + ceil32(arg1.length) + 160 len arg1.length + (32 * uint256(stor[_63])) + (32 * stor1[_63]) + (32 * stor2[_63]) + 320],
                                 msg.sender,
    stor101 = 1
}
