...
function sub_aa4ddf39(?) {
    ...
    mem[ceil32(ceil32(arg1.length)) + 97] = ownerOf[stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])]]
    return memory
      from ceil32(ceil32(arg1.length)) + 97
       len 32
}

function sub_d8ff2ca3(?) payable {
    require calldata.size - 4 >= 32
    require arg1 <= test266151307()
    require arg1 + 35 < calldata.size
    if arg1.length > test266151307():
    ...
    if not ownerOf[stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])]]:
        revert with 0, 'ERC721: owner query for nonexistent token'
    call ownerOf[stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])]] with:
       value msg.value wei
         gas gas_remaining wei
    if not ext_call.success:
        revert with 0, 'Failed to send pay'
}

function sub_cb09548c(?) {
    require calldata.size - 4 >= 32
    require arg1 <= test266151307()
    require arg1 + 35 < calldata.size
    if arg1.length > test266151307():
    ...
    mem[ceil32(ceil32(arg1.length)) + arg1.length + 133 len floor32(arg1.length + 35)] = Mask(8 * ceil32(arg1.length), -(8 * ceil32(arg1.length)) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * ceil32(arg1.length)) - 256, Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, '.ftm'), mem[ceil32(ceil32(arg1.length)) + arg1.length + 161 len floor32(arg1.length + 35) + -arg1.length - 32]
    mem[ceil32(ceil32(arg1.length)) + (2 * arg1.length) + 137] = 9
    stor[sha3(mem[ceil32(ceil32(arg1.length)) + arg1.length + 133 len arg1.length + 36])] = stor8
    return stor8
}
