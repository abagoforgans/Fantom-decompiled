...
function hashOperationBatch(address[] arg1, uint256[] arg2, bytes[] arg3, bytes32 arg4, bytes32 arg5) {
    ...
    while idx < arg3.length:
        ...
        u = u + 32
        continue 
    return sha3(Array(len=arg1.length, data=mem[320 len (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 64]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
}
...
function scheduleBatch(address[] arg1, uint256[] arg2, bytes[] arg3, bytes32 arg4, bytes32 arg5, uint256 arg6) {
    ...
    if roleAdmin[0xfeb09aa5aeb3702cfd50b6b62bc4532604938f21248a27a1d5ca736082b6819c][1][address(msg.sender)].field_0:
        ...
        _73 = sha3(Array(len=arg1.length, data=mem[320 len (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 64]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        if timestamp[Array(len=arg1.length, data=mem[320 len (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 64])][(32 * arg1.length) + 192][(32 * arg1.length) + (32 * arg2.length) + 224][arg4][arg5] > 0:
            revert with 0, 'TimelockController: operation already scheduled'
        if arg6 < minDelay:
            revert with 0, 'TimelockController: insufficient delay'
        if arg6 + block.timestamp < block.timestamp:
            revert with 0, 'SafeMath: addition overflow'
        timestamp[Array(len=arg1.length, data=mem[320 len (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 64])][(32 * arg1.length) + 192][(32 * arg1.length) + (32 * arg2.length) + 224][arg4][arg5] = arg6 + block.timestamp
        idx = 0
        while idx < arg1.length:
        ...
        while idx < arg3.length:
            ...
            continue 
        mem[64] = (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 384
        _76 = sha3(Array(len=arg1.length, data=mem[320 len (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 64]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        if timestamp[Array(len=arg1.length, data=mem[320 len (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 64])][(32 * arg1.length) + 192][(32 * arg1.length) + (32 * arg2.length) + 224][arg4][arg5] > 0:
            revert with 0, 'TimelockController: operation already scheduled'
        if arg6 < minDelay:
            revert with 0, 'TimelockController: insufficient delay'
...
function executeBatch(address[] arg1, uint256[] arg2, bytes[] arg3, bytes32 arg4, bytes32 arg5) payable {
    ...
    if not roleAdmin[0xd8aa0f3194971a2a116679f7c2090f6939c8d4e01a2a8d7e41d55e5351469e63][1][address(msg.sender)].field_0:
        ...
        while idx < arg3.length:
            ...
            continue 
        mem[64] = (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 384
        _182 = sha3(Array(len=arg1.length, data=mem[320 len (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 64]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        if not arg4:
            idx = 0
            while idx < arg1.length:
                require cd[((32 * idx) + arg1 + 36)] == address(cd[((32 * idx) + arg1 + 36)])
        ...
        mem[64] = (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 384
        _179 = sha3(Array(len=arg1.length, data=mem[320 len (64 * arg3.length) + (32 * arg1.length) + (32 * arg2.length) + 64]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        if not arg4:
            idx = 0
            while idx < arg1.length:
                require cd[((32 * idx) + arg1 + 36)] == address(cd[((32 * idx) + arg1 + 36)])
                ...
                call address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                   value cd[((32 * idx) + arg2 + 36)] wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)] + _281 + -mem[64] - 4]
                if return_data.size:
                    _289 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
