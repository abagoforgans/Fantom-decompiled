...
function lockLPToken(address arg1, uint256 arg2, uint256 arg3, address arg4) payable {
    ...
    if not return_data.size:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not arg2:
            mem[328 len 64] = 0, address(stor14), 0
            call arg1 with:
               funct uint32(stor14)
                 gas gas_remaining wei
                args 0, Mask(224, 32, 0, address(stor14), 0) >> 32, mem[392 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
            ...
            if stor12 * arg2 / arg2 != stor12:
                revert with 0, 
                            ...
                            uint32(arg2),
                            mem[356 len 4]
            mem[328 len 64] = 0, address(stor14), Mask(224, 32, stor12 * arg2 / 1000) >> 32
            call arg1 with:
               funct uint32(stor14)
                 gas gas_remaining wei
                args stor12 * arg2 / 1000, Mask(224, 32, address(stor14), Mask(224, 32, stor12 * arg2 / 1000) >> 32) >> 32, mem[392 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not arg2:
            mem[ceil32(return_data.size) + 329 len 64] = 0, address(stor14), 0
            call arg1 with:
               funct uint32(stor14)
                 gas gas_remaining wei
                args 0, Mask(224, 32, 0, address(stor14), 0) >> 32, mem[ceil32(return_data.size) + 393 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
                ...
                if not ext_call.success:
                    revert with 0, 
                                ...
                                45,
                                0x725472616e7366657248656c7065723a3a736166655472616e736665723a207472616e73666572206661696c65,
                                mem[(2 * ceil32(return_data.size)) + 443 len 19]
                if return_data.size:
                    require return_data.size >= 32
            ...
            mem[ceil32(return_data.size) + 329 len 64] = 0, address(stor14), Mask(224, 32, stor12 * arg2 / 1000) >> 32
            call arg1 with:
               funct uint32(stor14)
                 gas gas_remaining wei
                args stor12 * arg2 / 1000, Mask(224, 32, address(stor14), Mask(224, 32, stor12 * arg2 / 1000) >> 32) >> 32, mem[ceil32(return_data.size) + 393 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
