        ...
        if 10000 <= withdrawFeeFactor:
            ...
            if arg2 <= ext_call.return_data[0]:
                if wantLockedTotal >= arg2:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, arg2) >> 32
                    call wantAddress with:
                       funct uint32(stor9)
                         gas gas_remaining wei
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), Mask(224, 0, stor12.field_32)
                    call wantAddress with:
                       funct uint32(stor9)
                         gas gas_remaining wei
            ...
            if not arg2:
                ...
                if 0 <= ext_call.return_data[0]:
                    if wantLockedTotal >= 0:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0
                        call wantAddress with:
                           funct uint32(stor9)
                             gas gas_remaining wei
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), Mask(224, 0, stor12.field_32)
                        call wantAddress with:
                           funct uint32(stor9)
                             gas gas_remaining wei
                    ...
                    if wantLockedTotal >= ext_call.return_data[0]:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0 len 28]
                        call wantAddress with:
                           funct uint32(stor9)
                             gas gas_remaining wei
                ...
                if withdrawFeeFactor * arg2 / 10000 <= ext_call.return_data[0]:
                    if wantLockedTotal >= withdrawFeeFactor * arg2 / 10000:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, withdrawFeeFactor * arg2 / 10000) >> 32
                        call wantAddress with:
                           funct uint32(stor9)
                             gas gas_remaining wei
