...
function sub_a3c2e900(?) {
    ...
    while idx < cd[36] + (32 * ('cd', 36).length) + 36:
        ...
        mem[_174] = cd[(cd[36] + cd[idx] + 36)]
        require cd[36] + cd[idx] + cd[(cd[36] + cd[idx] + 36)] + 68 <= calldata.size
        mem[_174 + 32 len cd[(cd[36] + cd[idx] + 36)]] = call.data[cd[36] + cd[idx] + 68 len cd[(cd[36] + cd[idx] + 36)]]
        mem[_174 + cd[(cd[36] + cd[idx] + 36)] + 32] = 0
        mem[s] = _174
        idx = idx + 32
        s = s + 32
        continue 
                ...
                if ext_code.size(msg.sender) <= 0:
                    ...
                    if bool(stor12[stor8.length].field_0):
                        ...
                        if not _583:
                            ...
                            stor12[stor8.length].field_0 = (2 * _583) + 1
                            s = sha3(sha3(tokenByIndex.length, 12))
                            t = mem[(32 * idx) + 128] + 32
                            while mem[(32 * idx) + 128] + _583 + 32 > t:
                                stor[s] = mem[t]
                                s = s + 1
                                t = t + 32
                                continue 
                            s = sha3(sha3(tokenByIndex.length, 12)) + (Mask(251, 0, _583 + 31) >> 5)
                            while sha3(sha3(tokenByIndex.length, 12)) + (uint255(stor12[stor8.length].field_1) + 31 / 32) > s:
                                stor[s] = 0
                                s = s + 1
                                continue 
                ...
                if ext_code.size(msg.sender) <= 0:
                    ...
                    if bool(stor12[stor8.length].field_0):
                        ...
                        if not _586:
                            ...
                            stor12[stor8.length].field_0 = (2 * _586) + 1
                            s = sha3(sha3(tokenByIndex.length, 12))
                            t = mem[(32 * idx) + 128] + 32
                            while mem[(32 * idx) + 128] + _586 + 32 > t:
                                stor[s] = mem[t]
                                s = s + 1
                                t = t + 32
                                continue 
                            s = sha3(sha3(tokenByIndex.length, 12)) + (Mask(251, 0, _586 + 31) >> 5)
                            while sha3(sha3(tokenByIndex.length, 12)) + (uint255(stor12[stor8.length].field_1) + 31 / 32) > s:
                                stor[s] = 0
                                s = s + 1
                                continue 
...
function sub_aad583ac(?) payable {
    ...
    while idx < cd[36] + (32 * ('cd', 36).length) + 36:
        ...
        if mem[64] + ceil32(ceil32(cd[(cd[36] + cd[idx] + 36)])) + 1 > test266151307() or mem[64] + ceil32(ceil32(cd[(cd[36] + cd[idx] + 36)])) + 1 < mem[64]:
            revert with 'NH{q', 65
        mem[64] = mem[64] + ceil32(ceil32(cd[(cd[36] + cd[idx] + 36)])) + 1
        mem[_183] = cd[(cd[36] + cd[idx] + 36)]
        require cd[36] + cd[idx] + cd[(cd[36] + cd[idx] + 36)] + 68 <= calldata.size
        mem[_183 + 32 len cd[(cd[36] + cd[idx] + 36)]] = call.data[cd[36] + cd[idx] + 68 len cd[(cd[36] + cd[idx] + 36)]]
        mem[_183 + cd[(cd[36] + cd[idx] + 36)] + 32] = 0
        mem[s] = _183
        idx = idx + 32
        s = s + 32
        continue 
                ...
                if ext_code.size(msg.sender) <= 0:
                    ...
                    if bool(stor12[stor8.length].field_0):
                        ...
                        if not _602:
                            ...
                            stor12[stor8.length].field_0 = (2 * _602) + 1
                            s = sha3(sha3(tokenByIndex.length, 12))
                            t = mem[(32 * idx) + 128] + 32
                            while mem[(32 * idx) + 128] + _602 + 32 > t:
                                stor[s] = mem[t]
                                s = s + 1
                                t = t + 32
                                continue 
                            s = sha3(sha3(tokenByIndex.length, 12)) + (Mask(251, 0, _602 + 31) >> 5)
                            while sha3(sha3(tokenByIndex.length, 12)) + (uint255(stor12[stor8.length].field_1) + 31 / 32) > s:
                                stor[s] = 0
                                s = s + 1
                                continue 
