                                ...
                                if not mem[(32 * s) + mem[_572] + 44 len 20]:
                                    ...
                                    if address(_564) == 0x1111111111111111111111111111111111111111:
                                        ...
                                        while idx >= 32:
                                            ...
                                            idx = idx - 32
                                            continue 
                                        mem[mem[64] + floor32(mem[_3135])] = mem[_3135 + floor32(mem[_3135]) + -(mem[_3135] % 32) + 64 len mem[_3135] % 32] or Mask(8 * -(mem[_3135] % 32) + 32, -(8 * -(mem[_3135] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_3135])])
                                        call address(_3084).mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len _3398 + _3134 + -mem[64] + 96]
                                        if not return_data.size:
                                            if not ext_call.success:
                                                revert with 0, 'SafeERC20: low-level call failed'
                                            if not mem[96]:
                                                ...
                                                mem[mem[64] + 32] = _4336
                                                mem[mem[64] + 64] = 0
                                                emit Distributed(mem[mem[64]], _4336, 0);
                                            else:
                                                require mem[96] >= 32
                                                if not mem[128]:
                                                    revert with 0, 
                                                ...
                                                mem[mem[64] + 32] = _4437
                                                mem[mem[64] + 64] = 0
                                                emit Distributed(mem[mem[64]], _4437, 0);
                                        else:
                                            _4062 = mem[64]
                                            mem[64] = mem[64] + ceil32(return_data.size) + 1
                                            ...
                                            if not return_data.size:
                                                ...
                                                mem[mem[64] + 32] = _4341
                                                mem[mem[64] + 64] = 0
                                                emit Distributed(mem[mem[64]], _4341, 0);
                                            else:
                                                require return_data.size >= 32
                                                if not mem[_4062 + 32]:
                                                    revert with 0, 
                                                ...
                                                mem[mem[64] + 32] = _4440
                                                mem[mem[64] + 64] = 0
                                                emit Distributed(mem[mem[64]], _4440, 0);
                            s = s + 1
                            continue 
                    else:
                        mem[0] = 54
                                ...
                                if not mem[(32 * s) + mem[_572] + 44 len 20]:
                                    ...
                                    if address(_564) == 0x1111111111111111111111111111111111111111:
                                        ...
                                        while idx >= 32:
                                            ...
                                            idx = idx - 32
                                            continue 
                                        mem[_5090 + floor32(mem[_5091]) + 100] = mem[_5091 + -(mem[_5091] % 32) + floor32(mem[_5091]) + 64 len mem[_5091] % 32] or Mask(8 * -(mem[_5091] % 32) + 32, -(8 * -(mem[_5091] % 32) + 32) + 256, mem[_5090 + floor32(mem[_5091]) + 100])
                                        call address(_5070).mem[_5090 + 100 len 4] with:
                                             gas gas_remaining wei
                                            args mem[_5090 + 104 len _5222 - 4]
                                        if not return_data.size:
                                            if not ext_call.success:
                                                revert with 0, 'SafeERC20: low-level call failed'
                                            if not mem[96]:
                                                ...
                                                mem[_5090 + 100] = mem[(32 * s) + mem[_572] + 44 len 20]
                                                mem[_5090 + 132] = _5637
                                                mem[_5090 + 164] = _4972 * eth.balance(this.address) / 10000
                                                emit Distributed(mem[_5090 + 100], _5637, _4972 * eth.balance(this.address) / 10000);
                                            else:
                                                require mem[96] >= 32
                                                if not mem[128]:
                                                    revert with 0, 
                                                ...
                                                mem[_5090 + 132] = _5693
                                                mem[_5090 + 164] = _4972 * eth.balance(this.address) / 10000
                                                emit Distributed(mem[_5090 + 100], _5693, _4972 * eth.balance(this.address) / 10000);
                                        else:
                                            mem[64] = _5090 + ceil32(return_data.size) + 101
                                            mem[_5090 + 100] = return_data.size
                                            mem[_5090 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                            if not ext_call.success:
                                                revert with 0, 'SafeERC20: low-level call failed'
                                            if not return_data.size:
                                                require s < mem[mem[_572]]
                                                ...
                                                mem[_5090 + ceil32(return_data.size) + 101] = mem[(32 * s) + mem[_572] + 44 len 20]
                                                mem[_5090 + ceil32(return_data.size) + 133] = _5642
                                                mem[_5090 + ceil32(return_data.size) + 165] = _4972 * eth.balance(this.address) / 10000
                                                emit Distributed(mem[_5090 + ceil32(return_data.size) + 101], _5642, _4972 * eth.balance(this.address) / 10000);
                                            else:
                                                require return_data.size >= 32
                                                if not mem[_5090 + 132]:
                                                    revert with 0, 
                                                                32,
                                                                42,
                                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                                mem[_5090 + ceil32(return_data.size) + 211 len 22]
                                                require s < mem[mem[_572]]
                                                require s < mem[mem[_572 + 32]]
                                                _5696 = mem[(32 * s) + mem[_572 + 32] + 32]
                                                mem[_5090 + ceil32(return_data.size) + 101] = mem[(32 * s) + mem[_572] + 44 len 20]
                                                mem[_5090 + ceil32(return_data.size) + 133] = _5696
                                                mem[_5090 + ceil32(return_data.size) + 165] = _4972 * eth.balance(this.address) / 10000
                                                emit Distributed(mem[_5090 + ceil32(return_data.size) + 101], _5696, _4972 * eth.balance(this.address) / 10000);
                            else:
                                _4978 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_4978] = 26
                                ...
                                if not mem[(32 * s) + mem[_579] + 44 len 20]:
                                    ...
                                    if address(_564) == 0x1111111111111111111111111111111111111111:
                                        ...
                                        while idx >= 32:
                                            ...
                                            idx = idx - 32
                                            continue 
                                        mem[mem[64] + floor32(mem[_1202])] = mem[_1202 + floor32(mem[_1202]) + -(mem[_1202] % 32) + 64 len mem[_1202] % 32] or Mask(8 * -(mem[_1202] % 32) + 32, -(8 * -(mem[_1202] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_1202])])
                                        call address(_1183).mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len _1330 + _1201 + -mem[64] + 96]
                                        if not return_data.size:
                                            if not ext_call.success:
                                                revert with 0, 'SafeERC20: low-level call failed'
                                            if not mem[96]:
                                                ...
                                                mem[mem[64] + 32] = _1819
                                                mem[mem[64] + 64] = 0
                                                emit Distributed(mem[mem[64]], _1819, 0);
                                            else:
                                                require mem[96] >= 32
                                                if not mem[128]:
                                                    revert with 0, 
                                                ...
                                                mem[mem[64] + 32] = _1883
                                                mem[mem[64] + 64] = 0
                                                emit Distributed(mem[mem[64]], _1883, 0);
                                        else:
                                            _1682 = mem[64]
                                            mem[64] = mem[64] + ceil32(return_data.size) + 1
                                            mem[_1682] = return_data.size
                                            mem[_1682 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                            if not ext_call.success:
                                                revert with 0, 'SafeERC20: low-level call failed'
                                            if not return_data.size:
                                                require s < mem[mem[_579]]
                                                ...
                                                mem[mem[64] + 32] = _1824
                                                mem[mem[64] + 64] = 0
                                                emit Distributed(mem[mem[64]], _1824, 0);
                                            else:
                                                require return_data.size >= 32
                                                if not mem[_1682 + 32]:
                                                    revert with 0, 
                                                ...
                                                mem[mem[64] + 32] = _1886
                                                mem[mem[64] + 64] = 0
                                                emit Distributed(mem[mem[64]], _1886, 0);
                            else:
