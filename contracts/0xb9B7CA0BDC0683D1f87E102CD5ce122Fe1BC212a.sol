...
function sub_d3ee0d46(?) {
    ...
    if not ext_call.return_data[0]:
        ...
        call stor7.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
             gas gas_remaining wei
            args address(stor15), stor14, 0 / ext_call.return_data[0], 0, 0 / ext_call.return_data[0], 0, address(this.address), block.timestamp + 15
    else:
        require ext_call.return_data[0]
        ...
        if not stor20:
            ...
            if not ext_call.return_data[0] * stor20 / 100:
                ...
                call stor7.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                     gas gas_remaining wei
                    args address(stor15), stor14, 0 / ext_call.return_data[0], ext_call.return_data[0] * stor20 / 100, 0 / ext_call.return_data[0], 0, address(this.address), block.timestamp + 15
            else:
                ...
                call stor7.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                     gas gas_remaining wei
                    args address(stor15), stor14, 0 / ext_call.return_data[0], ext_call.return_data[0] * stor20 / 100, 0 / ext_call.return_data[0], 99 * ext_call.return_data[0] * stor20 / 100 / 100, address(this.address), block.timestamp + 15
        else:
            require stor20
            ...
            if not stor20 * ext_call.return_data[0] * stor20 / 100 / 100:
                ...
                if not ext_call.return_data[0] * stor20 / 100:
                    ...
                    call stor7.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                         gas gas_remaining wei
                        args address(stor15), stor14, stor20 * ext_call.return_data[0] * stor20 / 100 / 100 * ext_call.return_data[0] / ext_call.return_data[0], ext_call.return_data[0] * stor20 / 100, stor20 * ext_call.return_data[0] * stor20 / 100 / 100 * ext_call.return_data[0] / ext_call.return_data[0], 0, address(this.address), block.timestamp + 15
                else:
                    require ext_call.return_data[0] * stor20 / 100
                    if 99 * ext_call.return_data[0] * stor20 / 100 / ext_call.return_data[0] * stor20 / 100 != 99:
                        revert with 0, 'SafeMath: multiplication overflow'
                    ...
                    call stor7.addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                         gas gas_remaining wei
                        args address(stor15), stor14, stor20 * ext_call.return_data[0] * stor20 / 100 / 100 * ext_call.return_data[0] / ext_call.return_data[0], ext_call.return_data[0] * stor20 / 100, stor20 * ext_call.return_data[0] * stor20 / 100 / 100 * ext_call.return_data[0] / ext_call.return_data[0], 99 * ext_call.return_data[0] * stor20 / 100 / 100, address(this.address), block.timestamp + 15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(stor16)
    staticcall stor16.0x70a08231 with:
