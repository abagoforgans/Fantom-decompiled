...
const sub_d3ba753d(?) = 0x7b17021fcb7bc888641dc3bedfed3734fcaf2c87
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0 len 28]
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * sub_d68e1302 / 10000)) >> 32
                call lpPairAddress with:
                   funct uint32(stor11)
                     gas gas_remaining wei
            ...
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1) >> 32
                call lpPairAddress with:
                   funct uint32(stor11)
                     gas gas_remaining wei
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1 - (arg1 * sub_d68e1302 / 10000)) >> 32
                call lpPairAddress with:
                   funct uint32(stor11)
                     gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[0 len 28]
                call lpPairAddress with:
                   funct uint32(stor11)
                     gas gas_remaining wei
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * sub_d68e1302 / 10000)) >> 32
                call lpPairAddress with:
                   funct uint32(stor11)
                     gas gas_remaining wei
            ...
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1) >> 32
                call lpPairAddress with:
                   funct uint32(stor11)
                     gas gas_remaining wei
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), Mask(224, 32, arg1 - (arg1 * sub_d68e1302 / 10000)) >> 32
                call lpPairAddress with:
                   funct uint32(stor11)
                     gas gas_remaining wei
