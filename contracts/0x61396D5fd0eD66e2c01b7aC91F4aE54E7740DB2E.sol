...
function sub_fb652d4c(?) {
    ...
    mem[mem[64] + 4] = 32
    _16 = mem[ceil32(return_data.size) + 0, Mask(224, 32, ext_call.return_data[0]) >> 32 + 96]
    mem[mem[64] + 36] = mem[ceil32(return_data.size) + 0, Mask(224, 32, ext_call.return_data[0]) >> 32 + 96]
    mem[mem[64] + 68 len ceil32(_16)] = mem[ceil32(return_data.size) + 0, Mask(224, 32, ext_call.return_data[0]) >> 32 + 128 len ceil32(_16)]
    if ceil32(_16) > _16:
        mem[mem[64] + _16 + 68] = 0
    revert with 0, 32, mem[mem[64] + 36 len ceil32(_16) + 32]
}
