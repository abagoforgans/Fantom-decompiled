...
function sub_be774a71(?) {
    ...
    if ('cd', 4).length and 10^17 > -1 / ('cd', 4).length:
        revert with 'NH{q', 17
    call msg.sender with:
       value 10^17 * ('cd', 4).length wei
...
function sub_42c0b3ee(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        if cd[((32 * idx) + cd[36] + 36)] and 10^17 > -1 / cd[((32 * idx) + cd[36] + 36)]:
            revert with 'NH{q', 17
        if s > (-1 * 10^17 * cd[((32 * idx) + cd[36] + 36)]) - 1:
            revert with 'NH{q', 17
        if idx >= ('cd', 4).length:
            revert with 'NH{q', 50
        if idx >= ('cd', 36).length:
