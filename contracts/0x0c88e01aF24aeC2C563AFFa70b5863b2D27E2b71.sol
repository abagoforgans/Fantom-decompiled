...
address sub_1684cd38Address;

function name() payable {
    return name[0 len name.length]
}

function sub_1684cd38(?) payable {
    return sub_1684cd38Address
}
...
function sub_2bbe98b6(?) payable {
    require calldata.size - 4 >= 32
    require msg.sender == adminAddress
    sub_1684cd38Address = arg1
}

function mint(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require msg.sender == sub_1684cd38Address
    if not arg1:
