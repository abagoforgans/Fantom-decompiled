...
function calculateSwap(uint8 arg1, uint8 arg2, uint256 arg3) payable {
    ...
    staticcall metaSwapAddress.0x75d8e3e4 with:
    ...
    if not return_data.size:
        ...
        if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            revert with 0, 
                        ...
                        mem[420 len 4]
        require ext_code.size(metaSwapAddress)
        call metaSwapAddress.0x78e0fae8 with:
             gas gas_remaining wei
...
function removeLiquidityOneToken(uint256 arg1, uint8 arg2, uint256 arg3, uint256 arg4) payable {
    ...
    if not return_data.size:
        ...
        if arg2 < uint8(metaTokens.length - 1):
            ...
            staticcall metaTokens[arg2].0x70a08231 with:
                    gas gas_remaining wei
                   args this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            staticcall baseTokens[uint8(arg2 + -stor54.length - 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)].0x70a08231 with:
                    gas gas_remaining wei
                   args this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
