...
function stakes(bytes32 arg1) {
    ...
    return bool(uint8(stakes[arg1].field_0)), 
           bool(uint8(stakes[arg1].field_8)),
...
function sidepot(bytes32 arg1) {
    ...
    return bool(uint8(sidepot[arg1].field_0)), 
           bool(uint8(sidepot[arg1].field_8)),
...
function collect(bytes32 arg1, uint256[2] arg2, string arg3, uint256 arg4, string arg5, uint256 arg6) payable {
    ...
    if not uint8(stakes[arg1].field_0):
        revert with 0, 'Stake must be initialized'
    ...
    if stor5 != stakeToken[arg1]:
        if mem[96] != mem[128]:
            ...
            if uint8(sidepot[arg1].field_8):
                ...
                Mask(248, 0, sidepot[arg1].field_8) = 1
    ...
    if not arg4:
        if arg2 == uint256(stakes[arg1].field_768):
            if 2 <= uint256(stakes[arg1].field_1280):
                revert with 0, 'Cannot refund active stake'
        else:
...
function processClaim(bytes32 arg1, uint256 arg2, address arg3) payable {
    require calldata.size - 4 >= 96
    require arg3 == arg3
    if msg.sender != this.address:
        revert with 0, 'only contract can call'
    ...
    if _7:
        ...
        if var47002 > var47001:
            if 750 * 10^18 >= uint256(stakes[arg1].field_1792):
                ...
                if var70002 <= var70001:
                    if var72001 >= uint256(stakeMembers[arg1].field_0):
                        revert with 0, 50
                    if arg2 == uint256(stor[(4 * var74001) + sha3(var74002) + 2]):
                        mem[64] = mem[64] + 64
            ...
            if var49001 >= _7:
                revert with 0, 50
            if arg3 != mem[(32 * var51001) + ceil32(return_data.size) + 140 len 20]:
                if var55001 == -1:
                    revert with 0, 17
                if var63001 < 1:
                    revert with 0, 17
                if var67002 <= var67001:
                    if var69001 >= _7:
                        revert with 0, 50
                    if arg3 != mem[(32 * var71001) + ceil32(return_data.size) + 140 len 20]:
                        if var75001 == -1:
                            revert with 0, 17
                        # nil
                    else:
                ...
                if var73002 <= var73001:
                    if var75001 >= uint256(stakeMembers[arg1].field_0):
                        revert with 0, 50
                    if arg2 != uint256(stor[(4 * var77001) + sha3(var77002) + 2]):
                        if var81001 == -1:
                            revert with 0, 17
                        if var89001 < 1:
                            revert with 0, 17
        ...
        if 750 * 10^18 >= uint256(stakes[arg1].field_1792):
            ...
            if var60002 <= var60001:
                if var62001 >= uint256(stakeMembers[arg1].field_0):
                    revert with 0, 50
                if arg2 == uint256(stor[(4 * var64001) + sha3(var64002) + 2]):
                    _2932 = mem[64]
                    mem[64] = mem[64] + 64
                        ...
                        while idx < uint256(stakeMembers[arg1].field_0):
                            ...
                            if var82002 <= var82001:
                                if var84001 >= uint256(stakeMembers[arg1].field_0):
                                    revert with 0, 50
                                if arg2 != uint256(stor[(4 * var86001) + sha3(var86002) + 2]):
                                    # nil
                                else:
                                    _13600 = mem[64]
                                    mem[64] = mem[64] + 64
                ...
                if var80002 <= var80001:
                    if var82001 >= uint256(stakeMembers[arg1].field_0):
                        revert with 0, 50
                    if arg2 != uint256(stor[(4 * var84001) + sha3(var84002) + 2]):
                        if var88001 == -1:
                            revert with 0, 17
                        # nil
                    else:
                ...
                if stor5 == stakeToken[arg1]:
                    ...
                    if stor5 != stakeToken[arg1]:
                        if not var102001:
                            ...
                            require ext_code.size(arg3)
                            call arg3.mem[var111004 len 4] with:
                                 gas gas_remaining wei
                        ...
                        if not var93001:
                            ...
                            require ext_code.size(arg3)
                            call arg3.mem[var112004 len 4] with:
                                 gas gas_remaining wei
                    ...
                    if stor5 != stakeToken[arg1]:
                        if not var110001:
                            ...
                            require ext_code.size(arg3)
                            call arg3.mem[var119004 len 4] with:
                                 gas gas_remaining wei
                        ...
                        if not var101001:
                            ...
                            require ext_code.size(arg3)
                            call arg3.mem[var120004 len 4] with:
                                 gas gas_remaining wei
...
function adminRefund(bytes32 arg1) {
    require calldata.size - 4 >= 32
    if gubAddyAddress != msg.sender:
        revert with 0, 'Sender not authorized'
    if stor5 == stakeToken[arg1]:
        require ext_code.size(this.address)
        call this.address.0x33b2e6e9 with:
             gas gas_remaining wei
            args arg1, stakeToken[arg1]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        uint16(stakes[arg1].field_0) = 0
        uint256(stakes[arg1].field_256) = 0
                ...
                if bool(stor20[arg1].field_0):
                    ...
                    if 31 >= uint255(stor20[arg1].field_1):
                        if uint256(sidepotWinners[arg1].field_0):
                            ...
                            while 4 * uint256(sidepotMembers[arg1].field_0) > idx:
                                ...
                                idx = idx + 4
                                continue 
                            uint256(sidepotWinners[arg1].field_0) = 0
                            idx = 0
                            while 5 * uint256(sidepotWinners[arg1].field_0) > idx:
                                uint256(sidepotWinners[arg1][idx].field_0) = 0
                                uint256(sidepotWinners[arg1][idx].field_256) = 0
                                uint256(sidepotWinners[arg1][idx].field_512) = 0
                                uint256(sidepotWinners[arg1][idx].field_768) = 0
                                address(sidepotWinners[arg1][idx].field_1024) = 0
                                idx = idx + 5
                                continue 
                            stakeToken[arg1] = 0
                            timeCreated[arg1] = 0
                            ...
                            if arg1 != betIDRec[var98001]:
                                ...
                                if betIDRec.length - 1 >= betIDRec.length:
                                    revert with 0, 50
                                if var108003 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var108003] = betIDRec[betIDRec.length]
                                if not betIDRec.length:
                                    revert with 0, 49
                                betIDRec[betIDRec.length] = 0
                                betIDRec.length--
                        ...
                        if uint256(sidepotWinners[arg1].field_0):
                            ...
                            if betIDRec.length < 1:
                                revert with 0, 17
                            if var98002 > betIDRec.length - 1:
                                if not numberOfBets:
                                    revert with 0, 17
                                numberOfBets--
                            if var100001 >= betIDRec.length:
                                revert with 0, 50
                            if arg1 != betIDRec[var102001]:
                                if var106001 == -1:
                                    revert with 0, 17
                                if betIDRec.length < 1:
                                    revert with 0, 17
                                ...
                                if var104001 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var106001] = 0
                                if betIDRec.length < 1:
                                    revert with 0, 17
                                if betIDRec.length - 1 >= betIDRec.length:
                                    revert with 0, 50
                                if var112003 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var112003] = betIDRec[betIDRec.length]
                                if not betIDRec.length:
                                    revert with 0, 49
                                betIDRec[betIDRec.length] = 0
                                betIDRec.length--
                    ...
                    if 31 >= stor20[arg1].field_1 % 128:
                        if uint256(sidepotWinners[arg1].field_0):
                            ...
                            if betIDRec.length < 1:
                                revert with 0, 17
                            if var81002 > betIDRec.length - 1:
                                if not numberOfBets:
                                    revert with 0, 17
                                numberOfBets--
                            if var83001 >= betIDRec.length:
                                revert with 0, 50
                            if arg1 != betIDRec[var85001]:
                                if var89001 == -1:
                                    revert with 0, 17
                                if betIDRec.length < 1:
                                    revert with 0, 17
                                ...
                                if betIDRec.length - 1 >= betIDRec.length:
                                    revert with 0, 50
                                if var95003 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var95003] = betIDRec[betIDRec.length]
                                if not betIDRec.length:
                                    revert with 0, 49
                                betIDRec[betIDRec.length] = 0
                                betIDRec.length--
                            ...
                            if arg1 != betIDRec[var99001]:
                                ...
                                if betIDRec.length - 1 >= betIDRec.length:
                                    revert with 0, 50
                                if var109003 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var109003] = betIDRec[betIDRec.length]
                                if not betIDRec.length:
                                    revert with 0, 49
                                betIDRec[betIDRec.length] = 0
                                betIDRec.length--
                        ...
                        if uint256(sidepotWinners[arg1].field_0):
                            ...
                            if betIDRec.length < 1:
                                revert with 0, 17
                            if var85002 > betIDRec.length - 1:
                                if not numberOfBets:
                                    revert with 0, 17
                                numberOfBets--
                            if var87001 >= betIDRec.length:
                                revert with 0, 50
                            if arg1 != betIDRec[var89001]:
                                if var93001 == -1:
                                    revert with 0, 17
                                if betIDRec.length < 1:
                                    revert with 0, 17
                                ...
                                if betIDRec.length - 1 >= betIDRec.length:
                                    revert with 0, 50
                                if var99003 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var99003] = betIDRec[betIDRec.length]
                                if not betIDRec.length:
                                    revert with 0, 49
                                betIDRec[betIDRec.length] = 0
                                betIDRec.length--
                ...
                if bool(stor20[arg1].field_0):
                    ...
                    if 31 >= uint255(stor20[arg1].field_1):
                        ...
                        if uint256(sidepotWinners[arg1].field_0):
                            ...
                            if betIDRec.length < 1:
                                revert with 0, 17
                            if var102002 > betIDRec.length - 1:
                                if not numberOfBets:
                                    revert with 0, 17
                                numberOfBets--
                            if var104001 >= betIDRec.length:
                                revert with 0, 50
                            if arg1 != betIDRec[var106001]:
                                if var110001 == -1:
                                    revert with 0, 17
                                if betIDRec.length < 1:
                                    revert with 0, 17
                                ...
                                if var108001 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var110001] = 0
                                if betIDRec.length < 1:
                                    revert with 0, 17
                                if betIDRec.length - 1 >= betIDRec.length:
                                    revert with 0, 50
                                if var116003 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var116003] = betIDRec[betIDRec.length]
                                if not betIDRec.length:
                                    revert with 0, 49
                                betIDRec[betIDRec.length] = 0
                                betIDRec.length--
                    ...
                    if 31 >= stor20[arg1].field_1 % 128:
                        ...
                        if uint256(sidepotWinners[arg1].field_0):
                            ...
                            if betIDRec.length < 1:
                                revert with 0, 17
                            if var89002 > betIDRec.length - 1:
                                if not numberOfBets:
                                    revert with 0, 17
                                numberOfBets--
                            if var91001 >= betIDRec.length:
                                revert with 0, 50
                            if arg1 != betIDRec[var93001]:
                                if var97001 == -1:
                                    revert with 0, 17
                                if betIDRec.length < 1:
                                    revert with 0, 17
                                ...
                                if betIDRec.length - 1 >= betIDRec.length:
                                    revert with 0, 50
                                if var103003 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var103003] = betIDRec[betIDRec.length]
                                if not betIDRec.length:
                                    revert with 0, 49
                                betIDRec[betIDRec.length] = 0
                                betIDRec.length--
                ...
                if bool(stor20[arg1].field_0):
                    ...
                    if 31 >= stor20[arg1].field_1 % 128:
                        if uint256(sidepotWinners[arg1].field_0):
                            ...
                            if betIDRec.length < 1:
                                revert with 0, 17
                            if var96002 > betIDRec.length - 1:
                                if not numberOfBets:
                                    revert with 0, 17
                                numberOfBets--
                            if var98001 >= betIDRec.length:
                                revert with 0, 50
                            if arg1 != betIDRec[var100001]:
                                if var104001 == -1:
                                    revert with 0, 17
                                if betIDRec.length < 1:
                                    revert with 0, 17
                                ...
                                if var102001 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var104001] = 0
                                if betIDRec.length < 1:
                                    revert with 0, 17
                                if betIDRec.length - 1 >= betIDRec.length:
                                    revert with 0, 50
                                if var110003 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var110003] = betIDRec[betIDRec.length]
                                if not betIDRec.length:
                                    revert with 0, 49
                                betIDRec[betIDRec.length] = 0
                                betIDRec.length--
                    ...
                    if 31 >= stor20[arg1].field_1 % 128:
                        ...
                        if uint256(sidepotWinners[arg1].field_0):
                            ...
                            if arg1 != betIDRec[var94001]:
                                ...
                                if betIDRec.length - 1 >= betIDRec.length:
                                    revert with 0, 50
                                if var104003 >= betIDRec.length:
                                    revert with 0, 50
                                betIDRec[var104003] = betIDRec[betIDRec.length]
                                if not betIDRec.length:
                                    revert with 0, 49
                                betIDRec[betIDRec.length] = 0
                                betIDRec.length--
                        ...
                        if 31 >= stor20[arg1].field_1 % 128:
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var121001]:
                                    ...
                                    if betIDRec.length - 1 >= betIDRec.length:
                                        revert with 0, 50
                                    if var131003 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var131003] = betIDRec[betIDRec.length]
                                    if not betIDRec.length:
                                        revert with 0, 49
                                    betIDRec[betIDRec.length] = 0
                                    betIDRec.length--
                        ...
                        if 31 >= uint255(stor20[arg1].field_1):
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var110001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var126002 <= betIDRec.length - 1:
                                        if var128001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                    else:
                        ...
                        if 31 >= stor20[arg1].field_1 % 128:
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var111001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var127002 <= betIDRec.length - 1:
                                        if var129001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                    else:
                                    ...
                                    if betIDRec.length - 1 >= betIDRec.length:
                                        revert with 0, 50
                                    if var121003 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var121003] = betIDRec[betIDRec.length]
                                    if not betIDRec.length:
                                        revert with 0, 49
                                    betIDRec[betIDRec.length] = 0
                                    betIDRec.length--
                                ...
                                if betIDRec.length < 1:
                                    revert with 0, 17
                                if var121002 > betIDRec.length - 1:
                                    if not numberOfBets:
                                        revert with 0, 17
                                    numberOfBets--
                                if var123001 >= betIDRec.length:
                                    revert with 0, 50
                                if arg1 != betIDRec[var125001]:
                                    if var129001 == -1:
                                        revert with 0, 17
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    ...
                                    if var127001 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var129001] = 0
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if betIDRec.length - 1 >= betIDRec.length:
                                        revert with 0, 50
                                    if var135003 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var135003] = betIDRec[betIDRec.length]
                                    if not betIDRec.length:
                                        revert with 0, 49
                                    betIDRec[betIDRec.length] = 0
                                    betIDRec.length--
                        ...
                        if 31 >= stor20[arg1].field_1 % 128:
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var118001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var134002 <= betIDRec.length - 1:
                                        if var136001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                    else:
                                        if not numberOfBets:
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var122001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var138002 <= betIDRec.length - 1:
                                        # nil
                                    else:
                                        if not numberOfBets:
                                            revert with 0, 17
                        ...
                        if 31 >= stor20[arg1].field_1 % 128:
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var112001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var128002 <= betIDRec.length - 1:
                                        if var130001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                    else:
                                ...
                                if arg1 != betIDRec[var126001]:
                                    ...
                                    if betIDRec.length - 1 >= betIDRec.length:
                                        revert with 0, 50
                                    if var136003 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var136003] = betIDRec[betIDRec.length]
                                    if not betIDRec.length:
                                        revert with 0, 49
                                    betIDRec[betIDRec.length] = 0
                                    betIDRec.length--
                        ...
                        if 31 >= uint255(stor20[arg1].field_1):
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var135001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var151002 <= betIDRec.length - 1:
                                        if var153001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                    else:
                                        if not numberOfBets:
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var139001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var155002 <= betIDRec.length - 1:
                                        # nil
                                    else:
                                        if not numberOfBets:
                                            revert with 0, 17
                        ...
                        if 31 >= stor20[arg1].field_1 % 128:
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var122001]:
                                    ...
                                    if var138002 > betIDRec.length - 1:
                                        if not numberOfBets:
                                            revert with 0, 17
                                        numberOfBets--
                                    if var140001 >= betIDRec.length:
                                        revert with 0, 50
                                    if arg1 != betIDRec[var142001]:
                                        # nil
                                    else:
                                        if var144001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                else:
                                    if var124001 >= betIDRec.length:
                                ...
                                if arg1 != betIDRec[var136001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var152002 <= betIDRec.length - 1:
                                        if var154001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                    else:
                                        if not numberOfBets:
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var126001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var142002 > betIDRec.length - 1:
                                        if not numberOfBets:
                                            revert with 0, 17
                                        numberOfBets--
                                    if var144001 >= betIDRec.length:
                                ...
                                if arg1 != betIDRec[var140001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var156002 <= betIDRec.length - 1:
                                        # nil
                                    else:
                                        if not numberOfBets:
                                            revert with 0, 17
                    ...
                    if bool(stor20[arg1].field_0):
                        ...
                        if 31 >= uint255(stor20[arg1].field_1):
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var129001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var145002 <= betIDRec.length - 1:
                                        if var147001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                    else:
                                ...
                                if arg1 != betIDRec[var143001]:
                                    ...
                                    if betIDRec.length - 1 >= betIDRec.length:
                                        revert with 0, 50
                                    if var153003 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var153003] = betIDRec[betIDRec.length]
                                    if not betIDRec.length:
                                        revert with 0, 49
                                    betIDRec[betIDRec.length] = 0
                                    betIDRec.length--
                        ...
                        if 31 >= stor20[arg1].field_1 % 128:
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if var128001 >= betIDRec.length:
                                    revert with 0, 50
                                if arg1 != betIDRec[var130001]:
                                    if var134001 == -1:
                                        revert with 0, 17
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var146002 <= betIDRec.length - 1:
                                        if var148001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                    else:
                                        if not numberOfBets:
                                    ...
                                    if var132001 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var134001] = 0
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if betIDRec.length - 1 >= betIDRec.length:
                                        revert with 0, 50
                                    if var140003 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var140003] = betIDRec[betIDRec.length]
                                    if not betIDRec.length:
                                        revert with 0, 49
                                    betIDRec[betIDRec.length] = 0
                                    betIDRec.length--
                                ...
                                if arg1 != betIDRec[var144001]:
                                    ...
                                    if betIDRec.length - 1 >= betIDRec.length:
                                        revert with 0, 50
                                    if var154003 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var154003] = betIDRec[betIDRec.length]
                                    if not betIDRec.length:
                                        revert with 0, 49
                                    betIDRec[betIDRec.length] = 0
                                    betIDRec.length--
                        ...
                        if 31 >= stor20[arg1].field_1 % 128:
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var137001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var153002 <= betIDRec.length - 1:
                                        if var155001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                    else:
                                        if not numberOfBets:
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if arg1 != betIDRec[var127001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var143002 > betIDRec.length - 1:
                                        if not numberOfBets:
                                            revert with 0, 17
                                        numberOfBets--
                                    if var145001 >= betIDRec.length:
                                    ...
                                    if betIDRec.length - 1 >= betIDRec.length:
                                        revert with 0, 50
                                    if var137003 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var137003] = betIDRec[betIDRec.length]
                                    if not betIDRec.length:
                                        revert with 0, 49
                                    betIDRec[betIDRec.length] = 0
                                    betIDRec.length--
                                ...
                                if arg1 != betIDRec[var141001]:
                                    ...
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var157002 <= betIDRec.length - 1:
                                        # nil
                                    else:
                                        if not numberOfBets:
                                            revert with 0, 17
                    ...
                    if bool(stor20[arg1].field_0):
                        ...
                        if 31 >= stor20[arg1].field_1 % 128:
                            ...
                            if uint256(sidepotWinners[arg1].field_0):
                                ...
                                if var129001 >= betIDRec.length:
                                    revert with 0, 50
                                if arg1 != betIDRec[var131001]:
                                    if var135001 == -1:
                                        revert with 0, 17
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if var147002 <= betIDRec.length - 1:
                                        if var149001 >= betIDRec.length:
                                            revert with 0, 50
                                        # nil
                                    else:
                                        if not numberOfBets:
                                    ...
                                    if var133001 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var135001] = 0
                                    if betIDRec.length < 1:
                                        revert with 0, 17
                                    if betIDRec.length - 1 >= betIDRec.length:
                                        revert with 0, 50
                                    if var141003 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var141003] = betIDRec[betIDRec.length]
                                    if not betIDRec.length:
                                        revert with 0, 49
                                    betIDRec[betIDRec.length] = 0
                                    betIDRec.length--
                                ...
                                if arg1 != betIDRec[var145001]:
                                    ...
                                    if betIDRec.length - 1 >= betIDRec.length:
                                        revert with 0, 50
                                    if var155003 >= betIDRec.length:
                                        revert with 0, 50
                                    betIDRec[var155003] = betIDRec[betIDRec.length]
                                    if not betIDRec.length:
                                        revert with 0, 49
                                    betIDRec[betIDRec.length] = 0
                                    betIDRec.length--
