...
function createMarketSale(address arg1, uint256 arg2, address arg3) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(0x4e15361fd6b4bb609fa63c81a2be19d873717870)
    call 0x4e15361fd6b4bb609fa63c81a2be19d873717870.0x23b872dd with:
         gas gas_remaining wei
        args msg.sender, stor3, stor6[arg2].field_768 / 100 * msg.value
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
