...
function pause() payable {
    ...
    if ext_code.size(wantAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), 0
    call wantAddress with:
       funct uint32(stor18)
         gas gas_remaining wei
        args 0, mem[324 len 4]
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                call lpToken1Address with:
                   funct uint32(stor2), mem[(2 * ceil32(return_data.size)) + 658 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
                     gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    staticcall sub_a3afda1aAddress.userInfo(uint16 arg1, address arg2) with:
                            gas gas_remaining wei
                           args uint16(stor22.field_0), address(this.address), mem[(2 * ceil32(return_data.size)) + 822 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 64
                    require ext_code.size(address(summitAddress))
                    call address(summitAddress).withdraw(uint16 arg1, uint256 arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args uint16(stor22.field_0), ext_call.return_data[32], 0, mem[(2 * ceil32(return_data.size)) + 854 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        else:
            mem[456 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size > 0:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    call address(summitAddress).withdraw(uint16 arg1, uint256 arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args mem[(4 * ceil32(return_data.size)) + 760 len (6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 96]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
