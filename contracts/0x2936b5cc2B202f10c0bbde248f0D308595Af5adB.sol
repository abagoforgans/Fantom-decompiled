...
function name() {
    if bool(stor32.length):
            ...
            if stor32.length.field_1:
                if 31 < stor32.length.field_1:
                    ...
                    while stor32.length.field_1 + 96 > idx:
                        ...
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, stor32.length.field_1), data=mem[128 len ceil32(stor32.length.field_1)])
        ...
        return Array(len=2 * Mask(256, -1, stor32.length.field_1), data=mem[128 len ceil32(stor32.length.field_1)], mem[(2 * ceil32(stor32.length.field_1)) + 192 len 2 * ceil32(stor32.length.field_1)]), 
    if bool(stor32.length) == stor32.length.field_1 < 32:
        revert with 'NH{q', 34
    if bool(stor32.length):
        if bool(stor32.length) == stor32.length.field_1 < 32:
...
function symbol() {
    if bool(stor33.length):
        if bool(stor33.length) == stor33.length.field_1 < 32:
            revert with 'NH{q', 34
        if bool(stor33.length):
            if bool(stor33.length) == stor33.length.field_1 < 32:
                revert with 'NH{q', 34
            if stor33.length.field_1:
                if 31 < stor33.length.field_1:
                    mem[128] = uint256(stor33.field_0)
                    idx = 128
                    s = 0
                    while stor33.length.field_1 + 96 > idx:
                        mem[idx + 32] = stor33[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, stor33.length.field_1), data=mem[128 len ceil32(stor33.length.field_1)])
                mem[128] = 256 * stor33.length.field_8
        else:
            if bool(stor33.length) == stor33.length.field_1 < 32:
                revert with 'NH{q', 34
            if stor33.length.field_1:
                if 31 < stor33.length.field_1:
                    ...
                    return Array(len=2 * Mask(256, -1, stor33.length.field_1), data=mem[128 len ceil32(stor33.length.field_1)])
                mem[128] = 256 * stor33.length.field_8
        mem[ceil32(stor33.length.field_1) + 192 len ceil32(stor33.length.field_1)] = mem[128 len ceil32(stor33.length.field_1)]
        if ceil32(stor33.length.field_1) > stor33.length.field_1:
            mem[ceil32(stor33.length.field_1) + stor33.length.field_1 + 192] = 0
        return Array(len=2 * Mask(256, -1, stor33.length.field_1), data=mem[128 len ceil32(stor33.length.field_1)], mem[(2 * ceil32(stor33.length.field_1)) + 192 len 2 * ceil32(stor33.length.field_1)]), 
    if bool(stor33.length) == stor33.length.field_1 < 32:
        revert with 'NH{q', 34
    if bool(stor33.length):
        if bool(stor33.length) == stor33.length.field_1 < 32:
        ...
        if stor33.length.field_1:
            if 31 < stor33.length.field_1:
                ...
                while stor33.length.field_1 + 96 > idx:
                    ...
                    s = s + 1
                    continue 
                return Array(len=stor33.length % 128, data=mem[128 len ceil32(stor33.length.field_1)])
            mem[128] = 256 * stor33.length.field_8
    else:
        if bool(stor33.length) == stor33.length.field_1 < 32:
            revert with 'NH{q', 34
    ...
    if ceil32(stor33.length.field_1) > stor33.length.field_1:
        mem[ceil32(stor33.length.field_1) + stor33.length.field_1 + 192] = 0
    return Array(len=stor33.length % 128, data=mem[128 len ceil32(stor33.length.field_1)], mem[(2 * ceil32(stor33.length.field_1)) + 192 len 2 * ceil32(stor33.length.field_1)]), 
}
