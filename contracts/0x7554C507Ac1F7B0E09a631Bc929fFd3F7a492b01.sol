...
function tryAggregate(bool arg1, address arg2, bytes[] arg3) payable {
    ...
    while idx < arg2.length:
        ...
        if cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)] > test266151307():
            revert with 'NH{q', 65
        _129 = mem[64]
        if mem[64] + ceil32(cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)]) + 32 > test266151307() or mem[64] + ceil32(cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)]) + 32 < mem[64]:
            revert with 'NH{q', 65
