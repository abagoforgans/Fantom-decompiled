...
uint256 totalNFT;
uint256 pricePerNFT;
mapping of uint256 sub_dcd48b5d;
address sub_d9673ee9Address;

function totalNFT() {
    return totalNFT
}

function pricePerNFT() {
    return pricePerNFT
}
...
function sub_d9673ee9(?) {
    return sub_d9673ee9Address
}

function sub_dcd48b5d(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    return sub_dcd48b5d[arg1]
}
...
function pauseMint(bool arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    mintPaused = uint8(arg1)
    return arg1
}
...
function increaseTotal(uint256 arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 <= totalNFT:
        revert with 0, 'You cannot decrease NFT'
    totalNFT = arg1
}

function changePriceOfMintingNFT(uint256 arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    pricePerNFT = 10^18 * arg1
}
...
function sub_c79ded47(?) payable {
    ...
    if stor9[stor7].field_0:
        if stor9[stor7].field_0 == uint255(stor9[stor7].field_0) * 0.5 < 32:
            revert with 0, 34
        if arg2.length:
            stor9[stor7][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor9[stor7].field_0 = 0
            idx = 0
            while (uint255(stor9[stor7].field_0) * 0.5) + 31 / 32 > idx:
...
function mint(address arg1, string arg2) payable {
    ...
    require arg2 + arg2.length + 36 <= calldata.size
    if mintPaused:
        revert with 0, 'Minting Paused: Currently not able to mint New NFTs'
    if stor7 > totalNFT:
        revert with 0, 'No More NFT can be minted: Max NFT Cap Reached'
    if 10 < sub_dcd48b5d[msg.sender]:
        revert with 0, 'You cannot mint more than 10 NFT's'
    if msg.value < pricePerNFT:
        revert with 0, 'Please send Required Fantom To Mint a NFT'
    stor7++
    if not arg1:
        revert with 0, 'ERC721: mint to the zero address'
    if ownerOf[stor7]:
    ...
    if ext_code.size(arg1):
        ...
        if Mask(32, 224, ext_call.return_data[0]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
    if 1 > !sub_dcd48b5d[msg.sender]:
        revert with 0, 17
    sub_dcd48b5d[msg.sender]++
    if stor9[stor7].field_0:
        if stor9[stor7].field_0 == uint255(stor9[stor7].field_0) * 0.5 < 32:
            revert with 0, 34
        if arg2.length:
