...
function makeCustomTxn(address arg1, address arg2, address arg3, uint256 arg4) payable {
    ...
    if ext_call.return_data[0] >= arg4:
        ...
        idx = 96
        while 160 > idx:
            stor35[s].field_0 = mem[idx + 12 len 20]
            s = s + 1
            idx = idx + 32
            continue 
        idx = 2
        while stor35.length > idx:
            stor35[idx].field_0 = 0
            idx = idx + 1
            continue 
        ...
        mem[228] = 160
        mem[324] = stor35.length
        if not stor35.length:
            require ext_code.size(arg3)
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor35.length
        else:
            mem[0] = 35
            mem[356] = address(stor35.field_0)
            idx = 356
            s = 0
            while (32 * stor35.length) + 356 > idx + 32:
            ...
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor35.length, mem[356 len 32 * stor35.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                mem[556] = 160
                mem[652] = stor35.length
                if not stor35.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor35.length
                else:
                    mem[0] = 35
                    mem[684] = address(stor35.field_0)
                    idx = 684
                    s = 0
                    while (32 * stor35.length) + 684 > idx + 32:
                        mem[idx + 32] = stor35[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor35.length, mem[684 len 32 * stor35.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                mem[ceil32(return_data.size) + 653] = stor35.length
                if not stor35.length:
                    require ext_code.size(arg3)
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                    ...
                    mem[0] = 35
                    mem[ceil32(return_data.size) + 685] = address(stor35.field_0)
                    idx = ceil32(return_data.size) + 685
                    s = 0
                    while ceil32(return_data.size) + (32 * stor35.length) + 685 > idx + 32:
                        mem[idx + 32] = stor35[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor35.length, mem[ceil32(return_data.size) + 685 len 32 * stor35.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            if return_data.size <= 0:
                ...
                if not return_data.size:
                    ...
                    mem[(2 * ceil32(return_data.size)) + 654] = stor35.length
                    if not stor35.length:
                        require ext_code.size(arg3)
                        call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                        ...
                        mem[0] = 35
                        mem[(2 * ceil32(return_data.size)) + 686] = address(stor35.field_0)
                        idx = (2 * ceil32(return_data.size)) + 686
                        s = 0
                        while (2 * ceil32(return_data.size)) + (32 * stor35.length) + 686 > idx + 32:
                            mem[idx + 32] = stor35[s].field_256
                            idx = idx + 32
                            s = s + 1
                            continue 
                        ...
                        call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args arg4, 0, 160, address(this.address), block.timestamp + 600, stor35.length, mem[(2 * ceil32(return_data.size)) + 686 len 32 * stor35.length]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                ...
                if not return_data.size:
                    ...
                    if not stor35.length:
                        ...
                        call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args arg4, 0, 160, address(this.address), block.timestamp + 600, stor35.length, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                    else:
                        mem[0] = 35
                        mem[(2 * ceil32(return_data.size)) + 686] = address(stor35.field_0)
                        idx = (2 * ceil32(return_data.size)) + 686
                        ...
                        call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args arg4, 0, 160, address(this.address), block.timestamp + 600, stor35.length, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) + (32 * stor35.length) - (2 * ceil32(return_data.size))]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[(2 * ceil32(return_data.size)) + 490 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    mem[64] = (4 * ceil32(return_data.size)) + 490
