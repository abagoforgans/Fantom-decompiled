...
function panic() payable {
    ...
    if not return_data.size:
        ...
        if mem[96] <= 0:
            ...
            mem[_416 + 392 len 0] = 0
            call 0xe0654c8e6fd4d733349ac7e09f6f23da256bf475 with:
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 0) << 256, mem[_416 + 392 len 4]
        else:
            require mem[96] >= 32
            if not mem[128]:
                revert with 0, 
        ...
        if return_data.size <= 0:
            ...
            mem[_416 + ceil32(return_data.size) + 329 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 0
            mem[_416 + ceil32(return_data.size) + 421 len 4] = 0
            mem[_416 + ceil32(return_data.size) + 393 len 0] = 0
            call 0xe0654c8e6fd4d733349ac7e09f6f23da256bf475 with:
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), 0) << 256, mem[_416 + ceil32(return_data.size) + 393 len 4]
            if not return_data.size:
                if not ext_call.success:
                    if mem[96] > 0:
                        revert with memory
