...
function sub_a356aa65(?) {
    mem[96] = 7
    mem[64] = 352
    mem[128 len 224] = code.data[12955 len 224]
    idx = 1
    while idx <= 6:
        mem[0] = idx
        mem[32] = 12
...
function sub_c5ca93a7(?) {
    ...
    mem[128 len 32 * stor1[arg1].field_1536] = code.data[12955 len 32 * stor1[arg1].field_1536]
    mem[(32 * stor1[arg1].field_1536) + 128] = stor1[arg1].field_1536
    mem[(32 * stor1[arg1].field_1536) + 160 len 32 * stor1[arg1].field_1536] = code.data[12955 len 32 * stor1[arg1].field_1536]
    mem[(64 * stor1[arg1].field_1536) + 160] = stor1[arg1].field_1536
    mem[64] = (98 * stor1[arg1].field_1536) + 192
    mem[(64 * stor1[arg1].field_1536) + 192 len 32 * stor1[arg1].field_1536] = code.data[12955 len 32 * stor1[arg1].field_1536]
    idx = 1
    s = 0
    while idx <= stor1[arg1].field_1536:
        require s < mem[96]
