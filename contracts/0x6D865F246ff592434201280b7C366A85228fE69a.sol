...
#  - reinvest()
#
const sub_0d35f241(?) = 0x9083ea3756bde6ee6f27a6e996806fbd37f6f093

const sub_50d7d613(?) = 0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52

const sub_7f9eaef5(?) = 0x5cc61a78f164885776aa610fb0fe1257df78e59b

const sub_d8f06c26(?) = 0xef45d134b73241eda7703fa787148d9c9f4950b0
...
function stop() payable {
    ...
    call 0x9083ea3756bde6ee6f27a6e996806fbd37f6f093.withdrawAll(uint256 arg1) with:
...
function totalTokenBalance() payable {
    ...
    staticcall 0x9083ea3756bde6ee6f27a6e996806fbd37f6f093.userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args sub_cd4c4024, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not arg1:
        ...
        if 0 / totalShareBalance <= ext_call.return_data[0]:
            ...
            call 0x9083ea3756bde6ee6f27a6e996806fbd37f6f093.withdraw(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args sub_cd4c4024, (0 / totalShareBalance) - ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if sub_b433d112 + sub_957be30c[msg.sender] < sub_957be30c[msg.sender]:
                revert with 0, 'SafeMath: addition overflow'
            if sub_b433d112 + sub_957be30c[msg.sender] <= block.timestamp:
                ...
                if not 0 / totalShareBalance:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(wantTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[520 len 64] = 0, msg.sender, Mask(224, 32, (0 / totalShareBalance) - (sub_b6106f3f * 0 / totalShareBalance / 1000)) >> 32
                        call wantTokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args (0 / totalShareBalance) - (sub_b6106f3f * 0 / totalShareBalance / 1000), mem[456 len 28], mem[584 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0x7345524332303a206275726e20616d6f756e7420657863656564732062616c616e63
                        else:
                        ...
                        if not ext_code.size(wantTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 521 len 64] = 0, msg.sender, Mask(224, 32, (0 / totalShareBalance) - (sub_b6106f3f * 0 / totalShareBalance / 1000)) >> 32
                        call wantTokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args (0 / totalShareBalance) - (sub_b6106f3f * 0 / totalShareBalance / 1000), mem[ceil32(return_data.size) + 457 len 28], mem[ceil32(return_data.size) + 585 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0x7345524332303a206275726e20616d6f756e7420657863656564732062616c616e63
                        else:
        ...
        if (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance <= ext_call.return_data[0]:
            ...
            if sub_b433d112 + sub_957be30c[msg.sender] <= block.timestamp:
                ...
                if not (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(wantTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[520 len 64] = 0, msg.sender, Mask(224, 32, ((ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance) - (sub_b6106f3f * (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance / 1000)) >> 32
                        call wantTokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args ((ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance) - (sub_b6106f3f * (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance / 1000), mem[456 len 28], mem[584 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0x7345524332303a206275726e20616d6f756e7420657863656564732062616c616e63
                        else:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.size(wantTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 521 len 64] = 0, msg.sender, Mask(224, 32, ((ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance) - (sub_b6106f3f * (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance / 1000)) >> 32
                            call wantTokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args ((ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance) - (sub_b6106f3f * (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance / 1000), mem[ceil32(return_data.size) + 457 len 28], mem[ceil32(return_data.size) + 585 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0x7345524332303a206275726e20616d6f756e7420657863656564732062616c616e63
                            else:
            ...
            call 0x9083ea3756bde6ee6f27a6e996806fbd37f6f093.withdraw(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args sub_cd4c4024, ((ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShareBalance) - ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if sub_b433d112 + sub_957be30c[msg.sender] < sub_957be30c[msg.sender]:
                revert with 0, 'SafeMath: addition overflow'
    ...
    if not balanceOf[address(msg.sender)]:
        ...
        if (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalShareBalance <= ext_call.return_data[0]:
            ...
            if sub_b433d112 + sub_957be30c[msg.sender] <= block.timestamp:
                ...
                if (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalShareBalance:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(wantTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[520 len 64] = 0, msg.sender, Mask(224, 32, (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalShareBalance) >> 32
                        call wantTokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalShareBalance, mem[456 len 28], mem[584 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0x7345524332303a206275726e20616d6f756e7420657863656564732062616c616e63
                        else:
                        ...
                        if not ext_code.size(wantTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 521 len 64] = 0, msg.sender, Mask(224, 32, (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalShareBalance) >> 32
                        call wantTokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalShareBalance, mem[ceil32(return_data.size) + 457 len 28], mem[ceil32(return_data.size) + 585 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0x7345524332303a206275726e20616d6f756e7420657863656564732062616c616e63
                        else:
            ...
            call 0x9083ea3756bde6ee6f27a6e996806fbd37f6f093.withdraw(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args sub_cd4c4024, ((ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalShareBalance) - ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if sub_b433d112 + sub_957be30c[msg.sender] < sub_957be30c[msg.sender]:
                revert with 0, 'SafeMath: addition overflow'
