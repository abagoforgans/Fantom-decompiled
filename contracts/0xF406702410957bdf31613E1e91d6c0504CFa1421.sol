...
function hasAssets() payable {
    ...
    staticcall cTokenAddress.balanceOf(address arg1) with:
...
function apr() payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    if 2300000 * ext_call.return_data[0] / ext_call.return_data[0] != 2300000:
        revert with 0, 'SafeMath: multiplication overflow'
    return (2300000 * ext_call.return_data[0])
}
    ...
    if not ext_call.return_data[0]:
        ...
        if ext_call.return_data[0] < dustThreshold:
            ...
            if ext_call.return_data[0] < ext_call.return_data[0]:
                revert with 0, 'SafeMath: addition overflow'
            if ext_call.return_data[0] >= dustThreshold:
                if not 2300000 * ext_call.return_data[0]:
                    return 0
                if 2300000 * ext_call.return_data[0] * ext_call.return_data[0] / 2300000 * ext_call.return_data[0] != ext_call.return_data[0]:
                    revert with 0, 'SafeMath: multiplication overflow'
                return (2300000 * ext_call.return_data[0] * ext_call.return_data[0])
        else:
            require ext_code.size(cTokenAddress)
            staticcall cTokenAddress.exchangeRateStored() with:
                    gas gas_remaining wei
            ...
            if not ext_call.return_data[0]:
                ...
                if (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + ext_call.return_data[0] >= dustThreshold:
                    if not 2300000 * ext_call.return_data[0]:
                        return 0
                    if (2300000 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0]) + (2300000 * ext_call.return_data[0] * ext_call.return_data[0]) / 2300000 * ext_call.return_data[0] != (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) + ext_call.return_data[0]:
                        revert with 0, 'SafeMath: multiplication overflow'
                    return ((2300000 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0]) + (2300000 * ext_call.return_data[0] * ext_call.return_data[0]))
        if 2300000 * ext_call.return_data[0]:
            if 0 / 2300000 * ext_call.return_data[0]:
                revert with 0, 'SafeMath: multiplication overflow'
    return 0
}
...
function emergencyWithdraw(uint256 arg1) payable {
    ...
    if msg.sender == address(strategyAddress):
        ...
        if msg.sender == ext_call.return_data[12 len 20]:
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(6 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), address(ext_call.return_data[0]) << 64, 0, ext_call.return_data[0], 0
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(7 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), address(ext_call.return_data[0]) << 64, 0, ext_call.return_data[0], 0
    ...
    if msg.sender == address(strategyAddress):
        ...
        if dustThreshold + arg1 >= 2 * ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] <= dustThreshold:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(4 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0], 0
                mem[(4 * ceil32(return_data.size)) + 328] = 0
                call wantAddress with:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(7 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0], 0
                mem[(7 * ceil32(return_data.size)) + 328] = 0
                call wantAddress with:
                   funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0], 0) >> 224
                     gas gas_remaining wei
            ...
            if ext_call.return_data[0] >= arg1:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), arg1, 0
                mem[(2 * ceil32(return_data.size)) + 328] = 0
                call wantAddress with:
                   funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), arg1, 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), arg1, 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
            ...
            if ext_call.return_data[0] <= 1:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(6 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0], 0
                mem[(6 * ceil32(return_data.size)) + 328] = 0
                call wantAddress with:
                   funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0], 0) >> 224
                     gas gas_remaining wei
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(7 * ceil32(return_data.size)) + 324 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0], 0
        ...
        if msg.sender == ext_call.return_data[12 len 20]:
            ...
            if dustThreshold + arg1 >= 2 * ext_call.return_data[0]:
                ...
                if ext_call.return_data[0] <= dustThreshold:
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(8 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0], 0
                ...
                if ext_call.return_data[0] >= arg1:
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(4 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), arg1, 0
                    mem[(4 * ceil32(return_data.size)) + 328] = 0
                    call wantAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), arg1, 0) >> 224
                         gas gas_remaining wei
                ...
                if ext_call.return_data[0] <= 1:
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(8 * ceil32(return_data.size)) + 324 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0], 0
            ...
            if dustThreshold + arg1 >= 2 * ext_call.return_data[0]:
                ...
                if ext_call.return_data[0] <= dustThreshold:
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(10 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0], 0
                ...
                if ext_call.return_data[0] >= arg1:
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(6 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), arg1, 0
                    mem[(6 * ceil32(return_data.size)) + 328] = 0
                    call wantAddress with:
                       funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), arg1, 0) >> 224
                         gas gas_remaining wei
                ...
                if ext_call.return_data[0] <= 1:
                    ...
                    mem[(10 * ceil32(return_data.size)) + 192 len 4] = transfer(address arg1, uint256 arg2)
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(10 * ceil32(return_data.size)) + 324 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0], 0
