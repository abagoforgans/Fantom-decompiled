...
const name = 'Berry Chain'

const decimals = 8

const requestMinimum = 10^15
            ...
            if tokensPerEth * msg.value / 10^18:
                ...
                if stor4[address(msg.sender)]:
                    ...
                    if progress0drop > target0drop:
                        ...
                        require not distributionFinished
                        require totalDistributed + 10^10 >= totalDistributed
                        totalDistributed += 10^10
                        require balanceOf[address(msg.sender)] + 10^10 >= balanceOf[address(msg.sender)]
                        balanceOf[address(msg.sender)] += 10^10
                        emit Distr(10^10, msg.sender);
                        emit Transfer(10^10, 0, msg.sender);
