...
function getPairFor(address arg1, address arg2, address arg3) payable {
    ...
    if arg2 < arg3:
        ...
        return address(sha3(0, arg1, sha3(arg2, arg3), 0x882206a53d4b9e879052eb48cae33b526c71fa965196aac9d794897c3305223a))
    if not arg3:
        revert with 0, 'UniswapV2Library: ZERO_ADDRESS'
    return address(sha3(0, arg1, sha3(arg3, arg2), 0x882206a53d4b9e879052eb48cae33b526c71fa965196aac9d794897c3305223a))
}
...
function sub_4ce6e8e6(?) payable {
    ...
    if arg2 < arg3:
        ...
        if arg2 < arg3:
            if not arg2:
                revert with 0, 'UniswapV2Library: ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, arg1, sha3(arg2, arg3), 0x882206a53d4b9e879052eb48cae33b526c71fa965196aac9d794897c3305223a)))
            staticcall address(sha3(0, arg1, sha3(arg2, arg3), 0x882206a53d4b9e879052eb48cae33b526c71fa965196aac9d794897c3305223a)).getReserves() with:
                    gas gas_remaining wei
        else:
            if not arg3:
                revert with 0, 'UniswapV2Library: ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, arg1, sha3(arg3, arg2), 0x882206a53d4b9e879052eb48cae33b526c71fa965196aac9d794897c3305223a)))
            staticcall address(sha3(0, arg1, sha3(arg3, arg2), 0x882206a53d4b9e879052eb48cae33b526c71fa965196aac9d794897c3305223a)).getReserves() with:
                    gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function sortTokens(address arg1, address arg2) payable {
    ...
    if not _292 % 32:
        ...
        return address(arg2), 
               Array(len=mem[_292 + floor32(_20) + (2 * ceil32(return_data.size)) + 384 len floor32(mem[ceil32(return_data.size) + 96]) + 64], data=mem[floor32(_20) + (2 * ceil32(return_data.size)) + 160], mem[_292 + floor32(_20) + (2 * ceil32(return_data.size)) + floor32(mem[ceil32(return_data.size) + 96]) + 480 len floor32(mem[floor32(_20) + (2 * ceil32(return_data.size)) + 160]) + 32]),
               ext_call.return_data[0] << 248,
               address(arg1),
               mem[_292 + floor32(_20) + (2 * ceil32(return_data.size)) + 320],
               ext_call.return_data[0] << 248
    ...
    return address(arg2), 
           Array(len=mem[floor32(_292) + floor32(_20) + (2 * ceil32(return_data.size)) + 416 len floor32(mem[ceil32(return_data.size) + 96]) + 64], data=mem[floor32(_20) + (2 * ceil32(return_data.size)) + 160], mem[floor32(_292) + floor32(_20) + (2 * ceil32(return_data.size)) + floor32(mem[ceil32(return_data.size) + 96]) + 512 len floor32(mem[floor32(_20) + (2 * ceil32(return_data.size)) + 160]) + 32]),
           ext_call.return_data[0] << 248,
           address(arg1),
           mem[floor32(_292) + floor32(_20) + (2 * ceil32(return_data.size)) + 352],
           ext_call.return_data[0] << 248
