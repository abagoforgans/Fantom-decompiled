...
function denied(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
...
function deny(address arg1) payable {
    ...
    if stor2[address(arg1)]:
        revert with 0, 'ERC20: Account already denied'
...
function allow(address arg1) payable {
    ...
    if not stor2[address(arg1)]:
        revert with 0, 'ERC20: Account already allowed'
    stor2[address(arg1)] = 0
    emit 0x16c61d72: arg1
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if stor2[address(msg.sender)]:
        revert with 0, 'ERC20: Sender is denied'
    if stor2[address(arg1)]:
        revert with 0, 'ERC20: Recipient is denied'
    if not msg.sender:
