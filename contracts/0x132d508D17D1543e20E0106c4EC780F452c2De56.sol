...
function pause() payable {
    if msg.sender == owner:
        ...
        mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0
        ...
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0
...
function unpause() payable {
    if msg.sender == owner:
        ...
        if ext_code.size(wantAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        call wantAddress with:
           funct uint32(stor11)
             gas gas_remaining wei
        ...
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), -1
            if not approve(address arg1, uint256 arg2), Mask(224, 0, stor11):
                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        ...
        call wantAddress with:
           funct uint32(stor11)
             gas gas_remaining wei
            args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor11), uint32(stor11), -1
            if not approve(address arg1, uint256 arg2), Mask(224, 0, stor11):
            ...
            if tx.origin == owner:
                ...
                if paused:
                    ...
                    if not arg1:
                        ...
                        if ext_code.size(wantAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, arg1 - (arg1 * withdrawalFee / 10000)) >> 32
                        mem[352 len 4] = 0
                        call wantAddress with:
                           funct uint32(stor3)
                             gas gas_remaining wei
                        ...
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), arg1 - (arg1 * withdrawalFee / 10000)
                            if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor3):
                                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                            if not paused:
                                require ext_code.size(wantAddress)
            ...
            if tx.origin == owner:
                ...
                if paused:
                    ...
                    if not arg1:
                        ...
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transfer(address arg1, uint256 arg2), address(vaultAddress), arg1 - (arg1 * withdrawalFee / 10000)
                            if not 0, Mask(224, 0, stor3):
                                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                            if not paused:
                                require ext_code.size(wantAddress)
