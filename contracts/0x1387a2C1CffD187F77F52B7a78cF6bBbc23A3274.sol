...
function prepareForPreSale() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    uint256(stor32.field_0) = 0xffffffffffffffff00ff00ffffffffffffffffffffffffffffffffffffffffff and uint256(stor32.field_0)
    _taxFee = 0
    sub_68839377 = 0
    stor22 = 0
    _maxTxAmount = 10^18
...
function updateSwapBackSettings(bool arg1, bool arg2, uint256 arg3) {
    ...
    if arg1 != bool(swapAndLiquifyEnabled):
...
function setTaxes(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, bool arg7) {
    ...
    if _liquidityFee + _marketingFee < _liquidityFee:
        revert with 0, 'SafeMath: addition overflow'
    if _liquidityFee + _marketingFee > !_devFee:
        revert with 0, 17
    if _devFee < 0:
        revert with 0, 'SafeMath: addition overflow'
    if _liquidityFee + _marketingFee + _devFee > !_teamFee:
        revert with 0, 17
    if _teamFee < 0:
        revert with 0, 'SafeMath: addition overflow'
    sub_68839377 = _liquidityFee + _marketingFee + _devFee + _teamFee
    stor22 = _liquidityFee + _marketingFee + _devFee + _teamFee
}
