...
function multiTransfer(address[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        if not taxEnabled:
            if balanceOf[address(mem[(32 * idx) + 128])] > -mem[(32 * idx) + (32 * arg1.length) + 160] - 1:
                revert with 'NH{q', 17
            mem[0] = mem[(32 * idx) + 140 len 20]
            mem[32] = 0
            balanceOf[address(mem[(32 * idx) + 128])] += mem[(32 * idx) + (32 * arg1.length) + 160]
            mem[mem[64]] = mem[(32 * idx) + (32 * arg1.length) + 160]
            emit Transfer(_124, msg.sender, address(_122));
        else:
            if mem[(32 * idx) + (32 * arg1.length) + 160] and stor9 > -1 / mem[(32 * idx) + (32 * arg1.length) + 160]:
                revert with 'NH{q', 17
            if mem[(32 * idx) + (32 * arg1.length) + 160] and stor8 > -1 / mem[(32 * idx) + (32 * arg1.length) + 160]:
                revert with 'NH{q', 17
            if mem[(32 * idx) + (32 * arg1.length) + 160] * stor9 / 100 > -(mem[(32 * idx) + (32 * arg1.length) + 160] * stor8 / 100) - 1:
                revert with 'NH{q', 17
            if mem[(32 * idx) + (32 * arg1.length) + 160] < (mem[(32 * idx) + (32 * arg1.length) + 160] * stor9 / 100) + (mem[(32 * idx) + (32 * arg1.length) + 160] * stor8 / 100):
                revert with 'NH{q', 17
            if balanceOf[stor6] > -(mem[(32 * idx) + (32 * arg1.length) + 160] * stor9 / 100) - 1:
                revert with 'NH{q', 17
            balanceOf[stor6] += mem[(32 * idx) + (32 * arg1.length) + 160] * stor9 / 100
            if balanceOf[address(mem[(32 * idx) + 128])] > -mem[(32 * idx) + (32 * arg1.length) + 160] + (mem[(32 * idx) + (32 * arg1.length) + 160] * stor9 / 100) + (mem[(32 * idx) + (32 * arg1.length) + 160] * stor8 / 100) - 1:
                revert with 'NH{q', 17
            balanceOf[address(mem[(32 * idx) + 128])] = balanceOf[address(mem[(32 * idx) + 128])] + mem[(32 * idx) + (32 * arg1.length) + 160] - (mem[(32 * idx) + (32 * arg1.length) + 160] * stor9 / 100) - (mem[(32 * idx) + (32 * arg1.length) + 160] * stor8 / 100)
            if totalSupply < mem[(32 * idx) + (32 * arg1.length) + 160] * stor8 / 100:
                revert with 'NH{q', 17
            totalSupply -= mem[(32 * idx) + (32 * arg1.length) + 160] * stor8 / 100
            mem[0] = msg.sender
            mem[32] = 2
            if not stor2[address(msg.sender)]:
                emit Transfer((mem[(32 * idx) + (32 * arg1.length) + 160] - (mem[(32 * idx) + (32 * arg1.length) + 160] * stor9 / 100) - (mem[(32 * idx) + (32 * arg1.length) + 160] * stor8 / 100)), msg.sender, mem[(32 * idx) + 140 len 20]);
                emit Transfer((mem[(32 * idx) + (32 * arg1.length) + 160] * stor9 / 100), msg.sender, marketingAddress);
                mem[mem[64]] = mem[(32 * idx) + (32 * arg1.length) + 160] * stor8 / 100
            else:
                if stor10 == -1:
                    revert with 'NH{q', 17
                stor10++
                ...
                if not stor7:
                    revert with 'NH{q', 18
                if sha3(mem[_141 + 32 len mem[_141]]) % stor7 == 1:
                    require _124 - (_124 * stor9 / 100) - (_124 * stor8 / 100)
                    if totalSupply > -_124 + (_124 * stor9 / 100) + (_124 * stor8 / 100) - 1:
                        revert with 'NH{q', 17
                    totalSupply = totalSupply + _124 - (_124 * stor9 / 100) - (_124 * stor8 / 100)
                    mem[0] = address(_122)
                    mem[32] = 0
                    if balanceOf[address(_122)] > -_124 + (_124 * stor9 / 100) + (_124 * stor8 / 100) - 1:
                        revert with 'NH{q', 17
                    balanceOf[address(_122)] = balanceOf[address(_122)] + _124 - (_124 * stor9 / 100) - (_124 * stor8 / 100)
                    emit Transfer((_124 - (_124 * stor9 / 100) - (_124 * stor8 / 100)), 0, address(_122));
                emit Transfer((_124 - (_124 * stor9 / 100) - (_124 * stor8 / 100)), msg.sender, address(_122));
                emit Transfer((_124 * stor9 / 100), msg.sender, marketingAddress);
                mem[_137 + 128] = _124 * stor8 / 100
            emit Transfer((_124 * stor8 / 100), msg.sender, 0);
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
