...
function sub_87bb0bdb(?) payable {
    ...
    if 27 == uint8((bool(mem[(32 * ('cd', 68).length) + 738]) >> 255) + 27):
        ...
        while idx < ('cd', 68).length:
            ...
            staticcall address(cd[36]).isOwnerOf(address arg1, uint256 arg2) with:
                    gas gas_remaining wei
        ...
        if not sub_e32ead2d[cd[4]].field_512:
            if not sub_e32ead2d[cd[4]].field_256:
                ...
                require ext_code.size(address(cd[36]))
                call address(cd[36]).burnBatch(address arg1, uint256[] arg2) with:
                     gas gas_remaining wei
                        ...
                        if not sub_e32ead2d[cd[4]].field_512:
                            if not sub_e32ead2d[cd[4]].field_256:
                                ...
                                if 27 == uint8((bool(mem[(32 * ('cd', 68).length) + (32 * ('cd', 100).length) + 866]) >> 255) + 27):
                                    ...
                                    require ext_code.size(address(cd[36]))
                                    call address(cd[36]).mintBatch(address arg1, uint256 arg2, uint256[] arg3) with:
                                         gas gas_remaining wei
                                ...
                                if 27 == uint8((bool(mem[ceil32(return_data.size) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + 866]) >> 255) + 27):
                                    ...
                                    mem[(2 * ceil32(return_data.size)) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + ceil32(('cd', 132).length) + 866] = mem[ceil32(return_data.size) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + ceil32(('cd', 132).length) + mem[ceil32(return_data.size) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + ceil32(('cd', 132).length) + 866 len 4], Mask(224, 32, msg.sender) >> 32 + 866]
                            ...
                            if not return_data.size:
                                ...
                                if not sub_e32ead2d[cd[4]].field_256:
                                    ...
                                    if 27 == uint8((bool(mem[ceil32(return_data.size) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + 898]) >> 255) + 27):
                                        ...
                                        mem[(2 * ceil32(return_data.size)) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + ceil32(('cd', 132).length) + 898] = mem[ceil32(return_data.size) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + ceil32(('cd', 132).length) + mem[ceil32(return_data.size) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + ceil32(('cd', 132).length) + 898 len 4], Mask(224, 32, msg.sender) >> 32 + 898]
                                ...
                                if not sub_e32ead2d[cd[4]].field_256:
                                    ...
                                    if 27 == uint8((bool(mem[ceil32(return_data.size) + ceil32(return_data.size) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + 899]) >> 255) + 27):
                                        ...
                                        mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + ceil32(('cd', 132).length) + 899] = mem[ceil32(return_data.size) + ceil32(return_data.size) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + ceil32(('cd', 132).length) + mem[ceil32(return_data.size) + ceil32(return_data.size) + (32 * ('cd', 68).length) + (32 * ('cd', 100).length) + ceil32(('cd', 132).length) + 899 len 4], Mask(224, 32, msg.sender) >> 32 + 899]
