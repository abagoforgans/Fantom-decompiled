            ...
            if msg.value * tokensPerEth / 10^18:
                ...
                if stor4[address(msg.sender)]:
                    ...
                    if progress0drop > target0drop:
                        ...
                        require not distributionFinished
                        require totalDistributed + 100 * 10^6 >= totalDistributed
                        totalDistributed += 100 * 10^6
                        require balanceOf[address(msg.sender)] + 100 * 10^6 >= balanceOf[address(msg.sender)]
                        balanceOf[address(msg.sender)] += 100 * 10^6
                        emit Distr(100 * 10^6, msg.sender);
