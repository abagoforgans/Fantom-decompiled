...
function sub_d328a1d2(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_d328a1d2.length
    return sub_d328a1d2[arg1]
}
...
function balanceOfPool() payable {
    ...
    staticcall address(gaugeAddress).0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function retireStrat() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(gaugeAddress))
    call address(gaugeAddress).0x2e1a7d4d with:
         gas gas_remaining wei
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        staticcall wantAddress.0xdd62ed3e with:
                gas gas_remaining wei
               args address(this.address), address(gaugeAddress)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] >= ext_call.return_data[0]:
            require ext_code.size(address(gaugeAddress))
            call address(gaugeAddress).deposit(uint256 arg1) with:
                 gas gas_remaining wei
                args ext_call.return_data[0]
        else:
...
function pause() payable {
    ...
    call wantAddress with:
       funct uint32(stor7)
         gas gas_remaining wei
        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), 0) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
        ...
        if not return_data.size:
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = 0, address(gaugeAddress), 0
            call wantAddress with:
               funct uint32(stor5)
                 gas gas_remaining wei
            ...
            if return_data.size <= 0:
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 589 len 64] = 0, address(gaugeAddress), 0
                call wantAddress with:
                   funct uint32(stor5)
                     gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, ext_call.return_data[0] - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1 - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, ext_call.return_data[0] - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1 - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor12)
                         gas gas_remaining wei
    ...
    if ext_call.return_data[0] >= arg4:
        ...
        if not stor24.length:
            ...
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor24.length
        else:
            mem[0] = 24
            mem[356] = address(stor24.field_0)
            idx = 356
            s = 0
            while (32 * stor24.length) + 356 > idx + 32:
            ...
            call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor24.length, mem[356 len 32 * stor24.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if not stor24.length:
                    ...
                    mem[0] = 24
                    mem[684] = address(stor24.field_0)
                    idx = 684
                    s = 0
                    while (32 * stor24.length) + 684 > idx + 32:
                        mem[idx + 32] = stor24[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor24.length, mem[684 len 32 * stor24.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
...
function sub_675994d6(?) payable {
    ...
    if arg5 == 3:
        ...
        while outputToWantRoute.length > idx:
            ...
            continue 
        address(stor9) = arg4
        mem[260] = address(stor9)
        mem[292] = 0
        mem[224] = 68
        mem[260 len 28] = Mask(224, 0, stor9)
        mem[256 len 4] = approve(address arg1, uint256 arg2)
        mem[324] = 32
        mem[356] = 'SafeERC20: low-level call failed'
        if ext_code.size(wrappedAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[388 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0
        mem[480 len 4] = 0
        call wrappedAddress with:
           funct uint32(stor9)
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if ext_call.return_data[0]:
                revert with 0, 
                            ...
                            0x645361666545524332303a20617070726f76652066726f6d206e6f6e2d7a65726f20746f206e6f6e2d7a65726f20616c6c6f77616e63,
                            mem[510 len 10]
            mem[424] = address(stor9)
            mem[456] = -1
            mem[388] = 68
            mem[424 len 28] = Mask(224, 0, stor9)
            mem[420 len 4] = approve(address arg1, uint256 arg2)
            mem[488] = 32
            mem[520] = 'SafeERC20: low-level call failed'
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[552 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            mem[644 len 4] = 0
            call wrappedAddress with:
               funct uint32(stor9)
                 gas gas_remaining wei
            ...
            mem[ceil32(return_data.size) + 425] = address(stor9)
            mem[ceil32(return_data.size) + 457] = -1
            mem[ceil32(return_data.size) + 389] = 68
            mem[ceil32(return_data.size) + 425 len 28] = Mask(224, 0, stor9)
            ...
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 553 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        if arg5 != 2:
            ...
            while outputToWantRoute.length > idx:
                ...
                continue 
            address(stor9) = arg4
            mem[196] = address(stor9)
            mem[228] = 0
            mem[160] = 68
            mem[196 len 28] = Mask(224, 0, stor9)
            mem[192 len 4] = approve(address arg1, uint256 arg2)
            mem[260] = 32
            mem[292] = 'SafeERC20: low-level call failed'
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[324 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0
            mem[416 len 4] = 0
            mem[388 len 0] = 0
            call wrappedAddress with:
               funct uint32(stor9)
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0) << 256, mem[388 len 4]
            if not return_data.size:
                if not ext_call.success:
                    if wrappedAddress > 0:
                        revert with memory
                ...
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[488 len 64] = 0, address(stor9), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[580 len 4] = 0
                call wrappedAddress with:
                   funct uint32(stor9)
                     gas gas_remaining wei
                ...
                mem[ceil32(return_data.size) + 361] = address(stor9)
                ...
                if ext_code.size(wrappedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 489 len 64] = 0, address(stor9), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            ...
            while outputToWantRoute.length > idx:
                ...
                continue 
            address(stor9) = arg4
            mem[228] = address(stor9)
            mem[260] = 0
            mem[192] = 68
            mem[228 len 28] = Mask(224, 0, stor9)
            mem[224 len 4] = approve(address arg1, uint256 arg2)
            mem[292] = 32
            mem[324] = 'SafeERC20: low-level call failed'
            if ext_code.size(wrappedAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[356 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0
            mem[448 len 4] = 0
            call wrappedAddress with:
               funct uint32(stor9)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if wrappedAddress <= 0:
                    ...
                    if ext_call.return_data[0]:
                        revert with 0, 
                                    ...
                                    0x645361666545524332303a20617070726f76652066726f6d206e6f6e2d7a65726f20746f206e6f6e2d7a65726f20616c6c6f77616e63,
                                    mem[478 len 10]
                    mem[392] = address(stor9)
                    mem[424] = -1
                    mem[356] = 68
                    mem[392 len 28] = Mask(224, 0, stor9)
                    mem[388 len 4] = approve(address arg1, uint256 arg2)
                    mem[456] = 32
                    mem[488] = 'SafeERC20: low-level call failed'
                    if ext_code.size(wrappedAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[520 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                    mem[612 len 4] = 0
                    mem[584 len 0] = 0
                    call wrappedAddress with:
                       funct uint32(stor9)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[584 len 4]
                else:
                    require wrappedAddress >= 32
                    if not arg1:
                ...
                if return_data.size <= 0:
                    ...
                    mem[ceil32(return_data.size) + 393] = address(stor9)
                    mem[ceil32(return_data.size) + 425] = -1
                    mem[ceil32(return_data.size) + 357] = 68
                    mem[ceil32(return_data.size) + 393 len 28] = Mask(224, 0, stor9)
                    ...
                    if ext_code.size(wrappedAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 521 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                    ...
                    call wrappedAddress with:
                       funct uint32(stor9)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor9), uint32(stor9), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 585 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            if wrappedAddress > 0:
                                revert with memory
