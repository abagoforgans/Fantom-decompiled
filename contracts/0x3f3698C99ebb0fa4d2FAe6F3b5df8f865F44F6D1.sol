...
function sub_be4ee1b9(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return ((ext_call.return_data[0] * 111111111111111111111 * ext_call.return_data[0] / ext_call.return_data[0]) + (111111111111111111111 * ext_call.return_data[0] / ext_call.return_data[0]))
}
            ...
            if ext_call.success:
                ...
                if ext_call.success:
                    ...
                    while ext_call.success:
                        require return_data.size >= 32
                        require ext_code.size(0)
                        staticcall 0x0.0x18160ddd with:
                                gas gas_remaining wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        ...
                        if address(ext_call.return_data[0]) == address(ext_call.return_data[0]):
                            ...
                            require return_data.size >= 32
                            mem[32] = 6
                            sub_1fbedece[0] = (ext_call.return_data[0] * 111111111111111111111 * mem[96] / ext_call.return_data[0]) + (111111111111111111111 * mem[96] / ext_call.return_data[0])
                        else:
