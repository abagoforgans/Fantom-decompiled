...
function sub_3ab98c8c(?) payable {
    ...
    require ext_code.size(0x5a87bed287b5a591709708ec4f8f17e7c4398a32)
    staticcall 0x5a87bed287b5a591709708ec4f8f17e7c4398a32.0x3ab98c8c with:
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).poolInfo() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function vaults(uint256 arg1) payable {
    ...
    if ext_call.return_data[32] <= 0:
        revert with 0, 'dead'
    require ext_code.size(0x5a87bed287b5a591709708ec4f8f17e7c4398a32)
    staticcall 0x5a87bed287b5a591709708ec4f8f17e7c4398a32.0x8c64ea4a with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
