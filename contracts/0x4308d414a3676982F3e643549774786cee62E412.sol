...
function sub_be4ee1b9(?) {
    ...
    if ext_call.return_data[12 len 20] != address(ext_call.return_data[0]):
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        return ((ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) * ext_call.return_data[0]) + (Mask(112, 0, ext_call.return_data[32]) * ext_call.return_data[0]))
    staticcall arg1.price1CumulativeLast() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return ((ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * ext_call.return_data[0]) + (Mask(112, 0, ext_call.return_data[0]) * ext_call.return_data[0]))
}
                    ...
                    while ext_call.success:
                        ...
                        if address(ext_call.return_data[0]) == address(ext_call.return_data[0]):
                            ...
                            if address(ext_call.return_data[0]) != address(ext_call.return_data[0]):
                                ...
                                require return_data.size >= 32
                                mem[32] = 6
                                sub_1fbedece[0] = (ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) * mem[96]) + (Mask(112, 0, ext_call.return_data[32]) * mem[96])
                            else:
                                ...
                                require return_data.size >= 32
                                mem[32] = 6
                                sub_1fbedece[0] = (ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * mem[96]) + (Mask(112, 0, ext_call.return_data[0]) * mem[96])
                        else:
