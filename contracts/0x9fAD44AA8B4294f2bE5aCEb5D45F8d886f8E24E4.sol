...
function sub_9bf4ec2f(?) payable {
    ...
    require arg1 == arg1
    if stor1[arg1].field_1280:
        if stor1[arg1].field_1280 == stor1[arg1].field_1281 < 32:
            revert with 'NH{q', 34
        if stor1[arg1].field_1280:
            if stor1[arg1].field_1280 == stor1[arg1].field_1281 < 32:
                revert with 'NH{q', 34
            if stor1[arg1].field_1281:
                if 31 >= stor1[arg1].field_1281:
                    mem[128] = 256 * stor1[arg1].field_1288
                else:
                    mem[128] = stor1[arg1][5].field_0
                    idx = 128
                    s = 0
                    while stor1[arg1].field_1281 + 96 > idx:
                        mem[idx + 32] = stor1[arg1][s + 5].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
        else:
        ...
        return stor1[arg1].field_0, 
               ...
               Array(len=2 * Mask(256, -1, stor1[arg1].field_1281), data=mem[128 len ceil32(stor1[arg1].field_1281)])
    if stor1[arg1].field_1280 == stor1[arg1].field_1281 < 32:
        revert with 'NH{q', 34
    if stor1[arg1].field_1280:
        if stor1[arg1].field_1280 == stor1[arg1].field_1281 < 32:
    ...
    return stor1[arg1].field_0, 
           ...
           stor1[arg1].field_768,
           stor1[arg1].field_1024,
           Array(len=stor1[arg1].field_1280, data=mem[128 len ceil32(stor1[arg1].field_1281)])
}
