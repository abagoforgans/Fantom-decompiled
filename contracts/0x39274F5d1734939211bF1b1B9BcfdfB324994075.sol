    ...
    if not arg4.length % 32:
        ...
        if not Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, 0), mem[(32 * arg2.length) + (32 * arg3.length) + arg4.length + 224 len -arg4.length + ceil32(arg4.length)] % 32:
            ...
            call address(create.new_address) with:
               funct Mask(32, -(8 * ceil32(arg5.length) + -arg5.length + 4) + 256, 0) >> -(8 * ceil32(arg5.length) + -arg5.length + 4) + 256
                 gas gas_remaining wei
                args mem[(32 * arg2.length) + (32 * arg3.length) + ceil32(arg4.length) + ceil32(arg5.length) + 228 len floor32(Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, 0), mem[(32 * arg2.length) + (32 * arg3.length) + arg4.length + 224 len -arg4.length + ceil32(arg4.length)]) + arg4.length + (32 * arg3.length) + (32 * arg2.length) + 416]
    else:
        ...
        if not Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, 0), mem[(32 * arg2.length) + (32 * arg3.length) + arg4.length + 224 len -arg4.length + ceil32(arg4.length)] % 32:
            ...
            call address(create.new_address) with:
               funct Mask(32, -(8 * ceil32(arg5.length) + -arg5.length + 4) + 256, 0) >> -(8 * ceil32(arg5.length) + -arg5.length + 4) + 256
                 gas gas_remaining wei
                args mem[(32 * arg2.length) + (32 * arg3.length) + ceil32(arg4.length) + ceil32(arg5.length) + 228 len floor32(Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, 0), mem[(32 * arg2.length) + (32 * arg3.length) + arg4.length + 224 len -arg4.length + ceil32(arg4.length)]) + floor32(arg4.length) + (32 * arg3.length) + (32 * arg2.length) + 448]
