...
function sub_26689dbb(?) payable {
    ...
    if not s:
        ...
        mem[mem[64] + 64 len 32 * _54] = mem[_19 + 32 len 32 * _54]
        return 32, mem[mem[64] + 32 len (32 * _54) + 32]
    mem[_19 + 32 len 32 * s] = call.data[calldata.size len 32 * s]
    idx = 0
    s = 0
    while idx < ('cd', 4).length:
        mem[mem[64] + 4] = cd[((32 * idx) + cd[4] + 36)]
    ...
    _56 = mem[_19]
    mem[mem[64] + 32] = mem[_19]
    mem[mem[64] + 64 len 32 * _56] = mem[_19 + 32 len 32 * _56]
    return 32, mem[mem[64] + 32 len (32 * _56) + 32]
}
...
function sub_ac4fd404(?) payable {
    ...
    if not s:
        ...
        mem[mem[64] + 64 len 32 * _74] = mem[_27 + 32 len 32 * _74]
        return 32, mem[mem[64] + 32 len (32 * _74) + 32]
    mem[_27 + 32 len 32 * s] = call.data[calldata.size len 32 * s]
    idx = 0
    s = 0
    while idx < ('cd', 4).length:
        mem[mem[64] + 4] = cd[((32 * idx) + cd[4] + 36)]
    ...
    _76 = mem[_27]
    mem[mem[64] + 32] = mem[_27]
    mem[mem[64] + 64 len 32 * _76] = mem[_27 + 32 len 32 * _76]
    return 32, mem[mem[64] + 32 len (32 * _76) + 32]
}
