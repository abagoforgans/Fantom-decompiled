...
function findOnePercent(uint256 arg1) payable {
    ...
    return (arg1 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6)
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if not arg2 + basePercent - 1 / basePercent:
        ...
        if not arg2 + basePercent - 1 / basePercent * basePercent:
            ...
            require arg2 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6 <= arg2
            require arg2 <= balanceOf[address(msg.sender)]
            balanceOf[address(msg.sender)] -= arg2
            require balanceOf[address(arg1)] + arg2 - (arg2 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6) >= balanceOf[address(arg1)]
            balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 - (arg2 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6)
            require arg2 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6 <= totalSupply
            totalSupply -= arg2 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6
            emit Transfer((arg2 - (arg2 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6)), msg.sender, arg1);
            emit Transfer((arg2 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6), msg.sender, 0);
    return 1
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if not arg3 + basePercent - 1 / basePercent:
        ...
        if not arg3 + basePercent - 1 / basePercent * basePercent:
            ...
            require arg3 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6 <= arg3
            require balanceOf[address(arg2)] + arg3 - (arg3 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6) >= balanceOf[address(arg2)]
            balanceOf[address(arg2)] = balanceOf[address(arg2)] + arg3 - (arg3 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6)
            require arg3 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6 <= totalSupply
            totalSupply -= arg3 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6
            require arg3 <= allowance[address(arg1)][address(msg.sender)]
            allowance[address(arg1)][address(msg.sender)] -= arg3
            emit Transfer((arg3 - (arg3 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6)), arg1, arg2);
            emit Transfer((arg3 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6), arg1, 0);
    return 1
}
    ...
    while idx < arg1.length:
        ...
        if not mem[(32 * idx) + (32 * arg1.length) + 160] + basePercent - 1 / basePercent:
            ...
            if not mem[(32 * idx) + (32 * arg1.length) + 160] + basePercent - 1 / basePercent * basePercent:
                ...
                require mem[(32 * idx) + (32 * arg1.length) + 160] + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6 <= mem[(32 * idx) + (32 * arg1.length) + 160]
                require mem[(32 * idx) + (32 * arg1.length) + 160] <= balanceOf[address(msg.sender)]
                balanceOf[address(msg.sender)] -= mem[(32 * idx) + (32 * arg1.length) + 160]
                require balanceOf[address(mem[(32 * idx) + 128])] + mem[(32 * idx) + (32 * arg1.length) + 160] - (mem[(32 * idx) + (32 * arg1.length) + 160] + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6) >= balanceOf[address(mem[(32 * idx) + 128])]
                mem[0] = mem[(32 * idx) + 140 len 20]
                mem[32] = 3
                balanceOf[address(mem[(32 * idx) + 128])] = balanceOf[address(mem[(32 * idx) + 128])] + mem[(32 * idx) + (32 * arg1.length) + 160] - (mem[(32 * idx) + (32 * arg1.length) + 160] + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6)
                require mem[(32 * idx) + (32 * arg1.length) + 160] + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6 <= totalSupply
                totalSupply -= mem[(32 * idx) + (32 * arg1.length) + 160] + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6
                mem[(32 * arg1.length) + (32 * arg2.length) + 160] = mem[(32 * idx) + (32 * arg1.length) + 160] - (mem[(32 * idx) + (32 * arg1.length) + 160] + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6)
                emit Transfer(mem[(32 * arg1.length) + (32 * arg2.length) + 160], msg.sender, address(_35));
                mem[(32 * arg1.length) + (32 * arg2.length) + 160] = _37 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6
                emit Transfer((_37 + basePercent - 1 / basePercent * basePercent * basePercent / 10 * 10^6), msg.sender, 0);
        idx = idx + 1
        continue 
}
