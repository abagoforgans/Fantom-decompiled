...
function royaltyInfo(uint256 arg1, uint256 arg2) {
    ...
    if arg2 / 1000 and royaltyFee > -1 / arg2 / 1000:
        revert with 0, 17
    return stor16, arg2 / 1000 * royaltyFee
}
...
function ownerMint(uint256 arg1, address arg2) {
    ...
    if tokenByIndex.length > !arg1:
        revert with 0, 17
    require tokenByIndex.length + arg1 <= maxMint
    if tokenByIndex.length > !arg1:
        revert with 0, 17
    if tokenByIndex.length >= tokenByIndex.length + arg1:
    # nil
}
...
function sub_8bd7da33(?) payable {
    ...
    if 4 > !tokenByIndex.length:
        revert with 0, 17
    require tokenByIndex.length + 4 < maxMint
    ...
    call stor20 with:
       value 5 * mintFee / 5 wei
         gas 2300 * is_zero(value) wei
    if tokenByIndex.length > tokenByIndex.length + 4:
    # nil
}
...
function sub_3e839c26(?) payable {
    ...
    if 49 > !tokenByIndex.length:
        revert with 0, 17
    require tokenByIndex.length + 49 < maxMint
    ...
    call stor20 with:
       value 45 * mintFee / 5 wei
         gas 2300 * is_zero(value) wei
    if tokenByIndex.length > tokenByIndex.length + 49:
    # nil
}
...
function sub_a2878c39(?) payable {
    ...
    if 19 > !tokenByIndex.length:
        revert with 0, 17
    require tokenByIndex.length + 19 < maxMint
    ...
    call stor20 with:
       value 19 * mintFee / 5 wei
         gas 2300 * is_zero(value) wei
    if tokenByIndex.length > tokenByIndex.length + 19:
    # nil
}
...
function sub_f5ed3149(?) payable {
    ...
    if 99 > !tokenByIndex.length:
        revert with 0, 17
    require tokenByIndex.length + 99 < maxMint
    ...
    call stor20 with:
       value 90 * mintFee / 5 wei
         gas 2300 * is_zero(value) wei
    if tokenByIndex.length > tokenByIndex.length + 99:
    # nil
}
...
function sub_84f51f13(?) payable {
    ...
    if 199 > !tokenByIndex.length:
        revert with 0, 17
    require tokenByIndex.length + 199 < maxMint
    ...
    call stor20 with:
       value 180 * mintFee / 5 wei
         gas 2300 * is_zero(value) wei
    if tokenByIndex.length > tokenByIndex.length + 199:
    # nil
}
...
function publicMint() payable {
    ...
    require tokenByIndex.length < maxMint
