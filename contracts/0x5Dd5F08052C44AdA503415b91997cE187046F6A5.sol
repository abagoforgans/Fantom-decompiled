...
function withdrawMainToken(uint256 arg1) payable {
    ...
    rewardRate = 0
    require ext_code.size(mainTokenAddress)
    call mainTokenAddress.transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function notifyRewardAmount(uint256 arg1) payable {
        ...
        if block.timestamp >= periodFinish:
            ...
            if not periodFinish - block.timestamp:
                ...
                if (periodFinish * rewardRate) - (block.timestamp * rewardRate) + arg1 < arg1:
                    revert with 0, 'SafeMath: addition overflow'
                rewardRate = (periodFinish * rewardRate) - (block.timestamp * rewardRate) + arg1 / 2160 * 24 * 3600
    else:
        if block.timestamp < periodFinish:
            if lastUpdateTime > block.timestamp:
                revert with 0, 'SafeMath: subtraction overflow'
    ...
    if block.timestamp + (2160 * 24 * 3600) < block.timestamp:
        revert with 0, 'SafeMath: addition overflow'
    periodFinish = block.timestamp + (2160 * 24 * 3600)
...
function stake(uint256 arg1) payable {
    ...
    call lPTokenAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
