...
function mint(address[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        if idx >= mem[floor32(arg1.length) + 97]:
            revert with 'NH{q', 50
        _311 = mem[(32 * idx) + floor32(arg1.length) + 129]
        _312 = mem[64]
        mem[64] = mem[64] + 32
        mem[_312] = 0
        if not address(_309):
        ...
        if paused:
            revert with 0, 'Pausable: paused'
        stor9[_311] = tokenByIndex.length
        tokenByIndex.length++
        tokenByIndex[tokenByIndex.length] = _311
        if address(_309):
            tokenOfOwnerByIndex[address(_309)][stor3[address(_309)]] = _311
            stor7[_311] = balanceOf[address(_309)]
            if balanceOf[address(_309)] > -2:
                revert with 'NH{q', 17
            balanceOf[address(_309)]++
            mem[0] = _311
            mem[32] = 2
            ownerOf[_311] = address(_309)
            emit Transfer(0, address(_309), _311);
            if ext_code.size(address(_309)) > 0:
                ...
                s = 0
                while s < 0:
                    mem[mem[64] + s + 164] = mem[_312 + s + 32]
                    s = s + 32
                    continue 
                require ext_code.size(address(_309))
                call address(_309).onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                     gas gas_remaining wei
                    args msg.sender, 0, _311, 128, 0
            ...
            if tokenByIndex.length - 1 >= tokenByIndex.length:
                revert with 'NH{q', 50
            if stor9[_311] >= tokenByIndex.length:
                revert with 'NH{q', 50
            tokenByIndex[stor9[_311]] = tokenByIndex[tokenByIndex.length]
            stor9[stor8[stor8.length]] = stor9[_311]
            stor9[_311] = 0
            if not tokenByIndex.length:
                revert with 'NH{q', 49
            tokenByIndex[tokenByIndex.length] = 0
