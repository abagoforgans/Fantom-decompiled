...
function sub_3e7b62de(?) payable {
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length:
            ...
            staticcall address(_140).0xe6a43905 with:
                    gas gas_remaining wei
        ...
        while idx < ('cd', 36).length:
            ...
            staticcall address(_141).0xe6a43905 with:
                    gas gas_remaining wei
                   args address(cd[68]), address(cd[100])
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
...
function sub_6b1bdbc9(?) payable {
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length:
            ...
            staticcall address(_160).0xe6a43905 with:
                    gas gas_remaining wei
                   args address(cd[68]), address(cd[100])
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
        ...
        while idx < ('cd', 36).length:
            ...
            staticcall address(_161).0xe6a43905 with:
                    gas gas_remaining wei
                   args address(cd[68]), address(cd[100])
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
...
function executeOperation(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if not address(cd[(arg5 + 132)]):
        ...
        require _194 + return_data.size > _194 + mem[_194] + 31
        _198 = mem[_194 + mem[_194]]
        require mem[_194 + mem[_194]] <= test266151307()
        require (32 * mem[_194 + mem[_194]]) + 32 >= 0 and _194 + ceil32(return_data.size) + (32 * mem[_194 + mem[_194]]) + 32 <= test266151307()
        mem[64] = _194 + ceil32(return_data.size) + (32 * mem[_194 + mem[_194]]) + 32
        mem[_194 + ceil32(return_data.size)] = _198
        require return_data.size >= _196 + (32 * _198) + 32
        mem[_194 + ceil32(return_data.size) + 32 len 32 * _198] = mem[_194 + _196 + 32 len 32 * _198]
        mem[mem[64] + 4] = this.address
        require ext_code.size(address(cd[(arg5 + 196)]))
        staticcall address(cd[(arg5 + 196)]).0x70a08231 with:
                gas gas_remaining wei
        ...
        require _193 + return_data.size > _193 + mem[_193] + 31
        _197 = mem[_193 + mem[_193]]
        require mem[_193 + mem[_193]] <= test266151307()
        require (32 * mem[_193 + mem[_193]]) + 32 >= 0 and _193 + ceil32(return_data.size) + (32 * mem[_193 + mem[_193]]) + 32 <= test266151307()
        mem[64] = _193 + ceil32(return_data.size) + (32 * mem[_193 + mem[_193]]) + 32
        mem[_193 + ceil32(return_data.size)] = _197
        require return_data.size >= _195 + (32 * _197) + 32
        mem[_193 + ceil32(return_data.size) + 32 len 32 * _197] = mem[_193 + _195 + 32 len 32 * _197]
        mem[mem[64] + 4] = this.address
        require ext_code.size(address(cd[(arg5 + 196)]))
        staticcall address(cd[(arg5 + 196)]).0x70a08231 with:
                gas gas_remaining wei
...
function sub_3461a553(?) payable {
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length:
            ...
            staticcall address(_459).0xe6a43905 with:
                    gas gas_remaining wei
                   args address(cd[68]), address(cd[100])
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
        ...
        if not ('cd', 36).length:
            ...
            while idx < ('cd', 36).length:
                ...
                staticcall address(_1597).0xe6a43905 with:
                        gas gas_remaining wei
            ...
            while idx < ('cd', 36).length:
                ...
                staticcall address(_1598).0xe6a43905 with:
                        gas gas_remaining wei
                       args address(cd[100]), address(cd[68])
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
        ...
        while idx < ('cd', 36).length:
            ...
            staticcall address(_460).0xe6a43905 with:
                    gas gas_remaining wei
                   args address(cd[68]), address(cd[100])
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
        ...
        if not ('cd', 36).length:
            ...
            while idx < ('cd', 36).length:
                ...
                staticcall address(_1599).0xe6a43905 with:
                        gas gas_remaining wei
                       args address(cd[100]), address(cd[68])
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
            ...
            while idx < ('cd', 36).length:
                ...
                staticcall address(_1600).0xe6a43905 with:
                        gas gas_remaining wei
                       args address(cd[100]), address(cd[68])
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
...
function sub_77c6571a(?) payable {
    ...
    if not ('cd', 36).length:
        ...
        while idx < ('cd', 36).length:
            ...
            staticcall address(_1027).0xe6a43905 with:
                    gas gas_remaining wei
                   args address(cd[68]), address(cd[100])
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
        ...
        if not ('cd', 36).length:
            ...
            while idx < ('cd', 36).length:
                ...
                staticcall address(_3869).0xe6a43905 with:
                        gas gas_remaining wei
            ...
            if not ('cd', 36).length:
                ...
                while idx < ('cd', 36).length:
                    ...
                    staticcall address(_6145).0xe6a43905 with:
                            gas gas_remaining wei
                ...
                while idx < ('cd', 36).length:
                    ...
                    staticcall address(_6146).0xe6a43905 with:
                            gas gas_remaining wei
                           args address(cd[132]), address(cd[68])
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
            ...
            while idx < ('cd', 36).length:
                ...
                staticcall address(_3870).0xe6a43905 with:
                        gas gas_remaining wei
                       args address(cd[100]), address(cd[132])
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
            ...
            if not ('cd', 36).length:
                ...
                while idx < ('cd', 36).length:
                    ...
                    staticcall address(_6147).0xe6a43905 with:
                            gas gas_remaining wei
                           args address(cd[132]), address(cd[68])
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                ...
                while idx < ('cd', 36).length:
                    ...
                    staticcall address(_6148).0xe6a43905 with:
                            gas gas_remaining wei
                           args address(cd[132]), address(cd[68])
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
        ...
        while idx < ('cd', 36).length:
            ...
            staticcall address(_1028).0xe6a43905 with:
                    gas gas_remaining wei
                   args address(cd[68]), address(cd[100])
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
        ...
        if not ('cd', 36).length:
            ...
            while idx < ('cd', 36).length:
                ...
                staticcall address(_3871).0xe6a43905 with:
                        gas gas_remaining wei
                       args address(cd[100]), address(cd[132])
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
            ...
            if not ('cd', 36).length:
                ...
                while idx < ('cd', 36).length:
                    ...
                    staticcall address(_6149).0xe6a43905 with:
                            gas gas_remaining wei
                           args address(cd[132]), address(cd[68])
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                ...
                while idx < ('cd', 36).length:
                    ...
                    staticcall address(_6150).0xe6a43905 with:
                            gas gas_remaining wei
                           args address(cd[132]), address(cd[68])
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
            ...
            while idx < ('cd', 36).length:
                ...
                staticcall address(_3872).0xe6a43905 with:
                        gas gas_remaining wei
                       args address(cd[100]), address(cd[132])
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
            ...
            if not ('cd', 36).length:
                ...
                while idx < ('cd', 36).length:
                    ...
                    staticcall address(_6151).0xe6a43905 with:
                            gas gas_remaining wei
                           args address(cd[132]), address(cd[68])
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                ...
                while idx < ('cd', 36).length:
                    ...
                    staticcall address(_6152).0xe6a43905 with:
                            gas gas_remaining wei
                           args address(cd[132]), address(cd[68])
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
