...
function sub_6b3f4c21(?) payable {
    return sub_6b3f4c21Address
}
...
function sub_87af82b4(?) payable {
    require calldata.size - 4 >= 32
    if govAddress != msg.sender:
        revert with 0, '!gov'
    sub_6b3f4c21Address = arg1
    emit 0x7c0a5adf: arg1
}
        ...
        if 10000 <= withdrawFeeFactor:
            ...
            if arg2 > ext_call.return_data[0]:
                if wantLockedTotal >= ext_call.return_data[0]:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 0, stor13.field_32)
                    call wantAddress with:
                       funct uint32(stor10)
                         gas gas_remaining wei
                ...
                if wantLockedTotal < arg2:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg2) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor10)
                         gas gas_remaining wei
            ...
            if arg2:
                ...
                if withdrawFeeFactor * arg2 / 10000 <= ext_call.return_data[0]:
                    if wantLockedTotal >= withdrawFeeFactor * arg2 / 10000:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, withdrawFeeFactor * arg2 / 10000) >> 32
                        call wantAddress with:
                           funct uint32(stor10)
                             gas gas_remaining wei
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 0, stor13.field_32)
                        call wantAddress with:
                           funct uint32(stor10)
                             gas gas_remaining wei
                    ...
                    if wantLockedTotal >= ext_call.return_data[0]:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), ext_call.return_data[0 len 28]
                        call wantAddress with:
                           funct uint32(stor10)
                             gas gas_remaining wei
                ...
                if 0 <= ext_call.return_data[0]:
                    if wantLockedTotal >= 0:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor10), uint32(stor10), 0
                        call wantAddress with:
                           funct uint32(stor10)
                             gas gas_remaining wei
