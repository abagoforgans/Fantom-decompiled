...
function renounceOwnership() {
    ...
    emit code.data[8946 len 32]: owner, 0
    owner = 0
}
...
function unlock() {
    ...
    emit code.data[8946 len 32]: owner, stor1
    owner = stor1
}
...
function transferOwnership(address arg1) {
    ...
    emit code.data[8946 len 32]: owner, arg1
    owner = arg1
}
...
function CreateStandardToken(string arg1, string arg2, uint8 arg3, uint256 arg4) payable {
    ...
    if ceil32(arg1.length) <= arg1.length:
        create contract with 0 wei
                        code: code.data[4318 len 4628], msg.sender, Array(len=arg4, data=arg1.length, Mask(8 * ceil32(arg1.length), -(8 * ceil32(arg1.length)) + 256, arg1[all], Mask(8 * ceil32(arg1.length) - arg1.length, -(8 * ceil32(arg1.length) + -ceil32(ceil32(arg1.length)) + 31) + 256, arg2.length) >> -(8 * ceil32(arg1.length) + -ceil32(ceil32(arg1.length)) + 31) + 256) << (8 * ceil32(arg1.length)) - 256, arg2.length, Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], code.data[arg2.length + -ceil32(ceil32(arg2.length)) + 4349 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256), ceil32(arg1.length) + 192, arg3 << 248
    else:
        mem[ceil32(arg1.length) + ceil32(ceil32(arg1.length)) + ceil32(ceil32(arg2.length)) + 4918] = arg2.length
        mem[ceil32(arg1.length) + ceil32(ceil32(arg1.length)) + ceil32(ceil32(arg2.length)) + 4950 len ceil32(arg2.length)] = arg2[all], code.data[arg2.length + -ceil32(ceil32(arg2.length)) + 4349 len ceil32(arg2.length) - arg2.length]
