...
function sub_e7d7ec45(?) payable {
    ...
    mem[ceil32(ceil32(('cd', 68).length)) + 161 len 2587] = code.data[12332 len 2587]
    idx = 0
    s = 96
    t = ceil32(ceil32(('cd', 68).length)) + 2780
    while idx < 2:
    ...
    create contract with 0 wei
                    code: code.data[12332 len 2587], address(this.address), mem[ceil32(ceil32(('cd', 68).length)) + 2780 len 64], Array(len=('cd', 68).length, data=call.data[cd[68] + 36 len ('cd', 68).length])
