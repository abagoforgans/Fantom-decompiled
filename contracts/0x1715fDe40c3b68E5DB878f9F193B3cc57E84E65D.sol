...
const name = 'Jiyuu Coin ftm'

const decimals = 8

const requestMinimum = 200 * 10^6
            ...
            if msg.value * tokensPerEth / 10^18:
                ...
                if stor4[address(msg.sender)]:
                    ...
                    if progress0drop > target0drop:
                        ...
                        require not distributionFinished
                        require totalDistributed + 10^6 >= totalDistributed
                        totalDistributed += 10^6
                        require balanceOf[address(msg.sender)] + 10^6 >= balanceOf[address(msg.sender)]
                        balanceOf[address(msg.sender)] += 10^6
                        emit Distr(10^6, msg.sender);
                        emit Transfer(10^6, 0, msg.sender);
                                            ...
                                            if msg.value * tokensPerEth / 10^18 <= 0:
                                                ...
                                                if block.timestamp < deadline:
                                                    if 10^18 > msg.value:
                                                        ...
                                                        require not distributionFinished
                                                        require (50 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18) + totalDistributed >= totalDistributed
                                                        totalDistributed = (50 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18) + totalDistributed
                                                        require (50 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
                                                        balanceOf[address(msg.sender)] = (50 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18) + balanceOf[address(msg.sender)]
                                                        emit Distr(((50 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18)), msg.sender);
                                                        emit Transfer(((50 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18)), 0, msg.sender);
                                                        if totalDistributed < totalSupply:
                                                        else:
                                                            distributionFinished = 1
                                                else:
                                    ...
                                    if msg.value * tokensPerEth / 10^18 <= 0:
                                        ...
                                        if block.timestamp < deadline:
                                            if 10^18 > msg.value:
                                                ...
                                                require not distributionFinished
                                                require (100 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18) + totalDistributed >= totalDistributed
                                                totalDistributed = (100 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18) + totalDistributed
                                                require (100 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
                                                balanceOf[address(msg.sender)] = (100 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18) + balanceOf[address(msg.sender)]
                                                emit Distr(((100 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18)), msg.sender);
                                                emit Transfer(((100 * msg.value * tokensPerEth / 10^18 / 100) + (msg.value * tokensPerEth / 10^18)), 0, msg.sender);
                                                if totalDistributed < totalSupply:
                                                else:
                                                    distributionFinished = 1
                                        else:
