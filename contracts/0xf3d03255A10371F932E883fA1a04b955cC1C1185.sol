...
function sub_4746869e(?) payable {
    ...
    while idx < sub_d38b576d.length:
        ...
        mem[100] = 0xe2f22d84dabdc7de1492965c3abd41f34c08b852
        mem[132] = sub_d38b576d[idx].field_0
        require ext_code.size(0xce761d788df608bd21bdd59d6f4b54b2e27f25bb)
        call 0xce761d788df608bd21bdd59d6f4b54b2e27f25bb.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0xe2f22d84dabdc7de1492965c3abd41f34c08b852, sub_d38b576d[idx].field_0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if idx == -1:
            revert with 0, 17
...
function craft(uint256 arg1, uint256 arg2) payable {
    ...
    while idx < sub_d38b576d.length:
        mem[0] = 0
        mem[mem[64] + 100] = 0
        require ext_code.size(0xe2f22d84dabdc7de1492965c3abd41f34c08b852)
        staticcall 0xe2f22d84dabdc7de1492965c3abd41f34c08b852.simulate(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) with:
                gas gas_remaining wei
        ...
        if mem[_20]:
            require ext_code.size(0xe2f22d84dabdc7de1492965c3abd41f34c08b852)
            staticcall 0xe2f22d84dabdc7de1492965c3abd41f34c08b852.next_item() with:
                    gas gas_remaining wei
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            mem[mem[64] + 100] = 0
            require ext_code.size(0xe2f22d84dabdc7de1492965c3abd41f34c08b852)
            call 0xe2f22d84dabdc7de1492965c3abd41f34c08b852.craft(uint256 arg1, uint8 arg2, uint8 arg3, uint256 arg4) with:
                 gas gas_remaining wei
            ...
            mem[mem[64] + 68] = _28
            require ext_code.size(0xe2f22d84dabdc7de1492965c3abd41f34c08b852)
            call 0xe2f22d84dabdc7de1492965c3abd41f34c08b852.safeTransferFrom(address arg1, address arg2, uint256 arg3) with:
                 gas gas_remaining wei
                args this.address, stor1, _28
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        if idx == -1:
            revert with 0, 17
