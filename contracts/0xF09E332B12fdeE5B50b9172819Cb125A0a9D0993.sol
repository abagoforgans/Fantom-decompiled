...
function updateInfo() payable {
    ...
    if not sub_d373b52e.length:
        if sub_44951130.length:
            ...
            staticcall chefAddress.mem[var23003 len 4] with:
                    gas gas_remaining wei
            ...
            mem[var31005 len 160] = ext_call.return_data[0 len 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 160
            require var35004 < sub_d373b52e.length
            address(sub_d373b52e[var37001]) = address(var37003)
            require var37005 < sub_d373b52e.length
            mem[0] = address(sub_d373b52e[var39001])
            mem[32] = 6
            sub_1fbedece[address(stor3[var39001])] = 123123
            mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
            require ext_code.size(chefAddress)
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 160
            require var55004 < sub_d373b52e.length
            # nil
        else:
            mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
            require ext_code.size(chefAddress)
            staticcall chefAddress.mem[var19003 len 4] with:
                    gas gas_remaining wei
            ...
            mem[var27005 len 160] = ext_call.return_data[0 len 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 160
            require var31004 < sub_d373b52e.length
            address(sub_d373b52e[var33001]) = address(var33003)
            require var33005 < sub_d373b52e.length
            mem[0] = address(sub_d373b52e[var35001])
            mem[32] = 6
            sub_1fbedece[address(stor3[var35001])] = 123123
            mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
            require ext_code.size(chefAddress)
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 160
            require var51004 < sub_d373b52e.length
            address(sub_d373b52e[var53001]) = address(var53003)
            require var53005 < sub_d373b52e.length
            # nil
    else:
        ...
        if not sub_44951130.length:
            mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
            require ext_code.size(chefAddress)
            staticcall chefAddress.mem[var26003 len 4] with:
                    gas gas_remaining wei
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if var30003 >= mem[var30002]:
            mem[96] = 0x1526fe2700000000000000000000000000000000000000000000000000000000
            mem[100] = var32001
            require ext_code.size(chefAddress)
            staticcall chefAddress.mem[var34003 len 4] with:
                    gas gas_remaining wei
                   args mem[var34003 + 4 len var34004 - 4]
            mem[var34005 len 160] = ext_call.return_data[0 len 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 160
            require var38004 < sub_d373b52e.length
            address(sub_d373b52e[var40001]) = address(var40003)
            require var40005 < sub_d373b52e.length
            mem[0] = address(sub_d373b52e[var42001])
            mem[32] = 6
            sub_1fbedece[address(stor3[var42001])] = 123123
            mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
            require ext_code.size(chefAddress)
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 160
            require var58004 < sub_d373b52e.length
            # nil
        else:
            idx = 0
            s = 0
            ...
            mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
            require ext_code.size(chefAddress)
            staticcall chefAddress.mem[var30003 len 4] with:
                    gas gas_remaining wei
            ...
            mem[100] = var36001
            require ext_code.size(chefAddress)
            staticcall chefAddress.mem[var38003 len 4] with:
                    gas gas_remaining wei
                   args mem[var38003 + 4 len var38004 - 4]
            mem[var38005 len 160] = ext_call.return_data[0 len 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 160
            require var42004 < sub_d373b52e.length
            address(sub_d373b52e[var44001]) = address(var44003)
            require var44005 < sub_d373b52e.length
            mem[0] = address(sub_d373b52e[var46001])
            mem[32] = 6
            sub_1fbedece[address(stor3[var46001])] = 123123
            mem[96] = 0x81e3eda00000000000000000000000000000000000000000000000000000000
            require ext_code.size(chefAddress)
