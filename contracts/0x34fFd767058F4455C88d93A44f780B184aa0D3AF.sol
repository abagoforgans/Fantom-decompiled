...
function isWin(uint256 arg1, uint256 arg2) payable {
    ...
    if arg1 >= arg2:
        ...
        if not (arg1 * arg1) + (-1 * arg2 * arg1) + (-1 * arg1 * arg2) + (arg2 * arg2) + 5:
            revert with 'NH{q', 18
        if sha3(block.timestamp, battleCount) % (arg1 * arg1) + (-1 * arg2 * arg1) + (-1 * arg1 * arg2) + (arg2 * arg2) + 5 == 1:
            return 0
    else:
        if arg2 < arg1:
            revert with 'NH{q', 17
...
function battle(uint256 arg1, uint256 arg2) payable {
    ...
    if ext_call.return_data[0] >= ext_call.return_data[0]:
        if (ext_call.return_data[0] * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0]) > -6:
            revert with 'NH{q', 17
        if not (ext_call.return_data[0] * ext_call.return_data[0]) + (-1 * ext_call.return_data[0] * ext_call.return_data[0]) + (-1 * ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0]) + 5:
            revert with 'NH{q', 18
        if sha3(block.timestamp, battleCount) % (ext_call.return_data[0] * ext_call.return_data[0]) + (-1 * ext_call.return_data[0] * ext_call.return_data[0]) + (-1 * ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0]) + 5 == 1:
            emit 0xeaca0ab4: 0, arg1, arg2
            return 0
    else:
        if ext_call.return_data[0] < ext_call.return_data[0]:
            revert with 'NH{q', 17
    ...
    if not ext_call.return_data[0]:
        ...
        emit 0xeaca0ab4: 1, 10 * 10^18, arg1, arg2
    else:
        ...
        emit 0xeaca0ab4: 1, 10 * 10^18 * 2^ext_call.return_data[0], arg1, arg2
    return 1
}
