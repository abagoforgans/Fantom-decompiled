...
function unpause() payable {
    ...
    if not return_data.size:
        ...
        if ext_code.size(wantAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = 0, address(masterchefAddress), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        if ext_code.size(wantAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 425 len 64] = 0, address(masterchefAddress), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        call wantAddress with:
           funct uint32(stor5)
             gas gas_remaining wei
