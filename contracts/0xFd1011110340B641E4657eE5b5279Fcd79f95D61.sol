...
function sub_c06ef3e7(?) payable {
    require calldata.size - 4 >= 64
    if block.timestamp - userInfo[arg1][address(arg2)].field_512 / 60 / 60 / 24 > 1092:
        return 400
    if block.timestamp - userInfo[arg1][address(arg2)].field_512 / 60 / 60 / 24 > 364:
        return 150
    if block.timestamp - userInfo[arg1][address(arg2)].field_512 / 60 / 60 / 24 > 182:
        return 120
    if block.timestamp - userInfo[arg1][address(arg2)].field_512 / 60 / 60 / 24 > 31:
        return 105
    if block.timestamp - userInfo[arg1][address(arg2)].field_512 / 60 / 60 / 24 > 7:
        return 103
    if block.timestamp - userInfo[arg1][address(arg2)].field_512 / 60 / 60 / 24 > 1:
        return 101
    return 100
}
