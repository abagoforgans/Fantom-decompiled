...
function sub_a90d0391(?) payable {
    ...
    while idx < stor3.length:
        ...
        staticcall address(_26).getPair(address rg1, address rg2) with:
                gas gas_remaining wei
        ...
        require ext_code.size(mem[_29 + 12 len 20])
        staticcall mem[_29 + 12 len 20].getReserves() with:
                gas gas_remaining wei
        ...
        if 997 * 10^6 * mem[_33 + 18 len 14] / 997 * 10^6 != mem[_33 + 18 len 14]:
            revert with 0, 'SafeMath: multiplication overflow'
        if not mem[_33 + 50 len 14]:
            if 997 * 10^6 * mem[_33 + 18 len 14] / 997 * 10^6 <= s:
                idx = idx + 1
                s = s
                continue 
            idx = idx + 1
            s = 997 * 10^6 * mem[_33 + 18 len 14] / 997 * 10^6
            continue 
        require mem[_33 + 50 len 14]
        if 1000 * mem[_33 + 50 len 14] / mem[_33 + 50 len 14] != 1000:
            revert with 0, 'SafeMath: multiplication overflow'
        if (1000 * mem[_33 + 50 len 14]) + 997 * 10^6 < 1000 * mem[_33 + 50 len 14]:
            revert with 0, 'SafeMath: addition overflow'
        require (1000 * mem[_33 + 50 len 14]) + 997 * 10^6
        if 997 * 10^6 * mem[_33 + 18 len 14] / (1000 * mem[_33 + 50 len 14]) + 997 * 10^6 <= s:
            idx = idx + 1
            s = s
            continue 
        idx = idx + 1
        s = 997 * 10^6 * mem[_33 + 18 len 14] / (1000 * mem[_33 + 50 len 14]) + 997 * 10^6
        continue 
}
