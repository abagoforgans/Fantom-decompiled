...
function withdraw(address arg1, uint256 arg2, address arg3) payable {
    ...
    if vaults[address(arg1)] != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(address(strategies[address(arg1)]))
    call address(strategies[address(arg1)]).withdraw(uint256 rg1, address rg2) with:
         gas gas_remaining wei
        args arg2, arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function earn(address arg1, uint256 arg2) payable {
    ...
    if arg1 == ext_call.return_data[12 len 20]:
        mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, strategies[address(arg1)]), uint32(strategies[address(arg1)]), Mask(224, 32, arg2) >> 32
        call arg1 with:
        ...
        if not return_data.size:
            if not ext_call.success:
                revert with transfer(address rg1, uint256 rg2), Mask(224, 0, strategies[address(arg1)]), uint32(strategies[address(arg1)]), arg2
            if not transfer(address rg1, uint256 rg2), Mask(224, 0, strategies[address(arg1)]):
                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
        ...
        mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, converters[address(arg1)][address(ext_call.return_data[0])]), uint32(converters[address(arg1)][address(ext_call.return_data[0])]), Mask(224, 32, arg2) >> 32
        call arg1 with:
        ...
        if not return_data.size:
            if not ext_call.success:
                revert with transfer(address rg1, uint256 rg2), 
                            ...
                            arg2
            if not transfer(address rg1, uint256 rg2), Mask(224, 0, converters[address(arg1)][address(ext_call.return_data[0])]):
                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            ...
            if not ext_code.hash(address(ext_call.return_data[0])):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, strategies[address(arg1)]), uint32(strategies[address(arg1)]), ext_call.return_data[0 len 28]
            ...
            if not ext_code.hash(address(ext_call.return_data[0])):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, strategies[address(arg1)]), uint32(strategies[address(arg1)]), ext_call.return_data[0 len 28]
            call address(ext_call.return_data[0]) with:
               funct uint32(strategies[address(arg1)])
                 gas gas_remaining wei
