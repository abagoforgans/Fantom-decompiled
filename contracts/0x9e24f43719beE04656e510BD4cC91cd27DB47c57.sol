...
function sub_35c793ab(?) payable {
    ...
    return 32, 8445, code.data[7055 len 8381], mem[8509 len 3] >> 66792, address(arg1), address(arg2), 0 >> 67304, 0
}
...
function deploy(address arg1, address arg2) payable {
    ...
    if feeds[address(arg1)]:
        revert with 0, 'PE'
    mem[8640 len 8384] = code.data[7055 len 8381], mem[8509 len 3]
