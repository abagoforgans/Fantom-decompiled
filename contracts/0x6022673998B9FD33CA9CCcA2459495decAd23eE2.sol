    ...
    while idx < poolInfo.length:
        ...
        if not block.number - poolInfo[idx].field_512:
            ...
            if not 0 / totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _254 + 68] = mem[idx + _245 + 32]
                    idx = idx + 32
                    continue 
            ...
            idx = 0
            while idx < 26:
                mem[idx + _262 + 68] = mem[idx + _249 + 32]
                idx = idx + 32
                continue 
        ...
        if not block.number - poolInfo[idx].field_512:
            ...
            idx = 0
            while idx < 26:
                mem[idx + _269 + 68] = mem[idx + _253 + 32]
                idx = idx + 32
                continue 
        ...
        if not (block.number * sub_fd2d7913) - (poolInfo[idx].field_512 * sub_fd2d7913):
            ...
            idx = 0
            while idx < 26:
                mem[idx + _276 + 68] = mem[idx + _258 + 32]
                idx = idx + 32
                continue 
        ...
        while idx < poolInfo.length:
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _304 + 68] = mem[idx + _295 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _312 + 68] = mem[idx + _299 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _246 + 68] = mem[idx + _240 + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _309 + 68] = mem[idx + _298 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _319 + 68] = mem[idx + _303 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * sub_fd2d7913) - (poolInfo[idx].field_512 * sub_fd2d7913):
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _249 + 68] = mem[idx + _241 + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _316 + 68] = mem[idx + _302 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _326 + 68] = mem[idx + _308 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * sub_fd2d7913 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_fd2d7913 * poolInfo[idx].field_256) / totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _323 + 68] = mem[idx + _307 + 32]
                    idx = idx + 32
                    continue 
