...
function _fallback() {
    ...
    stor2.length.field_8 = 'SNTVT' / 256
    idx = 0
    ...
    stor3.length.field_8 = 'Sentivate' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 18
    stor5 = 4200000000 * 10^18
    stor6[0x2f3a5962357058e89fd6c86890d3d0b22b8983b1] = stor5
    emit Transfer(address rg1, address rg2, uint256 rg3):
                  stor5,
    emit 0x0: stor5
    emit 0x2f3a5962: stor5
    return code.data[694 len 5596]
}
