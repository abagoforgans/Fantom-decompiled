...
function sub_f745034c(?) payable {
    ...
    mem[(4 * ceil32(return_data.size)) + 100] = stor12
    ...
    mem[(6 * ceil32(return_data.size)) + 100] = stor13
    require ext_code.size(stor6)
    staticcall stor6.0x70a08231 with:
            gas gas_remaining wei
           args stor13
    ...
    mem[(7 * ceil32(return_data.size)) + 100] = stor13
    ...
    mem[(8 * ceil32(return_data.size)) + 100] = stor14
    ...
    mem[(10 * ceil32(return_data.size)) + 100] = stor14
    ...
    mem[(11 * ceil32(return_data.size)) + 100] = stor15
    require ext_code.size(stor6)
    staticcall stor6.0x70a08231 with:
            gas gas_remaining wei
           args stor15
    ...
    mem[(12 * ceil32(return_data.size)) + 100] = stor15
    ...
    mem[(13 * ceil32(return_data.size)) + 96] = 32
    mem[(13 * ceil32(return_data.size)) + 128] = ext_call.return_data[0]
    mem[(13 * ceil32(return_data.size)) + 160 len 32 * ext_call.return_data[0]] = mem[128 len 32 * ext_call.return_data[0]]
    return Array(len=ext_call.return_data[0], data=mem[(13 * ceil32(return_data.size)) + 160 len 32 * ext_call.return_data[0]])
}
...
function sub_5638195e(?) payable {
    ...
    while idx < ext_call.return_data[0]:
        ...
        staticcall mem[_593 + 12 len 20].0x70a08231 with:
                gas gas_remaining wei
               args stor0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        staticcall address(_596).0x18160ddd with:
                gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[64] = mem[64] + ceil32(return_data.size)
                    ...
                    if stor5 == address(_641):
                        ...
                        if stor4 == address(_641):
                            ...
                            if stor3 != address(_641):
                                ...
                                staticcall address(_645).0x70a08231 with:
                                        gas gas_remaining wei
                                       args address(_634)
                                mem[mem[64]] = ext_call.return_data[0]
                                if not ext_call.success:
    ...
    mem[var21007 + 32 len 32 * _1184] = mem[128 len 32 * _1184]
    mem[_589 + 96] = var21007 + (32 * _1184) + -_589 + 32
    _1192 = mem[96]
    mem[var21007 + (32 * _1184) + 32] = mem[96]
